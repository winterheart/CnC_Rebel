 ...
 *=============================================================================================*/
ServerControlClass::~ServerControlClass(void) { Stop_Listening(); }
 ...
 *   11/16/2001 4:01PM ST : Created                                                            *
 *=============================================================================================*/
bool ServerControlClass::Start_Listening(unsigned short port, char *password,
                                         const char *(*app_request_callback)(char *),
                                         void (*app_response_callback)(char *), bool loopback, unsigned long ip) {
  LocalPort = port;
  if (LocalPort != 0) {
