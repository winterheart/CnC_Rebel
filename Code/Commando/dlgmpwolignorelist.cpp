...
//
////////////////////////////////////////////////////////////////
MPWolIgnoreListPopupClass::MPWolIgnoreListPopupClass(void) : PopupDialogClass(IDD_MP_WOL_IGNORE_LIST) {
...
//
////////////////////////////////////////////////////////////////
void MPWolIgnoreListPopupClass::On_Init_Dialog(void) {
...
//
////////////////////////////////////////////////////////////////
void MPWolIgnoreListPopupClass::On_Command(int ctrl_id, int message_id, DWORD param) {
  switch (ctrl_id) {
  case IDC_ADD_BUTTON:
...
//
////////////////////////////////////////////////////////////////
void MPWolIgnoreListPopupClass::Refresh_List(void) {
  ListCtrlClass *list_ctrl = (ListCtrlClass *)Get_Dlg_Item(IDC_BUDDY_LIST_CTRL);
