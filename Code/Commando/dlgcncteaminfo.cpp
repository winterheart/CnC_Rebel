...
//
////////////////////////////////////////////////////////////////
CNCTeamInfoDialogClass::CNCTeamInfoDialogClass(void) : MenuDialogClass(IDD_CNC_TEAM_INFO) { return; }
...
//
////////////////////////////////////////////////////////////////
void CNCTeamInfoDialogClass::Configure_Icons(void) {
  ...
  const int ICON_CTRLS[] = {
      IDC_BUILDING01_ICON, IDC_BUILDING02_ICON, IDC_BUILDING03_ICON, IDC_BUILDING04_ICON, IDC_BUILDING05_ICON,
  };
...
//
////////////////////////////////////////////////////////////////
void CNCTeamInfoDialogClass::Populate_Player_List(void) {
  //
  //	Get a pointer to the list control
  //
  ListCtrlClass *list_ctrl = (ListCtrlClass *)Get_Dlg_Item(IDC_LIST_CTRL);
...
//
////////////////////////////////////////////////////////////////
int CALLBACK CNCTeamInfoDialogClass::ListSortCallback(ListCtrlClass *list_ctrl, int item_index1, int item_index2,
                                                      uint32 user_param) {
