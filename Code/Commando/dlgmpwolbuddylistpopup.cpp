...
MPWolBuddyListPopupClass::MPWolBuddyListPopupClass(void)
    : Observer(NULL), PopupDialogClass(IDD_MP_WOL_BUDDY_LIST_POPUP) {
  return;
}
...
//
////////////////////////////////////////////////////////////////
void MPWolBuddyListPopupClass::On_Init_Dialog(void) {
  //
...
//
////////////////////////////////////////////////////////////////
void MPWolBuddyListPopupClass::On_Command(int ctrl_id, int message_id, DWORD param) {
  switch (ctrl_id) {
...
//
////////////////////////////////////////////////////////////////
void MPWolBuddyListPopupClass::On_ListCtrl_DblClk(ListCtrlClass *list_ctrl, int ctrl_id, int item_index) {
  On_Select();
  return;
}
