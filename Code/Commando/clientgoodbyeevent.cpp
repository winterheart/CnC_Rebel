...
//-----------------------------------------------------------------------------
void cClientGoodbyeEvent::Init(void) {
...
//-----------------------------------------------------------------------------
void cClientGoodbyeEvent::Act(void) {
...
//-----------------------------------------------------------------------------
void cClientGoodbyeEvent::Export_Creation(BitStreamClass &packet) {
...
//-----------------------------------------------------------------------------
void cClientGoodbyeEvent::Import_Creation(BitStreamClass &packet) {
