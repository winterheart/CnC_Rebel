...
CnCReferenceMenuClass::CnCReferenceMenuClass(void)
    : OldBackdrop(NULL), Timer(0.5F), MenuDialogClass(IDD_MENU_CNC_REFERENCE) {
  _TheInstance = this;
  return;
}
...
//
////////////////////////////////////////////////////////////////
void CnCReferenceMenuClass::On_Init_Dialog(void) {
  ...
  Input::Get_Translated_Key_Name(Input::Get_Primary_Key_For_Function(INPUT_FUNCTION_EVA_MISSION_OBJECTIVES_TOGGLE),
                                 name);
...
//
////////////////////////////////////////////////////////////////
void CnCReferenceMenuClass::On_Destroy(void) {
  //
...
//
////////////////////////////////////////////////////////////////
void CnCReferenceMenuClass::On_Command(int ctrl_id, int message_id, DWORD param) {
...
//
////////////////////////////////////////////////////////////////
void CnCReferenceMenuClass::Display(void) {
  //
...
//
////////////////////////////////////////////////////////////////
void CnCReferenceMenuClass::On_Menu_Activate(bool onoff) {
  if (onoff) {
...
//
////////////////////////////////////////////////////////////////
void CnCReferenceMenuClass::On_Frame_Update(void) {
...
//
////////////////////////////////////////////////////////////////
void CnCReferenceMenuClass::Prompt_User(void) {
  //
...
//
////////////////////////////////////////////////////////////////
void CnCReferenceMenuClass::HandleNotification(DlgMsgBoxEvent &event) {
...
//
////////////////////////////////////////////////////////////////
void CnCReferenceMenuClass::Exit_Game(void) {
  //
  //	Close the dialog
  //
  End_Dialog();
...
bool is_team_change_enabled =
        ...
        The_Game()->IsTeamChangingAllowed.Is_True() &&
        (!(GameModeManager::Find("WOL") != NULL && GameModeManager::Find("WOL")->Is_Active()) ||
The_Game()->IsLaddered.Is_False()) && GameModeManager::Find("Combat") != NULL &&
        GameModeManager::Find("Combat")->Is_Active();
