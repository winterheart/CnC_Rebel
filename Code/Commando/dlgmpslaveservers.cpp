...
unsigned long SlaveServerDialogClass::EnableIDs[MAX_SLAVES] = {IDC_SLAVE_ENABLE1, IDC_SLAVE_ENABLE2, IDC_SLAVE_ENABLE3,
                                                               IDC_SLAVE_ENABLE4, IDC_SLAVE_ENABLE5, IDC_SLAVE_ENABLE6,
                                                               IDC_SLAVE_ENABLE7};

unsigned long SlaveServerDialogClass::NickIDs[MAX_SLAVES] = {
    IDC_NICK_EDIT1, IDC_NICK_EDIT2, IDC_NICK_EDIT3, IDC_NICK_EDIT4, IDC_NICK_EDIT5, IDC_NICK_EDIT6, IDC_NICK_EDIT7};

unsigned long SlaveServerDialogClass::PassIDs[MAX_SLAVES] = {
    IDC_PASS_EDIT1, IDC_PASS_EDIT2, IDC_PASS_EDIT3, IDC_PASS_EDIT4, IDC_PASS_EDIT5, IDC_PASS_EDIT6, IDC_PASS_EDIT7};

unsigned long SlaveServerDialogClass::SerialIDs[MAX_SLAVES] = {IDC_SERIAL_EDIT1, IDC_SERIAL_EDIT2, IDC_SERIAL_EDIT3,
                                                               IDC_SERIAL_EDIT4, IDC_SERIAL_EDIT5, IDC_SERIAL_EDIT6,
                                                               IDC_SERIAL_EDIT7};

unsigned long SlaveServerDialogClass::PortIDs[MAX_SLAVES] = {
    IDC_PORT_EDIT1, IDC_PORT_EDIT2, IDC_PORT_EDIT3, IDC_PORT_EDIT4, IDC_PORT_EDIT5, IDC_PORT_EDIT6, IDC_PORT_EDIT7};

unsigned long SlaveServerDialogClass::SettingsButtons[MAX_SLAVES] = {
    IDC_SLAVE1_SETTINGS, IDC_SLAVE2_SETTINGS, IDC_SLAVE3_SETTINGS, IDC_SLAVE4_SETTINGS,
    IDC_SLAVE5_SETTINGS, IDC_SLAVE6_SETTINGS, IDC_SLAVE7_SETTINGS};
...
//
////////////////////////////////////////////////////////////////
SlaveServerDialogClass::SlaveServerDialogClass(void) : MenuDialogClass(IDD_MP_WOL_SLAVESERVER) { Instance = this; }

void SlaveServerDialogClass::On_Init_Dialog(void) {
  /*
...
void SlaveServerDialogClass::On_Command(int ctrl_id, int message_id, DWORD param) {
  switch (ctrl_id) {
...
void SlaveServerDialogClass::Set_Slave_Button(int slavenum) {
  ...
  if (file.Is_Available()) {
    ...
    if (ini) {
      ...
      // int size = ini->Get_String("Settings", "ConfigName", "Custom C&C Server Settings", description,
      // sizeof(description));
...
//
////////////////////////////////////////////////////////////////
void SlaveServerDialogClass::On_Destroy(void) { MenuDialogClass::On_Destroy(); }
