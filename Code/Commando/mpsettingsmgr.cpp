...
//
////////////////////////////////////////////////////////////////
void MPSettingsMgrClass::Load_Settings(void) {
  //
...
//
////////////////////////////////////////////////////////////////
void MPSettingsMgrClass::Set_Last_Login(const char *name) {
  LastLogin = name;
...
//
////////////////////////////////////////////////////////////////
const char *MPSettingsMgrClass::Get_Last_Login(void) { return (const char *)LastLogin; }
...
//
////////////////////////////////////////////////////////////////
void MPSettingsMgrClass::Set_Auto_Login(const char *login) {
  AutoLogin = login;
...
//
////////////////////////////////////////////////////////////////
const char *MPSettingsMgrClass::Get_Auto_Login(void) { return (const char *)AutoLogin; }
...
//
////////////////////////////////////////////////////////////////
void MPSettingsMgrClass::Set_Auto_Password(const char *pass) {
  AutoPassword = pass;
...
//
////////////////////////////////////////////////////////////////
const char *MPSettingsMgrClass::Get_Auto_Password(void) { return (const char *)AutoPassword; }
...
//
////////////////////////////////////////////////////////////////
int MPSettingsMgrClass::Get_QuickMatch_Mode_Preference(const char *mode) {
...
//
////////////////////////////////////////////////////////////////
void MPSettingsMgrClass::Set_QuickMatch_Mode_Preference(const char *mode, int preference) {
...
//
////////////////////////////////////////////////////////////////
void MPSettingsMgrClass::Save_QuickMatch_Mode_Preferences(void) {
  RegistryClass registry(APPLICATION_SUB_KEY_NAME_QUICKMATCH);
...
//
////////////////////////////////////////////////////////////////
void MPSettingsMgrClass::Set_Is_Sidebar_Help_Displayed(bool onoff) {
...
//
////////////////////////////////////////////////////////////////
void MPSettingsMgrClass::Enable_Auto_Login_Prompt(bool onoff) {
...
//
////////////////////////////////////////////////////////////////
void MPSettingsMgrClass::Set_Option_Flag(OPTION flag, bool onoff) {
  if (onoff) {
    OptionFlags |= flag;
  } else {
    OptionFlags &= (~flag);
...
//
////////////////////////////////////////////////////////////////
bool MPSettingsMgrClass::Are_Alternate_Skins_Unlocked(void) {
