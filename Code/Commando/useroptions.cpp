...
void cUserOptions::Reread(void) {
  ...
  GameSpyBandwidthType.Set(
      RegistryClass(APPLICATION_SUB_KEY_NAME_GAMESPY).Get_Int("GameSpyBandwidthType", GameSpyBandwidthType.Get()));
}

/*
cRegistryInt cUserOptions::GameListFilterMaxPing(				APPLICATION_SUB_KEY_NAME_NETOPTIONS,
"GameListFilterMaxPing",								9999); cRegistryInt
cUserOptions::GameListFilterMinPlayersPresent(	APPLICATION_SUB_KEY_NAME_NETOPTIONS, "GameListFilterMinPlayersPresent",
0); cRegistryInt cUserOptions::GameListFilterMaxPlayersPresent(	APPLICATION_SUB_KEY_NAME_NETOPTIONS,
"GameListFilterMaxPlayersPresent",					99); cRegistryInt
cUserOptions::GameListFilterMaxPlayersPermitted( APPLICATION_SUB_KEY_NAME_NETOPTIONS,
"GameListFilterMaxPlayersPermitted",			99); cRegistryBool cUserOptions::GameListFilterShowPrivateGames(
APPLICATION_SUB_KEY_NAME_NETOPTIONS, "GameListFilterShowPrivateGames",					true);
cRegistryBool cUserOptions::GameListFilterShowOnlyDedicatedGames(	APPLICATION_SUB_KEY_NAME_NETOPTIONS,
"GameListFilterShowOnlyDedicatedGames",	false); cRegistryBool cUserOptions::GameListFilterShowOnlyGamesIRankFor(
APPLICATION_SUB_KEY_NAME_NETOPTIONS, "GameListFilterShowOnlyGamesIRankFor",	false);
*/
