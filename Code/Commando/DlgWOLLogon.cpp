...
DlgWOLLogon::DlgWOLLogon() : PopupDialogClass(IDD_WOL_LOGON), mIsPasswordEncrypted(false) {
...
DlgWOLLogon::~DlgWOLLogon() { WWDEBUG_SAY(("DlgWOLLogon: Destroyed\n")); }
...
void DlgWOLLogon::GetLogin(const wchar_t **name, const wchar_t **password, bool &encrypted) {
  if (name) {
...
bool DlgWOLLogon::IsRememberLoginChecked(void) { return Is_Dlg_Button_Checked(IDC_REMEMBER_LOGIN_CHECK); }
