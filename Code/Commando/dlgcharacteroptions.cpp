...
//
////////////////////////////////////////////////////////////////
CharacterOptionsMenuClass::CharacterOptionsMenuClass(void) : UnloadDefs(false), MenuDialogClass(IDD_OPTIONS_CHARACTER) {
...
//
////////////////////////////////////////////////////////////////
void CharacterOptionsMenuClass::On_Init_Dialog(void) {
...
//
////////////////////////////////////////////////////////////////
void CharacterOptionsMenuClass::On_Command(int ctrl_id, int message_id, DWORD param) {
...
//
////////////////////////////////////////////////////////////////
void CharacterOptionsMenuClass::Fill_Character_Combobox(void) {
  PurchaseSettingsDefClass *settings1 = PurchaseSettingsDefClass::Find_Definition(
...
//
////////////////////////////////////////////////////////////////
void CharacterOptionsMenuClass::On_ComboBoxCtrl_Sel_Change(ComboBoxCtrlClass *combo_ctrl, int ctrl_id, int old_sel,
                                                           int new_sel) {
...
//
////////////////////////////////////////////////////////////////
void CharacterOptionsMenuClass::Display_Default_Model(int definition_id) {
  //
