...
//
class cGameData : public Signaler<MPChooseTeamSignal> {
public:
  enum GameTypeEnum {
  ...
  bool Set_Generic_Num(int generic_num, int lower_bound, int upper_bound, int &set_num);
  ...
  bool				Get_Server_Is_Gameplay_Permitted(void)			{return
  ServerIsGameplayPermitted;}
  */
