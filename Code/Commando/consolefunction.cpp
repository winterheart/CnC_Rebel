...
public:
  ...
  virtual const char *Get_Help(void) {
    return "BUILDING_STATE <health:0,100> <power:0,1> - force all buildings to the given state";
  }
...
public:
  ...
  virtual void Activate(const char *input) {
    ...
    if (!stricmp("*", string)) {
      ...
      unsigned id[10];
      unsigned count = sscanf(input, "%d %d %d %d %d %d %d %d %d %d", &id[0], &id[1], &id[2], &id[3], &id[4], &id[5],
                              &id[6], &id[7], &id[8], &id[9]);
...
public:
  ...
  virtual void Activate(const char *input) {
    ...
    if (cnt >= 1)
      tfc = TextureFileClass::Get_Texture(id);
    if (tfc) {
      if (cnt == 1) {
...
public:
  ...
  virtual const char *Get_Help(void) {
    return "VIS_GRID_DEBUG <p,s,f,b,r> - p=parent,s=sibling,f=front,b=back,r=reset";
  }
  virtual void Activate(const char *input) {
...
class ShadowAttenuationConsoleFunctionClass : public ConsoleFunctionClass {
  ...
  virtual const char *Get_Help(void) {
    return "SHADOW_ATTENUATION <near> <far> - set the attenuation ranges for shadows.";
  }
  virtual void Activate(const char *input) {
...
class ShadowBlobTextureConsoleFunctionClass : public ConsoleFunctionClass {
  ...
  virtual const char *Get_Help(void) {
    return "SHADOW_BLOB_TEXTURE <texture filename> - sets the texture to use for blob shadows.";
  }
  virtual void Activate(const char *input) {
    if (strlen(input) > 0) {
...
class ShadowElevationConsoleFunctionClass : public ConsoleFunctionClass {
  ...
  virtual const char *Get_Help(void) {
    return "SHADOW_ELEVATION <elevation degrees> - sets the angle of the shadow projection.";
  }
  virtual void Activate(const char *input) {
    /*
...
class ShadowIntensityConsoleFunctionClass : public ConsoleFunctionClass {
  ...
  virtual const char *Get_Help(void) {
    return "SHADOW_INTENSITY <intensity> - sets the darkness of dynamic shadows (0 - 1).";
  }
  virtual void Activate(const char *input) {
    PhysicsSceneClass *scene = PhysicsSceneClass::Get_Instance();
...
class ShadowResolutionConsoleFunctionClass : public ConsoleFunctionClass {
  ...
  virtual const char *Get_Help(void) {
    return "SHADOW_RESOLUTION <res> - sets the resolution of dynamic shadows (use a power of 2!)";
  }
  virtual void Activate(const char *input) {
    PhysicsSceneClass *scene = PhysicsSceneClass::Get_Instance();
...
public:
  ...
  virtual const char *Get_Help(void) {
    return "PHYS3_NET <allowable_error> <pop_error> <corr_time> - sets the phys3 networking constants.";
  }
  virtual void Activate(const char *input) {
...
public:
  ...
  virtual void Activate(const char *input) { WW3D::Set_Next_Render_Device(); }
};
...
public:
  ...
  virtual void Activate(const char *input) {
    ...
    static const char *_comment[2] = {"Unexposed prelit meshes\n", "Exposed	prelit meshes\n"};
...
public:
  ...
  virtual void Activate(const char *input) { Get_Console()->Toggle_Player_Position(); }
};
...
public:
  ...
  virtual const char *Get_Help(void) {
    return "TOGGLE_RENDERING <static,dynamic,human,vehicles> - toggles rendering of various types.";
  }
  virtual void Activate(const char *input) {
    ...
    */
    if (_strnicmp(input, "st", 2) == 0) {
      ...
      Print(StaticPhysClass::Is_All_Rendering_Disabled() ? "Static object rendering DISABLED"
                                                         : "Static object rendering ENABLED");

    } else if (_strnicmp(input, "dy", 2) == 0) {

      DynamicPhysClass::Disable_All_Rendering(!DynamicPhysClass::Is_All_Rendering_Disabled());
      Print(DynamicPhysClass::Is_All_Rendering_Disabled() ? "Dynamic object rendering DISABLED"
                                                          : "Dynamic object rendering ENABLED");

    } else if (_strnicmp(input, "hu", 2) == 0) {

      HumanPhysClass::Disable_All_Rendering(!HumanPhysClass::Is_All_Rendering_Disabled());
      Print(HumanPhysClass::Is_All_Rendering_Disabled() ? "Human object rendering DISABLED"
                                                        : "Human object rendering ENABLED");

    } else if (_strnicmp(input, "ve", 2) == 0) {

      VehiclePhysClass::Disable_All_Rendering(!VehiclePhysClass::Is_All_Rendering_Disabled());
      Print(VehiclePhysClass::Is_All_Rendering_Disabled() ? "Vehicle object rendering DISABLED"
                                                          : "Vehicle object rendering ENABLED");
    }
  }
};
...
public:
  ...
  virtual const char *Get_Help(void) {
    return "TOGGLE_SIMULATION <static,dynamic,human,vehicles> - toggles rendering of various types.";
  }
  virtual void Activate(const char *input) {
    ...
    */
    if (_strnicmp(input, "st", 2) == 0) {
      ...
      Print(StaticPhysClass::Is_All_Simulation_Disabled() ? "Static object Simulation DISABLED"
                                                          : "Static object Simulation ENABLED");

    } else if (_strnicmp(input, "dy", 2) == 0) {

      DynamicPhysClass::Disable_All_Simulation(!DynamicPhysClass::Is_All_Simulation_Disabled());
      Print(DynamicPhysClass::Is_All_Simulation_Disabled() ? "Dynamic object Simulation DISABLED"
                                                           : "Dynamic object Simulation ENABLED");

    } else if (_strnicmp(input, "hu", 2) == 0) {

      HumanPhysClass::Disable_All_Simulation(!HumanPhysClass::Is_All_Simulation_Disabled());
      Print(HumanPhysClass::Is_All_Simulation_Disabled() ? "Human object Simulation DISABLED"
                                                         : "Human object Simulation ENABLED");

    } else if (_strnicmp(input, "ve", 2) == 0) {

      VehiclePhysClass::Disable_All_Simulation(!VehiclePhysClass::Is_All_Simulation_Disabled());
      Print(VehiclePhysClass::Is_All_Simulation_Disabled() ? "Vehicle object Simulation DISABLED"
                                                           : "Vehicle object Simulation ENABLED");
    }
  }
};
...
public:
  ...
  virtual const char *Get_Help(void) {
    return "RENDER_BOXES <mask> - enables rendering of boxes.  0=none 1=all 2=physical 4=projectile.";
  }
  virtual void Activate(const char *input) {
    int mask = atoi(input);
...
public:
  ...
  virtual const char *Get_Help(void) {
    return "AMBIENT_LIGHT <R> <G> <B> - sets the ambeint light color to <r> <g> <b>.";
  }
  virtual void Activate(const char *input) {
    if (COMBAT_SCENE) {
      float r, g, b;
...
public:
  ...
  virtual const char *Get_Help(void) {
    return "FRAME_TEXTURES - measures the amoutn of textures needed for the next frame.";
  }
  virtual void Activate(const char *input) { DebugManager::Measure_Frame_Textures(); }
};
    ...
    if (!cNetwork::I_Am_Server()) {
      ...
      if (on) {
        ...
        for (objnode = GameObjManager::Get_Smart_Game_Obj_List()->Head(); objnode; objnode = objnode->Next()) {
          ...
          if (p_smart_obj->As_SoldierGameObj() != NULL && p_smart_obj->Get_Player_Type() != PLAYERTYPE_NEUTRAL) {
...
public:
  ...
  virtual const char *Get_Help(void) {
    return "TOGGLE_EMOTICONS - Toggle the display of emot icons during conversations.";
  }
  virtual void Activate(const char * /*input*/) {
...
public:
  ...
  virtual const char *Get_Help(void) {
    return "toggle_ghost_debug_display - Displays a box around soldiers that are in 'ghost' collision mode.";
  }
  virtual void Activate(const char *input) {
...
public:
  ...
  // virtual	const char * Get_Help( void )	{ return "CnC [vehicle<def_name> | powerup<def_name>
  // |char<class>[minigunner|rocket_soldier|grenadier|engineer|flame_thrower|mutant]
  // <rank>[enlisted|officer|special_forces|boss] ] - Purchases a team vehicle, a player powerup or upgrades the
  // player."; }
...
public:
  ...
  virtual const char *Get_Help(void) {
    return "CHANGE_CHARACTER_CLASS <preset_name> - changes your character to the specified class.";
  }
  virtual void Activate(const char *input) {
    bool success = false;
...
public:
  ...
  virtual const char *Get_Help(void) {
    return "RENDER_MODE [0 fill | 1 lines | 2 points] - set the current render mode.";
  }
  virtual void Activate(const char *input) {
...
public:
  ...
  virtual const char *Get_Help(void) {
    return "TEXTURE_FILTER_MODE [none|fast|best] - set texture filter and mipmap modes.";
  }
  virtual void Activate(const char *input) {
...
public:
  ...
  virtual const char *Get_Help(void) {
    return "ENABLE_TRIANGLE_RENDER [none|opaque|sorting|all] - enable/disable triangle rendering.";
  }
  virtual void Activate(const char *input) {
    if (stricmp(input, "none") == 0) {
...
public:
  ...
  virtual const char *Get_Help(void) {
    return "DEBUG_TYPE [type|on|off] - toggles the debug display of type (info, warning, error, script)";
  }
  virtual void Activate(const char *input) {
    char str[128];
    sprintf(str, "ERROR (%s)\n", input);
...
public:
  ...
  virtual const char *Get_Help(void) {
    return "MAX_FACING_PENALTY - set the max facing penalty. Server only. Float. Use zero to disable.";
  }
  virtual void Activate(const char *input) {
    WWASSERT(input != NULL);
    if (cNetwork::I_Am_Server()) {
...
public:
  ...
  virtual const char *Get_Help(void) {
    return "IRRELEVANCE_PENALTY - set the irrelevance penalty. Server only. Float. Use zero to disable.";
  }
  virtual void Activate(const char *input) {
    WWASSERT(input != NULL);
    if (cNetwork::I_Am_Server()) {
...
public:
  ...
  virtual const char *Get_Help(void) {
    return "SET_PACKET_LOSS <percentage> - simulate packetloss at given percentage";
  }
  virtual void Activate(const char *input) {
    WWASSERT(input != NULL);
    double percentage;
...
public:
  ...
  virtual const char *Get_Help(void) {
    return "SET_PACKET_DUPLICATION <percentage> - simulate packet duplication at given percentage";
  }
  virtual void Activate(const char *input) {
    WWASSERT(input != NULL);
...
public:
  ...
  virtual const char *Get_Help(void) {
    return "SET_PACKET_LATENCY_RANGE <min> <max> - sets a range for simulated latency (in ms)";
  }
  virtual void Activate(const char *input) {
    WWASSERT(input != NULL);
    int min_latency_ms;
    ...
    if (num_args == 2 && min_latency_ms >= 0 && max_latency_ms >= 0 && min_latency_ms <= max_latency_ms) {
...
public:
  ...
  virtual const char *Get_Help(void) {
    return "SET_SPAM_COUNT <count> - S->C state packet is sent this many extra times.";
  }
  virtual void Activate(const char *input) {
    WWASSERT(input != NULL);
...
public:
  ...
  virtual void Activate(const char *input) {
    ...
    } else if (cMiscUtil::Is_String_Same(input, "netstats") || cMiscUtil::Is_String_Same(input, "ns")) {
    ...
    } else if (cMiscUtil::Is_String_Same(input, "packet_simulation") || cMiscUtil::Is_String_Same(input, "ps")) {
...
public:
  ...
  virtual const char *Get_Help(void) {
    return "CLIENT_HINT_FACTOR - set the client hint factor (worst:average). Client only. Float. Use zero to disable.";
  }
  virtual void Activate(const char *input) {
    WWASSERT(input != NULL);
...
public:
  ...
  virtual const char *Get_Help(void) {
    return "CREATE_BOT <number> - create specified number of bots (max 20, server only).";
  }
  virtual void Activate(const char *input) {
    if (cNetwork::I_Am_Server()) {
      int num_bots = 1;
...
public:
  ...
  virtual const char *Get_Help(void) {
    return "CREATE_GRUNT <number> - create specified number of grunts (server only, max 20).";
  }
  virtual void Activate(const char *input) {
    if (cNetwork::I_Am_Server()) {
      int num_grunts = 1;
...
public:
  ...
  virtual const char *Get_Help(void) {
    return "CREATE_OBJECT <name> - create the named object (server only). Use with caution.";
  }
  virtual void Activate(const char *input) {
...
public:
  ...
  virtual void Activate(const char *input) {
    ...
    if (cMiscUtil::Is_String_Same(input, "active_game_modes") || cMiscUtil::Is_String_Same(input, "agm")) {
      GameModeManager::List_Active_Game_Modes();
    } else if (cMiscUtil::Is_String_Same(input, "definitions") || cMiscUtil::Is_String_Same(input, "d")) {
...
public:
  ...
  virtual const char *Get_Help(void) {
    return "GOD - if you are a true believer, you may toggle your godlike status.\n";
  }
  ...
  virtual void Activate(const char *input) {
    ...
    if (cNetwork::I_Am_Client() && (!password.Is_Empty() || cDevOptions::IBelieveInGod.Is_True())) {
...
public:
  ...
  virtual void Activate(const char *input) {
    ...
    if (cMiscUtil::Is_String_Same(input, "bandwidth") || cMiscUtil::Is_String_Same(input, "bw")) {
    ...
    } else if (cMiscUtil::Is_String_Same(input, "client_rhost_data") || cMiscUtil::Is_String_Same(input, "crd")) {
      cDevOptions::ShowClientRhostData.Toggle();
    } else if (cMiscUtil::Is_String_Same(input, "diagnostics") || cMiscUtil::Is_String_Same(input, "diag")) {
    ...
    } else if (cMiscUtil::Is_String_Same(input, "ip_addresses") || cMiscUtil::Is_String_Same(input, "ip")) {
    ...
    } else if (cMiscUtil::Is_String_Same(input, "import_states_count") || cMiscUtil::Is_String_Same(input, "isc")) {
    ...
    } else if (cMiscUtil::Is_String_Same(input, "latency") || cMiscUtil::Is_String_Same(input, "lat")) {
      ConsoleFunctionManager::Parse_Input("clear ns"); // reset stats
      cDevOptions::ShowLatency.Toggle();
    } else if (cMiscUtil::Is_String_Same(input, "last_contact") || cMiscUtil::Is_String_Same(input, "lc")) {
      // ConsoleFunctionManager::Parse_Input("clear ns"); // reset stats
      cDevOptions::ShowLastContact.Toggle();
    } else if (cMiscUtil::Is_String_Same(input, "list_size") || cMiscUtil::Is_String_Same(input, "ls")) {
      cDevOptions::ShowListSizes.Toggle();
    } else if (cMiscUtil::Is_String_Same(input, "list_packet_size") || cMiscUtil::Is_String_Same(input, "lps")) {
      cDevOptions::ShowListPacketSizes.Toggle();
    } else if (cMiscUtil::Is_String_Same(input, "list_time") || cMiscUtil::Is_String_Same(input, "lt")) {
    ...
    } else if (cMiscUtil::Is_String_Same(input, "object_tally") || cMiscUtil::Is_String_Same(input, "ot")) {
    ...
    } else if (cMiscUtil::Is_String_Same(input, "AvgSizePacketsSentServer") ||
               cMiscUtil::Is_String_Same(input, "aspss")) {
      cDevOptions::AvgSizePacketsSentServer.Toggle();
    } else if (cMiscUtil::Is_String_Same(input, "AvgSizePacketsSentClient") ||
               cMiscUtil::Is_String_Same(input, "aspsc")) {
      cDevOptions::AvgSizePacketsSentClient.Toggle();
    } else if (cMiscUtil::Is_String_Same(input, "AvgSizePacketsRecdServer") ||
               cMiscUtil::Is_String_Same(input, "asprs")) {
      cDevOptions::AvgSizePacketsRecdServer.Toggle();
    } else if (cMiscUtil::Is_String_Same(input, "AvgSizePacketsRecdClient") ||
               cMiscUtil::Is_String_Same(input, "asprc")) {
    ...
    } else if (cMiscUtil::Is_String_Same(input, "WwnetAvgSizePacketsSentServer") ||
               cMiscUtil::Is_String_Same(input, "waspss")) {
      cDevOptions::WwnetAvgSizePacketsSentServer.Toggle();
    } else if (cMiscUtil::Is_String_Same(input, "WwnetAvgSizePacketsSentClient") ||
               cMiscUtil::Is_String_Same(input, "waspsc")) {
      cDevOptions::WwnetAvgSizePacketsSentClient.Toggle();
    } else if (cMiscUtil::Is_String_Same(input, "WwnetAvgSizePacketsRecdServer") ||
               cMiscUtil::Is_String_Same(input, "wasprs")) {
      cDevOptions::WwnetAvgSizePacketsRecdServer.Toggle();
    } else if (cMiscUtil::Is_String_Same(input, "WwnetAvgSizePacketsRecdClient") ||
               cMiscUtil::Is_String_Same(input, "wasprc")) {
    ...
    } else if (cMiscUtil::Is_String_Same(input, "priorities") || cMiscUtil::Is_String_Same(input, "pri")) {
      cDevOptions::ShowPriorities.Toggle();
    } else if (cMiscUtil::Is_String_Same(input, "server_rhost_data") || cMiscUtil::Is_String_Same(input, "srd")) {
      cDevOptions::ShowServerRhostData.Toggle();
    } else if (cMiscUtil::Is_String_Same(input, "soldier_data") || cMiscUtil::Is_String_Same(input, "sd")) {
      cDevOptions::ShowSoldierData.Toggle();
    } else if (cMiscUtil::Is_String_Same(input, "spawner_data") || cMiscUtil::Is_String_Same(input, "spawn")) {
      cDevOptions::ShowSpawnerData.Toggle();
    } else if (cMiscUtil::Is_String_Same(input, "vehicle_data") || cMiscUtil::Is_String_Same(input, "vd")) {
      cDevOptions::ShowVehicleData.Toggle();
    } else if (cMiscUtil::Is_String_Same(input, "door_data") || cMiscUtil::Is_String_Same(input, "dd")) {
      cDevOptions::ShowDoorData.Toggle();
    } else if (cMiscUtil::Is_String_Same(input, "elevator_data") || cMiscUtil::Is_String_Same(input, "ed")) {
      cDevOptions::ShowElevatorData.Toggle();
    } else if (cMiscUtil::Is_String_Same(input, "DSAPO_data") || cMiscUtil::Is_String_Same(input, "DSAPO_data")) {
      cDevOptions::ShowDSAPOData.Toggle();
    } else if (cMiscUtil::Is_String_Same(input, "building_data") || cMiscUtil::Is_String_Same(input, "bd")) {
      cDevOptions::ShowBuildingData.Toggle();
    } else if (cMiscUtil::Is_String_Same(input, "powerup_data") || cMiscUtil::Is_String_Same(input, "pd")) {
      cDevOptions::ShowPowerupData.Toggle();
    } else if (cMiscUtil::Is_String_Same(input, "wol_location") || cMiscUtil::Is_String_Same(input, "wl")) {
...
public:
  ...
  virtual const char *Get_Help(void) {
    return "SURFACE_EFFECTS_DEBUG - toggles display of surface effects debug info.";
  }
  virtual void Activate(const char *input) {
...
public:
  ...
  virtual const char *Get_Help(void) {
    return "SURFACE_TYPE_OVERRIDE <int> - all surfaces forced to be given type (-1 disables).";
  }
  virtual void Activate(const char *input) {
    int type = atoi(input);
...
public:
  ...
  virtual const char *Get_Help(void) {
    return "SURFACE_PHYSICS_OVERRIDE <friction> <drag> - force friction and drag for all surfaces (0.0 disables).";
  }
  virtual void Activate(const char *input) {
    float friction, drag;
...
public:
  ...
  virtual const char *Get_Help(void) {
    return "SET_STAR_SHIELD_STRENGTH <strength> - sets the strength of the star's shield.";
  }
  virtual void Activate(const char *input) {
    if (COMBAT_STAR) {
      DefenseObjectClass *defense = COMBAT_STAR->Get_Defense_Object();
...
public:
  ...
  virtual const char *Get_Help(void) {
    return "BUBYE <mindist> - kills everything but the star if they are at least mindist away.";
  }
  virtual void Activate(const char *input) {
...
public:
  ...
  virtual LPCSTR Get_Help(void) {
    return "KILL <object types> <percent=n> <id=xxxxx> - kills % of types "
           "(vehicles,soldiers,powerups,c4s,armeds,smarts,all). Server only";
  }
  virtual void Activate(LPCSTR input) {
    ...
    */
    ...
    if (strcmp(input, "")) {
      ...
      //
      char *p_id = (char *)::strstr(input, "id=");
      if (p_id != NULL) {
        int id = -1;
        ::sscanf(p_id, "id=%d", &id);
        if (cNetwork::I_Am_Client()) {
      ...
      char *p_pc = (char *)strstr(input, "percent=");
      int percent = 100;
      if (p_pc != NULL) {
      ...
      for (SLNode<BaseGameObj> *objnode = GameObjManager::Get_Game_Obj_List()->Head(); objnode != NULL;
        ...
        if ((strstr(input, "vehicles") && p_object->As_VehicleGameObj() != NULL) ||
            ...
            //					 (strstr(input, "commandos")	&& p_object->As_CommandoGameObj()
            //!= NULL) ||
            ...
            (strstr(input, "smarts") && p_object->As_SmartGameObj() != NULL) || (strstr(input, "all")) ||
            (strstr(input, "-9"))) {
...
public:
  ...
  virtual void Activate(const char *input) {
    ...
    for (int i = 0; i < 4; i++) {
      PhysicalGameObjDef *def =
          (PhysicalGameObjDef *)DefinitionMgrClass::Find_Typed_Definition("Commando", CLASSID_GAME_OBJECT_DEF_SOLDIER);
      WWASSERT(def);
...
public:
  ...
  virtual void Activate(const char *input) { Get_Console()->Profile_Command(input); }
};
...
public:
  ...
  virtual void Activate(const char *input) { WWProfileManager::Begin_Collecting(); }
};
...
public:
  ...
  virtual void Activate(const char *input) { WWProfileManager::End_Collecting("profile_log.txt"); }
};
...
public:
  ...
  virtual const char *Get_Help(void) {
    return "DEBUG_DEVICE [device|on|off] - toggles the debug device (screen, mono, dbwin32, log, windows)";
  }
  virtual void Activate(const char *input) {
    char str[128];
    sprintf(str, "ERROR (%s)\n", input);
...
public:
  ...
  virtual const char *Get_Help(void) {
    return "ADMIN_MESSAGE <message> - sends an admin message to all clients. Host only.";
  }
  virtual void Activate(const char *input) {
    WWASSERT(input != NULL);
...
public:
  ...
  virtual const char *Get_Help(void) {
    return "CLIENT_PHYSICS_OPTIMIZATION [0|1] - Update only visible physic objects on client.";
  }
  virtual void Activate(const char *input) {
    if (!cNetwork::I_Am_Server()) {
      int state = 0;
...
public:
  ...
  virtual const char *Get_Help(void) {
    return "STATS <off|fps|dx8|star|sr_history|sr|gerd|collision|culling|physics|vehicle|ai|wol|profile|memory> - "
           "changes stats display.";
  }
  virtual void Activate(const char *input) { StatisticsDisplayManager::Set_Display(input); }
};
...
public:
  ...
  virtual void Activate(const char *input) {
    ...
    if (sscanf(input, "%c", &sign) == 1 && (sign == '+' || sign == '-')) {
      ...
      WW3DErrorType error = WW3D::Set_Device_Resolution(resos[i].Width, resos[i].Height, resos[i].BitDepth, -1, true);
      if (error == WW3D_ERROR_OK) {
        ...
        error = WW3D::Set_Device_Resolution(w, h, bits, -1, true);
      }
    } else {
...
public:
  ...
  virtual void Activate(const char *input) { Toggle_Display_Findpaths(); }
};
...
public:
  ...
  virtual void Activate(const char *input) {
    ...
    if (p_me != NULL && p_recipient != NULL && amount >= cDonateEvent::Get_Minimum_Acceptable_Donation() &&
        (p_me->Get_Player_Type() == p_recipient->Get_Player_Type()) && p_me->Get_Money() >= amount) {
...
public:
  ...
  virtual const char *Get_Help(void) {
    return "QUIT_SLAVE slavename - Shutdown a slave server (dedicated master server only).";
  }
  virtual void Activate(const char *input) {
...
public:
  ...
  virtual const char *Get_Help(void) {
    return "NET_UPDATE_RATE - set the max. net update think rate (times per second).";
  }
  virtual void Activate(const char *input) {
    WWASSERT(input != NULL);
    int rate = ::atoi(input);
      ...
      if (The_Game() && The_Game()->IsDedicated.Is_True()) {
        ...
        if (active && The_Game()) {
          ...
          sprintf(buf, "     GDI : %d/%d players      %d points\n", cPlayerManager::Tally_Team_Size(PLAYERTYPE_GDI),
                  The_Game()->Get_Max_Players(), (int)cTeamManager::Find_Team(PLAYERTYPE_GDI)->Get_Score());
          ConsoleBox.Print(buf);

          sprintf(buf, "     NOD : %d/%d players      %d points\n", cPlayerManager::Tally_Team_Size(PLAYERTYPE_NOD),
                  The_Game()->Get_Max_Players(), (int)cTeamManager::Find_Team(PLAYERTYPE_NOD)->Get_Score());
          ConsoleBox.Print(buf);
  ...
  virtual void Activate(const char *) {
    ...
    if (cNetwork::I_Am_Server() && The_Game() && The_Game()->IsDedicated.Is_True() &&
      ...
      if (cNetwork::PServerConnection->Get_Num_RHosts() == 0) {
        ...
        for (int i = cNetwork::PServerConnection->Get_Min_RHost(); i <= cNetwork::PServerConnection->Get_Max_RHost();
             i++) {
          ...
          if (client) {
            ...
            if (playerptr) {
              ...
              sprintf(addr_string, "%d.%d.%d.%d;%d", (int)(addr->sin_addr.S_un.S_un_b.s_b1),
                      (int)(addr->sin_addr.S_un.S_un_b.s_b2), (int)(addr->sin_addr.S_un.S_un_b.s_b3),
                      (int)(addr->sin_addr.S_un.S_un_b.s_b4), unsigned int(ntohs(addr->sin_port)));
              ...
              sprintf(buffer, "%3d %s%- 6d %s\t%d\t%s%- 7d  %03d.%02d.%02d\n", i, temp_name,
                      (int)playerptr->Get_Score(), (playerptr->Get_Player_Type() == PLAYERTYPE_NOD) ? "NOD" : "GDI",
                      (int)client->Get_Average_Internal_Pingtime_Ms(), local_addr_string,
                      (int)(PacketManager.Get_Compressed_Bandwidth_Out(&client->Get_Address()) / 1024), hours, minutes,
                      seconds);
...
public:
  ...
  virtual const char *Get_Help(void) {
    return "BAN [<Nickname>|<Id>] - Permanently ban a user from this server(GameSpy & WOL mode only).";
  }
  virtual void Activate(const char *input) {
    ...
    if ((cGameSpyAdmin::Is_Gamespy_Game() || is_wol) && cNetwork::I_Am_Server()) {
      ...
      for (player_node = cPlayerManager::Get_Player_Object_List()->Head(); player_node != NULL;
           player_node = player_node->Next()) {
...
public:
  ...
  virtual const char *Get_Help(void) {
    return "ALLOW [<Nickname>|<Id>] - Remove user channel ban from this server (WOL mode only).";
  }
  virtual void Activate(const char *input) {
...
public:
  ...
  virtual const char *Get_Help(void) {
    return "RESTART - Quit to desktop and restart process (dedicated server only).";
  }
  virtual void Activate(const char *input) {
...
public:
  ...
  virtual void Activate(const char *input) { TheDX8MeshRenderer.Request_Log_Statistics(); }
};
...
public:
  ...
  virtual void Activate(const char *input) { WW3DAssetManager::Get_Instance()->Log_All_Textures(); }
};
...
public:
  ...
  virtual const char *Get_Help(void) {
    return ("TIME_OF_DAY <hours [0..23]> <minutes [0..59]> - sets the time of day for the background.");
  }
  virtual void Activate(const char *input) {
...
public:
  ...
  virtual void Activate(const char *input) { WW3D::Activate_Snapshot(true); }
};
...
public:
  ...
  virtual const char *Get_Help(void) {
    return "UNUSED_SPAWNERS - Displays the ID of spawns which have spawned nothing.";
  }
  virtual void Activate(const char *input) { SpawnManager::Display_Unused_Spawners(); }
};
...
public:
  ...
  virtual const char *Get_Help(void) {
    return "ALLOW_KILLING_HIBERNATING_SPAWN - Toggles the global ability for spawners to kill hibernating spawn.";
  }
  virtual void Activate(const char *input) {
...
public:
  ...
  virtual const char *Get_Help(void) {
    return "DISPLAY_HIBERNATING - Toggles displaying of objects begining and ending hibernation.";
  }
  virtual void Activate(const char *input) {
...
public:
  ...
  virtual const char *Get_Help(void) {
    return ("LIGHTNING <intensity [0..1]> [<start [0..1]> <end [0..1]> <heading [0..360]> <distribution [0..1]>] "
            "[ramptime [0+]] - Sets lightning.");
  }
  virtual void Activate(const char *input) {
...
public:
  ...
  virtual const char *Get_Help(void) {
    return ("WARBLITZ <intensity [0..1]> [<start [0..1]> <end [0..1]> <heading [0..360]> <distribution [0..1]>] "
            "[ramptime [0+]] - Sets war blitz.");
  }
  virtual void Activate(const char *input) {
...
public:
  ...
  virtual const char *Get_Help(void) {
    return ("WARP <player name> - warp to first other player or named player (client only).");
  }
  virtual void Activate(const char *input) {
    if (cNetwork::I_Am_Client()) {
...
public:
  ...
  virtual const char *Get_Help(void) {
    return ("WHOIS <player name> - who the heck is this annoying bugger? (server only)\n");
  }
  virtual void Activate(const char *input) {
    cPlayer *p_player = cPlayerManager::Find_Player(input);
...
public:
  ...
  virtual const char *Get_Help(void) {
    return ("WIND <heading [0..360]> <speed [0+]> <variability [0..1]> [ramptime [0+]] - Sets wind.");
  }
  virtual void Activate(const char *input) {
...
public:
  ...
  virtual void Activate(const char *input) { cAppPacketStats::Reset(); }
};
...
void ConsoleFunctionManager::Sort_Function_List(void) {
  ...
  while (!done) {
    ...
    for (int index = 0; index < count; index++) {
      if (stricmp(FunctionList[index]->Get_Name(), FunctionList[index + 1]->Get_Name()) > 0) {
...
//------------------------------------------------------------------------------------
int ConsoleFunctionManager::Get_Function_Count(void) { return FunctionList.Count(); }
...
void ConsoleFunctionManager::Next_Verbose_Help_Screen(void) {
  ...
  if (page_number >= 0) {
    ...
    for (int index = 0; index < FunctionList.Count(); index++) {
      command_number++;
      int per_page = 57;
      if (floor((float)(command_number / per_page)) == page_number) {
        ConsoleFunctionClass *function = FunctionList[index];
        WWASSERT(function != NULL);
...
void ConsoleFunctionManager::Parse_Input(const char *string) {
  if (!strnicmp(string, "help", 4)) {
    ...
    for (int index = 0; index < FunctionList.Count(); index++) {
      ...
      // it to match
      //
      if (function->Get_Alias() != NULL && strlen(function->Get_Alias()) > 0) {
        char alias[100];
        WWASSERT(strlen(function->Get_Alias()) < sizeof(alias));
        strcpy(alias, function->Get_Alias());
        int alias_len = strlen(alias);
        int string_len = strlen(string);
        if (!strnicmp(string, alias, alias_len) && (string_len == alias_len || string[alias_len] == ' ')) {
          string += alias_len;
          while (string && *string == ' ')
            string++;
...
ConsoleFunctionClass *ConsoleFunctionManager::Find_Command_Suggestion(const char *input, // incomplete function name
