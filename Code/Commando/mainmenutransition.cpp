...
MainMenuTransitionClass::MainMenuTransitionClass(void)
    : Model(NULL), Dialog(NULL), OtherDlg(NULL), Camera(NULL), CurrentFrame(0), TargetFrame(0), TransitionAnim(NULL) {
  return;
}
...
//
////////////////////////////////////////////////////////////////
void MainMenuTransitionClass::Set_Dialogs(DialogBaseClass *dialog, DialogBaseClass *other_dlg) {
  Dialog = dialog;
  OtherDlg = other_dlg;
  return;
}
...
//
////////////////////////////////////////////////////////////////
void MainMenuTransitionClass::Set_Model(RenderObjClass *model) {
...
//
////////////////////////////////////////////////////////////////
void MainMenuTransitionClass::Set_Type(TYPE type) {
...
//
////////////////////////////////////////////////////////////////
void MainMenuTransitionClass::Update_Controls(void) {
  const int ENTRIES = 6;

  const int ControlIDArray[ENTRIES] = {IDC_MENU_START_SP_GAME_BUTTON,
...
//
////////////////////////////////////////////////////////////////
bool MainMenuTransitionClass::Is_Valid(void) const {
  bool retval = false;
