...
void cDevOptions::Init() {
  ...
  WwnetAvgSizePacketsSentServer =
      cRegistryBool(APPLICATION_SUB_KEY_NAME_NETDEBUG, "WwnetAvgSizePacketsSentServer", false);
  WwnetAvgSizePacketsSentClient =
      cRegistryBool(APPLICATION_SUB_KEY_NAME_NETDEBUG, "WwnetAvgSizePacketsSentClient", false);
  WwnetAvgSizePacketsRecdServer =
      cRegistryBool(APPLICATION_SUB_KEY_NAME_NETDEBUG, "WwnetAvgSizePacketsRecdServer", false);
  WwnetAvgSizePacketsRecdClient =
      cRegistryBool(APPLICATION_SUB_KEY_NAME_NETDEBUG, "WwnetAvgSizePacketsRecdClient", false);
