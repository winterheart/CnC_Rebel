...
//	Local constants
////////////////////////////////////////////////////////////////
static enum { MBEVENT_DELETE_PROMPT = 1, MBEVENT_SAVE_PROMPT };
...
//
////////////////////////////////////////////////////////////////
ControlSaveLoadMenuClass::ControlSaveLoadMenuClass(void) : MenuDialogClass(IDD_MENU_CONTROL_SAVELOAD) { return; }
...
//
////////////////////////////////////////////////////////////////
void ControlSaveLoadMenuClass::On_Command(int ctrl_id, int message_id, DWORD param) {
  switch (ctrl_id) {
  ...
  if (curr_sel != -1) {
    ...
    if (config != NULL) {
      ...
      if (config->Is_Custom()) {
        ...
        message.Format(TRANSLATE(IDS_MENU_DELETE_SAVE_MSG), list_ctrl->Get_Entry_Text(curr_sel, 0));
...
//
////////////////////////////////////////////////////////////////
void ControlSaveLoadMenuClass::HandleNotification(DlgMsgBoxEvent &event) {
...
//
////////////////////////////////////////////////////////////////
void ControlSaveLoadMenuClass::On_ListCtrl_Delete_Entry(ListCtrlClass *list_ctrl, int ctrl_id, int item_index) {
  //
...
//
////////////////////////////////////////////////////////////////
void ControlSaveLoadMenuClass::On_ListCtrl_Sel_Change(ListCtrlClass *list_ctrl, int ctrl_id, int old_index,
                                                      int new_index) {
...
//
////////////////////////////////////////////////////////////////
int CALLBACK ControlSaveLoadMenuClass::ListSortCallback(ListCtrlClass *list_ctrl, int item_index1, int item_index2,
                                                        uint32 user_param) {
  int retval = 0;
...
//
////////////////////////////////////////////////////////////////
void ControlSaveLoadMenuClass::On_EditCtrl_Enter_Pressed(EditCtrlClass *edit_ctrl, int ctrl_id) {
