...
CNCPurchaseMainMenuClass::CNCPurchaseMainMenuClass(void)
    : Team(PurchaseSettingsDefClass::TEAM_GDI), ChatModule(NULL), RefreshTimer(0), MessageLogLength(0),
...
//
////////////////////////////////////////////////////////////////
void CNCPurchaseMainMenuClass::On_Init_Dialog(void) {
...
//
////////////////////////////////////////////////////////////////
void CNCPurchaseMainMenuClass::On_Destroy(void) {
...
//
////////////////////////////////////////////////////////////////
void CNCPurchaseMainMenuClass::Configure_Purchase_Controls(void) {
  const int CTRL_IDS[4] = {IDC_ENLISTED_PURCHASE_01, IDC_ENLISTED_PURCHASE_02, IDC_ENLISTED_PURCHASE_03,
...
//
////////////////////////////////////////////////////////////////
void CNCPurchaseMainMenuClass::Render(void) {
...
//
////////////////////////////////////////////////////////////////
void CNCPurchaseMainMenuClass::On_Command(int ctrl_id, int message_id, DWORD param) {
...
//
////////////////////////////////////////////////////////////////
void CNCPurchaseMainMenuClass::Do_Purchase_Screen(PurchaseSettingsDefClass::TYPE type) {
  //
  ...
  if (definition != NULL) {
    ...
    //
    if (type == PurchaseSettingsDefClass::TYPE_CLASSES || type == PurchaseSettingsDefClass::TYPE_VEHICLES) {
...
//
////////////////////////////////////////////////////////////////
void CNCPurchaseMainMenuClass::Clear_Selections(void) {
  const int CTRL_IDS[] = {IDC_ENLISTED_PURCHASE_01, IDC_ENLISTED_PURCHASE_02, IDC_ENLISTED_PURCHASE_03,
                          IDC_ENLISTED_PURCHASE_04, IDC_SUPPLY_PURCHASE,      IDC_BEACON_PURCHASE};
...
//
////////////////////////////////////////////////////////////////
void CNCPurchaseMainMenuClass::Purchase(void) {
  const int CTRL_IDS[] = {IDC_ENLISTED_PURCHASE_01, IDC_ENLISTED_PURCHASE_02, IDC_ENLISTED_PURCHASE_03,
                          IDC_ENLISTED_PURCHASE_04, IDC_SUPPLY_PURCHASE,      IDC_BEACON_PURCHASE};
...
//
////////////////////////////////////////////////////////////////
void CNCPurchaseMainMenuClass::On_Merchandise_Selected(MerchandiseCtrlClass *ctrl, int ctrl_id) {
  const int CTRL_IDS[] = {IDC_ENLISTED_PURCHASE_01, IDC_ENLISTED_PURCHASE_02, IDC_ENLISTED_PURCHASE_03,
                          IDC_ENLISTED_PURCHASE_04};
...
//
////////////////////////////////////////////////////////////////
void CNCPurchaseMainMenuClass::On_Merchandise_DblClk(MerchandiseCtrlClass *ctrl, int ctrl_id) {
...
//
////////////////////////////////////////////////////////////////
void CNCPurchaseMainMenuClass::Purchase_Item(int ctrl_id) {
  const int CTRL_IDS[] = {IDC_ENLISTED_PURCHASE_01, IDC_ENLISTED_PURCHASE_02, IDC_ENLISTED_PURCHASE_03,
                          IDC_ENLISTED_PURCHASE_04, IDC_SUPPLY_PURCHASE,      IDC_BEACON_PURCHASE};
  ...
  if (funds >= cost) {
    ...
    if (weapon_bag != NULL) {
      ...
      PowerUpGameObjDef *powerup_def =
          (PowerUpGameObjDef *)DefinitionMgrClass::Find_Definition(definition->Get_Beacon_Definition());
      if (powerup_def != NULL) {
...
//
////////////////////////////////////////////////////////////////
void CNCPurchaseMainMenuClass::Refresh_Button_States(void) {
  ButtonCtrlClass *chars_button = (ButtonCtrlClass *)Get_Dlg_Item(IDC_CHARACTERS_BUTTON);
  ButtonCtrlClass *vehicles_button = (ButtonCtrlClass *)Get_Dlg_Item(IDC_VEHICLES_BUTTON);
  ...
  Get_Dlg_Item(IDC_HOTKEY_TEXT_06)
      ->Set_Text_Color(enable_chars ? Vector3(1.0F, 1.0F, 1.0F) : Vector3(0.5F, 0.5F, 0.5F));
  Get_Dlg_Item(IDC_HOTKEY_TEXT_07)
      ->Set_Text_Color(enable_vehicles ? Vector3(1.0F, 1.0F, 1.0F) : Vector3(0.5F, 0.5F, 0.5F));
  return;
}
...
//
////////////////////////////////////////////////////////////////
bool CNCPurchaseMainMenuClass::On_Key_Down(uint32 key_id, uint32 key_data) {
  bool retval = false;
...
//
////////////////////////////////////////////////////////////////
void CNCPurchaseMainMenuClass::Refresh_Message_Log(void) {
  ListCtrlClass *list_ctrl = (ListCtrlClass *)Get_Dlg_Item(IDC_LIST_CTRL);
