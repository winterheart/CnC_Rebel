...
//-----------------------------------------------------------------------------
void cMoneyEvent::Init(int amount) {
...
//-----------------------------------------------------------------------------
void cMoneyEvent::Export_Creation(BitStreamClass &packet) {
  WWASSERT(cNetwork::I_Am_Client());
...
//-----------------------------------------------------------------------------
void cMoneyEvent::Import_Creation(BitStreamClass &packet) {
