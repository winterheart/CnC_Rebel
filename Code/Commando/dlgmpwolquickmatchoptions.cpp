...
//
////////////////////////////////////////////////////////////////
void MPWolQuickMatchOptionsMenuClass::On_Init_Dialog(void) {
...
//
////////////////////////////////////////////////////////////////
void MPWolQuickMatchOptionsMenuClass::On_Command(int ctrl_id, int message_id, DWORD param) {
  if (ctrl_id == IDOK) {
    if (Save_Settings()) {
      End_Dialog();
    }
...
//
////////////////////////////////////////////////////////////////
void MPWolQuickMatchOptionsMenuClass::On_SliderCtrl_Pos_Changed(SliderCtrlClass *slider_ctrl, int ctrl_id,
                                                                int new_pos) {
...
//
////////////////////////////////////////////////////////////////
void MPWolQuickMatchOptionsMenuClass::Update_Slider_Text(int ctrl_id) {
