...
enum { COL_DATE = 0, COL_TIME, COL_NAME };
...
//
////////////////////////////////////////////////////////////////
void LoadSPGameMenuClass::On_Init_Dialog(void) {
  //
...
//
////////////////////////////////////////////////////////////////
int LoadSPGameMenuClass::Build_List(const char *search_string, int start_index) {
  ListCtrlClass *list_ctrl = (ListCtrlClass *)Get_Dlg_Item(IDC_LOAD_GAME_LIST_CTRL);
  ...
  for (file_find = ::FindFirstFile(search_string, &find_info); (file_find != INVALID_HANDLE_VALUE) && keep_going;
    ...
    if (Is_Game_Allowed(find_info.cFileName)) {
      ...
      if (rank) {
        ...
        switch (mission) {
        case 0:
          description = TRANSLATE(IDS_LoadScreen_Tutorial_Item_00_Title);
          break;
        case 1:
          description = TRANSLATE(IDS_Enc_Miss_Title_M01_01);
          break;
        case 2:
          description = TRANSLATE(IDS_Enc_Miss_Title_M02_01);
          break;
        case 3:
          description = TRANSLATE(IDS_Enc_Miss_Title_M03_01);
          break;
        case 4:
          description = TRANSLATE(IDS_Enc_Miss_Title_M04_01);
          break;
        case 5:
          description = TRANSLATE(IDS_Enc_Miss_Title_M05_01);
          break;
        case 6:
          description = TRANSLATE(IDS_Enc_Miss_Title_M06_01);
          break;
        case 7:
          description = TRANSLATE(IDS_Enc_Miss_Title_M07_01);
          break;
        case 8:
          description = TRANSLATE(IDS_Enc_Miss_Title_M08_01);
          break;
        case 9:
          description = TRANSLATE(IDS_Enc_Miss_Title_M09_01);
          break;
        case 10:
          description = TRANSLATE(IDS_Enc_Miss_Title_M10_01);
          break;
        case 11:
          description = TRANSLATE(IDS_Enc_Miss_Title_M11_01);
          break;
        case 13:
          description = TRANSLATE(IDS_LoadScreen_MX0_Title);
          break;
        }
      }
...
//
////////////////////////////////////////////////////////////////
bool LoadSPGameMenuClass::Is_Game_Allowed(const char *filename) {
  ...
  if ((::strlen(filename) != 7) || (::stricmp(filename + (::strlen(filename) - 4), ".MIX") != 0) ||
      (::toupper(*filename) != 'M')) {
    return true;
  }
...
//
////////////////////////////////////////////////////////////////
int LoadSPGameMenuClass::Get_Game_Rank(const char *filename) {
...
//
////////////////////////////////////////////////////////////////
void LoadSPGameMenuClass::Set_Game_Rank(const char *filename, int rank) {
  // Strip extention
  StringClass name = filename;
  if (name.Get_Length() > 4) {
    name.Erase(name.Get_Length() - 4, 4);
...
//
////////////////////////////////////////////////////////////////
void LoadSPGameMenuClass::On_ListCtrl_Column_Click(ListCtrlClass *list_ctrl, int ctrl_id, int col_index) {
...
//
////////////////////////////////////////////////////////////////
void LoadSPGameMenuClass::On_ListCtrl_Delete_Entry(ListCtrlClass *list_ctrl, int ctrl_id, int item_index) {
  if (ctrl_id == IDC_LOAD_GAME_LIST_CTRL) {
...
//
////////////////////////////////////////////////////////////////
int CALLBACK LoadSPGameMenuClass::LoadListSortCallback(ListCtrlClass *list_ctrl, int item_index1, int item_index2,
                                                       uint32 user_param) {
  int retval = 0;
...
//
////////////////////////////////////////////////////////////////
void LoadSPGameMenuClass::On_Command(int ctrl_id, int message_id, DWORD param) {
  switch (ctrl_id) {
...
//
////////////////////////////////////////////////////////////////
void LoadSPGameMenuClass::On_ListCtrl_Sel_Change(ListCtrlClass *list_ctrl, int ctrl_id, int old_index, int new_index) {
  Update_Button_State();
  return;
}
...
//
////////////////////////////////////////////////////////////////
void LoadSPGameMenuClass::Update_Button_State(void) {
  bool enable = false;
...
//
////////////////////////////////////////////////////////////////
void LoadSPGameMenuClass::On_ListCtrl_DblClk(ListCtrlClass *list_ctrl, int ctrl_id, int item_index) {
  Load_Game();
  return;
}
...
//
////////////////////////////////////////////////////////////////
void LoadSPGameMenuClass::Delete_Game(bool prompt) {
  //
  //	Get a pointer to the list control
  //
  ListCtrlClass *list_ctrl = (ListCtrlClass *)Get_Dlg_Item(IDC_LOAD_GAME_LIST_CTRL);
    ...
    if (list_ctrl->Get_Entry_Data(item_index, 0) != NULL) {
      ...
      if (len >= 4 && ::lstrcmpi((filename.Peek_Buffer() + (len - 4)), ".mix") != 0) {
        ...
        if (prompt) {
          ...
          message.Format(TRANSLATE(IDS_MENU_DELETE_SAVE_MSG), list_ctrl->Get_Entry_Text(item_index, COL_NAME));

          //
          //	Display a message to the user asking if they really want to do this...
          //
          DlgMsgBox::DoDialog(TRANSLATE(IDS_MENU_DELETE_SAVE_TITLE), message, DlgMsgBox::YesNo, this,
...
//
////////////////////////////////////////////////////////////////
void LoadSPGameMenuClass::HandleNotification(DlgMsgBoxEvent &event) {
...
//
////////////////////////////////////////////////////////////////
void LoadSPGameMenuClass::Display(void) {
#ifndef MULTIPLAYERDEMO
...
//
////////////////////////////////////////////////////////////////
void LoadSPGameMenuClass::On_Last_Menu_Ending(void) {
