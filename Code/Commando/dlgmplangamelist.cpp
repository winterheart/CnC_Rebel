...
//	Local constants
////////////////////////////////////////////////////////////////
enum { COL_ICON = 0, COL_HOST_NAME, COL_GAME_NAME, COL_GAME_MAP, COL_PLAYERS, COL_MAX };
...
//
////////////////////////////////////////////////////////////////
MPLanGameListMenuClass::MPLanGameListMenuClass(void) : UpdateTimer(0), MenuDialogClass(IDD_MP_LAN_GAME_LIST) {
...
//
////////////////////////////////////////////////////////////////
void MPLanGameListMenuClass::On_Destroy(void) {
  //
...
//
////////////////////////////////////////////////////////////////
void MPLanGameListMenuClass::On_Command(int ctrl_id, int message_id, DWORD param) {
  switch (ctrl_id) {
...
//
////////////////////////////////////////////////////////////////
void MPLanGameListMenuClass::On_Frame_Update(void) {
  //
...
//
////////////////////////////////////////////////////////////////
void MPLanGameListMenuClass::Update_Game_List(void) {
  ListCtrlClass *list_ctrl = (ListCtrlClass *)Get_Dlg_Item(IDC_GAME_LIST_CTRL);
  if (list_ctrl == NULL) {
    return;
  }
...
//
////////////////////////////////////////////////////////////////
void MPLanGameListMenuClass::Join_Game(void) {
  ListCtrlClass *list_ctrl = (ListCtrlClass *)Get_Dlg_Item(IDC_GAME_LIST_CTRL);
...
//
////////////////////////////////////////////////////////////////
void MPLanGameListMenuClass::Connect_To_Server(void) {
  //
  //	Set the new nickname
  //
  WideStringClass nickname = Get_Dlg_Item_Text(IDC_NICKNAME_EDIT);
...
//
////////////////////////////////////////////////////////////////
void MPLanGameListMenuClass::On_ListCtrl_Delete_Entry(ListCtrlClass *list_ctrl, int ctrl_id, int item_index) {
  //
  //	Get the channel data from this entry
  //
...
//
////////////////////////////////////////////////////////////////
void MPLanGameListMenuClass::On_ListCtrl_DblClk(ListCtrlClass *list_ctrl, int ctrl_id, int item_index) {
  Join_Game();
  return;
}
...
//
////////////////////////////////////////////////////////////////
void MPLanGameListMenuClass::Display(void) {
  //
...
//
////////////////////////////////////////////////////////////////
void MPLanGameListMenuClass::On_Last_Menu_Ending(void) {
