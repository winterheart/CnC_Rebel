...
//
////////////////////////////////////////////////////////////////
HelpScreenDialogClass::HelpScreenDialogClass(void) : MenuDialogClass(IDD_HELP_SCREEN) { return; }
...
//
////////////////////////////////////////////////////////////////
HelpScreenDialogClass::~HelpScreenDialogClass(void) { return; }
...
//
////////////////////////////////////////////////////////////////
void HelpScreenDialogClass::On_Init_Dialog(void) {
...
//
////////////////////////////////////////////////////////////////
void HelpScreenDialogClass::On_Command(int ctrl_id, int message_id, DWORD param) {
  switch (ctrl_id) {
  case IDOK:
  case IDCANCEL:
...
//
////////////////////////////////////////////////////////////////
void HelpScreenDialogClass::Display(void) {
...
//
////////////////////////////////////////////////////////////////
void HelpScreenDialogClass::On_Menu_Activate(bool onoff) {
  if (onoff) {
...
//
////////////////////////////////////////////////////////////////
void HelpScreenDialogClass::On_Destroy(void) {
  //
  //	Restore the old backdrop
  //
  if (OldBackdrop != NULL) {
...
//
////////////////////////////////////////////////////////////////
bool HelpScreenDialogClass::On_Key_Down(uint32 key_id, uint32 key_data) {
  bool retval = false;
