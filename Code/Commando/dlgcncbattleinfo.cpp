...
//	Local constants
////////////////////////////////////////////////////////////////
enum { COL_RANK, COL_NAME, COL_KD, COL_SCORE };
...
static const BUILDING_INFO GDI_BUILDING_CTRLS[BUILDING_SLOT_COUNT] = {
    {IDC_GDI_BUILDING01_ICON, IDC_GDI_BUILDING01_HEALTHBAR}, {IDC_GDI_BUILDING02_ICON, IDC_GDI_BUILDING02_HEALTHBAR},
    {IDC_GDI_BUILDING03_ICON, IDC_GDI_BUILDING03_HEALTHBAR}, {IDC_GDI_BUILDING04_ICON, IDC_GDI_BUILDING04_HEALTHBAR},
    {IDC_GDI_BUILDING05_ICON, IDC_GDI_BUILDING05_HEALTHBAR}, {IDC_GDI_BUILDING06_ICON, IDC_GDI_BUILDING06_HEALTHBAR},
};

static const BUILDING_INFO NOD_BUILDING_CTRLS[BUILDING_SLOT_COUNT] = {
    {IDC_NOD_BUILDING01_ICON, IDC_NOD_BUILDING01_HEALTHBAR}, {IDC_NOD_BUILDING02_ICON, IDC_NOD_BUILDING02_HEALTHBAR},
    {IDC_NOD_BUILDING03_ICON, IDC_NOD_BUILDING03_HEALTHBAR}, {IDC_NOD_BUILDING04_ICON, IDC_NOD_BUILDING04_HEALTHBAR},
    {IDC_NOD_BUILDING05_ICON, IDC_NOD_BUILDING05_HEALTHBAR}, {IDC_NOD_BUILDING06_ICON, IDC_NOD_BUILDING06_HEALTHBAR},
};
...
//
////////////////////////////////////////////////////////////////
CNCBattleInfoDialogClass::CNCBattleInfoDialogClass(void) : MenuDialogClass(IDD_CNC_BATTLE_INFO) { return; }
...
void CNCBattleInfoDialogClass::Configure_Icons(void) {
  ...
  for (int index = 0; index < BUILDING_COUNT; index++) {
    ...
    if (building != NULL) {
      ...
      HealthBarCtrlClass *health_ctrl =
          (HealthBarCtrlClass *)Get_Dlg_Item(GDI_BUILDING_CTRLS[next_slot].health_ctrl_id);
  ...
  if (gdi_harvester != NULL) {
    float life =
        gdi_harvester->Get_Defense_Object()->Get_Health() / gdi_harvester->Get_Defense_Object()->Get_Health_Max();
    ((ImageCtrlClass *)Get_Dlg_Item(GDI_BUILDING_CTRLS[next_slot].icon_ctrl_id))
        ->Set_Texture("HUD_C&C_G_HARVISTER.TGA");
  ...
  for (int index = 0; index < BUILDING_COUNT; index++) {
    ...
    if (building != NULL) {
      ...
      ((ImageCtrlClass *)Get_Dlg_Item(NOD_BUILDING_CTRLS[next_slot].icon_ctrl_id))
          ->Set_Texture(NOD_BUILDINGS[index].texture_name);
  ...
  if (nod_harvester != NULL) {
    float life =
        nod_harvester->Get_Defense_Object()->Get_Health() / nod_harvester->Get_Defense_Object()->Get_Health_Max();
    ((ImageCtrlClass *)Get_Dlg_Item(NOD_BUILDING_CTRLS[next_slot].icon_ctrl_id))
        ->Set_Texture("HUD_C&C_N_HARVISTER.TGA");
    ((HealthBarCtrlClass *)Get_Dlg_Item(NOD_BUILDING_CTRLS[next_slot].health_ctrl_id))->Set_Life(life);
    next_slot++;
  }
...
//
////////////////////////////////////////////////////////////////
void CNCBattleInfoDialogClass::Populate_Player_List(ListCtrlClass *list_ctrl, int team_id) {
  //
...
//
////////////////////////////////////////////////////////////////
int CALLBACK CNCBattleInfoDialogClass::ListSortCallback(ListCtrlClass *list_ctrl, int item_index1, int item_index2,
                                                        uint32 user_param) {
