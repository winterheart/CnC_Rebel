...
//	Local constants
////////////////////////////////////////////////////////////////
enum { COL_PRIORITY = 0, COL_TEXT, COL_STATUS };
...
//
////////////////////////////////////////////////////////////////
EvaObjectivesTabClass::EvaObjectivesTabClass(void) : ChildDialogClass(IDD_ENCYCLOPEDIA_OBJECTIVES_TAB) { return; }
...
//
////////////////////////////////////////////////////////////////
void EvaObjectivesTabClass::On_Init_Dialog(void) {
  //
...
//
////////////////////////////////////////////////////////////////
void EvaObjectivesTabClass::On_Command(int ctrl_id, int message_id, DWORD param) {
...
//
////////////////////////////////////////////////////////////////
void EvaObjectivesTabClass::On_ListCtrl_Sel_Change(ListCtrlClass *list_ctrl, int ctrl_id, int old_index,
                                                   int new_index) {
...
//
////////////////////////////////////////////////////////////////
void EvaObjectivesTabClass::Update_Curr_Objective_Controls(void) {
  //
...
//
////////////////////////////////////////////////////////////////
void EvaObjectivesTabClass::Fill_Objectives_List(void) {
  //
  //	Get a pointer to the list control
  //
  ListCtrlClass *list_ctrl = (ListCtrlClass *)Get_Dlg_Item(IDC_OBJECTIVES_LIST_CTRL);
  ...
  for (int index = 0; index < count; index++) {
    ...
    if (objective != NULL) {
      ...
      //
      if (objective->Status != ObjectiveManager::STATUS_HIDDEN || ObjectiveManager::Is_Objective_Debug_Mode_Enabled()) {
        //
...
//
////////////////////////////////////////////////////////////////
int CALLBACK EvaObjectivesTabClass::ListSortCallback(ListCtrlClass *list_ctrl, int item_index1, int item_index2,
                                                     uint32 user_param) {
