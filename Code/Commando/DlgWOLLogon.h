...
class DlgWOLLogonEvent : public TypedEvent<DlgWOLLogonEvent, DlgWOLLogon> {
public:
  ...
  DlgWOLLogonEvent(Event event, DlgWOLLogon &dialog)
      : TypedEvent<DlgWOLLogonEvent, DlgWOLLogon>(dialog), mEvent(event) {}
...
class DlgWOLLogon : public PopupDialogClass, public Notifier<DlgWOLLogonEvent> {
public:
