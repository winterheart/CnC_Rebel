...
class RefPtrBase {
public:
  inline bool operator==(const RefPtrBase &rhs) const { return (mRefObject == rhs.mRefObject); }
...
protected:
  RefPtrBase() : mRefObject(NULL) {}

  RefPtrBase(RefCounted *object) : mRefObject(object) {
  ...
  RefPtrBase(const RefPtrBase &object) : mRefObject(object.mRefObject) {
  ...
  virtual ~RefPtrBase() { Release(); }

  const RefPtrBase &operator=(const RefPtrBase &);

  inline RefCounted *const GetRefObject(void) { return mRefObject; }

  inline const RefCounted *const GetRefObject(void) const { return mRefObject; }
...
private:
  ...
  template <typename Derived> friend RefPtr<Derived> Dynamic_Cast(RefPtrBase &);

  template <typename Type> friend RefPtr<Type> Reinterpret_Cast(RefPtrBase &);
};

template <typename Type> class RefPtr : public RefPtrBase {
public:
  RefPtr() : RefPtrBase() {}

  template <typename Derived> RefPtr(const RefPtr<Derived> &derived) : RefPtrBase() {
    Attach(static_cast<RefCounted *>(const_cast<Derived *>(derived.ReferencedObject())));
  }

  RefPtr(const RefPtr<Type> &object) : RefPtrBase() {
    Attach(static_cast<RefCounted *>(const_cast<Type *>(object.ReferencedObject())));
  }

  virtual ~RefPtr() {}

  template <typename Derived> inline const RefPtr<Type> &operator=(const RefPtr<Derived> &derived) {
    Attach(static_cast<RefCounted *>(const_cast<Derived *>(derived.ReferencedObject())));
    return *this;
  }
  ...
  template <typename NewType> inline operator RefPtr<NewType>() {
  ...
  inline Type *const ReferencedObject(void) { return reinterpret_cast<Type *>(GetRefObject()); }

  inline const Type *const ReferencedObject(void) const { return reinterpret_cast<const Type *>(GetRefObject()); }

  RefPtr(Type *object) : RefPtrBase() { Attach(static_cast<RefCounted *>(object)); }
...
template <typename Type> class RefPtrConst : public RefPtrBase {
public:
  RefPtrConst() : RefPtrConst() {}

  template <typename Derived> RefPtrConst(const RefPtr<Derived> &derived) : RefPtrBase() {
    Attach(static_cast<RefCounted *>(derived.ReferencedObject()));
  }

  RefPtrConst(const RefPtr<Type> &object) : RefPtrBase() {
    Attach(static_cast<RefCounted *>(const_cast<Type *const>(object.ReferencedObject())));
  }

  template <typename Derived> RefPtrConst(const RefPtrConst<Derived> &derived) : RefPtrBase() {
    Attach(static_cast<RefCounted *>(derived.ReferencedObject()));
  }

  RefPtrConst(const RefPtrConst<Type> &object) : RefPtrBase() {
    Attach(static_cast<RefCounted *>(object.ReferencedObject()));
  }

  template <typename Derived> inline const RefPtrConst<Type> &operator=(const RefPtr<Derived> &derived) {
    Attach(static_cast<RefCounted *>(derived.ReferencedObject()));
    return *this;
  }
  ...
  template <typename Derived> inline const RefPtrConst<Type> &operator=(const RefPtrConst<Derived> &derived) {
    Attach(static_cast<RefCounted *>(derived.ReferencedObject()));
    return *this;
  }
  ...
  inline const Type *const ReferencedObject() const { return reinterpret_cast<const Type *>(GetRefObject()); }

  RefPtrConst(const Type *object) : RefPtrBase() { Attach(static_cast<RefCounted *>(object)); }

  const RefPtrConst<Type> &operator=(const Type *object) { Attach(static_cast<RefCounted *>(object)); }
};

template <typename Derived> RefPtr<Derived> Dynamic_Cast(RefPtrBase &base) {
  RefPtr<Derived> derived;
  derived.Attach(base.GetRefObject());
  return derived;
}

template <typename Type> RefPtr<Type> Reinterpret_Cast(RefPtrBase &rhs) {
  RefPtr<Type> object;
  object.Attach(rhs.GetRefObject());
  return object;
}

template <typename Type> RefPtr<Type> Const_Cast(RefPtrConst<Type> &rhs) {
  RefPtr<Type> object;
