...
//
//////////////////////////////////////////////////////////////////////
TextMarqueeCtrlClass::TextMarqueeCtrlClass(void) : ScrollPos(0), PixelHeight(0), ScrollRate(2.0F) {
  //
...
//
//////////////////////////////////////////////////////////////////////
TextMarqueeCtrlClass::~TextMarqueeCtrlClass(void) { return; }
...
//
//////////////////////////////////////////////////////////////////////
void TextMarqueeCtrlClass::Create_Control_Renderer(void) {
...
//
//////////////////////////////////////////////////////////////////////
void TextMarqueeCtrlClass::Create_Text_Renderer(void) {
  ...
  //
  for (int index = curr_row; (index < CreditLines.Count()) && (text_rect.Top < ClientRect.Bottom); index++) {
    ...
    //
    StyleMgrClass::Render_Text(line.Text, renderer, color, shadow_color, text_rect, true, false,
                               StyleMgrClass::CENTER_JUSTIFY, false);
...
//
////////////////////////////////////////////////////////////////
void TextMarqueeCtrlClass::Build_Credit_Lines(void) {
...
#define COPY_LINE(dest, src_start, src_end)                                                                            \
  ...
  while (text != NULL) {
    ...
    while (line_start != NULL) {
      ...
      //
      WideStringClass txt;
      COPY_LINE(txt, line_start, line_end);
...
//
////////////////////////////////////////////////////////////////
int TextMarqueeCtrlClass::Read_Tag(const WCHAR *text, CREDIT_LINE &line) {
  int retval = -1;
...
//
////////////////////////////////////////////////////////////////
const WCHAR *TextMarqueeCtrlClass::Read_Line(const WCHAR *text, CREDIT_LINE &line) {
