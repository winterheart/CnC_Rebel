...
typedef int(CALLBACK *TREECTRL_SORT_CALLBACK)(TreeCtrlClass *tree_ctrl, TreeItemClass *item1, TreeItemClass *item2,
                                              uint32 user_param);
...
public:
  ...
  //	Content control
  //
  TreeItemClass *Insert_Item(const WCHAR *name, const char *icon_name, const char *selected_icon_name,
...
protected:
  ...
  static int CALLBACK Alphabetic_Sort_Callback(TreeCtrlClass *tree_ctrl, TreeItemClass *item1, TreeItemClass *item2,
                                               uint32 user_param);
...
public:
  ...
  TreeItemClass(TreeCtrlClass *ctrl)
      : TreeCtrl(ctrl), Parent(NULL), UserData(0), IsExpanded(false), NeedsChildren(false) {}
  ...
  //	Child access
  //
  void Add_Child(TreeItemClass *child) {
    ChildList.Add(child);
    NeedsChildren = false;
  }
