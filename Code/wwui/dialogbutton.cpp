...
//
////////////////////////////////////////////////////////////////
DialogButtonClass::DialogButtonClass(void) : WasButtonPressedOnMe(false), IsMouseOverMe(false) {
  //
...
//
////////////////////////////////////////////////////////////////
void DialogButtonClass::Render(void) {
  //
...
//
////////////////////////////////////////////////////////////////
void DialogButtonClass::On_Create(void) { return; }
...
//
////////////////////////////////////////////////////////////////
void DialogButtonClass::On_LButton_Down(const Vector2 &mouse_pos) {
  Set_Capture();
...
//
////////////////////////////////////////////////////////////////
void DialogButtonClass::On_LButton_Up(const Vector2 &mouse_pos) {
  Release_Capture();
...
//
////////////////////////////////////////////////////////////////
void DialogButtonClass::On_Mouse_Move(const Vector2 &mouse_pos) {
  IsMouseOverMe = Rect.Contains(mouse_pos);
  return;
}
...
//
////////////////////////////////////////////////////////////////
void DialogButtonClass::Create_Bitmap_Button(void) {
  ...
  TextureClass *texture =
      WW3DAssetManager::Get_Instance()->Get_Texture("button_test04.tga", TextureClass::MIP_LEVELS_1);
...
void Blit_Section(Render2DClass &renderer, const Vector2 &screen_pos, const Vector2 &texture_pos, const Vector2 &pixels,
...
//
////////////////////////////////////////////////////////////////
void DialogButtonClass::Create_Component_Button(void) {
  ButtonRenderers[0].Reset();
  ButtonRenderers[1].Reset();
  ...
  //	Upper left
  //
  ::Blit_Section(ButtonRenderers[0], Vector2(Rect.Left, Rect.Top), Vector2(0, 0), Vector2(edge_width, height),
                 texture_dimensions);

  ::Blit_Section(ButtonRenderers[1], Vector2(Rect.Left, Rect.Top), Vector2(0, dn_start), Vector2(edge_width, height),
                 texture_dimensions);
  ...
  //	Lower right
  //
  ::Blit_Section(ButtonRenderers[0], Vector2(Rect.Right - edge_width, Rect.Bottom - height),
                 Vector2(right - edge_width, bottom - height), Vector2(edge_width, height), texture_dimensions);

  ::Blit_Section(ButtonRenderers[1], Vector2(Rect.Right - edge_width, Rect.Bottom - height),
                 Vector2(right - edge_width, dn_start + bottom - height), Vector2(edge_width, height),
                 texture_dimensions);
  ...
  while (remaining_width > 0) {
    ...
    ::Blit_Section(ButtonRenderers[0], Vector2(x_pos, Rect.Top), horz_top_pos, horz_size, texture_dimensions);

    ::Blit_Section(ButtonRenderers[0], Vector2(x_pos, Rect.Bottom - height), horz_bottom_pos, horz_size,
                   texture_dimensions);

    ::Blit_Section(ButtonRenderers[1], Vector2(x_pos, Rect.Top), horz_top_pos + Vector2(0, dn_start), horz_size,
                   texture_dimensions);
  ...
  while (remaining_height > 0) {
    ...
    ::Blit_Section(ButtonRenderers[0], Vector2(Rect.Left, y_pos), vert_left_pos, vert_size, texture_dimensions);

    ::Blit_Section(ButtonRenderers[0], Vector2(Rect.Right - edge_width, y_pos), vert_right_pos, vert_size,
                   texture_dimensions);

    ::Blit_Section(ButtonRenderers[1], Vector2(Rect.Left, y_pos), vert_left_pos + Vector2(0, dn_start), vert_size,
                   texture_dimensions);
  ...
  while (remaining_height > 0) {
    ...
    while (remaining_width > 0) {
      ...
      ::Blit_Section(ButtonRenderers[0], Vector2(x_pos, y_pos), Vector2((right / 2) - 4, (bottom / 2) - 4), size,
                     texture_dimensions);
...
//
////////////////////////////////////////////////////////////////
void DialogButtonClass::Create_Component_Button2(void) {
  ButtonRenderers[0].Reset();
  ButtonRenderers[1].Reset();
  ButtonRenderers[0].Set_Coordinate_Range(Render2DClass::Get_Screen_Resolution());
  ButtonRenderers[1].Set_Coordinate_Range(Render2DClass::Get_Screen_Resolution());
...
//
////////////////////////////////////////////////////////////////
void DialogButtonClass::Create_Text_Renderers(void) {
...
//
////////////////////////////////////////////////////////////////
void DialogButtonClass::On_Set_Cursor(const Vector2 &mouse_pos) {
  //
...
//
////////////////////////////////////////////////////////////////
void DialogButtonClass::On_Kill_Focus(DialogControlClass *focus) {
  WasButtonPressedOnMe = false;
  IsMouseOverMe = false;
...
//
////////////////////////////////////////////////////////////////
bool DialogButtonClass::On_Key_Down(uint32 key_id, uint32 key_data) {
  switch (key_id) {
  case VK_RETURN:
  case VK_SPACE:
    Parent->On_Command(ID, BN_CLICKED, 0);
