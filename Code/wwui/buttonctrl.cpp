...
//
////////////////////////////////////////////////////////////////
ButtonCtrlClass::ButtonCtrlClass(void) : WasButtonPressedOnMe(false), IsMouseOverMe(false), PulseTime(0) {
  //
...
//
////////////////////////////////////////////////////////////////
void ButtonCtrlClass::Create_Vector_Button(void) {
...
void ButtonCtrlClass::Create_Bitmap_Button(void) {
  ...
  //
  /*TextureClass *texture = WW3DAssetManager::Get_Instance ()->Get_Texture ("if_circle02.tga",
  TextureClass::MIP_LEVELS_1); ButtonRenderers[0].Set_Texture (texture); ButtonRenderers[1].Set_Texture (texture);
  texture->Release_Ref();
...
//
////////////////////////////////////////////////////////////////
void Button_Blit_Section(Render2DClass &renderer, const Vector2 &screen_pos, const Vector2 &texture_pos,
                         const Vector2 &pixels, const Vector2 &texture_dimensions) {
...
void ButtonCtrlClass::Create_Component_Button(void) {
  ...
  //	Upper left
  //
  Button_Blit_Section(ButtonRenderers[0], Vector2(Rect.Left, Rect.Top), Vector2(left, top), Vector2(edge_width, height),
                      texture_dimensions);
  ...
  //	Lower right
  //
  Button_Blit_Section(ButtonRenderers[0], Vector2(Rect.Right - edge_width, Rect.Bottom - height),
  ...
  while (remaining_width > 0) {
    ...
    Button_Blit_Section(ButtonRenderers[0], Vector2(x_pos, Rect.Top), horz_top_pos, horz_size, texture_dimensions);

    Button_Blit_Section(ButtonRenderers[0], Vector2(x_pos, Rect.Bottom - height), horz_bottom_pos, horz_size,
                        texture_dimensions);
  ...
  while (remaining_height > 0) {
    ...
    Button_Blit_Section(ButtonRenderers[0], Vector2(Rect.Left, y_pos), vert_left_pos, vert_size, texture_dimensions);

    Button_Blit_Section(ButtonRenderers[0], Vector2(Rect.Right - edge_width, y_pos), vert_right_pos, vert_size,
                        texture_dimensions);
  ...
  while (remaining_height > 0) {
          ...
          while (remaining_width > 0) {
                  ...
                  ::Blit_Section (ButtonRenderers[0], Vector2 (x_pos, y_pos), Vector2 ((right / 2) - 4, (bottom / 2) -
  4), size, texture_dimensions);

                  ::Blit_Section (ButtonRenderers[1], Vector2 (x_pos, y_pos), Vector2 ((right / 2) - 4, dn_start +
  (bottom / 2) - 4), size, texture_dimensions);
...
//
////////////////////////////////////////////////////////////////
void ButtonCtrlClass::Create_Component_Button2(void) {
  ButtonRenderers[0].Reset();
  ButtonRenderers[1].Reset();
...
void ButtonCtrlClass::Create_Text_Renderers(void) {
  ...
  //
  StyleMgrClass::Render_Glow(Title, &GlowRenderer, Rect, 8, 8, StyleMgrClass::Get_Tab_Glow_Color(),
...
//
////////////////////////////////////////////////////////////////
void ButtonCtrlClass::Set_Bitmap(const char *texture_up_name, const char *texture_dn_name) {
  //
  ...
  if (texture_dn_name != NULL && texture_dn_name[0] != 0) {
    TextureClass *texture_dn =
        WW3DAssetManager::Get_Instance()->Get_Texture(texture_dn_name, TextureClass::MIP_LEVELS_1);
