...
DialogBaseClass::DialogBaseClass(int res_id)
    : DialogResID(res_id), AreControlsHidden(false), LastFocusControl(NULL), LastMouseClickTime(0), IsVisible(true),
      IsRunning(false) {
  return;
}
...
void DialogBaseClass::Start_Dialog(void) {
  ...
  //
  DialogParserClass::Parse_Template(DialogResID, &dlg_width, &dlg_height, &Title, &control_list);
...
//
////////////////////////////////////////////////////////////////
void DialogBaseClass::End_Dialog(void) {
...
//
////////////////////////////////////////////////////////////////
void DialogBaseClass::On_Frame_Update(void) {
  Add_Ref();
...
//
////////////////////////////////////////////////////////////////
void DialogBaseClass::Render(void) {
  Add_Ref();
...
//
////////////////////////////////////////////////////////////////
void DialogBaseClass::Enable_Dlg_Item(int id, bool onoff) {
  //
  //	Find the control
  //
...
//
////////////////////////////////////////////////////////////////
bool DialogBaseClass::Is_Dlg_Item_Enabled(int id) {
  bool retval = false;
...
//
////////////////////////////////////////////////////////////////
void DialogBaseClass::Set_Dlg_Item_Text(int id, const WCHAR *text) {
  //
  //	Find the control
  //
  DialogControlClass *control = Get_Dlg_Item(id);
...
//
////////////////////////////////////////////////////////////////
int DialogBaseClass::Get_Dlg_Item_Int(int id) const {
  int retval = 0;
...
//
////////////////////////////////////////////////////////////////
void DialogBaseClass::Set_Dlg_Item_Int(int id, int value) {
  //
  //	Find the control
  //
  DialogControlClass *control = Get_Dlg_Item(id);
...
//
////////////////////////////////////////////////////////////////
float DialogBaseClass::Get_Dlg_Item_Float(int id) const {
  float retval = 0;
...
//
////////////////////////////////////////////////////////////////
void DialogBaseClass::Set_Dlg_Item_Float(int id, float value) {
  //
  //	Find the control
  //
  DialogControlClass *control = Get_Dlg_Item(id);
...
//
////////////////////////////////////////////////////////////////
void DialogBaseClass::Check_Dlg_Button(int id, bool onoff) {
  //
  //	Find the control
  //
  DialogControlClass *control = Get_Dlg_Item(id);
...
//
////////////////////////////////////////////////////////////////
bool DialogBaseClass::Is_Dlg_Button_Checked(int id) const {
  bool retval = false;
...
//
////////////////////////////////////////////////////////////////
void DialogBaseClass::Free_Controls(void) {
  for (int index = 0; index < ControlList.Count(); index++) {
...
//
////////////////////////////////////////////////////////////////
void DialogBaseClass::Send_Mouse_Input(DialogControlClass *control, const Vector2 &mouse_pos) {
  //
...
//
////////////////////////////////////////////////////////////////
void DialogBaseClass::Update_Mouse_State(void) {
  //
...
//
////////////////////////////////////////////////////////////////
void DialogBaseClass::On_Command(int ctrl_id, int message_id, DWORD param) {
  //
...
//
////////////////////////////////////////////////////////////////
void DialogBaseClass::On_Activate(bool onoff) {
  if (onoff == false) {
...
//
////////////////////////////////////////////////////////////////
bool DialogBaseClass::Is_Active(void) { return (DialogMgrClass::Get_Active_Dialog() == this); }
...
//
////////////////////////////////////////////////////////////////
bool DialogBaseClass::On_Key_Down(uint32 key_id, uint32 key_data) {
  bool handled = false;
  ...
  if (key_id == VK_ESCAPE) {
    ...
    // pressed enter
    //
    if (input->As_ButtonCtrlClass() == NULL && input->As_MenuEntryCtrlClass() == NULL && key_id == VK_RETURN) {
      On_Command(IDOK, 0, 0);
      handled = true;
    }
...
//
////////////////////////////////////////////////////////////////
bool DialogBaseClass::On_Key_Up(uint32 key_id) {
  bool handled = false;
...
//
////////////////////////////////////////////////////////////////
void DialogBaseClass::On_Unicode_Char(uint16 unicode) {
  Add_Ref();
...
DialogControlClass *DialogBaseClass::Find_Next_Control(DialogControlClass *control, int direction) {
  ...
  for (int index = focus_index; index >= 0 && index < count; index += inc) {
    ...
    //
    if (control_list[new_focus_index]->Wants_Focus() && control_list[new_focus_index]->Is_Enabled()) {
      break;
    }
  }
...
//
////////////////////////////////////////////////////////////////
DialogControlClass *DialogBaseClass::Find_Next_Group_Control(DialogControlClass *control, int direction) {
  //
  //	Build a complete list of controls
  //
  CONTROL_LIST control_list;
  ...
  if (direction < 0) {
    ...
    if ((control_list[curr_index]->Get_Style() & WS_GROUP) || (curr_index == 0)) {
      //
    ...
    if (curr_index == (control_list.Count() - 1) || (control_list[curr_index + 1]->Get_Style() & WS_GROUP)) {
      //
...
//
////////////////////////////////////////////////////////////////
int DialogBaseClass::Find_Control_Index(DialogControlClass *control) { return ControlList.ID(control); }
...
//
////////////////////////////////////////////////////////////////
void DialogBaseClass::Add_Control(DialogControlClass *control) {
  //
...
//
////////////////////////////////////////////////////////////////
void DialogBaseClass::Remove_Control(DialogControlClass *control) {
  //
...
//
////////////////////////////////////////////////////////////////
int DialogBaseClass::Find_Focus_Control(void) {
  int focus_index = -1;
...
//
////////////////////////////////////////////////////////////////
void DialogBaseClass::Add_Child_Dialog(ChildDialogClass *child) {
  //
...
//
////////////////////////////////////////////////////////////////
void DialogBaseClass::Remove_Child_Dialog(ChildDialogClass *child) {
  ...
  if (index != -1) {
    ...
    // dialog
    //
    if (DialogMgrClass::Get_Focus() != NULL && DialogMgrClass::Get_Focus()->Peek_Parent() == child) {
      DialogMgrClass::Set_Focus(NULL);
      reset_focus = true;
    }
...
//
////////////////////////////////////////////////////////////////
void DialogBaseClass::Build_Control_List(CONTROL_LIST &list) {
  //
...
//
////////////////////////////////////////////////////////////////
void DialogBaseClass::Set_Rect(const RectClass &rect) {
  if (rect == Rect) {
    return;
  }
...
//
////////////////////////////////////////////////////////////////
void DialogBaseClass::Set_Default_Focus(void) {
  //
  //	Build a complete list of controls
  //
  CONTROL_LIST control_list;
