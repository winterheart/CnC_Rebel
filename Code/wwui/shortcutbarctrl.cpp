...
ShortcutBarCtrlClass::ShortcutBarCtrlClass(void)
    : FullRect(0, 0, 0, 0), IsHiddenState(true), CurrSel(-1), BarOpacity(1.0F), PulseDirection(-1.0F) {
  //
...
//
////////////////////////////////////////////////////////////////
ShortcutBarCtrlClass::~ShortcutBarCtrlClass(void) { return; }
...
//
////////////////////////////////////////////////////////////////
void ShortcutBarCtrlClass::Create_Text_Renderers(void) {
  //
  //	Start fresh
  //
  TextRenderer.Reset();
  ...
  for (int index = 0; index < ShortcutList.Count(); index++) {
    ...
    if (index == CurrSel) {
      ...
      StyleMgrClass::Render_Glow(text, &GlowRenderer, text_rect, 7, 7, StyleMgrClass::Get_Tab_Glow_Color(),
                                 StyleMgrClass::CENTER_JUSTIFY);
      ...
      //	Render the text for this button
      //
      StyleMgrClass::Render_Text(text, &TextRenderer, text_rect, true, true, StyleMgrClass::CENTER_JUSTIFY);
    }
  }
...
//
////////////////////////////////////////////////////////////////
void ShortcutBarCtrlClass::Create_Control_Renderers(void) {
  //
...
//
////////////////////////////////////////////////////////////////
void ShortcutBarCtrlClass::Create_Hidden_State_Renderers(void) {
  //
...
//
////////////////////////////////////////////////////////////////
void ShortcutBarCtrlClass::Create_Displayed_State_Renderers(void) {
  //
  //	Determine which color to draw the outline in
  //
  int color = StyleMgrClass::Get_Line_Color();
...
//
////////////////////////////////////////////////////////////////
void ShortcutBarCtrlClass::On_LButton_Up(const Vector2 &mouse_pos) { return; }
...
//
////////////////////////////////////////////////////////////////
void ShortcutBarCtrlClass::On_Create(void) { return; }
...
//
////////////////////////////////////////////////////////////////
void ShortcutBarCtrlClass::Get_Entry_Rect(int index, RectClass &rect) {
...
//
////////////////////////////////////////////////////////////////
void ShortcutBarCtrlClass::Send_Command(void) {
...
//
////////////////////////////////////////////////////////////////
void ShortcutBarCtrlClass::Update_Pulse(void) {
  if (IsHiddenState == false) {
    return;
  }
