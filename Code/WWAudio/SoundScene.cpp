...
//	Save/Load constants
//////////////////////////////////////////////////////////////////////////////////
enum { CHUNKID_VARIABLES = 0x00000100, CHUNKID_STATIC_SOUNDS, CHUNKID_DYNAMIC_SOUNDS };
...
void SoundSceneClass::Collect_Logical_Sounds(int listener_count) {
  ...
  // frame.
  //
  for (int total = 0; total < count && priority_queue.Process_Head(&listener); total++) {
...
//
////////////////////////////////////////////////////////////////////////////////////////////////
void SoundSceneClass::Collect_Audible_Sounds(Listener3DClass *listener, COLLECTED_SOUNDS &list) {
...
//
////////////////////////////////////////////////////////////////////////////////////////////////
void SoundSceneClass::Add_Sound(AudibleSoundClass *sound_obj, bool start_playing) {
  WWPROFILE("Add_Sound");
  WWMEMLOG(MEM_SOUND);
...
//
////////////////////////////////////////////////////////////////////////////////////////////////
bool SoundSceneClass::Is_Sound_In_Scene(AudibleSoundClass *sound_obj, bool all) {
  bool retval = false;
...
//
////////////////////////////////////////////////////////////////////////////////////////////////
bool SoundSceneClass::Is_Logical_Sound_In_Scene(LogicalSoundClass *sound_obj, bool single_shot) {
  bool retval = false;
