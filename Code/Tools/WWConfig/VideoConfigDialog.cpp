...
VideoConfigDialogClass::VideoConfigDialogClass(CWnd *pParent)
    : CurrentBitDepth(16), CurrentWidth(800), CurrentHeight(600), CurrentDriverIndex(0), CurrentIsWindowed(false),
...
VideoConfigDialogClass::~VideoConfigDialogClass() { VideoConfigDialogInstance = NULL; }

VideoConfigDialogClass *VideoConfigDialogClass::Get_Instance() { return VideoConfigDialogInstance; }
...
//
/////////////////////////////////////////////////////////////////////////////
void VideoConfigDialogClass::DoDataExchange(CDataExchange *pDX) {
...
/////////////////////////////////////////////////////////////////////////////
BOOL VideoConfigDialogClass::OnInitDialog(void) {
  ...
  int bit_depth = 0;
  int windowed = 0;
  if (WW3D::Registry_Load_Render_Device(RENEGADE_SUB_KEY_NAME_RENDER, device_name, 256, width, height, bit_depth,
                                        windowed, texture_depth)) {
    if (width != -1) {
      CurrentWidth = width;
    }
...
//
/////////////////////////////////////////////////////////////////////////////
void VideoConfigDialogClass::OnDestroy(void) {
  //
  //	Shutdown the engine
  //
  WW3D::Shutdown();
...
//
/////////////////////////////////////////////////////////////////////////////
void VideoConfigDialogClass::Update_Display_Settings(void) {
  //
...
//
/////////////////////////////////////////////////////////////////////////////
void VideoConfigDialogClass::Update_Resolution_Slider(void) {
  //
  //	Lookup the device description for the selected device
  //
  const RenderDeviceDescClass &driver_info = WW3D::Get_Render_Device_Desc(CurrentDriverIndex);
...
//
/////////////////////////////////////////////////////////////////////////////
void VideoConfigDialogClass::Update_Color_Combo(void) {
  //
  //	Start fresh
  //
...
//
/////////////////////////////////////////////////////////////////////////////
void VideoConfigDialogClass::Select_Default_Resolution(void) {
...
//
/////////////////////////////////////////////////////////////////////////////
void VideoConfigDialogClass::Update_Resolution_Text(void) {
...
//
/////////////////////////////////////////////////////////////////////////////
void VideoConfigDialogClass::OnItemchangedDriverList(NMHDR *pNMHDR, LRESULT *pResult) {
...
//
/////////////////////////////////////////////////////////////////////////////
void VideoConfigDialogClass::OnSelchangeBitdepthCombo(void) {
...
//
/////////////////////////////////////////////////////////////////////////////
void VideoConfigDialogClass::OnHScroll(UINT nSBCode, UINT nPos, CScrollBar *pScrollBar) {
...
//
/////////////////////////////////////////////////////////////////////////////
void VideoConfigDialogClass::Apply_Changes(void) {
  //
  //	Save the changes to the registry
  //
  WW3D::Registry_Save_Render_Device(RENEGADE_SUB_KEY_NAME_RENDER, CurrentDriverIndex, CurrentWidth, CurrentHeight,
                                    CurrentBitDepth, CurrentIsWindowed, WW3D::Get_Texture_Bitdepth());
  return;
}
...
/////////////////////////////////////////////////////////////////////////////
LRESULT
VideoConfigDialogClass::WindowProc(UINT message, WPARAM wParam, LPARAM lParam) {
...
//
/////////////////////////////////////////////////////////////////////////////
void VideoConfigDialogClass::OnWindowedCheck(void) {
