...
//
/////////////////////////////////////////////////////////////////////////////
void PerformanceConfigDialogClass::DoDataExchange(CDataExchange *pDX) {
...
//
/////////////////////////////////////////////////////////////////////////////
BOOL PerformanceConfigDialogClass::OnInitDialog(void) {
...
//
/////////////////////////////////////////////////////////////////////////////
void PerformanceConfigDialogClass::Build_Expert_Window_List(void) {
...
//
/////////////////////////////////////////////////////////////////////////////
void PerformanceConfigDialogClass::Display_Expert_Settings(bool onoff) {
  //
...
//
/////////////////////////////////////////////////////////////////////////////
void PerformanceConfigDialogClass::OnExpertCheck(void) {
...
//
/////////////////////////////////////////////////////////////////////////////
void PerformanceConfigDialogClass::Setup_Controls(void) {
  //
...
//
/////////////////////////////////////////////////////////////////////////////
void PerformanceConfigDialogClass::Load_Values(void) {
  //
...
//
/////////////////////////////////////////////////////////////////////////////
void PerformanceConfigDialogClass::Determine_Performance_Setting(void) {
...
//
/////////////////////////////////////////////////////////////////////////////
void PerformanceConfigDialogClass::Get_Settings(DynamicVectorClass<int> &settings) {
  //
...
//
/////////////////////////////////////////////////////////////////////////////
void PerformanceConfigDialogClass::Update_Expert_Controls(int level) {
  for (int index = 0; index < MAX_EXPERT_OPTIONS; index++) {
...
//
/////////////////////////////////////////////////////////////////////////////
void PerformanceConfigDialogClass::OnHScroll(UINT nSBCode, UINT nPos, CScrollBar *pScrollBar) {
...
//
/////////////////////////////////////////////////////////////////////////////
void PerformanceConfigDialogClass::Apply_Changes(void) {
  //
  //	Attempt to open the registry key
  //
  RegistryClass registry(KEY_NAME_SETTINGS);
  if (registry.Is_Valid()) {
    ...
    if (!CanDoMultiPass) {
      if (prelit_mode == 1)
        prelit_mode = WW3D::PRELIT_MODE_LIGHTMAP_MULTI_TEXTURE;
    }
...
/////////////////////////////////////////////////////////////////////////////
LRESULT
PerformanceConfigDialogClass::WindowProc(UINT message, WPARAM wParam, LPARAM lParam) {
...
//
/////////////////////////////////////////////////////////////////////////////
void PerformanceConfigDialogClass::OnShowWindow(BOOL bShow, UINT nStatus) {
  char string[_MAX_PATH];
  ...
  if (bShow) {
    ...
    if (video) {
      ...
      if (caps.Get_Max_Textures_Per_Pass() > 1) {
        SendDlgItemMessage(IDC_LIGHTING_MODE_COMBO, CB_ADDSTRING, 0,
                           (LPARAM)Locale_GetString(IDS_MULTI_TEXTURE, string));
      }
      ...
      if (caps.Support_Anisotropic_Filtering()) {
        SendDlgItemMessage(IDC_TEXTURE_FILTER_COMBO, CB_ADDSTRING, 0,
                           (LPARAM)Locale_GetString(IDS_ANISOTROPIC, string));
      }
