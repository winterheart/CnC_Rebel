...
EmitterRotationPropPageClass::EmitterRotationPropPageClass()
    : CPropertyPage(EmitterRotationPropPageClass::IDD), m_pEmitterList(NULL), m_bValid(true), m_RotationBar(NULL),
      m_Lifetime(0), m_MinRotation(0), m_MaxRotation(1), m_InitialOrientationRandom(0)
...
BOOL EmitterRotationPropPageClass::OnInitDialog() {
  ...
  //
  for (UINT index = 0; index < m_Rotations.NumKeyFrames; index++) {
    m_RotationBar->Modify_Point(index + 1, m_Rotations.KeyTimes[index] / m_Lifetime, 0, 0, 0);
...
//
/////////////////////////////////////////////////////////////
void EmitterRotationPropPageClass::Update_Rotations(void) {
  float position = 0;
  float red = 0;
  float green = 0;
  float blue = 0;
