...
SphereSizePropPageClass::SphereSizePropPageClass(SphereRenderObjClass *sphere)
    : m_RenderObj(sphere), m_bValid(true), m_ScaleXBar(NULL), m_ScaleYBar(NULL), m_ScaleZBar(NULL),
      m_Size(0.5F, 0.5F, 0.5F), CPropertyPage(SphereSizePropPageClass::IDD) {
...
//
/////////////////////////////////////////////////////////////
SphereSizePropPageClass::~SphereSizePropPageClass(void) { return; }
...
//
/////////////////////////////////////////////////////////////
void SphereSizePropPageClass::DoDataExchange(CDataExchange *pDX) {
...
//
/////////////////////////////////////////////////////////////
void SphereSizePropPageClass::Initialize(void) {
...
//
/////////////////////////////////////////////////////////////
BOOL SphereSizePropPageClass::OnInitDialog(void) {
  ...
  for (int index = 1; index < m_OrigScaleChannel.Get_Key_Count(); index++) {
    ...
    if (index == (m_OrigScaleChannel.Get_Key_Count() - 1)) {
      ...
      //
      unique_z = (::Is_LERP(prev_value.Get_Value().Z, prev_value.Get_Time(), curr_value.Get_Value().Z,
                            curr_value.Get_Time(), next_value.Get_Value().Z, next_value.Get_Time()) == false);
    }
...
//
/////////////////////////////////////////////////////////////
BOOL SphereSizePropPageClass::OnApply(void) {
  // Allow the base class to process this message
...
//
/////////////////////////////////////////////////////////////
void SphereSizePropPageClass::OnDestroy(void) {
...
//
/////////////////////////////////////////////////////////////
BOOL SphereSizePropPageClass::OnNotify(WPARAM wParam, LPARAM lParam, LRESULT *pResult) {
...
//
/////////////////////////////////////////////////////////////
BOOL SphereSizePropPageClass::OnCommand(WPARAM wParam, LPARAM lParam) {
...
//
/////////////////////////////////////////////////////////////
void SphereSizePropPageClass::OnCancel(void) {
  //
...
//
/////////////////////////////////////////////////////////////
void SphereSizePropPageClass::Update_Scale_Array(void) {
  m_ScaleChannel.Reset();
  ...
  while (x_index < max_x || y_index < max_y || z_index < max_z) {
    //
