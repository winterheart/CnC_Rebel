...
SphereGeneralPropPageClass::SphereGeneralPropPageClass(SphereRenderObjClass *sphere)
    : m_bValid(true), m_Lifetime(1.0F), m_RenderObj(sphere), CPropertyPage(SphereGeneralPropPageClass::IDD) {
...
//
/////////////////////////////////////////////////////////////
SphereGeneralPropPageClass::~SphereGeneralPropPageClass() { return; }
...
//
/////////////////////////////////////////////////////////////
void SphereGeneralPropPageClass::Initialize(void) {
  if (m_RenderObj != NULL) {
...
//
/////////////////////////////////////////////////////////////
void SphereGeneralPropPageClass::Add_Shader_To_Combo(ShaderClass &shader, LPCTSTR name) {
...
//
/////////////////////////////////////////////////////////////
BOOL SphereGeneralPropPageClass::OnInitDialog(void) {
...
//
/////////////////////////////////////////////////////////////
BOOL SphereGeneralPropPageClass::OnApply(void) {
  ...
  if (m_Name.GetLength() == 0) {
    ::MessageBox(m_hWnd, "Invalid sphere name.  Please enter a new name.", "Invalid settings",
...
//
/////////////////////////////////////////////////////////////
void SphereGeneralPropPageClass::OnBrowseButton(void) {
...
//
/////////////////////////////////////////////////////////////
void SphereGeneralPropPageClass::OnChangeFilenameEdit(void) {
  SetModified();
  return;
}
...
//
/////////////////////////////////////////////////////////////
void SphereGeneralPropPageClass::OnChangeNameEdit(void) {
  SetModified();
  return;
}
...
//
/////////////////////////////////////////////////////////////
BOOL SphereGeneralPropPageClass::OnNotify(WPARAM wParam, LPARAM lParam, LRESULT *pResult) {
  //
...
//
/////////////////////////////////////////////////////////////
void SphereGeneralPropPageClass::OnChangeLifetimeEdit(void) {
  SetModified();
  return;
}
...
//
/////////////////////////////////////////////////////////////
void SphereGeneralPropPageClass::OnSelchangeShaderCombo(void) {
  SetModified();
  return;
}
...
//
/////////////////////////////////////////////////////////////
BOOL SphereGeneralPropPageClass::OnCommand(WPARAM wParam, LPARAM lParam) {
