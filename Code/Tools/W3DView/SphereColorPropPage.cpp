...
SphereColorPropPageClass::SphereColorPropPageClass(SphereRenderObjClass *sphere)
    : m_RenderObj(sphere), m_bValid(true), m_ColorBar(NULL), m_OpacityBar(NULL), m_EnableOpactiyVector(false),
      m_InvertVector(false), CPropertyPage(SphereColorPropPageClass::IDD) {
...
//
/////////////////////////////////////////////////////////////
SphereColorPropPageClass::~SphereColorPropPageClass(void) { return; }
...
//
/////////////////////////////////////////////////////////////
void SphereColorPropPageClass::DoDataExchange(CDataExchange *pDX) {
...
//
/////////////////////////////////////////////////////////////
void SphereColorPropPageClass::Initialize(void) {
...
//
/////////////////////////////////////////////////////////////
BOOL SphereColorPropPageClass::OnInitDialog(void) {
  ...
  for (int index = 0; index < m_OrigColorChannel.Get_Key_Count(); index++) {
    m_ColorBar->Modify_Point(index, m_OrigColorChannel[index].Get_Time(), m_OrigColorChannel[index].Get_Value().X * 255,
  ...
  for (int index = 0; index < m_OrigAlphaChannel.Get_Key_Count(); index++) {
    m_OpacityBar->Modify_Point(index, m_OrigAlphaChannel[index].Get_Time(), m_OrigAlphaChannel[index].Get_Value() * 255,
  ...
  for (int index = 0; index < m_OrigVectorChannel.Get_Key_Count(); index++) {
    m_VectorBar->Modify_Point(index, m_OrigVectorChannel[index].Get_Time(), 128, 128, 128);
...
//
/////////////////////////////////////////////////////////////
BOOL SphereColorPropPageClass::OnApply(void) {
  // Allow the base class to process this message
...
//
/////////////////////////////////////////////////////////////
void SphereColorPropPageClass::OnDestroy(void) {
  //
...
//
/////////////////////////////////////////////////////////////
BOOL SphereColorPropPageClass::OnNotify(WPARAM wParam, LPARAM lParam, LRESULT *pResult) {
...
//
/////////////////////////////////////////////////////////////
void SphereColorPropPageClass::OnCancel(void) {
  //
...
//
/////////////////////////////////////////////////////////////
void SphereColorPropPageClass::Update_Opacities(void) {
  m_AlphaChannel.Reset();
...
//
/////////////////////////////////////////////////////////////
void SphereColorPropPageClass::Update_Colors(void) {
  m_ColorChannel.Reset();
...
//
/////////////////////////////////////////////////////////////
void SphereColorPropPageClass::Update_Vectors(void) {
  m_VectorChannel.Reset();
...
//
/////////////////////////////////////////////////////////////
void SphereColorPropPageClass::OnOpacityVectorCheck(void) {
...
//
/////////////////////////////////////////////////////////////
void SphereColorPropPageClass::OnInvertVectorCheck(void) {
