...
EmitterLinePropPageClass::EmitterLinePropPageClass()
    : CPropertyPage(EmitterLinePropPageClass::IDD), m_pEmitterList(NULL), m_bValid(true),
      m_MappingMode(W3D_EMITTER_RENDER_MODE_TRI_PARTICLES), m_MergeIntersections(false), m_EndCaps(false),
      m_DisableSorting(false), m_SubdivisionLevel(0), m_NoiseAmplitude(0.0f), m_MergeAbortFactor(0.0f),
      m_TextureTileFactor(0.0f), m_UPerSec(0.0f), m_VPerSec(0.0f) {
...
//  Initialize
//
void EmitterLinePropPageClass::Initialize(void) {
