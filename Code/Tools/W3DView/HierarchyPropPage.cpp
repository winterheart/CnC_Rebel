...
//  CHierarchyPropPage
//
CHierarchyPropPage::CHierarchyPropPage(const CString &stringHierarchyName) : CPropertyPage(CHierarchyPropPage::IDD) {
...
//  CHierarchyPropPage
//
CHierarchyPropPage::~CHierarchyPropPage(void) { return; }
