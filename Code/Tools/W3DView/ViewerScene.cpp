...
ViewerSceneIterator::ViewerSceneIterator(RefRenderObjListClass *list) : RobjIterator(list) {}

void ViewerSceneIterator::First(void) { RobjIterator.First(); }

void ViewerSceneIterator::Next(void) { RobjIterator.Next(); }

bool ViewerSceneIterator::Is_Done(void) { return RobjIterator.Is_Done(); }

RenderObjClass *ViewerSceneIterator::Current_Item(void) { return RobjIterator.Peek_Obj(); }
...
void ViewerSceneClass::Clear_Lineup(void) {
...
SphereClass ViewerSceneClass::Get_Bounding_Sphere(void) {
...
AABoxClass ViewerSceneClass::Get_Line_Up_Bounding_Box(void) {
...
bool ViewerSceneClass::Can_Line_Up(int class_id) {
  return (class_id == RenderObjClass::CLASSID_HMODEL) || (class_id == RenderObjClass::CLASSID_HLOD);
}

SceneIterator *ViewerSceneClass::Create_Line_Up_Iterator(void) { return new ViewerSceneIterator(&LineUpList); }

void ViewerSceneClass::Destroy_Line_Up_Iterator(SceneIterator *it) { delete it; }
