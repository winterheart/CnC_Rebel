...
static UINT indicators[] = {ID_SEPARATOR, // status line indicator
                            IDS_POLY_PANE,  IDS_PARTICLE_PANE, IDS_DISTANCE_PANE,
                            IDS_FRAME_PANE, IDS_FPS_PANE,      IDS_RESOLUTION_PANE};
...
//
////////////////////////////////////////////////////////////////////////////
CMainFrame::CMainFrame(void) : m_currentAssetType(TypeUnknown), m_bShowAnimationBar(TRUE), m_bInitialized(FALSE) {
  return;
}
...
BOOL CMainFrame::OnCreateClient(LPCREATESTRUCT /*lpcs*/, CCreateContext *pContext) {
  ...
  if (bReturn) {
    ...
    // of the W3D file.
    bReturn &= m_wndSplitter.CreateView(0, 0, RUNTIME_CLASS(CDataTreeView), CSize(340, 10), pContext);

    // Create the 'graphic' view which will contain a pictoral representation
    // of the currently selected object
    bReturn &= m_wndSplitter.CreateView(0, 1, RUNTIME_CLASS(CGraphicView), CSize(120, 10), pContext);
    ...
    if (bReturn) {
      ...
      if (pCGraphicView) {
        ...
        WW3D::Set_NPatches_Gap_Filling_Mode(gap_filling ? WW3D::NPATCHES_GAP_FILLING_ENABLED
...
//
////////////////////////////////////////////////////////////////////////////
void CMainFrame::OnObjectProperties(void) {
...
//
////////////////////////////////////////////////////////////////////////////
void CMainFrame::OnLodGenerate(void) {
...
//
////////////////////////////////////////////////////////////////////////////
void CMainFrame::Update_Frame_Time(DWORD clocks) {
...
//
////////////////////////////////////////////////////////////////////////////
void CMainFrame::OnAniSpeed(void) {
  CGraphicView *pCGraphicView = (CGraphicView *)m_wndSplitter.GetPane(0, 1);
  if (pCGraphicView) {
...
//
////////////////////////////////////////////////////////////////////////////
void CMainFrame::OnAniStart(void) {
  CGraphicView *pCGraphicView = (CGraphicView *)m_wndSplitter.GetPane(0, 1);
  ASSERT(pCGraphicView);
  if (pCGraphicView) {
    // Start the animation
...
//
////////////////////////////////////////////////////////////////////////////
void CMainFrame::OnCameraReset(void) {
  CGraphicView *pCGraphicView = (CGraphicView *)m_wndSplitter.GetPane(0, 1);
  ASSERT(pCGraphicView);
  if (pCGraphicView) {
...
//
////////////////////////////////////////////////////////////////////////////
void CMainFrame::OnObjectRotateZ(void) {
  CGraphicView *pCGraphicView = (CGraphicView *)m_wndSplitter.GetPane(0, 1);
  ASSERT(pCGraphicView);
  if (pCGraphicView) {
...
//
////////////////////////////////////////////////////////////////////////////
void CMainFrame::OnObjectRotateY(void) {
  CGraphicView *pCGraphicView = (CGraphicView *)m_wndSplitter.GetPane(0, 1);
  ASSERT(pCGraphicView);
  if (pCGraphicView) {
...
//
////////////////////////////////////////////////////////////////////////////
void CMainFrame::OnObjectRotateX(void) {
  CGraphicView *pCGraphicView = (CGraphicView *)m_wndSplitter.GetPane(0, 1);
  ASSERT(pCGraphicView);
  if (pCGraphicView)
...
//
////////////////////////////////////////////////////////////////////////////
void CMainFrame::OnLightAmbient(void) {
...
//
////////////////////////////////////////////////////////////////////////////
void CMainFrame::OnBackgroundColor(void) {
...
//
////////////////////////////////////////////////////////////////////////////
void CMainFrame::OnBackgroundFog(void) {
  CW3DViewDoc *pdoc = (CW3DViewDoc *)GetActiveDocument();
  if (pdoc) {
...
//
////////////////////////////////////////////////////////////////////////////
void CMainFrame::OnBackgroundBMP(void) {
...
//
////////////////////////////////////////////////////////////////////////////
void CMainFrame::OnSaveSettings(void) {
...
//
////////////////////////////////////////////////////////////////////////////
void CMainFrame::OnLoadSettings(void) {
  // Get the active document
  CW3DViewDoc *pCDoc = (CW3DViewDoc *)GetActiveDocument();
  if (pCDoc) {
    CFileDialog openFileDialog(TRUE, ".dat", NULL, OFN_HIDEREADONLY | OFN_OVERWRITEPROMPT | OFN_EXPLORER,
...
//
////////////////////////////////////////////////////////////////////////////
void CMainFrame::OnLODSetSwitch(void) {
...
//
////////////////////////////////////////////////////////////////////////////
void CMainFrame::OnLODSave(void) {
...
//
////////////////////////////////////////////////////////////////////////////
void CMainFrame::OnLODSaveAll(void) {
...
//
////////////////////////////////////////////////////////////////////////////
void CMainFrame::OnBackgroundObject(void) {
...
//
////////////////////////////////////////////////////////////////////////////
void CMainFrame::OnViewAnimationBar(void) {
...
//
////////////////////////////////////////////////////////////////////////////
void CMainFrame::OnViewObjectBar(void) {
...
//
////////////////////////////////////////////////////////////////////////////
void CMainFrame::OnAniStepFwd(void) {
  // Get the current doc
  CW3DViewDoc *pCDoc = (CW3DViewDoc *)GetActiveDocument();
  if (pCDoc) {
...
//
////////////////////////////////////////////////////////////////////////////
void CMainFrame::OnAniStepBkwd(void) {
  // Get the current doc
  CW3DViewDoc *pCDoc = (CW3DViewDoc *)GetActiveDocument();
  if (pCDoc) {
...
//
////////////////////////////////////////////////////////////////////////////
void CMainFrame::OnCameraAllowRotateX(void) {
  // Get the graphic view
  CGraphicView *pCGraphicView = (CGraphicView *)m_wndSplitter.GetPane(0, 1);
  if (pCGraphicView) {
...
//
////////////////////////////////////////////////////////////////////////////
void CMainFrame::OnCameraAllowRotateY(void) {
  // Get the graphic view
  CGraphicView *pCGraphicView = (CGraphicView *)m_wndSplitter.GetPane(0, 1);
  if (pCGraphicView) {
...
//
////////////////////////////////////////////////////////////////////////////
void CMainFrame::OnCameraAllowRotateZ(void) {
  // Get the graphic view
  CGraphicView *pCGraphicView = (CGraphicView *)m_wndSplitter.GetPane(0, 1);
  if (pCGraphicView) {
...
//
////////////////////////////////////////////////////////////////////////////
void CMainFrame::OnUpdateCameraAllowRotateX(CCmdUI *pCmdUI) {
  // Get the graphic view
  CGraphicView *pCGraphicView = (CGraphicView *)m_wndSplitter.GetPane(0, 1);
  if (pCGraphicView) {
...
//
////////////////////////////////////////////////////////////////////////////
void CMainFrame::OnUpdateCameraAllowRotateY(CCmdUI *pCmdUI) {
  // Get the graphic view
  CGraphicView *pCGraphicView = (CGraphicView *)m_wndSplitter.GetPane(0, 1);
  if (pCGraphicView) {
    // Either turn the check on or off depending on the view's settings
...
//
////////////////////////////////////////////////////////////////////////////
void CMainFrame::OnUpdateCameraAllowRotateZ(CCmdUI *pCmdUI) {
  // Get the graphic view
  CGraphicView *pCGraphicView = (CGraphicView *)m_wndSplitter.GetPane(0, 1);
  if (pCGraphicView) {
    // Either turn the check on or off depending on the view's settings
...
//
////////////////////////////////////////////////////////////////////////////
void CMainFrame::OnUpdateObjectRotateX(CCmdUI *pCmdUI) {
  CGraphicView *pCGraphicView = (CGraphicView *)m_wndSplitter.GetPane(0, 1);
  ASSERT(pCGraphicView);
  if (pCGraphicView) {
...
//
////////////////////////////////////////////////////////////////////////////
void CMainFrame::OnUpdateObjectRotateY(CCmdUI *pCmdUI) {
  CGraphicView *pCGraphicView = (CGraphicView *)m_wndSplitter.GetPane(0, 1);
  ASSERT(pCGraphicView);
  if (pCGraphicView) {
...
//
////////////////////////////////////////////////////////////////////////////
void CMainFrame::OnUpdateObjectRotateZ(CCmdUI *pCmdUI) {
  CGraphicView *pCGraphicView = (CGraphicView *)m_wndSplitter.GetPane(0, 1);
  ASSERT(pCGraphicView);
  if (pCGraphicView) {
    ...
    if (deviceSelDialog.DoModal() == IDOK) {
      ...
      if (bReturn) {
        ...
        if (::strstr(driver_name, "glide2") != NULL) {
          ...
          if ((is_voodoo2 && (driver_version < 2.54F)) || ((is_voodoo2 == false) && (driver_version < 2.46F))) {
...
//
////////////////////////////////////////////////////////////////////////////
void CMainFrame::OnDeviceChange(void) {
#ifdef WW3D_DX8
  Select_Device(true);
#else
...
//
////////////////////////////////////////////////////////////////////////////
void CMainFrame::OnCreateEmitter(void) {
...
//
////////////////////////////////////////////////////////////////////////////
void CMainFrame::OnEditEmitter(void) {
...
//
////////////////////////////////////////////////////////////////////////////
void CMainFrame::OnScaleEmitter(void) {
  // Get a pointer to the doc object
  CW3DViewDoc *pdoc = (CW3DViewDoc *)GetActiveDocument();
  if (pdoc != NULL) {
...
//
////////////////////////////////////////////////////////////////////////////
void CMainFrame::OnSaveEmitter(void) {
...
//
////////////////////////////////////////////////////////////////////////////
void CMainFrame::OnUpdateSaveEmitter(CCmdUI *pCmdUI) {
  pCmdUI->Enable(m_currentAssetType == TypeEmitter);
  return;
}
...
//
////////////////////////////////////////////////////////////////////////////
void CMainFrame::OnBoneAutoAssign(void) {
...
//
////////////////////////////////////////////////////////////////////////////
void CMainFrame::OnBoneManagement(void) {
...
//
////////////////////////////////////////////////////////////////////////////
void CMainFrame::OnSaveAggregate(void) {
...
//
////////////////////////////////////////////////////////////////////////////
void CMainFrame::OnUpdateLodSave(CCmdUI *pCmdUI) {
...
//
////////////////////////////////////////////////////////////////////////////
void CMainFrame::OnUpdateSaveAggregate(CCmdUI *pCmdUI) {
...
void CMainFrame::OnDestroy(void) {
  ...
  // Cache this information in the registry
  theApp.WriteProfileInt("Config", "AnimateCamera", (int)((CW3DViewDoc *)GetActiveDocument())->Is_Camera_Animated());

  // Cache this information in the registry
  theApp.WriteProfileInt("Config", "ResetCamera", (int)((CW3DViewDoc *)GetActiveDocument())->Is_Camera_Auto_Reset_On());
...
//
////////////////////////////////////////////////////////////////////////////
void CMainFrame::OnDecLight(void) {
...
//
////////////////////////////////////////////////////////////////////////////
void CMainFrame::OnIncLight(void) {
  CW3DViewDoc *pdoc = ::GetCurrentDocument();
  LightClass *plight = pdoc->GetSceneLight();
  if (plight != NULL) {
...
void CMainFrame::OnUpdateLightingExpose(CCmdUI *pcmdui) { pcmdui->SetCheck(WW3D::Expose_Prelit()); }
...
//
////////////////////////////////////////////////////////////////////////////
void CMainFrame::OnMakeAggregate(void) {
...
//
////////////////////////////////////////////////////////////////////////////
void CMainFrame::OnRenameAggregate(void) {
...
//
////////////////////////////////////////////////////////////////////////////
void CMainFrame::OnCrashApp(void) {
...
//
////////////////////////////////////////////////////////////////////////////
void CMainFrame::OnLODRecordScreenArea(void) {
...
//
////////////////////////////////////////////////////////////////////////////
void CMainFrame::OnLodPrevLevel(void) {
...
//
////////////////////////////////////////////////////////////////////////////
void CMainFrame::OnUpdateLodPrevLevel(CCmdUI *pCmdUI) {
  // Make sure the current object is an LOD
  RenderObjClass *prender_obj = (::GetCurrentDocument())->GetDisplayedObject();
  if ((prender_obj != NULL) && (prender_obj->Class_ID() == RenderObjClass::CLASSID_HLOD)) {
...
//
////////////////////////////////////////////////////////////////////////////
void CMainFrame::OnLodNextLevel(void) {
  ::GetCurrentDocument()->Switch_LOD(1);
  return;
}
...
//
////////////////////////////////////////////////////////////////////////////
void CMainFrame::OnUpdateLodNextLevel(CCmdUI *pCmdUI) {
  // Make sure the current object is an LOD
  RenderObjClass *prender_obj = (::GetCurrentDocument())->GetDisplayedObject();
  if ((prender_obj != NULL) && (prender_obj->Class_ID() == RenderObjClass::CLASSID_HLOD)) {
...
//
////////////////////////////////////////////////////////////////////////////
void CMainFrame::OnLodAutoswitch(void) {
...
//
////////////////////////////////////////////////////////////////////////////
void CMainFrame::OnUpdateLodAutoswitch(CCmdUI *pCmdUI) {
  ViewerSceneClass *pscene = ::GetCurrentDocument()->GetScene();
...
//
////////////////////////////////////////////////////////////////////////////
void CMainFrame::OnUpdateMakeMovie(CCmdUI *pCmdUI) {
...
//
////////////////////////////////////////////////////////////////////////////
void CMainFrame::OnMakeMovie(void) {
...
//
////////////////////////////////////////////////////////////////////////////
void CMainFrame::OnSaveScreenshot(void) {
  // Get the directory where this executable was run from
  TCHAR filename[MAX_PATH];
  ::GetModuleFileName(NULL, filename, sizeof(filename));
...
//
////////////////////////////////////////////////////////////////////////////
void CMainFrame::OnUpdateAdvancedAnim(CCmdUI *pCmdUI) {
...
//
////////////////////////////////////////////////////////////////////////////
void CMainFrame::OnCameraSettings(void) {
...
//
////////////////////////////////////////////////////////////////////////////
void CMainFrame::OnCopyScreenSize(void) {
  //
...
//
////////////////////////////////////////////////////////////////////////////
void CMainFrame::OnListMissingTextures(void) {
  //
...
//
////////////////////////////////////////////////////////////////////////////
void CMainFrame::OnTexturePath(void) {
...
//
////////////////////////////////////////////////////////////////////////////
void CMainFrame::OnChangeResolution(void) {
#ifdef WW3D_DX8
...
//
////////////////////////////////////////////////////////////////////////////
void CMainFrame::OnCreateSphere(void) {
  // Clear the current display
  CW3DViewDoc *doc = (CW3DViewDoc *)GetActiveDocument();
  if (doc) {
...
//
////////////////////////////////////////////////////////////////////////////
void CMainFrame::OnCreateRing(void) {
  // Clear the current display
  CW3DViewDoc *doc = (CW3DViewDoc *)GetActiveDocument();
  if (doc) {
    doc->DisplayObject((RenderObjClass *)NULL);
...
//
////////////////////////////////////////////////////////////////////////////
void CMainFrame::OnEditPrimitive(void) {
  // Get a pointer to the doc object
  CW3DViewDoc *doc = (CW3DViewDoc *)GetActiveDocument();
  if (doc != NULL) {
...
//
////////////////////////////////////////////////////////////////////////////
void CMainFrame::OnExportPrimitive(void) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnAddToLineup(void) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnImportFacialAnims(void) {
  //
  ...
  if (htree != NULL) {
    ...
    CFileDialog dialog(TRUE, ".txt", NULL, OFN_HIDEREADONLY | OFN_OVERWRITEPROMPT | OFN_ALLOWMULTISELECT | OFN_EXPLORER,
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnCreateSoundObject(void) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnEditSoundObject(void) {
  //
  // Get a pointer to the doc object
  //
  CW3DViewDoc *doc = (CW3DViewDoc *)GetActiveDocument();
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnExportSoundObj(void) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnUpdateExportSoundObj(CCmdUI *pCmdUI) {
  pCmdUI->Enable(m_currentAssetType == TypeSound);
  return;
}
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnEditAnimatedSoundsOptions(void) {
