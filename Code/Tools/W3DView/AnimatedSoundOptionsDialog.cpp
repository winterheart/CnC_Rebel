...
void AnimatedSoundOptionsDialogClass::OnSoundDefinitionLibraryBrowseButton(void) {
  CFileDialog dialog(TRUE, ".ddb", "20480.ddb", OFN_HIDEREADONLY | OFN_OVERWRITEPROMPT | OFN_EXPLORER,
...
void AnimatedSoundOptionsDialogClass::OnSoundIniBrowseButton(void) {
  CFileDialog dialog(TRUE, ".ini", "w3danimsound.ini", OFN_HIDEREADONLY | OFN_OVERWRITEPROMPT | OFN_EXPLORER,
...
void AnimatedSoundOptionsDialogClass::OnSoundPathBrowseButton(void) {
  RestrictedFileDialogClass dialog(TRUE, ".wav", "test.wav", OFN_HIDEREADONLY | OFN_EXPLORER, "Directories|*.wav||",
                                   AfxGetMainWnd());
