...
//  EmitterPropertySheetClass
//
EmitterPropertySheetClass::EmitterPropertySheetClass(EmitterInstanceListClass *emitter_list, UINT nIDCaption,
                                                     CWnd *pParentWnd)
...
//  EmitterPropertySheetClass
//
EmitterPropertySheetClass::EmitterPropertySheetClass(EmitterInstanceListClass *emitter_list, LPCTSTR pszCaption,
                                                     CWnd *pParentWnd)
...
void EmitterPropertySheetClass::Initialize(void) {
  ...
  /*if (m_pEmitter != NULL) {
          ...
          proto = (ParticleEmitterPrototypeClass *)WW3DAssetManager::Get_Instance ()->Find_Prototype
  (m_pEmitter->Get_Name ()); if (proto != NULL) { ParticleEmitterDefClass *definition = proto->Get_Definition ();
...
void EmitterPropertySheetClass::Create_New_Emitter(void) {
  ...
  emitter = new ParticleEmitterClass(10, 1, new Vector3SolidBoxRandomizer(Vector3(0.1F, 0.1F, 0.1F)), Vector3(0, 0, 1),
                                     new Vector3SolidBoxRandomizer(Vector3(0, 0, 0.1F)), 0, 0, color, opacity, size,
                                     rotation, 0.0f, frames, blurtimes, Vector3(0, 0, 0), 1.0F, NULL,
                                     ShaderClass::_PresetAdditiveSpriteShader, 0);
