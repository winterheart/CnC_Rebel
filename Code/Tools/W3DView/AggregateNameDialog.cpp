...
//	AggregateNameDialogClass
//
AggregateNameDialogClass::AggregateNameDialogClass(UINT resource_id, const CString &def_name, CWnd *pParent)
    : m_Name(def_name), CDialog(resource_id, pParent) {
  return;
}
...
//	OnOK
//
void AggregateNameDialogClass::OnOK(void) {
...
//	OnInitDialog
//
BOOL AggregateNameDialogClass::OnInitDialog(void) {
