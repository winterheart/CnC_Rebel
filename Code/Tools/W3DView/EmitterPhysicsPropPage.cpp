...
EmitterPhysicsPropPageClass::EmitterPhysicsPropPageClass(EmitterInstanceListClass *pemitter)
    : m_pEmitterList(NULL), m_bValid(true), m_Velocity(0, 0, 1), m_Acceleration(0, 0, 0), m_OutFactor(0),
      m_InheritanceFactor(0), m_Randomizer(NULL), CPropertyPage(EmitterPhysicsPropPageClass::IDD) {
...
//
/////////////////////////////////////////////////////////////
void EmitterPhysicsPropPageClass::Initialize(void) {
  SAFE_DELETE(m_Randomizer);
...
//
/////////////////////////////////////////////////////////////
BOOL EmitterPhysicsPropPageClass::OnInitDialog(void) {
  // Allow the base class to process this message
...
//
/////////////////////////////////////////////////////////////
BOOL EmitterPhysicsPropPageClass::OnApply(void) {
  //
...
//
/////////////////////////////////////////////////////////////
void EmitterPhysicsPropPageClass::OnSpecifyVelocityRandom(void) {
...
//
/////////////////////////////////////////////////////////////
void EmitterPhysicsPropPageClass::On_Setting_Changed(UINT ctrl_id) {
  switch (ctrl_id) {
  case IDC_VELOCITY_X_EDIT:
  case IDC_VELOCITY_Y_EDIT:
  case IDC_VELOCITY_Z_EDIT:
