...
EmitterLineGroupPropPageClass::EmitterLineGroupPropPageClass()
    : CPropertyPage(EmitterLineGroupPropPageClass::IDD), m_pEmitterList(NULL), m_bValid(true), m_BlurTimeBar(NULL),
      m_Lifetime(0), m_MinBlurTime(0), m_MaxBlurTime(1) {
...
//
/////////////////////////////////////////////////////////////
void EmitterLineGroupPropPageClass::Initialize(void) {
  SAFE_DELETE_ARRAY(m_BlurTimes.KeyTimes);
  SAFE_DELETE_ARRAY(m_BlurTimes.Values);
...
BOOL EmitterLineGroupPropPageClass::OnInitDialog() {
  ...
  //
  for (UINT index = 0; index < m_BlurTimes.NumKeyFrames; index++) {
    m_BlurTimeBar->Modify_Point(index + 1, m_BlurTimes.KeyTimes[index] / m_Lifetime, 0, 0, 0);
...
//
/////////////////////////////////////////////////////////////
void EmitterLineGroupPropPageClass::Update_Blur_Times(void) {
  float position = 0;
  float red = 0;
  float green = 0;
  float blue = 0;
...
//
/////////////////////////////////////////////////////////////
void EmitterLineGroupPropPageClass::On_Lifetime_Changed(float lifetime) {
