...
RingColorPropPageClass::RingColorPropPageClass(RingRenderObjClass *ring)
    : m_RenderObj(ring), m_bValid(true), m_ColorBar(NULL), m_OpacityBar(NULL),
...
//
/////////////////////////////////////////////////////////////
RingColorPropPageClass::~RingColorPropPageClass(void) { return; }
...
//
/////////////////////////////////////////////////////////////
void RingColorPropPageClass::DoDataExchange(CDataExchange *pDX) {
...
//
/////////////////////////////////////////////////////////////
void RingColorPropPageClass::Initialize(void) {
...
//
/////////////////////////////////////////////////////////////
BOOL RingColorPropPageClass::OnInitDialog(void) {
...
//
/////////////////////////////////////////////////////////////
BOOL RingColorPropPageClass::OnApply(void) {
  // Allow the base class to process this message
...
//
/////////////////////////////////////////////////////////////
void RingColorPropPageClass::OnDestroy(void) {
...
//
/////////////////////////////////////////////////////////////
BOOL RingColorPropPageClass::OnNotify(WPARAM wParam, LPARAM lParam, LRESULT *pResult) {
...
//
/////////////////////////////////////////////////////////////
void RingColorPropPageClass::OnCancel(void) {
  //
...
//
/////////////////////////////////////////////////////////////
void RingColorPropPageClass::Update_Opacities(void) {
  m_AlphaChannel.Reset();
...
//
/////////////////////////////////////////////////////////////
void RingColorPropPageClass::Update_Colors(void) {
  m_ColorChannel.Reset();
