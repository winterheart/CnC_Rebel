...
//  OnInitDialog
//
BOOL CBackgroundColorDialog::OnInitDialog(void) {
...
//  OnGrayscaleCheck
//
void CBackgroundColorDialog::OnGrayscaleCheck(void) {
  if (SendDlgItemMessage(IDC_GRAYSCALE_CHECK, BM_GETCHECK)) {
...
//  OnCancel
//
void CBackgroundColorDialog::OnCancel(void) {
  Vector3 colorSettings;
...
//
LRESULT
CBackgroundColorDialog::WindowProc(UINT message, WPARAM wParam, LPARAM lParam) {
  if (message == WM_PAINT) {
