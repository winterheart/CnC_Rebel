...
EmitterGeneralPropPageClass::EmitterGeneralPropPageClass(EmitterInstanceListClass *pemitter)
    : m_pEmitterList(NULL), m_Parent(NULL), m_bValid(true), m_Lifetime(0),
...
//  ~EmitterGeneralPropPageClass
//
EmitterGeneralPropPageClass::~EmitterGeneralPropPageClass(void) { return; }
...
//  Add_Shader_To_Combo
//
void EmitterGeneralPropPageClass::Add_Shader_To_Combo(ShaderClass &shader, LPCTSTR name) {
...
//  OnInitDialog
//
BOOL EmitterGeneralPropPageClass::OnInitDialog(void) {
  // Allow the base class to process this message
...
//  OnApply
//
BOOL EmitterGeneralPropPageClass::OnApply(void) {
  ...
  if (m_EmitterName.GetLength() == 0) {
    ::MessageBox(m_hWnd, "Invalid emitter name.  Please enter a new name.", "Invalid settings",
...
void EmitterGeneralPropPageClass::OnBrowseButton(void) {
  CFileDialog openFileDialog(TRUE, ".tga", NULL, OFN_HIDEREADONLY | OFN_OVERWRITEPROMPT | OFN_EXPLORER,
...
//
void EmitterGeneralPropPageClass::OnChangeFilenameEdit(void) {
  SetModified();
  return;
}
...
//  OnChangeNameEdit
//
void EmitterGeneralPropPageClass::OnChangeNameEdit(void) {
  SetModified();
  return;
}
...
//
void EmitterGeneralPropPageClass::OnChangeParticleLifetimeEdit(void) {
  SetModified();
  return;
}
...
//
void EmitterGeneralPropPageClass::OnSelchangeShaderCombo(void) {
  SetModified();
  return;
}
...
//
/////////////////////////////////////////////////////////////
void EmitterGeneralPropPageClass::OnParticleLifetimeCheck(void) {
