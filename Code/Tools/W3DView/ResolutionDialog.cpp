...
//
/////////////////////////////////////////////////////////////////////////////
ResolutionDialogClass::ResolutionDialogClass(CWnd *pParent /*=NULL*/) : CDialog(ResolutionDialogClass::IDD, pParent) {
...
//
/////////////////////////////////////////////////////////////////////////////
BOOL ResolutionDialogClass::OnInitDialog(void) {
  ...
  while (index--) {
    ...
    if (list_index >= 0) {
      ...
      //
      if (found == false && curr_width == width && curr_height == height && curr_bpp == bpp) {
...
//
/////////////////////////////////////////////////////////////////////////////
void ResolutionDialogClass::OnOK(void) {
  CDialog::OnOK();
...
//
/////////////////////////////////////////////////////////////////////////////
void ResolutionDialogClass::OnDblclkResolutionListCtrl(NMHDR *pNMHDR, LRESULT *pResult) {
  int list_index = m_ListCtrl.GetNextItem(-1, LVNI_ALL | LVNI_SELECTED);
  if (list_index >= 0) {
    OnOK();
  }
