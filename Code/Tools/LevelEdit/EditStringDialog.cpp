...
EditStringDialogClass::EditStringDialogClass(CWnd *pParent /*=NULL*/)
    : m_Object(NULL), CDialog(EditStringDialogClass::IDD, pParent) {
...
//
/////////////////////////////////////////////////////////////////////////////
void EditStringDialogClass::DoDataExchange(CDataExchange *pDX) {
...
//
/////////////////////////////////////////////////////////////////////////////
BOOL EditStringDialogClass::OnInitDialog(void) {
...
//
/////////////////////////////////////////////////////////////////////////////
void EditStringDialogClass::Convert_Newline_To_Chars(CString &string) {
  CString retval;
...
//
/////////////////////////////////////////////////////////////////////////////
void EditStringDialogClass::Convert_Chars_To_Newline(CString &string) {
  CString retval;
...
//
/////////////////////////////////////////////////////////////////////////////
void EditStringDialogClass::OnOK(void) {
  if (Validate_ID()) {
...
//
/////////////////////////////////////////////////////////////////////////////
bool EditStringDialogClass::Validate_ID(void) {
  bool retval = false;
...
bool Validate_String_ID(HWND wnd, const char *string_id) {
  ...
  if (code_id.GetLength() == 0) {
    ...
    //
    ::MessageBox(wnd, "Please enter a descriptive token for the code identifier.", "Invalid Code ID",
                 MB_ICONERROR | MB_OK);
    ...
    //
    ::MessageBox(wnd, "Code identifier is too short. Please enter a more descriptive token for the code identifier.",
                 "Invalid Code ID", MB_ICONERROR | MB_OK);
    ...
    //
    ::MessageBox(wnd,
                 "The code identifier must begin with a character (not a number), please enter a valid identifier.",
                 "Invalid Code ID", MB_ICONERROR | MB_OK);
    ...
    if (is_valid == false) {
      ...
      //
      ::MessageBox(wnd,
                   "The code identifier can only contain characters (a-z, A-Z), numbers (0-9), and the underscore "
                   "character (_), please enter a valid identifier.",
                   "Invalid Code ID", MB_ICONERROR | MB_OK);
