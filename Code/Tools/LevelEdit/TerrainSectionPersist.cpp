...
enum { CHUNKID_VARIABLES = 0x10251130, CHUNKID_TERRAIN_SECTION_INFO, CHUNKID_SECTION_PERSISTDATA };
...
TerrainSectionPersistClass::TerrainSectionPersistClass(void)
    : m_Position(0, 0, 0), m_DefinitionID(0), m_InstanceID(0), m_VisObjectID(0), m_VisSectorID(0), m_CullLink(-1) {
  return;
}
...
//
//////////////////////////////////////////////////////////////////////////////
TerrainSectionPersistClass::~TerrainSectionPersistClass(void) { return; }
...
//
//////////////////////////////////////////////////////////////////////////////
void TerrainSectionPersistClass::Apply(NodeClass *node) {
  SANITY_CHECK(node != NULL) { return; }
...
//
//////////////////////////////////////////////////////////////////////////////
void TerrainSectionPersistClass::Initialize(NodeClass *node) {
  SANITY_CHECK(node != NULL) { return; }
...
//
/////////////////////////////////////////////////////////////////
bool TerrainSectionPersistClass::Save(ChunkSaveClass &csave) {
...
//
/////////////////////////////////////////////////////////////////
bool TerrainSectionPersistClass::Load(ChunkLoadClass &cload) {
...
//
/////////////////////////////////////////////////////////////////
bool TerrainSectionPersistClass::Save_Variables(ChunkSaveClass &csave) {
...
//
/////////////////////////////////////////////////////////////////
bool TerrainSectionPersistClass::Load_Variables(ChunkLoadClass &cload) {
...
//
/////////////////////////////////////////////////////////////////
void TerrainSectionPersistListClass::Build_List(DynamicVectorClass<NodeClass *> &node_list) {
  Free_List();
...
//
//////////////////////////////////////////////////////////////////////////////
void TerrainSectionPersistListClass::Free_List(void) {
  //
...
//
/////////////////////////////////////////////////////////////////
void TerrainSectionPersistListClass::Save(ChunkSaveClass &csave) {
  //
...
//
/////////////////////////////////////////////////////////////////
void TerrainSectionPersistListClass::Load(ChunkLoadClass &cload) {
  Free_List();
...
//
////////////////////////////////////////////////////////////////
void TerrainSectionPersistListClass::Initialize_Virgin_Sections(void) {
  //
...
//
////////////////////////////////////////////////////////////////
void TerrainSectionPersistListClass::Assign_Section_IDs(TerrainNodeClass *node) {
