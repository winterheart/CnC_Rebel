...
//
//////////////////////////////////////////////////////////////////////
bool MixFileDatabaseClass::Open_Database(LPCTSTR ini_filename, LPCTSTR username, LPCTSTR password) {
  //
...
//
//////////////////////////////////////////////////////////////////////
bool MixFileDatabaseClass::Check_Out(LPCTSTR local_filename, bool get_locally) {
  bool retval = true;
...
//
//////////////////////////////////////////////////////////////////////
bool MixFileDatabaseClass::Get(LPCTSTR local_filename) {
...
//
//////////////////////////////////////////////////////////////////////
bool MixFileDatabaseClass::Internal_Get(LPCTSTR filename, LPCSTR local_path) {
  bool retval = false;
...
bool MixFileDatabaseClass::Copy_File(FileClass *src_file, LPCTSTR local_filename) {
  if (src_file == NULL || local_filename == NULL || ::GetFileAttributes(local_filename) != 0xFFFFFFFF) {
    return false;
  }
...
//
//////////////////////////////////////////////////////////////////////
bool MixFileDatabaseClass::Does_File_Exist(LPCTSTR local_filename) {
  bool retval = false;
...
//
//////////////////////////////////////////////////////////////////////////////////
bool MixFileDatabaseClass::Is_Texture(LPCSTR filename) {
...
//
//////////////////////////////////////////////////////////////////////////////////
void MixFileDatabaseClass::Swap_Texture_Extension(StringClass &filename) {
...
//
//////////////////////////////////////////////////////////////////////////////////
void MixFileDatabaseClass::Find_Files(DynamicVectorClass<StringClass> &file_list, LPCTSTR search_mask) {
  //
...
//
//////////////////////////////////////////////////////////////////////////////////
bool MixFileDatabaseClass::Get_All(LPCTSTR dest_path, LPCTSTR search_mask) {
...
//
///////////////////////////////////////////////////////////////////
void MixFileDatabaseClass::Get_Filename(LPCTSTR path, StringClass &filename) {
  filename = path;
  ::strlwr(filename.Peek_Buffer());
  ...
  if (subdir_token != NULL) {
    ...
    //
    size_t index = (subdir_token - filename.Peek_Buffer());
    for (; index > 0; index--) {
      if (filename[index] == '\\') {
