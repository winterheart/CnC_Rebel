...
//	Constants
///////////////////////////////////////////////////////////////////////
enum { CHUNKID_VARIABLES = 0x00000100, CHUNKID_NODES };
...
//
//////////////////////////////////////////////////////////////////////////////////////////
NodeMgrClass::~NodeMgrClass(void) { return; }
...
//
//////////////////////////////////////////////////////////////////////////////////////////
uint32 NodeMgrClass::Chunk_ID(void) const { return CHUNKID_NODEMGR; }
...
//
//////////////////////////////////////////////////////////////////////////////////////////
void NodeMgrClass::Setup_Node_Identity(NodeClass &node) {
...
//
//////////////////////////////////////////////////////////////////////////////////////////
void NodeMgrClass::Add_Node(NodeClass *node) {
...
//
//////////////////////////////////////////////////////////////////////////////////////////
void NodeMgrClass::Remove_Node(NodeClass *node) {
  WWASSERT(node != 0);
...
//
////////////////////////////////////////////////////////////////////////////
void NodeMgrClass::Link_Node(NodeClass *node) {
  WWASSERT(node->m_NextNode == 0);
  WWASSERT(node->m_PrevNode == 0);
...
//
////////////////////////////////////////////////////////////////////////////
void NodeMgrClass::Unlink_Node(NodeClass *node) {
  WWASSERT(node != 0);
...
NodeClass *NodeMgrClass::Find_Node(uint32 id) {
  ...
  for (NodeClass *node = _NodeListHead; (req_node == NULL) && (node != NULL); node = node->m_NextNode) {
    //
...
//
///////////////////////////////////////////////////////////////////////
NodeClass *NodeMgrClass::Get_Next(NodeClass *node) { return node->m_NextNode; }
...
//
///////////////////////////////////////////////////////////////////////
bool NodeMgrClass::Contains_Data(void) const { return (_NodeListHead != NULL); }
...
//
///////////////////////////////////////////////////////////////////////
bool NodeMgrClass::Save(ChunkSaveClass &csave) {
  bool retval = true;
...
//
///////////////////////////////////////////////////////////////////////
bool NodeMgrClass::Load(ChunkLoadClass &cload) {
  bool retval = true;
...
//
///////////////////////////////////////////////////////////////////////
bool NodeMgrClass::Save_Node_List(ChunkSaveClass &csave, NODE_LIST &node_list) {
  //
...
//
///////////////////////////////////////////////////////////////////////
bool NodeMgrClass::Load_Node_List(ChunkLoadClass &cload, NODE_LIST &node_list) {
  while (cload.Open_Chunk()) {
...
//
///////////////////////////////////////////////////////////////////////
bool NodeMgrClass::Load_Nodes(ChunkLoadClass &cload) {
  bool retval = true;
...
//
///////////////////////////////////////////////////////////////////////
void NodeMgrClass::On_Post_Load(void) {
...
//
///////////////////////////////////////////////////////////////////////
bool NodeMgrClass::Load_Variables(ChunkLoadClass &cload) {
  bool retval = true;
...
//
///////////////////////////////////////////////////////////////////////
void NodeMgrClass::Reload_Nodes(void) {
...
//
///////////////////////////////////////////////////////////////////////
void NodeMgrClass::Reload_Nodes(PresetClass *preset) {
  ::Get_Main_View()->Allow_Repaint(false);
...
//
///////////////////////////////////////////////////////////////////////
void NodeMgrClass::Put_Objects_Back(const NODE_LIST &obj_list) {
  //
...
//
///////////////////////////////////////////////////////////////////////
void NodeMgrClass::Remove_Dynamic_Objects(NODE_LIST &dynamic_obj_list) {
  //
...
//
///////////////////////////////////////////////////////////////////////
void NodeMgrClass::Remove_Static_Objects(NODE_LIST &static_obj_list) {
  //
  //	Build a list of nodes to that are not dynamic
  //
  for (NodeClass *node = NodeMgrClass::Get_First(); node != NULL; node = NodeMgrClass::Get_Next(node)) {
...
//
///////////////////////////////////////////////////////////////////////
uint32 NodeMgrClass::Get_Max_Used_ID(void) {
  //
...
//
///////////////////////////////////////////////////////////////////////
bool NodeMgrClass::Verify_Unique_ID(uint32 id) {
...
//
///////////////////////////////////////////////////////////////////////
void NodeMgrClass::Make_Static_Anim_Phys_Collideable(bool onoff) {
  //
...
//
///////////////////////////////////////////////////////////////////////
void NodeMgrClass::Build_ID_Collision_List(NODE_LIST &node_list) {
...
//
///////////////////////////////////////////////////////////////////////
void NodeMgrClass::Build_Unimportant_ID_Collision_List(NODE_LIST &node_list) {
  CWaitCursor wait_cursor;
    ...
    for (int index2 = 0; index2 < full_node_list.Count(); index2++) {
      ...
      if (node1 != node2 && node1->Get_ID() == node2->Get_ID()) {
        if (node_list.ID(node1) == -1) {
          ...
          //
          if (node1->As_ObjectNodeClass() == NULL && node1->Get_Type() != NODE_TYPE_SPAWNER &&
              node1->Get_Type() != NODE_TYPE_TILE && node1->Get_Type() != NODE_TYPE_WAYPATH &&
              node1->Get_Type() != NODE_TYPE_WAYPOINT && node1->Get_Type() != NODE_TYPE_SOUND) {
            node_list.Add(node1);
          }
        }
      }
...
//
///////////////////////////////////////////////////////////////////////
void NodeMgrClass::Reset_New_ID(void) {
  //
...
//
///////////////////////////////////////////////////////////////////////
uint32 NodeMgrClass::Find_Max_Used_ID(NODE_TYPE type) {
  //
...
//
//////////////////////////////////////////////////////////////////////////////////////////
uint32 NodeMgrClass::Get_Node_ID(NODE_TYPE type) {
  uint32 new_id = 0;
...
//
///////////////////////////////////////////////////////////////////////
void NodeMgrClass::Get_ID_Range(NODE_TYPE type, uint32 *min_id, uint32 *max_id) {
  switch (type) {
  case NODE_TYPE_TERRAIN:
  case NODE_TYPE_TERRAIN_SECTION:
  case NODE_TYPE_TILE:
...
//
///////////////////////////////////////////////////////////////////////
void NodeMgrClass::Build_Full_Node_List(DynamicVectorClass<NodeClass *> &node_list) {
  //
...
//
///////////////////////////////////////////////////////////////////////
void NodeMgrClass::Add_Nodes_To_List(DynamicVectorClass<NodeClass *> &node_list, NodeClass *node) {
  node_list.Add(node);
...
//
///////////////////////////////////////////////////////////////////////
void NodeMgrClass::Create_All_Embedded_Nodes(void) {
  //
