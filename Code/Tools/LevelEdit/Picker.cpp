...
//
///////////////////////////////////////////////////////////
PickerClass::PickerClass(void) : m_BrowseButton(NULL), m_Icon(NULL), CStatic() {
  //
  //	By default load the folder icon
  //
  m_Icon = (HICON)::LoadImage(::AfxGetResourceHandle(), MAKEINTRESOURCE(IDI_FOLDER_TINY), IMAGE_ICON, 16, 16,
                              LR_DEFAULTCOLOR);
  return;
}
...
//
///////////////////////////////////////////////////////////
PickerClass::~PickerClass(void) { return; }
...
//
///////////////////////////////////////////////////////////
bool PickerClass::Create_Picker(DWORD style, const RECT &rect, CWnd *parent, UINT id) {
  //
  //	Create the outer window
  //
  BOOL success = CreateEx(WS_EX_CLIENTEDGE, "STATIC", "", (style | SS_WHITERECT | WS_CLIPCHILDREN) & (~WS_BORDER), rect,
                          parent, id);
  if (success) {
    Initialize_Control();
  }
...
///////////////////////////////////////////////////////////
LRESULT
PickerClass::WindowProc(UINT message, WPARAM wParam, LPARAM lParam) {
  //
  // Should we just pass this onto the edit control?
  //
  if ((message == WM_GETTEXT) || (message == WM_GETTEXTLENGTH) || (message == WM_SETTEXT)) {
    ...
    return ::SendMessage(::GetParent(m_hWnd), message, MAKEWPARAM(id & 0xFFFF, HIWORD(wParam)), (LPARAM)m_hWnd);
...
//
///////////////////////////////////////////////////////////
void PickerClass::Initialize_Control(void) {
  //
  ...
  CRect rect;
  GetClientRect(&rect);
  m_EditCtrl = ::CreateWindowEx(0, "EDIT", "", WS_CHILD | WS_VISIBLE | ES_AUTOHSCROLL, 2,
                                (rect.Height() >> 1) - ((size.cy) >> 1), rect.Width() - BUTTON_WIDTH - 3, size.cy,
                                m_hWnd, (HMENU)EDIT_ID, ::AfxGetInstanceHandle(), NULL);
  CRect rect2;
  GetWindowRect(&rect2);
  ...
  //
  m_BrowseButton =
      ::CreateWindow("BUTTON", "", WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON | BS_OWNERDRAW, rect.Width() - BUTTON_WIDTH, 0,
                     BUTTON_WIDTH, rect.Height(), m_hWnd, (HMENU)BUTTON_ID, ::AfxGetInstanceHandle(), NULL);
...
//
///////////////////////////////////////////////////////////
void PickerClass::OnSize(UINT nType, int cx, int cy) {
  ...
  //
  ::SetWindowPos(m_BrowseButton, NULL, client_rect.Width() - BUTTON_WIDTH, 0, BUTTON_WIDTH, client_rect.Height(),
                 SWP_NOZORDER);
...
//
///////////////////////////////////////////////////////////
BOOL PickerClass::OnCommand(WPARAM wParam, LPARAM lParam) {
  //
...
//
///////////////////////////////////////////////////////////
void PickerClass::OnDrawItem(int nIDCtl, LPDRAWITEMSTRUCT pDrawItemStruct) {
  CRect rect;
...
//
///////////////////////////////////////////////////////////
void PickerClass::Set_Read_Only(bool readonly) {
...
//
///////////////////////////////////////////////////////////
BOOL PickerClass::OnEraseBkgnd(CDC *pDC) {
  CRect rect;
