...
//
///////////////////////////////////////////////////////////////
MouseMgrClass::MouseMgrClass(void) : m_MouseMode(MODE_OBJECT_MANIPULATE), IsLButtonDown(false), IsRButtonDown(false) {
...
//
///////////////////////////////////////////////////////////////
void MouseMgrClass::Move_Node(NodeClass *node) {
...
//
///////////////////////////////////////////////////////////////
void MouseMgrClass::Set_Mouse_Mode(MOUSE_MODE new_mode) {
  //
...
//
///////////////////////////////////////////////////////////////
void MouseModeClass::Handle_LButton_Down(UINT flags, CPoint point) {
...
//
///////////////////////////////////////////////////////////////
void MouseModeClass::Handle_LButton_Up(UINT flags, CPoint point) {
...
//
///////////////////////////////////////////////////////////////
void MouseModeClass::Handle_RButton_Down(UINT flags, CPoint point) {
...
//
///////////////////////////////////////////////////////////////
void MouseModeClass::Handle_RButton_Up(UINT flags, CPoint point) {
...
//
///////////////////////////////////////////////////////////////
void MouseModeClass::Handle_Mouse_Move(UINT flags, CPoint point) {
  m_MousePoint = point;
  if (m_bUpdate) {
...
//
///////////////////////////////////////////////////////////////
void MMObjectManipulateClass::Change_Operation(OBJECT_MODE type) {
  if (type != m_ObjectMode) {

    // Let the scene editor know we are ending a previous operation
    if ((m_ObjectMode == MODE_MOVE) || (m_ObjectMode == MODE_ROTATE)) {
...
//
///////////////////////////////////////////////////////////////
void MMObjectManipulateClass::Handle_LButton_Dblclk(UINT flags, CPoint point) {
...
//
///////////////////////////////////////////////////////////////
void MMObjectManipulateClass::Handle_LButton_Down(UINT flags, CPoint point) {
  // Allow the base class to process this message
...
//
///////////////////////////////////////////////////////////////
void MMObjectManipulateClass::Handle_LButton_Up(UINT flags, CPoint point) {
...
//
///////////////////////////////////////////////////////////////
void MMObjectManipulateClass::Handle_RButton_Down(UINT flags, CPoint point) {
...
//
///////////////////////////////////////////////////////////////
void MMObjectManipulateClass::Handle_RButton_Up(UINT flags, CPoint point) {
...
//
///////////////////////////////////////////////////////////////
void MMObjectManipulateClass::Handle_Mouse_Move(UINT flags, CPoint point) {
  if (m_ObjectMode == MODE_SELECT) {
    if ((abs(point.x - m_LastMousePoint.x) > 3) || (abs(point.y - m_LastMousePoint.y) > 3)) {
...
//
///////////////////////////////////////////////////////////////
void MMObjectManipulateClass::Set_Move_Nodes_Mode(void) {
...
//
///////////////////////////////////////////////////////////////
void MMObjectManipulateClass::On_Mode_Set(void) {
  // Reset the state
  ::ReleaseCapture();
  Change_Operation(MODE_NONE);
  return;
...
//
///////////////////////////////////////////////////////////////
void MMObjectManipulateClass::Move_Selection(CPoint point) {
  if (m_ForceDropToGround || ::Get_Current_Document()->Get_Mode_Modifiers() & MODE_MOD_DROP_TO_GROUND) {
...
//
///////////////////////////////////////////////////////////////
void MMObjectManipulateClass::Rotate_Selection(CPoint point) {
  // Get the bouding rectangle of the main view
  CRect rect;
...
//
///////////////////////////////////////////////////////////////
void MMWaypathEditClass::Exit_Mode(void) {
  m_Waypath = NULL;
  m_CurrentPoint = -1;
...
//
///////////////////////////////////////////////////////////////
void MMWaypathEditClass::On_Mode_Exit(void) {
...
//
///////////////////////////////////////////////////////////////
void MMWaypathEditClass::Handle_LButton_Down(UINT flags, CPoint point) {
  /*NodeClass *node = ::Get_Scene_Editor ()->Find_Node_At_Point (point);
...
//
///////////////////////////////////////////////////////////////
void MMWaypathEditClass::Handle_LButton_Up(UINT flags, CPoint point) {
  if (m_Waypath != NULL && m_CurrentPoint >= 0) {
...
//
///////////////////////////////////////////////////////////////
void MMWaypathEditClass::Handle_RButton_Down(UINT flags, CPoint point) { return; }
...
//
///////////////////////////////////////////////////////////////
void MMWaypathEditClass::Handle_RButton_Up(UINT flags, CPoint point) { return; }
...
//
///////////////////////////////////////////////////////////////
void MMWaypathEditClass::Handle_Mouse_Move(UINT flags, CPoint point) {
  if (m_Waypath != NULL && m_CurrentPoint >= 0) {
...
//
///////////////////////////////////////////////////////////////
void MMWaypathEditClass::On_Mode_Set(void) {
  // Reset the state
  ::ReleaseCapture();
...
//
///////////////////////////////////////////////////////////////
void MMGrabHandleDragClass::Handle_LButton_Up(UINT flags, CPoint point) {
...
//
///////////////////////////////////////////////////////////////
void MMGrabHandleDragClass::Handle_Mouse_Move(UINT flags, CPoint point) {
  //
...
//
///////////////////////////////////////////////////////////////
void MMGrabHandleDragClass::Set_Node_Info(NodeClass *node, int vertex_index) {
  m_Node = node;
...
//
///////////////////////////////////////////////////////////////
void MMHeightfieldEditClass::Handle_LButton_Down(UINT flags, CPoint point) { return; }
...
//
///////////////////////////////////////////////////////////////
void MMHeightfieldEditClass::Handle_LButton_Up(UINT flags, CPoint point) { return; }
...
//
///////////////////////////////////////////////////////////////
void MMHeightfieldEditClass::Handle_RButton_Down(UINT flags, CPoint point) { return; }
...
//
///////////////////////////////////////////////////////////////
void MMHeightfieldEditClass::Handle_RButton_Up(UINT flags, CPoint point) { return; }
...
//
///////////////////////////////////////////////////////////////
void MMHeightfieldEditClass::On_Mode_Set(void) { return; }
...
//
///////////////////////////////////////////////////////////////
void MMHeightfieldEditClass::On_Mode_Exit(void) { return; }
