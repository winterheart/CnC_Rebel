...
//	Save/load constants
//////////////////////////////////////////////////////////////////////////////
enum { CHUNKID_VARIABLES = 0x10251200, CHUNKID_BASE_CLASS, CHUNKID_SCRIPT };
...
//
//////////////////////////////////////////////////////////////////////////////
SpawnerNodeClass::SpawnerNodeClass(PresetClass *preset) : m_PhysObj(NULL), m_SpawnerObj(NULL), NodeClass(preset) {
  return;
}
...
//
//////////////////////////////////////////////////////////////////////////////
SpawnerNodeClass::SpawnerNodeClass(const SpawnerNodeClass &src) : m_PhysObj(NULL), m_SpawnerObj(NULL), NodeClass(NULL) {
  *this = src;
  return;
}
...
//
//////////////////////////////////////////////////////////////////////////////
void SpawnerNodeClass::Initialize(void) {
  MEMBER_RELEASE(m_PhysObj);
  SAFE_DELETE(m_SpawnerObj);
...
//
////////////////////////////////////////////////////////////////
const PersistFactoryClass &SpawnerNodeClass::Get_Factory(void) const { return _SpawnerNodePersistFactory; }
...
//
/////////////////////////////////////////////////////////////////
bool SpawnerNodeClass::Save(ChunkSaveClass &csave) {
...
//
/////////////////////////////////////////////////////////////////
bool SpawnerNodeClass::Load(ChunkLoadClass &cload) {
  Free_Spawn_Points();
  Free_Scripts();
...
//
///////////////////////////////////////////////////////////////////////
void SpawnerNodeClass::On_Post_Load(void) {
  //
...
//
///////////////////////////////////////////////////////////////////////
bool SpawnerNodeClass::Load_Variables(ChunkLoadClass &cload) {
  //
...
//
////////////////////////////////////////////////////////////////
uint32 SpawnerNodeClass::Get_Spawned_Definition_ID(void) {
  uint32 id = 0;
...
//
/////////////////////////////////////////////////////////////////
const SpawnerNodeClass &SpawnerNodeClass::operator=(const SpawnerNodeClass &src) {
...
//
//////////////////////////////////////////////////////////////////////
void SpawnerNodeClass::Pre_Export(void) {
  //
...
//
//////////////////////////////////////////////////////////////////////
void SpawnerNodeClass::Post_Export(void) {
  //
...
//
//////////////////////////////////////////////////////////////////////////////
void SpawnerNodeClass::Add_To_Scene(void) {
  SceneEditorClass *scene = ::Get_Scene_Editor();
  Create_Spawner_Obj();
...
//
//////////////////////////////////////////////////////////////////////////////
void SpawnerNodeClass::Remove_From_Scene(void) {
  SAFE_DELETE(m_SpawnerObj);
...
//
//////////////////////////////////////////////////////////////////////
SpawnPointNodeClass *SpawnerNodeClass::Add_Spawn_Point(const Matrix3D &tm) {
  //
...
//
//////////////////////////////////////////////////////////////////////
void SpawnerNodeClass::Remove_Spawn_Point(SpawnPointNodeClass *spawn_point) {
  //
...
//
//////////////////////////////////////////////////////////////////////
void SpawnerNodeClass::Free_Spawn_Points(void) {
  SceneEditorClass *scene = ::Get_Scene_Editor();
...
//
//////////////////////////////////////////////////////////////////////////////
void SpawnerNodeClass::Update_Lines(void) {
  for (int index = 0; index < m_SpawnPointNodes.Count(); index++) {
    SpawnPointNodeClass *spawn_point = m_SpawnPointNodes[index];
    EditorLineClass *line = m_SpawnPointLines[index];
...
//
//////////////////////////////////////////////////////////////////////////////
NodeClass *SpawnerNodeClass::Add_Child_Node(const Matrix3D &tm) { return Add_Spawn_Point(tm); }
...
//
////////////////////////////////////////////////////////////////
bool SpawnerNodeClass::Show_Settings_Dialog(void) {
...
//
/////////////////////////////////////////////////////////////////
void SpawnerNodeClass::Copy_Scripts(const SpawnerNodeClass &src) {
  Free_Scripts();
...
//
/////////////////////////////////////////////////////////////////
void SpawnerNodeClass::Free_Scripts(void) {
  for (int index = 0; index < m_Scripts.Count(); index++) {
    EditScriptClass *script = m_Scripts[index];
    SAFE_DELETE(script);
  }
...
//
//////////////////////////////////////////////////////////////////////////////
NodeClass *SpawnerNodeClass::Get_Sub_Node(int index) { return m_SpawnPointNodes[index]; }
