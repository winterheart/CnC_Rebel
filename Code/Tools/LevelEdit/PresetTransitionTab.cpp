...
PresetTransitionTabClass::PresetTransitionTabClass(PresetClass *preset)
    : m_Preset(preset), m_Height(0), m_RenderObj(NULL), m_TransitionList(NULL),
...
//
/////////////////////////////////////////////////////////////////////////////
void PresetTransitionTabClass::DoDataExchange(CDataExchange *pDX) {
...
#ifdef _DEBUG
void PresetTransitionTabClass::AssertValid() const { DockableFormClass::AssertValid(); }

void PresetTransitionTabClass::Dump(CDumpContext &dc) const { DockableFormClass::Dump(dc); }
#endif //_DEBUG
...
//
/////////////////////////////////////////////////////////////////////////////
bool PresetTransitionTabClass::Apply_Changes(void) {
  // Assume success
  bool retval = true;
...
//
/////////////////////////////////////////////////////////////////////////////
void PresetTransitionTabClass::Insert_Transition(TransitionDataClass *transition) {
...
//
/////////////////////////////////////////////////////////////////////////////
void PresetTransitionTabClass::OnAddButton(void) {
  Create_Render_Obj();
...
//
/////////////////////////////////////////////////////////////////////////////
void PresetTransitionTabClass::OnDeleteButton(void) {
  //
...
//
/////////////////////////////////////////////////////////////////////////////
void PresetTransitionTabClass::OnItemChangedTransitionList(NMHDR *pNMHDR, LRESULT *pResult) {
...
//
/////////////////////////////////////////////////////////////////////////////
void PresetTransitionTabClass::Create_Render_Obj(void) {
...
//
/////////////////////////////////////////////////////////////////////////////
void PresetTransitionTabClass::OnDeleteitemTransitionList(NMHDR *pNMHDR, LRESULT *pResult) {
  NM_LISTVIEW *pNMListView = (NM_LISTVIEW *)pNMHDR;
  (*pResult) = 0;
...
//
/////////////////////////////////////////////////////////////////////////////
void PresetTransitionTabClass::OnDblclkTransitionList(NMHDR *pNMHDR, LRESULT *pResult) {
  (*pResult) = 0;
