...
//
//////////////////////////////////////////////////////////////////////
RCStringExtractorClass::RCStringExtractorClass(void) : CategoryIndex(0) { return; }
...
//
//////////////////////////////////////////////////////////////////////
bool RCStringExtractorClass::Find_String(StringClass &line, const char *keyword, const char *replacement,
...
//
//////////////////////////////////////////////////////////////////////
void RCStringExtractorClass::Process_Line(StringClass &line, int &current_index) {
  StringClass contents;

  const char *KEYWORDS[] = {"CAPTION", "LTEXT", "PUSHBUTTON", "CONTROL", "RTEXT", "CTEXT"};
...
//
//////////////////////////////////////////////////////////////////////////
void RCStringExtractorClass::Set_Src_RC_Filename(const char *full_path) {
...
//
//////////////////////////////////////////////////////////////////////////
void RCStringExtractorClass::Extract_Strings(void) {
  //
...
//
//////////////////////////////////////////////////////////////////////////
int RCStringExtractorClass::Find_Starting_Index(void) {
  int max_index = 0;
