...
//	Local inlines
///////////////////////////////////////////////////////////////////////////////////////////
inline int Get_Ctrl_Height(HWND hdlg, int dlg_units) {
  RECT temp_rect;
  temp_rect.left = 0;
  temp_rect.top = 0;
...
inline void Get_String_Size(HWND parent_wnd, LPCTSTR text, LPSIZE text_size) {
...
//	Local prototypes
///////////////////////////////////////////////////////////////////////////////////////////
void Create_Float_Ctrls(CWnd *parent_wnd, CEdit &edit_ctrl, CSpinButtonCtrl &spin_ctrl, const CRect &rect, int id1,
                        int id2);
...
//
//////////////////////////////////////////////////////////////////////
void Create_Static_Text_Controls(HWND parent_wnd, const CRect &control_rect, CStatic *left_text, LPCTSTR param_name,
                                 CStatic *right_text, LPCTSTR units_name, CRect *remaining_rect) {
  //
  ...
  //
  left_text->Create(param_name, WS_CHILD | WS_VISIBLE | SS_LEFT, text_rect, CWnd::FromHandle(parent_wnd));
  ...
  if (right_text != NULL) {
    ...
    //
    right_text->Create(units_name, WS_CHILD | WS_VISIBLE | SS_LEFT, text2_rect, CWnd::FromHandle(parent_wnd));
...
//
//////////////////////////////////////////////////////////////////////
void Resize_Controls(const CRect &rect, CWnd &left_wnd, CWnd &middle_wnd, CWnd &right_wnd) {
  //
  ...
  right_wnd.SetWindowPos(NULL, old_rect2.left + new_width + SPACE_WIDTH, old_rect3.top, 0, 0,
...
//
//////////////////////////////////////////////////////////////////////
int FileParameterCtrlClass::Create(HWND parent_wnd, int id_start, LPRECT pos) {
  ...
  //
  m_StaticText.Create(m_Parameter->Get_Name(), WS_CHILD | WS_VISIBLE | SS_LEFT, text_rect,
  ...
  //
  m_FilePicker.Create_Picker(WS_CHILD | WS_TABSTOP | WS_VISIBLE, picker_rect, CWnd::FromHandle(parent_wnd), id_start);

  m_FilePicker.SetWindowText(m_Parameter->Get_String());

  CString filter_string;
  filter_string.Format("%s (*%s)|*%s|All Files (*.*)|*.*||", m_Parameter->Get_Description(),
                       m_Parameter->Get_Extension(), m_Parameter->Get_Extension());
...
//
//////////////////////////////////////////////////////////////////////
void FileParameterCtrlClass::Resize(const CRect &rect) {
  CRect old_rect1;
  CRect old_rect2;
...
//
//////////////////////////////////////////////////////////////////////
bool FileParameterCtrlClass::Is_Modified(void) const {
  bool retval = false;
...
//
//////////////////////////////////////////////////////////////////////
void FileParameterCtrlClass::Read_Data(HWND /*parent_wnd*/) {
  CString path;
...
//
//////////////////////////////////////////////////////////////////////
void FileParameterCtrlClass::Get_Current_Value(CString &value) const {
  CString filename;
...
//
//////////////////////////////////////////////////////////////////////
int StringsDBEntryParameterCtrlClass::Create(HWND parent_wnd, int id_start, LPRECT pos) {
  int text_height = ::Get_Ctrl_Height(parent_wnd, TEXT_HEIGHT);
  ...
  //	Create the file picker control
  //
  m_StringPicker.Create_Picker(WS_CHILD | WS_TABSTOP | WS_VISIBLE, picker_rect, CWnd::FromHandle(parent_wnd), id_start);
...
//
//////////////////////////////////////////////////////////////////////
void StringsDBEntryParameterCtrlClass::Resize(const CRect &rect) {
  CRect old_rect1;
  CRect old_rect2;
  m_StaticText.GetWindowRect(&old_rect1);
...
//
//////////////////////////////////////////////////////////////////////
void StringsDBEntryParameterCtrlClass::Read_Data(HWND /*parent_wnd*/) {
...
//
//////////////////////////////////////////////////////////////////////
int SoundFileParameterCtrlClass::Create(HWND parent_wnd, int id_start, LPRECT pos) {
...
//
//////////////////////////////////////////////////////////////////////
int StringParameterCtrlClass::Create(HWND parent_wnd, int id_start, LPRECT pos) {
  int text_height = ::Get_Ctrl_Height(parent_wnd, TEXT_HEIGHT);
  ...
  //
  m_EditCtrl.Create(WS_CHILD | WS_TABSTOP | WS_VISIBLE, edit_rect, CWnd::FromHandle(parent_wnd), id_start++);
...
//
//////////////////////////////////////////////////////////////////////
void StringParameterCtrlClass::Resize(const CRect &rect) {
  CRect old_rect1;
  CRect old_rect2;
  m_StaticText.GetWindowRect(&old_rect1);
...
//
//////////////////////////////////////////////////////////////////////
void StringParameterCtrlClass::Read_Data(HWND /*parent_wnd*/) {
  CString text;
...
//
//////////////////////////////////////////////////////////////////////
int IntParameterCtrlClass::Create(HWND parent_wnd, int id_start, LPRECT pos) {
  ...
  //
  CRect edit_rect;
  Create_Static_Text_Controls(parent_wnd, *pos, &m_StaticText1, param_name, &m_StaticText2, units_name, &edit_rect);
  ...
  //
  m_SpinCtrl.Create(UDS_ARROWKEYS | UDS_SETBUDDYINT | UDS_AUTOBUDDY | UDS_ALIGNRIGHT | UDS_NOTHOUSANDS | WS_CHILD |
                        WS_VISIBLE,
                    CRect(0, 0, 50, 20), CWnd::FromHandle(parent_wnd), id_start++);
...
//
//////////////////////////////////////////////////////////////////////
void IntParameterCtrlClass::Resize(const CRect &rect) {
...
//
//////////////////////////////////////////////////////////////////////
void IntParameterCtrlClass::Read_Data(HWND /*parent_wnd*/) {
  CString text_value;
...
//
//////////////////////////////////////////////////////////////////////
int FloatParameterCtrlClass::Create(HWND parent_wnd, int id_start, LPRECT pos) {
  CString param_name = m_Parameter->Get_Name();
  CString units_name = m_Parameter->Get_Units_Name();
  ...
  //
  ::Create_Float_Ctrls(CWnd::FromHandle(parent_wnd), m_EditCtrl, m_SpinCtrl, edit_rect, id_start++, id_start++);
...
//
//////////////////////////////////////////////////////////////////////
void FloatParameterCtrlClass::Resize(const CRect &rect) {
  Resize_Controls(rect, m_StaticText1, m_EditCtrl, m_StaticText2);
  m_SpinCtrl.SetBuddy(&m_EditCtrl);
  return;
}
...
//
//////////////////////////////////////////////////////////////////////
void FloatParameterCtrlClass::Read_Data(HWND /*parent_wnd*/) {
...
//
//////////////////////////////////////////////////////////////////////
int AngleParameterCtrlClass::Create(HWND parent_wnd, int id_start, LPRECT pos) {
  CString param_name = m_Parameter->Get_Name();
  CString units_name = m_Parameter->Get_Units_Name();
...
//
//////////////////////////////////////////////////////////////////////
void AngleParameterCtrlClass::Resize(const CRect &rect) {
  Resize_Controls(rect, m_StaticText1, m_EditCtrl, m_StaticText2);
  m_SpinCtrl.SetBuddy(&m_EditCtrl);
  return;
}
...
//
//////////////////////////////////////////////////////////////////////
void AngleParameterCtrlClass::Read_Data(HWND /*parent_wnd*/) {
...
//
//////////////////////////////////////////////////////////////////////
int BoolParameterCtrlClass::Create(HWND parent_wnd, int id_start, LPRECT pos) {
  CString param_name = m_Parameter->Get_Name();
  ...
  //	Create the edit control
  //
  m_CheckBoxCtrl.Create(param_name, WS_CHILD | WS_TABSTOP | WS_VISIBLE | BS_AUTOCHECKBOX, check_rect,
                        CWnd::FromHandle(parent_wnd), id_start++);
...
//
//////////////////////////////////////////////////////////////////////
void BoolParameterCtrlClass::Resize(const CRect &rect) {
  CRect old_rect;
...
//
//////////////////////////////////////////////////////////////////////
void BoolParameterCtrlClass::Read_Data(HWND /*parent_wnd*/) {
...
//
//////////////////////////////////////////////////////////////////////
int Vector3ParameterCtrlClass::Create(HWND parent_wnd, int id_start, LPRECT pos) {
  int text_height = ::Get_Ctrl_Height(parent_wnd, TEXT_HEIGHT);
  int edit_height = ::Get_Ctrl_Height(parent_wnd, CTRL_HEIGHT);
  ...
  //	Create the static text control
  //
  m_GroupBox.Create(m_Parameter->Get_Name(), WS_CHILD | WS_TABSTOP | WS_VISIBLE | BS_GROUPBOX, group_rect,
                    CWnd::FromHandle(parent_wnd), id_start++);
  ...
  for (int index = 0; index < 3; index++) {
    ...
    ::Create_Float_Ctrls(CWnd::FromHandle(parent_wnd), m_EditCtrls[index], m_SpinCtrls[index],
                         CRect(0, y_pos, 10, y_pos + edit_height), id_start++, id_start++);
  }
...
//
//////////////////////////////////////////////////////////////////////
void Vector3ParameterCtrlClass::Resize(const CRect &rect) {
  //
  ...
  for (int index = 0; index < 3; index++) {
    ...
    m_EditCtrls[index].SetWindowPos(NULL, edit_rect.left, edit_rect.top, edit_rect.Width(), edit_rect.Height(),
                                    SWP_NOZORDER);
...
//
//////////////////////////////////////////////////////////////////////
void Vector3ParameterCtrlClass::Read_Data(HWND /*parent_wnd*/) {
  Vector3 value;
...
//
//////////////////////////////////////////////////////////////////////
int Vector2ParameterCtrlClass::Create(HWND parent_wnd, int id_start, LPRECT pos) {
  int text_height = ::Get_Ctrl_Height(parent_wnd, TEXT_HEIGHT);
  int edit_height = ::Get_Ctrl_Height(parent_wnd, CTRL_HEIGHT);
...
//
//////////////////////////////////////////////////////////////////////
void Vector2ParameterCtrlClass::Resize(const CRect &rect) {
  //
  //	Resize the group box
  //
  CRect group_rect;
...
//
//////////////////////////////////////////////////////////////////////
void Vector2ParameterCtrlClass::Read_Data(HWND /*parent_wnd*/) {
  Vector2 value;
  value.X = ::GetWindowFloat(m_EditCtrls[0], true);
  value.Y = ::GetWindowFloat(m_EditCtrls[1], true);
...
//
//////////////////////////////////////////////////////////////////////
int RectParameterCtrlClass::Create(HWND parent_wnd, int id_start, LPRECT pos) {
  int text_height = ::Get_Ctrl_Height(parent_wnd, TEXT_HEIGHT);
  int edit_height = ::Get_Ctrl_Height(parent_wnd, CTRL_HEIGHT);
...
//
//////////////////////////////////////////////////////////////////////
void RectParameterCtrlClass::Resize(const CRect &rect) {
  //
  //	Resize the group box
  //
  CRect group_rect;
...
//
//////////////////////////////////////////////////////////////////////
void RectParameterCtrlClass::Read_Data(HWND /*parent_wnd*/) {
  RectClass value;
...
void Create_Float_Ctrls(CWnd *parent_wnd, CEdit &edit_ctrl, CSpinButtonCtrl &spin_ctrl, const CRect &rect, int id1,
  ...
  //	Create the spin control
  //
  spin_ctrl.Create(UDS_ARROWKEYS | UDS_SETBUDDYINT | UDS_AUTOBUDDY | UDS_NOTHOUSANDS | UDS_ALIGNRIGHT | WS_CHILD |
                       WS_VISIBLE,
                   CRect(0, 0, 50, 20), parent_wnd, id2);
...
//
//////////////////////////////////////////////////////////////////////
int EnumParameterCtrlClass::Create(HWND parent_wnd, int id_start, LPRECT pos) {
  CString param_name = m_Parameter->Get_Name();
  ...
  //	Create the static text control
  //
  m_StaticText.Create(param_name, WS_CHILD | WS_VISIBLE | SS_LEFT, text_rect, CWnd::FromHandle(parent_wnd));
  m_StaticText.SendMessage(WM_SETFONT, ::SendMessage(parent_wnd, WM_GETFONT, 0, 0L));
  ...
  //	Create the edit control
  //
  m_ComboBox.Create(WS_CHILD | WS_TABSTOP | WS_VISIBLE | WS_VSCROLL | CBS_DROPDOWNLIST, combo_rect,
                    CWnd::FromHandle(parent_wnd), id_start++);
...
//
//////////////////////////////////////////////////////////////////////
void EnumParameterCtrlClass::Resize(const CRect &rect) {
  CRect old_rect1;
  CRect old_rect2;
  m_StaticText.GetWindowRect(&old_rect1);
...
//
//////////////////////////////////////////////////////////////////////
void EnumParameterCtrlClass::Read_Data(HWND /*parent_wnd*/) {
...
//
//////////////////////////////////////////////////////////////////////
int ColorParameterCtrlClass::Create(HWND parent_wnd, int id_start, LPRECT pos) {
  CString param_name = m_Parameter->Get_Name();
  ...
  //
  m_ButtonID = id_start++;
  m_Button.Create("", WS_CHILD | WS_TABSTOP | WS_VISIBLE | BS_PUSHBUTTON | BS_OWNERDRAW, button_rect,
                  CWnd::FromHandle(parent_wnd), m_ButtonID);
...
//
//////////////////////////////////////////////////////////////////////
void ColorParameterCtrlClass::Resize(const CRect &rect) {
  CRect old_rect1;
  CRect old_rect2;
  m_StaticText.GetWindowRect(&old_rect1);
...
//
//////////////////////////////////////////////////////////////////////
void ColorParameterCtrlClass::Read_Data(HWND /*parent_wnd*/) { return; }
...
//
//////////////////////////////////////////////////////////////////////
bool ColorParameterCtrlClass::On_Command(HWND parent_wnd, WPARAM wparam, LPARAM lparam) {
  bool retval = false;

  if (LOWORD(wparam) == m_ButtonID && HIWORD(wparam) == BN_CLICKED) {
    //
...
//
//////////////////////////////////////////////////////////////////////
bool ColorParameterCtrlClass::On_DrawItem(HWND parent_wnd, WPARAM wparam, LPARAM lparam) {
  bool retval = false;
...
//
//////////////////////////////////////////////////////////////////////
int PhysDefParameterCtrlClass::Create(HWND parent_wnd, int id_start, LPRECT pos) {
  CString param_name = m_Parameter->Get_Name();
  ...
  //
  m_ButtonID = id_start++;
  m_Button.Create("Edit Phyiscs Object...", WS_CHILD | WS_TABSTOP | WS_VISIBLE | BS_PUSHBUTTON, button_rect,
                  CWnd::FromHandle(parent_wnd), m_ButtonID);
  m_Button.SendMessage(WM_SETFONT, ::SendMessage(parent_wnd, WM_GETFONT, 0, 0L));
...
//
//////////////////////////////////////////////////////////////////////
void PhysDefParameterCtrlClass::Resize(const CRect &rect) {
  CRect old_rect1;
  CRect old_rect2;
  m_StaticText.GetWindowRect(&old_rect1);
  m_Button.GetWindowRect(&old_rect2);
...
//
//////////////////////////////////////////////////////////////////////
void PhysDefParameterCtrlClass::Read_Data(HWND /*parent_wnd*/) { return; }
...
//
//////////////////////////////////////////////////////////////////////
bool PhysDefParameterCtrlClass::On_Command(HWND parent_wnd, WPARAM wparam, LPARAM lparam) {
  bool retval = false;
...
//
//////////////////////////////////////////////////////////////////////
int DefParameterCtrlClass::Create(HWND parent_wnd, int id_start, LPRECT pos) {
  ...
  //
  m_PresetPicker.Create_Picker(WS_CHILD | WS_TABSTOP | WS_VISIBLE, picker_rect, CWnd::FromHandle(parent_wnd), id_start);
...
//
//////////////////////////////////////////////////////////////////////
void DefParameterCtrlClass::Resize(const CRect &rect) {
  CRect old_rect1;
  CRect old_rect2;
  m_StaticText.GetWindowRect(&old_rect1);
...
//
//////////////////////////////////////////////////////////////////////
void DefParameterCtrlClass::On_Destroy(void) { return; }
...
//
//////////////////////////////////////////////////////////////////////
void DefParameterCtrlClass::Read_Data(HWND /*parent_wnd*/) {
...
//
//////////////////////////////////////////////////////////////////////
int ScriptParameterCtrlClass::Create(HWND parent_wnd, int id_start, LPRECT pos) {
  CString param_name = m_Parameter->Get_Name();
  ...
  //	Create the static text control
  //
  m_CheckBoxCtrl.Create(param_name, WS_CHILD | WS_TABSTOP | WS_VISIBLE | BS_AUTOCHECKBOX, text_rect,
                        CWnd::FromHandle(parent_wnd), id_start++);
  m_CheckBoxCtrl.SendMessage(WM_SETFONT, ::SendMessage(parent_wnd, WM_GETFONT, 0, 0L));
  ...
  m_Button.Create(button_text, WS_CHILD | WS_TABSTOP | WS_VISIBLE | BS_PUSHBUTTON, button_rect,
                  CWnd::FromHandle(parent_wnd), m_ButtonID);
  m_Button.SendMessage(WM_SETFONT, ::SendMessage(parent_wnd, WM_GETFONT, 0, 0L));
...
//
//////////////////////////////////////////////////////////////////////
void ScriptParameterCtrlClass::Resize(const CRect &rect) {
  CRect old_rect1;
  CRect old_rect2;
...
//
//////////////////////////////////////////////////////////////////////
void ScriptParameterCtrlClass::Read_Data(HWND /*parent_wnd*/) {
  //
...
//
//////////////////////////////////////////////////////////////////////
bool ScriptParameterCtrlClass::On_Command(HWND parent_wnd, WPARAM wparam, LPARAM lparam) {
  bool retval = false;
  ...
  if (LOWORD(wparam) == m_ButtonID && HIWORD(wparam) == BN_CLICKED) {
    ...
    retval = true;
  } else if (LOWORD(wparam) == ::GetWindowLong(m_CheckBoxCtrl, GWL_ID) && HIWORD(wparam) == BN_CLICKED) {
    m_Button.EnableWindow(m_CheckBoxCtrl.GetCheck());
  }
...
//
//////////////////////////////////////////////////////////////////////
int DefIDListParameterCtrlClass::Create(HWND parent_wnd, int id_start, LPRECT pos) {
  CString param_name = m_Parameter->Get_Name();
  ...
  //
  m_ButtonID = id_start++;
  m_Button.Create("Pick Presets...", WS_CHILD | WS_TABSTOP | WS_VISIBLE | BS_PUSHBUTTON, button_rect,
                  CWnd::FromHandle(parent_wnd), m_ButtonID);
  m_Button.SendMessage(WM_SETFONT, ::SendMessage(parent_wnd, WM_GETFONT, 0, 0L));
...
//
//////////////////////////////////////////////////////////////////////
void DefIDListParameterCtrlClass::Resize(const CRect &rect) {
  CRect old_rect1;
  CRect old_rect2;
  m_StaticText.GetWindowRect(&old_rect1);
  m_Button.GetWindowRect(&old_rect2);
...
//
//////////////////////////////////////////////////////////////////////
void DefIDListParameterCtrlClass::Read_Data(HWND /*parent_wnd*/) { return; }
...
//
//////////////////////////////////////////////////////////////////////
bool DefIDListParameterCtrlClass::On_Command(HWND parent_wnd, WPARAM wparam, LPARAM lparam) {
  bool retval = false;
...
//
//////////////////////////////////////////////////////////////////////
int ZoneParameterCtrlClass::Create(HWND parent_wnd, int id_start, LPRECT pos) {
  CString param_name = m_Parameter->Get_Name();
  ...
  //
  m_ButtonID = id_start++;
  m_Button.Create("Edit Zone...", WS_CHILD | WS_TABSTOP | WS_VISIBLE | BS_PUSHBUTTON, button_rect,
                  CWnd::FromHandle(parent_wnd), m_ButtonID);
  m_Button.SendMessage(WM_SETFONT, ::SendMessage(parent_wnd, WM_GETFONT, 0, 0L));
...
//
//////////////////////////////////////////////////////////////////////
void ZoneParameterCtrlClass::Resize(const CRect &rect) {
  CRect old_rect1;
  CRect old_rect2;
  m_StaticText.GetWindowRect(&old_rect1);
  m_Button.GetWindowRect(&old_rect2);
...
//
//////////////////////////////////////////////////////////////////////
void ZoneParameterCtrlClass::Read_Data(HWND /*parent_wnd*/) { return; }
...
//
//////////////////////////////////////////////////////////////////////
bool ZoneParameterCtrlClass::On_Command(HWND parent_wnd, WPARAM wparam, LPARAM lparam) {
  bool retval = false;
  return retval;
}
...
//
//////////////////////////////////////////////////////////////////////
int FilenameListParameterCtrlClass::Create(HWND parent_wnd, int id_start, LPRECT pos) {
  CString param_name = m_Parameter->Get_Name();
  ...
  //
  m_ButtonID = id_start++;
  m_Button.Create("Edit File List...", WS_CHILD | WS_TABSTOP | WS_VISIBLE | BS_PUSHBUTTON, button_rect,
                  CWnd::FromHandle(parent_wnd), m_ButtonID);
  m_Button.SendMessage(WM_SETFONT, ::SendMessage(parent_wnd, WM_GETFONT, 0, 0L));
...
//
//////////////////////////////////////////////////////////////////////
void FilenameListParameterCtrlClass::Resize(const CRect &rect) {
  CRect old_rect1;
  CRect old_rect2;
  m_StaticText.GetWindowRect(&old_rect1);
  m_Button.GetWindowRect(&old_rect2);
...
//
//////////////////////////////////////////////////////////////////////
void FilenameListParameterCtrlClass::Read_Data(HWND /*parent_wnd*/) { return; }
...
//
//////////////////////////////////////////////////////////////////////
bool FilenameListParameterCtrlClass::On_Command(HWND parent_wnd, WPARAM wparam, LPARAM lparam) {
  bool retval = false;
...
//
//////////////////////////////////////////////////////////////////////
int SeparatorParameterCtrlClass::Create(HWND parent_wnd, int id_start, LPRECT pos) {
  CString param_name = m_Parameter->Get_Name();
  ...
  m_FrameCtrl.Create(param_name, WS_CHILD | WS_VISIBLE | SS_ETCHEDHORZ, frame_rect, CWnd::FromHandle(parent_wnd),
                     id_start++);
  ...
  m_TextCtrl.Create(param_name, WS_CHILD | WS_VISIBLE | SS_LEFT, ctrl_rect, CWnd::FromHandle(parent_wnd), id_start++);
...
//
//////////////////////////////////////////////////////////////////////
void SeparatorParameterCtrlClass::Resize(const CRect &rect) {
  CRect old_rect;
