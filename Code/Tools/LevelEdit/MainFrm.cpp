...
static UINT indicators[] = {ID_SEPARATOR, // status line indicator
                            IDS_CAM_LOCATION, IDS_ANIM_FRAMES, IDS_TEXTURE_MEM, IDS_POLY_COUNT};
...
//  CMainFrame
//
CMainFrame::CMainFrame(void) : m_UpdateTimer(0), m_GrowthRate(0.25F), m_pCurrentDoc(NULL), m_MaxCamProfiles(0) {
  return;
}
...
//  ~CMainFrame
//
CMainFrame::~CMainFrame(void) { return; }
...
int CMainFrame::OnCreate(LPCREATESTRUCT lpCreateStruct) {
  ...
  for (int index = 0; index < ICON_COUNT; index++) {
    ...
    HICON hicon = (HICON)::LoadImage(::AfxGetResourceHandle(), MAKEINTRESOURCE(ICON_RESOURCE_IDS[index]), IMAGE_ICON,
                                     16, 16, LR_SHARED);
...
//
////////////////////////////////////////////////////////////////////////////
void CMainFrame::Create_Camera_Menu(void) {
  m_MaxCamProfiles = 0;
  ...
  if (ini_file != NULL) {
    ...
    for (int index = 0; index < count; index++) {
      StringClass profile_name(0u, true);
    ...
    //
    camera_menu->CheckMenuRadioItem(IDM_FIRST_CAM_PROFILE, IDM_FIRST_CAM_PROFILE + m_MaxCamProfiles,
                                    IDM_FIRST_CAM_PROFILE, MF_BYCOMMAND);
  }
...
//  Create_Toolbars
//
void CMainFrame::Create_Toolbars(void) {
  ...
  m_TestBar.SetBarStyle(m_TestBar.GetBarStyle() | CBRS_TOOLTIPS | CBRS_FLYBY | CBRS_SIZE_DYNAMIC | CBRS_GRIPPER);
  ...
  m_AniToolbar.SetBarStyle(m_AniToolbar.GetBarStyle() | CBRS_TOOLTIPS | CBRS_FLYBY | CBRS_SIZE_DYNAMIC);
  m_wndBottomToolBar.SetBarStyle(m_wndBottomToolBar.GetBarStyle() | CBRS_TOOLTIPS | CBRS_FLYBY | CBRS_SIZE_DYNAMIC);
  ...
  //
  FloatControlBar(
      &m_AmbientLightToolbar,
      CPoint(window_rect.left + ((window_rect.Width() << 1) / 3), window_rect.top + (window_rect.Height() >> 1)),
      CBRS_ALIGN_TOP);

  FloatControlBar(
      &m_CameraSettingsToolbar,
      CPoint(window_rect.left + ((window_rect.Width() << 1) / 3), window_rect.top + (window_rect.Height() >> 1)),
      CBRS_ALIGN_TOP);

  FloatControlBar(&m_AniToolbar, CPoint(window_rect.left + 10, (window_rect.top + window_rect.Height()) - 10),
                  CBRS_ALIGN_BOTTOM);
...
//  OnFinalRelease
//
void CMainFrame::OnFinalRelease(void) {
  // Allow the base class to process this message
  CFrameWnd::OnFinalRelease();
  return;
}

void CALLBACK PatsTextCallback(AudibleSoundClass *sound_obj, const StringClass &text, uint32 user_param) {
  CString message;
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::Configure_File_Factories(void) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnObjectManipulate(void) {
...
//
void CMainFrame::OnUpdateObjectManipulate(CCmdUI *pCmdUI) {
  // Get a pointer to the mouse manager for the editor
  MouseMgrClass *pmousemgr = ::Get_Mouse_Mgr();
...
//  OnModeCamera
//
void CMainFrame::OnModeCamera(void) {
  // Get a pointer to the mouse manager for the editor
  MouseMgrClass *pmousemgr = ::Get_Mouse_Mgr();
...
//  OnDeleteSelection
//
void CMainFrame::OnDeleteSelection(void) {
...
//  OnModeOrbit
//
void CMainFrame::OnModeOrbit(void) {
  // Get a pointer to the mouse manager for the editor
  MouseMgrClass *pmousemgr = ::Get_Mouse_Mgr();
...
//  OnUpdateModeOrbit
//
void CMainFrame::OnUpdateModeOrbit(CCmdUI *pCmdUI) {
  // Get a pointer to the mouse manager for the editor
  MouseMgrClass *pmousemgr = ::Get_Mouse_Mgr();
...
//  OnCoordWorld
//
void CMainFrame::OnCoordWorld(void) {
...
//  OnUpdateCoordWorld
//
void CMainFrame::OnUpdateCoordWorld(CCmdUI *pCmdUI) {
...
//  OnCoordView
//
void CMainFrame::OnCoordView(void) {
...
//  OnUpdateCoordView
//
void CMainFrame::OnUpdateCoordView(CCmdUI *pCmdUI) {
...
//  OnCoordObject
//
void CMainFrame::OnCoordObject(void) {
...
//  OnUpdateCoordObject
//
void CMainFrame::OnUpdateCoordObject(CCmdUI *pCmdUI) {
...
//  OnRestrictX
//
void CMainFrame::OnRestrictX(void) {
...
//  OnRestrictY
//
void CMainFrame::OnRestrictY(void) {
...
//  OnRestrictZ
//
void CMainFrame::OnRestrictZ(void) {
...
//  OnUpdateRestrictZ
//
void CMainFrame::OnUpdateRestrictZ(CCmdUI *pCmdUI) {
...
//  OnUpdateRestrictY
//
void CMainFrame::OnUpdateRestrictY(CCmdUI *pCmdUI) {
...
//  OnUpdateRestrictX
//
void CMainFrame::OnUpdateRestrictX(CCmdUI *pCmdUI) {
...
//  OnCameraFront
//
void CMainFrame::OnCameraFront(void) {
...
//  OnCameraBack
//
void CMainFrame::OnCameraBack(void) {
  // Move the camera to this new position
...
//  OnCameraLeft
//
void CMainFrame::OnCameraLeft(void) {
  // Move the camera to this new position
...
//  OnCameraRight
//
void CMainFrame::OnCameraRight(void) {
  // Move the camera to this new position
...
//  OnCameraTop
//
void CMainFrame::OnCameraTop(void) {
  // Move the camera to this new position
...
//  OnCameraBottom
//
void CMainFrame::OnCameraBottom(void) {
  // Move the camera to this new position
...
//  OnDropToGround
//
void CMainFrame::OnDropToGround(void) {
...
//
void CMainFrame::OnUpdateDropToGround(CCmdUI *pCmdUI) {
...
//  OnModeWalkthrough
//
void CMainFrame::OnModeWalkthrough(void) {
  // Get a pointer to the mouse manager for the editor
  MouseMgrClass *pmousemgr = ::Get_Mouse_Mgr();
...
//
void CMainFrame::OnUpdateModeWalkthrough(CCmdUI *pCmdUI) {
  // Get a pointer to the mouse manager for the editor
  MouseMgrClass *pmousemgr = ::Get_Mouse_Mgr();
...
//  OnUpdateModeWalkthrough
//
void CMainFrame::OnViewChangeDevice(void) {
...
//  OnLevelExport
//
void CMainFrame::OnLevelExport(void) {
  ...
  CFileDialog saveFileDialog(FALSE, ".mix", default_name, OFN_HIDEREADONLY | OFN_OVERWRITEPROMPT | OFN_EXPLORER,
                             "Renegade Mix (*.mix)|*.mix||", this);
...
//
void CMainFrame::OnViewAmbientLightDlg(void) {
...
//
void CMainFrame::OnUpdateViewAmbientLightDlg(CCmdUI *pCmdUI) {
...
//
void CMainFrame::OnViewToolbarCameraSettings(void) {
  // Toggle the visiblity state of the toolbar
...
//
void CMainFrame::OnUpdateViewToolbarCameraSettings(CCmdUI *pCmdUI) {
  // Check the menu option if the toolbar is currently displayed
...
//  OnCameraDepthLess
//
void CMainFrame::OnCameraDepthLess(void) {
...
//  OnCameraDepthMore
//
void CMainFrame::OnCameraDepthMore(void) {
  CameraMgr *pcamera_mgr = ::Get_Camera_Mgr();
  if (pcamera_mgr != NULL) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnSavePresets(void) {
  //
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnUpdateSavePresets(CCmdUI *pCmdUI) {
  pCmdUI->Enable(false);
  return;
}
...
BOOL CMainFrame::OnCommand(WPARAM wParam, LPARAM lParam) {
  if ((LOWORD(wParam) == ID_FILE_SAVE_AS) || (LOWORD(wParam) == ID_FILE_SAVE) || (LOWORD(wParam) == ID_FILE_OPEN)) {
    ...
    //	Set the check next to the first entry in the list
    //
    camera_menu->CheckMenuRadioItem(IDM_FIRST_CAM_PROFILE, IDM_FIRST_CAM_PROFILE + m_MaxCamProfiles, LOWORD(wParam),
                                    MF_BYCOMMAND);
  }
...
//
void CMainFrame::OnToggleSnappoints() {
...
//  OnUpdateToggleSnappoints
//
void CMainFrame::OnUpdateToggleSnappoints(CCmdUI *pCmdUI) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnAlwaysExport(void) {
  //
  // Ask the user to pick a path
  //
  CString path;
  if (::Browse_For_Folder(path, NULL, NULL, "Select a directory where the core file set will be copied.")) {
...
//  OnChangeBase
//
void CMainFrame::OnChangeBase(void) {
...
//  OnToggleVisWindow
//
void CMainFrame::OnToggleVisWindow(void) {
...
//  Show_Ani_Toolbar
//
void CMainFrame::Show_Ani_Toolbar(bool bshow) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnAniBackFrame(void) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnAniFirstFrame(void) {
  /*NodeInstanceClass *pnode = Get_Selection_Mgr ().Get_First ();
  if ((pnode != NULL) &&
      (pnode->Get_Type () == NODE_TYPE_TRANSITION_CHARACTER)) {
          TransitionCharacterClass *pcharacter = (TransitionCharacterClass *)pnode;
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnAniFwdFrame(void) {
  /*NodeInstanceClass *pnode = Get_Selection_Mgr ().Get_First ();
  if ((pnode != NULL) &&
      (pnode->Get_Type () == NODE_TYPE_TRANSITION_CHARACTER)) {
          TransitionCharacterClass *pcharacter = (TransitionCharacterClass *)pnode;
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnAniLastFrame(void) {
  /*NodeInstanceClass *pnode = Get_Selection_Mgr ().Get_First ();
  if ((pnode != NULL) &&
      (pnode->Get_Type () == NODE_TYPE_TRANSITION_CHARACTER)) {
          TransitionCharacterClass *pcharacter = (TransitionCharacterClass *)pnode;
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnAniPause(void) {
  /*NodeInstanceClass *pnode = Get_Selection_Mgr ().Get_First ();
  if ((pnode != NULL) &&
      (pnode->Get_Type () == NODE_TYPE_TRANSITION_CHARACTER)) {
          TransitionCharacterClass *pcharacter = (TransitionCharacterClass *)pnode;
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnAniPlay(void) {
  /*NodeInstanceClass *pnode = Get_Selection_Mgr ().Get_First ();
  if ((pnode != NULL) &&
      (pnode->Get_Type () == NODE_TYPE_TRANSITION_CHARACTER)) {
          TransitionCharacterClass *pcharacter = (TransitionCharacterClass *)pnode;
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnAniStop(void) {
  /*NodeInstanceClass *pnode = Get_Selection_Mgr ().Get_First ();
  if ((pnode != NULL) &&
      (pnode->Get_Type () == NODE_TYPE_TRANSITION_CHARACTER)) {
          TransitionCharacterClass *pcharacter = (TransitionCharacterClass *)pnode;
...
//  Update_Poly_Count
//
void CMainFrame::Update_Poly_Count(void) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::Update_Texture_Mem(void) {
  static DWORD last_update = ::GetTickCount();
  DWORD current_ticks = ::GetTickCount();
...
//  Update_Ani_Frame
//
void CMainFrame::Update_Ani_Frame(int frame, int max_frames) {
  CString message;
...
//
void CMainFrame::Update_Camera_Location(const Vector3 &position) {
...
//  OnCreateGroup
//
void CMainFrame::OnCreateGroup(void) { return; }

//////////////////////////////////////////////////////////////////////////
//
//  OnUpdateCreateGroup
//
void CMainFrame::OnUpdateCreateGroup(CCmdUI *pCmdUI) {
  pCmdUI->Enable(Get_Selection_Mgr().Get_Count() > 0);
  return;
}
...
//
void CMainFrame::OnUpdateToggleLights(CCmdUI *pCmdUI) {
...
//  OnRepartition
//
void CMainFrame::OnRepartition(void) {
  CWaitCursor wait_cursor;
...
//  OnUpdateToggleLights
//
void CMainFrame::OnAllowAutoUpdates(void) {
  // Toggle the state
...
//  OnUpdateToggleLights
//
void CMainFrame::OnUpdateAllowAutoUpdates(CCmdUI *pCmdUI) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnRotateLeft(void) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnRotateRight(void) {
  MoverClass::Rotate_Nodes_Z(1.0F);
  return;
}
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnCalcAllLights(void) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnCalcSelLights(void) {
  /*PhysListClass list;
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnUpdateCalcSelLights(CCmdUI *pCmdUI) {
  pCmdUI->Enable(Get_Selection_Mgr().Get_Count() > 0);
  return;
}
...
//  OnLockObjects
//
void CMainFrame::OnLockObjects(void) {
...
//  OnUnlockObjects
//
void CMainFrame::OnUnlockObjects(void) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnUpdateLockObjects(CCmdUI *pCmdUI) {
  pCmdUI->Enable(Get_Selection_Mgr().Get_Count() > 0);
  return;
}
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnUpdateUnlockObjects(CCmdUI *pCmdUI) {
  pCmdUI->Enable(Get_Selection_Mgr().Get_Count() > 0);
  return;
}
...
//  OnEditIncludes
//
void CMainFrame::OnEditIncludes(void) {
...
//
void CMainFrame::OnBackgroundSettings(void) {
...
//  OnToggleMusic
//
void CMainFrame::OnToggleMusic(void) {
...
//  OnUpdateToggleMusic
//
void CMainFrame::OnUpdateToggleMusic(CCmdUI *pCmdUI) {
...
//  OnToggleSounds
//
void CMainFrame::OnToggleSounds(void) {
...
//
void CMainFrame::OnUpdateToggleSounds(CCmdUI *pCmdUI) {
...
//
void CMainFrame::OnUpdateViewAggregateChildren(CCmdUI *pCmdUI) {
...
//  OnToggleSunlight
//
void CMainFrame::OnToggleSunlight(void) {
...
//
void CMainFrame::OnUpdateToggleSunlight(CCmdUI *pCmdUI) {
...
//  OnEditSunlight
//
void CMainFrame::OnEditSunlight(void) {
...
//  OnAutoGenVis
//
void CMainFrame::OnAutoGenVis(void) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnVisualOptions(void) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnViewVisPoints(void) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnUpdateViewVisPoints(CCmdUI *pCmdUI) {
...
void CMainFrame::OnSpecifyAssetDatabase(void) {
  ...
  if (dialog.DoModal() == IDOK) {
    ...
    //
    MessageBox("You must exit and restart the level editor for your changes to take effect.", "Database Change",
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnUpdateVisInvert(CCmdUI *pCmdUI) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnToggleBackfaces(void) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnUpdateToggleBackfaces(CCmdUI *pCmdUI) {
  SceneEditorClass *scene = ::Get_Scene_Editor();
  if (scene != NULL) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnToggleWireframeMode(void) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnUpdateToggleWireframeMode(CCmdUI *pCmdUI) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnViewVisErrors(void) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnUseVisCamera(void) { return; }
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnUpdateUseVisCamera(CCmdUI *pCmdUI) { return; }
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnGenerateObstacleVolumes(void) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnUpdateVisDisable(CCmdUI *pCmdUI) {
  SceneEditorClass *scene = ::Get_Scene_Editor();
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnDisplayPaths(void) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnUpdateDisplayPaths(CCmdUI *pCmdUI) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnTestPathfind(void) {
  CWaitCursor wait_cursor;
  ...
  if ((node1 != NULL) && (node2 != NULL)) {
    ...
    //
    for (NodeClass *node = NodeMgrClass::Get_First(NODE_TYPE_WAYPATH); node != NULL;
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnDisplayPathfindSectors(void) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnUpdateDisplayPathfindSectors(CCmdUI *pCmdUI) {
  bool displayed = PathfindClass::Get_Instance()->Are_Sectors_Displayed();
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnDisplayPathfindPortals(void) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnUpdateDisplayPathfindPortals(CCmdUI *pCmdUI) {
  bool displayed = PathfindClass::Get_Instance()->Are_Portals_Displayed();
  pCmdUI->SetCheck(displayed);
  return;
}
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnDisplayPathfindRawData(void) { return; }
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnUpdateDisplayPathfindRawData(CCmdUI *pCmdUI) { return; }
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnExportPathfind(void) {
  ...
  CFileDialog dialog(FALSE, ".pth", default_name, OFN_HIDEREADONLY | OFN_OVERWRITEPROMPT | OFN_EXPLORER,
                     "Pathfind database (*.pth)|*.pth||", this);
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnImportPathfind(void) {
  //
  // Use the level's filename to generate a default filename
  //
  CString default_name = ::Get_Current_Document()->GetPathName();
  ...
  CFileDialog dialog(TRUE, ".pth", default_name, OFN_HIDEREADONLY | OFN_OVERWRITEPROMPT | OFN_EXPLORER,
                     "Pathfind database (*.pth)|*.pth||", this);
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnImportVis(void) {
  // Use the level's filename to generate a default filename
  CString default_name = ::Get_Current_Document()->GetPathName();
  if (default_name.GetLength() > 0) {
    default_name = ::Get_Filename_From_Path(default_name);
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnExportVis(void) {
  // Use the level's filename to generate a default filename
  CString default_name = ::Get_Current_Document()->GetPathName();
  if (default_name.GetLength() > 0) {
    default_name = ::Get_Filename_From_Path(default_name);
  ...
  CFileDialog dialog(FALSE, ".vis", default_name, OFN_HIDEREADONLY | OFN_OVERWRITEPROMPT | OFN_EXPLORER,
                     "Vis Data File (*.vis)|*.vis||", this);
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnViewVisWindow(void) {
  SceneEditorClass *scene = ::Get_Scene_Editor();
  if (scene != NULL) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnUpdateViewVisWindow(CCmdUI *pCmdUI) {
  SceneEditorClass *scene = ::Get_Scene_Editor();
  if (scene != NULL) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnToggleManVisPoints(void) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnUpdateToggleManVisPoints(CCmdUI *pCmdUI) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnDiscardPathfind(void) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnDoDebug1(void) { return; }
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnDoDebug2(void) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnImportDynObjs(void) {
  // Use the level's filename to generate a default filename
  CString default_name = ::Get_Current_Document()->GetPathName();
  if (default_name.GetLength() > 0) {
    default_name = ::Get_Filename_From_Path(default_name);
  ...
  CFileDialog dialog(TRUE, ".dyn", default_name, OFN_HIDEREADONLY | OFN_OVERWRITEPROMPT | OFN_EXPLORER,
                     "Dynamic Objects (*.dyn)|*.dyn||", this);
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnExportDynObjs(void) {
  ...
  CFileDialog dialog(FALSE, ".dyn", default_name, OFN_HIDEREADONLY | OFN_OVERWRITEPROMPT | OFN_EXPLORER,
                     "Dynamic Objects (*.dyn)|*.dyn||", this);
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnTestGoto(void) {
  CWaitCursor wait_cursor;
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnImportStatic(void) {
  ...
  CFileDialog dialog(TRUE, ".sta", default_name, OFN_HIDEREADONLY | OFN_OVERWRITEPROMPT | OFN_EXPLORER,
                     "Static Data (*.sta)|*.sta||", this);

  if (dialog.DoModal() == IDOK) {
    CString filename = dialog.GetPathName();

    // Is the filename OK?
    HANDLE hfile = ::CreateFile(filename, GENERIC_READ, 0, NULL, OPEN_EXISTING, 0L, NULL);
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnExportStatic(void) {
  // Use the level's filename to generate a default filename
  CString default_name = ::Get_Current_Document()->GetPathName();
  if (default_name.GetLength() > 0) {
    default_name = ::Get_Filename_From_Path(default_name);
  ...
  CFileDialog dialog(FALSE, ".sta", default_name, OFN_HIDEREADONLY | OFN_OVERWRITEPROMPT | OFN_EXPLORER,
                     "Static Data (*.sta)|*.sta||", this);
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnDisplayWeb(void) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnUpdateDisplayWeb(CCmdUI *pCmdUI) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnUpdateDisplayFullPaths(CCmdUI *pCmdUI) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnDisplayFullPaths(void) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnDisplayVisSectors(void) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnUpdateDisplayVisSectors(CCmdUI *pCmdUI) {
  bool enabled = ::Get_Scene_Editor()->Is_Vis_Sector_Display_Enabled();
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnPrelitMultipass(void) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnUpdatePrelitMultipass(CCmdUI *pCmdUI) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnPrelitMultitex(void) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnUpdatePrelitMultitex(CCmdUI *pCmdUI) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnPrelitVertex(void) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnUpdatePrelitVertex(CCmdUI *pCmdUI) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnDebugScriptsMode(void) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnUpdateDebugScriptsMode(CCmdUI *pCmdUI) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnImportLights(void) {
  CFileDialog dialog(TRUE, ".wlt", NULL, OFN_HIDEREADONLY | OFN_OVERWRITEPROMPT | OFN_ALLOWMULTISELECT | OFN_EXPLORER,
                     "Westwood Light Database (*.wlt)|*.wlt||", this);
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnViewSoundSpheres(void) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnUpdateViewSoundSpheres(CCmdUI *pCmdUI) {
  bool enabled = ::Get_Scene_Editor()->Are_Sound_Spheres_Displayed();
  pCmdUI->SetCheck(enabled);
  return;
}
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnViewLightSpheres(void) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnUpdateViewLightSpheres(CCmdUI *pCmdUI) {
  bool enabled = ::Get_Scene_Editor()->Are_Light_Spheres_Displayed();
  pCmdUI->SetCheck(enabled);
  return;
}
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnImportSunlight(void) {
  CFileDialog dialog(TRUE, ".wlt", NULL, OFN_HIDEREADONLY | OFN_OVERWRITEPROMPT | OFN_EXPLORER,
                     "Westwood Light Database (*.wlt)|*.wlt||", this);
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnDiscardVis(void) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::Expand_Attenuation_Spheres(float amount) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnIncreaseSphere(void) {
  Adjust_Growth_Rate();
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnUpdateIncreaseSphere(CCmdUI *pCmdUI) {
  pCmdUI->Enable(::Get_Selection_Mgr().Get_Count() > 0);
  return;
}
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnDecreaseSphere(void) {
  Adjust_Growth_Rate();
  Expand_Attenuation_Spheres(-m_GrowthRate);
  return;
}
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnUpdateDecreaseSphere(CCmdUI *pCmdUI) {
  pCmdUI->Enable(::Get_Selection_Mgr().Get_Count() > 0);
  return;
}
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::Adjust_Growth_Rate(void) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnRunJob(void) {
  CFileDialog dialog(TRUE, ".job", "farm01.job", OFN_HIDEREADONLY | OFN_OVERWRITEPROMPT | OFN_EXPLORER,
                     "Vis Farm Job (*.job)|*.job||", this);
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnGotoLocation(void) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnExportThumbnails(void) {
  //
  // Determine which directory we should use as a default for the export
  //
  CString full_path = theApp.GetProfileString(CONFIG_KEY, LAST_EXPORT_DIR_VALUE);
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnVisStats(void) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnSetNodeIdStart(void) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnBuildDynaCullsys(void) {
  CWaitCursor wait_cursor;
  ...
  //
  NodeClass *node = NULL;
  for (node = NodeMgrClass::Get_First(); node != NULL; node = NodeMgrClass::Get_Next(node)) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnImportVisRemapData(void) {
  //
  // Use the level's filename to generate a default filename
  //
  CString default_name = ::Get_Current_Document()->GetPathName();
  ...
  CFileDialog dialog(TRUE, ".vrt", default_name, OFN_HIDEREADONLY | OFN_OVERWRITEPROMPT | OFN_EXPLORER,
                     "Vis remap table (*.vrt)|*.vrt||", this);
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnExportVisRemapData(void) {
  //
  // Use the level's filename to generate a default filename
  //
  CString default_name = ::Get_Current_Document()->GetPathName();
  ...
  CFileDialog dialog(FALSE, ".vrt", default_name, OFN_HIDEREADONLY | OFN_OVERWRITEPROMPT | OFN_EXPLORER,
                     "Vis remap table (*.vrt)|*.vrt||", this);
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnUpdateBulkReplace(CCmdUI *pCmdUI) {
  pCmdUI->Enable(::Get_Selection_Mgr().Get_Count() > 0);
  return;
}
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnBulkReplace(void) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnCheckIds(void) {
  NODE_LIST node_list;
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnExportLights(void) {
  //
  ...
  CFileDialog dialog(FALSE, ".wlt", NULL, OFN_HIDEREADONLY | OFN_OVERWRITEPROMPT | OFN_EXPLORER,
                     "Westwood Light Database (*.wlt)|*.wlt||", this);
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnOptimizeVisData(void) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnDisplayVisGridLittleBoxes(void) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnUpdateDisplayVisGridLittleBoxes(CCmdUI *pCmdUI) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnDisplayVisGrid(void) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnUpdateDisplayVisGrid(CCmdUI *pCmdUI) {
  pCmdUI->SetCheck(::Get_Scene_Editor()->Get_Vis_Grid_Display_Mode() ==
                   PhysicsSceneClass::VIS_GRID_DISPLAY_ACTUAL_BOXES);
  return;
}
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnEditStringsTable(void) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnExportStringIds(void) {
  CWaitCursor wait_cursor;
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnImportStringIds(void) {
  CWaitCursor wait_cursor;
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnBuildFlightInfo(void) {
  CWaitCursor wait_cursor;
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnToggleAttenuationSpheres(void) {
  SelectionMgrClass &sel_mgr = ::Get_Scene_Editor()->Get_Selection_Mgr();
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnUpdateToggleAttenuationSpheres(CCmdUI *pCmdUI) {
  pCmdUI->Enable(::Get_Selection_Mgr().Get_Count() > 0);
  return;
}
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnFixIdCollisions(void) {
  NODE_LIST node_list;
  NodeMgrClass::Build_ID_Collision_List(node_list);
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnResetDynaCullSystem(void) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnDisplayLightVectors(void) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnUpdateDisplayLightVectors(CCmdUI *pCmdUI) {
  bool enabled = ::Get_Scene_Editor()->Is_Lighting_Debug_Display_Enabled();
  pCmdUI->SetCheck(enabled);
  return;
}
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnDisplayStaticAnimObjects(void) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnUpdateDisplayStaticAnimObjects(CCmdUI *pCmdUI) {
  bool enabled = ::Get_Scene_Editor()->Are_Static_Anim_Phys_Displayed();
  pCmdUI->SetCheck(enabled);
  return;
}
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnEditConversations(void) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnBuildingPowerOn(void) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnUpdateBuildingPowerOn(CCmdUI *pCmdUI) {
  bool enabled = ::Get_Scene_Editor()->Is_Building_Power_Enabled();
  pCmdUI->SetCheck(enabled);
  return;
}
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnCreateProxies(void) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnUpdateCreateProxies(CCmdUI *pCmdUI) {
  bool enabled = ::Get_Scene_Editor()->Is_Proxy_Creation_Enabled();
  pCmdUI->SetCheck(enabled);
  return;
}
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnCheckInPresetChanges(void) {
  PresetMgrClass::Check_In_Presets();
  return;
}
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnUpdateCheckInPresetChanges(CCmdUI *pCmdUI) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnImmediatePresetCheckin(void) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnUpdateImmediatePresetCheckin(CCmdUI *pCmdUI) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnRemapIds(void) {
  if (::MessageBox(
          NULL, "Are you sure you want to remap the IDs of the currently selected objects into the current ID range?",
          "ID Remap", MB_ICONQUESTION | MB_YESNO) == IDYES) {
    SelectionMgrClass &sel_mgr = ::Get_Scene_Editor()->Get_Selection_Mgr();
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnUpdateRemapIds(CCmdUI *pCmdUI) {
  pCmdUI->Enable(::Get_Selection_Mgr().Get_Count() > 0);
  return;
}
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnVerifyCulling(void) {
  StringClass errors;
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnEnableVisSectorFallback(void) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnUpdateEnableVisSectorFallback(CCmdUI *pCmdUI) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnRunManualVisPoints(void) {
  CWaitCursor wait_cursor();
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnShowEditorObjects(void) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnUpdateShowEditorObjects(CCmdUI *pCmdUI) {
  bool enabled = ::Get_Scene_Editor()->Are_Editor_Objects_Displayed();
  pCmdUI->SetCheck(enabled);
  return;
}
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnAddChildNode(void) {
  SelectionMgrClass &sel_mgr = ::Get_Scene_Editor()->Get_Selection_Mgr();
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnUpdateAddChildNode(CCmdUI *pCmdUI) {
  bool enable = false;
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnCheckMemlog(void) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnMakeVisPoint(void) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnExportStringTable(void) {
  CFileDialog dialog(FALSE, ".txt", "strings_table.txt", OFN_HIDEREADONLY | OFN_OVERWRITEPROMPT | OFN_EXPLORER,
  ...
  if (dialog.DoModal() == IDOK) {
    ...
    if (file_attributes != 0xFFFFFFFF && file_attributes & FILE_ATTRIBUTE_READONLY) {
      ::MessageBox(::AfxGetMainWnd()->m_hWnd, "File is read-only, export operation can not complete.", "File Error",
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnGotoObject(void) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnExportPresets(void) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnImportPresets(void) {
  CFileDialog dialog(TRUE, ".txt", "presets.txt", OFN_HIDEREADONLY | OFN_OVERWRITEPROMPT | OFN_EXPLORER,
                     "Text Files (*.txt)|*.txt||", ::AfxGetMainWnd());
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnBatchExport(void) {

  CFileDialog dialog(TRUE, ".lvl", NULL, OFN_HIDEREADONLY | OFN_OVERWRITEPROMPT | OFN_EXPLORER | OFN_ALLOWMULTISELECT,
                     "Level Editor Files (*.lvl)|*.lvl||", this);
  ...
  if (dialog.DoModal() == IDOK) {
    ...
    if (::Browse_For_Folder(destination_dir, m_hWnd, "", "Select the destination directory for the export process.")) {
      ...
      if (::MessageBox(m_hWnd, "Would you like to export each level to its own sub-directory?", "Batch Export",
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnLockVisSamplePoint(void) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnUpdateLockVisSamplePoint(CCmdUI *pCmdUI) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnToggleTerrainSelection(void) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnUpdateToggleTerrainSelection(CCmdUI *pCmdUI) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnExportPresetFileDependencies(void) {

  PresetsFormClass *presets_form = ::Get_Presets_Form();
  if (presets_form != NULL) {

    CFileDialog dialog(FALSE, ".txt", "presets.txt", OFN_HIDEREADONLY | OFN_OVERWRITEPROMPT | OFN_EXPLORER,
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnImportStrings(void) {
  CWaitCursor wait_cursor;
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnExportTileList(void) {
  //
  // Use the level's filename to generate a default filename
  //
  CString default_name = ::Get_Current_Document()->GetPathName();
  ...
  CFileDialog dialog(FALSE, ".txt", default_name, OFN_HIDEREADONLY | OFN_OVERWRITEPROMPT | OFN_EXPLORER,
  ...
  if (dialog.DoModal() == IDOK) {
    ...
    if (text_file.Open(FileClass::WRITE)) {
      ...
      //
      bool do_sel_only = (MessageBox("Would you like to export tiles that are only in the current selection?",
                                     "Export Tile List", MB_ICONQUESTION | MB_YESNO) == IDYES);
      if (do_sel_only) {
        ...
        for (int index = 0; index < sel_mgr.Get_Count(); index++) {
          NodeClass *node = sel_mgr.Get_At(index);
          if (node != NULL && node->Is_Proxied() == false && node->Get_Type() == NODE_TYPE_TILE) {
            node_list.Add(node);
          }
        }
      ...
      for (int index = 0; index < node_list.Count(); index++) {
        ...
        //
        StringClass text;
        text.Format("%s:\t(%.3f, %.3f, %.3f), %.2f degrees", name, pos.X, pos.Y, pos.Z,
                    RAD_TO_DEGF(tm.Get_Z_Rotation()));
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnRemapUnimportantIds(void) {
  NODE_LIST node_list;
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnEditLevelSettings(void) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnExportTranslationData(void) {
  CFileDialog dialog(FALSE, ".xls", "strings.xls", OFN_HIDEREADONLY | OFN_OVERWRITEPROMPT | OFN_EXPLORER,
                     "Excel Spreadsheet (*.xls)|*.xls||", this);
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnImportTranslationData(void) {
  CFileDialog dialog(TRUE, ".xls", "strings.xls",
                     OFN_HIDEREADONLY | OFN_PATHMUSTEXIST | OFN_EXPLORER | OFN_FILEMUSTEXIST | OFN_SHAREAWARE,
                     "Excel Spreadsheet (*.xls)|*.xls||", this);
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnCompressTextures(void) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnUpdateCompressTextures(CCmdUI *pCmdUI) {
  bool enabled = EditorMixFileCreator::Are_Textures_Compressed();
  pCmdUI->SetCheck(enabled);
  return;
}
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnExportFileUsageReport(void) {
  CFileDialog dialog(FALSE, ".txt", "files.txt", OFN_HIDEREADONLY | OFN_OVERWRITEPROMPT | OFN_EXPLORER,
                     "Text Files (*.txt)|*.txt||", this);
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnExportMissingTranslationReport(void) {
  CFileDialog dialog(FALSE, ".txt", "files.txt", OFN_HIDEREADONLY | OFN_OVERWRITEPROMPT | OFN_EXPLORER,
                     "Text Files (*.txt)|*.txt||", this);
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnExportLanguage(void) {
  //
  // Determine which directory we should use as a default for the export
  //
  CString full_path = theApp.GetProfileString(CONFIG_KEY, LAST_EXPORT_DIR_VALUE);
  ...
  CFileDialog dialog(FALSE, ".dbs", "always.dbs", OFN_HIDEREADONLY | OFN_OVERWRITEPROMPT | OFN_EXPLORER,
                     "Renegade Database (*.dbs)|*.dbs||", this);
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnInitMenuPopup(CMenu *popup_menu, UINT nIndex, BOOL bSysMenu) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnAlwaysLocalExport(void) {
  //
  // Ask the user to pick a path
  //
  CString path;
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnExportInstallerLanguageVersion(void) {
  //
  // Determine which directory we should use as a default for the export
  //
  CString full_path = theApp.GetProfileString(CONFIG_KEY, LAST_EXPORT_DIR_VALUE);
  ...
  CFileDialog dialog(FALSE, ".tdb", "istrings.tdb", OFN_HIDEREADONLY | OFN_OVERWRITEPROMPT | OFN_EXPLORER,
                     "Translation Database(*.tdb)|*.tdb||", this);
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnExtractInstallerRcStrings(void) {
  CFileDialog dialog(TRUE, ".rc", NULL,
                     OFN_HIDEREADONLY | OFN_PATHMUSTEXIST | OFN_EXPLORER | OFN_FILEMUSTEXIST | OFN_SHAREAWARE,
                     "Resource Files (*.rc)|*.rc||", this);
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnExtractRcStrings(void) {
  CFileDialog dialog(TRUE, ".rc", NULL,
                     OFN_HIDEREADONLY | OFN_PATHMUSTEXIST | OFN_EXPLORER | OFN_FILEMUSTEXIST | OFN_SHAREAWARE,
                     "Resource Files (*.rc)|*.rc||", this);
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnCameraPerspective(void) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnCameraOrthographic(void) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnUpdateCameraOrthographic(CCmdUI *pCmdUI) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnUpdateCameraPerspective(CCmdUI *pCmdUI) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnModExport(void) {
  //
  // Determine which directory we should use as a default for the export
  //
  ...
  CFileDialog dialog(FALSE, ".pkg", default_name, OFN_HIDEREADONLY | OFN_OVERWRITEPROMPT | OFN_EXPLORER,
                     "Renegade Mod Package (*.pkg)|*.pkg||", this);
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnSaveLevel(void) {
  //
  ...
  CFileDialog dialog(TRUE, ".lvl", default_name, OFN_HIDEREADONLY | OFN_OVERWRITEPROMPT | OFN_EXPLORER,
                     "Level Editor Files (*.lvl)|*.lvl||", this);
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnModeHeightEdit(void) {
...
//
//////////////////////////////////////////////////////////////////////////
void CMainFrame::OnUpdateModeHeightEdit(CCmdUI *pCmdUI) {
