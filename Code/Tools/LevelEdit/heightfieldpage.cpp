...
HeightfieldPageClass::HeightfieldPageClass(CWnd *parent_wnd)
    : IsInitialized(false), CDialog(HeightfieldPageClass::IDD) {
...
//
/////////////////////////////////////////////////////////////////////////////
void HeightfieldPageClass::DoDataExchange(CDataExchange *pDX) {
...
#ifdef _DEBUG
void HeightfieldPageClass::AssertValid() const { CDialog::AssertValid(); }

void HeightfieldPageClass::Dump(CDumpContext &dc) const { CDialog::Dump(dc); }
#endif //_DEBUG
...
//
/////////////////////////////////////////////////////////////////////////////
void HeightfieldPageClass::OnSize(UINT nType, int cx, int cy) {
...
//
/////////////////////////////////////////////////////////////////////////////
void HeightfieldPageClass::OnDestroy(void) {
...
//
////////////////////////////////////////////////////////////////////////////
BOOL HeightfieldPageClass::OnInitDialog(void) {
...
//
////////////////////////////////////////////////////////////////////////////
void HeightfieldPageClass::OnCreateNewButton(void) {
...
//
////////////////////////////////////////////////////////////////////////////
BOOL HeightfieldPageClass::OnCommand(WPARAM wParam, LPARAM lParam) {
  if (IsInitialized) {
...
//
////////////////////////////////////////////////////////////////////////////
void HeightfieldPageClass::Update_Material_Button(int index) {
  if (index < 0 || index > 9) {
    return;
  }
...
//
////////////////////////////////////////////////////////////////////////////
void HeightfieldPageClass::OnMaterialSettingsButton(void) {
