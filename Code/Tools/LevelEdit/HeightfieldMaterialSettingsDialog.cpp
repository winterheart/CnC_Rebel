...
HeightfieldMaterialSettingsDialogClass::HeightfieldMaterialSettingsDialogClass(CWnd *pParent)
    : MaterialIndex(0), CDialog(HeightfieldMaterialSettingsDialogClass::IDD, pParent) {
...
//
/////////////////////////////////////////////////////////////////////////////
void HeightfieldMaterialSettingsDialogClass::DoDataExchange(CDataExchange *pDX) {
...
//
/////////////////////////////////////////////////////////////////////////////
BOOL HeightfieldMaterialSettingsDialogClass::OnInitDialog(void) {
...
//
/////////////////////////////////////////////////////////////////////////////
void HeightfieldMaterialSettingsDialogClass::OnOK(void) {
  bool is_ok = true;
...
//
/////////////////////////////////////////////////////////////////////////////
void HeightfieldMaterialSettingsDialogClass::OnBrowse(void) {
  //
  ...
  CFileDialog dialog(TRUE, ".tga", texture_path, OFN_HIDEREADONLY | OFN_EXPLORER, "Texture Files (*.tga)|*.tga||",
                     ::AfxGetMainWnd());
