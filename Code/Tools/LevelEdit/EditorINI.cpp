...
//	Get_CString
//
CString EditorINIClass::Get_CString(LPCTSTR section, LPCTSTR entry, LPCTSTR defvalue) const {
...
//	Get_Matrix3D
//
Matrix3D EditorINIClass::Get_Matrix3D(LPCTSTR section, LPCTSTR entry, const Matrix3D &defvalue) const {
...
//	Put_Vector3
//
bool EditorINIClass::Put_Vector3(LPCTSTR section, LPCTSTR entry, const Vector3 &value) {
  // Assume failure
  bool retval = false;
...
//	Put_Vector4
//
bool EditorINIClass::Put_Vector4(LPCTSTR section, LPCTSTR entry, const Vector4 &value) {
  // Assume failure
  bool retval = false;
