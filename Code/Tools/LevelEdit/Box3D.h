...
public:
  ...
  //////////////////////////////////////////////////////////
  Box3DClass(void) : m_Dimensions(1, 1, 1), m_bDirty(false), DynamicMeshClass(12, 24) { Create_Model(); }

  Box3DClass(float width, float height, float depth)
      : m_Dimensions(depth, width, height), m_bDirty(false), DynamicMeshClass(12, 24) {
    Create_Model();
  }

  Box3DClass(const Vector3 &dimensions) : m_Dimensions(dimensions), m_bDirty(false), DynamicMeshClass(12, 24) {
    Create_Model();
  }
...
protected:
  ...
  void Easy_Move_Vertex(int vertex_index, const Vector3 &vertex) {
    DynamicMeshClass::Move_Vertex(vertex_index, vertex.X, vertex.Y, vertex.Z);
  }
...
public:
  ...
  //	Public constructors/destructors
  //////////////////////////////////////////////////////////
  Box3DPhysClass(void) : m_pBox(NULL) { Initialize(1, 1, 1); }

  Box3DPhysClass(const Vector3 &dimensions) : m_pBox(NULL) { Initialize(dimensions.X, dimensions.Y, dimensions.Z); }
