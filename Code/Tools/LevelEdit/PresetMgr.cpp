...
//
///////////////////////////////////////////////////////////////////////
PresetMgrClass::PresetMgrClass(void) { return; }
...
//
////////////////////////////////////////////////////////////////////////////
void PresetMgrClass::Initialize(void) {
...
//
////////////////////////////////////////////////////////////////////////////
void PresetMgrClass::Shutdown(void) {
...
//
////////////////////////////////////////////////////////////////////////////
void PresetMgrClass::Free_Presets(void) {
...
void PresetMgrClass::Add_Preset(PresetClass *preset) {
  ...
  //
  if ((preset->m_NextPreset == NULL) && (preset->m_PrevPreset == NULL)) {
    Link_Preset(preset);
  }
...
//
////////////////////////////////////////////////////////////////////////////
void PresetMgrClass::Remove_Preset(PresetClass *preset) {
  WWASSERT(preset != 0);

  //
  //	Only unlink the preset if its in the list
  //
  if ((preset->m_NextPreset != NULL) || (preset->m_PrevPreset != NULL) || (preset == _PresetListHead)) {
...
//
////////////////////////////////////////////////////////////////////////////
void PresetMgrClass::Link_Preset(PresetClass *preset) {
...
//
////////////////////////////////////////////////////////////////////////////
void PresetMgrClass::Unlink_Preset(PresetClass *preset) {
  WWASSERT(preset != 0);
...
//
///////////////////////////////////////////////////////////////////////
uint32 PresetMgrClass::Chunk_ID(void) const { return CHUNKID_PRESETMGR; }
...
//
///////////////////////////////////////////////////////////////////////
bool PresetMgrClass::Contains_Data(void) const { return (_PresetListHead != NULL); }
...
//
///////////////////////////////////////////////////////////////////////
bool PresetMgrClass::Save_Embedded_Node_Data(ChunkSaveClass &csave) {
  //
  //	Loop over all the presets
  //
  for (PresetClass *preset = _PresetListHead; preset != NULL; preset = preset->m_NextPreset) {
    //
...
//
///////////////////////////////////////////////////////////////////////
bool PresetMgrClass::Load_Embedded_Node_Data(ChunkLoadClass &cload) {
  PresetClass *curr_preset = NULL;
...
//
///////////////////////////////////////////////////////////////////////
bool PresetMgrClass::Save_Presets(ChunkSaveClass &csave) {
  for (PresetClass *preset = _PresetListHead; preset != NULL; preset = preset->m_NextPreset) {
...
//
///////////////////////////////////////////////////////////////////////
bool PresetMgrClass::Load_Presets(ChunkLoadClass &cload) {
  bool retval = true;
...
//
///////////////////////////////////////////////////////////////////////
PresetClass *PresetMgrClass::Find_Typed_Preset(uint32 class_id, LPCTSTR name) {
  PresetClass *retval = NULL;
...
//
///////////////////////////////////////////////////////////////////////
PresetClass *PresetMgrClass::Find_Preset(LPCTSTR name) {
  PresetClass *retval = NULL;
...
//
///////////////////////////////////////////////////////////////////////
PresetClass *PresetMgrClass::Get_Next(PresetClass *preset) { return preset->m_NextPreset; }
...
//
///////////////////////////////////////////////////////////////////////
bool PresetMgrClass::Is_One_Of(uint32 id_to_find, ID_TYPE type, bool include_twiddlers, PresetClass *preset) {
  bool retval = false;
...
//
///////////////////////////////////////////////////////////////////////
PresetClass *PresetMgrClass::Get_First(uint32 id, ID_TYPE type, bool include_twiddlers) {
...
//
///////////////////////////////////////////////////////////////////////
PresetClass *PresetMgrClass::Get_Next(PresetClass *current, uint32 id, ID_TYPE type, bool include_twiddlers) {
  PresetClass *req_preset = NULL;
...
//
///////////////////////////////////////////////////////////////////////
void PresetMgrClass::Validate_Version(void) {
  ...
  if (::Get_File_Mgr()->Is_VSS_Read_Only() == false) {
    ...
    if (Check_Editor_Version() == false) {
      ...
      //	Warn the user
      //
      Message_Box(NULL, IDS_VERSION_ERROR_MSG, IDS_VERSION_ERROR_TITLE,
...
//
///////////////////////////////////////////////////////////////////////
bool PresetMgrClass::Check_Out_Database(uint32 class_id, bool *should_undo_on_err) {
...
//
///////////////////////////////////////////////////////////////////////
bool PresetMgrClass::Check_Out_Database(LPCTSTR path, bool *should_undo_on_err) {
  FileMgrClass *file_mgr = ::Get_File_Mgr();
  AssetDatabaseClass &asset_db = file_mgr->Get_Database_Interface();
  bool retval = false;
  ...
  if (status == AssetDatabaseClass::NOT_CHECKED_OUT) {
    ...
    if (retval) {
      ...
      ::MessageBox(::AfxGetMainWnd()->m_hWnd, "Unable to check out the preset library.", "VSS Error",
                   MB_ICONERROR | MB_OK);
    }
...
//
///////////////////////////////////////////////////////////////////////
bool PresetMgrClass::Check_In_Database(LPCTSTR path) {
  CWaitCursor wait_cursor;
...
//
///////////////////////////////////////////////////////////////////////
bool PresetMgrClass::Is_Database_Checked_Out(LPCTSTR full_path) {
  //
...
//
///////////////////////////////////////////////////////////////////////
bool PresetMgrClass::Undo_Database_Check_Out(uint32 class_id) {
  bool retval = false;
  FileMgrClass *file_mgr = ::Get_File_Mgr();
...
//
///////////////////////////////////////////////////////////////////////
void PresetMgrClass::Build_Preset_Tree(uint32 class_id, PRESET_TREE &tree, bool include_twiddlers) {
  tree.Reset();
  ...
  for (preset = Get_First(class_id, ID_CLASS, include_twiddlers); preset != NULL;
       preset = Get_Next(preset, class_id, ID_CLASS, include_twiddlers)) {

    //
    //	Add this preset to the list
    //
    if (preset->Get_Parent() == NULL || preset->Get_Definition()->Get_Class_ID() == CLASSID_TWIDDLERS) {
...
//
///////////////////////////////////////////////////////////////////////
void PresetMgrClass::Add_Children_To_Tree(uint32 parent_id, PRESET_TREE_LEAF *leaf, bool include_twiddlers) {
  //
...
//
///////////////////////////////////////////////////////////////////////
void PresetMgrClass::Build_Factory_Tree(uint32 class_id, FACTORY_TREE &tree) {
  tree.Reset();
  ...
  if (class_id == 0) {
    ...
    for (int index = 0; index < PRESET_CATEGORY_COUNT; index++) {
      ...
      if (DefinitionFactoryMgrClass::Find_Factory(PRESET_CATEGORIES[index].clsid) == NULL) {
        for (DefinitionFactoryClass *factory = DefinitionFactoryMgrClass::Get_First(factory_class_id); factory != NULL;
...
//
///////////////////////////////////////////////////////////////////////
void PresetMgrClass::Put_Presets_Back(PRESET_LIST &preset_list) {
  //
...
//
///////////////////////////////////////////////////////////////////////
void PresetMgrClass::Remove_Non_Matching_Presets(uint32 class_id, bool class_id_matters, bool is_temp,
  ...
  for (preset = Get_First(); preset != NULL; preset = next_preset) {
    ...
    //
    if ((preset->Get_IsTemporary() != is_temp) || (class_id_matters && (curr_class_id != class_id))) {
...
//
///////////////////////////////////////////////////////////////////////
void PresetMgrClass::Discard_Preset_Changes(void) {
...
//
///////////////////////////////////////////////////////////////////////
void PresetMgrClass::Check_In_Presets(void) {
  PresetsFormClass *presets_form = ::Get_Presets_Form();
  if (presets_form == NULL) {
    return;
  }
...
//
///////////////////////////////////////////////////////////////////////
void PresetMgrClass::Add_Dirty_Preset(int preset_id) {
  //
...
//
///////////////////////////////////////////////////////////////////////
void PresetMgrClass::Add_Dirty_Preset_Files_To_VSS(void) {
  //
...
//
///////////////////////////////////////////////////////////////////////
PresetClass *PresetMgrClass::Create_Preset(uint32 class_id, const char *name, bool is_temp) {
...
//
///////////////////////////////////////////////////////////////////////
void PresetMgrClass::Free_All_Embedded_Nodes(void) {
  //
