...
StringsCategoryViewDialogClass::StringsCategoryViewDialogClass(CWnd *pParent)
    : SelectedObjectID(0), CategoryID(0), IsInitialized(false), ShouldUpdateVersionNumber(false),
      CurrentColSort(COL_ID), AscendingSort(true), CallbackObject(NULL), EditMode(EDIT_MODE_STRING),
...
//
/////////////////////////////////////////////////////////////////////////////
void StringsCategoryViewDialogClass::DoDataExchange(CDataExchange *pDX) {
...
//
/////////////////////////////////////////////////////////////////////////////
void StringsCategoryViewDialogClass::Remove_Column(int col_id) {
...
//
/////////////////////////////////////////////////////////////////////////////
void StringsCategoryViewDialogClass::Set_Column_Width(int col_id, float width) {
...
//
/////////////////////////////////////////////////////////////////////////////
void StringsCategoryViewDialogClass::Create(CWnd *parent_wnd) {
...
//
/////////////////////////////////////////////////////////////////////////////
BOOL StringsCategoryViewDialogClass::OnInitDialog(void) {
  ...
  //
  for (TDBObjClass *object = TranslateDBClass::Get_First_Object(CategoryID); object != NULL;
...
//
/////////////////////////////////////////////////////////////////////////////
void StringsCategoryViewDialogClass::Update_Controls(void) {
  //
  //	Size the columns
  //
  CRect rect;
...
//
/////////////////////////////////////////////////////////////////////////////
int StringsCategoryViewDialogClass::Find_Entry(TDBObjClass *object) {
  int object_index = -1;
...
//
/////////////////////////////////////////////////////////////////////////////
void StringsCategoryViewDialogClass::OnDblclkStringList(NMHDR *pNMHDR, LRESULT *pResult) {
  (*pResult) = 0;
...
//
/////////////////////////////////////////////////////////////////////////////
void StringsCategoryViewDialogClass::OnColumnclickStringList(NMHDR *pNMHDR, LRESULT *pResult)
...
//
/////////////////////////////////////////////////////////////////////////////
int CALLBACK StringEntrySortCompareFn(LPARAM param1, LPARAM param2, LPARAM sort_info) {
  int retval = 0;
...
//
/////////////////////////////////////////////////////////////////////////////
void StringsCategoryViewDialogClass::Upate_Entry(int index) {
  if (index < 0) {
    return;
  }
...
//
/////////////////////////////////////////////////////////////////////////////
void StringsCategoryViewDialogClass::Insert_New_Entry(TDBObjClass *object) {
  if (object == NULL) {
    return;
  }
...
//
/////////////////////////////////////////////////////////////////////////////
void StringsCategoryViewDialogClass::OnDeleteitemStringList(NMHDR *pNMHDR, LRESULT *pResult) {
  NM_LISTVIEW *pNMListView = (NM_LISTVIEW *)pNMHDR;
  (*pResult) = 0;
...
//
/////////////////////////////////////////////////////////////////////////////
void StringsCategoryViewDialogClass::OnKeydownStringList(NMHDR *pNMHDR, LRESULT *pResult) {
...
//
/////////////////////////////////////////////////////////////////////////////
void StringsCategoryViewDialogClass::Resize_Controls(void) {
...
//
/////////////////////////////////////////////////////////////////////////////
void StringsCategoryViewDialogClass::Apply_Changes(void) {
  //
  //	Don't do anything if we aren't in edit mode
  //
  if (EditMode == EDIT_MODE_NONE) {
...
//
/////////////////////////////////////////////////////////////////////////////
void StringsCategoryViewDialogClass::OnSize(UINT nType, int cx, int cy) {
...
//
/////////////////////////////////////////////////////////////////////////////
void StringsCategoryViewDialogClass::Cut(DynamicVectorClass<TDBObjClass *> &entry_list, bool sel_only) {
...
//
/////////////////////////////////////////////////////////////////////////////
void StringsCategoryViewDialogClass::Paste(DynamicVectorClass<TDBObjClass *> &entry_list) {
  m_ListCtrl.SetRedraw(false);
...
//
/////////////////////////////////////////////////////////////////////////////
int StringsCategoryViewDialogClass::Get_Selection(void) {
  //
...
//
/////////////////////////////////////////////////////////////////////////////
void StringsCategoryViewDialogClass::OnItemchangedStringList(NMHDR *pNMHDR, LRESULT *pResult) {
  NM_LISTVIEW *pNMListView = (NM_LISTVIEW *)pNMHDR;
  (*pResult) = 0;
