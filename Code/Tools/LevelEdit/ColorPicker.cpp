...
ColorPickerClass::ColorPickerClass(void)
    : m_hBitmap(NULL), m_iWidth(0), m_iHeight(0), m_CurrentPoint(0, 0), m_CurrentColor(0), m_bSelecting(false),
      m_pBits(NULL), m_hMemDC(NULL), m_CurrentHue(0), CWnd() {
  return;
}
...
// OnPaint
//
void ColorPickerClass::OnPaint(void) {
  CPaintDC dc(this);
...
//
/////////////////////////////////////////////////////////////////////////////
BOOL ColorPickerClass::Create(LPCTSTR /*lpszClassName*/, LPCTSTR lpszWindowName, DWORD dwStyle, const RECT &rect,
  ...
  HWND hwnd = ::CreateWindow("WWCOLORPICKER", lpszWindowName, dwStyle, rect.left, rect.top, rect.right - rect.left,
...
//
/////////////////////////////////////////////////////////////////////////////
void ColorPickerClass::Create_Bitmap(void) {
  // Start fresh
  Free_Bitmap();
...
//
/////////////////////////////////////////////////////////////////////////////
void ColorPickerClass::Fill_Rect(UCHAR *pbits, const RECT &rect, COLORREF color, int scanline_size) {
...
/////////////////////////////////////////////////////////////////////////////
COLORREF
ColorPickerClass::Color_From_Point(int x, int y) {
...
//
/////////////////////////////////////////////////////////////////////////////
void Polar_To_Rect(float radius, float angle, float &x, float &y) {
...
//
/////////////////////////////////////////////////////////////////////////////
void Rect_To_Polar(float x, float y, float &radius, float &angle) {
  if (x == 0 && y == 0) {
    radius = 0;
    angle = 0;
  } else {
...
//
/////////////////////////////////////////////////////////////////////////////
void RGB_to_Hue(int red_val, int green_val, int blue_val, float &hue, float &value) {
...
//
/////////////////////////////////////////////////////////////////////////////
CPoint ColorPickerClass::Point_From_Color(COLORREF color) {
  // Window's bitmaps are DWORD aligned, so make sure
  // we take that into account.
  int alignment_offset = (m_iWidth * 3) % 4;
  alignment_offset = (alignment_offset != 0) ? (4 - alignment_offset) : 0;
...
//
/////////////////////////////////////////////////////////////////////////////
void ColorPickerClass::Paint_DIB(int width, int height, UCHAR *pbits) {
  // Window's bitmaps are DWORD aligned, so make sure
  // we take that into account.
...
//
/////////////////////////////////////////////////////////////////////////////
void ColorPickerClass::Free_Bitmap(void) {
  if (m_hBitmap != NULL) {
...
//
/////////////////////////////////////////////////////////////////////////////
BOOL ColorPickerClass::OnEraseBkgnd(CDC * /*pDC*/) { return TRUE; }
...
//
/////////////////////////////////////////////////////////////////////////////
void ColorPickerClass::OnLButtonDown(UINT nFlags, CPoint point) {
  SetCapture();
  m_bSelecting = true;
...
//
/////////////////////////////////////////////////////////////////////////////
void ColorPickerClass::OnLButtonUp(UINT nFlags, CPoint point) {
  if (m_bSelecting) {
    ::ClipCursor(NULL);
    ReleaseCapture();
    m_bSelecting = false;
...
//
/////////////////////////////////////////////////////////////////////////////
void ColorPickerClass::Calc_Display_Rect(RECT &rect) {
  GetClientRect(&rect);
...
//
/////////////////////////////////////////////////////////////////////////////
void ColorPickerClass::Erase_Marker(void) {
  ...
  if (m_hMemDC != NULL) {
    ...
    CRect rect;
    GetClientRect(&rect);
    ::BitBlt(hdc, m_CurrentPoint.x - 5, m_CurrentPoint.y - 5, 11, 11, m_hMemDC, m_CurrentPoint.x - 5,
             m_CurrentPoint.y - 5, SRCCOPY);
...
//
/////////////////////////////////////////////////////////////////////////////
void ColorPickerClass::Paint_Marker(void) {
  HDC hdc = ::GetDC(m_hWnd);
  if (m_hMemDC != NULL) {
    ...
    CRect rect;
    GetClientRect(&rect);
    ::BitBlt(hdc, m_CurrentPoint.x - 5, m_CurrentPoint.y - 5, 11, 11, m_hMemDC, 0, 0, SRCINVERT);
