...
public:
  ...
  void Increment_Processed_Node_Count(void) {
    ProcessedNodeCount++;
    CurrentNodeEdgeCount = CurrentNodeSampleCount = 0;
  }
  void Increment_Edge_Count(void) {
    TotalEdgeCount++;
    CurrentNodeEdgeCount++;
  }
  void Increment_Sample_Count(void) {
    TotalSampleCount++;
    CurrentNodeSampleCount++;
  }
...
inline VisGenProgressClass::VisGenProgressClass(void)
    : NodeCount(0), ProcessedNodeCount(0), TotalEdgeCount(0), TotalSampleCount(0), CurrentNodeEdgeCount(0),
      CurrentNodeSampleCount(0), CancelRequested(false) {}
