...
ScriptEditDialogClass::ScriptEditDialogClass(CWnd *pParent /*=NULL*/)
    : m_CurrentParamType(PARAM_TYPE_STRING), m_CurrentParamIndex(0), m_ValueVector3Dlg(NULL),
...
//
/////////////////////////////////////////////////////////////////////////////
void ScriptEditDialogClass::DoDataExchange(CDataExchange *pDX) {
...
//
/////////////////////////////////////////////////////////////////////////////
BOOL ScriptEditDialogClass::OnInitDialog(void) {
  ...
  m_ValueVector3Dlg->SetWindowPos(&m_ValueNumberEdit, rect.left,
                                  (rect.top + rect.Height() / 2) - (v3_rect.Height() / 2), 0, 0, SWP_NOSIZE);
...
//
/////////////////////////////////////////////////////////////////////////////
void ScriptEditDialogClass::Fill_Param_Combo(void) {
...
//
/////////////////////////////////////////////////////////////////////////////
void ScriptEditDialogClass::Switch_Value_Control_Type(void) {
...
//
/////////////////////////////////////////////////////////////////////////////
void ScriptEditDialogClass::Switch_Value_Control_Type(int param_index) {
  ...
  if (type != m_CurrentParamType) {
    ...
    case PARAM_TYPE_FLOAT:
    case PARAM_TYPE_INT: {
      if ((type != PARAM_TYPE_FLOAT) && (type != PARAM_TYPE_INT)) {
...
//
/////////////////////////////////////////////////////////////////////////////
void ScriptEditDialogClass::Fill_Value_Control(LPCTSTR value) {
  // What's type?
  switch (m_CurrentParamType) {
  case PARAM_TYPE_FLOAT: {
...
//
/////////////////////////////////////////////////////////////////////////////
void ScriptEditDialogClass::Save_Current_Value(void) {
  // What's type?
  CString text_value;
  switch (m_CurrentParamType) {
  case PARAM_TYPE_FLOAT: {
...
//
/////////////////////////////////////////////////////////////////////////////
void ScriptEditDialogClass::OnSelChangeParamNameCombo(void) {
...
//
/////////////////////////////////////////////////////////////////////////////
void ScriptEditDialogClass::OnSelChangeScriptName(void) {
...
//
/////////////////////////////////////////////////////////////////////////////
void ScriptEditDialogClass::OnDeltaposParamValueNumberSpin(NMHDR *pNMHDR, LRESULT *pResult) {
...
//
/////////////////////////////////////////////////////////////////////////////
void ScriptEditDialogClass::OnOK(void) {
  Save_Current_Value();
