...
enum { VARID_LOD_DIST = 0x01, VARID_MODEL_NAME, VARID_LIGHT_FILENAME };
...
//
//////////////////////////////////////////////////////////////////////////////////
TerrainDefinitionClass::~TerrainDefinitionClass(void) { return; }
...
//
//////////////////////////////////////////////////////////////////////////////////
const PersistFactoryClass &TerrainDefinitionClass::Get_Factory(void) const { return _TerrainPersistFactory; }
...
//
//////////////////////////////////////////////////////////////////////////////////
bool TerrainDefinitionClass::Save(ChunkSaveClass &csave) {
  bool retval = true;
...
//
//////////////////////////////////////////////////////////////////////////////////
bool TerrainDefinitionClass::Load(ChunkLoadClass &cload) {
  bool retval = true;
...
//
//////////////////////////////////////////////////////////////////////////////////
bool TerrainDefinitionClass::Save_Variables(ChunkSaveClass &csave) {
  bool retval = true;
...
//
//////////////////////////////////////////////////////////////////////////////////
bool TerrainDefinitionClass::Load_Variables(ChunkLoadClass &cload) {
  bool retval = true;
...
//
//////////////////////////////////////////////////////////////////////////////////
PersistClass *TerrainDefinitionClass::Create(void) const { return new TerrainNodeClass(); }
