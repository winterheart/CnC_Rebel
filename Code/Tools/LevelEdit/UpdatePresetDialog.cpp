...
//
/////////////////////////////////////////////////////////////////////////////
UpdatePresetDialogClass::UpdatePresetDialogClass(PresetClass *preset, CWnd *parent)
    : m_Preset(preset), CDialog(UpdatePresetDialogClass::IDD, parent) {
...
//
/////////////////////////////////////////////////////////////////////////////
void UpdatePresetDialogClass::DoDataExchange(CDataExchange *pDX) {
...
//
/////////////////////////////////////////////////////////////////////////////
BOOL UpdatePresetDialogClass::OnInitDialog(void) {
  CDialog::OnInitDialog();

  SANITY_CHECK(m_Preset != NULL && m_Preset->Get_Definition() != NULL) { return TRUE; }
...
//
/////////////////////////////////////////////////////////////////////////////
void UpdatePresetDialogClass::OnBrowse(void) { return; }
...
//
/////////////////////////////////////////////////////////////////////////////
void UpdatePresetDialogClass::OnChangeFilenameEdit(void) { return; }
...
//
/////////////////////////////////////////////////////////////////////////////
void UpdatePresetDialogClass::OnOK(void) {
  int count = m_ParamSheet->Get_Parameter_Count();
  for (int index = 0; index < count; index++) {
...
//
/////////////////////////////////////////////////////////////////////////////
void UpdatePresetDialogClass::Update_INI(LPCTSTR rel_folder) {
  //
  ...
  if (asset_db.Retry_Check_Out(path, 10, 1000)) {
    ...
    if (pini != NULL) {
      ...
      for (LPSTR newline = ::strchr(comments, '\r'); newline != NULL; newline = ::strchr(newline, '\r')) {
        newline[0] = '|';
        newline[1] = '|';
      }
