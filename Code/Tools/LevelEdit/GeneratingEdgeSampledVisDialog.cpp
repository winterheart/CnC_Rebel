...
GeneratingEdgeSampledVisDialogClass::GeneratingEdgeSampledVisDialogClass(CWnd *pParent /*=NULL*/)
    : m_IsCancelled(false), m_IsFinished(false), m_ProgressObj(NULL), m_StartTime(0), m_FarmMode(false),
...
//
/////////////////////////////////////////////////////////////////////////////
void GeneratingEdgeSampledVisDialogClass::DoDataExchange(CDataExchange *pDX) {
...
//
/////////////////////////////////////////////////////////////////////////////
BOOL GeneratingEdgeSampledVisDialogClass::OnInitDialog(void) {
...
//
/////////////////////////////////////////////////////////////////////////////
void GeneratingEdgeSampledVisDialogClass::OnTimer(UINT nIDEvent) {
  //
  //	Refresh the dialog
  //
  if (nIDEvent == 777) {
...
//
/////////////////////////////////////////////////////////////////////////////
void GeneratingEdgeSampledVisDialogClass::OnCancel(void) {
  m_IsCancelled = true;
...
//
/////////////////////////////////////////////////////////////////////////////
void GeneratingEdgeSampledVisDialogClass::Set_Progress_Obj(VisGenProgressClass *obj) {
  m_ProgressObj = obj;
  return;
}
...
//
/////////////////////////////////////////////////////////////////////////////
GeneratingEdgeSampledVisDialogClass *GeneratingEdgeSampledVisDialogClass::Display(void) {
  //
...
//
/////////////////////////////////////////////////////////////////////////////
void GeneratingEdgeSampledVisDialogClass::End_Dialog(void) {
...
//
/////////////////////////////////////////////////////////////////////////////
void GeneratingEdgeSampledVisDialogClass::Set_Finished(bool is_finished) {
...
//
////////////////////////////////////////////////////////////////////////////
UINT fnGeneratingVisDialogThread(DWORD dwparam1, DWORD dwparam2, DWORD /*dwparam3*/, HRESULT * /*presult*/,
                                 HWND * /*phmain_wnd*/
) {
