...
//
/////////////////////////////////////////////////////////////////////////
void StringsMgrClass::Create_Database_If_Necessary(void) {
...
//
/////////////////////////////////////////////////////////////////////////
void StringsMgrClass::Save_Translation_Database(void) {
  CString filename = ::Get_File_Mgr()->Make_Full_Path(STRINGS_DB_PATH);
...
//
/////////////////////////////////////////////////////////////////////////
void StringsMgrClass::Save_Translation_Database(const char *full_path) {
  //
  //	Create the file
  //
  HANDLE file = ::CreateFile(full_path, GENERIC_WRITE, 0, NULL, CREATE_ALWAYS, 0L, NULL);
...
//
/////////////////////////////////////////////////////////////////////////
void StringsMgrClass::Load_Translation_Database(void) {
  CString filename = ::Get_File_Mgr()->Make_Full_Path(STRINGS_DB_PATH);
...
//
/////////////////////////////////////////////////////////////////////////
void StringsMgrClass::Import_Strings(void) {
  CFileDialog dialog(TRUE, ".txt", "strings.txt", OFN_HIDEREADONLY | OFN_OVERWRITEPROMPT | OFN_EXPLORER,
...
//
/////////////////////////////////////////////////////////////////////////
void StringsMgrClass::Import_IDs(void) {
  CFileDialog dialog(TRUE, ".h", "string_ids.h", OFN_HIDEREADONLY | OFN_OVERWRITEPROMPT | OFN_EXPLORER,
...
//
/////////////////////////////////////////////////////////////////////////
void StringsMgrClass::Export_IDs(void) {
  CFileDialog dialog(FALSE, ".h", "string_ids.h", OFN_HIDEREADONLY | OFN_OVERWRITEPROMPT | OFN_EXPLORER,
                     "C Header Files (*.h)|*.h||", ::AfxGetMainWnd());
...
//
/////////////////////////////////////////////////////////////////////////
bool StringsMgrClass::Get_Latest_Version(void) {
  FileMgrClass *file_mgr = ::Get_File_Mgr();
  AssetDatabaseClass &asset_db = file_mgr->Get_Database_Interface();
...
//
/////////////////////////////////////////////////////////////////////////
bool StringsMgrClass::Check_Out(void) {
  FileMgrClass *file_mgr = ::Get_File_Mgr();
  AssetDatabaseClass &asset_db = file_mgr->Get_Database_Interface();
...
//
/////////////////////////////////////////////////////////////////////////
bool StringsMgrClass::Check_In(void) {
  FileMgrClass *file_mgr = ::Get_File_Mgr();
  AssetDatabaseClass &asset_db = file_mgr->Get_Database_Interface();
...
//
/////////////////////////////////////////////////////////////////////////
bool StringsMgrClass::Undo_Check_Out(void) {
  FileMgrClass *file_mgr = ::Get_File_Mgr();
  AssetDatabaseClass &asset_db = file_mgr->Get_Database_Interface();
  bool retval = false;
...
//
/////////////////////////////////////////////////////////////////////////
void StringsMgrClass::Edit_Database(HWND parent_wnd) {
...
//
/////////////////////////////////////////////////////////////////////////
void StringsMgrClass::Export_For_Translation(const char *filename, uint32 lang_id) {
  CWaitCursor wait_cursor;

  if (ExcelClass::Initialize() == false) {
    ::MessageBox(::AfxGetMainWnd()->m_hWnd,
                 "Cannot Initialize Excel, this feature requires Excel installed on the machine.", "Export Error",
                 MB_ICONERROR | MB_OK);
    return;
  }
  ...
  for (int index = 0; index < count; index++) {
    ...
    if (object != NULL && object->As_StringTwiddlerClass() == NULL) {
      ...
      AudibleSoundDefinitionClass *sound_def =
          (AudibleSoundDefinitionClass *)DefinitionMgrClass::Find_Definition(sound_preset_id, false);
      if (sound_def != NULL) {
...
//
/////////////////////////////////////////////////////////////////////////
void StringsMgrClass::Import_From_Translation(const char *filename, uint32 lang_id) {
  CWaitCursor wait_cursor;
    ...
    if (string_id.Is_Empty()) {
      ...
      if (object != NULL) {
        ...
        DefinitionClass *definition =
            DefinitionMgrClass::Find_Typed_Definition(ascii_preset_name, CLASSID_SOUND, false);
        if (definition != NULL) {
...
//
/////////////////////////////////////////////////////////////////////////////
void StringsMgrClass::Convert_Newline_To_Chars(WideStringClass &string) {
...
//
/////////////////////////////////////////////////////////////////////////////
void StringsMgrClass::Convert_Chars_To_Newline(WideStringClass &string) {
  WideStringClass retval;
...
//
/////////////////////////////////////////////////////////////////////////////
void StringsMgrClass::Apply_Characteristics(WideStringClass &english_string, WideStringClass &translated_string) {
