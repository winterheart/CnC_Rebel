...
SceneEditorClass::SceneEditorClass(void)
    : m_SelectionMgr(NULL), m_bLightsOn(true), m_bAggregateChildrenVisible(true), m_bVisPointsDisplayed(0),
      m_TotalVisPoints(0), m_ManualVisPointsVisible(true), m_MovingObject(NULL), m_DisplaySoundSpheres(false),
      m_DisplayLightSpheres(false), m_ShowStaticAnimPhys(true), m_ShowEditorObjects(true), m_BuildingPowerEnabled(true),
      m_CreateProxies(true), PhysicsSceneClass() {
  //
...
//
//////////////////////////////////////////////////////////////////////
void SceneEditorClass::Initialize(void) {
  //
...
//
//////////////////////////////////////////////////////////////////////
void SceneEditorClass::Cleanup_Resources(void) {
  //
...
//
//////////////////////////////////////////////////////////////////////
NodeClass *SceneEditorClass::Create_Node(PresetClass *preset, Matrix3D *transform, DWORD node_id, bool add_to_scene) {
...
//
//////////////////////////////////////////////////////////////////////
NodeClass *SceneEditorClass::Clone_Node(NodeClass *node) {
...
//
//////////////////////////////////////////////////////////////////////
void SceneEditorClass::Reload_Lightmap_Models(void) {
  //
...
//
//////////////////////////////////////////////////////////////////////
void SceneEditorClass::Add_Node(NodeClass *node) {
...
//
//////////////////////////////////////////////////////////////////////
bool SceneEditorClass::Delete_Node(NodeClass *node, bool allow_undo) {
...
//
//////////////////////////////////////////////////////////////////////
bool SceneEditorClass::Delete_Nodes(PresetClass *preset) {
  bool retval = true;
...
//
//////////////////////////////////////////////////////////////////////
void SceneEditorClass::Update_File_Mgr(NodeClass *node, bool add_node) {
...
//
//////////////////////////////////////////////////////////////////////
bool SceneEditorClass::Clone_Objects(void) {
...
//
//////////////////////////////////////////////////////////////////////
void SceneEditorClass::Add_Groups_To_List(NodeClass &node, GROUP_LIST &group_list) {
...
//
//////////////////////////////////////////////////////////////////////
void SceneEditorClass::Build_Group_List(GROUP_LIST &group_list, NodeClass *node) {
  if (node != NULL) {
...
//
//////////////////////////////////////////////////////////////////////
void SceneEditorClass::Add_Nodes_To_List(NodeClass &node, NODE_LIST &node_list) {
  //
  // Loop through all the children of this node and
...
//
//////////////////////////////////////////////////////////////////////
Vector3 SceneEditorClass::Build_Node_List(NODE_LIST &node_list) {
  //
...
//
//////////////////////////////////////////////////////////////////////
void SceneEditorClass::Build_Node_List(NODE_LIST &node_list, NodeClass *parent_node) {
  //
...
//
///////////////////////////////////////////////////////////////
void SceneEditorClass::Delete_Nodes(void) {
...
//
///////////////////////////////////////////////////////////////
void SceneEditorClass::Set_Selection(NodeClass *node) {
...
//
///////////////////////////////////////////////////////////////
void SceneEditorClass::Toggle_Selection(NodeClass *node) {
  //
...
//
///////////////////////////////////////////////////////////////
void SceneEditorClass::Update_Toolbars(void) {
...
//
///////////////////////////////////////////////////////////////
NodeClass *SceneEditorClass::Find_Node_At_Point(CPoint point, Vector3 *intersect_pt) {
  //
...
//
///////////////////////////////////////////////////////////////
bool SceneEditorClass::Execute_Function_At_Point(CPoint point) {
...
//
///////////////////////////////////////////////////////////////
void SceneEditorClass::Move_Selected_Nodes(void) {
...
//
///////////////////////////////////////////////////////////////
void SceneEditorClass::On_Frame(void) {
  //
...
//
///////////////////////////////////////////////////////////////
void SceneEditorClass::Record_Vis_Info(const Matrix3D &view_transform, const Vector3 &sample_location) {
  // Put up an hour glass
  CWaitCursor wait_cursor;

  PresetClass *preset = PresetMgrClass::Get_First(CLASSID_VIS_POINT_DEF, PresetMgrClass::ID_CLASS);
  if (preset == NULL) {
    CString message = "Missing 'Manual Vis Point' preset.  Please create a default preset under the 'Manual Vis Point' "
                      "folder in the preset library.";
    ...
    //
    VisSampleClass vis_sample = Update_Vis(view_transform * Vector3(0, 0, -scene_znear), view_transform,
                                           (VisDirBitsType)(VIS_FORWARD_BIT | VIS_DONT_RECENTER), scene_cam);
...
//
///////////////////////////////////////////////////////////////
void SceneEditorClass::Begin_Operation(OPERATION_TYPE type, NodeClass *node) {
  if (node != NULL) {
...
//
///////////////////////////////////////////////////////////////
void SceneEditorClass::Begin_Operation(OPERATION_TYPE type, NODE_LIST *affected_list) {
  NODE_LIST node_list;
...
//
///////////////////////////////////////////////////////////////
void SceneEditorClass::End_Operation(void) {
...
//
///////////////////////////////////////////////////////////////
bool SceneEditorClass::Undo(void) {
...
//
///////////////////////////////////////////////////////////////
bool SceneEditorClass::Cut_Objects(void) {
  bool retval = false;
...
//
///////////////////////////////////////////////////////////////
bool SceneEditorClass::Copy_Objects(void) {
  Empty_Local_Clipboard();
...
//
///////////////////////////////////////////////////////////////
bool SceneEditorClass::Paste_Objects(void) {
...
//
///////////////////////////////////////////////////////////////
bool SceneEditorClass::Can_Paste(void) {
  // Return the true/false result code
...
//
///////////////////////////////////////////////////////////////
void SceneEditorClass::Empty_Local_Clipboard(void) {
...
//
///////////////////////////////////////////////////////////////
GroupMgrClass *SceneEditorClass::Add_Global_Group(const CString &name, NODE_LIST *initial_list) {
...
//
///////////////////////////////////////////////////////////////
void SceneEditorClass::Remove_Global_Group(GroupMgrClass *group) {
...
//
///////////////////////////////////////////////////////////////
void SceneEditorClass::Reset_Global_Groups_List(void) {
...
//
////////////////////////////////////////////////////////////////
void SceneEditorClass::Add_Group_To_Toolbar(GroupMgrClass *group) {
  ASSERT(group != NULL);
...
//
////////////////////////////////////////////////////////////////
void SceneEditorClass::Remove_Group_From_Toolbar(GroupMgrClass *group) {
  ASSERT(group != NULL);
...
//
////////////////////////////////////////////////////////////////
void SceneEditorClass::Turn_Lights_On(bool onoff) {
  m_bLightsOn = onoff;
...
//
////////////////////////////////////////////////////////////////
void SceneEditorClass::Lock_Nodes(bool lock) {
  //
  // Loop through all the nodes in the current selection
  //
  for (int index = 0; index < m_SelectionMgr->Get_Count(); index++) {
...
//
////////////////////////////////////////////////////////////////
void SceneEditorClass::Set_Background_Music(LPCTSTR filename) {
  //
  //	Stop the old sound
  //
  WWAudioClass::Get_Instance()->Set_Background_Music(NULL);
...
//
////////////////////////////////////////////////////////////////
void SceneEditorClass::View_Aggregate_Children(bool view) {
...
//
////////////////////////////////////////////////////////////////
void SceneEditorClass::Display_Vis_Points(bool onoff) {
  // Did the state change?
...
//
////////////////////////////////////////////////////////////////
void SceneEditorClass::Create_Vis_Point(const Matrix3D &transform) {
  //
...
//
////////////////////////////////////////////////////////////////
void SceneEditorClass::Remove_All_Vis_Points(void) {
  ::Get_Main_View()->Allow_Repaint(false);
...
//
////////////////////////////////////////////////////////////////
void SceneEditorClass::Discard_Vis(void) {
  m_VisLog.Reset_Log();
  Remove_All_Vis_Points();
...
//
////////////////////////////////////////////////////////////////
void SceneEditorClass::Reset_Vis(bool doitnow) {
  m_VisLog.Reset_Log();
  Remove_All_Vis_Points();
...
//
////////////////////////////////////////////////////////////////
void SceneEditorClass::Internal_Vis_Reset(void) {
  if (VisResetNeeded) {
    PhysicsSceneClass::Internal_Vis_Reset();
...
//
////////////////////////////////////////////////////////////////
void SceneEditorClass::Get_Vis_Camera_FOV(double &hfov, double &vfov) {
...
//
////////////////////////////////////////////////////////////////
void SceneEditorClass::Get_Vis_Camera_Clip_Planes(float &znear, float &zfar) {
  CameraClass *vis_camera = Get_Vis_Camera();
  WWASSERT(vis_camera != NULL);
  if (vis_camera != NULL) {
...
//
////////////////////////////////////////////////////////////////
CameraClass *SceneEditorClass::Get_Render_Camera(void) {
...
//
////////////////////////////////////////////////////////////////
void SceneEditorClass::Generate_Pathfind_Portals(void) {
  CWaitCursor wait_cursor;
...
//
////////////////////////////////////////////////////////////////
void SceneEditorClass::Export_VIS(LPCTSTR filename) {
  //
  //	Create the file
  //
...
//
////////////////////////////////////////////////////////////////
void SceneEditorClass::Update_Selection_Boxes(void) {
  //
  // Loop through all the nodes in the current selection
  //
  for (int index = 0; index < m_SelectionMgr->Get_Count(); index++) {
...
//
////////////////////////////////////////////////////////////////
void SceneEditorClass::Re_Partition_Audio_System(void) {
...
//
////////////////////////////////////////////////////////////////
bool SceneEditorClass::Are_Manual_Vis_Points_Visible(void) { return m_ManualVisPointsVisible; }
...
//
////////////////////////////////////////////////////////////////
void SceneEditorClass::Show_Manual_Vis_Points(bool show_points) {
...
//
////////////////////////////////////////////////////////////////
void SceneEditorClass::DoObjectGoto(NodeClass *node1, NodeClass *node2) {
  SANITY_CHECK(node1 != NULL && node2 != NULL && node1->Get_Type() == NODE_TYPE_OBJECT) { return; }
...
//
////////////////////////////////////////////////////////////////
void SceneEditorClass::Export_Lights(LPCTSTR filename) {
  ...
  if (file != NULL && file->Create() && file->Open(FileClass::WRITE)) {
    ...
    //
    for (NodeClass *node = NodeMgrClass::Get_First(NODE_TYPE_LIGHT); node != NULL;
      ...
      if (light != NULL) {
        ...
        W3dLightTransformStruct w3d_tm = {tm[0][0], tm[0][1], tm[0][2], tm[0][3], tm[1][0], tm[1][1],
...
//
////////////////////////////////////////////////////////////////
void SceneEditorClass::Import_Lights(DynamicVectorClass<StringClass> &filename_list,
...
//
////////////////////////////////////////////////////////////////
void SceneEditorClass::Build_Light_List(ChunkLoadClass &cload, DynamicVectorClass<LightClass *> &light_list,
                                        int group_id) {
  while (cload.Open_Chunk()) {
    switch (cload.Cur_Chunk_ID()) {
...
//
////////////////////////////////////////////////////////////////
void SceneEditorClass::Filter_Lights(DynamicVectorClass<LightClass *> &light_list) {
  //
...
//
////////////////////////////////////////////////////////////////
void SceneEditorClass::Display_Sound_Spheres(bool onoff) {
  if (m_DisplaySoundSpheres != onoff) {
    ...
    // on or off.
    //
    for (NodeClass *node = NodeMgrClass::Get_First(NODE_TYPE_SOUND); node != NULL;
...
//
////////////////////////////////////////////////////////////////
void SceneEditorClass::Display_Light_Spheres(bool onoff) {
...
//
////////////////////////////////////////////////////////////////
void SceneEditorClass::Import_Sunlight(LPCTSTR filename) {
  DynamicVectorClass<LightClass *> light_list;
  ...
  if (more_than_one) {
    ...
    if (::MessageBox(::AfxGetMainWnd()->m_hWnd,
                     "There are multiple sunlight definitions in this file which have different settings.  Do you wish "
                     "to continue?",
                     "Ambiguous Lights", MB_ICONQUESTION | MB_YESNO) == IDNO) {
      apply_changes = false;
    }
  }
...
//
////////////////////////////////////////////////////////////////
bool SceneEditorClass::Compare_Lights(LightClass *light1, LightClass *light2) {
  bool retval = false;
  ...
  if (tm1 == tm2 && light1->Get_Type() == light2->Get_Type()) {
    //
    ...
    if (ambient1 == ambient2 && specular1 == specular2 && diffuse1 == diffuse2 && intensity1 == intensity2) {
      //
...
//
////////////////////////////////////////////////////////////////
void SceneEditorClass::Replace_Selection(void) {
  //
...
//
////////////////////////////////////////////////////////////////
void SceneEditorClass::Generate_Uniform_Sampled_Vis(float granularity, float sample_height, bool ignore_bias,
                                                    bool selection_only, bool farm_mode, int farm_cpu_index,
                                                    int farm_cpu_total) {
...
//
////////////////////////////////////////////////////////////////
void SceneEditorClass::Generate_Edge_Sampled_Vis(float granularity, bool ignore_bias, bool farm_mode,
                                                 int farm_cpu_index, int farm_cpu_total) {
  //
  ...
  for (int index = first_node; index < last_node && !progress_obj.Is_Cancel_Requested(); index++) {
...
//
////////////////////////////////////////////////////////////////
void SceneEditorClass::Generate_Light_Vis(bool farm_mode, int farm_cpu_index, int farm_cpu_total) {
...
//
////////////////////////////////////////////////////////////////
void SceneEditorClass::Generate_Manual_Vis(bool farm_mode, int farm_cpu_index, int farm_cpu_total) {
...
//
////////////////////////////////////////////////////////////////
void SceneEditorClass::Display_Editor_Objects(bool onoff) {
  ...
  for (int index = 0; index < node_list.Count(); index++) {
    ...
    if (node != NULL) {
      ...
      //
      if (type == NODE_TYPE_ZONE || type == NODE_TYPE_WAYPATH || type == NODE_TYPE_WAYPOINT ||
          type == NODE_TYPE_LIGHT || type == NODE_TYPE_TRANSITION || type == NODE_TYPE_TRANSITION_CHARACTER ||
          type == NODE_TYPE_SOUND || type == NODE_TYPE_VIS || type == NODE_TYPE_VIS_POINT ||
          type == NODE_TYPE_PATHFIND_START || type == NODE_TYPE_DUMMY_OBJECT || type == NODE_TYPE_COVER_SPOT ||
          type == NODE_TYPE_COVER_ATTACK_POINT || type == NODE_TYPE_DAMAGE_ZONE || type == NODE_TYPE_BUILDING ||
...
//
////////////////////////////////////////////////////////////////
void SceneEditorClass::Display_Static_Anim_Phys(bool onoff) {
...
//
////////////////////////////////////////////////////////////////
void SceneEditorClass::Enable_Building_Power(bool onoff) {
  //
  ...
  // on or off.
  //
  for (NodeClass *node = NodeMgrClass::Get_First(NODE_TYPE_BUILDING); node != NULL;
...
//
////////////////////////////////////////////////////////////////
void SceneEditorClass::Reset_Dynamic_Object_Visibility_Status(void) {
  //
...
//
////////////////////////////////////////////////////////////////
void SceneEditorClass::Reset_Vis_For_Node(NodeClass *node) {
...
//
////////////////////////////////////////////////////////////////
void SceneEditorClass::Update_Lighting(void) {
  Vector3 lev_min;
  Vector3 lev_max;
...
//
////////////////////////////////////////////////////////////////
void SceneEditorClass::Set_Sun_Light_Orientation(float yaw, float pitch) {
...
//
////////////////////////////////////////////////////////////////
void SceneEditorClass::Show_Vis_Window(bool onoff) {
...
//
////////////////////////////////////////////////////////////////
bool SceneEditorClass::Is_Vis_Window_Visible(void) {
  bool retval = true;

  if (m_VisWindow.m_hWnd == NULL || m_VisWindow.IsWindowVisible() == false) {
    retval = false;
  }
...
//
////////////////////////////////////////////////////////////////
void SceneEditorClass::On_Vis_Occluders_Rendered(VisRenderContextClass &context, VisSampleClass &sample) {
