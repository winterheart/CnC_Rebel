...
public:
  ...
  ///////////////////////////////////////////////////
  MouseModeClass(void) : m_bUpdate(false) {}
...
public:
  ...
  MMObjectManipulateClass(void)
      : m_ObjectMode(MODE_NONE), m_ForceDropToGround(false), m_CurrentMovePos(0, 0, 0), m_IntersectPoint(0, 0, 0) {
    m_LButtonMode = CameraMgr::MODE_MOVE_PLANE;
    m_RButtonMode = CameraMgr::MODE_MOVE_PLANE;
    m_BothButtonMode = CameraMgr::MODE_MOVE_PLANE;
  }
...
protected:
  ...
  //	Public data types
  ///////////////////////////////////////////////////
  typedef enum { MODE_NONE = -1, MODE_SELECT = 0, MODE_LINK, MODE_MOVE, MODE_ROTATE, MODE_COUNT } OBJECT_MODE;
...
public:
  ...
  //	Public constructors/destructors
  ///////////////////////////////////////////////////
  MMWaypathEditClass(void) : m_CurrentPoint(-1), m_Waypath(NULL) {
    m_LButtonMode = CameraMgr::MODE_MOVE_PLANE;
    m_RButtonMode = CameraMgr::MODE_MOVE_PLANE;
    m_BothButtonMode = CameraMgr::MODE_MOVE_PLANE;
  }
  ...
  virtual void Set_Waypath(WaypathNodeClass *waypath, int index = 0) {
    m_Waypath = waypath;
...
public:
  ...
  //	Public constructors/destructors
  ///////////////////////////////////////////////////
  MMGrabHandleDragClass(void) : m_Node(NULL), m_Vertex(0) {
    m_LButtonMode = CameraMgr::MODE_MOVE_PLANE;
    m_RButtonMode = CameraMgr::MODE_MOVE_PLANE;
    m_BothButtonMode = CameraMgr::MODE_MOVE_PLANE;
  }
...
public:
  ...
  //	Mouse message handlers
  //
  void Handle_LButton_Dblclk(UINT flags, CPoint point) {
    m_pModeObjects[m_MouseMode]->Handle_LButton_Dblclk(flags, point);
  }
  void Handle_LButton_Down(UINT flags, CPoint point) {
    m_pModeObjects[m_MouseMode]->Handle_LButton_Down(flags, point);
    IsLButtonDown = true;
  }
  void Handle_LButton_Up(UINT flags, CPoint point) {
    m_pModeObjects[m_MouseMode]->Handle_LButton_Up(flags, point);
    IsLButtonDown = false;
  }
  void Handle_RButton_Down(UINT flags, CPoint point) {
    m_pModeObjects[m_MouseMode]->Handle_RButton_Down(flags, point);
    IsRButtonDown = true;
  }
  void Handle_RButton_Up(UINT flags, CPoint point) {
    m_pModeObjects[m_MouseMode]->Handle_RButton_Up(flags, point);
    IsRButtonDown = false;
  }
