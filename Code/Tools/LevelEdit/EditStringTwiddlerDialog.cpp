...
EditStringTwiddlerDialogClass::EditStringTwiddlerDialogClass(CWnd *pParent /*=NULL*/)
    : StringObject(NULL), CDialog(EditStringTwiddlerDialogClass::IDD, pParent) {
...
//
/////////////////////////////////////////////////////////////////////////////
void EditStringTwiddlerDialogClass::DoDataExchange(CDataExchange *pDX) {
...
//
/////////////////////////////////////////////////////////////////////////////
BOOL EditStringTwiddlerDialogClass::OnInitDialog(void) {
...
//
/////////////////////////////////////////////////////////////////////////////
void EditStringTwiddlerDialogClass::Insert_String(int string_id) {
  //
...
//
/////////////////////////////////////////////////////////////////////////////
void EditStringTwiddlerDialogClass::OnAddButton(void) {
  //
...
//
/////////////////////////////////////////////////////////////////////////////
void EditStringTwiddlerDialogClass::OnOK(void) {
  //
...
//
/////////////////////////////////////////////////////////////////////////////
void EditStringTwiddlerDialogClass::OnKeydownListctrl(NMHDR *pNMHDR, LRESULT *pResult) {
