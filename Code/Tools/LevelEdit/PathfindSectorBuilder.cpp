...
PathfindSectorBuilderClass::PathfindSectorBuilderClass(void)
    : m_CurrentSector(NULL), m_SimBoundingBox(Vector3(0.5F, 0.5F, 1.8F)), m_SimBoxExtents(Vector3(0.25F, 0.25F, 0.9F)),
      m_DirInfo(NULL), m_StepHeight(0), m_TotalBoxCount(0), m_TotalBoxGuess(0), m_BeforeUpdateCount(0),
      m_AllowWaterFloodfill(false), m_MaxSectorDim(28000.0F) {
...
//
//////////////////////////////////////////////////////////////////////////
void PathfindSectorBuilderClass::Prepare_Level(void) {
...
//
//////////////////////////////////////////////////////////////////////////
void PathfindSectorBuilderClass::Restore_Level(void) {
  //
...
//
//////////////////////////////////////////////////////////////////////////
void PathfindSectorBuilderClass::Initialize(void) {
  Prepare_Level();
...
//
//////////////////////////////////////////////////////////////////////////
void PathfindSectorBuilderClass::Shutdown(void) {
  //
  //	Do some cleanup
  //
...
//
//////////////////////////////////////////////////////////////////////////
void PathfindSectorBuilderClass::Compress_Sectors_For_Dyna_Culling(void) {
...
//
//////////////////////////////////////////////////////////////////////////
void PathfindSectorBuilderClass::Compress_Sectors_For_Pathfind(void) {
  //
...
//
//////////////////////////////////////////////////////////////////////////
void PathfindSectorBuilderClass::Generate_Sectors(void) {
  //
...
//
//////////////////////////////////////////////////////////////////////////
bool PathfindSectorBuilderClass::Find_Ground(const Vector3 &pos, float *ground_pos) {
  bool retval = false;
  ...
  PhysAABoxCollisionTestClass test(sweep_box, sweep_vector, &result, STATIC_OBJ_COLLISION_GROUP,
  ...
  //
  if ((result.StartBad == false) && (result.Fraction < 1.0F) && (result.Normal.Z > 0.71F) &&
...
//
//////////////////////////////////////////////////////////////////////////
bool PathfindSectorBuilderClass::Find_Ceiling(const Vector3 &pos, float *ceiling_pos) {
  bool retval = false;
...
//
//////////////////////////////////////////////////////////////////////////
bool PathfindSectorBuilderClass::Try_Moving_Here(const Vector3 &start_pos, const Vector3 &expected_pos,
                                                 AABoxClass *real_pos) {
  bool is_valid = false;
...
//
//////////////////////////////////////////////////////////////////////////
bool PathfindSectorBuilderClass::Try_Standing_Here(const Vector3 &expected_pos, AABoxClass *real_pos) {
  bool is_valid = false;
  ...
  //
  CastResultStruct result;
  PhysAABoxCollisionTestClass test(sweep_box, m_SimMovement, &result, STATIC_OBJ_COLLISION_GROUP,
                                   COLLISION_TYPE_PHYSICAL);
...
//
//////////////////////////////////////////////////////////////////////////
void PathfindSectorBuilderClass::Do_Physics_Sim(const Vector3 &start_pos, PATHFIND_DIR direction) {
  //
...
//
//////////////////////////////////////////////////////////////////////////
void PathfindSectorBuilderClass::Do_Real_Physics_Sim(const Vector3 &start_pos, PATHFIND_DIR direction) {
  //
  //	Determine where the next cell should be
  //
  Vector3 expected_pos = start_pos + m_DirInfo[direction].move;
  ...
  if (found == false) {
    ...
    PhysicsSceneClass::Get_Instance()->Collect_Collideable_Objects(test_box, COLLISION_TYPE_PHYSICAL, true, false,
                                                                   &obj_list);
...
//
//////////////////////////////////////////////////////////////////////////
FloodfillBoxClass *PathfindSectorBuilderClass::Submit_Box(FloodfillBoxClass *from_obj, const AABoxClass &new_box,
...
//
//////////////////////////////////////////////////////////////////////////
void PathfindSectorBuilderClass::Floodfill(const Vector3 &start_pos) {
  //
...
//
//////////////////////////////////////////////////////////////////////////
FloodfillBoxClass *PathfindSectorBuilderClass::Get_Sector_Occupant(const Vector3 &pos) {
  //
...
//
//////////////////////////////////////////////////////////////////////////
void PathfindSectorBuilderClass::Mark_Sector(FloodfillBoxClass *body_box) {
  //
...
//
//////////////////////////////////////////////////////////////////////////
FloodfillBoxClass *PathfindSectorBuilderClass::Mark_Sector(const AABoxClass &bounding_box) {
  //
...
//
///////////////////////////////////////////////////////////////////////////
void PathfindSectorBuilderClass::Determine_Height(FloodfillBoxClass *start_box, float *min_z_pos, float *max_z_pos) {
...
//
//////////////////////////////////////////////////////////////////////////
int PathfindSectorBuilderClass::Build_Height_Values(void) {
...
//
//////////////////////////////////////////////////////////////////////////
inline bool Can_Traverse(FloodfillBoxClass *cell, PATHFIND_DIR dir) {
  //
...
//
//////////////////////////////////////////////////////////////////////////
inline bool Check_Directions(FloodfillBoxClass *cell, int dir_mask) {
  bool is_valid = true;
...
//
//////////////////////////////////////////////////////////////////////////
inline FloodfillBoxClass *PathfindSectorBuilderClass::Move_Dir(FloodfillBoxClass *start_box, PATHFIND_DIR dir,
                                                               int dir_mask) {
  //
  ...
  //
  if (start_box->Is_Two_Way_Traversible(dir) && Can_Traverse(new_cell, dir) && Check_Directions(new_cell, dir_mask)) {
    //
...
//
//////////////////////////////////////////////////////////////////////////
inline bool PathfindSectorBuilderClass::Check_Edge(FloodfillBoxClass *start_box, int count_left, int count_right,
                                                   int count_up, int count_down, PATHFIND_DIR move_dir) {
  bool retval = false;
...
//
//////////////////////////////////////////////////////////////////////////
FloodfillBoxClass *PathfindSectorBuilderClass::Find_Perimeter(FloodfillBoxClass *start_box, BOX_PERIMETER *perimeter) {
  ...
  } while (perimeter->stop_up == false || perimeter->stop_down == false || perimeter->stop_left == false ||
           perimeter->stop_right == false);
  ...
  if (upper_left1 != upper_left2) {
    CString message;
    message.Format("upper_left1 = %d\nupper_left2 = %d\nup_cell = %d\nleft_cell = %d", upper_left1, upper_left2,
                   up_cell, left_cell);
...
//
//////////////////////////////////////////////////////////////////////////
void PathfindSectorBuilderClass::Compress_Sectors(DynamicVectorClass<AABoxClass> *box_list) {
  //
  ...
  while (keep_going && ((start_box = FloodfillBoxClass::Get_First()) != NULL)) {
    ...
    //
    if ((start_box == old_start_box) && (FloodfillBoxClass::Get_First() != FloodfillBoxClass::Get_Last())) {
...
//
//////////////////////////////////////////////////////////////////////////
void Scan_Edge(FloodfillBoxClass *start_obj, int cell_count, PATHFIND_DIR check_dir, PATHFIND_DIR move_dir,
               int *best_count) {
...
//
//////////////////////////////////////////////////////////////////////////
bool PathfindSectorBuilderClass::Is_Valid_Sector(FloodfillBoxClass **upper_left_ptr, int &cells_right,
                                                 int &cells_down) {
  bool retval = true;
...
//
//////////////////////////////////////////////////////////////////////////
PathfindSectorClass *PathfindSectorBuilderClass::Build_Sector(FloodfillBoxClass *upper_left_ptr, int cells_right,
                                                              int cells_down) {
  ...
  for (int right = 0; (right < cells_right); right++) {
    ...
    for (int down = 0; (down < cells_down); down++) {
      ...
      //
      if ((down == 0) || (right == 0) || (down == (cells_down - 1)) || (right == (cells_right - 1))) {
        if (is_valid) {
...
//
//////////////////////////////////////////////////////////////////////////
void PathfindSectorBuilderClass::Generate_Portals(void) {
  //
...
//
///////////////////////////////////////////////////////////////////////////
void PathfindSectorBuilderClass::Free_Floodfill_Boxes(void) {
  //
...
//
///////////////////////////////////////////////////////////////////////////
void PathfindSectorBuilderClass::Cleanup_Level_Features(void) {
  //
...
//
///////////////////////////////////////////////////////////////////////////
void PathfindSectorBuilderClass::Detect_Level_Features(void) {
  //
...
//
///////////////////////////////////////////////////////////////////////////
void PathfindSectorBuilderClass::Detect_Elevators(void) {
  //
  //	Get the list of all static objects from the physics scene
  //
  RefPhysListIterator iterator = ::Get_Scene_Editor()->Get_Static_Object_Iterator();
...
//
///////////////////////////////////////////////////////////////////////////
void PathfindSectorBuilderClass::Detect_Doors(void) {
  //
  //	Get the list of all static objects from the physics scene
  //
  RefPhysListIterator iterator = ::Get_Scene_Editor()->Get_Static_Object_Iterator();
  for (iterator.First(); !iterator.Is_Done(); iterator.Next()) {
    ...
    if (door != NULL && door->Get_DoorPhysDef() != NULL && door->Get_DoorPhysDef()->Is_Vehicle_Door() == false) {
...
//
///////////////////////////////////////////////////////////////////////////
void PathfindSectorBuilderClass::Detect_Level_Transitions(void) {
  int ladder_index = 0;
...
//
///////////////////////////////////////////////////////////////////////////
void PathfindSectorBuilderClass::Post_Process_Floodfill_For_Level_Features(void) {
  //
...
//
///////////////////////////////////////////////////////////////////////////
void PathfindSectorBuilderClass::Apply_Level_Features(void) {
  //
...
//
///////////////////////////////////////////////////////////////////////////
TransitionInstanceClass *PathfindSectorBuilderClass::Find_Transition(TransitionDataClass::StyleType transition_type,
  ...
  for (node = (TransitionNodeClass *)NodeMgrClass::Get_First(NODE_TYPE_TRANSITION); node != NULL;
    ...
    if (index >= 0) {
      ...
      if (transition != NULL) {
        ...
        //
        if ((curr_delta < closest_z) && (WWMath::Fabs(start_pos.X - zone.Center.X) < 1.0F) &&
...
//
///////////////////////////////////////////////////////////////////////////
PathfindSectorClass *PathfindSectorBuilderClass::Find_Sector(const Vector3 &point, const AABoxClass &box) {
...
//
///////////////////////////////////////////////////////////////////////////
void PathfindSectorBuilderClass::Check_For_Level_Feature(FloodfillBoxClass *body_box) {
  if (m_LevelFeatureCullingSystem.Object_Count() > 0) {
    ...
    for (level_feature = m_LevelFeatureCullingSystem.Get_First_Collected_Object(); level_feature != NULL;
...
//
///////////////////////////////////////////////////////////////////////////
void PathfindSectorBuilderClass::Path_Across_Feature(LevelFeatureClass *level_feature) {
  //
...
//
////////////////////////////////////////////////////////////////////////////
UINT fnPathfindDialogThread(DWORD dwparam1, DWORD dwparam2, DWORD /*dwparam3*/, HRESULT * /*presult*/,
                            HWND * /*phmain_wnd*/
) {
