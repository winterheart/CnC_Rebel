...
//
/////////////////////////////////////////////////////////////
const GroupMgrClass &GroupMgrClass::operator=(const GroupMgrClass &src) {
...
//
/////////////////////////////////////////////////////////////
void GroupMgrClass::Export_Nodes(NODE_LIST &node_list) {
  //
...
//
/////////////////////////////////////////////////////////////
void GroupMgrClass::Import_Nodes(const NODE_LIST &node_list) {
...
//
/////////////////////////////////////////////////////////////
void GroupMgrClass::Remove_Node(NodeClass *node_to_remove) {
  bool found = false;
...
//
/////////////////////////////////////////////////////////////
void GroupMgrClass::Free_List(void) {
  for (int index = 0; index < m_GroupList.Count(); index++) {
    NodeClass *node = m_GroupList[index];
    MEMBER_RELEASE(node);
  }
...
//
/////////////////////////////////////////////////////////////
bool GroupMgrClass::Is_Item_In_Group(NodeClass *node_to_find) {
  bool retval = false;

  //
  //	Loop until we've found the node
  //
  for (int index = 0; (retval == false) && (index < m_GroupList.Count()); index++) {
    NodeClass *node = m_GroupList[index];
...
//
/////////////////////////////////////////////////////////////
void GroupMgrClass::Clone_Group(void) {
  NODE_LIST temp_list;
...
//
/////////////////////////////////////////////////////////////
void GroupMgrClass::Recalc_Stats(void) {
...
//
/////////////////////////////////////////////////////////////
void GroupMgrClass::Hide(bool hide) {
  // Loop through all the nodes in the group
  for (int index = 0; index < m_GroupList.Count(); index++) {
    NodeClass *node = m_GroupList[index];
    if (node != NULL) {
...
//
/////////////////////////////////////////////////////////////
void SelectionMgrClass::Remove_Node(NodeClass *node) {
  //
...
//
/////////////////////////////////////////////////////////////
void SelectionMgrClass::Reset(void) {
  // Loop through all the nodes in the group
  for (int index = 0; index < m_GroupList.Count(); index++) {
    NodeClass *node = m_GroupList[index];
    if (node != NULL) {
...
//
/////////////////////////////////////////////////////////////
void SelectionMgrClass::Clone_Group(void) {
  //
...
//
/////////////////////////////////////////////////////////////
void UserGroupMgrClass::Recalc_Stats(void) {
...
//
/////////////////////////////////////////////////////////////
void UserGroupMgrClass::Update_Global_Group_List(void) {
...
//
/////////////////////////////////////////////////////////////
void UserGroupMgrClass::Remove_Node(NodeClass *node) {
...
//
/////////////////////////////////////////////////////////////
UserGroupMgrClass::~UserGroupMgrClass(void) { return; }
