...
StringLibraryDialogClass::StringLibraryDialogClass(CWnd *pParent)
    : IsInitialized(false), CurrentTab(0), Mode(MODE_STRING), CDialog(StringLibraryDialogClass::IDD, pParent) {
...
//
/////////////////////////////////////////////////////////////////////////////
void StringLibraryDialogClass::DoDataExchange(CDataExchange *pDX) {
...
//
/////////////////////////////////////////////////////////////////////////////
BOOL StringLibraryDialogClass::OnInitDialog(void) {
...
//
/////////////////////////////////////////////////////////////////////////////
void StringLibraryDialogClass::OnSize(UINT nType, int cx, int cy) {
...
//
/////////////////////////////////////////////////////////////////////////////
void StringLibraryDialogClass::Resize_Controls(void) {
  //
  ...
  for (int index = 0; index < CategoryPages.Count(); index++) {
    CategoryPages[index]->SetWindowPos(NULL, tab_rect.left + BORDER_X, tab_rect.top + BORDER_Y,
                                       tab_rect.Width() - BORDER_X * 2, tab_rect.Height() - BORDER_Y * 2,
...
//
/////////////////////////////////////////////////////////////////////////////
void StringLibraryDialogClass::OnOK(void) {
  //
  //	Reset the database
  //
...
//
/////////////////////////////////////////////////////////////////////////////
void StringLibraryDialogClass::OnSelchangeTabCtrl(NMHDR *pNMHDR, LRESULT *pResult) {
  (*pResult) = 0;
...
//
/////////////////////////////////////////////////////////////////////////////
void StringLibraryDialogClass::Update_Page_Visibility(void) {
  //
...
//
/////////////////////////////////////////////////////////////////////////////
void StringLibraryDialogClass::OnAdd(void) {
...
//
/////////////////////////////////////////////////////////////////////////////
void StringLibraryDialogClass::OnRemove(void) {
  //
...
//
/////////////////////////////////////////////////////////////////////////////
void StringLibraryDialogClass::Add_Category_Page(TDBCategoryClass *category) {
  //
...
//
/////////////////////////////////////////////////////////////////////////////
void StringLibraryDialogClass::On_Cut(void) {
  Clear_Clipboard();
...
//
/////////////////////////////////////////////////////////////////////////////
void StringLibraryDialogClass::On_Paste(void) {
...
//
/////////////////////////////////////////////////////////////////////////////
void StringLibraryDialogClass::Clear_Clipboard(void) {
...
//
/////////////////////////////////////////////////////////////////////////////
void StringLibraryDialogClass::OnRename(void) {
  //
...
//
/////////////////////////////////////////////////////////////////////////////
void StringLibraryDialogClass::OnModeTwiddler(void) {
  Mode = MODE_TWIDDLER;
  Update_Mode();
...
//
/////////////////////////////////////////////////////////////////////////////
void StringLibraryDialogClass::OnModeString(void) {
  Mode = MODE_STRING;
  Update_Mode();
