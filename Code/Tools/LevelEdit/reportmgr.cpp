...
//
//////////////////////////////////////////////////////////////////////
void ReportMgrClass::Export_File_Usage_Report(const char *filename) {
  //
  //	Open the text file
  //
  TextFileClass file;
...
//
///////////////////////////////////////////////////////////////////////
void ReportMgrClass::Add_Definition_Dependencies(DefinitionClass *definition, STRING_LIST &list) {
  if (definition == NULL) {
    return;
  }
  ...
  for (int index = 0; index < count; index++) {
    ...
    if (parameter->Get_Type() == ParameterClass::TYPE_FILENAME ||
      ...
      DefinitionClass *sub_def =
          DefinitionMgrClass::Find_Definition(parameter->As_DefParameterClass()->Get_Value(), false);
...
//
//////////////////////////////////////////////////////////////////////
void ReportMgrClass::Export_Missing_Translation_Report(const char *filename, int lang_id) {
  //
  //	Open the text file
  //
  TextFileClass file;
