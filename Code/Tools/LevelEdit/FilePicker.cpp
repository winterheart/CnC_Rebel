...
//
///////////////////////////////////////////////////////////
FilePickerClass::FilePickerClass(void) : m_AssetTreeOnly(true), PickerClass() {
  m_ExtensionString = "*.*";
...
//
///////////////////////////////////////////////////////////
FilePickerClass::~FilePickerClass(void) { return; }
...
//
///////////////////////////////////////////////////////////
void FilePickerClass::On_Pick(void) {
  CString window_text;
  ...
  CFileDialog dialog(TRUE, m_ExtensionString, filename, OFN_HIDEREADONLY | OFN_OVERWRITEPROMPT | OFN_EXPLORER,
                     m_FilterString, this);
