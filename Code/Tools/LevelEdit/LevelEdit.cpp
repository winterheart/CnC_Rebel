...
//
/////////////////////////////////////////////////////////////////////////////
void fnMessage_Print_Func(DebugType /*type*/, const char *message) {
...
//
/////////////////////////////////////////////////////////////////////////////
void fnAssert_Print_Func(const char *message) {
  ::Output_Message(message);
  return;
}
...
//
/////////////////////////////////////////////////////////////////////////////
bool fnTrigger_Func(int trigger_num) {
...
//
/////////////////////////////////////////////////////////////////////////////
BOOL CLevelEditApp::InitInstance(void) {
  //
  ...
  pDocTemplate = new CSingleDocTemplate(IDR_MAINFRAME2, RUNTIME_CLASS(CLevelEditDoc),
  ...
  CSingleDocTemplate *pDocTemplate;
  pDocTemplate = new CSingleDocTemplate(IDR_MAINFRAME, RUNTIME_CLASS(CLevelEditDoc),
                                        RUNTIME_CLASS(CMainFrame), // main SDI frame window
                                        RUNTIME_CLASS(CLevelEditView));
  AddDocTemplate(pDocTemplate);
  ...
  HKEY reg_key = NULL;
  if (::RegCreateKeyEx(HKEY_CURRENT_USER, INSTALL_KEY, 0L, NULL, 0L, KEY_ALL_ACCESS, NULL, &reg_key, NULL) ==
      ERROR_SUCCESS) {
    ::RegSetValueEx(reg_key, INSTALL_VALUE, 0L, REG_SZ, (BYTE *)install_path, ::lstrlen(install_path) + 1);
    ::RegCloseKey(reg_key);
  }
...
void CLevelEditApp::OnFileOpen(void) {
  CFileDialog dialog(TRUE, ".lvl", NULL, OFN_HIDEREADONLY | OFN_OVERWRITEPROMPT | OFN_EXPLORER, "Level Files|*.lvl||",
                     ::AfxGetMainWnd());
...
void Register_Light_Icon(void) {
  ...
  //
  if (::RegCreateKeyEx(HKEY_CLASSES_ROOT, ".wlt", 0, NULL, REG_OPTION_NON_VOLATILE, KEY_ALL_ACCESS, NULL, &reg_key,
                       &disp) == ERROR_SUCCESS) {
    //
    ...
    //
    if (::RegCreateKeyEx(HKEY_CLASSES_ROOT, LIGHT_ICON_KEY, 0, NULL, REG_OPTION_NON_VOLATILE, KEY_ALL_ACCESS, NULL,
...
//
/////////////////////////////////////////////////////////////
BOOL CLevelEditApp::PreTranslateMessage(MSG *pMsg) {
  BOOL retval = false;
