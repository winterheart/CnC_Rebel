...
StringPickerDialogClass::StringPickerDialogClass(CWnd *pParent)
    : SelectedObjectID(0), CurrentTab(0), IsInitialized(false), CDialog(StringPickerDialogClass::IDD, pParent) {
...
//
/////////////////////////////////////////////////////////////////////////////
void StringPickerDialogClass::DoDataExchange(CDataExchange *pDX) {
...
//
/////////////////////////////////////////////////////////////////////////////
void StringPickerDialogClass::Create(CWnd *parent_wnd) {
...
//
/////////////////////////////////////////////////////////////////////////////
void StringPickerDialogClass::Resize_Controls(void) {
  //
  ...
  //
  ::SetWindowPos(::GetDlgItem(m_hWnd, IDC_STRING_EDIT), NULL, 0, edit_y_pos, tab_width, edit_height,
                 SWP_NOZORDER | SWP_NOCOPYBITS | SWP_NOACTIVATE);
...
//
/////////////////////////////////////////////////////////////////////////////
void StringPickerDialogClass::OnSelchangeTabCtrl(NMHDR *pNMHDR, LRESULT *pResult) {
  (*pResult) = 0;
...
//
/////////////////////////////////////////////////////////////////////////////
void StringPickerDialogClass::Update_Page_Visibility(void) {
  //
...
//
/////////////////////////////////////////////////////////////////////////////
void StringPickerDialogClass::OnSize(UINT nType, int cx, int cy) {
...
//
/////////////////////////////////////////////////////////////////////////////
BOOL StringPickerDialogClass::OnInitDialog(void) {
...
//
/////////////////////////////////////////////////////////////////////////////
void StringPickerDialogClass::Add_Category_Page(TDBCategoryClass *category) {
  //
...
//
/////////////////////////////////////////////////////////////////////////////
int StringPickerDialogClass::Get_Selection(void) {
  //
...
//
/////////////////////////////////////////////////////////////////////////////
void StringPickerDialogClass::On_Selection_Changed(int sel_object_id) {
...
//
/////////////////////////////////////////////////////////////////////////////
void StringPickerDialogClass::Update_Selected_String(void) {
