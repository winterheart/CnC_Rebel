...
//
////////////////////////////////////////////////////////////////////////
FileMgrClass::FileMgrClass(void) : m_bVSSInitialized(false), m_bReadOnlyVSS(true), m_IsSpecialUser(false) {
  ...
  //
  if ((m_BasePath.GetLength() > 0) && m_BasePath[::lstrlen(m_BasePath) - 1] != '\\') {
    m_BasePath += "\\";
  }
...
//
////////////////////////////////////////////////////////////////////////
void FileMgrClass::Initialize(void) {
  Free_Data();
  return;
}
...
//
////////////////////////////////////////////////////////////////////////
void FileMgrClass::Free_Data(void) {
...
//
////////////////////////////////////////////////////////////////////////
CString FileMgrClass::Make_Full_Path(LPCTSTR rel_path) {
...
//
////////////////////////////////////////////////////////////////////////
CString FileMgrClass::Make_Relative_Path(LPCTSTR full_path) {
...
//
////////////////////////////////////////////////////////////////////////
bool FileMgrClass::Is_Empty_Path(LPCTSTR path) {
  bool retval = true;
...
//
////////////////////////////////////////////////////////////////////////
bool FileMgrClass::Is_Path_Valid(LPCTSTR path) {
...
//
////////////////////////////////////////////////////////////////////////
bool FileMgrClass::Is_Path_In_Asset_Tree(LPCTSTR path) {
...
//
////////////////////////////////////////////////////////////////////////
bool FileMgrClass::Does_File_Exist(LPCTSTR filename, bool update_from_vss) {
...
//
/////////////////////////////////////////////////////////////////
int FileMgrClass::Find_File(LPCTSTR filename) const {
  // Assume failure
  int index = -1;
...
//
/////////////////////////////////////////////////////////////////
bool FileMgrClass::Remove_File(int index) {
  // Assume failure
  bool retval = false;
...
//
/////////////////////////////////////////////////////////////////
bool FileMgrClass::Add_Files_To_Database(LPCTSTR filename) {
  // Assume success
  // bool retval = true;
  ASSERT(filename != NULL);
...
//
/////////////////////////////////////////////////////////////////
bool FileMgrClass::Add_File_To_Database(LPCTSTR filename) {
  CString path = Make_Full_Path(filename);
  if (Does_File_Exist(path) && (m_DatabaseInterface->Does_File_Exist(path) == false)) {
...
//
/////////////////////////////////////////////////////////////////
void FileMgrClass::Add_Files_To_Database(void) {
  ...
  for (int index = 0; index < unique_list.Count(); index++) {
    ...
    //
    if (Does_File_Exist(full_path) && (m_DatabaseInterface->Does_File_Exist(full_path) == false)) {
...
//
/////////////////////////////////////////////////////////////////
int FileMgrClass::Add_File(LPCTSTR filename, bool subdir_important) {
  // Assume failure
  int index = -1;
...
//
/////////////////////////////////////////////////////////////////
bool FileMgrClass::Update_Texture_Cache(LPCTSTR start_path, RenderObjClass *prender_obj) {
  // Assume failure
  bool retval = false;
...
//
/////////////////////////////////////////////////////////////////
int FileMgrClass::Build_Texture_List(LPCTSTR start_path, RenderObjClass *prender_obj,
...
//
/////////////////////////////////////////////////////////////////
bool FileMgrClass::Determine_File_Location(LPCTSTR full_path, CString &real_location) {
  bool retval = false;
...
//
/////////////////////////////////////////////////////////////////
void FileMgrClass::Build_File_List(LPCTSTR start_path, RenderObjClass *render_obj, FILE_LIST &file_list) {
  CString path = start_path;
  ::Delimit_Path(path);
...
//
/////////////////////////////////////////////////////////////////
bool FileMgrClass::Initialize_VSS(LPCTSTR ini_file_path, LPCTSTR username, LPCTSTR password) {
  // Do we need to initialize the VSS database?
  if (m_bVSSInitialized == false) {

    // Attempt to open the database
    m_bVSSInitialized =
        m_DatabaseInterface->Open_Database(ini_file_path, username ? username : "User", password ? password : "");
...
//
/////////////////////////////////////////////////////////////////
bool FileMgrClass::Is_File_In_VSS(LPCTSTR filename) {
  // Assume failure
  bool retval = false;
...
//
/////////////////////////////////////////////////////////////////
int FileMgrClass::Build_Update_List(DynamicVectorClass<LevelFileStruct *> &update_list) {
  int count = 0;
...
//
/////////////////////////////////////////////////////////////////
bool FileMgrClass::Update_Files(DynamicVectorClass<LevelFileStruct *> *pupdate_list) {
  // Asssume success
  bool retval = true;
...
//
/////////////////////////////////////////////////////////////////
bool FileMgrClass::Update_File(int index) {
  // Asssume failure
  bool retval = false;
...
//
/////////////////////////////////////////////////////////////////
bool FileMgrClass::Update_File(LPCTSTR filename) {
  // Asssume failure
  bool retval = false;
...
//
/////////////////////////////////////////////////////////////////
bool FileMgrClass::Update_All_Files(LPCTSTR dest_path, LPCTSTR search_mask) {
  bool retval = false;
...
//
/////////////////////////////////////////////////////////////////
bool FileMgrClass::Get_Subproject(LPCTSTR path) {
  // Asssume failure
  bool retval = false;
...
//
/////////////////////////////////////////////////////////////////
void FileMgrClass::Set_Base_Path(LPCTSTR base) {
...
//
/////////////////////////////////////////////////////////////////
void FileMgrClass::Find_Files(LPCTSTR start_path, LPCTSTR wildcard, DynamicVectorClass<CString> &file_list,
                              bool recurse) {
  CString path = start_path;
  ...
  BOOL bcontinue = TRUE;
  HANDLE hfile_find;
  for (hfile_find = ::FindFirstFile(file_spec, &find_info); (hfile_find != INVALID_HANDLE_VALUE) && bcontinue;
...
//
/////////////////////////////////////////////////////////////////
bool FileMgrClass::Update_Model(LPCTSTR local_path, LPCTSTR new_filename) {
  // Assume failure
  bool retval = false;
...
//
/////////////////////////////////////////////////////////////////
void FileMgrClass::Build_Dependency_List(LPCTSTR asset_filename, UniqueListClass<CString> &list) {
...
//
/////////////////////////////////////////////////////////////////
bool FileMgrClass::Update_Asset_Tree(void) { return m_DatabaseInterface->Get_Subproject(m_BasePath); }

/////////////////////////////////////////////////////////////////
//
//	Build_Global_Include_List
//
void FileMgrClass::Build_Global_Include_List(void) {
...
//
/////////////////////////////////////////////////////////////////
void FileMgrClass::Build_Include_List(LPCTSTR ini_filename, DynamicVectorClass<CString> &list) {
  ...
  if (pini != NULL) {
    ...
    for (int index = 0; index < instance_count; index++) {
      ...
      pini->Get_String("Assets", pini->Get_Entry("Assets", index), "", filespec, sizeof(filespec));
...
//
/////////////////////////////////////////////////////////////////
bool FileMgrClass::Update_Global_Include_File_List(void) {
  bool retval = false;
...
//
/////////////////////////////////////////////////////////////////
void FileMgrClass::Update(NodeClass *node, bool add_node) {
  //
...
//
/////////////////////////////////////////////////////////////////
void FileMgrClass::Update(PresetClass *preset, bool add_node) {
  //
...
//
/////////////////////////////////////////////////////////////////
void FileMgrClass::Get_Preset_Library_Path(uint32 class_id, bool is_temp, CString &path) {
