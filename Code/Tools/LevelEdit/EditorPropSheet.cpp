...
EditorPropSheetClass::EditorPropSheetClass(void)
    : m_iCurrentTab(0), m_IsReadOnly(false), CDialog(EditorPropSheetClass::IDD, ::AfxGetMainWnd()) {
...
//
/////////////////////////////////////////////////////////////////////////////
void EditorPropSheetClass::DoDataExchange(CDataExchange *pDX) {
...
#ifdef _DEBUG
void EditorPropSheetClass::AssertValid() const { CDialog::AssertValid(); }

void EditorPropSheetClass::Dump(CDumpContext &dc) const { CDialog::Dump(dc); }
#endif //_DEBUG
...
//
/////////////////////////////////////////////////////////////////////////////
void EditorPropSheetClass::Reposition_Buttons(int cx, int cy) {
  //
  ...
  //
  ::SetWindowPos(::GetDlgItem(m_hWnd, IDCANCEL), NULL, (cx - button_rect.Width()) - BORDER_BUTTON_X,
                 (cy - button_rect.Height()) - BORDER_BUTTON_Y, 0, 0, SWP_NOZORDER | SWP_NOSIZE);

  ::SetWindowPos(::GetDlgItem(m_hWnd, IDC_OK), NULL, (cx - (button_rect.Width() << 1)) - (BORDER_BUTTON_X * 2),
                 (cy - button_rect.Height()) - BORDER_BUTTON_Y, 0, 0, SWP_NOZORDER | SWP_NOSIZE);
...
//
/////////////////////////////////////////////////////////////////////////////
void EditorPropSheetClass::OnSize(UINT nType, int cx, int cy) {
  ...
  if (::IsWindow(m_TabCtrl) && (cx > 0) && (cy > 0)) {
    ...
    for (int tab = 0; tab < m_TabList.Count(); tab++) {
...
//
/////////////////////////////////////////////////////////////////////////////
void EditorPropSheetClass::OnSelchangeTabCtrl(NMHDR *pNMHDR, LRESULT *pResult) {
...
//
/////////////////////////////////////////////////////////////////////////////
BOOL EditorPropSheetClass::OnInitDialog(void) {
  // Allow the base class to process this message
...
//
/////////////////////////////////////////////////////////////////////////////
BOOL EditorPropSheetClass::OnCommand(WPARAM wParam, LPARAM lParam) {
...
//
/////////////////////////////////////////////////////////////////////////////
void EditorPropSheetClass::OnOk(void) {
  if (Apply_Changes()) {
    EndDialog(IDOK);
  }
...
//
/////////////////////////////////////////////////////////////////////////////
bool EditorPropSheetClass::Apply_Changes(void) {
  bool is_valid = true;
...
//
/////////////////////////////////////////////////////////////////////////////
void EditorPropSheetClass::OnCancel(void) {
  for (int tab = 0; tab < m_TabList.Count(); tab++) {
