...
EditConversationDialogClass::EditConversationDialogClass(CWnd *pParent /*=NULL*/)
    : m_Conversation(NULL), CDialog(EditConversationDialogClass::IDD, pParent) {
...
//
/////////////////////////////////////////////////////////////////////////////
void EditConversationDialogClass::DoDataExchange(CDataExchange *pDX) {
...
//
/////////////////////////////////////////////////////////////////////////////
BOOL EditConversationDialogClass::OnInitDialog(void) {
  ...
  //
  HICON lock_icon =
      (HICON)::LoadImage(::AfxGetResourceHandle(), MAKEINTRESOURCE(IDI_LOCK), IMAGE_ICON, 16, 16, LR_DEFAULTCOLOR);
...
//
/////////////////////////////////////////////////////////////////////////////
void EditConversationDialogClass::OnDblclkRemarkList(NMHDR *pNMHDR, LRESULT *pResult) {
  (*pResult) = 0;
...
//
/////////////////////////////////////////////////////////////////////////////
void EditConversationDialogClass::OnKeydownRemarkList(NMHDR *pNMHDR, LRESULT *pResult) {
...
//
/////////////////////////////////////////////////////////////////////////////
void EditConversationDialogClass::OnOK(void) {
  CDialog::OnOK();
...
//
/////////////////////////////////////////////////////////////////////////////
void EditConversationDialogClass::OnAdd(void) {
  //
  //	Make a bitmask of the orators that are configured
  //
  int orator_bitmask = 0;
...
//
/////////////////////////////////////////////////////////////////////////////
void EditConversationDialogClass::Set_Conversation(ConversationClass *conversation) {
...
//
/////////////////////////////////////////////////////////////////////////////
ConversationRemarkClass *EditConversationDialogClass::Get_Entry_Data(int index) {
...
//
/////////////////////////////////////////////////////////////////////////////
void EditConversationDialogClass::Add_Entry(const ConversationRemarkClass &remark, int insert_index) {
  //
...
//
/////////////////////////////////////////////////////////////////////////////
void EditConversationDialogClass::OnInsert(void) {
  int sel_index = m_ListCtrl.GetNextItem(-1, LVNI_ALL | LVNI_SELECTED);
  if (sel_index != -1) {
...
//
/////////////////////////////////////////////////////////////////////////////
void EditConversationDialogClass::OnItemchangedRemarkList(NMHDR *pNMHDR, LRESULT *pResult) {
...
//
/////////////////////////////////////////////////////////////////////////////
void EditConversationDialogClass::Update_Button_States(void) {
  int sel_index = m_ListCtrl.GetNextItem(-1, LVNI_ALL | LVNI_SELECTED);
...
//
/////////////////////////////////////////////////////////////////////////////
BOOL EditConversationDialogClass::OnCommand(WPARAM wParam, LPARAM lParam) {
...
//
/////////////////////////////////////////////////////////////////////////////
void EditConversationDialogClass::Update_Remarks(int orator_index) {
...
//
/////////////////////////////////////////////////////////////////////////////
void EditConversationDialogClass::Update_Enable_State(int orator_index) {
  BOOL is_checked = (SendDlgItemMessage(ORATOR_CTRLS[orator_index].button_id, BM_GETCHECK) == 1);
...
//
/////////////////////////////////////////////////////////////////////////////
void EditConversationDialogClass::Update_Player_Type_Combos(int orator_index) {
...
//
/////////////////////////////////////////////////////////////////////////////
int EditConversationDialogClass::Get_Orator_Type(int orator_index) {
  int retval = -1;
...
//
/////////////////////////////////////////////////////////////////////////////
void EditConversationDialogClass::OnDeleteitemRemarkList(NMHDR *pNMHDR, LRESULT *pResult) {
  NM_LISTVIEW *pNMListView = (NM_LISTVIEW *)pNMHDR;
  (*pResult) = 0;
...
//
/////////////////////////////////////////////////////////////////////////////
int EditConversationDialogClass::Find_Combobox_Entry(int orator_type) {
  int retval = -1;
