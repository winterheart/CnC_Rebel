...
//
/////////////////////////////////////////////////////////
void ExporterClass::Export_Level(LPCTSTR filename) {
...
//
/////////////////////////////////////////////////////////
void ExporterClass::Make_Temp_Directory(void) {
  //
...
//
/////////////////////////////////////////////////////////
void ExporterClass::Delete_Temp_Directory(void) {
  //
...
//
/////////////////////////////////////////////////////////
void ExporterClass::Export_Dependency_File(void) {
  //
...
//
/////////////////////////////////////////////////////////
bool ExporterClass::Export_Level_File(void) {
  //
...
//
/////////////////////////////////////////////////////////
void ExporterClass::Export_Always_Files(LPCTSTR path) {
  CWaitCursor wait_cursor;
  m_AssetList.Delete_All();
...
//
/////////////////////////////////////////////////////////
bool ExporterClass::Export_Level_Data(void) {
  bool retval = true;
...
//
/////////////////////////////////////////////////////////
void ExporterClass::Export_Database_Mix(LPCTSTR path) {
  CWaitCursor wait_cursor;
  m_AssetList.Delete_All();
...
//
/////////////////////////////////////////////////////////
bool ExporterClass::Export_Definition_Databases(bool use_temp_strings_library) {
...
//
/////////////////////////////////////////////////////////
bool ExporterClass::Build_File_List(const STRING_LIST &search_list, STRING_LIST &file_list) {
  bool retval = true;
...
//
/////////////////////////////////////////////////////////
void ExporterClass::Find_Files(const char *search_mask, STRING_LIST &file_list) {
  //
  ...
  HANDLE hfile_find;
  for (hfile_find = ::FindFirstFile(search_mask, &find_info); (hfile_find != INVALID_HANDLE_VALUE) && keep_going;
  ...
  //
  keep_going = TRUE;
  for (hfile_find = ::FindFirstFile(full_search_mask, &find_info); (hfile_find != INVALID_HANDLE_VALUE) && keep_going;
       keep_going = ::FindNextFile(hfile_find, &find_info)) {
    //
    //	Don't do this if its a directory
    //
...
//
/////////////////////////////////////////////////////////
void ExporterClass::Process_Include_Files(const STRING_LIST &search_list) {
  STRING_LIST file_list;
  Build_File_List(search_list, file_list);
...
//
/////////////////////////////////////////////////////////
bool ExporterClass::Export_Include_Files(const STRING_LIST &file_list) {
  //
...
//
////////////////////////////////////////////////////////////////////////////
bool ExporterClass::Delete_File(LPCTSTR filename) {
  bool retval = false;
...
//
//////////////////////////////////////////////////////////////////////////////////
bool ExporterClass::Clean_Directory(LPCTSTR local_dir) {
  bool retval = true;
  ...
  WIN32_FIND_DATA find_info = {0};
  HANDLE hfind;
  for (HANDLE hfind = ::FindFirstFile(search_mask, &find_info); (hfind != INVALID_HANDLE_VALUE) && keep_going;
...
//
//////////////////////////////////////////////////////////////////////////////////
void ExporterClass::Pre_Level_Export(DynamicVectorClass<NodeClass *> &node_list) {
  //
...
//
//////////////////////////////////////////////////////////////////////////////////
void ExporterClass::Post_Level_Export(DynamicVectorClass<NodeClass *> &node_list) {
  //
...
//
/////////////////////////////////////////////////////////
void ExporterClass::Export_Package(LPCTSTR full_path) {
  CWaitCursor wait_cursor;
...
//
/////////////////////////////////////////////////////////
void ExporterClass::Add_Files_To_Mod_Package(LPCTSTR full_path) {
  //
  ...
  for (file_find = ::FindFirstFile(search_path, &find_info); (file_find != INVALID_HANDLE_VALUE) && keep_going;
...
//
/////////////////////////////////////////////////////////
void ExporterClass::Export_Level_Only(LPCTSTR path) {
  CWaitCursor wait_cursor;
  m_AssetList.Delete_All();
