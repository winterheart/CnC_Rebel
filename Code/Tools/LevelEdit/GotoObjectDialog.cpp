...
//
/////////////////////////////////////////////////////////////////////////////
GotoObjectDialogClass::GotoObjectDialogClass(NodeClass *node, CWnd *parent)
    : m_pNode(node), CDialog(GotoObjectDialogClass::IDD, parent) {
...
// DoDataExchange
//
void GotoObjectDialogClass::DoDataExchange(CDataExchange *pDX) {
...
//
/////////////////////////////////////////////////////////////////////////////
BOOL GotoObjectDialogClass::OnInitDialog(void) {
...
//
/////////////////////////////////////////////////////////////////////////////
void GotoObjectDialogClass::OnOK(void) {
...
//
/////////////////////////////////////////////////////////////////////////////
int GotoObjectDialogClass::Get_Current_Selection(void) {
  // Assume failure
  int index = -1;
...
//
/////////////////////////////////////////////////////////////////////////////
void GotoObjectDialogClass::OnEditChangeObjectList(void) {
...
//
/////////////////////////////////////////////////////////////////////////////
void GotoObjectDialogClass::OnSelChangeObjectList(void) {
