...
SelectPresetDialogClass::SelectPresetDialogClass(CWnd *pParent /*=NULL*/)
    : m_ClassID(0), m_Preset(NULL), m_IconIndex(0), m_InitialSelection(NULL), m_AllowNoneSelection(true),
...
//
/////////////////////////////////////////////////////////////////////////////
void SelectPresetDialogClass::DoDataExchange(CDataExchange *pDX) {
...
//
/////////////////////////////////////////////////////////////////////////////
BOOL SelectPresetDialogClass::OnInitDialog(void) {
...
//
/////////////////////////////////////////////////////////////////////////////
void SelectPresetDialogClass::Fill_Tree(NTreeLeafClass<PresetClass *> *leaf, HTREEITEM parent_item) {
  //
...
//
/////////////////////////////////////////////////////////////////////////////
void SelectPresetDialogClass::OnOK(void) {
  //
...
//
/////////////////////////////////////////////////////////////////////////////
void SelectPresetDialogClass::OnDestroy(void) {
  //
...
//
/////////////////////////////////////////////////////////////////////////////
void SelectPresetDialogClass::Build_Full_Preset_Tree(void) {
  //
  ...
  for (int index = 0; index < PRESET_CATEGORY_COUNT; index++) {
    ...
    if (factory == NULL) {
                            ...
                            factory = DefinitionFactoryMgrClass::Get_Next (factory, PRESET_CATEGORIES[index].clsid))
            {
                    ...
                    HTREEITEM child_item = m_TreeCtrl.InsertItem (factory->Get_Name (), FOLDER_ICON, FOLDER_ICON,
    tree_item); Generate_Tree (factory->Get_Class_ID (), child_item);
            }
...
//
/////////////////////////////////////////////////////////////////////////////
void SelectPresetDialogClass::Generate_Tree(int class_id, HTREEITEM parent_item) {
  //
  //	Is there a factory to create this class of defintion?
  //
...
//
/////////////////////////////////////////////////////////////////////////////
void SelectPresetDialogClass::OnSelchangedPresetTree(NMHDR *pNMHDR, LRESULT *pResult) {
