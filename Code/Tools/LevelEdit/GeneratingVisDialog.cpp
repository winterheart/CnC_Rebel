...
GeneratingVisDialogClass::GeneratingVisDialogClass(float granularity, CWnd *parent)
    : m_bStop(false), m_Granularity(granularity), m_SampleHeight(10.0f), m_CurrentPoint(0), m_TotalPoints(0),
      m_StartTime(0), m_FarmMode(false), m_IgnoreBias(false), m_SelectionOnly(false),
...
//
/////////////////////////////////////////////////////////////////////////////
void GeneratingVisDialogClass::DoDataExchange(CDataExchange *pDX) {
...
//
//////////////////////////////////////////////////////////////////////////////
BOOL GeneratingVisDialogClass::OnInitDialog(void) {
...
//
//////////////////////////////////////////////////////////////////////////////
void GeneratingVisDialogClass::OnCancel(void) {
  m_bStop = true;
  return;
}
...
//
//////////////////////////////////////////////////////////////////////////////
void GeneratingVisDialogClass::Reset_Vis_Data_For_Nodes(NODE_LIST &node_list) {
...
//
//////////////////////////////////////////////////////////////////////////////
void GeneratingVisDialogClass::Build_Node_List(NODE_LIST &node_list) {
  //
...
//////////////////////////////////////////////////////////////////////////////
LRESULT
GeneratingVisDialogClass::WindowProc(UINT message, WPARAM wParam, LPARAM lParam) {
...
//
//////////////////////////////////////////////////////////////////////////////
void GeneratingVisDialogClass::Update_Time(void) {
  //
...
//
//////////////////////////////////////////////////////////////////////////////
void GeneratingVisDialogClass::Render_Vis_Points(VIS_POINT_LIST &point_list) {
  SceneEditorClass *scene_editor = ::Get_Scene_Editor();
  ...
  for (int index = 0; (index < count) && !m_bStop; index++) {
    ...
    for (int sub_point = 0; sub_point < sub_point_list->Count(); sub_point++) {
      ...
      //
      vis_sample = scene_editor->Update_Vis(
          sample_point, transform,
          VisDirBitsType(VIS_FORWARD_BIT | VIS_LEFT_BIT | VIS_RIGHT_BIT | VIS_UP_BIT | VIS_DOWN_BIT));
      vis_log.Log_Sample(vis_sample);
...
//
//////////////////////////////////////////////////////////////////////////////
void GeneratingVisDialogClass::Generate_Points(NODE_LIST &node_list, VisPointGeneratorClass &generator) {
  //
