...
PresetsFormClass::PresetsFormClass(CWnd *parent_wnd)
    : m_DragItem(NULL), m_IsDragging(false), m_DragImageList(NULL), CDialog(PresetsFormClass::IDD) {
...
PresetsFormClass::~PresetsFormClass() { return; }
...
#ifdef _DEBUG
void PresetsFormClass::AssertValid() const { CDialog::AssertValid(); }

void PresetsFormClass::Dump(CDumpContext &dc) const { CDialog::Dump(dc); }
#endif //_DEBUG
...
//
/////////////////////////////////////////////////////////////////////////////
void PresetsFormClass::OnSize(UINT nType, int cx, int cy) {
...
//
/////////////////////////////////////////////////////////////////////////////
BOOL PresetsFormClass::OnInitDialog(void) {
...
//
/////////////////////////////////////////////////////////////////////////////
void PresetsFormClass::Reload_Presets(void) {
  ...
  for (int index = 0; index < PRESET_CATEGORY_COUNT; index++) {
    ...
    if (factory != NULL) {
      ...
      //
      for (factory = DefinitionFactoryMgrClass::Get_First(PRESET_CATEGORIES[index].clsid); factory != NULL;
...
//
/////////////////////////////////////////////////////////////////////////////
void PresetsFormClass::Fill_In_Presets(HTREEITEM root_item) {
...
//
/////////////////////////////////////////////////////////////////////////////
void PresetsFormClass::Fill_In_Preset_Children(HTREEITEM root_item, uint32 parent_id) {
  //
...
PresetsFormClass::Find_Preset(HTREEITEM root_item, uint32 id) {
  ...
  //
  for (HTREEITEM tree_item = m_TreeCtrl.GetChildItem(root_item); (tree_item != NULL) && (preset_item == NULL);
...
PresetsFormClass::Find_Factory(HTREEITEM root_item, uint32 id) {
  ...
  //	Look for the preset in this item's children (recursive)
  //
  for (HTREEITEM tree_item = m_TreeCtrl.GetChildItem(root_item); (tree_item != NULL) && (factory_item == NULL);
       tree_item = m_TreeCtrl.GetNextSiblingItem(tree_item)) {
...
//
/////////////////////////////////////////////////////////////////////////////
DefinitionFactoryClass *PresetsFormClass::Get_Selected_Factory(void) {
...
//
/////////////////////////////////////////////////////////////////////////////
void PresetsFormClass::Set_Item_Data(HTREEITEM item, DefinitionFactoryClass *factory) {
  //
...
//
/////////////////////////////////////////////////////////////////////////////
void PresetsFormClass::Set_Item_Data(HTREEITEM item, PresetClass *preset) {
  //
  //	Allocate a new wrapper if we need to
  //
  ITEM_DATA *item_data = (ITEM_DATA *)m_TreeCtrl.GetItemData(item);
...
//
/////////////////////////////////////////////////////////////////////////////
DefinitionFactoryClass *PresetsFormClass::Get_Item_Factory(HTREEITEM item) {
...
//
/////////////////////////////////////////////////////////////////////////////
DefinitionClass *PresetsFormClass::Get_Item_Definition(HTREEITEM item) {
...
//
/////////////////////////////////////////////////////////////////////////////
PresetClass *PresetsFormClass::Get_Item_Preset(HTREEITEM item) {
  PresetClass *preset = NULL;
  if (item != NULL) {
...
//
/////////////////////////////////////////////////////////////////////////////
int PresetsFormClass::Get_Icon(PresetClass *preset) {
...
/////////////////////////////////////////////////////////////////////////////
HTREEITEM
PresetsFormClass::Insert_Preset(HTREEITEM root_item, PresetClass *preset) {
...
//
/////////////////////////////////////////////////////////////////////////////
void PresetsFormClass::OnDeleteitemPresetsTree(NMHDR *pNMHDR, LRESULT *pResult) {
...
//
/////////////////////////////////////////////////////////////////////////////
bool PresetsFormClass::Modify_Preset(void) {
  bool retval = false;
...
//
/////////////////////////////////////////////////////////////////////////////
void PresetsFormClass::OnModify(void) {
  HTREEITEM current_item = m_TreeCtrl.GetSelectedItem();
  PresetClass *preset = Get_Item_Preset(current_item);
  if (preset != NULL) {
...
//
/////////////////////////////////////////////////////////////////////////////
bool PresetsFormClass::Load_Databases(void) {
  // Start fresh
...
//
/////////////////////////////////////////////////////////////////////////////
bool PresetsFormClass::Load_Preset_Libraries(void) {
  //
  //	Try to load the library for each factory
  //
  DefinitionFactoryClass *factory = NULL;
  for (factory = DefinitionFactoryMgrClass::Get_First(); factory != NULL;
...
//
/////////////////////////////////////////////////////////////////////////////
bool PresetsFormClass::Load_Presets(uint32 class_id) {
  //
  ...
  //	Open the file
  //
  HANDLE file = ::CreateFile(path, GENERIC_READ, FILE_SHARE_READ, NULL, OPEN_EXISTING, 0L, NULL);
...
//
/////////////////////////////////////////////////////////////////////////////
bool PresetsFormClass::Old_Load_Presets(void) {
...
//
/////////////////////////////////////////////////////////////////////////////
bool PresetsFormClass::Load_Temp_Presets(void) {
  CString path = ::Get_File_Mgr()->Make_Full_Path(TEMP_DB_PATH);

  //
  //	Open the file
  //
  HANDLE hfile = ::CreateFile(path, GENERIC_READ, FILE_SHARE_READ, NULL, OPEN_EXISTING, 0L, NULL);
...
//
/////////////////////////////////////////////////////////////////////////////
bool PresetsFormClass::Save_Temp_Presets(void) {
  Save_Presets(0, true);
  return true;
}
...
//
/////////////////////////////////////////////////////////////////////////////
bool PresetsFormClass::Save_Global_Presets(uint32 class_id) {
...
//
/////////////////////////////////////////////////////////////////////////////
void PresetsFormClass::Build_DDB_File_List(DynamicVectorClass<CString> &file_list, HTREEITEM parent_item) {
  //
  //	Loop over all the immediate children
  //
  for (HTREEITEM child_item = m_TreeCtrl.GetChildItem(parent_item); child_item != NULL;
...
//
/////////////////////////////////////////////////////////////////////////////
void PresetsFormClass::Save_Preset_Libraries(HTREEITEM parent_item) {
...
//
/////////////////////////////////////////////////////////////////////////////
bool PresetsFormClass::Save_Presets(LPCTSTR path, uint32 class_id, bool class_id_matters, bool temps_only) {
  ///
  ...
  //
  HANDLE file = ::CreateFile(path, GENERIC_WRITE, 0, NULL, CREATE_ALWAYS, 0L, NULL);
...
//
/////////////////////////////////////////////////////////////////////////////
bool PresetsFormClass::Save_Presets(uint32 class_id, bool temps_only) {
  //
  //	Build a filename for the presets library
  //
  CString path;
...
//
/////////////////////////////////////////////////////////////////////////////
void PresetsFormClass::Save_Presets(HANDLE file, uint32 class_id, bool class_id_matters, bool temps_only) {
  //
  ...
  //
  DefinitionClass *definition = NULL;
  for (definition = DefinitionMgrClass::Get_First(); definition != NULL;
  ...
  PresetClass *preset = NULL;
  for (preset = PresetMgrClass::Get_First(); preset != NULL; preset = PresetMgrClass::Get_Next(preset)) {
    //
...
//
/////////////////////////////////////////////////////////////////////////////
void PresetsFormClass::Reselect_Item(int id, bool is_factory) {
...
//
/////////////////////////////////////////////////////////////////////////////
void PresetsFormClass::OnAddTemp(void) {
...
//
/////////////////////////////////////////////////////////////////////////////
void PresetsFormClass::OnAdd(void) {
  DefinitionFactoryClass *factory = Get_Selected_Factory();
  if (factory != NULL) {
...
//
/////////////////////////////////////////////////////////////////////////////
void PresetsFormClass::OnMake(void) {
  HTREEITEM current_item = m_TreeCtrl.GetSelectedItem();
  PresetClass *preset = Get_Item_Preset(current_item);
  if (preset != NULL) {
...
//
/////////////////////////////////////////////////////////////////////////////
PresetClass *PresetsFormClass::Add_New_Preset(LPCTSTR name, bool is_temp, bool sel_new) {
...
//
/////////////////////////////////////////////////////////////////////////////
void PresetsFormClass::OnDelete(void) {
  HTREEITEM current_item = m_TreeCtrl.GetSelectedItem();
  PresetClass *preset = Get_Item_Preset(current_item);
  if (preset != NULL) {
    ...
    //
    if (::Message_Box(m_hWnd, IDS_DELETE_PRESET_MSG, IDS_DELETE_PRESET_TITLE, MB_ICONQUESTION | MB_YESNO) == IDYES) {
...
//
////////////////////////////////////////////////////////////////////////////
void PresetsFormClass::Sort_Nodes(HTREEITEM root_item, bool recursive) {
  for (HTREEITEM tree_item = m_TreeCtrl.GetChildItem(root_item); tree_item != NULL;
       tree_item = m_TreeCtrl.GetNextSiblingItem(tree_item)) {
    //
    //	Sort the children
    //
...
//
////////////////////////////////////////////////////////////////////////////
PresetClass *PresetsFormClass::Create_Preset(DefinitionFactoryClass *factory, bool is_temp) {
  //
...
//
////////////////////////////////////////////////////////////////////////////
void PresetsFormClass::Build_Child_List(HTREEITEM parent_item, DynamicVectorClass<HTREEITEM> &list) {
  //
  //	Loop over all the immediate children
  //
  for (HTREEITEM child_item = m_TreeCtrl.GetChildItem(parent_item); child_item != NULL;
...
//
////////////////////////////////////////////////////////////////////////////
bool PresetsFormClass::Enable_Button(int cmd_id) {
  bool retval = false;
  ...
  if (current_item != NULL) {
    ...
    case IDC_CONVERT:
      ...
      if (preset != NULL && preset->Get_Parent() != NULL && preset->Get_Parent()->Get_IsTemporary()) {
        retval = false;
      }
      break;
    ...
    case IDM_UPDATE_EMBEDDED_NODE_LIST:
      ...
      //
      if (preset != NULL) {
        if (preset->Get_Class_ID() != CLASSID_TERRAIN && preset->Get_Class_ID() != CLASSID_TILE) {
          retval = false;
        }
      }
...
//
////////////////////////////////////////////////////////////////////////////
void PresetsFormClass::OnSelchangedPresetsTree(NMHDR *pNMHDR, LRESULT *pResult) {
  NM_TREEVIEW *pNMTreeView = (NM_TREEVIEW *)pNMHDR;
  (*pResult) = 0;
...
//
////////////////////////////////////////////////////////////////////////////
void PresetsFormClass::Propagate_Changes(HTREEITEM modified_item, DERIVED_PARAM_LIST &list) {
  CWaitCursor wait_cursor;
...
//
////////////////////////////////////////////////////////////////////////////
void PresetsFormClass::Compare_Derived_Parameters(PresetClass *curr_preset, DefinitionClass *base_def,
                                                  DefinitionClass *derived_def, DERIVED_PARAM_LIST &list) {
...
//
////////////////////////////////////////////////////////////////////////////
void PresetsFormClass::Build_Inherited_Param_List(HTREEITEM parent_item, DERIVED_PARAM_LIST &list) {
...
//
////////////////////////////////////////////////////////////////////////////
void PresetsFormClass::OnPlay(void) {
...
//
////////////////////////////////////////////////////////////////////////////
void PresetsFormClass::OnInfo(void) {
  HTREEITEM current_item = m_TreeCtrl.GetSelectedItem();
  PresetClass *preset = Get_Item_Preset(current_item);
  if (preset != NULL) {
...
//
////////////////////////////////////////////////////////////////////////////
void PresetsFormClass::OnExtra(void) {
  //
...
//
////////////////////////////////////////////////////////////////////////////
BOOL PresetsFormClass::OnNotify(WPARAM wParam, LPARAM lParam, LRESULT *pResult) {
...
//
////////////////////////////////////////////////////////////////////////////
void PresetsFormClass::OnUpdateConvert(CCmdUI *pCmdUI) {
...
//
////////////////////////////////////////////////////////////////////////////
void PresetsFormClass::OnUpdateInfo(CCmdUI *pCmdUI) {
...
//
////////////////////////////////////////////////////////////////////////////
void PresetsFormClass::OnUpdatePlay(CCmdUI *pCmdUI) {
...
//
////////////////////////////////////////////////////////////////////////////
void PresetsFormClass::OnUpdateUpdateVss(CCmdUI *pCmdUI) {
...
//
////////////////////////////////////////////////////////////////////////////
void PresetsFormClass::Get_Menu_Text(int menu_id, CString &text) {
  switch (menu_id) {
  case IDC_PLAY:
    text = "Play...";
    break;
...
//
////////////////////////////////////////////////////////////////////////////
void PresetsFormClass::OnDrawItem(int nIDCtl, LPDRAWITEMSTRUCT lpDrawItemStruct) {
  HICON icon = NULL;
  ...
  ::DrawState(lpDrawItemStruct->hDC, NULL, NULL, (LPARAM)(LPCTSTR)text, 0, rect.left + 24,
              rect.top + (rect.Height() >> 1) - (text_size.cy >> 1), 0, 0, DST_TEXT | dss_state);

  //
  //	Draw the associated icon (if necessary)
  //
  if (icon != NULL) {
    ::DrawState(lpDrawItemStruct->hDC, NULL, NULL, (LPARAM)icon, 0, rect.left + 4, rect.top + 4, 16, 16,
                DST_ICON | dss_state);
  }
...
//
////////////////////////////////////////////////////////////////////////////
void PresetsFormClass::OnMeasureItem(int nIDCtl, LPMEASUREITEMSTRUCT lpMeasureItemStruct) {
  CString text;
...
//
////////////////////////////////////////////////////////////////////////////
void PresetsFormClass::OnConvert(void) {
  ...
  if (preset != NULL) {
    ...
    //
    CString message;
    message.Format("Are you sure you wish to convert '%s' from a temporary preset to a shared preset?",
                   preset->Get_Name());
...
//
////////////////////////////////////////////////////////////////////////////
void PresetsFormClass::OnUpdateVss(void) {
  HTREEITEM item = m_TreeCtrl.GetSelectedItem();
  PresetClass *preset = Get_Item_Preset(item);
  if (preset != NULL) {
...
//
////////////////////////////////////////////////////////////////////////////
void PresetsFormClass::OnClearEmbeddedNodeList(void) {
  CWaitCursor wait_cursor;
...
//
////////////////////////////////////////////////////////////////////////////
void PresetsFormClass::Reset_Embedded_Node_Instances(PresetClass *preset) {
  if (preset == NULL) {
    return;
  }
...
//
////////////////////////////////////////////////////////////////////////////
void PresetsFormClass::OnBuildEmbedNodeList(void) {
  //
  //	Prompt the user
  //
  if (::MessageBox(m_hWnd,
                   "This operation will embed a copy of all the nodes in scene into this preset.  Are you sure you "
                   "wish to continue?",
...
//
////////////////////////////////////////////////////////////////////////////
void PresetsFormClass::Update_Embedded_Nodes(PresetClass *preset) {
  Reset_Embedded_Node_Instances(preset);
...
//
////////////////////////////////////////////////////////////////////////////
void PresetsFormClass::OnBatchImportTerrain(void) {
  CFileDialog dialog(TRUE, ".w3d", NULL, OFN_HIDEREADONLY | OFN_OVERWRITEPROMPT | OFN_ALLOWMULTISELECT | OFN_EXPLORER,
...
//
////////////////////////////////////////////////////////////////////////////
void PresetsFormClass::OnUpdateClearEmbeddedNodeList(CCmdUI *pCmdUI) {
...
//
////////////////////////////////////////////////////////////////////////////
void PresetsFormClass::OnUpdateEmbeddedNodeList(CCmdUI *pCmdUI) {
...
//
////////////////////////////////////////////////////////////////////////////
void PresetsFormClass::OnUpdateBatchImportTerrain(CCmdUI *pCmdUI) {
...
//
////////////////////////////////////////////////////////////////////////////
void PresetsFormClass::Add_Terrain_Preset(LPCTSTR filename) {
...
//
////////////////////////////////////////////////////////////////////////////
void PresetsFormClass::OnBegindragPresetsTree(NMHDR *pNMHDR, LRESULT *pResult) {
...
//
////////////////////////////////////////////////////////////////////////////
void PresetsFormClass::OnLButtonUp(UINT nFlags, CPoint point) {
  if (m_IsDragging) {
...
//
////////////////////////////////////////////////////////////////////////////
void PresetsFormClass::OnMouseMove(UINT nFlags, CPoint point) {
  if (m_IsDragging) {
...
//
////////////////////////////////////////////////////////////////////////////
bool PresetsFormClass::Is_Drag_OK(HTREEITEM drag_item) {
  bool retval = false;
...
//
////////////////////////////////////////////////////////////////////////////
bool PresetsFormClass::Is_Drop_OK(HTREEITEM drop_item) {
  bool retval = false;
...
//
////////////////////////////////////////////////////////////////////////////
void PresetsFormClass::Do_Drop(HTREEITEM drag_item, HTREEITEM drop_item) {
  CWaitCursor wait_cursor;
  ...
  if (is_drag_temp == false) {
    ...
    if (PresetMgrClass::Check_Out_Database(class_id, &undo_on_err)) {
      ...
      //
      if (drag_preset != NULL && drag_preset->Get_Definition()->Get_ID() == drag_preset_id && drag_item != NULL &&
          drop_item != NULL && drag_item != drop_item) {
        //
        ...
        //
        ::MessageBox(NULL, "Either the drag source or the drop target no longer exists, please try again.",
                     "Drag/Drop Error", MB_OK | MB_ICONERROR);
...
//
////////////////////////////////////////////////////////////////////////////
void PresetsFormClass::Move_Preset(HTREEITEM preset_item, HTREEITEM parent_item) {
...
//
////////////////////////////////////////////////////////////////////////////
void PresetsFormClass::Copy_Preset_Items(HTREEITEM preset_item, HTREEITEM parent_item) {
  //
  ...
  //
  for (HTREEITEM child_item = m_TreeCtrl.GetChildItem(preset_item); child_item != NULL;
       child_item = m_TreeCtrl.GetNextSiblingItem(child_item)) {
...
//
////////////////////////////////////////////////////////////////////////////
void PresetsFormClass::OnDestroy(void) {
...
//
////////////////////////////////////////////////////////////////////////////
void PresetsFormClass::Export_File_Dependencies(const char *filename) {
  //
  //	Create the file
  //
...
//
////////////////////////////////////////////////////////////////////////////
void PresetsFormClass::Build_File_Dependencies_For_Definition(DynamicVectorClass<StringClass> &file_list,
...
//
////////////////////////////////////////////////////////////////////////////
void PresetsFormClass::Add_Preset(PresetClass *preset) {
  uint32 class_id = preset->Get_Class_ID();
...
//
////////////////////////////////////////////////////////////////////////////
void PresetsFormClass::Sort_Items(uint32 class_id) {
  //
  //	Find the root item
  //
  HTREEITEM root_item = Find_Factory(TVI_ROOT, class_id);
