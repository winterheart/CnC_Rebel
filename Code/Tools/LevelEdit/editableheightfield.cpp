...
EditableHeightfieldClass::EditableHeightfieldClass(void)
    : Width(0), Height(0), Density(1.0F), GridPointsX(0), GridPointsY(0), GridPointCount(0), Grid(NULL),
      GridNormals(NULL), QuadFlags(NULL), PatchGrid(NULL), PhysObjGrid(NULL), PatchesX(0), PatchesY(0),
      PatchGridPointsX(0), PatchGridPointsY(0), PatchWidth(0.0F), PatchHeight(0.0F) {
  Initialize();
  return;
}
...
//
//////////////////////////////////////////////////////////////////////
const EditableHeightfieldClass &EditableHeightfieldClass::operator=(const EditableHeightfieldClass &src) {
  return *this;
}
...
//
//////////////////////////////////////////////////////////////////////
void EditableHeightfieldClass::Initialize(void) {
  //
  //	Zero all the lists
  //
...
//
//////////////////////////////////////////////////////////////////////
void EditableHeightfieldClass::Create(float width, float height, float meters_per_point) {
...
//
//////////////////////////////////////////////////////////////////////
void EditableHeightfieldClass::Set_Dimensions(float width, float height, float meters_per_point) {
  Free_Grid();
...
//
//////////////////////////////////////////////////////////////////////
void EditableHeightfieldClass::Allocate_Grid(void) {
  //
...
//
//////////////////////////////////////////////////////////////////////
void EditableHeightfieldClass::Initialize_Grid(void) {
  float y_value = 0;
...
//
//////////////////////////////////////////////////////////////////////
void EditableHeightfieldClass::Free_Grid(void) {
...
//
//////////////////////////////////////////////////////////////////////
void EditableHeightfieldClass::Update_Texture_Quad_List(int min_x, int min_y, int max_x, int max_y) {
  //
      ...
      for (int patch_quad_y = 0; patch_quad_y < quads_per_patch_y; patch_quad_y++) {
        for (int patch_quad_x = 0; patch_quad_x < quads_per_patch_x; patch_quad_x++) {
          ...
          for (int layer = 0; layer < MAX_TEXTURE_PASSES; layer++) {
            ...
            //
            if (TextureWeights[layer][v0_index] > 0.0F || TextureWeights[layer][v1_index] > 0.0F ||
                TextureWeights[layer][v2_index] > 0.0F || TextureWeights[layer][v3_index] > 0.0F) {
              //
...
//
//////////////////////////////////////////////////////////////////////
void EditableHeightfieldClass::Set_Material(int index, TerrainMaterialClass *material) {
...
//
//////////////////////////////////////////////////////////////////////
void EditableHeightfieldClass::On_Material_Changed(int index) {
...
//
//////////////////////////////////////////////////////////////////////
void EditableHeightfieldClass::Update_UVs(void) { return; }
...
//
//////////////////////////////////////////////////////////////////////
void EditableHeightfieldClass::Update_Normals(int min_x, int min_y, int max_x, int max_y) {
  //
...
//
//////////////////////////////////////////////////////////////////////
void EditableHeightfieldClass::Initialize_Material(void) {
  //
...
//
//////////////////////////////////////////////////////////////////////
void EditableHeightfieldClass::Free_Material(void) {
  //
...
//
//////////////////////////////////////////////////////////////////////
void EditableHeightfieldClass::Deform_Heightfield(const Vector3 &world_space_center, float amount, float inner_radius,
                                                  float outter_radius) {
  //
...
//
//////////////////////////////////////////////////////////////////////
void EditableHeightfieldClass::Smooth_Foundation_Heightfield(const Vector3 &world_space_center, float amount,
...
//
//////////////////////////////////////////////////////////////////////
void EditableHeightfieldClass::Smooth_Heightfield(const Vector3 &world_space_center, float amount, float inner_radius,
                                                  float outter_radius) {
  //
  //	First, transform the center point into heightfield (object) space
  //
  ...
  static const Vector2i INDEX_RING_OFFSETS[] = {Vector2i(-1, -1), Vector2i(0, -1),  Vector2i(+1, -1), Vector2i(-1, 0),
    ...
    for (int x_pos = min_x; x_pos <= max_x; x_pos++) {
      ...
      if (dist <= outter_radius) {
        ...
        for (int index = 0; index < 7; index++) {
          ...
          //
          if (new_x_pos >= 0 && new_x_pos < GridPointsX && new_y_pos >= 0 && new_y_pos < GridPointsY) {
...
//
//////////////////////////////////////////////////////////////////////
void EditableHeightfieldClass::Cutout_Heightfield(const Vector3 &world_space_center, float outter_radius,
                                                  bool subtract) {
  //
  //	First, transform the center point into heightfield (object) space
  //
...
//
//////////////////////////////////////////////////////////////////////
void EditableHeightfieldClass::Paint_Heightfield(const Vector3 &world_space_center, int texture_index, float amount,
                                                 float inner_radius, float outter_radius) {
  //
  //	First, transform the center point into heightfield (object) space
  //
...
//
//////////////////////////////////////////////////////////////////////
bool EditableHeightfieldClass::Save(ChunkSaveClass &csave) {
  //
  //	Write the variables
  //
...
//
//////////////////////////////////////////////////////////////////////
void EditableHeightfieldClass::Load_Materials(ChunkLoadClass &cload) {
  //
  //	Start fresh
  //
  Free_Material();
...
//
//////////////////////////////////////////////////////////////////////
bool EditableHeightfieldClass::Load(ChunkLoadClass &cload) {
  Free_Grid();
...
//
////////////////////////////////////////////////////////////////
void EditableHeightfieldClass::Load_Variables(ChunkLoadClass &cload) {
  int texture_passes = MAX_TEXTURE_PASSES;
...
//
////////////////////////////////////////////////////////////////
void EditableHeightfieldClass::On_Post_Load(void) {
  // Assign_Unique_IDs ();
  return;
}
...
//
////////////////////////////////////////////////////////////////
void EditableHeightfieldClass::Assign_Unique_IDs(void) {
...
//
////////////////////////////////////////////////////////////////
void EditableHeightfieldClass::Create(const char *heightmap_filename, float width, float height, float meters_per_point,
                                      float scale) {
  //
  //	Load the bitmap from disk
  //
  HBITMAP bitmap =
      (HBITMAP)::LoadImage(NULL, heightmap_filename, IMAGE_BITMAP, 0, 0, LR_LOADFROMFILE | LR_CREATEDIBSECTION);
  if (bitmap != NULL) {
...
//
////////////////////////////////////////////////////////////////
void EditableHeightfieldClass::Create(HBITMAP bitmap, float width, float height, float meters_per_point, float scale) {
  if (bitmap == NULL) {
    return;
  }
  ...
  ::GetDIBits(screen_dc, bitmap, 0, bmp_info.bmHeight, (LPVOID)bmp_bits, (BITMAPINFO *)&bitmap_info, DIB_RGB_COLORS);
...
//
////////////////////////////////////////////////////////////////
void EditableHeightfieldClass::Allocate_Patches(void) {
  PatchGridPointsX = 64;
  PatchGridPointsY = 64;
...
//
////////////////////////////////////////////////////////////////
void EditableHeightfieldClass::Update_Patch_Pos_And_Normals(int min_x, int min_y, int max_x, int max_y) {
  //
  //	Determine which patches this operation would possibly affect
  //
  int min_patch_x = min_x / (PatchGridPointsX - 1);
...
//
////////////////////////////////////////////////////////////////
void EditableHeightfieldClass::Free_Patches(void) {
  int patch_count = PatchesX * PatchesY;
