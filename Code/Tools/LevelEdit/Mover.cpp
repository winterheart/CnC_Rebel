...
//
///////////////////////////////////////////////////////////////////////
void MoverClass::Get_Mouse_Ray(const POINT &mouse_pos, float length, Vector3 &start, Vector3 &end) {
...
//
///////////////////////////////////////////////////////////////////////
void MoverClass::Get_Mouse_Ray(float length, Vector3 &start, Vector3 &end) {
  //
  // Ensure the 'point' is correct for this mode (fullscreen/windowed)
  //
  CPoint point;
...
//
///////////////////////////////////////////////////////////////////////
void MoverClass::Get_LOS_Ray(const POINT &mouse_pos, float length, Vector3 &start, Vector3 &end) {
...
//
///////////////////////////////////////////////////////////////////////
void MoverClass::Get_LOS_Ray(float length, Vector3 &start, Vector3 &end) {
  //
  // Ensure the 'point' is correct for this mode (fullscreen/windowed)
  //
  CPoint point;
...
//
///////////////////////////////////////////////////////////////////////
void MoverClass::Position_Node(NodeClass *node) {
...
//
///////////////////////////////////////////////////////////////////////
void MoverClass::Position_Node_Along_Ray(NodeClass *node) {
  //
  //	Determine what ray to cast the node along
  //
  Vector3 ray_start;
...
//
///////////////////////////////////////////////////////////////////////
void MoverClass::Position_Nodes_Along_Ray(void) {
  //
  //	Determine what ray to cast the node along
  //
  Vector3 ray_start;
...
//
///////////////////////////////////////////////////////////////////////
void MoverClass::Position_Nodes_Along_Ray(const Vector3 &start, const Vector3 &end) {
  NODE_LIST list;
...
//
///////////////////////////////////////////////////////////////////////
Vector3 MoverClass::Position_Nodes_Along_Ray(NODE_LIST &list, const Vector3 &tracking_pt, const Vector3 &start,
                                             const Vector3 &end) {
  if (list.Count() == 1) {
...
//
///////////////////////////////////////////////////////////////////////
Vector3 MoverClass::Position_Node_Along_Ray(NodeClass *node, const Vector3 &start, const Vector3 &end) {
...
//
///////////////////////////////////////////////////////////////////////
bool MoverClass::Calc_Ray_Intersection_XY(float plane, const Vector3 &ray_start, const Vector3 &ray_end,
                                          Vector3 &result) {
...
//
///////////////////////////////////////////////////////////////////////
bool MoverClass::Calc_Ray_Intersection_XZ(float plane, const Vector3 &ray_start, const Vector3 &ray_end,
                                          Vector3 &result) {
  // Assume no intersection
  bool intersected = false;
...
//
///////////////////////////////////////////////////////////////////////
bool MoverClass::Calc_Ray_Intersection_YZ(float plane, const Vector3 &ray_start, const Vector3 &ray_end,
                                          Vector3 &result) {
  // Assume no intersection
  bool intersected = false;
...
//
///////////////////////////////////////////////////////////////////////
void MoverClass::Transform_Node(NodeClass *node, const Matrix3D &transform) {
  //
...
//
///////////////////////////////////////////////////////////////////////
void MoverClass::Transform_Nodes(NodeClass *node, const Matrix3D &transform) {
  NODE_LIST list;
...
//
///////////////////////////////////////////////////////////////////////
void MoverClass::Transform_Nodes(NODE_LIST &list, NodeClass *node, const Matrix3D &transform) {
  Matrix3D curr_transform = node->Get_Transform();
...
//
///////////////////////////////////////////////////////////////////////
void MoverClass::Move_Node(NodeClass *node, const Vector3 &translation) {
...
//
///////////////////////////////////////////////////////////////////////
void MoverClass::Simple_Move_Nodes(NODE_LIST &list, const Vector3 &translation) {
  for (int index = 0; index < list.Count(); index++) {
    NodeClass *node = list[index];
    node->Translate(translation);
  }
...
//
///////////////////////////////////////////////////////////////////////
void MoverClass::Move_Nodes(const Vector3 &translation) {
  NODE_LIST list;
  ::Get_Scene_Editor()->Build_Node_List(list);
...
//
///////////////////////////////////////////////////////////////////////
Vector3 MoverClass::Move_Nodes(NODE_LIST &list, const Vector3 &tracking_point) {
  //
...
//
///////////////////////////////////////////////////////////////////////
Vector3 MoverClass::Calc_New_Position(const Matrix3D &coord_system, const Vector3 &start_in_world_coords,
                                      LPPOINT mouse_pos) {
...
//
///////////////////////////////////////////////////////////////////////
void MoverClass::Rotate_Nodes(float deltax, float deltay, const Quaternion &rotation) {
  NODE_LIST list;
  Vector3 center = ::Get_Scene_Editor()->Build_Node_List(list);
...
//
///////////////////////////////////////////////////////////////////////
void MoverClass::Rotate_Nodes(NODE_LIST &list, const Vector3 &center, float deltax, float deltay,
...
//
///////////////////////////////////////////////////////////////////////
void MoverClass::Rotate_Nodes(NODE_LIST &list, const Matrix3D &rotation_matrix, const Vector3 &center) {
  //
  //	Setup the rotation
  //
  Matrix3D coord_system(1);
...
//
///////////////////////////////////////////////////////////////////////
void MoverClass::Rotate_Nodes_Z(float multiplier) {
  NODE_LIST list;
  Vector3 center = ::Get_Scene_Editor()->Build_Node_List(list);
...
//
///////////////////////////////////////////////////////////////////////
void MoverClass::Rotate_Nodes_Z(NODE_LIST &list, const Vector3 &center, float multiplier) {
  Matrix3D coord_system(1);
  coord_system.Set_Translation(center);
...
//
///////////////////////////////////////////////////////////////////////
void MoverClass::Rotate_Node_Z90(NodeClass *node, const Matrix3D &rotation_matrix, const Matrix3D &coord_system) {
...
//
///////////////////////////////////////////////////////////////////////
void MoverClass::Rotate_Node_Freely(NodeClass *node, const Matrix3D &rotation_matrix, const Matrix3D &coord_system) {
  if (node->Is_Locked() == false) {
...
//
///////////////////////////////////////////////////////////////////////
void MoverClass::Rotate_Node(NodeClass *node, const Matrix3D &rotation_matrix, const Matrix3D &coord_system) {
  //
...
//
///////////////////////////////////////////////////////////////////////
void MoverClass::Translate_Node(NodeClass *node, const Vector3 &vector) {
  if (node->Is_Locked() == false) {
