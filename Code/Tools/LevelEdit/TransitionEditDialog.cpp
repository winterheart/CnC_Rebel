...
TransitionEditDialogClass::TransitionEditDialogClass(CWnd *pParent /*=NULL*/)
    : m_LookAtDist(0), m_Camera(NULL), m_Scene(NULL), m_RenderObj(NULL), m_Transition(NULL), m_Zone(NULL),
      m_CharacterObj(NULL), m_Animation(NULL), m_SwapChain(NULL), m_TimerID(0), m_CurrFrame(0), m_LastAnimUpdate(0),
      m_IsEditingZone(true), m_IsEditingChar(true), m_IsAnimating(false), m_IsSizingZone(false),
      m_IsRotatingChar(false), CDialog(TransitionEditDialogClass::IDD, pParent) {
...
//
/////////////////////////////////////////////////////////////////////////////
void TransitionEditDialogClass::DoDataExchange(CDataExchange *pDX) {
...
//
/////////////////////////////////////////////////////////////////////////////
BOOL TransitionEditDialogClass::OnInitDialog(void) {
  ...
  ScreenToClient(&rect);
  m_Toolbar.SetWindowPos(NULL, rect.left + (rect.Width() >> 1) - (size.cx >> 1),
                         rect.top + (rect.Height() >> 1) - (size.cy >> 1), rect.Width(), rect.Height(), SWP_SHOWWINDOW);
  ...
  m_TimerID = ::timeSetEvent(50, 50, fnUpdateTimer, (DWORD)m_hWnd, TIME_PERIODIC);
  return TRUE;
}
...
//
/////////////////////////////////////////////////////////////////////////////
void TransitionEditDialogClass::OnOK(void) {
  //
...
//
/////////////////////////////////////////////////////////////////////////////
void TransitionEditDialogClass::OnDestroy(void) {
  // Stop the timer
  if (m_TimerID != 0) {
...
//
/////////////////////////////////////////////////////////////////////////////
void TransitionEditDialogClass::Render_View(void) {
...
//
/////////////////////////////////////////////////////////////////////////////
void CALLBACK TransitionEditDialogClass::fnUpdateTimer(UINT uID, UINT uMsg, DWORD user_data, DWORD dw1, DWORD dw2) {
...
/////////////////////////////////////////////////////////////////////////////
LRESULT
TransitionEditDialogClass::WindowProc(UINT message, WPARAM wParam, LPARAM lParam) {
  if (message == (WM_USER + 101)) {
    ...
    //
    if (wParam == VK_NUMPAD8 || wParam == VK_NUMPAD2 || wParam == VK_NUMPAD4 || wParam == VK_NUMPAD6 ||
...
//
/////////////////////////////////////////////////////////////////////////////
void TransitionEditDialogClass::OnTop(void) {
...
//
/////////////////////////////////////////////////////////////////////////////
void TransitionEditDialogClass::OnFront(void) {
  Vector3 pos = m_RenderObj->Get_Position();
...
//
/////////////////////////////////////////////////////////////////////////////
void TransitionEditDialogClass::OnLeft(void) {
  Vector3 pos = m_RenderObj->Get_Position();
...
//
/////////////////////////////////////////////////////////////////////////////
void TransitionEditDialogClass::OnRight(void) {
  Vector3 pos = m_RenderObj->Get_Position();
...
//
/////////////////////////////////////////////////////////////////////////////
void TransitionEditDialogClass::Load_Object(void) {
  //
...
//
/////////////////////////////////////////////////////////////////////////////
void TransitionEditDialogClass::Insert_Zone(void) {
  //
...
//
/////////////////////////////////////////////////////////////////////////////
void TransitionEditDialogClass::Set_Render_Obj(RenderObjClass *render_obj) {
...
//
/////////////////////////////////////////////////////////////////////////////
void TransitionEditDialogClass::Set_Transition(TransitionDataClass *transition) {
...
//
/////////////////////////////////////////////////////////////////////////////
void TransitionEditDialogClass::Handle_Keypress(void) {
  //
  ...
  //
  if ((::GetAsyncKeyState(VK_NUMPAD8) < 0) || (::GetAsyncKeyState(VK_NUMPAD2) < 0)) {
  ...
  //
  if ((::GetAsyncKeyState(VK_NUMPAD4) < 0) || (::GetAsyncKeyState(VK_NUMPAD6) < 0)) {
  ...
  //
  if ((::GetAsyncKeyState(VK_NUMPAD7) < 0) || (::GetAsyncKeyState(VK_NUMPAD1) < 0)) {
  ...
  if ((::GetAsyncKeyState(VK_UP) < 0) || (::GetAsyncKeyState(VK_DOWN) < 0) || (::GetAsyncKeyState(VK_LEFT) < 0) ||
    ...
    //
    if (m_IsRotatingChar && ((::GetAsyncKeyState(VK_RIGHT) < 0) || (::GetAsyncKeyState(VK_LEFT) < 0))) {
      Matrix3D tm = m_CharacterObj->Get_Transform();
...
//
/////////////////////////////////////////////////////////////////////////////
void TransitionEditDialogClass::Update_Status(void) {
  //
  ...
  CString status;
  status.Format("Zone Pos (%.2f, %.2f, %.2f)\nZone Size (%.2f, %.2f, %.2f)", zone_pos.X, zone_pos.Y, zone_pos.Z,
  ...
  status.Format("Char Pos (%.2f, %.2f, %.2f)\nChar Rot (%.2f)", char_pos.X, char_pos.Y, char_pos.Z,
                RAD_TO_DEG(char_rot));
...
//
/////////////////////////////////////////////////////////////////////////////
void TransitionEditDialogClass::Fill_Trigger_List(void) {
...
//
/////////////////////////////////////////////////////////////////////////////
void TransitionEditDialogClass::Fill_Animation_List(void) {
  int index = 0;
...
//
/////////////////////////////////////////////////////////////////////////////
void TransitionEditDialogClass::OnEditChar(void) {
...
//
/////////////////////////////////////////////////////////////////////////////
void TransitionEditDialogClass::OnEditZone(void) {
...
//
/////////////////////////////////////////////////////////////////////////////
void TransitionEditDialogClass::Load_Animation(void) {
  //
...
//
/////////////////////////////////////////////////////////////////////////////
void TransitionEditDialogClass::Load_Animation(LPCTSTR filename) {
  //
...
//
/////////////////////////////////////////////////////////////////////////////
void TransitionEditDialogClass::Load_Character(void) {
...
//
/////////////////////////////////////////////////////////////////////////////
void TransitionEditDialogClass::OnSelChangeAnimationList(void) {
  Load_Animation();
  return;
}
...
//
/////////////////////////////////////////////////////////////////////////////
LRESULT CALLBACK TransitionEditDialogClass::fn3DWindow(HWND hwnd, UINT message, WPARAM wparam, LPARAM lparam) {
...
//
/////////////////////////////////////////////////////////////////////////////
void TransitionEditDialogClass::Handle_LBUTTON_DOWN(WPARAM wparam, LPARAM lparam) {
...
//
/////////////////////////////////////////////////////////////////////////////
void TransitionEditDialogClass::Handle_LBUTTON_UP(WPARAM wparam, LPARAM lparam) {
  ::ReleaseCapture();
  return;
}
...
//
/////////////////////////////////////////////////////////////////////////////
void TransitionEditDialogClass::Handle_MOUSEMOVE(WPARAM wparam, LPARAM lparam) {
  ...
  if ((wparam & MK_LBUTTON) && (wparam & MK_RBUTTON)) {
    ...
    if (::GetCapture() == ::GetDlgItem(m_hWnd, IDC_3D_WINDOW)) {
      ::Trackball_Camera(::GetDlgItem(m_hWnd, IDC_3D_WINDOW), *m_Camera, Vector3(0, 0, 0), point, m_LastPoint);
    }
...
//
/////////////////////////////////////////////////////////////////////////////
void Trackball_Camera(HWND hwnd, CameraClass &camera, const Vector3 &center, POINT point, POINT last_point) {
  RECT rect;
...
//
/////////////////////////////////////////////////////////////////////////////
BOOL TransitionEditDialogClass::PreTranslateMessage(MSG *pMsg) {
  if (pMsg->message == WM_KEYDOWN || pMsg->message == WM_KEYUP) {

    if (pMsg->wParam == VK_NUMPAD8 || pMsg->wParam == VK_NUMPAD2 || pMsg->wParam == VK_NUMPAD4 ||
        pMsg->wParam == VK_NUMPAD6 || pMsg->wParam == VK_NUMPAD7 || pMsg->wParam == VK_NUMPAD1 ||
...
//
/////////////////////////////////////////////////////////////////////////////
void TransitionEditDialogClass::OnAniBackFrame(void) {
  m_CurrFrame -= 1.0F;
  if (m_CurrFrame < 0) {
...
//
/////////////////////////////////////////////////////////////////////////////
void TransitionEditDialogClass::OnAniFirstFrame(void) {
  m_CurrFrame = 0;
  m_CharacterObj->Set_Animation(m_Animation, m_CurrFrame);
  m_IsAnimating = false;
  return;
...
//
/////////////////////////////////////////////////////////////////////////////
void TransitionEditDialogClass::OnAniFwdFrame(void) {
  m_CurrFrame += 1;
...
//
/////////////////////////////////////////////////////////////////////////////
void TransitionEditDialogClass::OnAniLastFrame(void) {
  m_CurrFrame = float(m_Animation->Get_Num_Frames() - 1);
  m_CharacterObj->Set_Animation(m_Animation, m_CurrFrame);
  m_IsAnimating = false;
  return;
...
//
/////////////////////////////////////////////////////////////////////////////
void TransitionEditDialogClass::OnAniPause(void) {
  m_IsAnimating = false;
  return;
}
...
//
/////////////////////////////////////////////////////////////////////////////
void TransitionEditDialogClass::OnAniPlay(void) {
  m_IsAnimating = true;
...
//
/////////////////////////////////////////////////////////////////////////////
void TransitionEditDialogClass::OnAniStop(void) {
  m_CurrFrame = 0;
  m_CharacterObj->Set_Animation(m_Animation, m_CurrFrame);
  m_IsAnimating = false;
  return;
...
//
/////////////////////////////////////////////////////////////////////////////
void TransitionEditDialogClass::Update_Animation(void) {
  if (m_IsAnimating) {
...
//
/////////////////////////////////////////////////////////////////////////////
void TransitionEditDialogClass::OnSizeZone(void) {
...
//
/////////////////////////////////////////////////////////////////////////////
void TransitionEditDialogClass::OnRotateChar(void) {
