...
ZoneEditDialogClass::ZoneEditDialogClass(CWnd *pParent /*=NULL*/)
    : m_LookAtDist(0), m_Camera(NULL), m_Scene(NULL), m_RenderObj(NULL), m_PhysObj(NULL), m_Zone(NULL), m_TimerID(0),
      m_IsEditingZone(true), m_IsSizingZone(false), m_SwapChain(NULL), m_Initialized(false),
...
//
/////////////////////////////////////////////////////////////////////////////
void ZoneEditDialogClass::DoDataExchange(CDataExchange *pDX) {
...
//
/////////////////////////////////////////////////////////////////////////////
BOOL ZoneEditDialogClass::OnInitDialog(void) {
...
//
/////////////////////////////////////////////////////////////////////////////
void ZoneEditDialogClass::OnOK(void) {
  //
...
//
/////////////////////////////////////////////////////////////////////////////
void ZoneEditDialogClass::OnDestroy(void) {
  // Stop the timer
  if (m_TimerID != 0) {
...
//
/////////////////////////////////////////////////////////////////////////////
void ZoneEditDialogClass::Render_View(void) {
...
//
/////////////////////////////////////////////////////////////////////////////
void CALLBACK ZoneEditDialogClass::fnUpdateTimer(UINT uID, UINT uMsg, DWORD user_data, DWORD dw1, DWORD dw2) {
...
/////////////////////////////////////////////////////////////////////////////
LRESULT
ZoneEditDialogClass::WindowProc(UINT message, WPARAM wParam, LPARAM lParam) {
...
//
/////////////////////////////////////////////////////////////////////////////
void ZoneEditDialogClass::OnTop(void) {
...
//
/////////////////////////////////////////////////////////////////////////////
void ZoneEditDialogClass::OnFront(void) {
  Vector3 pos = m_RenderObj->Get_Position();
...
//
/////////////////////////////////////////////////////////////////////////////
void ZoneEditDialogClass::OnLeft(void) {
  Vector3 pos = m_RenderObj->Get_Position();
...
//
/////////////////////////////////////////////////////////////////////////////
void ZoneEditDialogClass::OnRight(void) {
  Vector3 pos = m_RenderObj->Get_Position();
...
//
/////////////////////////////////////////////////////////////////////////////
void ZoneEditDialogClass::Load_Object(void) {
  //
...
//
/////////////////////////////////////////////////////////////////////////////
void ZoneEditDialogClass::Insert_Zone(void) {
  //
...
//
/////////////////////////////////////////////////////////////////////////////
void ZoneEditDialogClass::Set_Phys_Obj(PhysClass *phys_obj) {
...
//
/////////////////////////////////////////////////////////////////////////////
void ZoneEditDialogClass::Handle_Keypress(void) {
  //
...
//
/////////////////////////////////////////////////////////////////////////////
void ZoneEditDialogClass::Update_Status(void) {
  //
...
//
/////////////////////////////////////////////////////////////////////////////
void ZoneEditDialogClass::OnEditZone(void) {
...
//
/////////////////////////////////////////////////////////////////////////////
LRESULT CALLBACK ZoneEditDialogClass::fn3DWindow(HWND hwnd, UINT message, WPARAM wparam, LPARAM lparam) {
...
//
/////////////////////////////////////////////////////////////////////////////
void ZoneEditDialogClass::Handle_LBUTTON_DOWN(WPARAM wparam, LPARAM lparam) {
...
//
/////////////////////////////////////////////////////////////////////////////
void ZoneEditDialogClass::Handle_LBUTTON_UP(WPARAM wparam, LPARAM lparam) {
  ::ReleaseCapture();
  return;
}
...
//
/////////////////////////////////////////////////////////////////////////////
void ZoneEditDialogClass::Handle_MOUSEMOVE(WPARAM wparam, LPARAM lparam) {
  if (m_Initialized == false) {
    return;
  }
...
//
/////////////////////////////////////////////////////////////////////////////
BOOL ZoneEditDialogClass::PreTranslateMessage(MSG *pMsg) {
...
//
/////////////////////////////////////////////////////////////////////////////
void ZoneEditDialogClass::OnSizeZone(void) {
...
//
/////////////////////////////////////////////////////////////////////////////
void ZoneEditDialogClass::OnLastFrame(void) {
...
//
/////////////////////////////////////////////////////////////////////////////
void ZoneEditDialogClass::OnFirstFrame(void) {
