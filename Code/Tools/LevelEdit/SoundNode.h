...
//	On_Rotate
//////////////////////////////////////////////////////////////////
inline void SoundNodeClass::On_Rotate(void) {
  if (SoundObj != NULL) {
...
//	On_Translate
//////////////////////////////////////////////////////////////////
inline void SoundNodeClass::On_Translate(void) {
  if (SoundObj != NULL) {
    SoundObj->Set_Transform(m_Transform);
  }
...
//	On_Transform
//////////////////////////////////////////////////////////////////
inline void SoundNodeClass::On_Transform(void) {
  if (SoundObj != NULL) {
    SoundObj->Set_Transform(m_Transform);
  }
...
//////////////////////////////////////////////////////////////////
inline float SoundNodeClass::Get_Attenuation_Radius(void) { return InstanceSettings.Get_DropOff_Radius(); }

//////////////////////////////////////////////////////////////////
//	Set_Attenuation_Radius
//////////////////////////////////////////////////////////////////
inline void SoundNodeClass::Set_Attenuation_Radius(float radius) {
