...
enum { CHUNKID_VARIABLES = 0x02291130, CHUNKID_BASE_CLASS, CHUNKID_WAYPOINTS };
...
WaypathNodeClass::WaypathNodeClass(PresetClass *preset)
    : m_PhysObj(NULL), m_Flags(FLAG_HUMAN | FLAG_GROUND_VEHICLE), m_RuntimeWaypath(NULL), m_HasLoadCompleted(true),
      NodeClass(preset) {
  return;
}
...
//
//////////////////////////////////////////////////////////////////////////////
void WaypathNodeClass::Initialize(void) {
  MEMBER_RELEASE(m_PhysObj);
...
//
////////////////////////////////////////////////////////////////
const PersistFactoryClass &WaypathNodeClass::Get_Factory(void) const { return _WaypathNodePersistFactory; }
...
//
/////////////////////////////////////////////////////////////////
bool WaypathNodeClass::Save(ChunkSaveClass &csave) {
...
//
/////////////////////////////////////////////////////////////////
bool WaypathNodeClass::Load(ChunkLoadClass &cload) {
...
//
///////////////////////////////////////////////////////////////////////
bool WaypathNodeClass::Load_Variables(ChunkLoadClass &cload) {
  //
...
//
///////////////////////////////////////////////////////////////////////
void WaypathNodeClass::On_Post_Load(void) {
  //
...
//
///////////////////////////////////////////////////////////////////////
void WaypathNodeClass::Set_Transform(const Matrix3D &tm) {
...
//
/////////////////////////////////////////////////////////////////
const WaypathNodeClass &WaypathNodeClass::operator=(const WaypathNodeClass &src) {
  //
...
//
//////////////////////////////////////////////////////////////////////
void WaypathNodeClass::Pre_Export(void) {
  //
  ...
  for (int index = 0; index < m_PointList.Count(); index++) {
    ...
    if (waypoint != NULL) {
      ...
      runtime_waypoint->Set_Flag(WaypointClass::FLAG_REQUIRES_JUMP,
                                 waypoint->Get_Flag(WaypointNodeClass::FLAG_REQUIRES_JUMP));
...
//
//////////////////////////////////////////////////////////////////////
void WaypathNodeClass::Post_Export(void) {
  //
...
//
//////////////////////////////////////////////////////////////////////
void WaypathNodeClass::Free_Waypoints(void) {
  //
...
//
//////////////////////////////////////////////////////////////////////////////
void WaypathNodeClass::Add_To_Scene(void) {
...
//
//////////////////////////////////////////////////////////////////////////////
void WaypathNodeClass::Remove_From_Scene(void) {
  SceneEditorClass *scene = ::Get_Scene_Editor();
...
//
//////////////////////////////////////////////////////////////////////////////
void WaypathNodeClass::Delete_Point(int index) {
  SANITY_CHECK(index >= 0 && index < m_PointList.Count()) { return; }
...
//
//////////////////////////////////////////////////////////////////////////////
void WaypathNodeClass::Insert_Point(int index, const Vector3 &point) {
  SANITY_CHECK(index >= 0 && index <= m_PointList.Count()) { return; }
...
//
//////////////////////////////////////////////////////////////////////////////
int WaypathNodeClass::Find_Index(WaypointNodeClass *waypoint) {
  int retval = -1;
...
//
//////////////////////////////////////////////////////////////////////////////
int WaypathNodeClass::Add_Point(const Vector3 &point) {
  //
...
//
//////////////////////////////////////////////////////////////////////////////
void WaypathNodeClass::On_Point_Moved(int index, const Vector3 &new_pos) {
  SegmentedLineClass *line = Peek_Line();
  if (line != NULL) {
...
//
//////////////////////////////////////////////////////////////////////////////
void WaypathNodeClass::Update_Line(void) {
  SegmentedLineClass *line = Peek_Line();
  if (line != NULL) {
...
//
//////////////////////////////////////////////////////////////////////////////
WaypointNodeClass *WaypathNodeClass::Create_Waypoint(const Vector3 &point) {
  //
...
//
//////////////////////////////////////////////////////////////////////////////
SegmentedLineClass *WaypathNodeClass::Peek_Line(void) {
...
//
//////////////////////////////////////////////////////////////////////////////
void WaypathNodeClass::Set_Flags(int flags) {
  m_Flags = flags;
  return;
}
...
//
//////////////////////////////////////////////////////////////////////////////
void WaypathNodeClass::Set_Flag(int flag, bool onoff) {
  m_Flags &= ~flag;
  if (onoff) {
    m_Flags |= flag;
  }
...
//
//////////////////////////////////////////////////////////////////////////////
bool WaypathNodeClass::Get_Flag(int flag) { return bool((m_Flags & flag) == flag); }
...
//
//////////////////////////////////////////////////////////////////////////////
void WaypathNodeClass::Hide(bool hide) {
  //
...
//
//////////////////////////////////////////////////////////////////////////////
bool WaypathNodeClass::Show_Settings_Dialog(void) {
...
//
//////////////////////////////////////////////////////////////////////////////
void WaypathNodeClass::On_Delete(void) {
  //
  //	Apply the same operation to all the points along the path
  //
  for (int index = 0; index < m_PointList.Count(); index++) {
...
//
//////////////////////////////////////////////////////////////////////////////
void WaypathNodeClass::On_Restore(void) {
  //
  //	Apply the same operation to all the points along the path
  //
  for (int index = 0; index < m_PointList.Count(); index++) {
