...
LightDefinitionClass::LightDefinitionClass(void)
    : m_CastsShadows(false), m_AmbientColor(0.7F, 0.7F, 0.7F), m_DiffuseColor(0.7F, 0.7F, 0.7F),
      m_SpecularColor(0.7F, 0.7F, 0.7F), m_Intensity(1.0F), m_FarRadiusInner(10.0F), m_FarRadiusOuter(20.0F),
      m_SpotDir(0, 0, 0), m_SpotAngle(0), m_SpotExp(0), m_LightType(LightClass::POINT), DefinitionClass() {
  ...
  ENUM_PARAM(LightDefinitionClass, m_LightType,
             ("Point", LightClass::POINT, "Directional", LightClass::DIRECTIONAL, "Spotlight", LightClass::SPOT, NULL));
...
//
//////////////////////////////////////////////////////////////////////////////////
LightDefinitionClass::~LightDefinitionClass(void) { return; }
...
//
//////////////////////////////////////////////////////////////////////////////////
const LightDefinitionClass &LightDefinitionClass::operator=(const LightDefinitionClass &src) {
...
//
//////////////////////////////////////////////////////////////////////////////////
const PersistFactoryClass &LightDefinitionClass::Get_Factory(void) const { return _LightPersistFactory; }
...
//
//////////////////////////////////////////////////////////////////////////////////
bool LightDefinitionClass::Save(ChunkSaveClass &csave) {
  bool retval = true;
...
//
//////////////////////////////////////////////////////////////////////////////////
bool LightDefinitionClass::Load(ChunkLoadClass &cload) {
  bool retval = true;
...
//
//////////////////////////////////////////////////////////////////////////////////
bool LightDefinitionClass::Save_Variables(ChunkSaveClass &csave) {
  bool retval = true;
...
//
//////////////////////////////////////////////////////////////////////////////////
bool LightDefinitionClass::Load_Variables(ChunkLoadClass &cload) {
  bool retval = true;
...
//
//////////////////////////////////////////////////////////////////////////////////
PersistClass *LightDefinitionClass::Create(void) const { return new LightNodeClass(); }
