...
VisPointGeneratorClass::VisPointGeneratorClass(float granularity)
    : m_Granularity(granularity), m_BaseGranularity(granularity), m_IgnoreBias(false), m_ViewPlaneExtent(0, 0, 0),
      m_WorldToGridTM(1), m_CurrentNode(NULL), m_StatWindow(NULL), m_pCameraSimOffsets(NULL), m_CurrentPointList(NULL),
      m_PolygonsProcessed(0), m_TotalPoints(0), m_CameraSimPointCount(DEF_CAM_SIM_POINT_COUNT),
      m_CurrentCeilingHeight(DEF_POINT_RAISE_HEIGHT), m_VisSampleHeight(DEF_VIS_SAMPLE_HEIGHT) {
...
//
//////////////////////////////////////////////////////////////////////////
static inline bool Is_Numerical(char ch) { return ((ch >= '0' && ch <= '9') || ch == '-' || ch == '+' || ch == '.'); }
...
//
//////////////////////////////////////////////////////////////////////////
static bool Read_Float_Param(LPCTSTR text, LPCTSTR key, float *value) {
  bool retval = false;
...
//
//////////////////////////////////////////////////////////////////////////
void VisPointGeneratorClass::Determine_Granularity(MeshClass &mesh) {
  //
...
//
//////////////////////////////////////////////////////////////////////////
void VisPointGeneratorClass::Submit_Mesh(MeshClass &mesh) {
  ...
  Vector3 offset(-(box.Center.X - box.Extent.X), -(box.Center.Y - box.Extent.Y), -(box.Center.Z - box.Extent.Z));
...
//
/////////////////////////////////////////////////////////////////////////
void VisPointGeneratorClass::Subdivide_And_Submit_Centers(const Vector3 &point1, const Vector3 &point2,
...
//
/////////////////////////////////////////////////////////////////////////
bool VisPointGeneratorClass::Find_Valid_Points(const Vector3 &start, const Vector3 &end, const Matrix3 &orientation,
                                               bool do_camera_ring) {
  bool retval = false;
...
//
/////////////////////////////////////////////////////////////////////////
bool VisPointGeneratorClass::Check_Ceiling(const Vector3 &position, float *ceiling_dist) {
  bool retval = true;
...
//
/////////////////////////////////////////////////////////////////////////
bool VisPointGeneratorClass::Is_Grid_Cell_Empty(const Vector3 &position) {
...
//
/////////////////////////////////////////////////////////////////////////
bool VisPointGeneratorClass::Submit_Point(const Matrix3D &vis_transform, bool do_camera_ring) {
  bool was_valid = true;
  ...
  Vector3 cell_center((grid_pos.X * m_Granularity) + half_gran, (grid_pos.Y * m_Granularity) + half_gran,
...
//
/////////////////////////////////////////////////////////////////////////
bool VisPointGeneratorClass::Do_View_Planes_Pass(const Matrix3D &vis_transform) {
  bool retval = true;
...
//
/////////////////////////////////////////////////////////////////////////
bool VisPointGeneratorClass::Test_Camera_Sim_Point(const Vector3 &start_point, const Vector3 &end_point,
                                                   Matrix3D *transform_result, NodeClass **node_result) {
  bool retval = false;
...
//
/////////////////////////////////////////////////////////////////////////
NodeClass *VisPointGeneratorClass::Find_Floor_Node(const Vector3 &start_point) {
  NodeClass *node = NULL;
  ...
  if (res.Fraction < 1.0F) {
    ...
    if (physobj != NULL) {
      ...
      //
      HITTESTINFO *hittest = (HITTESTINFO *)physobj->Peek_Model()->Get_User_Data();
      if ((hittest != NULL) && (hittest->Type == HITTESTINFO::Node)) {
        //
...
//
/////////////////////////////////////////////////////////////////////////
bool VisPointGeneratorClass::Is_Object_Invalid_Roof(RenderObjClass *render_obj) {
  bool retval = true;
...
//
/////////////////////////////////////////////////////////////////////////
void VisPointGeneratorClass::Initialize_Camera_Sim(void) {
  SAFE_DELETE_ARRAY(m_pCameraSimOffsets);
...
//
/////////////////////////////////////////////////////////////////////////
void VisPointGeneratorClass::Generate_Camera_Locations(const Matrix3D &real_vis_point) {
  ...
  for (int index = 0; index < m_CameraSimPointCount; index++) {
    ...
    //
    Test_Camera_Sim_Point(position, end_point, &sim_points[index].vis_point, &sim_points[index].node);
  }
  ...
  for (int index = 0; index < m_CameraSimPointCount; index++) {
    ...
    //
    if ((sim_points[index].node != current_node) || (index == m_CameraSimPointCount - 1)) {
      ...
      if (index > 0) {
        ...
        for (int offset = 0; (offset < max) && !found; offset++) {
          ...
          if (((middle_index + offset) < index) && (sim_points[middle_index + offset].node != NULL)) {
            middle_index += offset;
            found = true;
          } else if (((middle_index - offset) >= start_index) && (sim_points[middle_index - offset].node != NULL)) {
            middle_index -= offset;
            found = true;
          }
        }
...
//
/////////////////////////////////////////////////////////////////////////
void VisPointGeneratorClass::Set_Current_Node(NodeClass *node) {
  m_CurrentNode = node;
  return;
}
...
//
/////////////////////////////////////////////////////////////////////////
void VisPointGeneratorClass::Post_Process_Nodes(void) { return; }
...
//
/////////////////////////////////////////////////////////////////////////
void VisPointGeneratorClass::Add_Manual_Nodes(void) {
