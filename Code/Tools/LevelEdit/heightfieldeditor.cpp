...
//
//////////////////////////////////////////////////////////////////////
void HeightfieldEditorClass::Initialize(void) { return; }
...
//
//////////////////////////////////////////////////////////////////////
void HeightfieldEditorClass::Shutdown(void) {
  //
...
//
//////////////////////////////////////////////////////////////////////
void HeightfieldEditorClass::Set_Brush_Radii(float inner_radius, float outter_radius) {
...
//
//////////////////////////////////////////////////////////////////////
void HeightfieldEditorClass::Get_Brush_Radii(float &inner_radius, float &outter_radius) {
...
//
//////////////////////////////////////////////////////////////////////
void HeightfieldEditorClass::Set_Mode(EDITING_MODE mode) {
  Mode = mode;
  return;
}
...
//
//////////////////////////////////////////////////////////////////////
void HeightfieldEditorClass::On_Frame_Update(void) {
  //
  ...
  if (phys_obj != NULL) {
    ...
    //
    PhysicsSceneClass::Get_Instance()->Add_Debug_AABox(
        AABoxClass(res.ContactPoint + Vector3(0, 0, 2.0F), Vector3(1.0F, 1.0F, 1.0F)), Vector3(1, 0, 0));
    ...
    if (model != NULL && model->Class_ID() == RenderObjClass::CLASSID_RENEGADE_TERRAIN && CurrentHeightfield != NULL) {
      ...
      if (::Get_Mouse_Mgr()->Is_LButton_Down()) {
        ...
        if (Mode == MODE_DEFORM) {
          ...
          heightfield->Smooth_Foundation_Heightfield(res.ContactPoint, BrushAmount, BrushInnerRadius,
                                                     BrushOutterRadius);
          ...
          heightfield->Paint_Heightfield(res.ContactPoint, CurrentTextureIndex, BrushAmount, BrushInnerRadius,
                                         BrushOutterRadius);
        }
...
//
//////////////////////////////////////////////////////////////////////
void HeightfieldEditorClass::Render(void) { return; }
...
HeightfieldEditorClass::Create_Texture_Thumbnail(const char *filename, int width, int height) {
  ...
  HBITMAP bitmap =
      ::CreateDIBSection(screen_dc, (const BITMAPINFO *)&bitmap_info, DIB_RGB_COLORS, (void **)&dest_bits, NULL, 0L);
  ...
  //
  BitmapHandlerClass::Copy_Image(dest_bits, width, height, dest_pitch, WW3D_FORMAT_R8G8B8, src_bits, sd.Width,
                                 sd.Height, src_pitch, WW3D_FORMAT_R8G8B8, NULL, 0, false);
...
//
//////////////////////////////////////////////////////////////////////
void HeightfieldEditorClass::Set_Material(int index, TerrainMaterialClass *material) {
  //
...
//
//////////////////////////////////////////////////////////////////////
TerrainMaterialClass *HeightfieldEditorClass::Peek_Material(int index) {
...
//
//////////////////////////////////////////////////////////////////////
TerrainMaterialClass *HeightfieldEditorClass::Get_Material(int index) {
  //
...
//
//////////////////////////////////////////////////////////////////////
void HeightfieldEditorClass::Load_Materials(EditableHeightfieldClass *heightfield) {
  if (heightfield == NULL) {
    return;
  }
...
//
//////////////////////////////////////////////////////////////////////
void HeightfieldEditorClass::Set_Current_Heightfield(EditableHeightfieldClass *heightfield) {
  CurrentHeightfield = heightfield;
...
//
//////////////////////////////////////////////////////////////////////
void HeightfieldEditorClass::On_Material_Changed(int material_index) {
  //
