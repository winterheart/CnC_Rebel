...
public:
  VisPointListClass(void) : DynamicVectorClass<Matrix3D>() {}
...
class VisPointInfo {
public:
  VisPointInfo(void) : m_DoCameraRing(true), m_Transform(1) {}
...
private:
  ...
  bool Test_Camera_Sim_Point(const Vector3 &start_point, const Vector3 &end_point, Matrix3D *transform_result,
