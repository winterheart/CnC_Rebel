...
BaseGameObj::BaseGameObj(void)
    : Definition(NULL),
      ...
      // ID( 0 ),
      IsPostThinkAllowed(false), EnableCinematicFreeze(true) {
...
**
*/
BaseGameObj::~BaseGameObj(void) { GameObjManager::Remove(this); }

/*
**
*/
void BaseGameObj::Init(const BaseGameObjDef &definition) { Definition = &definition; }

const BaseGameObjDef &BaseGameObj::Get_Definition(void) const { return *Definition; };
