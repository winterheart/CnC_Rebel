...
#define ADD_STATE_TO_MACHINE(machine, state)                                                                           \
  machine.Add_State(&objClass::On_##state##_Think, &objClass::On_##state##_Request_End, &objClass::On_##state##_Begin, \
                    &objClass::On_##state##_End);
...
#define SM_NO_REQ_END                                                                                                  \
  {                                                                                                                    \
    return true;                                                                                                       \
  }

#define DECLARE_STATE(state, begin, end, think, req_end)                                                               \
  void On_##state##_Begin(void) begin void On_##state##_End(void) end void On_##state##_Think(void)                    \
      think bool On_##state##_Request_End(int state) req_end

#define DECLARE_STATE_HANDLER_BEGIN(state) void On_##state##_Begin(void)

#define DECLARE_STATE_HANDLER_END(state) void On_##state##_End(void)

#define DECLARE_STATE_HANDLER_THINK(state) void On_##state##_Think(void)

#define DECLARE_STATE_HANDLER_REQUEST_END(state) bool On_##state##_Request_End(int state)

#define STATE_IMPL_BEGIN(state) On_##state##_Begin

#define STATE_IMPL_END(state) On_##state##_End

#define STATE_IMPL_THINK(state) On_##state##_Think

#define STATE_IMPL_REQUEST_END(state) On_##state##_Request_End
...
//
//////////////////////////////////////////////////////////////////////
template <class T> class StateClass {
public:
  ///////////////////////////////////////////////////////////////////
  //	Public constructors/destructors
  ///////////////////////////////////////////////////////////////////
  StateClass<T>(void) : Think(NULL), RequestEnd(NULL), Begin(NULL), End(NULL) {}
...
//
//////////////////////////////////////////////////////////////////////
template <class T> class StateMachineClass {
public:
  ///////////////////////////////////////////////////////////////////
  //	Public typedefs
  ///////////////////////////////////////////////////////////////////
  ...
  //	Public constructors/destructors
  ///////////////////////////////////////////////////////////////////
  StateMachineClass(T *object) : CurrState(-1), Object(object), IsHalted(false) {}
  ...
  //	Add_State
  ///////////////////////////////////////////////////////////////////
  void Add_State(typename STATE_OBJ::THINK_PTR think_ptr, typename STATE_OBJ::REQUEST_END_PTR request_ptr,
                 typename STATE_OBJ::BEGIN_PTR begin_ptr, typename STATE_OBJ::END_PTR end_ptr) {
    StateClass<T> state;
  ...
  //	Get_State
  ///////////////////////////////////////////////////////////////////
  int Get_State(void) { return CurrState; }
...
protected:
  ...
  //	Is_Valid_State
  ///////////////////////////////////////////////////////////////////
  bool Is_Valid_State(int index) { return (index >= 0 && index < StateTable.Count()); }
