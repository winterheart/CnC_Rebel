...
//	Factories
//////////////////////////////////////////////////////////////////////////
SimplePersistFactoryClass<MendozaBossGameObjDefClass, CHUNKID_GAME_OBJECT_DEF_MENDOZA_BOSS>
    _MendozaBossGameObjDefPersistFactory;
SimplePersistFactoryClass<MendozaBossGameObjClass, CHUNKID_GAME_OBJECT_MENDOZA_BOSS> _MendozaBossGameObjPersistFactory;
DECLARE_DEFINITION_FACTORY(MendozaBossGameObjDefClass, CLASSID_GAME_OBJECT_DEF_MENDOZA_BOSS, "Mendoza Boss")
_MendozaBossGameObjDefDefFactory;
...
//
//////////////////////////////////////////////////////////////////////////
MendozaBossGameObjDefClass::~MendozaBossGameObjDefClass(void) { return; }
...
//
//////////////////////////////////////////////////////////////////////////
uint32 MendozaBossGameObjDefClass::Get_Class_ID(void) const { return CLASSID_GAME_OBJECT_DEF_MENDOZA_BOSS; }
...
//
//////////////////////////////////////////////////////////////////////////
PersistClass *MendozaBossGameObjDefClass::Create(void) const {
...
//
//////////////////////////////////////////////////////////////////////////
bool MendozaBossGameObjDefClass::Save(ChunkSaveClass &csave) {
...
//
//////////////////////////////////////////////////////////////////////////
bool MendozaBossGameObjDefClass::Load(ChunkLoadClass &cload) {
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjDefClass::Save_Variables(ChunkSaveClass &csave) { return; }
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjDefClass::Load_Variables(ChunkLoadClass &cload) {
...
//
///////////////////////////////////////////////////////////////////////////
const PersistFactoryClass &MendozaBossGameObjDefClass::Get_Factory(void) const {
...
MendozaBossGameObjClass::MendozaBossGameObjClass(void)
    : MendozaTauntTimeLeft(0), AvailableTaunts(0xFFFFFF), OverallState(this), MendozaState(this), SydneyState(this),
      AttackState(this), CameraState(this), MoveState(this), HeadState(this), OverallStateTimer(0),
      MendozaStateTimer(0), CameraShakeTimer(0), CameraStateTimer(0), StartTimer(0), AttackStateTimer(0),
      RandomTargetTimer(0), FireballStartTimer(0), NextKnockdownAvailableTime(0), SydneyStateTimer(0),
      HasMeleeAttackHit(false), LastMeleeAnimFrame(0), NextMeleeAttackTime(0), MoveStateTimer(0), CameraBoneModel(NULL),
      Sydney(NULL), MendozaPos(0, 0, 0), StarPos(0, 0, 0), ShootGroundPos(0, 0, 0), SideKickPos(0, 0, 0) {
  Shuffle_Taunt_List();
  ...
  CameraState.Add_State(&objClass::On_CAMERA_STATE_FACE_ZOOM_Think, NULL, &objClass::On_CAMERA_STATE_FACE_ZOOM_Begin,
                        NULL);
  CameraState.Add_State(&objClass::On_CAMERA_STATE_WAYPATH_FOLLOW_Think, NULL,
                        &objClass::On_CAMERA_STATE_WAYPATH_FOLLOW_Begin, NULL);
  CameraState.Add_State(&objClass::On_CAMERA_STATE_LOOK_AT_DEAD_BOSS_Think, NULL,
                        &objClass::On_CAMERA_STATE_LOOK_AT_DEAD_BOSS_Begin, NULL);
...
//
///////////////////////////////////////////////////////////////////////////
const PersistFactoryClass &MendozaBossGameObjClass::Get_Factory(void) const {
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::Init(const MendozaBossGameObjDefClass &definition) {
...
//
///////////////////////////////////////////////////////////////////////////
const MendozaBossGameObjDefClass &MendozaBossGameObjClass::Get_Definition(void) const {
...
//
///////////////////////////////////////////////////////////////////////////
bool MendozaBossGameObjClass::Save(ChunkSaveClass &csave) {
...
//
///////////////////////////////////////////////////////////////////////////
bool MendozaBossGameObjClass::Load(ChunkLoadClass &cload) {
  while (cload.Open_Chunk()) {
    switch (cload.Cur_Chunk_ID()) {
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::On_Post_Load(void) {
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::Initialize_Boss(void) {
  //
  //	Find Sydney
  //
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::Save_Variables(ChunkSaveClass &csave) {
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::Apply_Control(void) {
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::Think(void) {
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::Shuffle_Taunt_List(void) {
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::Apply_Damage_Extended(const OffenseObjectClass &damager, float scale,
  ...
  if (SydneyState.Get_State() == SYDNEY_STATE_COWERING) {
    ...
    if (health_percent > 0.25F) {
      ...
      //
      if (health_percent > 0.3F && NextKnockdownAvailableTime <= 0 &&
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::On_MENDOZA_STATE_STANDING_Begin(void) {
  MendozaStateTimer = 0;
  return;
}
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::On_MENDOZA_STATE_FALLING_Begin(void) {
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::On_MENDOZA_STATE_FALLING_Think(void) {
...
//
///////////////////////////////////////////////////////////////////////////
bool MendozaBossGameObjClass::On_MENDOZA_STATE_FALLING_Request_End(int /*new_state*/) { return false; }
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::On_MENDOZA_STATE_KIPPING_Begin(void) {
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::STATE_IMPL_END(MENDOZA_STATE_KIPPING)(void) {
  //
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::On_MENDOZA_STATE_KIPPING_Think(void) {
  if (Get_Anim_Control()->Is_Complete()) {
...
//
///////////////////////////////////////////////////////////////////////////
bool MendozaBossGameObjClass::On_MENDOZA_STATE_KIPPING_Request_End(int /*new_state*/) { return false; }
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::On_MENDOZA_STATE_PACK_EXPLODING_Begin(void) {
  //
...
//
///////////////////////////////////////////////////////////////////////////
bool MendozaBossGameObjClass::STATE_IMPL_REQUEST_END(MENDOZA_STATE_PACK_EXPLODING)(int state) { return false; }
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::On_MENDOZA_STATE_PACK_EXPLODING_Think(void) {
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::On_MENDOZA_STATE_DYING_Begin(void) {
  //
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::On_MENDOZA_STATE_DYING_Think(void) {
  MendozaStateTimer -= TimeManager::Get_Frame_Real_Seconds();
  if (MendozaStateTimer <= 0) {
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::On_MENDOZA_STATE_DEAD_Begin(void) {
  //
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::On_MENDOZA_STATE_DEAD_Think(void) {
  MendozaStateTimer -= TimeManager::Get_Frame_Real_Seconds();
  if (MendozaStateTimer <= 0) {
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::On_CAMERA_STATE_NORMAL_Begin(void) { return; }
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::On_CAMERA_STATE_FACE_ZOOM_Begin(void) {
  //
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::On_CAMERA_STATE_FACE_ZOOM_Think(void) {
  //
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::On_CAMERA_STATE_WAYPATH_FOLLOW_Begin(void) {
  //
  //	Restore time
  //
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::On_CAMERA_STATE_WAYPATH_FOLLOW_Think(void) {
  //
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::On_CAMERA_STATE_LOOK_AT_DEAD_BOSS_Begin(void) {
  //
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::On_CAMERA_STATE_LOOK_AT_DEAD_BOSS_Think(void) {
  //
  //	Kick out of this state when finished
  //
  CameraStateTimer -= TimeManager::Get_Frame_Real_Seconds();
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::Attach_Sound(const char *sound_name, const char *bone_name) {
  //
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::Attach_Fire_Sound(void) {
  //
  //	Create the sound object from its preset
  //
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::On_ATTACK_STATE_NONE_Begin(void) { return; }
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::On_ATTACK_STATE_NONE_Think(void) { return; }
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::On_ATTACK_STATE_MELEE_Begin(void) {
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::On_ATTACK_STATE_MELEE_Think(void) {
  //
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::STATE_IMPL_BEGIN(ATTACK_STATE_MELEE_FLYING_SIDEKICK_RUN)(void) {
  //
  //	Kill the action
  //
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::STATE_IMPL_THINK(ATTACK_STATE_MELEE_FLYING_SIDEKICK_RUN)(void) {
  //
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::STATE_IMPL_BEGIN(ATTACK_STATE_MELEE_FLYING_SIDEKICK)(void) {
  HasMeleeAttackHit = false;
  LastMeleeAnimFrame = 0;
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::STATE_IMPL_END(ATTACK_STATE_MELEE_FLYING_SIDEKICK)(void) {
  //
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::STATE_IMPL_THINK(ATTACK_STATE_MELEE_FLYING_SIDEKICK)(void) {
  //
  //	Get a direction vector between Mendoza and his destination
  //
  Vector3 dir_vector = (SideKickPos - MendozaPos);
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::On_ATTACK_STATE_MELEE_CRESENT_KICK_Begin(void) {
  //
  //	Kill the action
  //
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::STATE_IMPL_END(ATTACK_STATE_MELEE_CRESENT_KICK)(void) {
  //
  //	Release our lock on the human state
  //
  HumanState.Set_State(HumanStateClass::ANIMATION);
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::On_ATTACK_STATE_MELEE_CRESENT_KICK_Think(void) {
  if (Get_Anim_Control()->Is_Complete()) {
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::On_ATTACK_STATE_MELEE_SIDE_KICK_Begin(void) {
  //
  //	Kill the action
  //
  // Get_Action ()->Reset (100.0F);
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::STATE_IMPL_END(ATTACK_STATE_MELEE_SIDE_KICK)(void) {
  //
  //	Release our lock on the human state
  //
  HumanState.Set_State(HumanStateClass::ANIMATION);
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::On_ATTACK_STATE_MELEE_SIDE_KICK_Think(void) {
  if (Get_Anim_Control()->Is_Complete()) {
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::On_ATTACK_STATE_MELEE_SIDE_KICK_RETRACT_Begin(void) {
  //
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::STATE_IMPL_END(ATTACK_STATE_MELEE_SIDE_KICK_RETRACT)(void) {
  //
  //	Release our lock on the human state
  //
  HumanState.Set_State(HumanStateClass::ANIMATION);
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::On_ATTACK_STATE_MELEE_SIDE_KICK_RETRACT_Think(void) {
  if (Get_Anim_Control()->Is_Complete()) {
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::On_ATTACK_STATE_MELEE_PUNCH_Begin(void) {
  //
  //	Kill the action
  //
  // Get_Action ()->Reset (100.0F);
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::STATE_IMPL_END(ATTACK_STATE_MELEE_PUNCH)(void) {
  //
  //	Release our lock on the human state
  //
  HumanState.Set_State(HumanStateClass::ANIMATION);
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::On_ATTACK_STATE_MELEE_PUNCH_Think(void) {
  if (Get_Anim_Control()->Is_Complete()) {
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::STATE_IMPL_BEGIN(ATTACK_STATE_FLAMETHROWER)(void) {
  //
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::STATE_IMPL_END(ATTACK_STATE_FLAMETHROWER)(void) {
  //
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::STATE_IMPL_THINK(ATTACK_STATE_FLAMETHROWER)(void) {
  //
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::STATE_IMPL_BEGIN(ATTACK_STATE_FIREBALL)(void) {
  //
  //	Switch to the flamethrower...
  //
  WeaponBag->Select_Weapon_ID(Get_Definition().WeaponDefID);
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::STATE_IMPL_END(ATTACK_STATE_FIREBALL)(void) {
  //
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::STATE_IMPL_THINK(ATTACK_STATE_FIREBALL)(void) {
  //
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::STATE_IMPL_BEGIN(ATTACK_STATE_HANDGUN)(void) {
  //
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::STATE_IMPL_END(ATTACK_STATE_HANDGUN)(void) {
  //
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::STATE_IMPL_THINK(ATTACK_STATE_HANDGUN)(void) {
  bool turn_on_weapon = false;
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::STATE_IMPL_BEGIN(ATTACK_STATE_SYDNEY)(void) {
  //
  //	Switch to the handgun...
  //
  WeaponBag->Select_Weapon_ID(Get_Definition().WeaponDefID);
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::STATE_IMPL_END(ATTACK_STATE_SYDNEY)(void) {
  //
  //	Stop firing...
  //
  Set_Boolean_Control(ControlClass::BOOLEAN_WEAPON_FIRE_SECONDARY, false);
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::STATE_IMPL_THINK(ATTACK_STATE_SYDNEY)(void) {
  AttackStateTimer -= TimeManager::Get_Frame_Seconds();
  if (AttackStateTimer <= 0) {
...
//
///////////////////////////////////////////////////////////////////////////
bool MendozaBossGameObjClass::Fly_Move(const Vector3 &vector) {
  //
...
//
///////////////////////////////////////////////////////////////////////////
bool MendozaBossGameObjClass::Apply_Bone_Collision_Damage(const char *bone_name) {
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::STATE_IMPL_BEGIN(OVERALL_STATE_FLYING_SIDEKICK)(void) {
  //
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::STATE_IMPL_BEGIN(OVERALL_STATE_MELEE_ATTACK)(void) {
  //
  //	Pull the strings to get the melee battle to begin
  //
  MendozaState.Set_State(MENDOZA_STATE_STANDING);
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::STATE_IMPL_BEGIN(OVERALL_STATE_RANGED_ATTACK)(void) {
  //
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::STATE_IMPL_THINK(OVERALL_STATE_RANGED_ATTACK)(void) {
  //
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::STATE_IMPL_BEGIN(OVERALL_STATE_FIREBALL_ATTACK)(void) {
  //
  //	Pull the strings to get the ranged battle to begin
  //
  MendozaState.Set_State(MENDOZA_STATE_STANDING);
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::STATE_IMPL_THINK(OVERALL_STATE_FIREBALL_ATTACK)(void) { return; }
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::STATE_IMPL_BEGIN(OVERALL_STATE_FIND_HEALTH)(void) {
  //
  //	Reset the states
  //
  MendozaState.Set_State(MENDOZA_STATE_STANDING);
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::STATE_IMPL_THINK(OVERALL_STATE_FIND_HEALTH)(void) {
  //
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::STATE_IMPL_BEGIN(OVERALL_STATE_SYDNEY_BOLTS)(void) {
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::STATE_IMPL_THINK(OVERALL_STATE_SYDNEY_BOLTS)(void) {
  OverallStateTimer -= TimeManager::Get_Frame_Seconds();
  if (OverallStateTimer <= 0) {
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::STATE_IMPL_BEGIN(OVERALL_STATE_RUN_AFTER_SYDNEY)(void) {
  //
  //	Start chasing Sydney
  //
  MendozaState.Set_State(MENDOZA_STATE_STANDING);
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::STATE_IMPL_THINK(OVERALL_STATE_RUN_AFTER_SYDNEY)(void) {
  //
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::STATE_IMPL_BEGIN(OVERALL_STATE_TOY_WITH_SYDNEY)(void) {
  //
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::STATE_IMPL_THINK(OVERALL_STATE_TOY_WITH_SYDNEY)(void) {
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::STATE_IMPL_BEGIN(OVERALL_STATE_DEATH_SEQUENCE)(void) {
  //
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::STATE_IMPL_BEGIN(SYDNEY_STATE_WAITING)(void) { return; }
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::STATE_IMPL_BEGIN(SYDNEY_STATE_BOLTING)(void) {
  //
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::STATE_IMPL_THINK(SYDNEY_STATE_BOLTING)(void) {
  Vector3 syd_pos;
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::STATE_IMPL_BEGIN(SYDNEY_STATE_TRIPPING)(void) {
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::STATE_IMPL_THINK(SYDNEY_STATE_TRIPPING)(void) {
  SoldierGameObj *sydney = Sydney.Get_Ptr()->As_PhysicalGameObj()->As_SoldierGameObj();
  ...
  //
  if (sydney->Get_Anim_Control()->Is_Complete() && OverallState.Get_State() == OVERALL_STATE_TOY_WITH_SYDNEY) {
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::STATE_IMPL_BEGIN(SYDNEY_STATE_GETTING_UP)(void) {
  SoldierGameObj *sydney = Sydney.Get_Ptr()->As_PhysicalGameObj()->As_SoldierGameObj();
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::STATE_IMPL_THINK(SYDNEY_STATE_GETTING_UP)(void) {
  SoldierGameObj *sydney = Sydney.Get_Ptr()->As_PhysicalGameObj()->As_SoldierGameObj();
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::STATE_IMPL_BEGIN(SYDNEY_STATE_COWERING)(void) {
  SoldierGameObj *sydney = Sydney.Get_Ptr()->As_PhysicalGameObj()->As_SoldierGameObj();
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::STATE_IMPL_END(SYDNEY_STATE_COWERING)(void) {
  SoldierGameObj *sydney = Sydney.Get_Ptr()->As_PhysicalGameObj()->As_SoldierGameObj();
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::STATE_IMPL_THINK(SYDNEY_STATE_COWERING)(void) {
  SoldierGameObj *sydney = Sydney.Get_Ptr()->As_PhysicalGameObj()->As_SoldierGameObj();
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::STATE_IMPL_BEGIN(SYDNEY_STATE_STRIKE_A_POSE)(void) {
  SoldierGameObj *sydney = Sydney.Get_Ptr()->As_PhysicalGameObj()->As_SoldierGameObj();
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::STATE_IMPL_BEGIN(MOVE_STATE_CHASE_SYDNEY)(void) {
  //
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::STATE_IMPL_BEGIN(MOVE_STATE_STOP)(void) {
  //
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::STATE_IMPL_BEGIN(MOVE_STATE_GET_CLOSE_TO_PLAYER)(void) {
  MoveStateTimer = 0.0F;
  return;
}
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::STATE_IMPL_END(MOVE_STATE_GET_CLOSE_TO_PLAYER)(void) {
  //
  //	Simply stop any action
  //
  Get_Action()->Reset(100);
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::STATE_IMPL_THINK(MOVE_STATE_GET_CLOSE_TO_PLAYER)(void) {
  //
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::STATE_IMPL_BEGIN(MOVE_STATE_ATTACK_PATTERN1)(void) {
  MoveStateTimer = 0.0F;
  return;
}
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::STATE_IMPL_END(MOVE_STATE_ATTACK_PATTERN1)(void) {
  //
  //	Simply stop any action
  //
  Get_Action()->Reset(100);
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::STATE_IMPL_THINK(MOVE_STATE_ATTACK_PATTERN1)(void) {
  //
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::STATE_IMPL_BEGIN(MOVE_STATE_ATTACK_PATTERN2)(void) {
  MoveStateTimer = 0.0F;
  return;
}
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::STATE_IMPL_END(MOVE_STATE_ATTACK_PATTERN2)(void) {
  //
  //	Simply stop any action
  //
  Get_Action()->Reset(100);
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::STATE_IMPL_THINK(MOVE_STATE_ATTACK_PATTERN2)(void) {
  //
  //	Is it time to move somewhere else?
  //
  MoveStateTimer -= TimeManager::Get_Frame_Seconds();
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::STATE_IMPL_BEGIN(MOVE_STATE_GOTO_HELIPAD)(void) {
  //
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::STATE_IMPL_END(MOVE_STATE_GOTO_HELIPAD)(void) {
  //
  //	Simply stop any action
  //
  Get_Action()->Reset(100);
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::STATE_IMPL_THINK(MOVE_STATE_GOTO_HELIPAD)(void) {
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::STATE_IMPL_BEGIN(MOVE_STATE_RUN_TO_HEALTH)(void) {
  //
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::STATE_IMPL_END(MOVE_STATE_RUN_TO_HEALTH)(void) {
  //
  //	Simply stop any action
  //
  Get_Action()->Reset(100);
  ...
  for (obj_node = GameObjManager::Get_Game_Obj_List()->Head(); obj_node; obj_node = obj_node->Next()) {
    ...
    if (phys_game_obj != NULL && phys_game_obj->As_PowerUpGameObj() != NULL) {
      ...
      if (powerup != NULL) {
        ...
        //
        if (BOSS_AREA_BOX01.Contains(powerup_pos) || BOSS_AREA_BOX02.Contains(powerup_pos) ||
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::STATE_IMPL_BEGIN(HEAD_STATE_NONE)(void) {
  Cancel_Look_At();
  return;
}
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::STATE_IMPL_THINK(HEAD_STATE_LOOKING_AT_STAR)(void) {
  //
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::STATE_IMPL_THINK(HEAD_STATE_LOOKING_AT_SYDNEY)(void) {
  Vector3 syd_pos;
  Sydney.Get_Ptr()->Get_Position(&syd_pos);
...
//
///////////////////////////////////////////////////////////////////////////
void MendozaBossGameObjClass::Spawn_Health_Powerups(void) {
