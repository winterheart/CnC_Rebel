...
public:
  ...
  // Termination
  // virtual	void					Destroy(bool damaged = false)	{ DestroyType = damaged ?
  // DESTROY_DAMAGED : DESTROY_CONTROLLED; } bool
  // Is_Destroy()						{ return (DestroyType != DESTROY_NONE); } bool
  // Is_Damage_Destroyed()			{ return (DestroyType == DESTROY_DAMAGED); }
