...
TransitionEffectClass *CombatMaterialEffectManager::Get_Spawn_Effect(void) {
...
TransitionEffectClass *CombatMaterialEffectManager::Get_Death_Effect(void) {
  TransitionEffectClass *effect = NEW_REF(TransitionEffectClass, ());
...
TransitionEffectClass *CombatMaterialEffectManager::Get_Health_Effect(void) {
  TransitionEffectClass *effect = NEW_REF(TransitionEffectClass, ());
  effect->Set_Parameter(0.0f);
...
TransitionEffectClass *CombatMaterialEffectManager::Get_Electrocution_Effect(void) {
  TransitionEffectClass *effect = NEW_REF(TransitionEffectClass, ());
  effect->Set_Parameter(0.0f);
  effect->Set_Target_Parameter(0.49f);
  effect->Set_Transition_Time(1.0f);
