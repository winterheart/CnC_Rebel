...
static const char *BULDING_TYPE_NAMES[TYPE_COUNT + 1] = {
    "<None>",     "Power Plant", "Soldier Factory", "Vehicle Factory", "Refinery",     "Com Center",
    "Repair Bay", "Shrine",      "Helipad",         "Conyard",         "Base Defense",
};

static const char *BULDING_TEAM_NAMES[BASE_COUNT] = {"GDI", "NOD"};
...
DECLARE_DEFINITION_FACTORY(BuildingGameObjDef, CLASSID_GAME_OBJECT_DEF_BUILDING, "<Generic Building>")
_BuildingGameObjDefDefFactory;
...
BuildingGameObjDef::BuildingGameObjDef(void)
    : MCTSkin(0), Type(TYPE_NONE), GDIDamageReportID(0), NodDamageReportID(0), GDIDestroyReportID(0),
...
//
/////////////////////////////////////////////////////////////////////////////
uint32 BuildingGameObjDef::Get_Class_ID(void) const { return CLASSID_GAME_OBJECT_DEF_BUILDING; }
...
//
/////////////////////////////////////////////////////////////////////////////
PersistClass *BuildingGameObjDef::Create(void) const {
...
//
/////////////////////////////////////////////////////////////////////////////
bool BuildingGameObjDef::Save(ChunkSaveClass &csave) {
...
//
/////////////////////////////////////////////////////////////////////////////
bool BuildingGameObjDef::Load(ChunkLoadClass &cload) {
  int legacy_team = -1;
...
//
/////////////////////////////////////////////////////////////////////////////
const PersistFactoryClass &BuildingGameObj::Get_Factory(void) const { return _BuildingGameObjPersistFactory; }
...
BuildingGameObj::BuildingGameObj(void)
    : Position(0, 0, 0), IsPowerOn(true), CurrentState(-1), AnnouncementSphere(Vector3(0, 0, 0), 1.0F),
      CollectionSphere(Vector3(0, 0, 0), 50.0F), CurrentAnnouncement(NULL), IsDestroyed(false), BuildingMonitor(NULL),
      BaseController(NULL) {
...
//
/////////////////////////////////////////////////////////////////////////////
void BuildingGameObj::Init(void) { Init(Get_Definition()); }
...
//
/////////////////////////////////////////////////////////////////////////////
void BuildingGameObj::Init(const BuildingGameObjDef &definition) {
...
//
/////////////////////////////////////////////////////////////////////////////
bool BuildingGameObj::Save(ChunkSaveClass &csave) {
...
//
/////////////////////////////////////////////////////////////////////////////
bool BuildingGameObj::Load(ChunkLoadClass &cload) {
  while (cload.Open_Chunk()) {
    switch (cload.Cur_Chunk_ID()) {
...
//
/////////////////////////////////////////////////////////////////////////////
void BuildingGameObj::Enable_Power(bool onoff) {
  if (IsPowerOn != onoff) {
...
void BuildingGameObj::Apply_Damage(const OffenseObjectClass &damager, float scale, int alternate_skin) {
  ...
  */
  ...
  //	WWDEBUG_SAY(("Applied damage to a building (prefix=%s) new health =
...
//
/////////////////////////////////////////////////////////////////////////////
bool BuildingGameObj::Is_Interior_Mesh_Name(const char *name) {
...
//
/////////////////////////////////////////////////////////////////////////////
bool BuildingGameObj::Is_Exterior_Mesh_Name(const char *name) {
// (gth) Renegade day 120 patch, accept tiles as building "parts"
#if 0
	char * meshname = strchr(name,'.');
	if (meshname != NULL) {
...
//
/////////////////////////////////////////////////////////////////////////////
bool BuildingGameObj::Name_Prefix_Matches_This_Building(const char *name) {
  bool retval = false;
...
//
/////////////////////////////////////////////////////////////////////////////
void BuildingGameObj::Set_Normalized_Health(float health) {
  //
  ...
  WWDEBUG_SAY(("  prefix = %s mesh count = %d aggregate count = %d light count = %d\r\n",
    Get_Definition().MeshPrefix.Peek_Buffer(), InteriorMeshes.Count() + ExteriorMeshes.Count(), Aggregates.Count(),
...
//
/////////////////////////////////////////////////////////////////////////////
void BuildingGameObj::Update_State(bool force_update) {
  /*
...
//
/////////////////////////////////////////////////////////////////////////////
void BuildingGameObj::Play_Announcement(int text_id, bool broadcast) {
  Stop_Current_Announcement();
...
//
/////////////////////////////////////////////////////////////////////////////
void BuildingGameObj::Stop_Current_Announcement(void) {
  if (CurrentAnnouncement) {
...
//
/////////////////////////////////////////////////////////////////////////////
void BuildingGameObj::Initialize_Building(void) {
...
//
/////////////////////////////////////////////////////////////////////////////
void BuildingGameObj::Reset_Components(void) {
  RefMultiListIterator<StaticPhysClass> mesh_iterator(&InteriorMeshes);
...
//
/////////////////////////////////////////////////////////////////////////////
void BuildingGameObj::Enable_Alternate_Materials(RefMultiListClass<StaticPhysClass> &models, bool onoff) {
...
//
/////////////////////////////////////////////////////////////////////////////
void BuildingGameObj::CnC_Initialize(BaseControllerClass *base) {
  BaseController = base;
...
//
/////////////////////////////////////////////////////////////////////////////
void BuildingGameObj::On_Damaged(void) {
  //
...
//
/////////////////////////////////////////////////////////////////////////////
void BuildingGameObj::On_Destroyed(void) {
  IsDestroyed = true;
...
//
/////////////////////////////////////////////////////////////////////////////
void BuildingGameObj::Import_Rare(BitStreamClass &packet) {
...
//
/////////////////////////////////////////////////////////////////////////////
void BuildingGameObj::Export_Rare(BitStreamClass &packet) {
...
//
/////////////////////////////////////////////////////////////////////////////
void BuildingGameObj::Set_Precision(void) {
...
//
/////////////////////////////////////////////////////////////////////////////
void BuildingGameObj::Collect_Building_Components(void) {
  Reset_Components();
...
//
/////////////////////////////////////////////////////////////////////////////
void BuildingGameObj::Export_Creation(BitStreamClass &packet) {
...
//
/////////////////////////////////////////////////////////////////////////////
void BuildingGameObj::Import_Creation(BitStreamClass &packet) {
...
//
/////////////////////////////////////////////////////////////////////////////
void BuildingGameObj::Find_Closest_Poly_For_Model(RenderObjClass *model, const Vector3 &pos, float *distance2) {
  if (model == NULL) {
    return;
  }
