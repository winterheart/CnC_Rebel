...
TextWindowClass::TextWindowClass(void)
    : FirstLineIndex(0), CurrentDisplayCount(0), IsDisplayed(false), AreColumnsDisplayed(false), IsViewDirty(true),
      TextRect(0, 0, 0, 0), ColumnHeight(0), LineSpacing(0) {
...
//
////////////////////////////////////////////////////////////////
void TextWindowClass::Initialize(SceneClass *scene) {
...
//
////////////////////////////////////////////////////////////////
void TextWindowClass::Shutdown(void) {
...
//
////////////////////////////////////////////////////////////////
void TextWindowClass::Free_Backdrop(void) {
  //
...
//
////////////////////////////////////////////////////////////////
void TextWindowClass::Free_Contents(void) {
  //
...
//
////////////////////////////////////////////////////////////////
void TextWindowClass::Free_Renderers(void) {
  //
...
//
////////////////////////////////////////////////////////////////
void TextWindowClass::Set_Backdrop(const char *texture_name, const RectClass &screen_rect, const Vector2 &texture_size,
                                   const RectClass &endcap_rect, const RectClass &fadeout_rect,
...
//
////////////////////////////////////////////////////////////////
void TextWindowClass::On_Frame_Update(void) { return; }
...
//
////////////////////////////////////////////////////////////////
void TextWindowClass::Add_Column(const WCHAR *column_name, float width, const Vector3 &color) {
  //
...
//
////////////////////////////////////////////////////////////////
bool TextWindowClass::Remove_Column(int index) {
...
//
////////////////////////////////////////////////////////////////
void TextWindowClass::Delete_All_Columns(void) {
...
//
////////////////////////////////////////////////////////////////
int TextWindowClass::Get_Item_Count(void) const { return Columns[0]->Get_Item_Count(); }
...
//
////////////////////////////////////////////////////////////////
int TextWindowClass::Get_Display_Count(void) {
  if (IsViewDirty) {
    Update_View();
  }
...
//
////////////////////////////////////////////////////////////////
bool TextWindowClass::Delete_Item(int index) {
  bool retval = true;
...
//
////////////////////////////////////////////////////////////////
int TextWindowClass::Insert_Item(int index, const WCHAR *text) {
  if (Columns.Count() <= 0) {
    return -1;
  }
...
//
////////////////////////////////////////////////////////////////
bool TextWindowClass::Set_Item_Text(int index, int col_index, const WCHAR *text) {
...
//
////////////////////////////////////////////////////////////////
bool TextWindowClass::Set_Item_Color(int index, int col_index, const Vector3 &color) {
  if (col_index < 0 || col_index >= Columns.Count()) {
    return false;
  }
...
//
////////////////////////////////////////////////////////////////
bool TextWindowClass::Set_Item_Data(int index, uint32 user_data) {
  //
...
//
////////////////////////////////////////////////////////////////
uint32 TextWindowClass::Get_Item_Data(int index) {
  //
...
//
////////////////////////////////////////////////////////////////
void TextWindowClass::Delete_All_Items(void) {
  for (int index = 0; index < Columns.Count(); index++) {
...
//
////////////////////////////////////////////////////////////////
void TextWindowClass::Build_View(void) {
  //
  //	Start fresh
  //
  Free_Renderers();
...
//
////////////////////////////////////////////////////////////////
void TextWindowClass::Update_View(float *total_height, bool info_only) {
  //
...
//
////////////////////////////////////////////////////////////////
float TextWindowClass::Get_Total_Display_Height(void) {
...
//
////////////////////////////////////////////////////////////////
void TextWindowClass::Update_Row(int item_index, float y_pos, float *row_height) {
...
//
////////////////////////////////////////////////////////////////
void TextWindowClass::Display(bool onoff) {
...
//
////////////////////////////////////////////////////////////////
void TextWindowClass::Page_Down(void) {
...
//
////////////////////////////////////////////////////////////////
void TextWindowClass::Page_Up(void) {
  FirstLineIndex -= CurrentDisplayCount;
...
//
////////////////////////////////////////////////////////////////
void TextWindowClass::Scroll_To_Top(void) {
  FirstLineIndex = 0;
  Update_View();
  return;
}
...
//
////////////////////////////////////////////////////////////////
void TextWindowClass::Render(void) {
...
//
////////////////////////////////////////////////////////////////
void TextColumnClass::Free_Data(void) {
  Delete_All_Items();
  return;
}
...
//
////////////////////////////////////////////////////////////////
void TextColumnClass::Reset_Contents(void) {
  //
...
//
////////////////////////////////////////////////////////////////
int TextColumnClass::Insert_Item(int index, const WCHAR *item_name) {
...
//
////////////////////////////////////////////////////////////////
bool TextColumnClass::Delete_Item(int index) {
  bool retval = false;
...
//
////////////////////////////////////////////////////////////////
void TextColumnClass::Delete_All_Items(void) {
  //
