...
enum { ROCKET_STATE_OPENING = 1, ROCKET_STATE_OPEN, ROCKET_STATE_CLOSING, ROCKET_STATE_CLOSED, ROCKET_STATE_FIRING };

enum { GATLING_STATE_NORMAL = 1, GATLING_STATE_REVVING_UP, GATLING_STATE_FIRING };
...
//	Weapon constants
//////////////////////////////////////////////////////////////////////////
enum { ROCKET_RIGHT = 0, ROCKET_LEFT = 1 };

//////////////////////////////////////////////////////////////////////////
//	Taunt constants
//////////////////////////////////////////////////////////////////////////

const char *TAUNT_IDS[6] = {"IDS_SAKURA_BOSS_TAUNT1", "IDS_SAKURA_BOSS_TAUNT2", "IDS_SAKURA_BOSS_TAUNT3",
...
//	Factories
//////////////////////////////////////////////////////////////////////////
SimplePersistFactoryClass<SakuraBossGameObjDef, CHUNKID_GAME_OBJECT_DEF_SAKURA_BOSS>
    _SakuraBossGameObjDefPersistFactory;
SimplePersistFactoryClass<SakuraBossGameObj, CHUNKID_GAME_OBJECT_SAKURA_BOSS> _SakuraBossGameObjPersistFactory;
DECLARE_DEFINITION_FACTORY(SakuraBossGameObjDef, CLASSID_GAME_OBJECT_DEF_SAKURA_BOSS, "Sakura Boss")
_SakuraBossGameObjDefDefFactory;
...
SakuraBossGameObjDef::SakuraBossGameObjDef(void)
    : GattlingGunDefID(0), RocketLauncherDefID(0), GattlingGunRevSoundDefID(0), RocketDestroyedExplosionID(0),
...
//
//////////////////////////////////////////////////////////////////////////
SakuraBossGameObjDef::~SakuraBossGameObjDef(void) { return; }
...
//
//////////////////////////////////////////////////////////////////////////
uint32 SakuraBossGameObjDef::Get_Class_ID(void) const { return CLASSID_GAME_OBJECT_DEF_SAKURA_BOSS; }
...
//
//////////////////////////////////////////////////////////////////////////
PersistClass *SakuraBossGameObjDef::Create(void) const {
...
//
//////////////////////////////////////////////////////////////////////////
bool SakuraBossGameObjDef::Save(ChunkSaveClass &csave) {
...
//
//////////////////////////////////////////////////////////////////////////
bool SakuraBossGameObjDef::Load(ChunkLoadClass &cload) {
...
//
///////////////////////////////////////////////////////////////////////////
void SakuraBossGameObjDef::Save_Variables(ChunkSaveClass &csave) {
...
//
///////////////////////////////////////////////////////////////////////////
void SakuraBossGameObjDef::Load_Variables(ChunkLoadClass &cload) {
...
//
///////////////////////////////////////////////////////////////////////////
const PersistFactoryClass &SakuraBossGameObjDef::Get_Factory(void) const { return _SakuraBossGameObjDefPersistFactory; }
...
SakuraBossGameObj::SakuraBossGameObj(void)
    : GattlingGun(NULL), RockerLauncherLeft(NULL), RockerLauncherRight(NULL), AvailableWeapons(WEAPON_ALL),
      OverallState(STATE_ATTACK_LIFT_AREA), NextOverallState(STATE_ATTACK_LIFT_AREA),
      RocketLauncherState(ROCKET_STATE_CLOSED), GattlingGunState(GATLING_STATE_NORMAL),
      SakuraState(SAKURA_STATE_NORMAL), VehicleState(VEHICLE_STATE_HOVERING), GattlingGunStateTimeLeft(0),
      SakuraTauntTimeLeft(0), CurrentMuzzleIndex(0), RocketLauncherStateTimeLeft(0), OverallStateTimeLeft(10.0F),
      TargetTimeLeft(0), FaceTargetInTransition(false), CurrentHealth(1.0F), TargetAngle(0), IsAttacking(false),
      Path(NULL), ChopperTiltBoneIndex(0), TiltAngle(0), AvailableTaunts(0xFFFFFF) {
  Path = new PathClass;
...
//
///////////////////////////////////////////////////////////////////////////
const PersistFactoryClass &SakuraBossGameObj::Get_Factory(void) const { return _SakuraBossGameObjPersistFactory; }
...
//
////////////////////////////////////////////////////////////////
void SakuraBossGameObj::Init(void) { Init(Get_Definition()); }
...
//
///////////////////////////////////////////////////////////////////////////
void SakuraBossGameObj::Init(const SakuraBossGameObjDef &definition) {
  ...
  const WeaponDefinitionClass *rocket_launcher_def =
      WeaponManager::Find_Weapon_Definition(definition.RocketLauncherDefID);
...
//
///////////////////////////////////////////////////////////////////////////
const SakuraBossGameObjDef &SakuraBossGameObj::Get_Definition(void) const {
...
//
///////////////////////////////////////////////////////////////////////////
bool SakuraBossGameObj::Save(ChunkSaveClass &csave) {
...
//
///////////////////////////////////////////////////////////////////////////
bool SakuraBossGameObj::Load(ChunkLoadClass &cload) {
  while (cload.Open_Chunk()) {
    switch (cload.Cur_Chunk_ID()) {
...
//
///////////////////////////////////////////////////////////////////////////
void SakuraBossGameObj::On_Post_Load(void) {
  ...
  //	Lookup the weapon definitions
  //
  const WeaponDefinitionClass *gatling_gun_def =
      WeaponManager::Find_Weapon_Definition(Get_Definition().GattlingGunDefID);
  const WeaponDefinitionClass *rocket_launcher_def =
      WeaponManager::Find_Weapon_Definition(Get_Definition().RocketLauncherDefID);
...
//
///////////////////////////////////////////////////////////////////////////
void SakuraBossGameObj::Save_Variables(ChunkSaveClass &csave) {
...
//
///////////////////////////////////////////////////////////////////////////
void SakuraBossGameObj::Load_Variables(ChunkLoadClass &cload) {
  while (cload.Open_Micro_Chunk()) {
    switch (cload.Cur_Micro_Chunk_ID()) {
...
//
///////////////////////////////////////////////////////////////////////////
void SakuraBossGameObj::Apply_Control(void) {
...
//
///////////////////////////////////////////////////////////////////////////
void SakuraBossGameObj::Update_Decision_Data(void) {
  //
  ...
  //
  IsAttacking = false;
  if (RocketLauncherState != ROCKET_STATE_CLOSED || GattlingGunState != GATLING_STATE_NORMAL) {
    IsAttacking = true;
  }
...
//
///////////////////////////////////////////////////////////////////////////
void SakuraBossGameObj::Think(void) {
  Pilot.Think();
...
//
///////////////////////////////////////////////////////////////////////////
void SakuraBossGameObj::Request_Overall_State(int new_state) {
  if (OverallState != STATE_IN_TRANSITION && OverallState != new_state) {

    switch (new_state) {
    case STATE_CIRCLE_POWER_PLANT:

      if (OverallState == STATE_CIRCLE_REFINERY || OverallState == STATE_ATTACK_LIFT_AREA) {
        Do_Waypath(WID_REFINERY_TO_PPLANT);
        Set_Overall_State(STATE_IN_TRANSITION);

      } else if (OverallState == STATE_LONG_STRAFING_RUN || OverallState == STATE_LAND_IN_TIBERIUM_FIELD ||
    ...
    case STATE_CIRCLE_REFINERY:
      ...
      if (OverallState == STATE_CIRCLE_POWER_PLANT || OverallState == STATE_LAND_IN_TIBERIUM_FIELD ||
          OverallState == STATE_LONG_STRAFING_RUN2) {
    ...
    case STATE_LAND_IN_TIBERIUM_FIELD:
      ...
      } else if (OverallState == STATE_CIRCLE_POWER_PLANT || OverallState == STATE_LONG_STRAFING_RUN2) {
    ...
    case STATE_VALLEY_STRAFE:
      ...
      if (OverallState == STATE_CIRCLE_REFINERY || OverallState == STATE_CIRCLE_POWER_PLANT ||
    ...
    case STATE_ATTACK_LIFT_AREA:
      ...
      if (OverallState == STATE_CIRCLE_REFINERY || OverallState == STATE_LONG_STRAFING_RUN ||
    ...
    case STATE_LONG_STRAFING_RUN2:
      ...
      } else if (OverallState == STATE_CIRCLE_POWER_PLANT || OverallState == STATE_LAND_IN_TIBERIUM_FIELD ||
                 OverallState == STATE_LONG_STRAFING_RUN) {
...
//
///////////////////////////////////////////////////////////////////////////
void SakuraBossGameObj::Set_Overall_State(int new_state) {
...
//
///////////////////////////////////////////////////////////////////////////
bool SakuraBossGameObj::Should_Change_Overall_State(void) {
...
//
///////////////////////////////////////////////////////////////////////////
void SakuraBossGameObj::Decide_New_Overall_State(void) {
  //
  ...
  if (Should_Change_Overall_State()) {
    ...
    if (CurrentHealth < 0.45F && FreeRandom.Get_Int(4) == 1) {
      ...
      //
      if (TargetPos.X < -104.0F && TargetPos.Y > 69.0F && TargetPos.Y < 85.8F) {
        Request_Overall_State(STATE_ATTACK_LIFT_AREA);

      } else if (OverallState != STATE_CIRCLE_REFINERY && TargetPos.X < -125.0F && TargetPos.Y > -19.0F) {

        Request_Overall_State(STATE_CIRCLE_REFINERY);

      } else if (OverallState != STATE_CIRCLE_POWER_PLANT && TargetPos.X > -84.0F && TargetPos.Z > 11.0F) {

        Request_Overall_State(STATE_CIRCLE_POWER_PLANT);

      } else if (OverallState != STATE_LAND_IN_TIBERIUM_FIELD && TargetPos.Y < 39.0F) {
...
//
///////////////////////////////////////////////////////////////////////////
void SakuraBossGameObj::Update_Overall_State(void) {
  ...
  case STATE_LONG_STRAFING_RUN: {
    ...
    if (CurrentTarget != NULL) {
      ...
      if (TargetAngle > DEG_TO_RADF(-75) && TargetAngle < DEG_TO_RADF(75)) {
        ...
        //
        if (curr_position.Y >= -40.0F && curr_position.Y <= 140.0F && curr_position.X >= -178.0F) {
          should_fire = true;
        }
      }
...
//
///////////////////////////////////////////////////////////////////////////
void SakuraBossGameObj::Update_Tilt(void) {
...
//
///////////////////////////////////////////////////////////////////////////
void SakuraBossGameObj::Attack_Target(float rocket_priority, float gattling_priority) {
  //
  ...
  if (FreeRandom.Get_Int(4) == 2) {
    ...
    //
    if (((AvailableWeapons & WEAPON_ROCKETS_LEFT) == 0) && ((AvailableWeapons & WEAPON_ROCKETS_RIGHT) == 0)) {
...
//
///////////////////////////////////////////////////////////////////////////
void SakuraBossGameObj::Stop_Attacking(void) {
  //
...
//
///////////////////////////////////////////////////////////////////////////
void SakuraBossGameObj::Set_Vehicle_State(int new_state) {
...
//
///////////////////////////////////////////////////////////////////////////
void SakuraBossGameObj::Update_Vehicle_State(void) {
  //
...
//
///////////////////////////////////////////////////////////////////////////
void SakuraBossGameObj::Set_Sakura_State(int new_state) {
...
//
///////////////////////////////////////////////////////////////////////////
void SakuraBossGameObj::Shuffle_Taunt_List(void) {
...
//
///////////////////////////////////////////////////////////////////////////
void SakuraBossGameObj::Update_Sakura_State(void) {
  switch (SakuraState) {
  case SAKURA_STATE_NORMAL:
    break;
...
//
///////////////////////////////////////////////////////////////////////////
void SakuraBossGameObj::Set_Gattling_Gun_State(int new_state) {
...
//
///////////////////////////////////////////////////////////////////////////
void SakuraBossGameObj::Update_Gattling_Gun_State(void) {
...
//
///////////////////////////////////////////////////////////////////////////
void SakuraBossGameObj::Set_Rocket_State(int new_state) {
...
//
///////////////////////////////////////////////////////////////////////////
void SakuraBossGameObj::Update_Rocket_State(void) {
...
//
///////////////////////////////////////////////////////////////////////////
void SakuraBossGameObj::Apply_Damage_Extended(const OffenseObjectClass &damager, float scale, const Vector3 &direction,
...
//
///////////////////////////////////////////////////////////////////////////
void SakuraBossGameObj::Blow_Off_Weapon(int weapon_id) {
  Matrix3D tm(1);
...
//
///////////////////////////////////////////////////////////////////////////
void SakuraBossGameObj::Open_Rocket_Launchers(bool onoff) {
  AnimControlClass *anim_control = Get_Anim_Control();
...
//
///////////////////////////////////////////////////////////////////////////
bool SakuraBossGameObj::Are_Rocker_Launchers_Ready(void) {
  bool retval = false;
...
//
///////////////////////////////////////////////////////////////////////////
void SakuraBossGameObj::Move_To_Location(const Vector3 &pos, float speed) {
  MoveToLocation = pos;
...
//
///////////////////////////////////////////////////////////////////////////
const Matrix3D &SakuraBossGameObj::Get_Muzzle(int /*index*/) {
...
//
///////////////////////////////////////////////////////////////////////////
void SakuraBossGameObj::Update_Target(void) {
  //
...
//
///////////////////////////////////////////////////////////////////////////
SoldierGameObj *SakuraBossGameObj::Find_Closest_Human_Player(void) {
...
//
///////////////////////////////////////////////////////////////////////////
void SakuraBossGameObj::Do_Waypath(int waypath_id, int start_id, int end_id) {
