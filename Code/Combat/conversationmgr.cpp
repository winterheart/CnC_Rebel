...
//
////////////////////////////////////////////////////////////////
ConversationMgrClass::ConversationMgrClass(void) { return; }
...
//
////////////////////////////////////////////////////////////////
void ConversationMgrClass::Reset_Conversations(int category_index, bool reset_start_id) {
...
//
////////////////////////////////////////////////////////////////
void ConversationMgrClass::Reset_All_Other_Conversations(ActiveConversationClass *active_conversation) {
...
//
////////////////////////////////////////////////////////////////
void ConversationMgrClass::Reset_Active_Conversations(void) {
...
//
////////////////////////////////////////////////////////////////
void ConversationMgrClass::Reset(void) {
  //
  //	Release our hold on all the active conversations
  //
  Reset_Active_Conversations();
...
//
////////////////////////////////////////////////////////////////
uint32 ConversationMgrClass::Chunk_ID(void) const { return CHUNKID_CONVERSATION_MGR; }
...
//
////////////////////////////////////////////////////////////////
bool ConversationMgrClass::Save(ChunkSaveClass &csave) {
...
//
////////////////////////////////////////////////////////////////
bool ConversationMgrClass::Load_Conversations(ChunkLoadClass &cload, int category_id) {
...
//
////////////////////////////////////////////////////////////////
bool ConversationMgrClass::Load(ChunkLoadClass &cload) {
...
//
///////////////////////////////////////////////////////////////////////
void ConversationMgrClass::Load_Variables(ChunkLoadClass &cload) {
  //
...
//
////////////////////////////////////////////////////////////////
void ConversationMgrClass::Build_Buddy_List(PhysicalGameObj *orator, DynamicVectorClass<PhysicalGameObj *> &buddy_list,
                                            bool include_orator) {
  //
    ...
    if (phys_observer != NULL) {
      ...
      if (game_obj != NULL) {
        ...
        if (other_orator != NULL && (include_orator || other_orator != orator)) {
          ...
          //
          if (other_orator->Is_In_Conversation() == false && other_orator->Are_Innate_Conversations_Enabled()) {
...
ConversationClass *ConversationMgrClass::Find_Conversation(const char *conversation_name) {
  ...
  for (int cat_index = 0; cat_index < CATEGORY_MAX; cat_index++) {
    ...
    for (int index = 0; index < count; index++) {
      ...
      //	Is this the conversation we were looking for?
      //
      if (curr_conversation != NULL && ::strcmpi(curr_conversation->Get_Name(), conversation_name) == 0) {
        conversation = curr_conversation;
        conversation->Add_Ref();
        break;
      }
...
//
////////////////////////////////////////////////////////////////
ActiveConversationClass *ConversationMgrClass::Start_Conversation(PhysicalGameObj *orator, int conversation_id,
                                                                  bool force) {
...
ActiveConversationClass *ConversationMgrClass::Start_Conversation(PhysicalGameObj *orator,
                                                                  const char *conversation_name, bool force) {
  ActiveConversationClass *active_conversation = NULL;
...
////////////////////////////////////////////////////////////////
ActiveConversationClass *ConversationMgrClass::Start_Conversation(PhysicalGameObj *orator,
                                                                  ConversationClass *conversation, bool force) {
  //
...
//
////////////////////////////////////////////////////////////////
void ConversationMgrClass::Start_Conversation(PhysicalGameObj *orator) {
  //
  //	Build a list of potential participants in the conversation
  //
...
//
////////////////////////////////////////////////////////////////
bool ConversationMgrClass::Test_Conversation(PhysicalGameObj *initiator, ConversationClass *conversation,
                                             DynamicVectorClass<PhysicalGameObj *> &buddy_list, bool force) {
...
//
////////////////////////////////////////////////////////////////
bool ConversationMgrClass::Test_Orator(ConversationClass *conversation, OratorClass *orator,
  ...
  if (orator->Get_Orator_Type() == game_obj->Get_Definition().Get_Orator_Type()) {
    ...
    if (soldier == NULL || soldier->Is_Human_Controlled() || soldier->Get_AI_State() == conversation->Get_AI_State()) {
      retval = true;
    }
  }
...
////////////////////////////////////////////////////////////////
ConversationClass *
ConversationMgrClass::Pick_Conversation(PhysicalGameObj *initiator,
...
//
////////////////////////////////////////////////////////////////
bool ConversationMgrClass::Is_Key_Conversation_Playing(void) {
  bool retval = false;
...
//
////////////////////////////////////////////////////////////////
void ConversationMgrClass::Think(void) {
...
//
////////////////////////////////////////////////////////////////
ActiveConversationClass *ConversationMgrClass::Create_New_Conversation(ConversationClass *conversation) {
  ActiveConversationClass *active_conversation = NULL;
...
//
////////////////////////////////////////////////////////////////
void ConversationMgrClass::Remove_Conversation(ConversationClass *conversation) {
