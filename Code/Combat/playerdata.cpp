...
**
*/
PlayerDataClass::PlayerDataClass(void) : Score(0), Money(0), PunishTimer(0) { Stats_Reset(); }
...
//------------------------------------------------------------------------------------
int PlayerDataClass::Get_Weapon_Fired_Count(void) const { return StatWeaponIDFired.Count(); }
