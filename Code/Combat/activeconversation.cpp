...
//	Constants
////////////////////////////////////////////////////////////////
enum { CHUNKID_VARIABLES = 0x08090727, CHUNKID_ORATOR, CHUNKID_MONITOR };
...
ActiveConversationClass::ActiveConversationClass(void)
    : ID(0), Conversation(NULL), CurrentRemark(-1), NextRemarkTimer(0), State(STATE_INITIALIZING),
      InitializingTimeLeft(60000), ActionID(0), OratorSpokenBitmask(0), CentralPos(0, 0, 0), Priority(30), MaxDist(0),
      IsInterruptable(true), CurrentSound(NULL) {
  return;
}
...
//
////////////////////////////////////////////////////////////////
void ActiveConversationClass::Free_Orator_List(void) {
  //
...
//
////////////////////////////////////////////////////////////////
void ActiveConversationClass::Set_Conversation(ConversationClass *conversation) {
...
//
////////////////////////////////////////////////////////////////
OratorClass *ActiveConversationClass::Add_Orator(PhysicalGameObj *game_obj) {
  //
...
//
////////////////////////////////////////////////////////////////
void ActiveConversationClass::Start_Conversation(void) {
  ...
  for (int orator_index = 0; main_speaker == NULL && orator_index < OratorList.Count(); orator_index++) {
  ...
  if (main_speaker != NULL) {
    ...
    for (int index = 0; index < OratorList.Count(); index++) {
      ...
      if (game_obj != NULL) {
        ...
        //
        if (game_obj->As_SmartGameObj() == NULL || game_obj->As_SmartGameObj()->Is_Human_Controlled() ||
            OratorList.Count() <= 2) {
...
//
////////////////////////////////////////////////////////////////
void ActiveConversationClass::Think(void) {
  //
...
//
////////////////////////////////////////////////////////////////
void ActiveConversationClass::Say_Next_Remark(void) {
  //
...
//
////////////////////////////////////////////////////////////////
bool ActiveConversationClass::Is_Audience_In_Place(void) {
  bool retval = true;
...
//
////////////////////////////////////////////////////////////////
void ActiveConversationClass::Check_For_Audience(void) {
  if (State == STATE_WAITING_FOR_AUDIENCE) {
...
//
////////////////////////////////////////////////////////////////
bool ActiveConversationClass::Save(ChunkSaveClass &csave) {
...
//
////////////////////////////////////////////////////////////////
bool ActiveConversationClass::Load(ChunkLoadClass &cload) {
  Free_Orator_List();
  int monitor_index = 0;
...
//
///////////////////////////////////////////////////////////////////////
void ActiveConversationClass::Load_Variables(ChunkLoadClass &cload) {
...
//
///////////////////////////////////////////////////////////////////////
void ActiveConversationClass::Set_Orator_Arrived(PhysicalGameObj *orator, bool has_arrived) {
...
//
///////////////////////////////////////////////////////////////////////
bool ActiveConversationClass::Get_Orator_Location(PhysicalGameObj *orator, Vector3 *position) {
  WWASSERT(orator != NULL);
...
//
///////////////////////////////////////////////////////////////////////
bool ActiveConversationClass::Get_Current_Orator_Location(Vector3 *position) {
  WWASSERT(position != NULL);
...
//
///////////////////////////////////////////////////////////////////////
PhysicalGameObj *ActiveConversationClass::Get_Current_Orator(void) {
...
//
///////////////////////////////////////////////////////////////////////
void ActiveConversationClass::Get_Conversation_Center(Vector3 *position) {
  WWASSERT(position != NULL);
  (*position) = CentralPos;
  return;
}
...
//
///////////////////////////////////////////////////////////////////////
OratorClass *ActiveConversationClass::Get_Orator_Information(PhysicalGameObj *soldier) {
...
//
///////////////////////////////////////////////////////////////////////
void ActiveConversationClass::Register_Monitor(ScriptableGameObj *game_obj) {
  bool found = false;
  int empty_index = -1;
...
//
///////////////////////////////////////////////////////////////////////
void ActiveConversationClass::Unregister_Monitor(ScriptableGameObj *game_obj) {
  //
...
//
///////////////////////////////////////////////////////////////////////
void ActiveConversationClass::Notify_Monitors_On_End(ActionCompleteReason reason) {
  //
...
//
///////////////////////////////////////////////////////////////////////
void ActiveConversationClass::Notify_Monitors(int custom_event_id, int param) {
  //
  //	Notify all the game objects
  //
  for (int index = 0; index < MAX_MONITORS; index++) {
...
//
///////////////////////////////////////////////////////////////////////
void ActiveConversationClass::Control_Orator(SoldierGameObj *soldier) {
  ...
  if (orator_info->Get_Flag(OratorClass::FLAG_DONT_TURN_HEAD) == false) {
    ...
    if (orator != NULL) {
      ...
      if (is_something_to_look_at &&
          (force_facing || ((orator_info->Get_Flag(OratorClass::FLAG_DONT_FACE) == false) &&
...
//
///////////////////////////////////////////////////////////////////////
void ActiveConversationClass::Stop_Conversation(ActionCompleteReason reason) {
  if (Is_Finished()) {
    return;
  }
...
//
///////////////////////////////////////////////////////////////////////
float ActiveConversationClass::Get_Conversation_Time(void) {
  float retval = 0.0F;
...
//
///////////////////////////////////////////////////////////////////////
void ActiveConversationClass::Stop_Current_Sound(void) {
  //
