...
DECLARE_DEFINITION_FACTORY(PurchaseSettingsDefClass, CLASSID_GLOBAL_SETTINGS_DEF_PURCHASE, "Purchase Settings")
_PurchaseDefDefFactory;
...
//
//////////////////////////////////////////////////////////////////////
PurchaseSettingsDefClass::PurchaseSettingsDefClass(void) : Team(TEAM_GDI), Type(TYPE_CLASSES) {
  //
...
//
  ...
  for (int index = 0; index < MAX_ENTRIES; index++) {
    ...
    for (int alt_index = 0; alt_index < MAX_ALTERNATES; alt_index++) {
      ...
      NAMED_EDITABLE_PARAM(PurchaseSettingsDefClass, ParameterClass::TYPE_STRING,
                           AlternateTextureList[index][alt_index], name);
...
//
///////////////////////////////////////////////////////////////////////////////////////////
uint32 PurchaseSettingsDefClass::Get_Class_ID(void) const { return CLASSID_GLOBAL_SETTINGS_DEF_PURCHASE; }
...
//
///////////////////////////////////////////////////////////////////////////////////////////
const PersistFactoryClass &PurchaseSettingsDefClass::Get_Factory(void) const { return _PurchaseDefPersistFactory; }
...
//
///////////////////////////////////////////////////////////////////////////////////////////
bool PurchaseSettingsDefClass::Save(ChunkSaveClass &csave) {
...
//
///////////////////////////////////////////////////////////////////////////////////////////
bool PurchaseSettingsDefClass::Load(ChunkLoadClass &cload) {
...
//
///////////////////////////////////////////////////////////////////////////////////////////
void PurchaseSettingsDefClass::Load_Variables(ChunkLoadClass &cload) {
  int entry_index = 0;
  int alt_index = 0;
...
//
///////////////////////////////////////////////////////////////////////////////////////////
PurchaseSettingsDefClass *PurchaseSettingsDefClass::Find_Definition(TYPE type, TEAM team) {
