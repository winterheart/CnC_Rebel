...
BeaconGameObjDef::BeaconGameObjDef(void)
    : BroadcastToAllTime(5.0F), ArmTime(10.0F), DisarmTime(10.0F), PreDetonateCinematicDelay(0), DetonateTime(30.0F),
      PostDetonateTime(10.0F), ArmedSoundDefID(0), DisarmingTextID(0), DisarmedTextID(0), ArmingTextID(0),
      ArmingInterruptedTextID(0), DisarmingInterruptedTextID(0), PreDetonateCinematicDefID(0),
      PostDetonateCinematicDefID(0), ExplosionDefID(0), IsNuke(true) {
  //
  //	Editable support
  //
...
//
////////////////////////////////////////////////////////////////
BeaconGameObjDef::~BeaconGameObjDef(void) { return; }
...
//
////////////////////////////////////////////////////////////////
uint32 BeaconGameObjDef::Get_Class_ID(void) const { return CLASSID_GAME_OBJECT_DEF_BEACON; }
...
//
////////////////////////////////////////////////////////////////
PersistClass *BeaconGameObjDef::Create(void) const {
...
//
////////////////////////////////////////////////////////////////
bool BeaconGameObjDef::Save(ChunkSaveClass &csave) {
...
//
////////////////////////////////////////////////////////////////
bool BeaconGameObjDef::Load(ChunkLoadClass &cload) {
...
//
////////////////////////////////////////////////////////////////
void BeaconGameObjDef::Load_Variables(ChunkLoadClass &cload) {
...
//
////////////////////////////////////////////////////////////////
const PersistFactoryClass &BeaconGameObjDef::Get_Factory(void) const { return _BeaconGameObjDefPersistFactory; }
...
BeaconGameObj::BeaconGameObj(void)
    : StateTimer(0), PreDetonateTimer(0), DetonateTimer(0), WarningTimer(0.0f), State(0), IsArmed(false),
      WeaponDefinition(NULL), MessageSound(NULL), ArmedSound(NULL), OwnerBackup(NULL) {
...
//
////////////////////////////////////////////////////////////////
const PersistFactoryClass &BeaconGameObj::Get_Factory(void) const { return _BeaconGameObjPersistFactory; }
...
//
////////////////////////////////////////////////////////////////
void BeaconGameObj::Init(void) { Init(Get_Definition()); }
...
//
////////////////////////////////////////////////////////////////
void BeaconGameObj::Init(const BeaconGameObjDef &definition) {
...
//
////////////////////////////////////////////////////////////////
void BeaconGameObj::Init_Beacon(const WeaponDefinitionClass *definition, SoldierGameObj *owner,
...
//
////////////////////////////////////////////////////////////////
bool BeaconGameObj::Save(ChunkSaveClass &csave) {
...
//
////////////////////////////////////////////////////////////////
bool BeaconGameObj::Load(ChunkLoadClass &cload) {
  while (cload.Open_Chunk()) {
    switch (cload.Cur_Chunk_ID()) {
...
//
////////////////////////////////////////////////////////////////
void BeaconGameObj::Load_Variables(ChunkLoadClass &cload) {
  while (cload.Open_Micro_Chunk()) {
...
//
////////////////////////////////////////////////////////////////
void BeaconGameObj::Get_Information(StringClass &string) {
...
//
////////////////////////////////////////////////////////////////
void BeaconGameObj::Start_Cinematic(int id) {
  //
...
//
////////////////////////////////////////////////////////////////
void BeaconGameObj::Update_State(void) {
...
//
////////////////////////////////////////////////////////////////
BaseControllerClass *BeaconGameObj::Get_Enemy_Base(void) {
  //
...
//
////////////////////////////////////////////////////////////////
bool BeaconGameObj::Is_In_Enemy_Base(void) {
  bool retval = false;
...
//
////////////////////////////////////////////////////////////////
void BeaconGameObj::Display_Message(int text_id) {
  Stop_Current_Message_Sound();
...
//
////////////////////////////////////////////////////////////////
void BeaconGameObj::Begin_Arming(void) {
  //
  //	Switch states
  //
...
//
////////////////////////////////////////////////////////////////
void BeaconGameObj::Start_Owner_Animation(void) {
  Restore_Owner();
...
//
////////////////////////////////////////////////////////////////
void BeaconGameObj::Stop_Owner_Animation(void) {
  Restore_Owner();
...
//
////////////////////////////////////////////////////////////////
bool BeaconGameObj::Was_Owner_Interrupted(void) {
  Restore_Owner();
  ...
  if (soldier == NULL || soldier->Is_Dead()) {
    ...
    //
    if (retval == false) {
      for (int index = ControlClass::BOOLEAN_ONE_TIME_FIRST; index <= ControlClass::BOOLEAN_DROP_FLAG; index++) {
        //
        //	Check this input to see if the soldier is moving
        //
...
//
////////////////////////////////////////////////////////////////
void BeaconGameObj::Completely_Damaged(const OffenseObjectClass &damager) {
...
//
////////////////////////////////////////////////////////////////
void BeaconGameObj::Create_Explosion(void) {
  if (CombatManager::I_Am_Server()) {
    Restore_Owner();
  }
  ...
  if (Get_Owner() != NULL) {
    ...
    if (CombatManager::I_Am_Server()) {
      ...
      ExplosionDefinitionClass *explosion_def =
          (ExplosionDefinitionClass *)DefinitionMgrClass::Find_Definition(Get_Definition().ExplosionDefID);
      if (explosion_def != NULL) {
        ...
        for (obj_node = GameObjManager::Get_Building_Game_Obj_List()->Head(); obj_node != NULL;
