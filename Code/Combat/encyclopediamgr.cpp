...
//	Local constants
////////////////////////////////////////////////////////////////
enum { CHUNKID_VARIABLES = 0x09221214, CHUNKID_TYPE_DATA };
...
//
//////////////////////////////////////////////////////////////////////
void EncyclopediaMgrClass::Shutdown(void) {
  //
...
//
//////////////////////////////////////////////////////////////////////
bool EncyclopediaMgrClass::Reveal_Object(TYPE type, int object_id) {
  bool retval = false;
...
//
//////////////////////////////////////////////////////////////////////
bool EncyclopediaMgrClass::Is_Object_Revealed(TYPE type, int object_id) {
  bool retval = false;
...
//
//////////////////////////////////////////////////////////////////////
void EncyclopediaMgrClass::Reveal_All_Objects(void) {
  //
...
//
//////////////////////////////////////////////////////////////////////
void EncyclopediaMgrClass::Hide_All_Objects(void) {
  //
...
//
////////////////////////////////////////////////////////////////
void EncyclopediaMgrClass::Load_Variables(ChunkLoadClass &cload) {
...
//
////////////////////////////////////////////////////////////////
bool EncyclopediaMgrClass::Reveal_Object(DamageableGameObj *game_obj) {
  if (game_obj == NULL) {
    return false;
  }
...
//
////////////////////////////////////////////////////////////////
void EncyclopediaMgrClass::Display_Event_UI(void) {
  //
...
//
////////////////////////////////////////////////////////////////
void EncyclopediaMgrClass::Store_Data(void) {
  for (int index = 0; index < TYPE_COUNT; index++) {
...
//
////////////////////////////////////////////////////////////////
void EncyclopediaMgrClass::Restore_Data(void) {
  for (int index = 0; index < TYPE_COUNT; index++) {
