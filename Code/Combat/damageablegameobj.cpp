...
DamageableGameObjDef::DamageableGameObjDef(void)
    : TranslatedNameID(0), EncyclopediaType(EncyclopediaMgrClass::TYPE_UNKNOWN), EncyclopediaID(0),
      NotTargetable(false), DefaultPlayerType(PLAYERTYPE_NEUTRAL) {
...
** DamageableGameObj
*/
DamageableGameObj::DamageableGameObj(void) : IsHealthBarDisplayed(true) { Set_Player_Type(PLAYERTYPE_NEUTRAL); }

DamageableGameObj::~DamageableGameObj(void) { Remove_All_Observers(); }
...
//-----------------------------------------------------------------------------
bool DamageableGameObj::Is_Team_Player(void) { return PlayerType == PLAYERTYPE_NOD || PlayerType == PLAYERTYPE_GDI; }

//-----------------------------------------------------------------------------
Vector3 DamageableGameObj::Get_Team_Color(void) { return Get_Color_For_Team(PlayerType); }
