...
protected:
  ...
  enum { ENGORGED_STATE_NONE = 0, ENGORGED_STATE_ABSORBING_TIBERIUM, ENGORGED_STATE_FADING };

  enum { JUMP_STATE_NONE = 0, JUMP_STATE_CROUCHING, JUMP_STATE_JUMPING, JUMP_STATE_LANDING };

  enum { HAVOC_STATE_NONE = 0, HAVOC_STATE_GRABBED, HAVOC_STATE_FLYING };

  enum { STEALTH_SOLDIER_STATE_NONE = 0, STEALTH_SOLDIER_STATE_DISPLAY, STEALTH_SOLDIER_STATE_FLYING };

  enum { THROWN_OBJECT_STATE_NONE = 0, THROWN_OBJECT_STATE_PICKUP, THROWN_OBJECT_STATE_FLYING };
...
private:
  ...
  enum { ARC_OBJ_COUNT = 10, BONE_COUNT = 6 };
...
///////////////////////////////////////////////////////////////////
WWINLINE SoldierGameObj *RaveshawBossGameObjClass::Peek_Stealth_Soldier(void) {
