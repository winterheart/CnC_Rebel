...
bool SaveGameManager::Smart_Peek_Description(const char *filename, WideStringClass &description,
...
bool SaveGameManager::Peek_Description(const char *filename, WideStringClass &description,
                                       WideStringClass &mission_name) {
  //
