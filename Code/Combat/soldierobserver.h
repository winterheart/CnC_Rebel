...
public:
  ...
  void Set_Home_Location(const Vector3 &location, float radius) {
...
private:
  ...
  */
  ...
  void Action_Face_Location(SoldierGameObj *soldier, const Vector3 &location, SoldierAIState ai_state,
                            bool crouched = false);
  void Action_Goto_Location(SoldierGameObj *soldier, const Vector3 &location, SoldierAIState ai_state,
                            float speed = 1.0f, float distance = 1.0f, bool crouched = false);
  void Action_Goto_Location_Facing(SoldierGameObj *soldier, const Vector3 &location, SoldierAIState ai_state,
                                   const Vector3 &facing_pos, float speed = 1.0f, float distance = 1.0f,
                                   bool crouched = false);
  void Action_Attack_Object(SoldierGameObj *soldier, PhysicalGameObj *enemy, float range, bool kneel,
                            const Vector3 &move_location, float arrived_distance);
