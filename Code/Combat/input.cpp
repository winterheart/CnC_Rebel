...
float Input::Get_Mouse_Sensitivity(void) { return MouseSensitivity; }
...
bool Input::Get_Mouse_Invert(void) { return MouseInvert; }
...
bool Input::Get_Mouse_2D_Invert(void) { return Mouse2DInvert; }
  ...
  if (MenuMode == false || ConsoleMode) {
    ...
    for (int index = 0; index < INPUT_FUNCTION_COUNT; index++) {
      ...
      if (value1 == 0.0F && value2 == 0.0F) {
        if (FunctionPrimaryKeys[index] == DIK_RETURN || FunctionSecondaryKeys[index] == DIK_RETURN) {
    ...
    //
    FunctionValue[INPUT_FUNCTION_VEHICLE_TURN_LEFT] =
        max(FunctionValue[INPUT_FUNCTION_MOVE_LEFT], FunctionValue[INPUT_FUNCTION_TURN_LEFT]);
    FunctionValue[INPUT_FUNCTION_VEHICLE_TURN_RIGHT] =
        max(FunctionValue[INPUT_FUNCTION_MOVE_RIGHT], FunctionValue[INPUT_FUNCTION_TURN_RIGHT]);
...
// Ignore the clamp
    ...
    if ((input & 0xFF) >= DIK_1 && (input & 0xFF) <= DIK_0) {
      ...
      //			modifier |= ((DirectInput::Get_Button_Value(DIK_SHIFT) & BUTTON_BIT_HELD) ? BUTTON_SHIFT
      //: 0);
...
**
*/
int Input::Get_Primary_Key_For_Function(int function_id) { return FunctionPrimaryKeys[function_id]; }

/*
**
*/
int Input::Get_Secondary_Key_For_Function(int function_id) { return FunctionSecondaryKeys[function_id]; }

/*
**
*/
void Input::Set_Primary_Key_For_Function(int function_id, int key_id) {
...
**
*/
void Input::Set_Secondary_Key_For_Function(int function_id, int key_id) {
...
**
*/
void Input::Save_Configuration(const char *filename) {
  INIClass input_ini;
...
**
*/
void Input::Load_Accelerated_Keys(INIClass *input_ini) {
...
**
*/
void Input::Save_Accelerated_Keys(INIClass *input_ini) {
  for (int index = 0; index < AcceleratedKeyList.Count(); index++) {
    AcceleratedKeyDef &def = AcceleratedKeyList[index];
...
//
////////////////////////////////////////////////////////////////
void Input::Get_Translated_Key_Name(int dik_id, WideStringClass &name) {
...
**
*/
void Input::Load_Misc_Settings(INIClass *input_ini) {
...
**
*/
void Input::Save_Misc_Settings(INIClass *input_ini) {
...
**
*/
int Input::Find_First_Function_By_Primary_Key(int key_id) { return Find_Next_Function_By_Primary_Key(-1, key_id); }

/*
**
*/
int Input::Find_Next_Function_By_Primary_Key(int function_id, int key_id) {
  int retval = -1;
...
**
*/
int Input::Find_First_Function_By_Secondary_Key(int key_id) { return Find_Next_Function_By_Secondary_Key(-1, key_id); }

/*
**
*/
int Input::Find_Next_Function_By_Secondary_Key(int function_id, int key_id) {
  int retval = -1;
