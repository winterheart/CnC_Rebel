...
**
************************************************************************************************/
SimplePersistFactoryClass<DamageableStaticPhysDefClass, PHYSICS_CHUNKID_DAMAGEABLESTATICPHYSDEF>
    _DamageableStaticPhysDefPersistFactory;

DECLARE_DEFINITION_FACTORY(DamageableStaticPhysDefClass, CLASSID_DAMAGEABLESTATICPHYSDEF, "DamageableStaticPhys")
_DamageableStaticPhysDefDefFactory;

DamageableStaticPhysDefClass::DamageableStaticPhysDefClass(void)
    : StaticAnimPhysDefClass(), KilledExplosion(0), LiveLoopStart(0), LiveLoopEnd(0), LiveTwitchStart(0),
      LiveTwitchEnd(0), DeathTransitionStart(0), DeathTransitionEnd(0), DeadLoopStart(0), DeadLoopEnd(0),
      DeadTwitchStart(0), DeadTwitchEnd(0), PlayTwitchesToCompletion(false) {
...
uint32 DamageableStaticPhysDefClass::Get_Class_ID(void) const { return CLASSID_DAMAGEABLESTATICPHYSDEF; }
...
**
************************************************************************************************/
SimplePersistFactoryClass<DamageableStaticPhysClass, PHYSICS_CHUNKID_DAMAGEABLESTATICPHYS>
    _DamageableStaticPhysPersistFactory;

const PersistFactoryClass &DamageableStaticPhysClass::Get_Factory(void) const {
  return _DamageableStaticPhysPersistFactory;
}

DamageableStaticPhysClass::DamageableStaticPhysClass(void) : CurState(STATE_LIVE_LOOP) {}
