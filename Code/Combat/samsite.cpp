...
SAMSiteGameObjDef::SAMSiteGameObjDef(void) { MODEL_DEF_PARAM(SAMSiteGameObjDef, PhysDefID, "DecorationPhysDef"); }

uint32 SAMSiteGameObjDef::Get_Class_ID(void) const { return CLASSID_GAME_OBJECT_DEF_SAMSITE; }
...
const PersistFactoryClass &SAMSiteGameObjDef::Get_Factory(void) const { return _SAMSiteGameObjDefPersistFactory; }
...
const PersistFactoryClass &SAMSiteGameObj::Get_Factory(void) const { return _SAMSiteGameObjPersistFactory; }
...
** SAMSiteGameObject
*/
SAMSiteGameObj::SAMSiteGameObj() : TurretBone(-1), BarrelBone(-1), State(SAMSITE_STATE_DOWN) {}
...
**
*/
void SAMSiteGameObj::Init(void) { Init(Get_Definition()); }

void SAMSiteGameObj::Init(const SAMSiteGameObjDef &definition) { SmartGameObj::Init(definition); }
...
void SAMSiteGameObj::Export_Frequent(BitStreamClass &packet) { SmartGameObj::Export_Frequent(packet); }
