...
HarvesterClass::HarvesterClass(void)
    : Refinery(NULL), DockLocation(0, 0, 0), DockEntrance(0, 0, 0), StateTimer(0), State(STATE_UNINITIALIZED),
      Vehicle(NULL), IsHarvesting(false) {
...
//
////////////////////////////////////////////////////////////////
HarvesterClass::~HarvesterClass(void) { return; }
...
//
////////////////////////////////////////////////////////////////
void HarvesterClass::Initialize(void) {
  Go_Harvest();
  return;
}
...
//
////////////////////////////////////////////////////////////////
void HarvesterClass::Go_Harvest(void) {
  //
...
//
////////////////////////////////////////////////////////////////
void HarvesterClass::Go_Unload_Tiberium(void) {
...
//
////////////////////////////////////////////////////////////////
void HarvesterClass::Unload_Tiberium(void) {
...
//
////////////////////////////////////////////////////////////////
void HarvesterClass::Harvest_Tiberium(void) {
  //
...
//
////////////////////////////////////////////////////////////////
void HarvesterClass::Action_Complete(GameObject *game_obj, int action_id, ActionCompleteReason complete_reason) {
  //
...
//
////////////////////////////////////////////////////////////////
void HarvesterClass::Animation_Complete(GameObject *game_obj, const char *animation_name) { return; }
...
//
////////////////////////////////////////////////////////////////
void HarvesterClass::Detach(GameObject * /*game_obj*/) {
  //
...
//
////////////////////////////////////////////////////////////////
void HarvesterClass::Think(void) {
  if (IsHarvesting) {
...
//
////////////////////////////////////////////////////////////////
void HarvesterClass::Play_Harvest_Animation(bool onoff) {
  if (onoff) {
...
//
////////////////////////////////////////////////////////////////
void HarvesterClass::Custom(GameObject *game_obj, int type, int param, GameObject *sender) {
  //
