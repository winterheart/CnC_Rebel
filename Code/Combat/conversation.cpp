...
//	Constants
////////////////////////////////////////////////////////////////
enum { CHUNKID_BASE_CLASS = 0x08090315, CHUNKID_VARIABLES, CHUNKID_ORATOR, CHUNKID_REMARK };
...
ConversationClass::ConversationClass(void)
    : ID(0), IsInnate(true), IsKey(false), Probability(1.0F), AIState(AI_STATE_IDLE), CategoryID(0), LookAtObjID(0),
      Priority(30), MaxDist(0), IsInterruptable(true) {
  return;
}
...
//
////////////////////////////////////////////////////////////////
const ConversationClass &ConversationClass::operator=(const ConversationClass &src) {
  //
  //	Start fresh
  //
  Clear_Remarks();
...
//
////////////////////////////////////////////////////////////////
void ConversationClass::Clear_Orators(void) {
...
//
////////////////////////////////////////////////////////////////
void ConversationClass::Clear_Remarks(void) {
...
//
////////////////////////////////////////////////////////////////
int ConversationClass::Get_Orator_Count(void) const { return OratorList.Count(); }
...
//
////////////////////////////////////////////////////////////////
void ConversationClass::Add_Orator(const OratorClass &orator) {
...
//
////////////////////////////////////////////////////////////////
void ConversationClass::Add_Remark(const ConversationRemarkClass &remark) {
...
//
////////////////////////////////////////////////////////////////
bool ConversationClass::Get_Remark_Info(int index, ConversationRemarkClass &remark) {
  bool retval = false;
...
//
////////////////////////////////////////////////////////////////
bool ConversationClass::Save(ChunkSaveClass &csave) {
...
//
////////////////////////////////////////////////////////////////
bool ConversationClass::Load(ChunkLoadClass &cload) {
