...
MessageWindowClass::MessageWindowClass(void)
    : TextWindow(NULL), DecayTime(6000), Scene(NULL), Camera(NULL), HeadModel(NULL), IsRectangleDirty(true) {
...
//
////////////////////////////////////////////////////////////////
void MessageWindowClass::Initialize(void) {
  ...
  TextWindow->Set_Backdrop("hud_6x4_Messages.tga", CurrentRect, settings->Get_Messages_Texture_Size(),
                           settings->Get_Messages_Endcap_Rect(), settings->Get_Messages_Fadeout_Rect(),
                           settings->Get_Messages_Background_Rect());
...
//
////////////////////////////////////////////////////////////////
void MessageWindowClass::Render(void) {
  WWMEMLOG(MEM_GAMEDATA);
...
//
////////////////////////////////////////////////////////////////
void MessageWindowClass::Add_Message(const WideStringClass &message, const Vector3 &color, SmartGameObj *game_obj,
                                     float decay_time) {
  WWMEMLOG(MEM_GAMEDATA);
  if (TextWindow == NULL) {
    return;
...
//
////////////////////////////////////////////////////////////////
void MessageWindowClass::Update_Window_Rectangle(void) {
  //
...
//
////////////////////////////////////////////////////////////////
bool MessageWindowClass::Has_Data(void) const { return (TextWindow != NULL && TextWindow->Get_Item_Count() > 0); }
...
//
////////////////////////////////////////////////////////////////
void MessageWindowClass::Reset_Current_Rect(void) {
  EvaSettingsDefClass *settings = EvaSettingsDefClass::Get_Instance();
