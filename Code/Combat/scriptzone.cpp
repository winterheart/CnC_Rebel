...
static const char *ZONE_TYPE_NAMES[TYPE_COUNT] = {
    "Default",        "Capture The Flag", "Vehicle Construction", "Vehicle Repair",
    "Tiberium Field", "Beacon",           "GDI Tiberium Field",   "NOD Tiberium Field",
};

/*
** Editable and Save/Load system stuff
*/
SimplePersistFactoryClass<ScriptZoneGameObjDef, CHUNKID_GAME_OBJECT_DEF_SCRIPT_ZONE>
    _ScriptZoneGameObjDefPersistFactory;

DECLARE_DEFINITION_FACTORY(ScriptZoneGameObjDef, CLASSID_GAME_OBJECT_DEF_SCRIPT_ZONE, "Script Zone")
_ScriptZoneGameObjDefDefFactory;

ScriptZoneGameObjDef::ScriptZoneGameObjDef(void)
    : Color(0, 0.7F, 0), CheckStarsOnly(true), ZoneType(TYPE_DEFAULT), IsEnvironmentZone(false) {
...
uint32 ScriptZoneGameObjDef::Get_Class_ID(void) const { return CLASSID_GAME_OBJECT_DEF_SCRIPT_ZONE; }
...
const PersistFactoryClass &ScriptZoneGameObjDef::Get_Factory(void) const { return _ScriptZoneGameObjDefPersistFactory; }
...
ScriptZoneGameObj::ScriptZoneGameObj(void) : PlayerType(PLAYERTYPE_NEUTRAL) {}
...
const PersistFactoryClass &ScriptZoneGameObj::Get_Factory(void) const { return _ScriptZoneGameObjPersistFactory; }

/*
**
*/
void ScriptZoneGameObj::Init(void) { Init(Get_Definition()); }

void ScriptZoneGameObj::Init(const ScriptZoneGameObjDef &definition) { ScriptableGameObj::Init(definition); }
