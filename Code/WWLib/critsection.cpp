...
CriticalSectionClass::CriticalSectionClass() : inside(false) {
#ifndef _UNIX
...
CriticalSectionClass::LockClass::LockClass(CriticalSectionClass &c) : crit(c) { crit.Enter(); }

CriticalSectionClass::LockClass::~LockClass() { crit.Exit(); }