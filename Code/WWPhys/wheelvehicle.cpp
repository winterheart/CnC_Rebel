...
WheeledVehicleClass::WheeledVehicleClass(void) : SteeringAngle(0) {}

void WheeledVehicleClass::Init(const WheeledVehicleDefClass &def) { MotorVehicleClass::Init(def); }

WheeledVehicleClass::~WheeledVehicleClass(void) {}

SuspensionElementClass *WheeledVehicleClass::Alloc_Suspension_Element(void) { return new WVWheelClass; }
...
** Save-Load System
*/
const PersistFactoryClass &WheeledVehicleClass::Get_Factory(void) const { return _WheeledVehicleFactory; }
...
DECLARE_DEFINITION_FACTORY(WheeledVehicleDefClass, CLASSID_WHEELEDVEHICLEDEF, "WheeledVehicle")
_WheeledVehicleDefDefFactory;
...
WheeledVehicleDefClass::WheeledVehicleDefClass(void) : MaxSteeringAngle(DEFAULT_MAX_STEER_ANGLE) {
  // make our parameters editable!
  ANGLE_EDITABLE_PARAM(WheeledVehicleDefClass, MaxSteeringAngle, DEG_TO_RADF(0.0f), DEG_TO_RADF(90.0f));
}

uint32 WheeledVehicleDefClass::Get_Class_ID(void) const { return CLASSID_WHEELEDVEHICLEDEF; }

const PersistFactoryClass &WheeledVehicleDefClass::Get_Factory(void) const { return _WheeledVehicleDefFactory; }
