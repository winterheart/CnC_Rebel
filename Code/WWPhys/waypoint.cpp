...
enum { CHUNKID_VARIABLES = 0x04290112, CHUNKID_BASE_CLASS };

enum { VARID_OLD_PTR = 0x01, VARID_FLAGS, VARID_POSITION, VARID_ID, VARID_ACTION_ID };
...
//
////////////////////////////////////////////////////////////////
WaypointClass::WaypointClass(void) : m_ID(0), m_Position(0, 0, 0), m_Flags(0), m_ActionPortalID(-1) { return; }
...
WaypointClass::WaypointClass(const WaypointClass &src)
    : m_ID(0), m_Position(0, 0, 0), m_Flags(0), m_ActionPortalID(-1) {
  (*this) = src;
  return;
}
...
WaypointClass::WaypointClass(const Vector3 &position)
    : m_ID(0), m_Position(position), m_Flags(0), m_ActionPortalID(-1) {
  return;
}
...
//
////////////////////////////////////////////////////////////////
const PersistFactoryClass &WaypointClass::Get_Factory(void) const { return _WaypointPersistFactory; }
...
//
/////////////////////////////////////////////////////////////////
bool WaypointClass::Save(ChunkSaveClass &csave) {
...
//
/////////////////////////////////////////////////////////////////
bool WaypointClass::Load(ChunkLoadClass &cload) {
...
//
///////////////////////////////////////////////////////////////////////
bool WaypointClass::Load_Variables(ChunkLoadClass &cload) {
  //
...
//
///////////////////////////////////////////////////////////////////////
const WaypointClass &WaypointClass::operator=(const WaypointClass &src) {
  //
...
//
///////////////////////////////////////////////////////////////////////
PathfindActionPortalClass *WaypointClass::Get_Action_Portal(void) {
  //
...
//
///////////////////////////////////////////////////////////////////////
void WaypointClass::Set_Action_Portal(PathfindActionPortalClass *portal) {
  if (portal != NULL) {
