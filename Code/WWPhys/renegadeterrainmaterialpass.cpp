...
RenegadeTerrainMaterialPassClass::RenegadeTerrainMaterialPassClass(void)
    : VertexAlpha(NULL), GridUVs(NULL), Material(NULL), VertexCount(0) {
...
//
////////////////////////////////////////////////////////////////
void RenegadeTerrainMaterialPassClass::Allocate(int vertex_count) {
  //
...
//
////////////////////////////////////////////////////////////////
void RenegadeTerrainMaterialPassClass::Reset(void) {
  //
  //	Allocate the vertex index map
  //
  for (int index = 0; index < PASS_COUNT; index++) {
...
//
//////////////////////////////////////////////////////////////////////
bool RenegadeTerrainMaterialPassClass::Save(ChunkSaveClass &csave) {
  //
  //	Write the variables
  //
...
//
//////////////////////////////////////////////////////////////////////
bool RenegadeTerrainMaterialPassClass::Load(ChunkLoadClass &cload) {
  int pass = -1;
...
//
////////////////////////////////////////////////////////////////
void RenegadeTerrainMaterialPassClass::Load_Variables(ChunkLoadClass &cload) {
  int vertex_count = 0;
