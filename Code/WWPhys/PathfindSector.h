...
public:
  ...
  ////////////////////////////////////////////////////////////////////
  PathfindSectorClass(void) : m_IsValid(true) {}

  PathfindSectorClass(const AABoxClass &box) : m_IsValid(true) {}
...
inline const AABoxClass &PathfindSectorClass::Get_Bounding_Box(void) const { return Get_Cull_Box(); }

inline void PathfindSectorClass::Set_Bounding_Box(const AABoxClass &box) {
  Set_Cull_Box(box);
  return;
}

inline void PathfindSectorClass::Add_Portal(uint32 portal_id) {
  m_PortalList.Add(portal_id);
  return;
}

inline int PathfindSectorClass::Get_Portal_Count(void) { return m_PortalList.Count(); }

inline bool PathfindSectorClass::Can_Access_Portal(PathfindPortalClass *last_portal, PathfindPortalClass *test_portal) {
...
public:
  ...
  //	Public constructors/destructors
  ////////////////////////////////////////////////////////////////////
  PathfindWaypathSectorClass(void) : WaypathID(-1) {}
