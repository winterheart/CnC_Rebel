...
void Add_New_Portal_To_List(DynamicVectorClass<PathfindWaypathPortalClass *> &portal_list,
                            PathfindSectorClass *dest_sector1, PathfindSectorClass *dest_sector2, int waypath_id,
                            int waypoint_index, const Vector3 &portal_pos, float percent);
...
PathfindClass::PathfindClass(void)
    : m_SectorsDisplayed(false), m_PortalsDisplayed(false), m_Plotter(NULL), m_SectorList(1000), // 1000's of these
...
//
///////////////////////////////////////////////////////////////////////////
void PathfindClass::Add_Sector(PathfindSectorClass *sector, bool add_to_tree) {
...
//
///////////////////////////////////////////////////////////////////////////
int PathfindClass::Add_Portal(PathfindPortalClass *portal) {
  //
...
//
///////////////////////////////////////////////////////////////////////////
int PathfindClass::Add_Waypath_Portal(PathfindWaypathPortalClass *portal) {
  //
  //	Add this portal to the housekeeping list
  //
  portal->Add_Ref();
...
//
///////////////////////////////////////////////////////////////////////////
int PathfindClass::Add_Temporary_Portal(PathfindSectorClass *sector_from, PathfindSectorClass *sector_to,
                                        const Vector3 &start_pos, const Vector3 &dest_pos) {
  int retval = 0;
...
//
///////////////////////////////////////////////////////////////////////////
bool PathfindClass::Save(ChunkSaveClass &csave) {
...
//
///////////////////////////////////////////////////////////////////////////
bool PathfindClass::Save_Portals(ChunkSaveClass &csave) {
  bool retval = true;
...
//
///////////////////////////////////////////////////////////////////////////
bool PathfindClass::Load(ChunkLoadClass &cload) {
  WWMEMLOG(MEM_PATHFIND);
  ...
  //
  if (cload.Open_Chunk() != true || cload.Cur_Chunk_ID() != CHUNKID_DATABASE) {
    retval = false;
  }
...
//
///////////////////////////////////////////////////////////////////////////
bool PathfindClass::Save_Sector(ChunkSaveClass &csave, PathfindSectorClass *sector) {
  bool retval = true;
...
//
///////////////////////////////////////////////////////////////////////////
bool PathfindClass::Load_Sector(ChunkLoadClass &cload) {
  bool retval = true;
...
//
///////////////////////////////////////////////////////////////////////////
bool PathfindClass::Load_Portal(ChunkLoadClass &cload, PathfindPortalClass *portal) {
  //
...
//
///////////////////////////////////////////////////////////////////////////
int PathfindClass::Get_Sector_Index(PathfindSectorClass *sector) {
...
//
///////////////////////////////////////////////////////////////////////////
void PathfindClass::Collect_Sectors(DynamicVectorClass<PathfindSectorClass *> &list, const AABoxClass &box,
  ...
  //
  PathfindSectorClass *sector = NULL;
  for (sector = m_SectorTree.Get_First_Collected_Object(); sector != NULL;
...
//
///////////////////////////////////////////////////////////////////////////
PathfindSectorClass *PathfindClass::Find_Sector(const Vector3 &position, float sector_fudge,
                                                PathfindSectorClass *exclude_sector) {
  //
...
//
///////////////////////////////////////////////////////////////////////////
void PathfindClass::Reset_Sectors(void) {
...
//
///////////////////////////////////////////////////////////////////////////
void PathfindClass::Reset_Portals(void) {
  Display_Portals(false);
...
//
///////////////////////////////////////////////////////////////////////////
void PathfindClass::Display_Sectors(bool onoff) {
  //
  //	Start fresh
  //
...
//
///////////////////////////////////////////////////////////////////////////
void PathfindClass::Display_Portals(bool onoff) {
  //
  //	Start fresh
  //
...
//
///////////////////////////////////////////////////////////////////////////
void PathfindClass::Add_Waypath(WaypathClass *waypath) {
  if (waypath != NULL) {
    waypath->Add_Ref();
...
//
///////////////////////////////////////////////////////////////////////////
bool PathfindClass::Remove_Waypath(WaypathClass *waypath) {
  bool retval = false;
...
//
///////////////////////////////////////////////////////////////////////////
WaypathClass *PathfindClass::Find_Waypath(int id) const {
...
//
///////////////////////////////////////////////////////////////////////////
void PathfindClass::Reset_Waypaths(void) {
  //
...
//
//////////////////////////////////////////////////////////////////////////////////
bool PathfindClass::Save_Waypaths(ChunkSaveClass &csave) {
  //
...
//
//////////////////////////////////////////////////////////////////////////////////
bool PathfindClass::Save_Culling_System(ChunkSaveClass &csave) {
  bool retval = true;
...
//
//////////////////////////////////////////////////////////////////////////////////
bool PathfindClass::Load_Culling_System(ChunkLoadClass &cload) {
  bool retval = true;
...
//
//////////////////////////////////////////////////////////////////////////////////
void PathfindClass::Re_Partition_Sector_Tree(void) {
...
//
/////////////////////////////////////////////////////////////////////////
PathfindPortalClass *PathfindClass::Peek_Portal(int portal_index) {
...
//
//////////////////////////////////////////////////////////////////////////////////
float PathfindClass::Get_Height_Value(const Vector3 &pos) { return HeightDBClass::Get_Height(pos); }
...
bool PathfindClass::Find_Random_Spot(const Vector3 &center, float max_dist, Vector3 *dest) {
  bool retval = false;
...
//
//////////////////////////////////////////////////////////////////////////////////
void PathfindClass::Free_Waypath_Sectors_And_Portals(void) {
  //
  //	Release our hold on each of the waypath portals
  //
  for (int index = 0; index < m_WaypathPortalList.Count(); index++) {
...
//
//////////////////////////////////////////////////////////////////////////////////
void PathfindClass::Generate_Waypath_Sectors_And_Portals(void) {
  //
  //	Start fresh
  //
  Free_Waypath_Sectors_And_Portals();
...
//
//////////////////////////////////////////////////////////////////////////////////
void PathfindClass::Generate_Waypath_Sector_And_Portals(WaypathClass *waypath) {
  ...
  for (int index = 0; index < waypoint_count; index++) {
    ...
    if (sector_at_pos != NULL) {
      ...
      //
      ::Add_New_Portal_To_List(portal_list, new_sector, sector_at_pos, waypath_id, index, waypoint_pos, 0);
    }
  }
  ...
  if (portal_list.Count() > 0) {
    ...
    //
    ::qsort(&portal_list[0], portal_list.Count(), sizeof(PathfindWaypathPortalClass *),
...
//
//////////////////////////////////////////////////////////////////////////////////
void PathfindClass::Add_Intersection_Portals_To_List(DynamicVectorClass<PathfindWaypathPortalClass *> &portal_list,
  ...
  for (int waypoint_index = 0; waypoint_index < waypoint_count - 1; waypoint_index++) {
    ...
    //
    PathfindSectorClass *sector = NULL;
    for (sector = m_SectorTree.Peek_First_Collected_Object(); sector != NULL;
      ...
      if (::Find_Intersection_Point(sector_box, pos1, pos2, &percent, &portal_pos)) {
        ...
        //	Add a new portal to the list at this position
        //
        ::Add_New_Portal_To_List(portal_list, dest_sector, sector, waypath_id, waypoint_index, portal_pos, percent);
      }
    }
  }
...
//
//////////////////////////////////////////////////////////////////////////////////
void PathfindClass::Find_Portals(const Vector3 &p0, const Vector3 &p1, DynamicVectorClass<PathfindPortalClass *> &list,
  ...
  for (int index = 0; index < m_PortalList.Count(); index++) {
    ...
    if (action_portals_only == false ||
        (action_portal != NULL && portal->Get_Action_Type() != PathClass::ACTION_NONE)) {
        ...
        if (action_portals_only) {
          ...
          if (sector != NULL) {
            ...
            if (exit_portal != NULL) {
              ...
              if (::Find_Intersection_Point(exit_box, p0, p1, &percent1, &intersection_pt)) {
...
//
//////////////////////////////////////////////////////////////////////////////////
void PathfindClass::Render_Debug_Widgets(RenderInfoClass &rinfo) {
