...
public:
  PhysAABoxIntersectionTestClass(const AABoxClass &box, int col_group, int col_type,
      ...
      : AABoxIntersectionTestClass(box, col_type), CollisionGroup(col_group), IntersectedObjects(result_list),
...
public:
  PhysOBBoxIntersectionTestClass(const OBBoxClass &box, int col_group, int col_type,
                                 NonRefPhysListClass *result_list = NULL)
      : OBBoxIntersectionTestClass(box, col_type), CollisionGroup(col_group), IntersectedObjects(result_list),
        CheckStaticObjs(true), CheckDynamicObjs(true) {}
...
public:
  PhysMeshIntersectionTestClass(MeshClass *mesh, int col_group, int col_type, NonRefPhysListClass *result_list)
      : IntersectionTestClass(col_type), Mesh(NULL), CollisionGroup(col_group), IntersectedObjects(result_list),
        CheckStaticObjs(true), CheckDynamicObjs(true) {
    WWASSERT(mesh != NULL);
