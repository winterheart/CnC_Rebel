...
MotorcycleClass::MotorcycleClass(void) : LeanK0(18.0f), LeanK1(5.0f) {}
...
void MotorcycleClass::Compute_Inertia(void) { WheeledVehicleClass::Compute_Inertia(); }

const PersistFactoryClass &MotorcycleClass::Get_Factory(void) const { return _MotorcycleFactory; }
...
MotorcycleDefClass::MotorcycleDefClass(void) : LeanK0(18.0f), LeanK1(5.0f) {
...
uint32 MotorcycleDefClass::Get_Class_ID(void) const { return CLASSID_MOTORCYCLEDEF; }
...
const PersistFactoryClass &MotorcycleDefClass::Get_Factory(void) const { return _MotorcycleDefFactory; }
