...
inline PATHFIND_DIR Mask_to_Dir(DIRECTION_MASK mask) {
...
inline PATHFIND_DIR Inverse_Pathfind_Dir(PATHFIND_DIR dir) {
  if (dir < 2)
    return PATHFIND_DIR(dir + 2);
  return PATHFIND_DIR(dir - 2);
}

inline PATHFIND_DIR Clockwise_Pathfind_Dir(PATHFIND_DIR dir) { return PATHFIND_DIR((dir + 3) % DIR_MAX); }
...
public:
  ...
  FloodfillBoxClass(void)
      : m_Sector(NULL), m_Flags(NeedsProcessing), m_DirectionInfo(0), m_CompressedSkipCount(0), m_MinZPos(0),
        m_MaxZPos(0), m_GridLink(NULL), m_Prev(NULL), m_Next(NULL) {
...
// Find_Relative
//////////////////////////////////////////////////////////////////////////
inline FloodfillBoxClass *FloodfillBoxClass::Find_Relative(int cx, int cy) {
...
// Remove
//////////////////////////////////////////////////////////////////////////
inline void FloodfillBoxClass::Remove(void) {
  if (m_Prev) {
...
// Is_Edge
//////////////////////////////////////////////////////////////////////////
inline bool FloodfillBoxClass::Is_Edge(void) {
  bool retval = false;

  if (Peek_Neighbor(DIR_FORWARD) == NULL || Peek_Neighbor(DIR_BACKWARD) == NULL || Peek_Neighbor(DIR_LEFT) == NULL ||
...
//////////////////////////////////////////////////////////////////////////
inline bool FloodfillBoxClass::Are_Neighbors_Processed(void) {
  bool retval = true;
...
// Set_Neighbor
//////////////////////////////////////////////////////////////////////////
inline void FloodfillBoxClass::Set_Neighbor(PATHFIND_DIR dir, FloodfillBoxClass *obj, bool traversible) {
  m_Neighbors[dir] = obj;
...
// Set_Flag
//////////////////////////////////////////////////////////////////////////
inline void FloodfillBoxClass::Set_Flag(uint8 flag, bool value) {
  m_Flags &= ~flag;
  if (value) {
    m_Flags |= flag;
  }
...
// Set_Traversible
//////////////////////////////////////////////////////////////////////////
inline void FloodfillBoxClass::Set_Traversible(PATHFIND_DIR dir, bool onoff) {
  if (onoff) {
...
// Get_Traversible
//////////////////////////////////////////////////////////////////////////
inline bool FloodfillBoxClass::Get_Traversible(PATHFIND_DIR dir) {
  int bit = (1 << dir);
...
// Part_Of_Portal
//////////////////////////////////////////////////////////////////////////
inline void FloodfillBoxClass::Part_Of_Portal(PATHFIND_DIR dir, bool onoff) {
  if (onoff) {
...
// Part_Of_Portal
//////////////////////////////////////////////////////////////////////////
inline bool FloodfillBoxClass::Part_Of_Portal(PATHFIND_DIR dir) {
  int bit = (1 << (dir + 4));
  return (m_DirectionInfo & bit) == bit;
}
