...
public:
  ...
  */
  PhysRayCollisionTestClass(const LineSegClass &ray, CastResultStruct *res, int group,
                            int type = COLLISION_TYPE_PROJECTILE)
      : RayCollisionTestClass(ray, res, type), CollidedPhysObj(NULL), CollisionGroup(group), CheckStaticObjs(true),
...
public:
  ...
  ** group - collision group of the object making query
  */
  PhysAABoxCollisionTestClass(const AABoxClass &aabox, const Vector3 &move, CastResultStruct *res, int group,
                              int type = COLLISION_TYPE_PHYSICAL)
      : AABoxCollisionTestClass(aabox, move, res, type), CollidedPhysObj(NULL), CollisionGroup(group),
        CheckStaticObjs(true), CheckDynamicObjs(true) {}
...
public:
  ...
  ** group - collision group of the object making query
  */
  PhysOBBoxCollisionTestClass(const OBBoxClass &box, const Vector3 &move, CastResultStruct *res, int group,
                              int type = COLLISION_TYPE_PHYSICAL)
      : OBBoxCollisionTestClass(box, move, res, type), CollidedPhysObj(NULL), CollisionGroup(group),
        CheckStaticObjs(true), CheckDynamicObjs(true) {}
