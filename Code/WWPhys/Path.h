...
public:
  ...
  typedef enum { LINEAR = 0, SPLINE } TRAVERSAL_TYPE;
...
protected:
  ...
  typedef struct _PATH_NODE {
    ...
    _PATH_NODE(void)
        : time(0), next_time(0), tighten_spline(false), action_id(ACTION_NONE), mechanism_id(0), dest_pos(0, 0, 0),
          pos(0, 0, 0) {}
  ...
  void Add_Waypath_Data(DynamicVectorClass<PATH_NODE> &node_list, WaypathClass *waypath, int start_index,
                        int end_index);
  void Add_Waypoint_Info_To_Node_List(DynamicVectorClass<PATH_NODE> &node_list, WaypointClass *waypoint,
...
//	Get_Action_Type
/////////////////////////////////////////////////////////////////////////
inline PathClass::ACTION_ID PathClass::Get_Action_Type(void) {
...
/////////////////////////////////////////////////////////////////////////
inline void PathClass::Get_Action_Destination(Vector3 &dest) {
  if (m_CurrentAction >= 0 && m_CurrentAction < m_PathActions.Count()) {
...
//	Get_Action_Entrance
/////////////////////////////////////////////////////////////////////////
inline void PathClass::Get_Action_Entrance(Vector3 &position) {
  if (m_CurrentAction >= 0 && m_CurrentAction < m_PathActions.Count()) {
...
/////////////////////////////////////////////////////////////////////////
inline uint32 PathClass::Get_Action_Mechanism(void) {
