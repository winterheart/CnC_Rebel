...
const unsigned short Indices[] = {3, 5, 1, 7, 5, 3, 1, 5, 0, 5, 4, 0, 4, 2, 0, 4, 6, 2,
                                  7, 3, 2, 6, 7, 2, 7, 6, 5, 5, 6, 4, 2, 3, 1, 2, 1, 0};
 ...
 **
 *========================================================================*/
Line3DClass::Line3DClass(const Vector3 &start, const Vector3 &end, float width, float r, float g, float b,
                         float opacity) {
...
Line3DClass::Line3DClass(const Line3DClass &src)
    : RenderObjClass(src), Length(src.Length), Width(src.Width), Shader(src.Shader), Color(src.Color) {
  for (int i = 0; i < 8; i++)
    vert[i] = src.vert[i];
}
 ...
 *   01/15/1998 NH  : Created.                                            *
 *========================================================================*/
RenderObjClass *Line3DClass::Clone(void) const { return NEW_REF(Line3DClass, (*this)); }
 ...
 *   04/21/1998 NH  : Ported to SR 1.3.                                   *
 *========================================================================*/
void Line3DClass::Re_Color(float r, float g, float b) { Color = Vector4(r, g, b, Color.W); }
