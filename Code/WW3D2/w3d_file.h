...
*		W3D_CHUNK_MATERIAL_INFO					// how many passes, vertex mtls, shaders, and
textures... *		W3D_CHUNK_SHADERS							// array of
W3dShaderStruct's *		W3D_CHUNK_VERTEX_MATERIALS *			W3D_CHUNK_VERTEX_MATERIAL *
W3D_CHUNK_VERTEX_MATERIAL_NAME *				W3D_CHUNK_VERTEX_MATERIAL_INFO
                        ...
...
enum {
  ...
  W3D_CHUNK_VERTEX_MATERIAL_IDS =
      0x00000039,                    // single or per-vertex array of uint32 vertex material indices (check chunk size)
  ...
  W3D_CHUNK_MORPH_ANIMATION =
      0x000002C0,               // hierarchy morphing animation data (morphs between poses, for facial animation)
  W3D_CHUNK_MORPHANIM_HEADER,   // W3dMorphAnimHeaderStruct describes playback rate, number of frames, and type of
                                // compression
  ...
  W3D_CHUNK_POINTS =
      0x00000440, // array of W3dVectorStruct's.  May appear in meshes, hmodels, lodmodels, or collections.
  ...
  W3D_CHUNK_HLOD_AGGREGATE_ARRAY,         // array of aggregates, contains W3D_CHUNK_SUB_OBJECT_ARRAY_HEADER and
                                          // W3D_CHUNK_SUB_OBJECT_ARRAY
  ...
  W3D_CHUNK_LIGHT_TRANSFORM,         // position and orientation (defined as right-handed 4x3 matrix transform
                                     // W3dLightTransformStruct).

  W3D_CHUNK_DAZZLE =
      0x00000900,        // wrapper for a glare object.  Creates halos and flare lines seen around a bright light source
...
struct W3dTexCoordStruct {
  bool operator==(W3dTexCoordStruct t) { return ((U == t.U) && (V == t.V)); }
...
struct W3dRGBStruct {
  ...
  bool operator==(W3dRGBStruct c) { return ((R == c.R) && (G == c.G) && (B == c.B)); }

  bool operator!=(W3dRGBStruct c) { return (!(*this == c)); }
  ...
  unsigned Get_Color() { return (R << 24) | (G << 16) | (B << 8); }
...
struct W3dVertexMaterialStruct {
  ...
  bool operator==(W3dVertexMaterialStruct vm) {
    return (Attributes == vm.Attributes && Ambient == vm.Ambient && Diffuse == vm.Diffuse && Specular == vm.Specular &&
            Emissive == vm.Emissive && Shininess == vm.Shininess && Opacity == vm.Opacity &&
            Translucency == vm.Translucency);
  }

  bool operator!=(W3dVertexMaterialStruct vm) { return (!(*this == vm)); }
...
enum {
  ...
  W3DSHADER_DESTBLENDFUNC_ONE_MINUS_SRC_COLOR, // destination pixel multiplied by one minus (i.e. inverse) fragment RGB
                                               // components
...
#define W3DTEXTURE_MIP_LEVELS_2                                                                                        \
  0x0040 // generate up to 2 mip-levels (NOTE: use W3DTEXTURE_NO_LOD to generate just 1 mip-level)
...
#define W3D_MESH_FLAG_COLLISION_BOX                                                                                    \
  0x00000001 // (obsolete as of 4.1) mesh is a collision box (should be 8 verts, should be hidden, etc)
...
#define W3D_MESH_FLAG_COLLISION_TYPE_VEHICLE                                                                           \
  0x00000100 // vehicles collide with this mesh (and with physical collision meshes)
...
#define OBSOLETE_W3D_MESH_FLAG_LIGHTMAPPED                                                                             \
  0x00004000 // obsolete lightmapped mesh
...
#define W3D_MESH_FLAG_PRELIT_LIGHTMAP_MULTI_PASS                                                                       \
  0x04000000 // mesh contains a precalculated multi-pass lightmapped material chunk wrapper
#define W3D_MESH_FLAG_PRELIT_LIGHTMAP_MULTI_TEXTURE                                                                    \
  0x08000000 // mesh contains a precalculated multi-texture lightmapped material chunk wrapper
...
/********************************************************************************
        ...
        W3D_CHUNK_MORPH_ANIMATION							=0x000002C0,	// wrapper for
the entire anim W3D_CHUNK_MORPHANIM_HEADER,
// W3dMorphAnimHeaderStruct describes playback rate, number of frames, and type of compression
                W3D_CHUNK_MORPHANIM_CHANNEL,
// wrapper for a channel W3D_CHUNK_MORPHANIM_POSENAME,
// name of the other anim which contains the poses for this morph channel W3D_CHUNK_MORPHANIM_KEYDATA,
// array of W3dMorphAnimKeyStruct's (use chunk length to determine how many) W3D_CHUNK_MORPHANIM_PIVOTCHANNELDATA,
...
//
enum { EMITTER_TYPEID_DEFAULT = 0, EMITTER_TYPEID_COUNT };
...
// description of an HLod object (see HLodClass) W3D_CHUNK_HLOD_HEADER,
// general information such as name and version W3D_CHUNK_HLOD_LOD_ARRAY,
// wrapper around the array of objects for each level of detail W3D_CHUNK_HLOD_SUB_OBJECT_ARRAY_HEADER,
// info on the objects in this level of detail array W3D_CHUNK_HLOD_SUB_OBJECT,
// an object in this level of detail array W3D_CHUNK_HLOD_AGGREGATE_ARRAY,
// array of aggregates, contains W3D_CHUNK_SUB_OBJECT_ARRAY_HEADER and W3D_CHUNK_SUB_OBJECT_ARRAY
                W3D_CHUNK_HLOD_PROXY_ARRAY,
// array of proxies, used for application-defined purposes
