...
void BitmapHandlerClass::Create_Mipmap_B8G8R8A8(unsigned char *dest_surface, unsigned dest_surface_pitch,
...
void BitmapHandlerClass::Copy_Image_Generate_Mipmap(unsigned width, unsigned height, unsigned char *dest_surface,
                                                    unsigned dest_pitch, WW3DFormat dest_format,
                                                    unsigned char *src_surface, unsigned src_pitch,
                                                    WW3DFormat src_format, unsigned char *mip_surface,
                                                    unsigned mip_pitch) {
...
void BitmapHandlerClass::Copy_Image(unsigned char *dest_surface, unsigned dest_surface_width,
                                    ...
                                    WW3DFormat src_surface_format, const unsigned char *src_palette,
                                    unsigned src_palette_bpp, bool generate_mip_level) {
    ...
    if (generate_mip_level) {
      ...
      if (dest_surface_width == 1) {
        ...
        for (unsigned y = 0; y < dest_surface_height / 2; ++y) {
          ...
          unsigned b8g8r8a8_10;
          unsigned b8g8r8a8_11;
          for (unsigned x = 0; x < dest_surface_width / 2;
               x++, dest_ptr += dest_bpp * 2, src_ptr += src_bpp * 2, mip_ptr += src_bpp) {
            ...
            Read_B8G8R8A8(b8g8r8a8_11, src_ptr + src_bpp + src_surface_pitch, src_surface_format, src_palette,
                          src_palette_bpp);
