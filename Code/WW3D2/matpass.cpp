...
MaterialPassClass::MaterialPassClass(void)
    : Shader(0), Material(NULL), CullVolume(NULL), EnableOnTranslucentMeshes(true) {
 ...
 *   12/9/99    gth : Created.                                                                 *
 *=============================================================================================*/
void MaterialPassClass::Set_Material(VertexMaterialClass *mat) { REF_PTR_SET(Material, mat); }
