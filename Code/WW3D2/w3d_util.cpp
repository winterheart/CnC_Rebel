...
void W3dUtilityClass::Convert_Shader(const W3dShaderStruct &shader, ShaderClass *set) {
  ...
  //	set->Set_Post_Detail_Color_Func ((ShaderClass::DetailColorFuncType) W3d_Shader_Get_Post_Detail_Color_Func
  //(&shader)); 	set->Set_Post_Detail_Alpha_Func ((ShaderClass::DetailAlphaFuncType)
