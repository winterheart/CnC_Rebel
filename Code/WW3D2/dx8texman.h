...
public:
  DX8TextureTrackerClass(unsigned int w, unsigned int h, WW3DFormat format, TextureClass::MipCountType count, bool rt,
                         TextureClass *tex)
      : Width(w), Height(h), Format(format), Mip_level_count(count), RenderTarget(rt), Texture(tex) {}
