...
public:
  ...
  DX8Caps(DX_IDirect3DX *direct3d, const DX_D3DCAPS &caps, WW3DFormat display_format,
          const DX_D3DADAPTER_IDENTIFIER &adapter_id);
  DX8Caps(DX_IDirect3DX *direct3d, DX_IDirect3DDevice *D3DDevice, WW3DFormat display_format,
          const DX_D3DADAPTER_IDENTIFIER &adapter_id);
