...
#define SC_OPAQUE                                                                                                      \
  (SHADE_CNST(PASS_LEQUAL, DEPTH_WRITE_ENABLE, COLOR_WRITE_ENABLE, SRCBLEND_ONE, DSTBLEND_ZERO, FOG_DISABLE,           \
              GRADIENT_MODULATE, SECONDARY_GRADIENT_DISABLE, TEXTURING_ENABLE, ALPHATEST_DISABLE, CULL_MODE_ENABLE,    \
...
#define SC_ADDITIVE                                                                                                    \
  (SHADE_CNST(PASS_LEQUAL, DEPTH_WRITE_DISABLE, COLOR_WRITE_ENABLE, SRCBLEND_ONE, DSTBLEND_ONE, FOG_DISABLE,           \
              GRADIENT_MODULATE, SECONDARY_GRADIENT_DISABLE, TEXTURING_ENABLE, ALPHATEST_DISABLE, CULL_MODE_ENABLE,    \
              DETAILCOLOR_DISABLE, DETAILALPHA_DISABLE))
...
#define SC_BUMPENVMAP                                                                                                  \
  (SHADE_CNST(PASS_LEQUAL, DEPTH_WRITE_DISABLE, COLOR_WRITE_ENABLE, SRCBLEND_ONE, DSTBLEND_ONE, FOG_DISABLE,           \
              GRADIENT_BUMPENVMAP, SECONDARY_GRADIENT_DISABLE, TEXTURING_ENABLE, ALPHATEST_DISABLE, CULL_MODE_ENABLE,  \
...
#define SC_ALPHA                                                                                                       \
  (SHADE_CNST(PASS_LEQUAL, DEPTH_WRITE_DISABLE, COLOR_WRITE_ENABLE, SRCBLEND_SRC_ALPHA, DSTBLEND_ONE_MINUS_SRC_ALPHA,  \
              FOG_DISABLE, GRADIENT_MODULATE, SECONDARY_GRADIENT_DISABLE, TEXTURING_ENABLE, ALPHATEST_DISABLE,         \
...
#define SC_MULTIPLICATIVE                                                                                              \
  (SHADE_CNST(PASS_LEQUAL, DEPTH_WRITE_DISABLE, COLOR_WRITE_ENABLE, SRCBLEND_ZERO, DSTBLEND_SRC_COLOR, FOG_DISABLE,    \
              GRADIENT_MODULATE, SECONDARY_GRADIENT_DISABLE, TEXTURING_ENABLE, ALPHATEST_DISABLE, CULL_MODE_ENABLE,    \
              DETAILCOLOR_DISABLE, DETAILALPHA_DISABLE))
...
#define SC_OP_2D                                                                                                       \
  (SHADE_CNST(PASS_ALWAYS, DEPTH_WRITE_DISABLE, COLOR_WRITE_ENABLE, SRCBLEND_ONE, DSTBLEND_ZERO, FOG_DISABLE,          \
              GRADIENT_DISABLE, SECONDARY_GRADIENT_DISABLE, TEXTURING_ENABLE, ALPHATEST_DISABLE, CULL_MODE_ENABLE,     \
              DETAILCOLOR_DISABLE, DETAILALPHA_DISABLE))
...
#define SC_OP_SPRITE                                                                                                   \
  (SHADE_CNST(PASS_LEQUAL, DEPTH_WRITE_DISABLE, COLOR_WRITE_ENABLE, SRCBLEND_ONE, DSTBLEND_ZERO, FOG_DISABLE,          \
              GRADIENT_DISABLE, SECONDARY_GRADIENT_DISABLE, TEXTURING_ENABLE, ALPHATEST_DISABLE, CULL_MODE_ENABLE,     \
              DETAILCOLOR_DISABLE, DETAILALPHA_DISABLE))
...
#define SC_ADD_2D                                                                                                      \
  (SHADE_CNST(PASS_ALWAYS, DEPTH_WRITE_DISABLE, COLOR_WRITE_ENABLE, SRCBLEND_ONE, DSTBLEND_ONE, FOG_DISABLE,           \
              GRADIENT_DISABLE, SECONDARY_GRADIENT_DISABLE, TEXTURING_ENABLE, ALPHATEST_DISABLE, CULL_MODE_ENABLE,     \
              DETAILCOLOR_DISABLE, DETAILALPHA_DISABLE))
...
#define SC_ALPHA_2D                                                                                                    \
  (SHADE_CNST(PASS_ALWAYS, DEPTH_WRITE_DISABLE, COLOR_WRITE_ENABLE, SRCBLEND_SRC_ALPHA, DSTBLEND_ONE_MINUS_SRC_ALPHA,  \
              FOG_DISABLE, GRADIENT_DISABLE, SECONDARY_GRADIENT_DISABLE, TEXTURING_ENABLE, ALPHATEST_DISABLE,          \
              CULL_MODE_ENABLE, DETAILCOLOR_DISABLE, DETAILALPHA_DISABLE))
...
#define SC_OPAQUE_SOLID                                                                                                \
  (SHADE_CNST(PASS_LEQUAL, DEPTH_WRITE_ENABLE, COLOR_WRITE_ENABLE, SRCBLEND_ONE, DSTBLEND_ZERO, FOG_DISABLE,           \
              GRADIENT_MODULATE, SECONDARY_GRADIENT_DISABLE, TEXTURING_DISABLE, ALPHATEST_DISABLE, CULL_MODE_ENABLE,   \
              DETAILCOLOR_DISABLE, DETAILALPHA_DISABLE))
...
#define SC_ALPHA_SOLID                                                                                                 \
  (SHADE_CNST(PASS_LEQUAL, DEPTH_WRITE_DISABLE, COLOR_WRITE_ENABLE, SRCBLEND_SRC_ALPHA, DSTBLEND_ONE_MINUS_SRC_ALPHA,  \
              FOG_DISABLE, GRADIENT_MODULATE, SECONDARY_GRADIENT_DISABLE, TEXTURING_DISABLE, ALPHATEST_DISABLE,        \
              CULL_MODE_ENABLE, DETAILCOLOR_DISABLE, DETAILALPHA_DISABLE))
...
#define SC_ATEST_2D                                                                                                    \
  (SHADE_CNST(PASS_ALWAYS, DEPTH_WRITE_DISABLE, COLOR_WRITE_ENABLE, SRCBLEND_ONE, DSTBLEND_ZERO, FOG_DISABLE,          \
              GRADIENT_DISABLE, SECONDARY_GRADIENT_DISABLE, TEXTURING_ENABLE, ALPHATEST_ENABLE, CULL_MODE_ENABLE,      \
              DETAILCOLOR_DISABLE, DETAILALPHA_DISABLE))
...
#define SC_ATESTBLEND_2D                                                                                               \
  (SHADE_CNST(PASS_ALWAYS, DEPTH_WRITE_DISABLE, COLOR_WRITE_ENABLE, SRCBLEND_SRC_ALPHA, DSTBLEND_ONE_MINUS_SRC_ALPHA,  \
              FOG_DISABLE, GRADIENT_DISABLE, SECONDARY_GRADIENT_DISABLE, TEXTURING_ENABLE, ALPHATEST_ENABLE,           \
              CULL_MODE_ENABLE, DETAILCOLOR_DISABLE, DETAILALPHA_DISABLE))
...
#define SC_ATESTBLEND_SPRITE                                                                                           \
  (SHADE_CNST(PASS_LEQUAL, DEPTH_WRITE_ENABLE, COLOR_WRITE_ENABLE, SRCBLEND_SRC_ALPHA, DSTBLEND_ONE_MINUS_SRC_ALPHA,   \
              FOG_DISABLE, GRADIENT_DISABLE, SECONDARY_GRADIENT_DISABLE, TEXTURING_ENABLE, ALPHATEST_ENABLE,           \
              CULL_MODE_ENABLE, DETAILCOLOR_DISABLE, DETAILALPHA_DISABLE))
...
#define SC_SCREEN_2D                                                                                                   \
  (SHADE_CNST(PASS_ALWAYS, DEPTH_WRITE_DISABLE, COLOR_WRITE_ENABLE, SRCBLEND_ONE, DSTBLEND_ONE_MINUS_SRC_COLOR,        \
              FOG_DISABLE, GRADIENT_DISABLE, SECONDARY_GRADIENT_DISABLE, TEXTURING_ENABLE, ALPHATEST_DISABLE,          \
              CULL_MODE_ENABLE, DETAILCOLOR_DISABLE, DETAILALPHA_DISABLE))
...
#define SC_SCREEN_SPRITE                                                                                               \
  (SHADE_CNST(PASS_LEQUAL, DEPTH_WRITE_DISABLE, COLOR_WRITE_ENABLE, SRCBLEND_ONE, DSTBLEND_ONE_MINUS_SRC_COLOR,        \
              FOG_DISABLE, GRADIENT_DISABLE, SECONDARY_GRADIENT_DISABLE, TEXTURING_ENABLE, ALPHATEST_DISABLE,          \
              CULL_MODE_ENABLE, DETAILCOLOR_DISABLE, DETAILALPHA_DISABLE))
...
#define SC_MUL_2D                                                                                                      \
  (SHADE_CNST(PASS_ALWAYS, DEPTH_WRITE_DISABLE, COLOR_WRITE_ENABLE, SRCBLEND_ZERO, DSTBLEND_SRC_COLOR, FOG_DISABLE,    \
              GRADIENT_DISABLE, SECONDARY_GRADIENT_DISABLE, TEXTURING_ENABLE, ALPHATEST_DISABLE, CULL_MODE_ENABLE,     \
              DETAILCOLOR_DISABLE, DETAILALPHA_DISABLE))
...
const Blend srcBlendLUT[ShaderClass::SRCBLEND_MAX] = {Blend(D3DBLEND_ZERO, false), Blend(D3DBLEND_ONE, false),
                                                      Blend(D3DBLEND_SRCALPHA, true),
                                                      Blend(D3DBLEND_INVSRCALPHA, true)};

const Blend dstBlendLUT[ShaderClass::DSTBLEND_MAX] = {
    Blend(D3DBLEND_ZERO, false),        Blend(D3DBLEND_ONE, false),     Blend(D3DBLEND_SRCCOLOR, false),
    Blend(D3DBLEND_INVSRCCOLOR, false), Blend(D3DBLEND_SRCALPHA, true), Blend(D3DBLEND_INVSRCALPHA, true)};
...
void ShaderClass::Apply() {
  ...
  if (diff & (ShaderClass::MASK_COLORMASK | ShaderClass::MASK_SRCBLEND | ShaderClass::MASK_DSTBLEND |
              ShaderClass::MASK_ALPHATEST)) {
    ...
    diff &= ~(ShaderClass::MASK_COLORMASK | ShaderClass::MASK_SRCBLEND | ShaderClass::MASK_DSTBLEND |
              ShaderClass::MASK_ALPHATEST);
    if (!diff)
      return;
  }
...
ShaderClass::StaticSortCategoryType ShaderClass::Get_SS_Category(void) const {
  ...
  if (ALPHATEST_ENABLE == Get_Alpha_Test()) {
    if (DSTBLEND_ZERO == Get_Dst_Blend_Func())
      return SSCAT_ALPHA_TEST;
    if ((SRCBLEND_SRC_ALPHA == Get_Src_Blend_Func()) && (DSTBLEND_ONE_MINUS_SRC_ALPHA == Get_Dst_Blend_Func()))
      return SSCAT_ALPHA_TEST;
  }
  // category: Additive
 ...
 *   4/24/2001  gth : Created.                                                                 *
 *=============================================================================================*/
bool ShaderClass::Is_Backface_Culling_Inverted(void) { return (_PolygonCullMode == D3DCULL_CCW); }
