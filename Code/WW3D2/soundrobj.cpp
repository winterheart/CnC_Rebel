...
//
//////////////////////////////////////////////////////////////////////////////////
SoundRenderObjClass::SoundRenderObjClass(void) : Flags(FLAG_STOP_WHEN_HIDDEN), Sound(NULL), IsInitialized(false) {
  return;
}
...
//
//////////////////////////////////////////////////////////////////////////////////
const SoundRenderObjClass &SoundRenderObjClass::operator=(const SoundRenderObjClass &src) {
  //
...
SoundRenderObjDefClass::SoundRenderObjDefClass(void)
    : Version(W3D_CURRENT_SOUNDROBJ_VERSION), Flags(SoundRenderObjClass::FLAG_STOP_WHEN_HIDDEN) {
  return;
}
...
//
//////////////////////////////////////////////////////////////////////////////////
const SoundRenderObjDefClass &SoundRenderObjDefClass::operator=(const SoundRenderObjDefClass &src) {
...
WW3DErrorType SoundRenderObjDefClass::Load_W3D(ChunkLoadClass &cload) {
  ...
  //
  if ((Read_Header(cload) == WW3D_ERROR_OK) && (Read_Definition(cload) == WW3D_ERROR_OK)) {
...
WW3DErrorType SoundRenderObjDefClass::Save_W3D(ChunkSaveClass &csave) {
  ...
  if (csave.Begin_Chunk(W3D_CHUNK_SOUNDROBJ) == TRUE) {
    ...
    //
    if ((Write_Header(csave) == WW3D_ERROR_OK) && (Write_Definition(csave) == WW3D_ERROR_OK)) {
      retval = WW3D_ERROR_OK;
    }
...
WW3DErrorType SoundRenderObjDefClass::Read_Header(ChunkLoadClass &cload) {
  ...
  //
  if (cload.Open_Chunk() && (cload.Cur_Chunk_ID() == W3D_CHUNK_SOUNDROBJ_HEADER)) {
    //
...
WW3DErrorType SoundRenderObjDefClass::Read_Definition(ChunkLoadClass &cload) {
  ...
  //
  if (cload.Open_Chunk() && (cload.Cur_Chunk_ID() == W3D_CHUNK_SOUNDROBJ_DEFINITION)) {
    //
