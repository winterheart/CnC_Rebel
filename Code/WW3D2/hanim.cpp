...
void HAnimComboClass::Append_Anim_Combo_Data(HAnimComboDataClass *Data) { HAnimComboData.Add(Data); }

void HAnimComboClass::Remove_Anim_Combo_Data(HAnimComboDataClass *Data) { HAnimComboData.Delete_Object(Data); }
