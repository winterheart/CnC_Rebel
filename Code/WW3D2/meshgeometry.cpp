...
MeshGeometryClass::MeshGeometryClass(void)
    : MeshName(NULL), UserText(NULL), Flags(0), SortLevel(SORT_LEVEL_NONE), W3dAttributes(0), PolyCount(0),
      VertexCount(0), Poly(NULL), PolySurfaceType(NULL), Vertex(NULL), VertexNorm(NULL), PlaneEq(NULL),
      VertexShadeIdx(NULL), VertexBoneLink(NULL), BoundBoxMin(0, 0, 0), BoundBoxMax(1, 1, 1),
      BoundSphereCenter(0, 0, 0), BoundSphereRadius(1), CullTree(NULL) {}
 ...
 *   5/10/2001  gth : Created.                                                                 *
 *=============================================================================================*/
void MeshGeometryClass::Generate_Rigid_APT(const OBBoxClass &local_box, const Vector3 &viewdir,
 ...
 *   11/9/2000  gth : Created.                                                                 *
 *=============================================================================================*/
void MeshGeometryClass::Generate_Skin_APT(const OBBoxClass &world_box, SimpleDynVecClass<uint32> &apt,
    ...
    */
    ...
    for (int poly_counter = 0; poly_counter < poly_count; poly_counter++) {
      ...
      count += (unsigned int)Cast_Semi_Infinite_Axis_Aligned_Ray_To_Triangle(
          v0, v1, v2, tri_plane, start_point, axis_r[axis_dir], axis_1[axis_dir], axis_2[axis_dir], direction[axis_dir],
          flags);
    }
  }
