...
Null3DObjClass::Null3DObjClass(const Null3DObjClass &src) { strcpy(Name, src.Name); }
...
RenderObjClass *Null3DObjClass::Clone(void) const { return NEW_REF(Null3DObjClass, (*this)); }
...
NullPrototypeClass::NullPrototypeClass(const W3dNullObjectStruct &null) { Definition = null; }
