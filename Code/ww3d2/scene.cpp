...
SceneClass::SceneClass(void)
    : AmbientLight(0.5f, 0.5f, 0.5f), PolyRenderMode(FILL), ExtraPassPolyRenderMode(EXTRA_PASS_DISABLE),
      FogEnabled(false), FogColor(0, 0, 0), FogStart(0.0f), FogEnd(1000.0f) // Arbitrary default value
{}
 ...
 *   2/25/99    GTH : Created.                                                                 *
 *=============================================================================================*/
void SceneClass::Add_Render_Object(RenderObjClass *obj) { obj->Notify_Added(this); }
 ...
 *   2/25/99    GTH : Created.                                                                 *
 *=============================================================================================*/
void SceneClass::Remove_Render_Object(RenderObjClass *obj) { obj->Notify_Removed(this); }
...
SimpleSceneIterator::SimpleSceneIterator(RefRenderObjListClass *list, bool onlyvis) : RobjIterator(list) {
...
RenderObjClass *SimpleSceneIterator::Current_Item(void) { return RobjIterator.Peek_Obj(); }
