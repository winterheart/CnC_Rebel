...
const unsigned int ParticleBufferClass::PermutationArray[16] = {11, 3, 7, 14, 0, 13, 1, 2, 5, 12, 15, 6, 9, 8, 4, 10};
...
float ParticleBufferClass::LODMaxScreenSizes[17] = {
    NO_MAX_SCREEN_SIZE, NO_MAX_SCREEN_SIZE, NO_MAX_SCREEN_SIZE, NO_MAX_SCREEN_SIZE, NO_MAX_SCREEN_SIZE,
    NO_MAX_SCREEN_SIZE, NO_MAX_SCREEN_SIZE, NO_MAX_SCREEN_SIZE, NO_MAX_SCREEN_SIZE, NO_MAX_SCREEN_SIZE,
    NO_MAX_SCREEN_SIZE, NO_MAX_SCREEN_SIZE, NO_MAX_SCREEN_SIZE, NO_MAX_SCREEN_SIZE, NO_MAX_SCREEN_SIZE,
...
static const W3dEmitterLinePropertiesStruct _DefaultLineEmitterProps = {0, 0, 0.0f, 1.5f, 1.0f, 0.0f, 0.0f, 0,
                                                                        0, 0, 0,    0,    0,    0,    0,    0};

ParticleBufferClass::ParticleBufferClass(ParticleEmitterClass *emitter, unsigned int buffer_size,
                                         ...
                                         ParticlePropertyStruct<float> &blurtime, Vector3 accel, float max_age,
    ...
    : NewParticleQueue(NULL), NewParticleQueueStart(0U), NewParticleQueueEnd(0U), NewParticleQueueCount(0U),
      RenderMode(render_mode), FrameMode(frame_mode), MaxAge(1000.0f * max_age), LastUpdateTime(WW3D::Get_Sync_Time()),
      IsEmitterDead(false), MaxSize(0.0f), MaxNum(buffer_size), Start(0U), End(0U), NewEnd(0U), NonNewNum(0), NewNum(0),
      BoundingBox(Vector3(0, 0, 0), Vector3(0, 0, 0)), BoundingBoxDirty(true), NumColorKeyFrames(0),
      ColorKeyFrameTimes(NULL), ColorKeyFrameValues(NULL), ColorKeyFrameDeltas(NULL), NumAlphaKeyFrames(0),
      AlphaKeyFrameTimes(NULL), AlphaKeyFrameValues(NULL), AlphaKeyFrameDeltas(NULL), NumSizeKeyFrames(0),
      SizeKeyFrameTimes(NULL), SizeKeyFrameValues(NULL), SizeKeyFrameDeltas(NULL), NumRotationKeyFrames(0),
      RotationKeyFrameTimes(NULL), RotationKeyFrameValues(NULL), HalfRotationKeyFrameDeltas(NULL),
      OrientationKeyFrameValues(NULL), NumFrameKeyFrames(0), FrameKeyFrameTimes(NULL), FrameKeyFrameValues(NULL),
      FrameKeyFrameDeltas(NULL), NumBlurTimeKeyFrames(0), BlurTimeKeyFrameTimes(NULL), BlurTimeKeyFrameValues(NULL),
      BlurTimeKeyFrameDeltas(NULL), NumRandomColorEntriesMinus1(0), RandomColorEntries(NULL),
      NumRandomAlphaEntriesMinus1(0), RandomAlphaEntries(NULL), NumRandomSizeEntriesMinus1(0), RandomSizeEntries(NULL),
      ColorRandom(0, 0, 0), OpacityRandom(0), SizeRandom(0), RotationRandom(0), FrameRandom(0),
      InitialOrientationRandom(0), NumRandomRotationEntriesMinus1(0), RandomRotationEntries(NULL),
      NumRandomOrientationEntriesMinus1(0), RandomOrientationEntries(NULL), NumRandomFrameEntriesMinus1(0),
      RandomFrameEntries(NULL), NumRandomBlurTimeEntriesMinus1(0), RandomBlurTimeEntries(NULL), PointGroup(NULL),
      LineRenderer(NULL), LineGroup(NULL), Diffuse(NULL), TailDiffuse(NULL), Color(NULL), Alpha(NULL), Size(NULL),
      Orientation(NULL), Frame(NULL), UCoord(NULL), TailPosition(NULL), APT(NULL), PingPongPosition(pingpong),
      Velocity(NULL), TimeStamp(NULL), Emitter(emitter), DecimationThreshold(0U), ProjectedArea(0.0f),
...
ParticleBufferClass::ParticleBufferClass(const ParticleBufferClass &src)
    : RenderObjClass(src), NewParticleQueue(NULL), NewParticleQueueStart(0U), NewParticleQueueEnd(0U),
      NewParticleQueueCount(0U), RenderMode(src.RenderMode), FrameMode(src.FrameMode), MaxAge(src.MaxAge),
      LastUpdateTime(WW3D::Get_Sync_Time()), IsEmitterDead(false), MaxSize(src.MaxSize), MaxNum(src.MaxNum), Start(0U),
      End(0U), NewEnd(0U), NonNewNum(0), NewNum(0), BoundingBox(Vector3(0, 0, 0), Vector3(0, 0, 0)),
      BoundingBoxDirty(true), NumColorKeyFrames(src.NumColorKeyFrames), ColorKeyFrameTimes(NULL),
      ColorKeyFrameValues(NULL), ColorKeyFrameDeltas(NULL), NumAlphaKeyFrames(src.NumAlphaKeyFrames),
      AlphaKeyFrameTimes(NULL), AlphaKeyFrameValues(NULL), AlphaKeyFrameDeltas(NULL),
      NumSizeKeyFrames(src.NumSizeKeyFrames), SizeKeyFrameTimes(NULL), SizeKeyFrameValues(NULL),
      SizeKeyFrameDeltas(NULL), NumRotationKeyFrames(src.NumRotationKeyFrames), RotationKeyFrameTimes(NULL),
      RotationKeyFrameValues(NULL), HalfRotationKeyFrameDeltas(NULL), OrientationKeyFrameValues(NULL),
      NumFrameKeyFrames(src.NumFrameKeyFrames), FrameKeyFrameTimes(NULL), FrameKeyFrameValues(NULL),
      FrameKeyFrameDeltas(NULL), NumBlurTimeKeyFrames(src.NumBlurTimeKeyFrames), BlurTimeKeyFrameTimes(NULL),
      BlurTimeKeyFrameValues(NULL), BlurTimeKeyFrameDeltas(NULL), RandomColorEntries(NULL), RandomAlphaEntries(NULL),
      RandomSizeEntries(NULL), ColorRandom(src.ColorRandom), OpacityRandom(src.OpacityRandom),
      SizeRandom(src.SizeRandom), RotationRandom(src.RotationRandom), FrameRandom(src.FrameRandom),
      InitialOrientationRandom(src.InitialOrientationRandom), NumRandomRotationEntriesMinus1(0),
      RandomRotationEntries(NULL), NumRandomOrientationEntriesMinus1(0), RandomOrientationEntries(NULL),
      NumRandomFrameEntriesMinus1(0), RandomFrameEntries(NULL), NumRandomBlurTimeEntriesMinus1(0),
      RandomBlurTimeEntries(NULL), PointGroup(NULL), LineRenderer(NULL), LineGroup(NULL), Diffuse(NULL),
      TailDiffuse(NULL), Color(NULL), Alpha(NULL), Size(NULL), Orientation(NULL), Frame(NULL), UCoord(NULL),
      TailPosition(NULL), APT(NULL), PingPongPosition(src.PingPongPosition), Velocity(NULL), TimeStamp(NULL),
      Emitter(src.Emitter), DecimationThreshold(src.DecimationThreshold), ProjectedArea(0.0f),
...
RenderObjClass *ParticleBufferClass::Clone(void) const { return new ParticleBufferClass(*this); }
...
int ParticleBufferClass::Get_Particle_Count(void) const { return NonNewNum + NewNum; }
...
void ParticleBufferClass::Render_Line(RenderInfoClass &rinfo) {
  ...
  if (tmp_points.Count() > 0) {
    ...
    LineRenderer->Render(rinfo, Transform, tmp_points.Count(), &(tmp_points[0]), bounding_sphere);
  }
}
...
void ParticleBufferClass::Render_Line_Group(RenderInfoClass &rinfo) {
  ...
  case SAME_AS_HEAD_ALPHA_ZERO:
    ...
    if (!Diffuse) {
      ...
      if (!TailDiffuse)
        TailDiffuse = NEW_REF(ShareBufferClass<Vector4>, (MaxNum));
  ...
  case SAME_AS_HEAD:
    ...
    if (!Diffuse) {
      REF_PTR_RELEASE(TailDiffuse);
      DefaultTailDiffuse.Set(ColorKeyFrameValues[0].X, ColorKeyFrameValues[0].Y, ColorKeyFrameValues[0].Z,
...
void ParticleBufferClass::Decrement_LOD(void) {
  if (DecimationThreshold < LodCount)
    DecimationThreshold++;
}

float ParticleBufferClass::Get_Cost(void) const { return (Cost[(LodCount - 1) - DecimationThreshold]); }

float ParticleBufferClass::Get_Value(void) const { return (Value[(LodCount - 1) - DecimationThreshold]); }

float ParticleBufferClass::Get_Post_Increment_Value(void) const { return (Value[LodCount - DecimationThreshold]); }
...
int ParticleBufferClass::Get_LOD_Level(void) const { return ((LodCount - 1) - DecimationThreshold); }
...
void ParticleBufferClass::Reset_Colors(ParticlePropertyStruct<Vector3> &new_props) {
  ...
  bool color_rand_zero =
      (fabs(new_props.Rand.X) < eps_byte && fabs(new_props.Rand.Y) < eps_byte && fabs(new_props.Rand.Z) < eps_byte);
...
void ParticleBufferClass::Reset_Size(ParticlePropertyStruct<float> &new_props) {
  ...
  if (size_rand_zero && new_props.NumKeyFrames == 0) {
    ...
    float last_size =
        ...
        SizeKeyFrameDeltas[NumSizeKeyFrames - 1] * (float)(MaxAge - SizeKeyFrameTimes[NumSizeKeyFrames - 1]);
...
void ParticleBufferClass::Reset_Rotations(ParticlePropertyStruct<float> &new_props, float orient_rnd) {
  ...
  */
  ...
  static const float eps_rotation =
      2.77777778e-4f; // Epsilon is equivalent to one rotation per hour (in rotations / second)
  ...
  if (orientation_rand_zero && rotation_rand_zero && new_props.NumKeyFrames == 0 &&
      fabs(new_props.Start) < eps_rotation) {
    ...
    for (i = 1; i < NumRotationKeyFrames; i++) {
      ...
      OrientationKeyFrameValues[i] =
          ...
          delta_t * (RotationKeyFrameValues[i - 1] + HalfRotationKeyFrameDeltas[i - 1] * delta_t);
    }
...
void ParticleBufferClass::Update_Visual_Particle_State(void) {
  ...
  bool is_linegroup =
      ((RenderMode == W3D_EMITTER_RENDER_MODE_LINEGRP_TETRA) || (RenderMode == W3D_EMITTER_RENDER_MODE_LINEGRP_PRISM));
  if (!Color && !Alpha && !Size && !Orientation && !Frame && !UCoord && !is_linegroup)
    return;
  ...
  for (part = Start; part < sub1_end; part++) {
    ...
    if (size) {
      ...
      size[part] = SizeKeyFrameValues[skey] + SizeKeyFrameDeltas[skey] * (float)(part_age - SizeKeyFrameTimes[skey]) +
...
void ParticleBufferClass::Get_New_Particles(void) {
  ...
  for (; NewParticleQueueCount;) {
    ...
    // velocity.
    if (HasAccel) {
      position[NewEnd] = new_particle.Position + (new_particle.Velocity + 0.5f * Accel * fp_age) * fp_age;

      Velocity[NewEnd] = new_particle.Velocity + (Accel * fp_age);
    } else {
      position[NewEnd] = new_particle.Position + (new_particle.Velocity * fp_age);
...
void ParticleBufferClass::Get_Color_Key_Frames(ParticlePropertyStruct<Vector3> &colors) const {
  ...
  if ((ColorKeyFrameDeltas != NULL) &&
      ((ColorKeyFrameDeltas[NumColorKeyFrames - 1].X != 0) || (ColorKeyFrameDeltas[NumColorKeyFrames - 1].Y != 0) ||
...
void ParticleBufferClass::Get_Opacity_Key_Frames(ParticlePropertyStruct<float> &opacities) const {
  ...
  //	Determine if there is a keyframe at the very end of the particle's lifetime
  //
  if ((AlphaKeyFrameDeltas != NULL) && (AlphaKeyFrameDeltas[NumAlphaKeyFrames - 1] != 0)) {
    real_keyframe_count++;
    create_last_keyframe = true;
  }
...
void ParticleBufferClass::Get_Size_Key_Frames(ParticlePropertyStruct<float> &sizes) const {
  ...
  //	Determine if there is a keyframe at the very end of the particle's lifetime
  //
  if ((SizeKeyFrameDeltas != NULL) && (SizeKeyFrameDeltas[NumSizeKeyFrames - 1] != 0)) {
    real_keyframe_count++;
    create_last_keyframe = true;
  }
...
void ParticleBufferClass::Get_Rotation_Key_Frames(ParticlePropertyStruct<float> &rotations) const {
  ...
  /*
  ** NOTE: Rotations are stored internally in rotations per millisecond. These will be converted to rotations per
  *second.
  */
  ...
  //	Determine if there is a keyframe at the very end of the particle's lifetime
  //
  if ((HalfRotationKeyFrameDeltas != NULL) && (HalfRotationKeyFrameDeltas[NumRotationKeyFrames - 1] != 0)) {
    real_keyframe_count++;
    create_last_keyframe = true;
  }
...
void ParticleBufferClass::Get_Frame_Key_Frames(ParticlePropertyStruct<float> &frames) const {
  ...
  //	Determine if there is a keyframe at the very end of the particle's lifetime
  //
  if ((FrameKeyFrameDeltas != NULL) && (FrameKeyFrameDeltas[NumFrameKeyFrames - 1] != 0)) {
    real_keyframe_count++;
    create_last_keyframe = true;
  }
...
void ParticleBufferClass::Get_Blur_Time_Key_Frames(ParticlePropertyStruct<float> &blurtimes) const {
  ...
  //	Determine if there is a keyframe at the very end of the particle's lifetime
  //
  if ((BlurTimeKeyFrameDeltas != NULL) && (BlurTimeKeyFrameDeltas[NumBlurTimeKeyFrames - 1] != 0)) {
    real_keyframe_count++;
    create_last_keyframe = true;
  }
