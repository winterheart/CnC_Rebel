...
private:
  ...
  */
  struct CullNodeStruct {
    CullNodeStruct(void)
        : Index(0), Min(0, 0, 0), Max(0, 0, 0), Front(NULL), Back(NULL), PolyCount(0), PolyIndices(NULL) {}
    ~CullNodeStruct(void) {
      if (Front) {
        delete Front;
      }
  ...
  */
  struct SplitChoiceStruct {
    SplitChoiceStruct(void)
        : Cost(FLT_MAX), FrontCount(0), BackCount(0), BMin(BIG_VERTEX, BIG_VERTEX, BIG_VERTEX),
          BMax(SMALL_VERTEX, SMALL_VERTEX, SMALL_VERTEX), FMin(BIG_VERTEX, BIG_VERTEX, BIG_VERTEX),
          FMax(SMALL_VERTEX, SMALL_VERTEX, SMALL_VERTEX), Plane(AAPlaneClass::XNORMAL, 0) {}
  ...
  struct SplitArraysStruct {
    SplitArraysStruct(void) : FrontCount(0), BackCount(0), FrontPolys(NULL), BackPolys(NULL) {}
  ...
  */
  ...
  void Build_W3D_AABTree_Recursive(CullNodeStruct *node, W3dMeshAABTreeNode *w3dnodes, uint32 *poly_indices,
