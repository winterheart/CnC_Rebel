...
TexProjectClass::TexProjectClass(void)
    : Flags(DEFAULT_FLAGS), DesiredIntensity(1.0f), Intensity(1.0f), Attenuation(1.0f), MaterialPass(NULL),
      Mapper1(NULL), RenderTarget(NULL), HFov(90.0f), VFov(90.0f), XMin(-10.0f), XMax(10.0f), YMin(-10.0f), YMax(10.0f),
 ...
 *   1/4/00     gth : Created.                                                                 *
 *=============================================================================================*/
int TexProjectClass::Get_Texture_Size(void) { return (Flags & SIZE_MASK) >> SIZE_SHIFT; }
 ...
 *   1/11/00    gth : Created.                                                                 *
 *=============================================================================================*/
bool TexProjectClass::Compute_Perspective_Projection(RenderObjClass *model, const Vector3 &lightpos, float znear,
                                                     float zfar) {
  if (model == NULL) {
 ...
 *   1/11/00    gth : Created.                                                                 *
 *=============================================================================================*/
bool TexProjectClass::Compute_Perspective_Projection(const AABoxClass &obj_box, const Matrix3D &tm,
                                                     const Vector3 &lightpos, float user_znear, float user_zfar) {
  /*
 ...
 *   1/11/00    gth : Created.                                                                 *
 *=============================================================================================*/
bool TexProjectClass::Compute_Ortho_Projection(RenderObjClass *model, const Vector3 &lightdir, float znear,
                                               float zfar) {
  if (model == NULL) {
    WWDEBUG_SAY(("Attempting to generate projection for a NULL model\r\n"));
    return false;
 ...
 *   1/11/00    gth : Created.                                                                 *
 *=============================================================================================*/
bool TexProjectClass::Compute_Ortho_Projection(const AABoxClass &obj_box, const Matrix3D &tm, const Vector3 &lightdir,
                                               float user_znear, float user_zfar) {
  /*
  ** Compute the center of the box in world-space
  */
  ...
  ** All done!
  */
  Set_Ortho_Projection(box.Center.X - box.Extent.X, box.Center.X + box.Extent.X, box.Center.Y - box.Extent.Y,
                       box.Center.Y + box.Extent.Y, znear, zfar);
  Set_Transform(texture_tm);
  return true;
}
 ...
 *=============================================================================================*/
bool TexProjectClass::Needs_Render_Target(void) { return Get_Flag(TEXTURE_DIRTY); }
