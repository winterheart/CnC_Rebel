...
SegmentedLineClass::SegmentedLineClass(const SegmentedLineClass &src)
    : MaxSubdivisionLevels(src.MaxSubdivisionLevels), NormalizedScreenArea(src.NormalizedScreenArea),
      PointLocations(src.PointLocations), LineRenderer(src.LineRenderer) {}
...
void SegmentedLineClass::Add_Point(const Vector3 &location) { PointLocations.Add(location); }
...
TextureClass *SegmentedLineClass::Get_Texture(void) { return LineRenderer.Get_Texture(); }

ShaderClass SegmentedLineClass::Get_Shader(void) { return LineRenderer.Get_Shader(); }

void SegmentedLineClass::Get_Color(Vector3 &color) { color.Set(LineRenderer.Get_Color()); }

float SegmentedLineClass::Get_Opacity(void) { return LineRenderer.Get_Opacity(); }

float SegmentedLineClass::Get_Noise_Amplitude(void) { return LineRenderer.Get_Noise_Amplitude(); }

float SegmentedLineClass::Get_Merge_Abort_Factor(void) { return LineRenderer.Get_Merge_Abort_Factor(); }

unsigned int SegmentedLineClass::Get_Subdivision_Levels(void) { return MaxSubdivisionLevels; }
...
float SegmentedLineClass::Get_Texture_Tile_Factor(void) { return LineRenderer.Get_Texture_Tile_Factor(); }

Vector2 SegmentedLineClass::Get_UV_Offset_Rate(void) { return LineRenderer.Get_UV_Offset_Rate(); }

int SegmentedLineClass::Is_Merge_Intersections(void) { return LineRenderer.Is_Merge_Intersections(); }

int SegmentedLineClass::Is_Freeze_Random(void) { return LineRenderer.Is_Freeze_Random(); }

int SegmentedLineClass::Is_Sorting_Disabled(void) { return LineRenderer.Is_Sorting_Disabled(); }

int SegmentedLineClass::Are_End_Caps_Enabled(void) { return LineRenderer.Are_End_Caps_Enabled(); }

void SegmentedLineClass::Set_Texture(TextureClass *texture) { LineRenderer.Set_Texture(texture); }
...
void SegmentedLineClass::Set_Color(const Vector3 &color) { LineRenderer.Set_Color(color); }

void SegmentedLineClass::Set_Opacity(float opacity) { LineRenderer.Set_Opacity(opacity); }
...
void SegmentedLineClass::Set_Merge_Abort_Factor(float factor) { LineRenderer.Set_Merge_Abort_Factor(factor); }
...
void SegmentedLineClass::Set_Texture_Tile_Factor(float factor) { LineRenderer.Set_Texture_Tile_Factor(factor); }

void SegmentedLineClass::Set_UV_Offset_Rate(const Vector2 &rate) { LineRenderer.Set_UV_Offset_Rate(rate); }
...
RenderObjClass *SegmentedLineClass::Clone(void) const { return NEW_REF(SegmentedLineClass, (*this)); }
...
int SegmentedLineClass::Get_LOD_Level(void) const { return (int)LineRenderer.Get_Current_Subdivision_Level(); }

int SegmentedLineClass::Get_LOD_Count(void) const { return (int)MaxSubdivisionLevels; }
/*
