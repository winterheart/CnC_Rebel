...
CameraClass::CameraClass(void)
    : Projection(PERSPECTIVE), Viewport(Vector2(0, 0), Vector2(1, 1)), // pixel viewport to render into
      AspectRatio(4.0f / 3.0f), ZNear(1.0f),                           // near clip plane distance
...
CameraClass::CameraClass(const CameraClass &src)
    : RenderObjClass(src), Projection(src.Projection), Viewport(src.Viewport), ViewPlane(src.ViewPlane),
      ZNear(src.ZNear), ZFar(src.ZFar), FrustumValid(src.FrustumValid), Frustum(src.Frustum),
      NearClipBBox(src.NearClipBBox), ProjectionTransform(src.ProjectionTransform),
      CameraInvTransform(src.CameraInvTransform), AspectRatio(src.AspectRatio), ZBufferMin(src.ZBufferMin),
 ...
 *   3/21/98    GTH : Created.                                                                 *
 *=============================================================================================*/
RenderObjClass *CameraClass::Clone(void) const { return NEW_REF(CameraClass, (*this)); }
...
void CameraClass::Update_Frustum(void) const {
  ...
  if (Projection == PERSPECTIVE) {
    ...
    ProjectionTransform.Init_Perspective(vpmin.X * znear_dist, vpmax.X * znear_dist, vpmin.Y * znear_dist,
