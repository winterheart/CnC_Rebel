...
bool INIClass::Is_Loaded() const { return (!SectionList->Is_Empty()); }
 ...
 * HISTORY:                                                                                    *
 *=============================================================================================*/
INIClass::INIClass() : Filename(nullptr) { Initialize(); }
...
INIClass::INIClass(FileClass &file) : Filename(nullptr) {
  Initialize();
  Load(file);
}
...
INIClass::INIClass(const char *filename) : Filename(nullptr) {
  Initialize();
 ...
 *=============================================================================================*/
const char *INIClass::Get_Filename() const { return Filename; }
 ...
 *   9/29/99    EHC : Created.                                                                 *
 *=============================================================================================*/
unsigned INIClass::Enumerate_Entries(const char *Section, const char *Entry_Prefix, unsigned StartNumber,
                                     unsigned EndNumber) {
 ...
 *=============================================================================================*/
const WideStringClass &INIClass::Get_Wide_String(WideStringClass &new_string, char const *section, char const *entry,
                                                 wchar_t const *defvalue) const {
  wchar_t out[1024];
  char buffer[1024];
...
int INIClass::Get_String(char const *section, char const *entry, char const *defvalue, char *buffer, int size) const {
  ...
  */
  ...
  //		buffer[0] = '\0';
  //	}
  if (buffer == nullptr || size < 2 || section == nullptr || entry == nullptr)
    return (0);
...
** GetString
*/
const StringClass &INIClass::Get_String(StringClass &new_string, char const *section, char const *entry,
 ...
 *   09/19/1997 JLB : Created.                                                                 *
 *=============================================================================================*/
TPoint3D<float> const INIClass::Get_Point(char const *section, char const *entry,
 ...
 *=============================================================================================*/
TPoint2D<float> const INIClass::Get_Point(char const *section, char const *entry,
...
void INIClass::Keep_Blank_Entries(bool keep_blanks) { KeepBlankEntries = keep_blanks; }
