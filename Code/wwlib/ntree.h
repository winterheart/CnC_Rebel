...
public:
  ...
  //	Public constructors/destructors
  //////////////////////////////////////////////////////////////
  NTreeLeafClass(void) : m_Parent(NULL), m_Child(NULL), m_PrevSibling(NULL), m_NextSibling(NULL) {}
...
//	~NTreeLeafClass
/////////////////////////////////////////////////////////
template <class T> NTreeLeafClass<T>::~NTreeLeafClass(void) {
...
//	Remove
/////////////////////////////////////////////////////////
template <class T> void NTreeLeafClass<T>::Remove(void) {
  Add_Ref();
