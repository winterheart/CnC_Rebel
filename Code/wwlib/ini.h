...
public:
  ...
  */
  unsigned Enumerate_Entries(const char *section, const char *entry_prefix, unsigned startnumber = 0,
  ...
  */
  ...
  const StringClass &Get_String(StringClass &new_string, char const *section, char const *entry,
