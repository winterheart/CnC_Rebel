...
**
**********************************************************************************************/
template <class T, int BLOCK_SIZE = 64> class AutoPoolClass {
public:
 ...
 *   7/29/99    GTH : Created.                                                                 *
 *=============================================================================================*/
template <class T, int BLOCK_SIZE> void ObjectPoolClass<T, BLOCK_SIZE>::Free_Object(T *obj) {
  // destruct the object
  obj->T::~T();
 ...
 *   7/29/99    GTH : Created.                                                                 *
 *=============================================================================================*/
template <class T, int BLOCK_SIZE> void *AutoPoolClass<T, BLOCK_SIZE>::operator new(size_t size) {
