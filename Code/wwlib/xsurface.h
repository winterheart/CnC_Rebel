...
public:
  ...
  **	operation.
  */
  static bool Prep_For_Blit(Surface &dest, Rect &drect, Surface const &source, Rect &srect, bool &overlapped,
                            void *&dbuffer, void *&sbuffer);
  static bool Prep_For_Blit(Surface &dest, Rect const &dcliprect, Rect &drect, Surface const &source,
