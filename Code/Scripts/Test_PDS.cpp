...
DECLARE_SCRIPT(PDS_Generic_Test,
               ""){void Created(GameObject * game_obj){Commands->Start_Timer(game_obj, this, 3.0F, 777);
return;
}
...
DECLARE_SCRIPT(PDS_Test_Modify_Attack,
               "WaypathID=:int"){void Created(GameObject * game_obj){Commands->Start_Timer(game_obj, this, 3.0F, 777);
return;
}
...
DECLARE_SCRIPT(PDS_Test_Conversation,
...
DECLARE_SCRIPT(PDS_Test_Goto_Loc,
               "ObjDestID=:int"){////////////////////////////////////////////////////////////////////
                                 //	Created
                                 ////////////////////////////////////////////////////////////////////
                                 void Created(GameObject * game_obj){Commands->Start_Timer(game_obj, this, 3.0F, 777);
...
DECLARE_SCRIPT(PDS_Test_Follow_Waypath, "WaypathID=:int,WaypointStartID=:int,WaypointEndID=:int"){
    void Created(GameObject * game_obj){Commands->Grant_Key(game_obj, 0, true);
...
void Timer_Expired(GameObject *game_obj, int timer_id) {
  //		Commands->Action_Movement_Follow_Waypath (game_obj, Get_Int_Parameter(0), Get_Int_Parameter(1),
  //Get_Int_Parameter(2), true);
...
DECLARE_SCRIPT(PDS_Test_Bubba, "") {
  ...
  enum { STATE_DYING = 0, STATE_FOLLOWING, STATE_CRINGING };
...
DECLARE_SCRIPT(PDS_Test_Controller,
               ""){////////////////////////////////////////////////////////////////////
                   //	Created
                   ////////////////////////////////////////////////////////////////////
                   void Created(GameObject * game_obj){Commands->Start_Timer(game_obj, this, 2.0F, 777);
return;
}
...
DECLARE_SCRIPT(PDS_Test_Gunboat, "") {
  ...
  enum { STATE_AT_BEACHHEAD = 0, STATE_AT_INLET, STATE_FIGHTING_BIG_GUN, STATE_IN_TRANSIT };
