...
void M00_Controller_Trigger_RMV(GameObject *obj, GameObject *target, float time_lower_bound, float time_upper_bound,
                                int custom_type, int custom_param) {
...
DECLARE_SCRIPT(M00_Trigger_When_Killed_RMV,
    ...
    if (script_enabled) {
      ...
      if (target) {
        ...
        SCRIPT_DEBUG_MESSAGE(
            ("ERROR - M00_Trigger_When_Killed_RMV could not find its target object, id = %d!\n", target_id));
      }
    }
  }
  ...
  void Custom(GameObject * obj, int type, int param, GameObject *sender) {
    ...
    if ((type == M00_CUSTOM_TRIGGER_ACTIVATE_ALL) || (type == M00_CUSTOM_TRIGGER_ACTIVATE_KILLED) ||
        (type == Get_Int_Parameter("Receive_Type"))) {
...
DECLARE_SCRIPT(M00_Trigger_When_Destroyed_RMV,
  ...
  void Destroyed(GameObject * obj) {
    ...
    if (script_enabled) {
      ...
      if (target) {
        ...
        SCRIPT_DEBUG_MESSAGE(
            ("ERROR - M00_Trigger_When_Destroyed_RMV could not find its target object, id = %d!\n", target_id));
      }
    }
  }
  ...
  void Custom(GameObject * obj, int type, int param, GameObject *sender) {
    ...
    if ((type == M00_CUSTOM_TRIGGER_ACTIVATE_ALL) || (type == M00_CUSTOM_TRIGGER_ACTIVATE_DESTROYED) ||
        (type == Get_Int_Parameter("Receive_Type"))) {
      if (param == Get_Int_Parameter("Receive_Param_On")) {
        SCRIPT_DEBUG_MESSAGE(("M00_Trigger_When_Destroyed_RMV ENABLED.\n"));
        script_enabled = true;
...
DECLARE_SCRIPT(
    ...
    "Target_ID:int, Send_Type:int, Send_Parameter:int, Min_Delay=0.0:float, Max_Delay=0.0:float, Debug_Mode=0:int") {
  bool debug_mode;
  ...
  void Created(GameObject * obj) {
    ...
    if (target) {
      ...
      SCRIPT_DEBUG_MESSAGE(
          ("ERROR - M00_Trigger_When_Created_RMV could not find its target object, id = %d!\n", target_id));
    }
  }
};
...
DECLARE_SCRIPT(M00_Trigger_Zone_Entered_RMV,
  ...
  typedef enum { ANYONE, COMMANDO, NONCOMMANDO } EntererType;
  EntererType allowed;
  ...
  void Entered(GameObject * obj, GameObject * enterer) {
    if (script_enabled) {
      ...
      if (target) {
        ...
        SCRIPT_DEBUG_MESSAGE(
            ("ERROR - M00_Trigger_Zone_Entered_RMV did not find its target object, id = %d!\n", target_id));
      }
    }
  }
  ...
  void Custom(GameObject * obj, int type, int param, GameObject *sender) {
    ...
    if ((type == M00_CUSTOM_TRIGGER_ACTIVATE_ALL) || (type == M00_CUSTOM_TRIGGER_ACTIVATE_ZONE_ENTERED) ||
        (type == Get_Int_Parameter("Receive_Type"))) {
      if (param == Get_Int_Parameter("Receive_Param_On")) {
        SCRIPT_DEBUG_MESSAGE(("M00_Trigger_Zone_Entered_RMV ENABLED.\n"));
        script_enabled = true;
...
DECLARE_SCRIPT(M00_Trigger_Zone_Exited_RMV,
  ...
  void Exited(GameObject * obj, GameObject * enterer) {
    if (script_enabled) {
      ...
      if (target) {
        ...
        SCRIPT_DEBUG_MESSAGE(
            ("ERROR - M00_Trigger_Zone_Exited_RMV could not find its target object, id = %d!\n", target_id));
      }
    }
  }
...
DECLARE_SCRIPT(M00_Trigger_Zone_Entered_Or_Exited_RMV,
  ...
  void Exited(GameObject * obj, GameObject * enterer) {
    if (script_enabled) {
      ...
      if (target) {
        ...
        SCRIPT_DEBUG_MESSAGE(
            ("ERROR - M00_Trigger_Zone_Entered_Or_Exited_RMV did not find its target object, id = %d!\n", target_id));
      }
    }
  }
  ...
  void Entered(GameObject * obj, GameObject * enterer) {
    if (script_enabled) {
      ...
      if (target) {
        ...
        SCRIPT_DEBUG_MESSAGE(
            ("ERROR - M00_Trigger_Zone_Entered_Or_Exited_RMV could not find its target object, id = %d!\n", target_id));
      }
    }
  }
...
DECLARE_SCRIPT(M00_Trigger_When_Enemy_Seen_RMV,
  ...
  void Enemy_Seen(GameObject * obj, GameObject * enemy) {
    if (script_enabled) {
      ...
      if (target) {
        ...
        SCRIPT_DEBUG_MESSAGE(
            ("ERROR - M00_Trigger_When_Enemy_Seen_RMV could not find its target object, id = %d!\n", target_id));
      }
    }
  }
  ...
  void Custom(GameObject * obj, int type, int param, GameObject *sender) {
    ...
    if ((type == M00_CUSTOM_TRIGGER_ACTIVATE_ALL) || (type == M00_CUSTOM_TRIGGER_ACTIVATE_ENEMY_SEEN) ||
        (type == Get_Int_Parameter("Receive_Type"))) {
      if (param == Get_Int_Parameter("Receive_Param_On")) {
        SCRIPT_DEBUG_MESSAGE(("M00_Trigger_When_Enemy_Seen_RMV ENABLED.\n"));
        script_enabled = true;
...
DECLARE_SCRIPT(
    ...
    "Send_Type:int, Send_Param:int, Min_Delay=0.0:float, Max_Delay=0.0:float, Trigger_Count=0:int, Debug_Mode=0:int") {
  bool script_enabled;
  int trigger_count;
  bool debug_mode;
  ...
  void Damaged(GameObject * obj, GameObject * damager, float amount) {
    if (script_enabled) {
      ...
      if (target) {
        ...
        SCRIPT_DEBUG_MESSAGE(
            ("ERROR - M00_Trigger_When_Damaged_RMV could not find the target object, id = %d!\n", target_id));
      }
    }
  }
  ...
  void Custom(GameObject * obj, int type, int param, GameObject *sender) {
    ...
    if ((type == M00_CUSTOM_TRIGGER_ACTIVATE_ALL) || (type == M00_CUSTOM_TRIGGER_ACTIVATE_DAMAGED) ||
        (type == Get_Int_Parameter("Receive_Type"))) {
      if (param == Get_Int_Parameter("Receive_Param_On")) {
        SCRIPT_DEBUG_MESSAGE(("M00_Trigger_When_Damaged_RMV ENABLED.\n"));
        script_enabled = true;
...
DECLARE_SCRIPT(M00_Trigger_When_Action_Complete_RMV,
  ...
  void Action_Complete(GameObject * obj, int action_id) {
    if (script_enabled) {
      ...
      if (target) {
        ...
        SCRIPT_DEBUG_MESSAGE(
            ("ERROR - M00_Trigger_When_Action_Complete_RMV cannot find its target object, id = %d!\n", target_id));
      }
    }
  }
  ...
  void Custom(GameObject * obj, int type, int param, GameObject *sender) {
    ...
    if ((type == M00_CUSTOM_TRIGGER_ACTIVATE_ALL) || (type == M00_CUSTOM_TRIGGER_ACTIVATE_ACTION_COMPLETE) ||
        (type == Get_Int_Parameter("Receive_Type"))) {
      if (param == Get_Int_Parameter("Receive_Param_On")) {
...
DECLARE_SCRIPT(M00_Trigger_When_Animation_Complete_RMV,
  ...
  void Animation_Complete(GameObject * obj, const char *name) {
    if (script_enabled) {
      SCRIPT_DEBUG_MESSAGE(
          ("Animation complete by unit with active M00_Trigger_When_Animation_Complete_RMV attached.\n"));
      if (trigger_count == 1) {
        script_enabled = false;
      }
      if (trigger_count > 0) {
      ...
      if (target) {
        ...
        SCRIPT_DEBUG_MESSAGE(
            ("ERROR - M00_Trigger_When_Animation_Complete_RMV cannot find its target object, id = %d!\n", target_id));
      }
    }
  }
  ...
  void Custom(GameObject * obj, int type, int param, GameObject *sender) {
    ...
    if ((type == M00_CUSTOM_TRIGGER_ACTIVATE_ALL) || (type == M00_CUSTOM_TRIGGER_ACTIVATE_ANIMATION_COMPLETE) ||
        (type == Get_Int_Parameter("Receive_Type"))) {
      if (param == Get_Int_Parameter("Receive_Param_On")) {
        SCRIPT_DEBUG_MESSAGE(("M00_Trigger_When_Animation_Complete_RMV ENABLED.\n"));
        script_enabled = true;
...
DECLARE_SCRIPT(M00_Trigger_Timer_Expired_RAD,
      ...
      if (trigger_count) {
        ...
        if (timer_id == M00_TIMER_TRIGGER_EXPIRED) {
          ...
          if (target_obj) {
            ...
            Commands->Send_Custom_Event(obj, target_obj, Get_Int_Parameter("Send_Type"),
                                        Get_Int_Parameter("Send_Param"), delay_value);
          }
        } else {
  ...
  void Custom(GameObject * obj, int type, int param, GameObject *sender) {
    ...
    if ((type == M00_CUSTOM_TRIGGER_ACTIVATE_ALL) || (type == M00_CUSTOM_TRIGGER_TIMER_EXPIRED) ||
        (type == Get_Int_Parameter("Receive_Type"))) {
      if (param == Get_Int_Parameter("Receive_Param_On")) {
        script_active = true;
        trigger_count = Get_Int_Parameter("Trigger_Count");
...
DECLARE_SCRIPT(M00_Trigger_State_Sequence_RAD,
  ...
  void Send_Custom(GameObject * obj) {
    ...
    if (state_num) {
      ...
      if (target_obj) {
        ...
        SCRIPT_DEBUG_MESSAGE(
            ("ERROR - M00_Trigger_State_Sequence_RAD could not find its target object, id = %d!\n", target_id));
      }
    }
  }
};
