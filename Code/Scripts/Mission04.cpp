  ...
  void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason complete_reason) {
    ...
    case ACTION_COMPLETE_CONVERSATION_ENDED: //
    {
      if (action_id == missionIntroConv) // rescue prisoners here
      {
        ...
        Commands->Add_Objective(100, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_PENDING, IDS_Enc_ObjTitle_Primary_M04_01,
                                NULL, IDS_Enc_Obj_Primary_M04_01);
        Commands->Add_Radar_Marker(101, Commands->Get_Position(Commands->Find_Object(M04_PRISON_PRISONER_01_JDG)),
                                   RADAR_BLIP_SHAPE_OBJECTIVE, RADAR_BLIP_COLOR_PRIMARY_OBJECTIVE);
        Commands->Add_Radar_Marker(102, Commands->Get_Position(Commands->Find_Object(M04_PRISON_PRISONER_02_JDG)),
                                   RADAR_BLIP_SHAPE_OBJECTIVE, RADAR_BLIP_COLOR_PRIMARY_OBJECTIVE);
        Commands->Add_Radar_Marker(103, Commands->Get_Position(Commands->Find_Object(M04_PRISON_PRISONER_03_JDG)),
                                   RADAR_BLIP_SHAPE_OBJECTIVE, RADAR_BLIP_COLOR_PRIMARY_OBJECTIVE);
      ...
      else if (action_id == missileConv) // sabotage missile racks  M04_Add_MissileRoom_Objective_Conversation_02
      {
        ...
        Commands->Add_Objective(300, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_PENDING, IDS_Enc_ObjTitle_Primary_M04_03,
                                NULL, IDS_Enc_Obj_Primary_M04_03);
        ...
        /*int missileConv02 = Commands->Create_Conversation( "M04_Add_MissileRoom_Objective_Conversation_02", 100, 1000,
        false); Commands->Join_Conversation( NULL, missileConv02, false, false, true ); Commands->Start_Conversation(
        missileConv02,  missileConv02 );*/
      ...
      else if (action_id == engineIntroConv) // destroy engine terminals
      {
        ...
        Commands->Add_Objective(200, OBJECTIVE_TYPE_SECONDARY, OBJECTIVE_STATUS_PENDING,
                                IDS_Enc_ObjTitle_Secondary_M04_02, NULL, IDS_Enc_Obj_Secondary_M04_02);
      ...
      {
        Commands->Add_Objective(110, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_PENDING, IDS_Enc_ObjTitle_Primary_M04_02,
                                NULL, IDS_Enc_Obj_Primary_M04_02);
      ...
      else if (action_id == medlab_conv) // get prison key from guard
      {
        ...
        if (warden != NULL) {
          ...
          Commands->Add_Radar_Marker(111, wardenLocation, RADAR_BLIP_SHAPE_OBJECTIVE,
      ...
      {
        Commands->Create_Sound("00-n040e", Vector3(0, 0, 0), obj);
        Commands->Add_Objective(600, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_PENDING, IDS_Enc_ObjTitle_Primary_M04_07,
                                NULL, IDS_Enc_Obj_Primary_M04_07);
        Commands->Add_Radar_Marker(601, Commands->Get_Position(Commands->Find_Object(M04_SHIPS_FIRST_MATE_JDG)),
                                   RADAR_BLIP_SHAPE_OBJECTIVE, RADAR_BLIP_COLOR_PRIMARY_OBJECTIVE);
      ...
      {
        Commands->Add_Objective(800, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_PENDING, IDS_Enc_ObjTitle_Primary_M04_06,
                                NULL, IDS_Enc_Obj_Primary_M04_06);
        Commands->Add_Radar_Marker(801, Vector3(2.55f, -5.29f, -16.96f), RADAR_BLIP_SHAPE_OBJECTIVE,
                                   RADAR_BLIP_COLOR_PRIMARY_OBJECTIVE);
    ...
    ***********************************************************************************************************/
    ...
    if (type == 0) {
      ...
      else if (param == announce_missile_room_objective) //
      {
        ...
        // Commands->Create_Sound ( "00-n040e", Vector3 (0,0,0), obj);
        Commands->Add_Objective(400, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_PENDING, IDS_Enc_ObjTitle_Primary_M04_04,
                                NULL, IDS_Enc_Obj_Primary_M04_04);
        Commands->Add_Radar_Marker(401, Commands->Get_Position(Commands->Find_Object(100409)),
                                   RADAR_BLIP_SHAPE_OBJECTIVE, RADAR_BLIP_COLOR_PRIMARY_OBJECTIVE);
        Commands->Add_Radar_Marker(402, Commands->Get_Position(Commands->Find_Object(100410)),
                                   RADAR_BLIP_SHAPE_OBJECTIVE, RADAR_BLIP_COLOR_PRIMARY_OBJECTIVE);
        Commands->Send_Custom_Event(obj, obj, 0, 1, 2); // this sets a small delay before havoc responds
        ...
        Commands->Add_Objective(500, OBJECTIVE_TYPE_SECONDARY, OBJECTIVE_STATUS_PENDING,
                                IDS_Enc_ObjTitle_Secondary_M04_03, NULL, IDS_Enc_Obj_Secondary_M04_03);
      ...
      else if (param == announce_first_mate_objective && first_mate_primary_active != true &&
               first_mate_primary_triggered == false) //
      {
      ...
      {
        int captainConv =
            Commands->Create_Conversation("M04_Add_Captains_Key_Objective_Conversation", 100, 1000, false);
        ...
        // Commands->Create_Sound ( "00-n040e", Vector3 (0,0,0), obj);
        Commands->Add_Objective(700, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_PENDING, IDS_Enc_ObjTitle_Primary_M04_05,
                                NULL, IDS_Enc_Obj_Primary_M04_05);
        Commands->Add_Radar_Marker(701, Commands->Get_Position(Commands->Find_Object(M04_SHIPS_CAPTAIN_JDG)),
                                   RADAR_BLIP_SHAPE_OBJECTIVE, RADAR_BLIP_COLOR_PRIMARY_OBJECTIVE);
      ...
      ***********************************************************************************************************/
        ...
        if ((mission_started == true) && (captain_primary_active == false) && (first_mate_primary_active == false) &&
            (torpedo_primary_active == false) && (missile_primary_active == false) &&
            (prisoner_primary_active == false)) {
      ...
      ***********************************************************************************************************/
      else if (param == missile_01_sabotaged) //
      {
        ...
        if (number_missiles_sabotaged == 1) {
          int missile_conv1 =
              Commands->Create_Conversation("M04_MissileRack_01_Sabotaged_Conversation", 100, 1000, true);
          ...
          int missile_conv1 =
              Commands->Create_Conversation("M04_MissileRack_02_Sabotaged_Conversation", 100, 1000, true);
          Commands->Join_Conversation(NULL, missile_conv1, false, false, false);
          Commands->Start_Conversation(missile_conv1, missile_conv1);
        }
          ...
          int missile_conv1 =
              Commands->Create_Conversation("M04_MissileRack_03_Sabotaged_Conversation", 100, 1000, true);
          Commands->Join_Conversation(NULL, missile_conv1, false, false, false);
          Commands->Start_Conversation(missile_conv1, missile_conv1);
        }
...
*****************************************************************************************************************/
DECLARE_SCRIPT(M04_PointGuard_JDG, ""){void Created(GameObject * obj){Commands->Set_Innate_Is_Stationary(obj, true);
}
...
DECLARE_SCRIPT(M04_A01_Sniper_JDG, ""){void Created(GameObject * obj){ActionParamsStruct params;
...
void Damaged(GameObject *obj, GameObject *damager, float amount) { Commands->Action_Reset(obj, 100); }
...
*************************************************************************************************************/
DECLARE_SCRIPT(M04_MissileRoom_EnterZone_Left_JDG, ""){void Entered(GameObject * obj, GameObject *enterer){
    if (enterer == STAR){Commands->Send_Custom_Event(obj, Commands->Find_Object(M04_CARGOHOLD_CONTROLLER_JDG), 0, 600,
                                                     0); // have leftside guard come in
Commands->Send_Custom_Event(obj, Commands->Find_Object(M04_CARGOHOLD_CONTROLLER_JDG), 0, 200,
                            0); // put missile room guys to 50% priority
...
DECLARE_SCRIPT(M04_MissileRoom_EnterZone_Right_JDG, ""){void Entered(GameObject * obj, GameObject *enterer){
    if (enterer == STAR){Commands->Send_Custom_Event(obj, Commands->Find_Object(M04_CARGOHOLD_CONTROLLER_JDG), 0, 500,
                                                     0); // have rightside guard come in
Commands->Send_Custom_Event(obj, Commands->Find_Object(M04_CARGOHOLD_CONTROLLER_JDG), 0, 200,
                            0); // put missile room guys to 50% priority
...
DECLARE_SCRIPT(M04_CargoMissileRooms_Dude_Controller_JDG,
               "") // this guys ID number is M04_CARGOHOLD_CONTROLLER_JDG 100558
{
  ...
  void Custom(GameObject * obj, int type, int param, GameObject *sender) {
    if (param == 100) {
      ...
      GameObject *missileRoomUpperguardOne =
          Commands->Create_Object("Nod_MiniGunner_0", Vector3(9.485f, -66.975f, -9.00f));
      ...
      GameObject *missileRoomUpperguardTwo =
          Commands->Create_Object("Nod_MiniGunner_0", Vector3(-9.456f, -61.862f, -9.00f));
  ...
  /*void Action_Complete (GameObject *obj, int action_id, ActionCompleteReason complete_reason)
  {
          if (complete_reason == ACTION_COMPLETE_CONVERSATION_ENDED)
          {
                  if (action_id == cargo_conv1)
                  {
                          ...
                          if (blackHand01 != NULL)
                          {
                                  Commands->Debug_Message ( "**********************cargo conv 01 is over--sending custom
...
DECLARE_SCRIPT(M04_MissileRoom_Guard_01_JDG, "") {
  ...
  REGISTER_VARIABLES() { SAVE_VARIABLE(curr_action_id, 1); }
  ...
  void Killed(GameObject * obj, GameObject * killer) {
    Commands->Send_Custom_Event(obj, Commands->Find_Object(M04_CARGOHOLD_CONTROLLER_JDG), 0, 300,
                                0); // tell controller youre dead
  }
...
****************************************************************************************************************/
DECLARE_SCRIPT(M04_EngineRoom_EnterZone_JDG, ""){void Entered(GameObject * obj, GameObject *enterer){
    if (enterer == STAR){Commands->Send_Custom_Event(obj, Commands->Find_Object(M04_OBJECTIVE_CONTROLLER_JDG), 0, 430,
                                                     0); // tell objective controller to announce objective
Commands->Send_Custom_Event(obj, Commands->Find_Object(M04_CARGOHOLD_CONTROLLER_JDG), 0, 700,
                            0); // tell cargo/missile contoller to turn off spawners
...
DECLARE_SCRIPT(M04_EngineRoom_BuildingController_JDG, "") // M04_ENGINEROOM_BUILDING_CONTROLLER_JDG	150001
{
  ...
  void Created(GameObject * obj) {
    ...
    engineroom_sound02 =
        Commands->Create_Sound("SFX.Machine_Turbine_01_offset2", Vector3(-6.021f, -104.445f, -15.157f), obj);
    engineroom_sound03 = Commands->Create_Sound("SFX.Ship_Amb_Engineroom", Vector3(-0.942f, -74.017f, -11.840f), obj);
    engineroom_sound04 =
        Commands->Create_Sound("SFX.Steam_Med_Pressure_01_offset1", Vector3(-9.838f, -76.426f, -13.498f), obj);
    ...
    if (type == 0) {
      if (param == M01_IVE_BEEN_KILLED_JDG) {
        ...
        if (targetsDestroyed == 4) {
          ...
          engineroom_sound03 =
              Commands->Create_Sound("SFX.Ship_Engine_Broken_01", Vector3(9.731f, -95.172f, -11.028f), obj);
          engineroom_sound04 =
              Commands->Create_Sound("SFX.Ship_Engine_Broken_01", Vector3(-2.976f, -91.511f, -12.275f), obj);
          engineroom_sound05 =
              Commands->Create_Sound("SFX.Ship_Engine_Broken_02", Vector3(3.918f, -84.200f, -11.625f), obj);
          engineroom_sound06 =
              Commands->Create_Sound("SFX.Ship_Engine_Broken_02", Vector3(-9.033f, -96.617f, -12.678f), obj);
          engineroom_sound07 =
              Commands->Create_Sound("SFX.Ship_Engine_Broken_03", Vector3(2.750f, -93.408f, -12.047f), obj);
          engineroom_sound08 =
              Commands->Create_Sound("SFX.Ship_Engine_Broken_03", Vector3(-7.275f, -83.744f, -12.941f), obj);
          ...
          Commands->Debug_Message(
              "**********************all engine room targets destroyed--applying damage to engine room\n");
...
DECLARE_SCRIPT(M04_EngineRoom_PrisonLift_EnterZone_JDG, ""){
    void Entered(GameObject * obj, GameObject *enterer){if (enterer == STAR){Vector3 spawnSpot(-0.512f, -95.434f, 0);
...
DECLARE_SCRIPT(M04_EngineRoom_LiftEngineer_JDG, ""){void Created(GameObject * obj){ActionParamsStruct params;
...
DECLARE_SCRIPT(M04_EngineRoom_Start_Guard_Conversation_Zone_JDG,
    ...
    if (enterer == STAR){GameObject *prisonGuard01 = Commands->Find_Object(M04_ENGINEROOM_PRISONGUARD_01_JDG);
      ...
      if (obj) {
        ...
        if (obj && guard02 != NULL) {
          const char *conversations[3] = {
              "M04_PrisonHazing_Conversation_01", "M04_PrisonHazing_Conversation_02",
          ...
          counter++;
             ...
             engineDestroyed == true) // controller is telling you to start acting--engines destroyed
    {
      Commands->Action_Reset(obj, 100);
...
DECLARE_SCRIPT(M04_EngineRoom_Prison_Guard_02_JDG, "") // M04_ENGINEROOM_PRISONGUARD_02_JDG 101989
{
  ...
  REGISTER_VARIABLES() { SAVE_VARIABLE(engineDestroyed, 1); }
...
DECLARE_SCRIPT(M04_EngineRoom_TalkToPrisoners_Zone_JDG, ""){void Entered(GameObject * obj, GameObject *enterer){
    if (enterer == STAR){bool playerHasLev01Card = Commands->Has_Key(STAR, 1);

if (playerHasLev01Card == false) {
  GameObject *prisoner01 = Commands->Find_Object(M04_PRISON_PRISONER_01_JDG);
  if (prisoner01 != NULL) {
    Commands->Send_Custom_Event(obj, prisoner01, 0, M01_MODIFY_YOUR_ACTION_04_JDG,
                                0); // tell prisoner 3 that Havoc is close by
  }
  ...
  void Custom(GameObject * obj, int type, int param, GameObject *sender) {
    ...
    else if (param == M01_MODIFY_YOUR_ACTION_03_JDG && wave_counter <= 4) //
    {
      ...
      wave_counter++;
             ...
             wave_counter < 100) // playre is in first talk zone--start conversation
    {
      Commands->Action_Reset(obj, 100);
      wave_counter = 100;
...
DECLARE_SCRIPT(M04_EngineRoom_Prisoner_02_JDG, "") // this guys ID number is M04_PRISON_PRISONER_02_JDG 101196
{
  ...
  REGISTER_VARIABLES() { SAVE_VARIABLE(firstTimeDamaged, 1); }
...
/*DECLARE_SCRIPT(M04_EngineRoom_Prisoner_02_JDG, "")//this guys ID number is M04_PRISON_PRISONER_02_JDG 101196
{
        ...
        void Damaged( GameObject * obj, GameObject * damager, float amount )
        {
                if (obj && damager == STAR)
                {
                        ...
                        if (firstTimeDamaged == true)
                        {
                                Commands->Create_Sound ( "00-N066E", Vector3 (0,0,0), obj );//you are firing on a
friendly unit firstTimeDamaged = false; ActionParamsStruct params; params.Set_Basic( this, 100,
M01_DOING_ANIMATION_02_JDG ); params.Set_Animation( "H_A_J21C", false ); Commands->Action_Play_Animation (  obj, params
); Vector3 myPosition = Commands->Get_Position ( obj ); Commands->Create_Sound ( "M04 PanicGuy 01 Twiddler", myPosition,
obj );
                        }
                }
        }
...
DECLARE_SCRIPT(M04_Prison_CellDoor_Zone_JDG, ""){void Created(GameObject * obj){
...
***********************************************************************************************************/
DECLARE_SCRIPT(M04_AftDeck_InnerSanctum_Entry_Zone_JDG, ""){void Entered(GameObject * obj, GameObject *enterer){
    if (enterer == STAR){Commands->Create_Sound("00-n060e", Commands->Get_Position(obj), obj); // updating radar flags
Commands->Send_Custom_Event(obj, Commands->Find_Object(M04_AFT_DECK_CONTROLLER_JDG), 0, 4000,
                            0); // tell aft deck controller that player is moving forward
...
{void Entered(GameObject * obj, GameObject *enterer){
    if (enterer == STAR){Commands->Create_Sound("00-n060e", Commands->Get_Position(obj), obj); // updating radar flags
Commands->Send_Custom_Event(obj, Commands->Find_Object(M04_AFT_DECK_CONTROLLER_JDG), 0, 5000,
                            0); // tell aft deck controller that player is moving forward
...
DECLARE_SCRIPT(M04_AftDeck_02_Controller_JDG, "") // this guys number is M04_AFT_DECK_CONTROLLER_JDG 100624
{
  ...
  void Custom(GameObject * obj, int type, int param, GameObject *sender) {
    ...
    else if (param == 4000) // player is moving up toward first mate
    {
      ...
      GameObject *rightBarrackspatrolGuy =
          Commands->Create_Object("Nod_MiniGunner_1Off", Vector3(-9.33f, -102.35f, 6.00f));
    ...
    else if (param == 5000) // player is almost at first mate
    {
      ...
      GameObject *blackHandMateGuard03 =
          Commands->Create_Object("Nod_FlameThrower_0", Vector3(-4.25f, -85.21f, 12.00f));
      Commands->Attach_Script(blackHandMateGuard03, "M04_Aft_FirstMateBodyguard_JDG", "");
      Commands->Set_Facing(blackHandMateGuard03, 175);

      GameObject *blackHandMateGuard04 =
...
DECLARE_SCRIPT(M04_Aft_FirstMateBodyguard_JDG, ""){void Created(GameObject * obj){Commands->Innate_Disable(obj);
}
...
DECLARE_SCRIPT(M04_SecondaryBridge_Enter_Zone_JDG, ""){void Entered(GameObject * obj, GameObject *enterer){
    if (enterer == STAR){Commands->Send_Custom_Event(obj, Commands->Find_Object(M04_SHIPS_FIRST_MATE_JDG), 0, 100,
                                                     0); // tell first mate to start hearing stuff
// Commands->Send_Custom_Event( obj, Commands->Find_Object (M04_OBJECTIVE_CONTROLLER_JDG), 0, 1000, 0 );//tell objective
// controller to play battle music
Commands->Send_Custom_Event(obj, Commands->Find_Object(M04_AFT_DECK_CONTROLLER_JDG), 0, 5500,
                            0); // tell bodyguards to goto innate
...
DECLARE_SCRIPT(M04_Player_Is_Leaving_Aft_Deck_JDG, ""){void Entered(GameObject * obj, GameObject *enterer){
    if (enterer == STAR){Commands->Send_Custom_Event(obj, Commands->Find_Object(M04_AFT_DECK_CONTROLLER_JDG), 0, 6000,
                                                     0); // tell aft deck controller to clean up any remaining soldiers
...
DECLARE_SCRIPT(M04_Aft_LeftBarracks_TalkGuy_JDG, ""){void Created(GameObject * obj){ActionParamsStruct params;
...
DECLARE_SCRIPT(M04_AftDeck_Reinforcement_JDG, ""){void Created(GameObject * obj){ActionParamsStruct params;
...
void Killed(GameObject *obj, GameObject *killer) {
  Commands->Send_Custom_Event(obj, Commands->Find_Object(M04_AFT_DECK_CONTROLLER_JDG), 0, 200,
                              0); // tell aft deck controller that you've been killed
}
...
DECLARE_SCRIPT(M04_AftDeck_02_PatrolGuy_01_JDG, ""){void Created(GameObject * obj){ActionParamsStruct params;
params.Set_Basic(this, 45, 100);
params.Set_Movement(Vector3(0, 0, 0), .20f, .25f);
...
DECLARE_SCRIPT(M04_AftDeck_02_PatrolGuy_02_JDG, ""){void Created(GameObject * obj){ActionParamsStruct params;
params.Set_Basic(this, 45, 100);
params.Set_Movement(Vector3(0, 0, 0), .20f, .25f);
...
DECLARE_SCRIPT(M04_AftDeck_02_Blackhand_PatrolGuy_JDG,
               ""){void Created(GameObject * obj){float delayTimer = Commands->Get_Random(2, 5);
...
DECLARE_SCRIPT(M04_AftDeck_02_Entry_Zone_JDG, ""){void Entered(GameObject * obj, GameObject *enterer){
    if (enterer == STAR){Commands->Create_Sound("00-n060e", Commands->Get_Position(obj), obj); // updating radar flags
Commands->Send_Custom_Event(obj, Commands->Find_Object(M04_AFT_DECK_CONTROLLER_JDG), 0, 100,
                            0); // tell aft deck controller to start scenario
...
DECLARE_SCRIPT(M04_Surprise_Apache_JDG, ""){void Created(GameObject * obj){Commands->Disable_Physical_Collisions(obj);
ActionParamsStruct params;
params.Set_Basic(this, 100, M01_WALKING_WAYPATH_01_JDG);
...
*************************************************************************************************************/
DECLARE_SCRIPT(M04_Apache_Enter_Zone_JDG, ""){void Entered(GameObject * obj, GameObject *enterer){
    if (enterer == STAR){Commands->Send_Custom_Event(obj, Commands->Find_Object(M04_APACHE_CONTROLLER_JDG), 0, 100,
                                                     0); // tell apache controller to place actors
...
DECLARE_SCRIPT(M04_ApacheRoom_Controller_JDG, "") // this guys ID number is M04_APACHE_CONTROLLER_JDG	200586
{
  ...
  REGISTER_VARIABLES() { SAVE_VARIABLE(m04apache_ID, 1); }

  void Created(GameObject * obj) { m04apache_ID = 0; }
  ...
  void Custom(GameObject * obj, int type, int param, GameObject *sender) {
    if (param == 100) // recieved custom from enter zones--here comes the player(s)
    {
      ...
      GameObject *m04apacheSniper01 =
          Commands->Create_Object("Nod_MiniGunner_2SF", Vector3(-13.728f, 63.244f, -9.003f));
...
DECLARE_SCRIPT(M04_ForeDeck_Initial_Enter_Zone_JDG, ""){void Entered(GameObject * obj, GameObject *enterer){
    if (enterer == STAR){Commands->Send_Custom_Event(obj, Commands->Find_Object(M04_FORE_DECK_CONTROLLER_JDG), 0, 100,
                                                     0); // tell ForeDeck controller that player(s) is approaching
...
DECLARE_SCRIPT(M04_MedLab_Enter_Zone_JDG, ""){void Entered(GameObject * obj, GameObject *enterer){
    if (enterer == STAR){Commands->Send_Custom_Event(obj, Commands->Find_Object(M04_PRISON_WARDEN_JDG), 0, 100,
                                                     0); // tell prison warden to start acting
Commands->Send_Custom_Event(obj, Commands->Find_Object(M04_MEDLAB_TECHNICIAN_JDG), 0, 100,
                            0); // tell medlab tech to start acting
...
DECLARE_SCRIPT(M04_ForeDeck_Reinforcement_JDG, ""){void Created(GameObject * obj){ActionParamsStruct params;
...
void Killed(GameObject *obj, GameObject *killer) {
  Commands->Send_Custom_Event(obj, Commands->Find_Object(M04_FORE_DECK_CONTROLLER_JDG), 0, 200,
                              0); // tell controller you've been killed
}
}
;
...
DECLARE_SCRIPT(M04_ForeDeck_Controller_JDG, "") // this guys ID number is M04_FORE_DECK_CONTROLLER_JDG 100790
{
  ...
  void Custom(GameObject * obj, int type, int param, GameObject *sender) {
    if (param == 100) // recieved custom from enter zones--here comes the player(s)
    {
      ...
      GameObject *mapRoomGuard01 =
          Commands->Create_Object("Nod_Minigunner_2SF_AutoRifle", Vector3(5.99f, 91.56f, -6.0f));
      Commands->Attach_Script(mapRoomGuard01, "M04_ForeDeck_MapRoom_Guard01_JDG", "");

      GameObject *mapRoomGuard02 =
          Commands->Create_Object("Nod_Minigunner_2SF_AutoRifle", Vector3(-6.46f, 92.67f, -6.0f));
    ...
    else if (param == 500) // player is moving toward captain from grunt mess hall
    {
      ...
      GameObject *closetGuy01 =
          Commands->Create_Object("Nod_Minigunner_2SF_AutoRifle", Vector3(-3.361f, 79.633f, 3.0f));
      ...
      GameObject *BH_messhall_guy01 =
          Commands->Create_Object("Nod_Minigunner_2SF_AutoRifle", Vector3(5.89f, 88.47f, 6.0f));
      Commands->Attach_Script(BH_messhall_guy01, "M04_BH_MessHall_Guy_JDG", "");
      Commands->Set_Facing(BH_messhall_guy01, -135);

      GameObject *BH_messhall_guy02 =
          Commands->Create_Object("Nod_Minigunner_2SF_AutoRifle", Vector3(5.30f, 87.52f, 6.0f));
      Commands->Attach_Script(BH_messhall_guy02, "M04_BH_MessHall_Guy_JDG", "");
      Commands->Set_Facing(BH_messhall_guy02, -155);

      GameObject *BH_messhall_guy03 =
          Commands->Create_Object("Nod_Minigunner_2SF_AutoRifle", Vector3(2.64f, 88.12f, 6.0f));
      Commands->Attach_Script(BH_messhall_guy03, "M04_BH_MessHall_Guy_JDG", "");
      Commands->Set_Facing(BH_messhall_guy03, -135);

      GameObject *BH_messhall_guy04 =
          Commands->Create_Object("Nod_Minigunner_2SF_AutoRifle", Vector3(2.08f, 87.44f, 6.0f));
      Commands->Attach_Script(BH_messhall_guy04, "M04_BH_MessHall_Guy_JDG", "");
      Commands->Set_Facing(BH_messhall_guy04, -140);

      GameObject *BH_messhall_guy05 =
          Commands->Create_Object("Nod_Minigunner_2SF_AutoRifle", Vector3(-0.38f, 87.29f, 6.0f));
    ...
    {
      GameObject *captains_bodyguard_01 =
          Commands->Create_Object("Nod_FlameThrower_1Off", Vector3(-17.79f, 85.49f, 13.13f));
      Commands->Attach_Script(captains_bodyguard_01, "M04_Captains_Bodyguard_JDG", "");
      GameObject *captains_bodyguard_02 =
          Commands->Create_Object("Nod_FlameThrower_1Off", Vector3(-15.26f, 79.5f, 13.13f));
      Commands->Attach_Script(captains_bodyguard_02, "M04_Captains_Bodyguard_JDG", "");
      GameObject *captains_bodyguard_03 =
          Commands->Create_Object("Nod_FlameThrower_1Off", Vector3(17.79f, 85.49f, 13.13f));
      Commands->Attach_Script(captains_bodyguard_03, "M04_Captains_Bodyguard_JDG", "");
      GameObject *captains_bodyguard_04 =
          Commands->Create_Object("Nod_FlameThrower_1Off", Vector3(15.26f, 79.5f, 13.13f));
      Commands->Attach_Script(captains_bodyguard_04, "M04_Captains_Bodyguard_JDG", "");
      GameObject *captains_bodyguard_05 =
          Commands->Create_Object("Nod_FlameThrower_1Off", Vector3(-8.67f, 81.66f, 13.13f));
      Commands->Attach_Script(captains_bodyguard_05, "M04_Captains_Bodyguard_JDG", "");
      GameObject *captains_bodyguard_06 =
          Commands->Create_Object("Nod_FlameThrower_1Off", Vector3(8.67f, 81.66f, 13.13f));
...
DECLARE_SCRIPT(M04_Captains_Bodyguard_Reinforcement_JDG, "") {
  ...
  REGISTER_VARIABLES() { SAVE_VARIABLE(engaged, 1); }
...
DECLARE_SCRIPT(M04_Captains_Bodyguard_Reinforcement02_JDG, ""){void Created(GameObject * obj){ActionParamsStruct params;
params.Set_Basic(this, 45, 100);
params.Set_Movement(Vector3(0, 0, 0), 1.0f, .25f);
...
DECLARE_SCRIPT(M04_Captains_Bridge_Enter_Zone_JDG,
    ...
    Commands->Send_Custom_Event(obj, Commands->Find_Object(M04_FORE_DECK_CONTROLLER_JDG), 0, 700,
                                0); // tell foredeck controller that player is approaching main bridge
Commands->Send_Custom_Event(obj, Commands->Find_Object(M04_SHIPS_CAPTAIN_JDG), 0, 100,
                            0);                                       // this tells captain to turn on hearing
...
DECLARE_SCRIPT(M04_BH_MessHall_Trigger_Zone_JDG, ""){void Entered(GameObject * obj, GameObject *enterer){
    if (enterer == STAR){Commands->Send_Custom_Event(obj, Commands->Find_Object(M04_FORE_DECK_CONTROLLER_JDG), 0, 650,
                                                     0); // tell foredeck controller that player is entering BH messhall
Commands->Create_Sound("00-c164e", Commands->Get_Position(obj), obj); // proceed with caution
// clean up this zone
...
DECLARE_SCRIPT(M04_BH_MessHall_Guy_JDG, "") {
  ...
  REGISTER_VARIABLES() { SAVE_VARIABLE(ok_to_react, 1); }
...
DECLARE_SCRIPT(M04_ForeDeck_ClosetSurprise_Guy_JDG, ""){void Created(GameObject * obj){Commands->Innate_Disable(obj);
}
...
DECLARE_SCRIPT(M04_ForeDeck_ClosetSurprise_Trigger_Zone_JDG, ""){void Entered(GameObject * obj, GameObject *enterer){
    if (enterer == STAR){Commands->Send_Custom_Event(obj, Commands->Find_Object(M04_FORE_DECK_CONTROLLER_JDG), 0, 505,
                                                     0); // tell foredeck controller that player is leaving mess hall
...
DECLARE_SCRIPT(M04_GruntMessHall_Exit_Zone_JDG, ""){void Entered(GameObject * obj, GameObject *enterer){
    if (enterer == STAR){Commands->Send_Custom_Event(obj, Commands->Find_Object(M04_FORE_DECK_CONTROLLER_JDG), 0, 500,
                                                     0); // tell foredeck controller that player is leaving mess hall
...
DECLARE_SCRIPT(M04_GruntMessHall_Entry_Zone_JDG, ""){void Entered(GameObject * obj, GameObject *enterer){
    if (enterer == STAR){Commands->Send_Custom_Event(obj, Commands->Find_Object(M04_FORE_DECK_CONTROLLER_JDG), 0, 300,
                                                     0); // tell foredeck controller that player is entering mess hall
...
DECLARE_SCRIPT(M04_Firefight_Start_Battle_Music_JDG, "") {
  ...
  REGISTER_VARIABLES() { SAVE_VARIABLE(playerHasLevel3Keycard, 1); }

  void Created(GameObject * obj) { playerHasLevel3Keycard = false; }
...
DECLARE_SCRIPT(M04_Firefight_NodGuys, ""){void Killed(GameObject * obj, GameObject *killer){
    Commands->Send_Custom_Event(obj, Commands->Find_Object(M04_END_FIREFIGHT_CONTROLLER_JDG), 0, 666,
                                0); // tell controller you've been killed
}
}
;

DECLARE_SCRIPT(M04_PostFirstMate_SamRoom_PatrolGuy_JDG, ""){void Created(GameObject * obj){ActionParamsStruct params;
params.Set_Basic(this, 45, M01_WALKING_WAYPATH_01_JDG);
params.Set_Movement(Vector3(0, 0, 0), WALK, .25f);
...
DECLARE_SCRIPT(M04_RocketEmplacement_01_JDG, "") // 103461
{
  ...
  void Created(GameObject * obj) { secondary_apache_spawned = false; }
...
DECLARE_SCRIPT(M04_SecondaryApache01_JDG, ""){void Created(GameObject * obj){ActionParamsStruct params;
params.Set_Basic(this, 100, M01_WALKING_WAYPATH_01_JDG);
...
DECLARE_SCRIPT(M04_SecondaryApache02_JDG, ""){void Created(GameObject * obj){ActionParamsStruct params;
params.Set_Basic(this, 100, M01_WALKING_WAYPATH_01_JDG);
...
DECLARE_SCRIPT(M04_Hunter_JDG, "") {
  ...
  REGISTER_VARIABLES() { SAVE_VARIABLE(myPriority, 1); }
        ...
        void Custom( GameObject * obj, int type, int param, GameObject * sender )
        {
                if (type == 0)
                {
                        ...
                        else if (param == M01_MODIFY_YOUR_ACTION_02_JDG)//monitor how close you are to player
                        {
                                ...
                                if (distanceFromStar <= 40)//******play eva warning conversation here*****
                                {
                                        int conv = Commands->Create_Conversation(
"M04_Eva_WarnsAboutHunters_Conversation", 100, 50, false); Commands->Join_Conversation( NULL, conv, false, false, false
); Commands->Start_Conversation( conv,  conv );
                                }
...
DECLARE_SCRIPT(M04_Cooks_Script_JDG, ""){void Created(GameObject * obj){Commands->Set_Innate_Is_Stationary(obj, true);
Commands->Set_Player_Type(obj, SCRIPT_PLAYERTYPE_NOD);
}
}
;

DECLARE_SCRIPT(M04_Prison_Keycard_CheckZone_JDG, ""){void Entered(GameObject * obj, GameObject *enterer){
    if (enterer == STAR){GameObject *prisonGuard01 = Commands->Find_Object(M04_ENGINEROOM_PRISONGUARD_01_JDG);
GameObject *prisonGuard02 = Commands->Find_Object(M04_ENGINEROOM_PRISONGUARD_02_JDG);
...
DECLARE_SCRIPT(M04_TiberiumHold_EntryZone_and_Controller_JDG,
               "") // this guys ID number is M04_TIBERIUM_HOLD_CONTROLLER_JDG 100572
{
  bool entered;
  bool ok_to_clean_up;
  int cargo_conv1;
  ...
  void Entered(GameObject * obj, GameObject * enterer) {
    if (enterer == STAR && (ok_to_clean_up == true)) {
      Commands->Send_Custom_Event(obj, Commands->Find_Object(M04_AFT_DECK_CONTROLLER_JDG), 0, 6000,
                                  0); // tell aft deck controller to clean up any remaining soldiers
    }
...
DECLARE_SCRIPT(M04_TibHold_SimpleMutant_JDG,
               ""){void Created(GameObject * obj){Commands->Set_Animation_Frame(obj, "S_A_HUMAN.H_A_822A", 15);
}
}
;
...
DECLARE_SCRIPT(M04_TibHold_RealMutant_JDG, ""){void Created(GameObject * obj){Commands->Enable_Hibernation(obj, false);
...
DECLARE_SCRIPT(M04_TibHold_MutantChambers_Controller_JDG, "") // M04_TIBERIUM_CHAMBERCONTROLLER_JDG 104113
{
  ...
  void Custom(GameObject * obj, int type, int param, GameObject *sender) {
    if (type == 0) {
      ...
      {
        Commands->Debug_Message(
            "***************************Mutant chamber received custom that non-destroyed version has been killed\n");
...
DECLARE_SCRIPT(M04_TibHold_MutantChamber_NoThreat_JDG, "") {
  ...
  REGISTER_VARIABLES() { SAVE_VARIABLE(switched, 1); }
  ...
  void Damaged(GameObject * obj, GameObject * damager, float amount) {
    ...
    if (obj && switched == true) {
      ...
      if (myController != NULL) {
        Commands->Debug_Message(
            "***************************Mutant chamber sending custom that non-destroyed version has been killed\n");
...
DECLARE_SCRIPT(M04_TibHold_Mutant_NoThreat_JDG, "") {
  ...
  REGISTER_VARIABLES() { SAVE_VARIABLE(myMaxHealth, 1); }
...
DECLARE_SCRIPT(M04_Visceroid_JDG, ""){void Created(GameObject * obj){ActionParamsStruct params;
params.Set_Basic(this, 100, M01_GOING_TO_HAVOC_JDG);
...
DECLARE_SCRIPT(M04_Visceroid_Dude_01_JDG, "") // M04_TIBERIUM_HOLD_TECH01_JDG	 102147
{
  ...
  REGISTER_VARIABLES() { SAVE_VARIABLE(spill_conv1, 1); }
...
DECLARE_SCRIPT(M04_Visceroid_Dude_02_JDG, "") // M04_TIBERIUM_HOLD_TECH02_JDG	 102148
{
  ...
  REGISTER_VARIABLES() { SAVE_VARIABLE(first_time_damaged, 1); }
...
DECLARE_SCRIPT(M04_Keycard_01_Script_JDG, ""){void Created(GameObject * obj){Commands->Enable_Hibernation(obj, false);
}
...
DECLARE_SCRIPT(M04_Keycard_02_Script_JDG, ""){void Created(GameObject * obj){Commands->Enable_Hibernation(obj, false);
}

void Custom(GameObject *obj, int type, int param, GameObject *sender) {
  if (type == CUSTOM_EVENT_POWERUP_GRANTED) {
    Commands->Send_Custom_Event(obj, Commands->Find_Object(M04_OBJECTIVE_CONTROLLER_JDG), 0, 510, 4);
    // Commands->Send_Custom_Event( obj, Commands->Find_Object (M04_OBJECTIVE_CONTROLLER_JDG), 0, 1001, 2 );//tell
    // objective controller to go back to regular background music
    Commands->Send_Custom_Event(
        obj, Commands->Find_Object(M04_TIBERIUM_HOLD_CONTROLLER_JDG), 0, 2000,
        0); // this custom tells the tib zone that its okay clean up aft deck soldiers next time entered
...
DECLARE_SCRIPT(M04_Keycard_03_Script_JDG, ""){void Created(GameObject * obj){Commands->Enable_Hibernation(obj, false);
}
...
void Custom(GameObject *obj, int type, int param, GameObject *sender) {
  if (type == CUSTOM_EVENT_POWERUP_GRANTED) {
    ...
    // Commands->Send_Custom_Event( obj, Commands->Find_Object (M04_OBJECTIVE_CONTROLLER_JDG), 0, 1001, 2 );//tell
    // objective controller to go back to regular background music controller to start action
    Commands->Send_Custom_Event(obj, Commands->Find_Object(101126), 0, 100,
                                0); // tells subbay zones to okay battle music
    Commands->Send_Custom_Event(obj, Commands->Find_Object(101127), 0, 100,
                                0); // tells subbay zones to okay battle music
    Commands->Send_Custom_Event(obj, Commands->Find_Object(101128), 0, 100,
                                0); // tells subbay zones to okay battle music
    Commands->Send_Custom_Event(obj, Commands->Find_Object(101129), 0, 100,
                                0); // tells subbay zones to okay battle music
    Commands->Send_Custom_Event(obj, Commands->Find_Object(101130), 0, 100,
                                0); // tells subbay zones to okay battle music
    Commands->Send_Custom_Event(obj, Commands->Find_Object(101131), 0, 100,
                                0); // tells subbay zones to okay battle music

    Commands->Send_Custom_Event(obj, Commands->Find_Object(101132), 0, 100,
                                0); // tells subbay zones to okay battle music
    Commands->Send_Custom_Event(obj, Commands->Find_Object(101133), 0, 100,
                                0); // tells subbay zones to okay battle music
    Commands->Send_Custom_Event(obj, Commands->Find_Object(101134), 0, 100,
                                0); // tells subbay zones to okay battle music
    Commands->Send_Custom_Event(obj, Commands->Find_Object(101135), 0, 100,
                                0); // tells subbay zones to okay battle music
    Commands->Send_Custom_Event(obj, Commands->Find_Object(101136), 0, 100,
                                0); // tells subbay zones to okay battle music
    Commands->Send_Custom_Event(obj, Commands->Find_Object(101137), 0, 100,
                                0); // tells subbay zones to okay battle music
...
#define STATIONARY_DELAY_TIMER 0x1234553
    ...
    void Created(GameObject * obj){Commands->Start_Timer(obj, this, 1, STATIONARY_DELAY_TIMER);
}
...
DECLARE_SCRIPT(M04_Prisoners_Rescued_Controller_JDG,
               ""){void Custom(GameObject * obj, int type, int param, GameObject *sender){if (type == 0){
    if (param == 1){Commands->Send_Custom_Event(obj, Commands->Find_Object(M04_END_FIREFIGHT_CONTROLLER_JDG), 0, 1,
                                                2); // telling firefight controller to allow end firefight
Commands->Send_Custom_Event(obj, Commands->Find_Object(M04_OBJECTIVE_CONTROLLER_JDG), 0, 500, 2);
Commands->Send_Custom_Event(obj, Commands->Find_Object(M04_AFT_DECK_CONTROLLER_JDG), 0, 3000,
                            2); // tell aft deck controller that prisoners have been rescued
...
DECLARE_SCRIPT(M04_MissileRoom_ObjectiveZone_JDG, ""){void Entered(GameObject * obj, GameObject *enterer){
    if (enterer == STAR){Commands->Send_Custom_Event(obj, Commands->Find_Object(M04_OBJECTIVE_CONTROLLER_JDG), 0, 440,
                                                     0); // tell objective controller to announce missile objective
...
DECLARE_SCRIPT(M04_EngineRoom_SniperScript_JDG, ""){void Created(GameObject * obj){int easy = 0;
...
DECLARE_SCRIPT(M04_Apache_GoBackToHangar_EntryZone_JDG, "") // 105085
{
  ...
  REGISTER_VARIABLES() { SAVE_VARIABLE(apache_id, 1); }

  void Created(GameObject * obj) { apache_id = NULL; }
  ...
  void Entered(GameObject * obj, GameObject * enterer) {
    if (enterer == STAR) {
      GameObject *apache = Commands->Find_Object(apache_id);
      if (apache != NULL) {
        Commands->Send_Custom_Event(obj, apache, 0, M01_MODIFY_YOUR_ACTION_06_JDG,
                                    0); // tell helicopter to go wait above hangar
      }
    }
  }
};
...
DECLARE_SCRIPT(M04_ApacheRoom_Apache_JDG, "") {
  ...
  void Custom(GameObject * obj, int type, int param, GameObject *sender) {
    ...
    else if (param == M01_MODIFY_YOUR_ACTION_07_JDG && waitingInAmbush == true &&
             fightingInHangar == false) // player is on top floor hangar--spring the trap
    {
      Commands->Debug_Message(
          "***************************apache has received custom that player is on top floor hangar\n");
      waitingInAmbush = false;
    ...
    else if (param == M01_MODIFY_YOUR_ACTION_08_JDG && waitingInAmbush == true &&
             fightingInHangar == false) // player is on middle floor hangar--spring the trap
    {
      Commands->Debug_Message(
          "***************************apache has received custom that player is on middle floor hangar\n");
      waitingInAmbush = false;
      fightingInHangar = true;
      params.Set_Basic(this, 100, M01_WALKING_WAYPATH_05_JDG);
      params.Set_Attack(STAR, 1000, 0, true);
    ...
    else if (param == M01_MODIFY_YOUR_ACTION_09_JDG && waitingInAmbush == true &&
             fightingInHangar == false) // player is on bottom floor hangar--spring the trap
    {
      Commands->Debug_Message(
          "***************************apache has received custom that player is on bottom floor hangar\n");
      waitingInAmbush = false;
      fightingInHangar = true;
      params.Set_Basic(this, 100, M01_WALKING_WAYPATH_05_JDG);
      params.Set_Attack(STAR, 1000, 0, true);
  ...
  void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason complete_reason) {
    ...
    if (action_id == M01_WALKING_WAYPATH_01_JDG && complete_reason == ACTION_COMPLETE_NORMAL) {
      ...
      Commands->Send_Custom_Event(obj, obj, 0, M01_MODIFY_YOUR_ACTION_03_JDG, 0);
             ...
             complete_reason == ACTION_COMPLETE_NORMAL) { // you are now waiting above the hangar
      Commands->Debug_Message("***************************apache should now be waiting over hangar\n");

      GameObject *zone01 =
          Commands->Find_Object(105011); // these are the enter zones for going back through the apache hangar
      GameObject *zone02 = Commands->Find_Object(105012);
      GameObject *zone03 = Commands->Find_Object(105081);
      GameObject *zone04 = Commands->Find_Object(105082);
      GameObject *zone05 = Commands->Find_Object(105083);
...
DECLARE_SCRIPT(M04_Firefight_Prisoner, "") {
  ...
  void Killed(GameObject * obj, GameObject * killer) {
    ...
    Commands->Send_Custom_Event(obj, Commands->Find_Object(M04_END_FIREFIGHT_CONTROLLER_JDG), 0, 10,
                                0); // tell controller you've been killed
  }
...
DECLARE_SCRIPT(M04_Firefight_Controller_JDG, "") // this guys ID number is M04_END_FIREFIGHT_CONTROLLER_JDG 100948
{
  ...
  void Custom(GameObject * obj, int type, int param, GameObject *sender) {
    ...
    else if (param == 20) // tell POWs to gather at sub
    {
      ...
      int medlabConversation =
          Commands->Create_Conversation("M04_Rally_Round_The_Sub_Boy_Conversation", 100, 50, false);
      Commands->Join_Conversation(NULL, medlabConversation, false, true, true);
      // Commands->Join_Conversation( medTech, medlabConversation, false, true, true );
      Commands->Start_Conversation(medlabConversation, medlabConversation);
    }
    ...
    {
      // Commands->Create_Sound ( "00-d404e", Commands->Get_Position ( obj ), obj );//updating radar flags..temp
      // placeholder
    }
...
DECLARE_SCRIPT(M04_Firefight_RallyZone, "") // this guys ID number is 101194
{
  ...
  void Entered(GameObject * obj, GameObject * enterer) {
    ...
    if (enterer == STAR) {
      ...
      // else
      //{
      //	Commands->Send_Custom_Event( obj, Commands->Find_Object (M04_OBJECTIVE_CONTROLLER_JDG), 0,
      //M01_DO_END_MISSION_CHECK_JDG, 0 );
      // }
    }
    ...
    if ((player_at_rallypoint == true) && (prisoner01_at_rallypoint == true) && (prisoner02_at_rallypoint == true) &&
        (prisoner03_at_rallypoint == true)) {
      Commands->Send_Custom_Event(obj, Commands->Find_Object(M04_OBJECTIVE_CONTROLLER_JDG), 0,
                                  M01_DO_END_MISSION_CHECK_JDG, 0);
    }
...
DECLARE_SCRIPT(M04_Mutant_UpdateDisc_JDG, ""){void Custom(GameObject * obj, int type, int param, GameObject *sender){
    if (type == CUSTOM_EVENT_POWERUP_GRANTED){Commands->Reveal_Encyclopedia_Character(27);
...
DECLARE_SCRIPT(M04_Start_TorpedoObjective_Zone_JDG, "") // 105238 105239
{
  ...
  void Created(GameObject * obj) { conversationPlaying = false; }
...
DECLARE_SCRIPT(M04_BigSam_EntryZone_JDG, "") // 104942
{
  ...
  REGISTER_VARIABLES() { SAVE_VARIABLE(missilesSabotaged, 1); }

  void Created(GameObject * obj) { missilesSabotaged = false; }
...
DECLARE_SCRIPT(M04_BigSam_Script_JDG, "") // 104873
{
  ...
  void Created(GameObject * obj) { Commands->Set_Animation_Frame(obj, "DSP_L4GIANTGUN.DSP_L4GIANTGUN", 0); }
...
DECLARE_SCRIPT(M04_PlaySound_OnZoneEntry_OneTime_JDG,
               "SoundName:string"){void Entered(GameObject * obj, GameObject *enterer){
    if (enterer == STAR){const char *sound_name = Get_Parameter("SoundName");
...
DECLARE_SCRIPT(M04_Objective_Reminder_Controller_JDG, "") // 105760
{
  ...
  void Custom(GameObject * obj, int type, int param, GameObject *sender) {
    if (type == M01_ADD_OBJECTIVE_POG_JDG) {
      ...
      {
        if (missile_primaryActive == true && commandClearance == true) { // M04_Add_MissileRoom_Objective_Conversation
          int reminderConv =
              Commands->Create_Conversation("M04_Add_MissileRoom_Objective_Conversation", 10, 1000, false);
          Commands->Join_Conversation(NULL, reminderConv, false, false, true);
          Commands->Start_Conversation(reminderConv, reminderConv);
        }

        else if (torpedo_primaryActive == true && commandClearance == true) { // M04_Add_Torpedo_Objective_Conversation
          int reminderConv = Commands->Create_Conversation("M04_Add_Torpedo_Objective_Conversation", 10, 1000, false);
          Commands->Join_Conversation(NULL, reminderConv, false, false, true);
          Commands->Start_Conversation(reminderConv, reminderConv);
        }

        else if (l01keycard_primaryActive == true && commandClearance == true) { // M04_Add_PrisonKey_Objective
          int reminderConv = Commands->Create_Conversation("M04_Add_PrisonKey_Objective", 10, 1000, false);
          Commands->Join_Conversation(NULL, reminderConv, false, false, true);
          Commands->Start_Conversation(reminderConv, reminderConv);
        }

        else if (prisoner_primaryActive == true && commandClearance == true) { // M04_Mission_Start_Conversation
          int reminderConv = Commands->Create_Conversation("M04_Mission_Start_Conversation", 10, 1000, false);
          Commands->Join_Conversation(NULL, reminderConv, false, false, true);
          Commands->Start_Conversation(reminderConv, reminderConv);
        }

        else if (l03keycard_primaryActive == true &&
                 commandClearance == true) { // M04_Add_Captains_Key_Objective_Conversation
          int reminderConv =
              Commands->Create_Conversation("M04_Add_Captains_Key_Objective_Conversation", 10, 1000, false);
          Commands->Join_Conversation(NULL, reminderConv, false, false, true);
          Commands->Start_Conversation(reminderConv, reminderConv);
        }

        else if (l02keycard_primaryActive == true && commandClearance == true) { // M04_Add_FirstMate_Objective_JDG
          int reminderConv = Commands->Create_Conversation("M04_Add_FirstMate_Objective_JDG", 10, 1000, false);
          Commands->Join_Conversation(NULL, reminderConv, false, false, true);
          Commands->Start_Conversation(reminderConv, reminderConv);
        }

        else if (escape_primaryActive == true && commandClearance == true) { // M04_Rally_Round_The_Sub_Boy_Conversation
