  ...
  void Custom(GameObject * obj, int type, int param, GameObject *sender) {
    ...
    case (MX0_A02_CUSTOM_TYPE_MAIN_STARTUP): {
      if (!ran_startup) {
        ...
        GameObject *humm_vee =
            Commands->Create_Object("MX0_GDI_Humm-Vee_destroyed", Vector3(-84.582f, -60.035f, 1.050f));
        if (humm_vee) {
        ...
        GameObject *debris =
            Commands->Create_Object("Simple_Level_x0_A02_Blockage", Vector3(-71.233f, -41.517f, 0.181f));
        if (debris) {
        ...
        if (a01_controller) {
          Commands->Send_Custom_Event(obj, a01_controller, MX0_A02_CUSTOM_TYPE_GET_SNIPER_01_ID,
                                      MX0_A02_CUSTOM_PARAM_DEFAULT, 0.0f);
          Commands->Send_Custom_Event(obj, a01_controller, MX0_A02_CUSTOM_TYPE_GET_SNIPER_02_ID,
                                      MX0_A02_CUSTOM_PARAM_DEFAULT, 0.0f);
        }
      ...
      if (sender) {
        if (param < MX0_A02_ACTOR_NOD_START) {
          Commands->Send_Custom_Event(
              obj, sender, MX0_A02_CUSTOM_TYPE_REQUEST_TARGET,
              MX0_A02_UNIT_ID[Get_Int_Random(MX0_A02_ACTOR_NOD_START, (MX0_A02_ACTOR_HEADCOUNT - 1))], 0.0f);
        } else {
          Commands->Send_Custom_Event(obj, sender, MX0_A02_CUSTOM_TYPE_REQUEST_TARGET,
                                      MX0_A02_UNIT_ID[Get_Int_Random(1, (MX0_A02_ACTOR_NOD_START - 1))], 0.0f);
        }
      }
      break;
    }
    ...
    case (MX0_A02_CUSTOM_TYPE_NOD_SOLDIER_KILLED): {
      ...
      if (!retreat_sequence) {
        ...
        if (!prevent_spawns) {
          ...
          if (!sequence_active) {
            // If the amount of unit space is adequate, increment the sequence and spawn the units. Tell them what they
            // are to do.
            ...
            if (space_available) {
              ...
              {
                GameObject *soldier =
                    Commands->Create_Object("MX0_Nod_Minigunner_0", Vector3(-78.442f, -78.044f, 6.404f));
                if (soldier) {
                  space_available--;
                  sequence_active = true;
              ...
              {
                GameObject *soldier =
                    Commands->Create_Object("MX0_Nod_Minigunner_0", Vector3(-102.985f, -73.331f, 4.415f));
                if (soldier) {
                  space_available--;
                  sequence_active = true;
              ...
              case (2): {
                GameObject *soldier =
                    Commands->Create_Object("Nod_RocketSoldier_0", Vector3(-78.442f, -78.044f, 6.404f));
                if (soldier) {
                  space_available--;
                  sequence_active = true;
              ...
              {
                GameObject *chinook_obj1 =
                    Commands->Create_Object("Invisible_Object", Vector3(-71.497f, -47.387f, 9.0f));
                if (chinook_obj1) {
                  sequence_active = true;
                ...
                GameObject *soldier = Commands->Find_Object(MX0_A02_UNIT_ID[2]);
                if (soldier) {
                  Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_GDI_NOTICES_HELI_01,
                                              MX0_A02_CUSTOM_PARAM_DEFAULT, 10.0f);
                }
                break;
              }
              case (4): // Next chopper arrives with FlameThrower infantry.
              {
                ...
                GameObject *chinook_obj1 =
                    Commands->Create_Object("Invisible_Object", Vector3(-83.454f, -70.323f, 9.60f));
                if (chinook_obj1) {
                  sequence_active = true;
                ...
                GameObject *soldier = Commands->Find_Object(MX0_A02_UNIT_ID[2]);
                if (soldier) {
                  Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_GDI_NOTICES_HELI_02,
                                              MX0_A02_CUSTOM_PARAM_DEFAULT, 10.0f);
                }
                break;
              }
            ...
            while (count < MX0_A02_ACTOR_HEADCOUNT) {
              if (!MX0_A02_UNIT_ID[count]) {
                ...
                if (spawnloc) {
                  ...
                  Commands->Send_Custom_Event(obj, spawnloc, MX0_A02_CUSTOM_TYPE_DAMAGE_ON,
                                              MX0_A02_CUSTOM_PARAM_DEFAULT, 0.1f);
    ...
    case (MX0_A02_CUSTOM_TYPE_GDI_NOTICES_NOD_01): {
      ...
      if (soldier) {
        ...
        if (target) {
          Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_GDI_NOTICES_NOD_01,
                                      MX0_A02_CUSTOM_PARAM_DEFAULT, 0.0f);
        }
      }
      break;
    ...
    case (MX0_A02_CUSTOM_TYPE_GDI_SHOOTS_NOD_01): {
      ...
      if (soldier) {
        GameObject *target = Commands->Find_Object(MX0_A02_UNIT_ID[current_nod_target]);
        if (target) {
          Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_GDI_SHOOTS_NOD_01,
                                      MX0_A02_UNIT_ID[current_nod_target], 0.0f);
        }
      }
    ...
    case (MX0_A02_CUSTOM_TYPE_GDI_SHOOTS_NOD_02): {
      ...
      if (soldier) {
        GameObject *target = Commands->Find_Object(MX0_A02_UNIT_ID[current_nod_target]);
        if (target) {
          Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_GDI_SHOOTS_NOD_02,
                                      MX0_A02_UNIT_ID[current_nod_target], 0.0f);
        }
      }
      break;
    ...
    case (MX0_A02_CUSTOM_TYPE_GDI_NOTICES_FLAME_DEAD): {
      GameObject *soldier = Commands->Find_Object(MX0_A02_UNIT_ID[4]);
      if (soldier) {
        Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_GDI_NOTICES_FLAME_DEAD,
                                    MX0_A02_CUSTOM_PARAM_DEFAULT, 0.0f);
      }
      break;
    }
    case (MX0_A02_CUSTOM_TYPE_HELI_DESTROYED_02): {
      if (!call_heli_destroy_once) {
        ...
        GameObject *soldier = Commands->Find_Object(MX0_A02_UNIT_ID[2]);
        if (soldier) {
          Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_HELI_DESTROYED_02, MX0_A02_CUSTOM_PARAM_DEFAULT,
                                      0.5f);
        }
    ...
    case (MX0_A02_CUSTOM_TYPE_ENTERED_TANK): {
      ...
      if (controller) {
        Commands->Send_Custom_Event(obj, controller, MX0_A03_CUSTOM_TYPE_START_ZONE, MX0_A02_CUSTOM_PARAM_DEFAULT,
                                    2.0f);
      }
    ...
    case (MX0_A02_TIMER_NOD_RETREAT): {
      ...
      while (count < MX0_A02_ACTOR_HEADCOUNT) {
        if (MX0_A02_UNIT_ID[count]) {
          GameObject *soldier = Commands->Find_Object(MX0_A02_UNIT_ID[count]);
          if (soldier) {
            Commands->Send_Custom_Event(obj, soldier, MX0_A02_CUSTOM_TYPE_RETREAT_SEQUENCE,
                                        MX0_A02_CUSTOM_PARAM_DEFAULT, 0.0f);
          }
        }
        count++;
...
DECLARE_SCRIPT(MX0_A02_ACTOR, "ActorID=0:int") {
  ...
  void Created(GameObject * obj) {
    ...
    if (!actor_id) {
      ...
      case (5): // Nod FlameThrower jumps down and fires at targets until dead.
      {
        ...
        if (controller) {
          Commands->Send_Custom_Event(obj, controller, MX0_A02_CUSTOM_TYPE_GDI_NOTICES_FLAME,
                                      MX0_A02_CUSTOM_PARAM_DEFAULT, 0.0f);
        }
        break;
      }
      ...
      if (default_state) {
        ...
        if ((!death_animation) && (can_damage)) {
          ...
          case (1): {
            ...
            GameObject *controller = Commands->Find_Object(MX0_A02_CONTROLLER_ID);
            if (controller) {
              Commands->Send_Custom_Event(obj, controller, MX0_A02_CUSTOM_TYPE_GDI_RESPONDS_01,
                                          MX0_A02_CUSTOM_PARAM_DEFAULT, 0.0f);
            }
            break;
          }
  ...
  void Killed(GameObject * obj, GameObject * killer) {
    if (active_actor) {
      ...
      if (controller) {
        if (killer == STAR) {
          Commands->Send_Custom_Event(obj, controller, MX0_A02_CUSTOM_TYPE_PLAYER_KILLED_NOD,
                                      MX0_A02_CUSTOM_PARAM_DEFAULT, 0.0f);
        } else {
          if (killer) {
    ...
    if (active_actor) {
      ...
      case (MX0_A02_CUSTOM_KILL_SNIPER_01): {
        ...
        if (sniper) {
          ...
          if (location) {
            ...
            GameObject *controller = Commands->Find_Object(MX0_A02_CONTROLLER_ID);
            if (controller) {
              Commands->Send_Custom_Event(obj, controller, MX0_A02_CUSTOM_TYPE_HANDOFF_SNIPER_02_ID,
                                          MX0_A02_CUSTOM_PARAM_DEFAULT, 0.0f);
            }
          }
        } else {
      ...
      case (MX0_A02_CUSTOM_TYPE_GET_APC_ID): {
        ...
        if (apc) {
          GameObject *controller = Commands->Find_Object(MX0_A02_CONTROLLER_ID);
          if (controller) {
            Commands->Send_Custom_Event(obj, controller, MX0_A02_CUSTOM_TYPE_APC_BLOWITUP, MX0_A02_CUSTOM_PARAM_DEFAULT,
                                        1.0f);
          }
          ActionParamsStruct params;
    ...
    if (active_actor) {
      if ((complete_reason == ACTION_COMPLETE_CONVERSATION_ENDED) ||
        ...
        case (MX0_A02_SPEECH_GDI_NOTICES_NOD_01): {
          GameObject *controller = Commands->Find_Object(MX0_A02_CONTROLLER_ID);
          if (controller) {
            Commands->Send_Custom_Event(obj, controller, MX0_A02_CUSTOM_TYPE_GDI_SHOOTS_NOD_01,
                                        MX0_A02_CUSTOM_PARAM_DEFAULT, 0.0f);
          }
          break;
        }
        ...
        case (MX0_A02_SPEECH_ENGINEER_DONE): {
          ...
          GameObject *controller = Commands->Find_Object(MX0_A02_CONTROLLER_ID);
          if (controller) {
            Commands->Send_Custom_Event(obj, controller, MX0_A02_CUSTOM_TYPE_ENGINEER_DONE,
                                        MX0_A02_CUSTOM_PARAM_DEFAULT, 0.0f);
          }
          break;
        }
        ...
        case (MX0_A02_SPEECH_GDI_SPOTS_HELI_02): {
          GameObject *controller = Commands->Find_Object(MX0_A02_CONTROLLER_ID);
          if (controller) {
            Commands->Send_Custom_Event(obj, controller, MX0_A02_CUSTOM_TYPE_SHOOT_HELI_02,
                                        MX0_A02_CUSTOM_PARAM_DEFAULT, 0.0f);
          }
          break;
        }
        ...
        case (MX0_A02_ACTION_NODFALL01_MOVE): {
          ...
          GameObject *controller = Commands->Find_Object(MX0_A02_CONTROLLER_ID);
          if (controller) {
            Commands->Send_Custom_Event(obj, controller, MX0_A02_CUSTOM_TYPE_GDI_NOTICES_NOD_01,
                                        MX0_A02_CUSTOM_PARAM_DEFAULT, 0.0f);
          }
          break;
        }
        case (MX0_A02_ACTION_NODFALL02_MOVE): {
          ...
          GameObject *controller = Commands->Find_Object(MX0_A02_CONTROLLER_ID);
          if (controller) {
            Commands->Send_Custom_Event(obj, controller, MX0_A02_CUSTOM_TYPE_GDI_SHOOTS_NOD_02,
                                        MX0_A02_CUSTOM_PARAM_DEFAULT, 0.0f);
          }
          break;
        }
        ...
        case (MX0_A02_ACTION_NOD_DONEWITH_APC): {
          ...
          GameObject *controller = Commands->Find_Object(MX0_A02_CONTROLLER_ID);
          if (controller) {
            Commands->Send_Custom_Event(obj, controller, MX0_A02_CUSTOM_TYPE_NEXT_SEQUENCE,
                                        MX0_A02_CUSTOM_PARAM_DEFAULT, 0.0f);
          }
          break;
        }
    ...
    if (active_actor) {
      ...
      case (MX0_A02_TIMER_BASIC_MOVE_01): {
        if (default_state) {
          ...
          Commands->Start_Timer(obj, this,
                                (MX0_A02_TIMERLENGTH_BASIC_MOVE + Get_Int_Random(0, MX0_A02_TIMERLENGTH_BASIC_MOVE)),
      ...
      case (MX0_A02_TIMER_DESTROY_FLAME): {
        GameObject *controller = Commands->Find_Object(MX0_A02_CONTROLLER_ID);
        if (controller) {
          Commands->Send_Custom_Event(obj, controller, MX0_A02_CUSTOM_TYPE_GDI_NOTICES_FLAME_DEAD,
                                      MX0_A02_CUSTOM_PARAM_DEFAULT, 1.0f);
        }
        Commands->Apply_Damage(obj, 10000.0f, "Blamokiller", obj);
        break;
      }
      ...
      case (MX0_A02_TIMER_WAITFOR_MOVETOTANK): {
        GameObject *controller = Commands->Find_Object(MX0_A02_CONTROLLER_ID);
        if (controller) {
          Commands->Send_Custom_Event(obj, controller, MX0_A02_CUSTOM_TYPE_ENGINEER_MOVETOTANK,
                                      MX0_A02_CUSTOM_PARAM_DEFAULT, 0.0f);
        }
        break;
      }
      case (MX0_A02_TIMER_WAITFOR_MOVETORUBBLE): {
        GameObject *controller = Commands->Find_Object(MX0_A02_CONTROLLER_ID);
        if (controller) {
          Commands->Send_Custom_Event(obj, controller, MX0_A02_CUSTOM_TYPE_ENGINEER_02_REGISTER,
                                      MX0_A02_CUSTOM_PARAM_DEFAULT, 0.0f);
        }
        ActionParamsStruct params;
...
DECLARE_SCRIPT(MX0_A02_GDI_VEHICLE, ""){void Created(GameObject * obj){Commands->Set_Health(obj, 10.0f);
}

void Damaged(GameObject *obj, GameObject *damager, float amount) { Commands->Set_Health(obj, 10.0f); }
}
;
...
DECLARE_SCRIPT(MX0_A02_GDI_APC, "") {
  ...
  void Created(GameObject * obj) { can_damage = false; }
...
DECLARE_SCRIPT(MX0_A02_ZONE_STARTUP, ""){void Entered(GameObject * obj, GameObject *enterer){
    GameObject *controller = Commands->Find_Object(MX0_A02_CONTROLLER_ID);
if (controller) {
...
DECLARE_SCRIPT(MX0_A02_HELICOPTER,
               "ActorID=0:int"){void Created(GameObject * obj){int actor_id = Get_Int_Parameter("ActorID");
if (actor_id) {
...
DECLARE_SCRIPT(MX0_A02_DEFAULT_OFF, ""){void Created(GameObject * obj){Commands->Innate_Disable(obj);
}
...
DECLARE_SCRIPT(MX0_A02_ZONE_DEFAULT_ON, ""){void Entered(GameObject * obj, GameObject *enterer){
    GameObject *controller = Commands->Find_Object(MX0_A02_CONTROLLER_ID);
if (controller) {
...
const Vector3 M03_A05_spawn_location[3] = {Vector3(-53.33f, 37.58f, 8.87f), Vector3(-111.40f, 32.27f, 9.31f),
...
DECLARE_SCRIPT(M00_Test_Sound_RAD, ""){
    void Created(GameObject * obj){int id = Commands->Create_Conversation("M00_TEST_CONVERSATION", 100, 300, true);
