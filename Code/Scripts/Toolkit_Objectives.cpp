...
DECLARE_SCRIPT(
    ...
    "Object_ID:int, Custom_Type:int, Activate_Param=0:int, Unhide_Param=0:int, Success_Param:int, Failure_Param:int") {
  ...
  void Created(GameObject * obj) {
    ...
    if ((activate == 0) && (hidden == false)) {
      ...
      case 1:
        Commands->Add_Objective(objective_id, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_PENDING, description_id, NULL,
                                0);
        break;
      case 2:
        Commands->Add_Objective(objective_id, OBJECTIVE_TYPE_SECONDARY, OBJECTIVE_STATUS_PENDING, description_id, NULL,
                                0);
        break;
      case 3:
        Commands->Add_Objective(objective_id, OBJECTIVE_TYPE_TERTIARY, OBJECTIVE_STATUS_PENDING, description_id, NULL,
                                0);
        break;
      }
      ...
      switch (objective_type) {
      case 1:
        Commands->Add_Objective(objective_id, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_HIDDEN, description_id, NULL, 0);
        break;
      case 2:
        Commands->Add_Objective(objective_id, OBJECTIVE_TYPE_SECONDARY, OBJECTIVE_STATUS_HIDDEN, description_id, NULL,
                                0);
        break;
      case 3:
        Commands->Add_Objective(objective_id, OBJECTIVE_TYPE_TERTIARY, OBJECTIVE_STATUS_HIDDEN, description_id, NULL,
                                0);
        break;
      }
      if ((blip) && (Commands->Find_Object(object_id) != NULL))
...
DECLARE_SCRIPT(M00_Objective_Controller_For_Locations_RMV,
               "Objective_ID:int, Objective_Type=1:int, Objective_Description_ID:int, Radar_Blip=1:int, Hidden=0:int, "
...
DECLARE_SCRIPT(M00_Objective_Radar_Blip_On_Object_RMV,
               "Objective_ID:int, Activate_Type=0:int, Activate_Param=0:int"){void Created(GameObject * obj){
    bool activate = ((Get_Int_Parameter("Activate_Type") == 0) && (Get_Int_Parameter("Activate_Param") == 0)) ? true
                                                                                                              : false;
...
DECLARE_SCRIPT(
    ...
    "Activate_Param=0:int, Number_Of_Triggers:int, Trigger_Param:int, Unhide_Param=0:int, Failure_Param:int") {
...
DECLARE_SCRIPT(M00_Global_Objective_Controller_RMV, "Set_Type:int, Set_Status:int, Remove:int") {
  ...
  void Custom(GameObject * obj, int type, int param, GameObject *sender) {
    if (type == set_type) {
      ...
      switch (i_new) {
      case 1:
        Commands->Change_Objective_Type(i_obj, OBJECTIVE_TYPE_PRIMARY);
      case 2:
        Commands->Change_Objective_Type(i_obj, OBJECTIVE_TYPE_SECONDARY);
      case 3:
        Commands->Change_Objective_Type(i_obj, OBJECTIVE_TYPE_TERTIARY);
      }
      ...
      switch (i_new) {
      case 1:
        Commands->Set_Objective_Status(i_obj, OBJECTIVE_STATUS_PENDING);
      case 2:
        Commands->Set_Objective_Status(i_obj, OBJECTIVE_STATUS_ACCOMPLISHED);
      case 3:
        Commands->Set_Objective_Status(i_obj, OBJECTIVE_STATUS_FAILED);
      case 4:
        Commands->Set_Objective_Status(i_obj, OBJECTIVE_STATUS_HIDDEN);
      }
    } else if (type == remove) {
