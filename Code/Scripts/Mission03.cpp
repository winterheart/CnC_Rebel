...
DECLARE_SCRIPT(M03_Objective_Controller, "") // 1100004
{
  ...
  void Created(GameObject * obj) {
    ...
    rain = true;
    //	Commands->Add_Objective(1006, OBJECTIVE_TYPE_TERTIARY, OBJECTIVE_STATUS_HIDDEN, 1008,
    //IDS_Enc_ObjTitle_Hidden_M03_02, NULL, IDS_Enc_Obj_Hidden_M03_02); 	Commands->Add_Objective(1007,
    //OBJECTIVE_TYPE_SECONDARY, OBJECTIVE_STATUS_HIDDEN, 1009, NULL, 0); 	Commands->Add_Objective(1008,
    //OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_HIDDEN, 1010, NULL, 0); 	Commands->Add_Objective(1009,
    //OBJECTIVE_TYPE_TERTIARY, OBJECTIVE_STATUS_HIDDEN, 1011,IDS_Enc_ObjTitle_Hidden_M03_02, NULL,
    //IDS_Enc_Obj_Hidden_M03_02); 	Commands->Add_Objective(1010, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_HIDDEN, 1019,
    //NULL, 0); 	Commands->Add_Objective(1011, OBJECTIVE_TYPE_TERTIARY, OBJECTIVE_STATUS_HIDDEN, 1020,
    //IDS_Enc_ObjTitle_Hidden_M03_02, NULL, IDS_Enc_Obj_Hidden_M03_02); 	Commands->Add_Objective(1012,
    //OBJECTIVE_TYPE_TERTIARY, OBJECTIVE_STATUS_HIDDEN, 1021, IDS_Enc_ObjTitle_Hidden_M03_02, NULL,
    //IDS_Enc_Obj_Hidden_M03_02);
  ...
  void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason reason) {
    ...
    if (reason == ACTION_COMPLETE_CONVERSATION_ENDED) {
      if (action_id == 1) {
        Commands->Add_Objective(1002, OBJECTIVE_TYPE_SECONDARY, OBJECTIVE_STATUS_PENDING,
                                IDS_Enc_ObjTitle_Secondary_M03_02, NULL, IDS_Enc_Obj_Secondary_M03_02);
        object = Commands->Find_Object(300056);
        if (object) {
          Commands->Set_Objective_Radar_Blip_Object(1002, object);
          Commands->Set_Objective_HUD_Info(1002, 94, "POG_M03_2_02.tga",
                                           IDS_POG_DESTROY /*, Commands->Get_Position (object)*/);
        }
      }

      if (action_id == 2) {
        Commands->Add_Objective(1004, OBJECTIVE_TYPE_SECONDARY, OBJECTIVE_STATUS_PENDING,
                                IDS_Enc_ObjTitle_Secondary_M03_03, NULL, IDS_Enc_Obj_Secondary_M03_03);
        object = Commands->Find_Object(1205777);
        if (object) {
          Commands->Set_Objective_Radar_Blip_Object(1004, Commands->Find_Object(1205777));
          Commands->Set_Objective_HUD_Info(1004, 97, "POG_M03_2_02.tga",
                                           IDS_POG_DESTROY /*, Commands->Get_Position (object)*/);
  ...
  void Custom(GameObject * obj, int type, int param, GameObject *sender) {
    ...
    if (type >= 300 && type <= 312) {
      ...
      case 1:
        ...
        break;
      case 2:
        Fail_Mission_Objective(type + 700);
        break;
      case 3:
        Add_Mission_Objective(type + 700);
        break;
      case 4:
        Unhide_Mission_Objective(type + 700);
        break;
      }
    }
  ...
  void Add_Mission_Objective(int id) {
    ...
    switch (id) {
    case 1000: {
      Commands->Add_Objective(id, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_PENDING, IDS_Enc_ObjTitle_Primary_M03_01,
                              NULL, IDS_Enc_Obj_Primary_M03_01);
      object = Commands->Find_Object(1100009);
      if (object) {
        Commands->Set_Objective_Radar_Blip_Object(id, object);
        Commands->Set_Objective_HUD_Info_Position(1000, 96, "POG_M03_1_01.tga", IDS_POG_LOCATE,
    ...
    case 1001: {
      Commands->Add_Objective(id, OBJECTIVE_TYPE_SECONDARY, OBJECTIVE_STATUS_PENDING, IDS_Enc_ObjTitle_Secondary_M03_01,
                              NULL, IDS_Enc_Obj_Secondary_M03_01);
      object = Commands->Find_Object(1212283);
      if (object) {
        Commands->Debug_Message("object found");
        Commands->Set_Objective_Radar_Blip_Object(id, object);
        Commands->Set_Objective_HUD_Info_Position(1001, 99, "POG_M03_2_01.tga", IDS_POG_DEFEAT,
                                                  Commands->Get_Position(object));
    ...
    case 1002: {
      ...
      if (object) {
        Commands->Set_Objective_Radar_Blip_Object(1002, object);
        Commands->Set_Objective_HUD_Info_Position(1002, 98, "POG_M03_2_02.tga", IDS_POG_DESTROY,
                                                  Commands->Get_Position(object));
        Commands->Send_Custom_Event(controller, controller, REMOVE_SECONDARY_POG, id, SECONDARY_POG_DELAY);
      }
    ...
    case 1004:
      Sam_Sites_2_Dialogue();
      break;
    case 1006: {
      Commands->Add_Objective(id, OBJECTIVE_TYPE_TERTIARY, OBJECTIVE_STATUS_PENDING, IDS_Enc_ObjTitle_Hidden_M03_01,
                              NULL, IDS_Enc_Obj_Hidden_M03_01);
      Commands->Start_Timer(controller, this, 4.0f, 912);
    } break;
    case 1007: {
      Commands->Add_Objective(id, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_PENDING, IDS_Enc_ObjTitle_Primary_M03_02,
                              NULL, IDS_Enc_Obj_Primary_M03_02);
      object = Commands->Find_Object(1215546);
      if (object) {
        Commands->Set_Objective_Radar_Blip_Object(1007, object);
        Commands->Set_Objective_HUD_Info_Position(1007, 95, "POG_M03_1_02.tga", IDS_POG_LOCATE,
                                                  Commands->Get_Position(object));
      }
    ...
    case 1008: {
      Commands->Add_Objective(id, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_PENDING, IDS_Enc_ObjTitle_Primary_M03_03,
                              NULL, IDS_Enc_Obj_Primary_M03_03);
      object = Commands->Find_Object(1100009);
      if (object) {
        Commands->Set_Objective_Radar_Blip_Object(1008, object);
        Commands->Set_Objective_HUD_Info_Position(1008, 94, "POG_M03_1_03.tga", IDS_POG_ACCESS,
                                                  Commands->Get_Position(object));
      }
    ...
    case 1009:
      Commands->Add_Objective(id, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_PENDING, IDS_Enc_ObjTitle_Hidden_M03_02,
                              NULL, IDS_Enc_Obj_Hidden_M03_02);
      break;
    case 1010: {
      Commands->Add_Objective(id, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_PENDING, IDS_Enc_ObjTitle_Primary_M03_04,
                              NULL, IDS_Enc_Obj_Primary_M03_04);
      object = Commands->Find_Object(1213908);
      if (object) {
        Commands->Set_Objective_Radar_Blip_Object(1010, object);
        Commands->Set_Objective_HUD_Info_Position(1010, 93, "POG_M03_1_04.tga", IDS_POG_ESCAPE,
                                                  Commands->Get_Position(object));
      }
    ...
    case 1011:
      Commands->Add_Objective(id, OBJECTIVE_TYPE_TERTIARY, OBJECTIVE_STATUS_PENDING, IDS_Enc_ObjTitle_Hidden_M03_03,
                              NULL, IDS_Enc_Obj_Hidden_M03_03);
      break;
    case 1012:
      Commands->Add_Objective(id, OBJECTIVE_TYPE_TERTIARY, OBJECTIVE_STATUS_PENDING, IDS_Enc_ObjTitle_Hidden_M03_04,
                              NULL, IDS_Enc_Obj_Hidden_M03_04);
      break;
    }
  }
  ...
  void Complete_Mission_Objective(int id) {
    ...
    if (id == 1006 || id == 1009 || id == 1011 || id == 1012) {
      if (id == 1009) {
        Commands->Add_Objective(id, OBJECTIVE_TYPE_TERTIARY, OBJECTIVE_STATUS_PENDING, IDS_Enc_ObjTitle_Hidden_M03_02,
                                NULL, IDS_Enc_Obj_Hidden_M03_02);
  ...
  void Fail_Mission_Objective(int id) { Commands->Set_Objective_Status(id, OBJECTIVE_STATUS_FAILED); }
...
DECLARE_SCRIPT(M03_Gunboat_Controller_RMV,
  ...
  enum { GUNBOAT_ACTION, GUNBOAT_TIMER };
  ...
  void Timer_Expired(GameObject * obj, int timer_id) {
    if (timer_id == GUNBOAT_TIMER && !cannon_killed) {
      ...
      case STATE_IN_TRANSIT:
        ...
        case STATE_AT_VILLAGE:
          params.Set_Movement(cannon_start, 0.5f, 3);
          break;
        }
  ...
  void Damaged(GameObject * obj, GameObject * damager, float amount) {
    ...
    if (damager == Commands->Find_Object(1100002)) {
      if (++dam_count > 1 && dam_count <= 3) {
        if (Commands->Get_Health(Commands->Find_Object(300058)) > 0 ||
            Commands->Get_Health(Commands->Find_Object(300058)) > 0) {
...
DECLARE_SCRIPT(Sakura_Killed, "") {
  ...
  REGISTER_VARIABLES() { SAVE_VARIABLE(music_id, 1); }
...
DECLARE_SCRIPT(M03_Outro_Cinematic, "") {
  ...
  REGISTER_VARIABLES() { SAVE_VARIABLE(star_id, 1); }
...
DECLARE_SCRIPT(RMV_M03_Comm_Center_Terminal, "") {
  ...
  REGISTER_VARIABLES() { SAVE_VARIABLE(has_been_poked, 1); }

  void Created(GameObject * obj) { has_been_poked = false; }
...
01-I050E	"Do you know someone who would make a positive addition to the Brotherhood? Now they can enlist online
at 'WWW dot BrotherhoodRecruitment dot Nod' " 01-I062E	"Immediately report the presence of visceroids to your
supervisor." 01-I066E	"Workers found loitering in this area will be terminated." 01-I076E	"Hazmat suits are
required for your safety." 01-I078E	"Please do not inhale decontamination agents."
...
DECLARE_SCRIPT(M03_Announce_PowerPlant_Controller_JDG, "") {
  ...
  void Custom(GameObject * obj, int type, int param, GameObject *sender) {
    ...
    if (param == stop_announcements) {
      ...
      const char *sounds[19] = {"01-i000e", "01-i002e", "01-i004e", "01-i006e", "01-i008e", "01-i010e", "01-i012e",
                                "01-i014e", "01-i016e", "01-i018e", "01-i020e", "01-i024e", "01-i026e", "01-i050e",
                                "01-i062e", "01-i066e", "01-i076e", "01-i078e", "01-i022e"};
...
01-i060E	"Leaking barrels are a health hazard. Report any faulty containment vessels to your supervisor
immediately." 01-i062E	"Immediately report the presence of visceroids to your supervisor." 01-i064E	"Do not
discharge weapons near containment barrels." 01-i066E	"Workers found loitering in this area will be terminated."
...
DECLARE_SCRIPT(M03_Announce_Refinery_Controller_JDG, "") {
  ...
  void Custom(GameObject * obj, int type, int param, GameObject *sender) {
    if (param == stop_announcements) {
      ...
      const char *sounds[28] = {"01-i010E", "01-i022E", "01-i032E", "01-i034E", "01-i052E", "01-i054E", "01-i056E",
                                "01-i058E", "01-i060E", "01-i062E", "01-i064E", "01-i066E", "01-i068E", "01-i070E",
                                "01-i072E", "01-i074E", "01-i076E", "01-i078E", "01-i080E", "01-i082E", "01-i084E",
                                "01-i086E", "01-i088E", "01-i090E", "01-i092E", "01-i094E", "01-i096E", "01-i098E"};
      ...
      if ((lineNumber >= 0.5) && (lineNumber < 1.5)) {
        ...
        // soundName = "01-i054e";
        sound = 4;
        // 01-i054E	"Harvester approaching. Please clear docking bay at once."  Only plays when harvester is
        // approaching.
...
01-I050E	"Do you know someone who would make a positive addition to the Brotherhood? Now they can enlist online
at 'WWW dot BrotherhoodRecruitment dot Nod' " 01-I062E	"Immediately report the presence of visceroids to your
supervisor." 01-I066E	"Workers found loitering in this area will be terminated."
*/
...
DECLARE_SCRIPT(M03_Initial_Powerups, "") {
  ...
  void Created(GameObject * obj) { Commands->Start_Timer(obj, this, 0.5f, POWERUP_TIMER); }
...
DECLARE_SCRIPT(M03_Move_Commando_To_Start, "") {
  ...
  void Created(GameObject * obj) { Commands->Start_Timer(obj, this, 1.0f, M03_COMMANDO_MOVE_TIMER); }
...
DECLARE_SCRIPT(M03_Chinook_Drop_Soldiers_GDI, "Controller_ID:int") {
  ...
  int Find_Location(int type) { return type - 4001; }
...
DECLARE_SCRIPT(M03_Inlet_Soldier_GDI,
...
DECLARE_SCRIPT(M03_Beach_Soldier_GDI,
               "Number:int"){void Created(GameObject * obj){int num = Get_Int_Parameter("Number");
switch (num) {
case 0:
...
DECLARE_SCRIPT(M03_Chinook_Reinforcements,
...
DECLARE_SCRIPT(M03_Chinook_Spawned_Soldier_GDI, "Area:int, Send_Type_When_Killed:int, Target_ID:int") {
  ...
  void Custom(GameObject * obj, int type, int param, GameObject *sender) {
    if (type == 999 && param == 999) {
      ...
      switch (area) {
      case 0:
        dest.Set(-100, -50, 5.986f);
        break;
      case 1:
        dest.Set(87, -58, 1.662f);
        break;
      case 2:
        dest.Set(-125, 13, 9.362f);
        break;
      }
...
DECLARE_SCRIPT(M03_Objective_Tracker, "") {
  ...
  REGISTER_VARIABLES() { SAVE_VARIABLE(number_completed, 1); }

  void Created(GameObject * obj) { number_completed = 0; }
...
DECLARE_SCRIPT(M03_Intro_Substitute, ""){void Custom(GameObject * obj, int type, int param, GameObject *sender){
    if (type == 999){Commands->Start_Timer(obj, this, 3.0f, 9998);
}
}
...
DECLARE_SCRIPT(M03_Alternate_Sam_Site, "Chinook_Controller_ID:int") {
  ...
  REGISTER_VARIABLES() { SAVE_VARIABLE(spoke, 1); }

  void Created(GameObject * obj) { spoke = false; }
...
DECLARE_SCRIPT(M03_Flyover_Controller, "") {
  ...
  void Timer_Expired(GameObject * obj, int timer_id) {
    const char *flyovers[17] = {"A-10_1.txt", "A-10_2.txt", "A-10_3.txt", "A-10_4.txt", "A-10_5.txt", "A-10_6.txt",
                                "Orca_1.txt", "Orca_2.txt", "Orca_3.txt", "Orca_4.txt", "Orca_5.txt", "Orca_1.txt",
                                "Orca_2.txt", "Orca_3.txt", "Orca_4.txt", "Orca_5.txt", "Orca_6.txt"};
...
DECLARE_SCRIPT(M03_Destroyed_Chinook,
               "Controller_ID:int, Simple_ID:int"){void Killed(GameObject * obj, GameObject *killer){
...
DECLARE_SCRIPT(M03_Chinook_Fodder_Creator, ""){void Custom(GameObject * obj, int type, int param, GameObject *sender){
    if (Commands->Find_Object(1100003) == NULL){return;
}
...
DECLARE_SCRIPT(M03_Tailgun, "Controller_ID:int"){void Killed(GameObject * obj, GameObject *killer){
    GameObject *con = Commands->Find_Object(Get_Int_Parameter("Controller_ID"));
if (con) {
...
DECLARE_SCRIPT(M03_Tailgun_Fodder_Zone, "Spawner_ID_1:int, Spawner_ID_2:int, Spawner_ID_3:int") {
  ...
  REGISTER_VARIABLES() { SAVE_VARIABLE(active, 1); }
...
DECLARE_SCRIPT(M03_Tailgun_Fodder, ""){void Created(GameObject * obj){Commands->Action_Reset(obj, 99);
GameObject *star = Commands->Get_A_Star(Commands->Get_Position(obj));
if (star) {
  ActionParamsStruct params;
  params.Set_Basic(this, 99, 0);
...
DECLARE_SCRIPT(M03_Big_Gun_Explosion, ""){
    void Created(GameObject * obj){Commands->Create_3D_Sound_At_Bone("Explosion_Large_07", obj, "O_WREAKAGE");
}
}
;
...
DECLARE_SCRIPT(M03_Base_Patrol, "WaypathID:int"){void Created(GameObject * obj){ActionParamsStruct params;
...
DECLARE_SCRIPT(M03_Base_Harvester,
...
DECLARE_SCRIPT(M03_Wheres_The_Star,
               "Controller_ID:int, Type:int, Param:int"){void Entered(GameObject * obj, GameObject *enterer){
...
#define BEACH_FACING -180.0f
  ...
  void Custom(GameObject * obj, int type, int param, GameObject *sender) {
    ...
    if (type == 6000 && param == 6000) {
      if ((beach_active && target_killed[0] != 1000) || (inlet_active && target_killed[1] != 1000) ||
          (base_active && target_killed[2] != 1000)) {
        forced = true;
    ...
    if (type == 1000 && param == 1000 && (inlet_active || base_active || beach_active)) {
      count++;
      if ((beach_active && count >= target_killed[0]) || (inlet_active && count >= target_killed[1]) ||
          (base_active && count >= target_killed[2])) {
        forced = false;
        /*int id = Commands->Create_Conversation("Nod_Reinforcements", 100);
        Commands->Join_Conversation(NULL, id, true, true, true);
        Commands->Join_Conversation(Commands->Get_A_Star(Vector3(0,0,0)), id, true, true, true);
...
DECLARE_SCRIPT(M03_Officer_With_Key_Card, ""){void Killed(GameObject * obj, GameObject *killer){
    if (!Commands->Has_Key(killer, 1)){Vector3 pos = Commands->Get_Position(obj) + Vector3(0, 0, 0.5);
...
DECLARE_SCRIPT(M03_Officer_With_Key_Card2, ""){void Killed(GameObject * obj, GameObject *killer){
    if (!Commands->Has_Key(killer, 2)){Vector3 pos = Commands->Get_Position(obj) + Vector3(0, 0, 0.5);
...
DECLARE_SCRIPT(M03_Key_Card, ""){void Custom(GameObject * obj, int type, int param,
                                             GameObject *sender){GameObject *con = Commands->Find_Object(1100004);
if (con) {
...
DECLARE_SCRIPT(M03_Staged_Conversation_1, "Soldier_1_ID:int, Soldier_2_ID:int"){
    void Custom(GameObject * obj, int type, int param, GameObject *sender){
        if (type == 1000 && param == 1000){GameObject *soldier1 = Commands->Find_Object(Get_Int_Parameter(0));
...
DECLARE_SCRIPT(M03_Staged_Conversation_Soldier,
               ""){void Created(GameObject * obj){Commands->Start_Timer(obj, this, 0.5f, 0);
}
...
DECLARE_SCRIPT(M03_Beach_Turret, ""){void Created(GameObject * obj){Commands->Start_Timer(obj, this, 1.0f, 0);
}
...
DECLARE_SCRIPT(M03_Destroyed_SAM_Site, ""){void Created(GameObject * obj){Commands->Start_Timer(obj, this, 1.0f, 0);
}

void Timer_Expired(GameObject *obj, int timer_id) { Commands->Create_2D_Sound("00-N170E"); }
}
;

DECLARE_SCRIPT(M03_Destroyed_Turret, ""){void Created(GameObject * obj){Commands->Start_Timer(obj, this, 1.0f, 0);
...
DECLARE_SCRIPT(M03_Structure_Powerup_Drop, "Powerup:string"){
    void Killed(GameObject * obj, GameObject *killed){Vector3 pos = Commands->Get_Position(obj);
float facing = Commands->Get_Facing(obj);
...
DECLARE_SCRIPT(DLS_Volcano_Active,
  ...
  void Entered(GameObject * obj, GameObject * enterer) { volcano_active = false; }
};

DECLARE_SCRIPT(M03_Sakura_Explosion, ""){void Destroyed(GameObject * obj){
...
DECLARE_SCRIPT(DLS_Volcano_Stumble, "Debug_Mode=0:int") {
  enum { FALL_FORWARD, FALL_BACK, RISE_FORWARD, RISE_BACK, FLEE_VOLCANO, STUMBLE };

  bool animating;

  REGISTER_VARIABLES() { SAVE_VARIABLE(animating, 1); }
...
DECLARE_SCRIPT(M03_Beach_Radio, "") {
  ...
  void Killed(GameObject * obj, GameObject * killer) { Commands->Stop_Conversation(conv_id); }
...
DECLARE_SCRIPT(M03_Protect_The_MCT, "Building:int") {
  ...
  REGISTER_VARIABLES() { SAVE_VARIABLE(completed, 1); }

  void Created(GameObject * obj) { completed = false; }
...
DECLARE_SCRIPT(M03_Power_Plant, ""){
    void Killed(GameObject * obj, GameObject *killer){GameObject *comm_center = Commands->Find_Object(1150002);
...
DECLARE_SCRIPT(M03_Refinery, ""){void Killed(GameObject * obj, GameObject *killer){
...
DECLARE_SCRIPT(M03_Zone_Enabled_Spawner, "Spawner_num:int, Control_num:int"){
    void Entered(GameObject * obj, GameObject *enterer){int control = Get_Int_Parameter("Control_num");
...
DECLARE_SCRIPT(M03_Killed_Disabled_Spawner, "Spawner_num:int"){void Killed(GameObject * obj, GameObject *killer){
    if (killer == STAR){Commands->Enable_Spawner(Get_Int_Parameter("Spawner_num"), false);
}
}
}
;

DECLARE_SCRIPT(M03_Goto_Star, ""){void Created(GameObject * obj){Commands->Start_Timer(obj, this, 3.5f, GOTO_STAR);
}
...
DECLARE_SCRIPT(M03_Mct_Poke, "") {
  ...
  void Created(GameObject * obj) { already_poked = false; }
...
DECLARE_SCRIPT(M03_Killed_Sound, "Officer=0:int, Location=0:int"){void Killed(GameObject * obj, GameObject *killer){
...
DECLARE_SCRIPT(M03_Past_Pillbox, ""){void Entered(GameObject * obj, GameObject *enterer){
...
DECLARE_SCRIPT(M10_Elevator_All_Zone, "Controller_num:int") {
  ...
  REGISTER_VARIABLES() { SAVE_VARIABLE(star_in_zone, 1); }

  void Created(GameObject * obj) { star_in_zone = false; }
...
DECLARE_SCRIPT(M03_AggAndCover, ""){void Created(GameObject * obj){Commands->Set_Innate_Aggressiveness(obj, 50.0f);
Commands->Set_Innate_Take_Cover_Probability(obj, 100.0f);
}
}
;

DECLARE_SCRIPT(M03_Technician_Work, ""){void Created(GameObject * obj){ActionParamsStruct params;
...
DECLARE_SCRIPT(M03_Paratrooper_Run, "") {
  ...
  void Created(GameObject * obj) { initial_damage = false; }
...
DECLARE_SCRIPT(M03_Cine_Explosion, ""){void Custom(GameObject * obj, int type, int param, GameObject *sender){
    if (type == 600){Commands->Create_Explosion("M03_Cine_Explosion", Commands->Get_Position(obj), obj);
}
}
}
;
