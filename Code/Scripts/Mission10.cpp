...
DECLARE_SCRIPT(M10_Objective_Controller, "") {
  ...
  void Created(GameObject * obj) {
    ...
    Commands->Add_Objective(1020, OBJECTIVE_TYPE_TERTIARY, OBJECTIVE_STATUS_HIDDEN, IDS_Enc_ObjTitle_Hidden_M10_01,
                            NULL, IDS_Enc_Obj_Hidden_M10_01);
    Commands->Add_Objective(1021, OBJECTIVE_TYPE_TERTIARY, OBJECTIVE_STATUS_HIDDEN, IDS_Enc_ObjTitle_Hidden_M10_02,
                            NULL, IDS_Enc_Obj_Hidden_M10_02);
  }
  ...
  void Add_An_Objective(int id) {
    ...
    switch (id) {
    case 1001: {
      Commands->Add_Objective(1001, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_PENDING, IDS_Enc_ObjTitle_Primary_M10_05,
                              NULL, IDS_Enc_Obj_Primary_M10_05);
      object = Commands->Find_Object(2007444);
      if (object) {
        Commands->Set_Objective_Radar_Blip_Object(1001, object);
        Commands->Set_Objective_HUD_Info_Position(1001, 75, "POG_M10_1_05.tga", IDS_POG_DESTROY,
                                                  Commands->Get_Position(object));
      }
    } break;
    case 1002: {
      Commands->Add_Objective(1002, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_PENDING, IDS_Enc_ObjTitle_Primary_M10_02,
                              NULL, IDS_Enc_Obj_Primary_M10_02);
      object = Commands->Find_Object(2007445);
      if (object) {
        Commands->Set_Objective_Radar_Blip_Object(1002, object);
        Commands->Set_Objective_HUD_Info_Position(1002, 78, "POG_M10_1_02.tga", IDS_POG_DESTROY,
                                                  Commands->Get_Position(object));
      }
    } break;
    case 1003: {
      Commands->Add_Objective(1003, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_PENDING, IDS_Enc_ObjTitle_Primary_M10_07,
                              NULL, IDS_Enc_Obj_Primary_M10_07);
      object = Commands->Find_Object(2007446);
      if (object) {
        Commands->Set_Objective_Radar_Blip_Object(1003, object);
        Commands->Set_Objective_HUD_Info_Position(1003, 73, "POG_M10_1_07.tga", IDS_POG_SABOTAGE,
                                                  Commands->Get_Position(object));
      }
    } break;
    case 1004: {
      Commands->Add_Objective(1004, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_PENDING, IDS_Enc_ObjTitle_Primary_M10_04,
                              NULL, IDS_Enc_Obj_Primary_M10_04);
      object = Commands->Find_Object(2007447);
      if (object) {
        Commands->Set_Objective_Radar_Blip_Object(1004, object);
        Commands->Set_Objective_HUD_Info_Position(1004, 76, "POG_M10_1_04.tga", IDS_POG_DESTROY,
                                                  Commands->Get_Position(object));
      }
    } break;
    case 1005: {
      Commands->Add_Objective(1005, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_PENDING, IDS_Enc_ObjTitle_Primary_M10_01,
                              NULL, IDS_Enc_Obj_Primary_M10_01);
      object = Commands->Find_Object(1100166);
      if (object) {
        Commands->Set_Objective_Radar_Blip_Object(1005, object);
        Commands->Set_Objective_HUD_Info_Position(1005, 80, "POG_M10_1_01.tga", IDS_POG_OPEN,
                                                  Commands->Get_Position(object));
      }
    } break;
    case 1006: {
      Commands->Add_Objective(1006, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_PENDING, IDS_Enc_ObjTitle_Primary_M10_06,
                              NULL, IDS_Enc_Obj_Primary_M10_06);
      object = Commands->Find_Object(2017706);
      if (object) {
        Commands->Set_Objective_Radar_Blip_Object(1006, object);
        Commands->Set_Objective_HUD_Info_Position(1006, 74, "POG_M10_1_01.tga", IDS_POG_OPEN,
                                                  Commands->Get_Position(object));
      }
    } break;
    case 1007: {
      Commands->Add_Objective(1007, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_PENDING, IDS_Enc_ObjTitle_Primary_M10_03,
                              NULL, IDS_Enc_Obj_Primary_M10_03);
      object = Commands->Find_Object(1100169);
      if (object) {
        Commands->Set_Objective_Radar_Blip_Object(1007, object);
        Commands->Set_Objective_HUD_Info_Position(1007, 77, "POG_M10_1_01.tga", IDS_POG_OPEN,
                                                  Commands->Get_Position(object));
      }
    } break;
    case 1008: {
      Commands->Add_Objective(1008, OBJECTIVE_TYPE_SECONDARY, OBJECTIVE_STATUS_PENDING,
                              IDS_Enc_ObjTitle_Secondary_M10_01, NULL, IDS_Enc_Obj_Secondary_M10_01);
      object = Commands->Find_Object(2007448);
      if (object) {
        Commands->Set_Objective_Radar_Blip_Object(1008, object);
        Commands->Set_Objective_HUD_Info_Position(1008, 51, "POG_M10_2_01.tga", IDS_POG_DESTROY,
                                                  Commands->Get_Position(object));
        Commands->Send_Custom_Event(obj, obj, REMOVE_SECONDARY_POG, 1008, SECONDARY_POG_DELAY);
      }
    } break;
    case 1009: {
      Commands->Add_Objective(1009, OBJECTIVE_TYPE_SECONDARY, OBJECTIVE_STATUS_PENDING,
                              IDS_Enc_ObjTitle_Secondary_M10_04, NULL, IDS_Enc_Obj_Secondary_M10_04);
      object = Commands->Find_Object(2007449);
      if (object) {
        Commands->Set_Objective_Radar_Blip_Object(1009, object);
        Commands->Set_Objective_HUD_Info_Position(1009, 50, "POG_M10_2_03.tga", IDS_POG_DESTROY,
                                                  Commands->Get_Position(object));
        Commands->Send_Custom_Event(obj, obj, REMOVE_SECONDARY_POG, 1009, SECONDARY_POG_DELAY);
      }
    } break;
    case 1010: {
      Commands->Add_Objective(1010, OBJECTIVE_TYPE_SECONDARY, OBJECTIVE_STATUS_PENDING,
                              IDS_Enc_ObjTitle_Secondary_M10_06, NULL, IDS_Enc_Obj_Secondary_M10_06);
      object = Commands->Find_Object(2007450);
      if (object) {
        Commands->Set_Objective_Radar_Blip_Object(1010, object);
        Commands->Set_Objective_HUD_Info_Position(1010, 59, "POG_M10_2_05.tga", IDS_POG_DESTROY,
                                                  Commands->Get_Position(object));
        Commands->Send_Custom_Event(obj, obj, REMOVE_SECONDARY_POG, 1010, SECONDARY_POG_DELAY);
      }
    } break;
    case 1011: {
      Commands->Add_Objective(1011, OBJECTIVE_TYPE_SECONDARY, OBJECTIVE_STATUS_PENDING,
                              IDS_Enc_ObjTitle_Secondary_M10_08, NULL, IDS_Enc_Obj_Secondary_M10_08);
      object = Commands->Find_Object(2005260);
      if (object) {
        Commands->Set_Objective_Radar_Blip_Object(1011, object);
        Commands->Set_Objective_HUD_Info_Position(1011, 58, "POG_M10_2_07.tga", IDS_POG_DESTROY,
                                                  Commands->Get_Position(object));
        Commands->Send_Custom_Event(obj, obj, REMOVE_SECONDARY_POG, 1011, SECONDARY_POG_DELAY);
      }
    } break;
    case 1012: {
      Commands->Add_Objective(1012, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_PENDING, IDS_Enc_ObjTitle_Primary_M10_08,
                              NULL, IDS_Enc_Obj_Primary_M10_08);

      object = Commands->Find_Object(2000890);
      if (object) {
        Commands->Set_Objective_Radar_Blip_Object(1012, object);
        Commands->Set_Objective_HUD_Info_Position(1012, 79, "POG_M10_1_08.tga", IDS_POG_ACQUIRE,
                                                  Commands->Get_Position(object));
      }

    } break;
    case 1013: {
      Commands->Add_Objective(1013, OBJECTIVE_TYPE_SECONDARY, OBJECTIVE_STATUS_PENDING,
                              IDS_Enc_ObjTitle_Secondary_M10_10, NULL, IDS_Enc_Obj_Secondary_M10_10);
      object = Commands->Find_Object(1154083);
      if (object) {
        Commands->Set_Objective_Radar_Blip_Object(1013, object);
        Commands->Set_Objective_HUD_Info_Position(1013, 57, "POG_M10_2_06.tga", IDS_POG_DESTROY,
                                                  Commands->Get_Position(object));
        Commands->Send_Custom_Event(obj, obj, REMOVE_SECONDARY_POG, 1013, SECONDARY_POG_DELAY);
      }
    } break;
    case 1014: {
      Commands->Add_Objective(1014, OBJECTIVE_TYPE_SECONDARY, OBJECTIVE_STATUS_PENDING,
                              IDS_Enc_ObjTitle_Secondary_M10_07, NULL, IDS_Enc_Obj_Secondary_M10_07);
      object = Commands->Find_Object(1154084);
      if (object) {
        Commands->Set_Objective_Radar_Blip_Object(1014, object);
        Commands->Set_Objective_HUD_Info_Position(1014, 56, "POG_M10_2_06.tga", IDS_POG_DESTROY,
                                                  Commands->Get_Position(object));
        Commands->Send_Custom_Event(obj, obj, REMOVE_SECONDARY_POG, 1014, SECONDARY_POG_DELAY);
      }
    } break;
    case 1015: {
      Commands->Add_Objective(1015, OBJECTIVE_TYPE_SECONDARY, OBJECTIVE_STATUS_PENDING,
                              IDS_Enc_ObjTitle_Secondary_M10_03, NULL, IDS_Enc_Obj_Secondary_M10_03);
      object = Commands->Find_Object(1100007);
      if (object) {
        Commands->Set_Objective_Radar_Blip_Object(1015, object);
        Commands->Set_Objective_HUD_Info_Position(1015, 55, "POG_M10_2_02.tga", IDS_POG_DESTROY,
                                                  Commands->Get_Position(object));
        Commands->Send_Custom_Event(obj, obj, REMOVE_SECONDARY_POG, 1015, SECONDARY_POG_DELAY);
      }
    } break;
    case 1016: {
      Commands->Add_Objective(1016, OBJECTIVE_TYPE_SECONDARY, OBJECTIVE_STATUS_PENDING,
                              IDS_Enc_ObjTitle_Secondary_M10_11, NULL, IDS_Enc_Obj_Secondary_M10_11);
      object = Commands->Find_Object(1100010);
      if (object) {
        Commands->Set_Objective_Radar_Blip_Object(1016, object);
        Commands->Set_Objective_HUD_Info_Position(1016, 54, "POG_M10_2_02.tga", IDS_POG_DESTROY,
                                                  Commands->Get_Position(object));
        Commands->Send_Custom_Event(obj, obj, REMOVE_SECONDARY_POG, 1016, SECONDARY_POG_DELAY);
      }
    } break;
    case 1017: {
      Commands->Add_Objective(1017, OBJECTIVE_TYPE_SECONDARY, OBJECTIVE_STATUS_PENDING,
                              IDS_Enc_ObjTitle_Secondary_M10_09, NULL, IDS_Enc_Obj_Secondary_M10_09);
      ...
      if (object && object2) {
        ...
        Commands->Set_Objective_HUD_Info_Position(1017, 53, "POG_M10_2_02.tga", IDS_POG_DESTROY,
                                                  Commands->Get_Position(object));
        Commands->Send_Custom_Event(obj, obj, REMOVE_SECONDARY_POG, 1017, SECONDARY_POG_DELAY);
      }
    } break;
    case 1018: {
      Commands->Add_Objective(1018, OBJECTIVE_TYPE_SECONDARY, OBJECTIVE_STATUS_PENDING,
                              IDS_Enc_ObjTitle_Secondary_M10_05, NULL, IDS_Enc_Obj_Secondary_M10_05);
      ...
      if (object || object2) {
        ...
        Commands->Set_Objective_HUD_Info_Position(1018, 52, "POG_M10_2_02.tga", IDS_POG_DESTROY,
                                                  Commands->Get_Position(object));
      }
    } break;
    case 1019: {
      Commands->Add_Objective(1019, OBJECTIVE_TYPE_SECONDARY, OBJECTIVE_STATUS_PENDING,
                              IDS_Enc_ObjTitle_Secondary_M10_12, NULL, IDS_Enc_Obj_Secondary_M10_12);
      ...
      if (object || object2) {
        ...
        Commands->Set_Objective_HUD_Info_Position(1019, 51, "POG_M10_2_11.tga", IDS_POG_DESTROY,
                                                  Commands->Get_Position(object));
      }
    } break;
    }
...
DECLARE_SCRIPT(M10_Ion_Cannon, ""){void Custom(GameObject * obj, int type, int param, GameObject *sender){
    if (type == CUSTOM_EVENT_POWERUP_GRANTED){GameObject *obj_con = Commands->Find_Object(1100154);
...
DECLARE_SCRIPT(M10_Turret_Tank,
               "CheckBlocked=1:int"){void Created(GameObject * obj){Commands->Enable_Enemy_Seen(obj, true);
}
...
void Timer_Expired(GameObject *obj, int timer_id) { Commands->Action_Reset(obj, 99); }
}
;
...
DECLARE_SCRIPT(M10_Power_Plant, "") {
  ...
  REGISTER_VARIABLES() { SAVE_VARIABLE(con_yard_destroyed, 1); }
  ...
  void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason reason) {
    ...
    if (action_id == 100014) {
      Commands->Send_Custom_Event(obj, obj_con, 1001, 3, 0.0f);
  ...
  void Killed(GameObject * obj, GameObject * killer) {
    ...
    if (obelisk) {
      Commands->Send_Custom_Event(obj, obelisk, 1000, 1000, 0.0f);
    }
...
DECLARE_SCRIPT(M10_Con_Yard, ""){void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason reason){
    GameObject *obj_con = Commands->Find_Object(1100154);

if (action_id == 100005) {
  Commands->Send_Custom_Event(obj, obj_con, 1002, 1, 0.0f);
}
}
...
void Killed(GameObject *obj, GameObject *killer) {
  ...
  if (power_plant) {
    Commands->Send_Custom_Event(obj, power_plant, 3000, 3000, 0.0f);
  }
  GameObject *turret1 = Commands->Find_Object(1100013);
  if (turret1) {
    Commands->Send_Custom_Event(obj, turret1, 3000, 3000, 0.0f);
  }
  GameObject *comm_center = Commands->Find_Object(1153932);
  if (comm_center) {
    Commands->Send_Custom_Event(obj, comm_center, 3000, 3000, 0.0f);
  }
  GameObject *heli_pad = Commands->Find_Object(1154083);
  if (heli_pad) {
    Commands->Send_Custom_Event(obj, heli_pad, 3000, 3000, 0.0f);
  }
  GameObject *sam_site = Commands->Find_Object(1100010);
  if (sam_site) {
    Commands->Send_Custom_Event(obj, sam_site, 3000, 3000, 0.0f);
  }
  GameObject *turret2 = Commands->Find_Object(1100014);
  if (turret2) {
    Commands->Send_Custom_Event(obj, turret2, 3000, 3000, 0.0f);
  }

  GameObject *hon = Commands->Find_Object(1153939);
  if (hon) {
    Commands->Send_Custom_Event(obj, hon, 3000, 3000, 0.0f);
  }
  GameObject *sam1 = Commands->Find_Object(1100007);
  if (sam1) {
    Commands->Send_Custom_Event(obj, sam1, 3000, 3000, 0.0f);
  }
  GameObject *turret3 = Commands->Find_Object(2000728);
  if (turret3) {
    Commands->Send_Custom_Event(obj, turret3, 3000, 3000, 0.0f);
  }
  GameObject *turret4 = Commands->Find_Object(2000729);
  if (turret4) {
    Commands->Send_Custom_Event(obj, turret4, 3000, 3000, 0.0f);
  }
  GameObject *refinery = Commands->Find_Object(1153940);
  if (refinery) {
    Commands->Send_Custom_Event(obj, refinery, 3000, 3000, 0.0f);
  }
  GameObject *turret5 = Commands->Find_Object(1205749);
  if (turret5) {
    Commands->Send_Custom_Event(obj, turret5, 3000, 3000, 0.0f);
  }
  GameObject *turret6 = Commands->Find_Object(1205748);
  if (turret6) {
    Commands->Send_Custom_Event(obj, turret6, 3000, 3000, 0.0f);
  }
  GameObject *obelisk = Commands->Find_Object(1153938);
  if (obelisk) {
    Commands->Send_Custom_Event(obj, obelisk, 3000, 3000, 0.0f);
  }
  GameObject *sam2 = Commands->Find_Object(1100008);
  if (sam2) {
    Commands->Send_Custom_Event(obj, sam2, 3000, 3000, 0.0f);
  }
  GameObject *sam3 = Commands->Find_Object(1100009);
  if (sam3) {
    Commands->Send_Custom_Event(obj, sam3, 3000, 3000, 0.0f);
  }
  GameObject *airstrip = Commands->Find_Object(1154061);
  if (airstrip) {
    Commands->Send_Custom_Event(obj, airstrip, 3000, 3000, 0.0f);
  }
  GameObject *helipad1 = Commands->Find_Object(1154084);
  if (helipad1) {
    Commands->Send_Custom_Event(obj, helipad1, 3000, 3000, 0.0f);
  }
  GameObject *sam4 = Commands->Find_Object(1100012);
  if (sam4) {
    Commands->Send_Custom_Event(obj, sam4, 3000, 3000, 0.0f);
  }
  GameObject *sam5 = Commands->Find_Object(1100011);
  if (sam5) {
    Commands->Send_Custom_Event(obj, sam5, 3000, 3000, 0.0f);
  }
  GameObject *silo1 = Commands->Find_Object(1153935);
  if (silo1) {
    Commands->Send_Custom_Event(obj, silo1, 3000, 3000, 0.0f);
  }
  GameObject *silo2 = Commands->Find_Object(1154051);
  if (silo2) {
    Commands->Send_Custom_Event(obj, silo2, 3000, 3000, 0.0f);
  }
}
}
;

DECLARE_SCRIPT(M10_Comm_Center, ""){void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason reason){
    GameObject *obj_con = Commands->Find_Object(1100154);

if (action_id == 100011) {
  Commands->Send_Custom_Event(obj, obj_con, 1004, 3, 0.0f);
  Commands->Send_Custom_Event(obj, obj_con, 1004, 1, 0.0f);
}
}
...
DECLARE_SCRIPT(M10_Hand_Of_Nod, ""){void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason reason){
    GameObject *obj_con = Commands->Find_Object(1100154);

if (action_id == 100021) {
  Commands->Send_Custom_Event(obj, obj_con, 1008, 1, 0.0f);
}
}
...
DECLARE_SCRIPT(M10_Refinery, ""){void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason reason){
    GameObject *obj_con = Commands->Find_Object(1100154);

if (action_id == 100031) {
  Commands->Send_Custom_Event(obj, obj_con, 1009, 1, 0.0f);
}
}
...
DECLARE_SCRIPT(M10_Airstrip, ""){void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason reason){
    GameObject *obj_con = Commands->Find_Object(1100154);

if (action_id == 100037) {
  Commands->Send_Custom_Event(obj, obj_con, 1010, 1, 0.0f);
}
}
...
DECLARE_SCRIPT(M10_Silo, ""){
    void Killed(GameObject * obj, GameObject *killer){GameObject *silo_con = Commands->Find_Object(2005260);
if (silo_con) {
  Commands->Send_Custom_Event(obj, silo_con, KILLED, 0, 0.0f);
}
}
}
;
...
DECLARE_SCRIPT(M10_Silo_Controller, "") {
  ...
  void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason reason) {
    if (action_id == 100043) {
      ...
      // Commands->Set_Objective_Status(1011, OBJECTIVE_STATUS_ACCOMPLISHED);
      Commands->Send_Custom_Event(obj, obj_con, 1011, 3, 0.0f);
      Commands->Send_Custom_Event(obj, obj_con, 1011, 1, 0.0f);
    }
  }
...
DECLARE_SCRIPT(M10_Obelisk, "") {
  ...
  void Killed(GameObject * obj, GameObject * killer) {
    if (!objective_completed) {
      GameObject *obj_con = Commands->Find_Object(1100154);
      if (obj_con) {
        Commands->Send_Custom_Event(obj, obj_con, 1020, 1, 0.0f);
        Commands->Send_Custom_Event(obj, Commands->Find_Object(2010415), KILLED, 0, 0.0f);
        Commands->Send_Custom_Event(obj, Commands->Find_Object(6000728), KILLED, 0, 0.0f);
      }
    }
  }
...
DECLARE_SCRIPT(M10_Turret, ""){void Created(GameObject * obj){Commands->Enable_Enemy_Seen(obj, true);
}
...
DECLARE_SCRIPT(M10_Destroyed_Turret, ""){void Created(GameObject * obj){Commands->Start_Timer(obj, this, 1.0f, 0);
}

void Timer_Expired(GameObject *obj, int timer_id) { Commands->Create_2D_Sound("EVA_Enemy_Structure_Destroyed"); }
}
;

DECLARE_SCRIPT(M10_Destroy_Self,
               ""){void Custom(GameObject * obj, int type, int param, GameObject *sender){Commands->Destroy_Object(obj);
}
}
;
...
DECLARE_SCRIPT(M10_Apache, "Area:int") {
  ...
  void Custom(GameObject * obj, int type, int param, GameObject *sender) {
    ...
    if (type == 200 && param == 200) {
      int pad_obj[3] = {1110050, 1110051, 1110052};
    ...
    if (type == 400 && param == 400) {
      int waypath[3] = {1110082, 1110040, 1110045};
...
DECLARE_SCRIPT(M10_No_More_Parachute, ""){
    void Destroyed(GameObject * obj){Commands->Create_3D_Sound_At_Bone("parachute_away", obj, "ROOTTRANSFORM");
}
}
;
...
DECLARE_SCRIPT(M10_Reinforcement_Chinook, "Controller_ID:int") {
  ...
  REGISTER_VARIABLES() { SAVE_VARIABLE(sound_id, 1); }

  void Created(GameObject * obj) { sound_id = Commands->Create_3D_Sound_At_Bone("Chinook_Idle_01", obj, "V_FUSELAGE"); }
  ...
  void Destroyed(GameObject * obj) { Commands->Stop_Sound(sound_id, true); }
};
  ...
  void Timer_Expired(GameObject * obj, int timer_id) {
    if (timer_id == CARGO_DROP) {
      if (!tank_alive && airstrip_alive) {
        ...
        GameObject *stealth_tank = Commands->Create_Object("Nod_Stealth_Tank", Vector3(0, 0, 0));
        if (stealth_tank) {
          Commands->Send_Custom_Event(obj, new_object, M00_CUSTOM_CINEMATIC_SET_SLOT + 3,
                                      Commands->Get_ID(stealth_tank), 0.0f);
          Commands->Attach_Script(stealth_tank, "M10_Stealth_Attack_02", "");
        }
...
DECLARE_SCRIPT(M10_Ion_Cannon_Detector, ""){void Created(GameObject * obj){Commands->Set_Is_Rendered(obj, false);
Commands->Enable_Hibernation(obj, false);
...
void Sound_Heard(GameObject *obj, const CombatSound &sound) {
  ...
  if (Commands->Get_Distance(my_pos, sound.Position) <= 6.0f) {
    if (obj_con) {
      Commands->Send_Custom_Event(obj, obj_con, 1007, 1, 0.0f);
    }
  } else {
    if (obj_con) {
      Commands->Send_Custom_Event(obj, obj_con, 1007, 2, 0.0f);
    }
  }
}
}
...
DECLARE_SCRIPT(M10_Stealth, ""){void Created(GameObject * obj){Commands->Enable_Stealth(obj, true);
}
}
;

DECLARE_SCRIPT(M10_Home_Point, "Radius=5.0:float"){void Created(GameObject * obj){
    Commands->Set_Innate_Soldier_Home_Location(obj, Commands->Get_Position(obj), Get_Float_Parameter("Radius"));
}
}
;

DECLARE_SCRIPT(M10_HON_Spawn_Zones, "Zone_Number:int"){void Entered(GameObject * obj, GameObject *enterer){
    switch (Get_Int_Parameter("Zone_Number")){case 1 : {Commands->Enable_Spawner(1100124, true);
...
DECLARE_SCRIPT(M10_Refinery_Spawn_Zones, "Zone_Number:int"){void Entered(GameObject * obj, GameObject *enterer){
    switch (Get_Int_Parameter("Zone_Number")){case 1 : {Commands->Enable_Spawner(1100202, true);
...
DECLARE_SCRIPT(M10_PowerPlant_Spawn_Zones, "Zone_Number:int"){void Entered(GameObject * obj, GameObject *enterer){
    switch (Get_Int_Parameter("Zone_Number")){case 1 : {Commands->Enable_Spawner(1100244, true);
...
DECLARE_SCRIPT(M10_ComCenter_Spawn_Zones, "Zone_Number:int"){void Entered(GameObject * obj, GameObject *enterer){
    switch (Get_Int_Parameter("Zone_Number")){case 1 : {Commands->Enable_Spawner(1100232, true);
...
DECLARE_SCRIPT(M10_Gate_Test, ""){
    void Poked(GameObject * obj, GameObject *poker){Commands->Static_Anim_Phys_Goto_Last_Frame(2050007, NULL);
}
}
;
...
DECLARE_SCRIPT(M10_Mammoth_Target_Destruction, "Target_Number:int"){void Destroyed(GameObject * obj){
...
DECLARE_SCRIPT(M10_Stationary, ""){void Created(GameObject * obj){Commands->Set_Innate_Is_Stationary(obj, true);
}
}
;
...
DECLARE_SCRIPT(M10_GDI_Reinforcement_Waypath,
               ""){void Created(GameObject * obj){Commands->Set_Innate_Aggressiveness(obj, 10.0f);
...
DECLARE_SCRIPT(M10_SAM_Reinforce, ""){void Killed(GameObject * obj, GameObject *killer){
    Commands->Send_Custom_Event(obj, Commands->Find_Object(2000861), REINFORCE, 1, 0.0f);
}
}
;

DECLARE_SCRIPT(M10_Refinery_Key_Grant, ""){
    void Killed(GameObject * obj, GameObject *killer){Vector3 create_position = Commands->Get_Position(obj);
...
DECLARE_SCRIPT(M10_Gate_Check, "Objective:int, Gate1:int, Gate2:int") {
  ...
  REGISTER_VARIABLES() { SAVE_VARIABLE(already_poked, 1); }
  ...
  void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason reason) {
    ...
    if (action_id == 100002) {
      first = true;
      Commands->Send_Custom_Event(obj, obj_con, 1005, 1, 0.0f);
    }
    ...
    if (action_id == 100017) {
      Commands->Send_Custom_Event(obj, obj_con, 1006, 1, 0.0f);
    }
  }
...
DECLARE_SCRIPT(M10_Spacecraft_Check, ""){void Poked(GameObject * obj, GameObject *poker){
    if (Commands->Has_Key(STAR, 3)){Commands->Static_Anim_Phys_Goto_Last_Frame(2058171, NULL);
}
}
}
;
...
DECLARE_SCRIPT(M10_Mammoth_Grant_Controller, "") // 2001634
{
  ...
  // Register variables to be Auto-Saved
  // All variables must have a unique ID, less than 256, that never changes
  REGISTER_VARIABLES() { SAVE_VARIABLE(hon_alive, 1); }

  void Created(GameObject * obj) { hon_alive = true; }
...
DECLARE_SCRIPT(M10_Hon_Killed,
               ""){void Killed(GameObject * obj, GameObject *killer){Commands->Enable_Spawner(2000849, false);
Commands->Enable_Spawner(2000850, false);
Commands->Enable_Spawner(2000851, false);

Commands->Send_Custom_Event(obj, Commands->Find_Object(2001634), KILLED, HON, 0.0f);
}
}
;

DECLARE_SCRIPT(M10_Helipad_Killed, ""){void Killed(GameObject * obj, GameObject *killer){
    Commands->Send_Custom_Event(obj, Commands->Find_Object(2001634), KILLED, HELIPAD, 0.0f);
}
}
;

DECLARE_SCRIPT(M10_Stealth_Drop, ""){void Created(GameObject * obj){Commands->Enable_Stealth(obj, false);
}

void Destroyed(GameObject *obj) { Commands->Send_Custom_Event(obj, Commands->Find_Object(1110056), KILLED, 0, 0.0f); }
...
DECLARE_SCRIPT(M10_Obelisk_MCT, "") {
  ...
  REGISTER_VARIABLES() { SAVE_VARIABLE(alive, 1); }
  ...
  void Poked(GameObject * obj, GameObject * poker) {
    if (alive) {
      Commands->Send_Custom_Event(obj, Commands->Find_Object(2010415), M10_PLAYERTYPE_CHANGE_OBELISK, 0, 0.0f);
    }
  }
...
DECLARE_SCRIPT(M10_Refinery_Keycard, ""){void Custom(GameObject * obj, int type, int param, GameObject *sender){
    if (type == CUSTOM_EVENT_POWERUP_GRANTED){GameObject *obj_con = Commands->Find_Object(1100154);
if (obj_con) {
  Commands->Send_Custom_Event(obj, obj_con, 1012, 1, 0.0f);
}
}
}
}
    ...
    if (type == FLYOVER) {
      if (++count >= 3) {
        ...
        const char *flyovers[10] = {
            "X10A_Apache_00.txt", "X10A_Apache_01.txt", "X10A_Apache_02.txt",
            "X10A_Apache_03.txt", "X10A_Apache_04.txt",

            "X10A_Trnspt_00.txt", "X10A_Trnspt_01.txt", "X10A_Trnspt_02.txt",
            "X10A_Trnspt_03.txt", "X10A_Trnspt_04.txt",
...
DECLARE_SCRIPT(M10_Conversation_Zone, "Conv_Num:int") {
  ...
  void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason reason) {
    ...
    if (action_id == 100007) {
      Commands->Send_Custom_Event(obj, obj_con, 1007, 3, 0.0f);
    }
    ...
    if (action_id == 100018) {
      Commands->Send_Custom_Event(obj, obj_con, 1006, 3, 0.0f);
    }
    ...
    if (action_id == 100033) {
      Commands->Send_Custom_Event(obj, obj_con, 1018, 3, 0.0f);
    }

    if (action_id == 100036) {
      Commands->Send_Custom_Event(obj, obj_con, 1010, 3, 0.0f);
    }

    if (action_id == 100039) {
      Commands->Send_Custom_Event(obj, obj_con, 1014, 3, 0.0f);
    }
    ...
    if (action_id == 100044) {
      Commands->Send_Custom_Event(obj, obj_con, 1017, 3, 0.0f);
    }
  ...
  void Entered(GameObject * obj, GameObject * enterer) {
    if (!already_entered) {
      ...
      case 6: {
        ...
        Commands->Send_Custom_Event(obj, Commands->Find_Object(2014793), ENTERED, 0, 0.0f);
      ...
      case 7: {
        ...
        Commands->Send_Custom_Event(obj, Commands->Find_Object(2017710), ENTERED, 0, 0.0f);
      ...
      case 15: {
        ...
        Commands->Send_Custom_Event(obj, Commands->Find_Object(2014798), ENTERED, 0, 0.0f);
        Commands->Send_Custom_Event(obj, Commands->Find_Object(2014799), ENTERED, 0, 0.0f);
      ...
      case 30: {
        ...
        Commands->Send_Custom_Event(obj, Commands->Find_Object(2015525), ENTERED, 0, 0.0f);
      ...
      case 32: {
        if (Commands->Get_Health(Commands->Find_Object(1153940)) > 0.0f) {
          ...
          Commands->Send_Custom_Event(obj, Commands->Find_Object(2016248), ENTERED, 0, 0.0f);
      ...
      case 42: {
        if (Commands->Get_Health(Commands->Find_Object(2063323)) > 0.0f ||
            Commands->Get_Health(Commands->Find_Object(1153935)) > 0.0f) {
          already_entered = true;

          Commands->Send_Custom_Event(obj, Commands->Find_Object(2016251), ENTERED, 0, 0.0f);
          Commands->Send_Custom_Event(obj, Commands->Find_Object(2016976), ENTERED, 0, 0.0f);
      ...
      case 44: {
        if (Commands->Get_Health(Commands->Find_Object(1100012)) > 0.0f ||
            Commands->Get_Health(Commands->Find_Object(1100011)) > 0.0f) {
          already_entered = true;

          Commands->Send_Custom_Event(obj, Commands->Find_Object(2017698), ENTERED, 0, 0.0f);
      ...
      case 51: {
        if (Commands->Get_Health(Commands->Find_Object(1100014)) > 0.0f ||
            Commands->Get_Health(Commands->Find_Object(1100013)) > 0.0f) {
          already_entered = true;
      ...
      case 54: {
        ...
        Commands->Send_Custom_Event(obj, Commands->Find_Object(2014795), ENTERED, 0, 0.0f);
        Commands->Send_Custom_Event(obj, Commands->Find_Object(2017711), ENTERED, 0, 0.0f);
...
DECLARE_SCRIPT(M10_Sam_Killed, "SamNumber:int"){
    /*void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason reason)
    {
            ...
            if (action_id == 100050)
            {
                    Commands->Send_Custom_Event(obj, obj_con, 1016, 1, 0.0f);
            }
    }*/

    void Killed(GameObject * obj, GameObject *killer){GameObject *obj_con = Commands->Find_Object(1100154);
...
case 2: {
  Commands->Send_Custom_Event(obj, obj_con, 1017, 1, 0.0f);
} break;
case 3: {
  Commands->Send_Custom_Event(obj, obj_con, 1018, 1, 0.0f);
} break;
case 4: {
  Commands->Send_Custom_Event(obj, obj_con, 1016, 3, 0.0f);
  Commands->Send_Custom_Event(obj, obj_con, 1016, 1, 0.0f);
...
DECLARE_SCRIPT(M10_Helipad_Destroyed,
               "PadNumber:int"){void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason reason){
    GameObject *obj_con = Commands->Find_Object(1100154);

if (action_id == 100040) {
  Commands->Send_Custom_Event(obj, obj_con, 1014, 3, 0.0f);
  Commands->Send_Custom_Event(obj, obj_con, 1014, 1, 0.0f);
}

if (action_id == 100048) {
  Commands->Send_Custom_Event(obj, obj_con, 1013, 3, 0.0f);
  Commands->Send_Custom_Event(obj, obj_con, 1013, 1, 0.0f);
}
}
...
DECLARE_SCRIPT(M10_Mrls_Grant, "") {
  ...
  void Timer_Expired(GameObject * obj, int timer_id) {
    if (timer_id == GRANT_MRLS) {
      if (!occupied1 && grant) {
        GameObject *mrls =
            Commands->Create_Object("GDI_MRLS_Player", Commands->Get_Position(Commands->Find_Object(drop_loc1)));
        Commands->Attach_Script(mrls, "M10_Mrls_Waypath", "");
      }

      else if (!occupied2 && grant) {
        GameObject *mrls2 =
            Commands->Create_Object("GDI_MRLS_Player", Commands->Get_Position(Commands->Find_Object(drop_loc2)));
...
DECLARE_SCRIPT(M10_Mrls_Waypath, ""){
    void Created(GameObject * obj){Commands->Send_Custom_Event(obj, Commands->Find_Object(1100007),
                                                               M00_CUSTOM_SAM_SITE_IGNORE, Commands->Get_ID(obj), 0.0f);
...
void Killed(GameObject *obj, GameObject *killer) {
  Commands->Send_Custom_Event(obj, Commands->Find_Object(1100166), MAMMY, 0, 0.0f);
}
...
DECLARE_SCRIPT(M10_Ssm_Trigger, "") {
  ...
  void Entered(GameObject * obj, GameObject * enterer) {
    if (!already_entered) {
      ...
      Commands->Send_Custom_Event(obj, Commands->Find_Object(2009688), M00_LAUNCH_SSM, 0, 0.0f);
    }
  }
};
...
DECLARE_SCRIPT(M10_Radar_Scramble, "") {
  ...
  void Entered(GameObject * obj, GameObject * enterer) {
    if (Commands->Get_Health(Commands->Find_Object(1153932)) > 0 &&
        Commands->Get_Health(Commands->Find_Object(1153931)) > 0) {
      if (!already_entered) {
        Commands->Send_Custom_Event(obj, Commands->Find_Object(1110022), ENTERED, 0, 0.0f);
        Commands->Send_Custom_Event(obj, Commands->Find_Object(1100160), ENTERED, 0, 0.0f);
        already_entered = true;
...
DECLARE_SCRIPT(M10_Radar_UnScramble,
               ""){void Entered(GameObject * obj, GameObject *enterer){Commands->Enable_Radar(true);
}
}
;

DECLARE_SCRIPT(M10_HON_KillPrevention, ""){
    void Killed(GameObject * obj, GameObject *killer){if (killer != STAR){Commands->Set_Health(obj, 1.0f);
}
}
}
;
...
DECLARE_SCRIPT(M10_NBase_Attacked, "") // 1206469
{
  ...
  REGISTER_VARIABLES() { SAVE_VARIABLE(message_fired, 1); }

  void Created(GameObject * obj) { message_fired = false; }
...
DECLARE_SCRIPT(M10_Lv2_KeyCarrier, ""){
    void Killed(GameObject * obj, GameObject *killer){Vector3 spawnLocation = Commands->Get_Position(obj);
                  ...
                  case ACTION_COMPLETE_CONVERSATION_ENDED:
                          {
                                  if (action_id == 100061)
                                  {
                                          Commands->Debug_Message ( "***************************kane conversation 02 is
  over--sending delete custom\n" ); Commands->Send_Custom_Event ( obj, obj, 0, 8000, 2 );
                                  }
                          }
                          break;
          }
...
{void Created(GameObject * obj){if (STAR){int id = Commands->Create_Conversation("M10CON057", 99, 100, true);
