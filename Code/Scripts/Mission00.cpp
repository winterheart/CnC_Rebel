...
DECLARE_SCRIPT(MTU_Tutorial_Controller, "") {
  ...
  void Created(GameObject * obj) {
    ...
    Commands->Add_Radar_Marker(MTU_RADAR_MCT_01, Vector3(29.63f, 11.98f, -8.04f), RADAR_BLIP_SHAPE_STATIONARY,
                               RADAR_BLIP_COLOR_GDI);
    Commands->Add_Radar_Marker(MTU_RADAR_MCT_02, Vector3(10.15f, -19.68f, -8.36f), RADAR_BLIP_SHAPE_STATIONARY,
                               RADAR_BLIP_COLOR_GDI);
    Commands->Add_Radar_Marker(MTU_RADAR_MCT_03, Vector3(-43.23f, 25.66f, -6.32f), RADAR_BLIP_SHAPE_STATIONARY,
                               RADAR_BLIP_COLOR_GDI);
    Commands->Add_Radar_Marker(MTU_RADAR_MCT_04, Vector3(-25.33f, 56.15f, -7.56f), RADAR_BLIP_SHAPE_STATIONARY,
                               RADAR_BLIP_COLOR_GDI);
    Commands->Add_Radar_Marker(MTU_RADAR_MCT_05, Vector3(-7.89f, 15.57f, -8.75f), RADAR_BLIP_SHAPE_STATIONARY,
                               RADAR_BLIP_COLOR_GDI);

    // Add all objectives as hidden to start.

    Commands->Add_Objective(MTU_OBJECTIVE_01, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_HIDDEN,
                            IDS_Enc_ObjTitle_Primary_M00_01, "IDS_M00EVAG_DSGN0056I1EVAG_SND",
                            IDS_Enc_Obj_Primary_M00_01);
    Commands->Add_Objective(MTU_OBJECTIVE_02, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_HIDDEN,
                            IDS_Enc_ObjTitle_Primary_M00_02, "IDS_M00EVAG_DSGN0056I1EVAG_SND",
                            IDS_Enc_Obj_Primary_M00_02);
    Commands->Add_Objective(MTU_OBJECTIVE_03, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_HIDDEN,
                            IDS_Enc_ObjTitle_Primary_M00_03, "IDS_M00EVAG_DSGN0056I1EVAG_SND",
                            IDS_Enc_Obj_Primary_M00_03);
    Commands->Add_Objective(MTU_OBJECTIVE_04, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_HIDDEN,
                            IDS_Enc_ObjTitle_Primary_M00_04, "IDS_M00EVAG_DSGN0056I1EVAG_SND",
                            IDS_Enc_Obj_Primary_M00_04);
    Commands->Add_Objective(MTU_OBJECTIVE_05, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_HIDDEN,
                            IDS_Enc_ObjTitle_Primary_M00_05, "IDS_M00EVAG_DSGN0056I1EVAG_SND",
                            IDS_Enc_Obj_Primary_M00_05);
    Commands->Add_Objective(MTU_OBJECTIVE_06, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_HIDDEN,
                            IDS_Enc_ObjTitle_Primary_M00_06, "IDS_M00EVAG_DSGN0056I1EVAG_SND",
                            IDS_Enc_Obj_Primary_M00_06);
  ...
  void Custom(GameObject * obj, int type, int param, GameObject *sender) {
    ...
    case (MTU_TYPE_RANGE_SETUP_HANDGUN): {
      GameObject *range_target_one_obj =
          Commands->Create_Object("Nod_Minigunner_0", Vector3(-32.264f, 50.158f, 1.015f));
      if (range_target_one_obj) {
      ...
      GameObject *range_target_two_obj =
          Commands->Create_Object("Nod_Minigunner_0", Vector3(-33.849f, 53.635f, 1.371f));
      if (range_target_two_obj) {
      ...
      GameObject *range_target_three_obj =
          Commands->Create_Object("Nod_Minigunner_0", Vector3(-35.616f, 53.662f, 1.394f));
      if (range_target_three_obj) {
    ...
    case (MTU_TYPE_RANGE_SETUP_SNIPER_RIFLE): {
      GameObject *range_target_one_obj =
          Commands->Create_Object("Nod_Minigunner_0", Vector3(-39.228f, 47.670f, 3.232f));
      if (range_target_one_obj) {
        range_target_one = Commands->Get_ID(range_target_one_obj);
        Commands->Attach_Script(range_target_one_obj, "MTU_Range_Target", "1");
      ...
      GameObject *range_target_two_obj =
          Commands->Create_Object("Nod_Minigunner_0", Vector3(-36.870f, 50.308f, 1.014f));
      if (range_target_two_obj) {
        Commands->Set_Facing(range_target_two_obj, 90.0f);
        range_target_two = Commands->Get_ID(range_target_two_obj);
        Commands->Attach_Script(range_target_two_obj, "MTU_Range_Target", "2");
      ...
      GameObject *range_target_three_obj =
          Commands->Create_Object("Nod_Minigunner_0", Vector3(-32.215f, 50.497f, 1.014f));
      if (range_target_three_obj) {
        Commands->Set_Facing(range_target_three_obj, 90.0f);
        range_target_three = Commands->Get_ID(range_target_three_obj);
        Commands->Attach_Script(range_target_three_obj, "MTU_Range_Target", "3");
    ...
    case (MTU_TYPE_RANGE_SETUP_AUTORIFLE): {
      ...
      GameObject *range_target_two_obj =
          Commands->Create_Object("Nod_Minigunner_0", Vector3(-39.557f, 49.958f, 3.232f));
      if (range_target_two_obj) {
        range_target_two = Commands->Get_ID(range_target_two_obj);
        Commands->Attach_Script(range_target_two_obj, "MTU_Range_Target", "2");
      ...
      GameObject *range_target_three_obj =
          Commands->Create_Object("Nod_Minigunner_0", Vector3(-29.893f, 50.071f, 3.232f));
      if (range_target_three_obj) {
        range_target_three = Commands->Get_ID(range_target_three_obj);
        Commands->Attach_Script(range_target_three_obj, "MTU_Range_Target", "3");
    ...
    case (MTU_TYPE_RANGE_SETUP_GRENADE): {
      ...
      GameObject *range_target_three_obj =
          Commands->Create_Object("Nod_Minigunner_0", Vector3(-36.812f, 47.595f, 3.232f));
      if (range_target_three_obj) {
        range_target_three = Commands->Get_ID(range_target_three_obj);
        Commands->Set_Facing(range_target_three_obj, 90.0f);
        Commands->Attach_Script(range_target_three_obj, "MTU_Range_Target", "3");
    ...
    case (MTU_TYPE_RANGE_SETUP_CHAINGUN): {
      GameObject *range_target_one_obj =
          Commands->Create_Object("Nod_Minigunner_0", Vector3(-32.160f, 50.072f, 1.015f));
      if (range_target_one_obj) {
        range_target_one = Commands->Get_ID(range_target_one_obj);
        Commands->Attach_Script(range_target_one_obj, "MTU_Range_Target", "1");
      ...
      GameObject *range_target_two_obj =
          Commands->Create_Object("Nod_Minigunner_0", Vector3(-34.704f, 47.525f, 3.232f));
      if (range_target_two_obj) {
        range_target_two = Commands->Get_ID(range_target_two_obj);
        Commands->Attach_Script(range_target_two_obj, "MTU_Range_Target", "2");
        Commands->Attach_Script(range_target_two_obj, "MTU_Range_Target_Miss_Commando", "");
      ...
      GameObject *range_target_three_obj =
          Commands->Create_Object("Nod_Minigunner_0", Vector3(-37.425f, 49.562f, 1.015f));
      if (range_target_three_obj) {
        range_target_three = Commands->Get_ID(range_target_three_obj);
        Commands->Attach_Script(range_target_three_obj, "MTU_Range_Target", "3");
    ...
    case (MTU_TYPE_RANGE_SETUP_FLAMETHROWER): {
      GameObject *range_target_one_obj =
          Commands->Create_Object("Nod_Minigunner_0", Vector3(-29.966f, 50.615f, 3.232f));
      if (range_target_one_obj) {
        range_target_one = Commands->Get_ID(range_target_one_obj);
        Commands->Attach_Script(range_target_one_obj, "MTU_Range_Target", "1");
      ...
      GameObject *range_target_two_obj =
          Commands->Create_Object("Nod_Minigunner_0", Vector3(-39.083f, 47.287f, 3.232f));
      if (range_target_two_obj) {
        range_target_two = Commands->Get_ID(range_target_two_obj);
        Commands->Attach_Script(range_target_two_obj, "MTU_Range_Target", "2");
      ...
      GameObject *range_target_three_obj =
          Commands->Create_Object("Nod_Minigunner_0", Vector3(-39.557f, 50.218f, 3.232f));
      if (range_target_three_obj) {
        range_target_three = Commands->Get_ID(range_target_three_obj);
    ...
    case (MTU_TYPE_RANGE_SETUP_ROCKET): {
      ...
      GameObject *range_target_two_obj =
          Commands->Create_Object("Nod_Minigunner_0", Vector3(-33.967f, 50.601f, 1.014f));
      if (range_target_two_obj) {
        range_target_two = Commands->Get_ID(range_target_two_obj);
        Commands->Set_Facing(range_target_two_obj, 90.0f);
        Commands->Attach_Script(range_target_two_obj, "MTU_Range_Target", "2");
    ...
    case (MTU_TYPE_RANGE_SETUP_C4): {
      ...
      GameObject *range_target_two_obj =
          Commands->Create_Object("Nod_Minigunner_0", Vector3(-31.702f, 49.550f, 1.016f));
      if (range_target_two_obj) {
        range_target_two = Commands->Get_ID(range_target_two_obj);
        Commands->Set_Facing(range_target_two_obj, -90.0f);
        Commands->Attach_Script(range_target_two_obj, "MTU_Range_Target", "2");
      ...
      GameObject *range_target_three_obj =
          Commands->Create_Object("Nod_Minigunner_0", Vector3(-37.801f, 49.708f, 1.015f));
      if (range_target_three_obj) {
        range_target_three = Commands->Get_ID(range_target_three_obj);
        Commands->Set_Facing(range_target_three_obj, -90.0f);
        Commands->Attach_Script(range_target_three_obj, "MTU_Range_Target", "3");
    ...
    case (MTU_TYPE_RANGE_SETUP_ION): {
      ...
      GameObject *range_target_two_obj =
          Commands->Create_Object("Nod_Minigunner_0", Vector3(-31.562f, 50.246f, 1.015f));
      if (range_target_two_obj) {
        range_target_two = Commands->Get_ID(range_target_two_obj);
        Commands->Set_Facing(range_target_two_obj, 90.0f);
        Commands->Attach_Script(range_target_two_obj, "MTU_Range_Target", "2");
      ...
      GameObject *range_target_three_obj =
          Commands->Create_Object("Nod_Minigunner_0", Vector3(-37.501f, 50.184f, 1.014f));
      if (range_target_three_obj) {
        range_target_three = Commands->Get_ID(range_target_three_obj);
        Commands->Set_Facing(range_target_three_obj, 90.0f);
        Commands->Attach_Script(range_target_three_obj, "MTU_Range_Target", "3");
...
DECLARE_SCRIPT(MTU_Tutorial_Instructor, "") {
  ...
  void Say_Something(GameObject * obj, int speech_id) {
    ...
    case (MTU_SPEECH_GUNNER_ION): {
      Commands->Add_Radar_Marker(MTU_RADAR_GUNNER, Vector3(-34.91f, 61.62f, 2.60f), RADAR_BLIP_SHAPE_OBJECTIVE,
    ...
    case (MTU_SPEECH_HOTWIRE_INTRO): {
      ...
      Commands->Add_Radar_Marker(MTU_RADAR_COURSE_01, Vector3(-32.12f, -48.05f, 1.37f), RADAR_BLIP_SHAPE_OBJECTIVE,
                                 RADAR_BLIP_COLOR_SECONDARY_OBJECTIVE);
      Commands->Add_Radar_Marker(MTU_RADAR_COURSE_02, Vector3(-26.36f, 34.21f, 2.0f), RADAR_BLIP_SHAPE_OBJECTIVE,
                                 RADAR_BLIP_COLOR_SECONDARY_OBJECTIVE);
      Commands->Add_Radar_Marker(MTU_RADAR_COURSE_03, Vector3(47.16f, 39.18f, 1.51f), RADAR_BLIP_SHAPE_OBJECTIVE,
                                 RADAR_BLIP_COLOR_SECONDARY_OBJECTIVE);
      Commands->Add_Radar_Marker(MTU_RADAR_COURSE_04, Vector3(30.77f, -26.61f, 2.75f), RADAR_BLIP_SHAPE_OBJECTIVE,
                                 RADAR_BLIP_COLOR_SECONDARY_OBJECTIVE);
  ...
  void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason complete_reason) {
    if ((complete_reason == ACTION_COMPLETE_CONVERSATION_ENDED) ||
      ...
      case (MTU_SPEECH_LOGAN_JUMP_TEST): // Logan finished giving jump test introduction, enable commando and move to
                                         // next spot.
      {
      ...
      case (MTU_SPEECH_LOGAN_EVA): // Logan finished introducing EVA, turn on first objective radar location.
      {
        ...
        Commands->Set_Objective_HUD_Info_Position(MTU_OBJECTIVE_01, 99, "POG_M00_1_01.tga", IDS_POG_LOCATE,
                                                  Vector3(-12.39f, 20.78f, 1.81f));
      ...
      case (MTU_SPEECH_LOGAN_KEYCARDS): // Logan finished introducing keycards, give the commando a green one and
                                        // continue.
      {
      ...
      case (MTU_SPEECH_LOGAN_WHATSNEXT): // Logan gave the Whats Next dialog.
      {
        ...
        Commands->Set_Objective_HUD_Info_Position(MTU_OBJECTIVE_04, 99, "POG_M00_1_04.tga", IDS_POG_LOCATE,
                                                  Vector3(24.40f, 11.86f, 2.60f));
        Move_Somewhere(obj, MTU_MOVE_LOGAN_REFINERY, MTU_ACTION_DEFAULT);
        break;
      }
      case (MTU_SPEECH_LOGAN_PREPARE_POWER): // Logan is moving toward the power plant
      {
        ...
        Commands->Set_Objective_HUD_Info_Position(MTU_OBJECTIVE_05, 99, "POG_M00_1_05.tga", IDS_POG_LOCATE,
                                                  Vector3(-42.46f, 19.45f, 3.79f));
        Move_Somewhere(obj, MTU_MOVE_LOGAN_POWER, MTU_ACTION_DEFAULT);
        break;
      }
      case (MTU_SPEECH_LOGAN_PREPARE_INFANTRY): {
      ...
      case (MTU_SPEECH_SYDNEY_RADAR): {
        ...
        Commands->Set_Objective_HUD_Info_Position(MTU_OBJECTIVE_02, 99, "POG_M00_1_02.tga", IDS_POG_LOCATE,
                                                  Vector3(-16.216f, 72.693f, 1.042f));
        GameObject *logan = Commands->Find_Object(MTU_LOGAN);
        if (logan) {
      ...
      case (MTU_SPEECH_GUNNER_ENDING): {
        ...
        Commands->Set_Objective_HUD_Info_Position(MTU_OBJECTIVE_03, 99, "POG_M00_1_03.tga", IDS_POG_LOCATE,
                                                  Vector3(-0.687f, -18.630f, 0.100f));
        break;
      }
...
DECLARE_SCRIPT(MTU_GDI_Soldier, "") {
  ...
  REGISTER_VARIABLES() { SAVE_VARIABLE(gate_guard_opened, 1); }
...
DECLARE_SCRIPT(MTU_Commando, "") {
  ...
  REGISTER_VARIABLES() { SAVE_VARIABLE(sydney_shot, 1); }
...
DECLARE_SCRIPT(MTU_Commando_Startup,
               ""){void Created(GameObject * obj){Commands->Attach_Script(obj, "MTU_Commando", "");
}
}
;

DECLARE_SCRIPT(MTU_PowerUp_Health, ""){void Custom(GameObject * obj, int type, int param, GameObject *sender){
    if (type == CUSTOM_EVENT_POWERUP_GRANTED){GameObject *sydney = Commands->Find_Object(MTU_SYDNEY);
if (sydney) {
...
DECLARE_SCRIPT(MTU_PowerUp_Armor, ""){void Custom(GameObject * obj, int type, int param, GameObject *sender){
    if (type == CUSTOM_EVENT_POWERUP_GRANTED){GameObject *sydney = Commands->Find_Object(MTU_SYDNEY);
if (sydney) {
...
DECLARE_SCRIPT(MTU_Nod_Apache,
               "Apache_ID:int"){void Created(GameObject * obj){Commands->Disable_Physical_Collisions(obj);
ActionParamsStruct params;
params.Set_Basic(this, 100, 0);
...
DECLARE_SCRIPT(MTU_Range_Target_Path_Mid, ""){void Created(GameObject * obj){ActionParamsStruct params;
...
DECLARE_SCRIPT(MTU_Range_Target_Path_Right, ""){void Created(GameObject * obj){ActionParamsStruct params;
params.Set_Basic(this, 100, 1);
params.Set_Movement(Vector3(0, 0, 0), WALK, 1.0f);
...
DECLARE_SCRIPT(MTU_Range_Target_Path_Left, ""){void Created(GameObject * obj){ActionParamsStruct params;
params.Set_Basic(this, 100, 1);
params.Set_Movement(Vector3(0, 0, 0), WALK, 1.0f);
...
DECLARE_SCRIPT(MTU_Range_Target_Miss_Commando,
               ""){void Created(GameObject * obj){Commands->Enable_Enemy_Seen(obj, true);
}
...
DECLARE_SCRIPT(MTU_Range_Powerup,
               "Powerup_ID:int"){void Custom(GameObject * obj, int type, int param, GameObject *sender){
    if (type == CUSTOM_EVENT_POWERUP_GRANTED){GameObject *controller = Commands->Find_Object(MTU_CONTROLLER);
if (controller) {
...
DECLARE_SCRIPT(MTU_Building_Controller, "Building_ID:int") {
  ...
  void Created(GameObject * obj) { can_be_damaged = false; }
...
DECLARE_SCRIPT(MTU_Nod_Soldier, "Soldier_ID:int"){void Created(GameObject * obj){Commands->Grant_Key(obj, 1, true);
...
DECLARE_SCRIPT(MTU_Flyover,
               "Vehicle_ID:int"){void Created(GameObject * obj){int vehicle_id = Get_Int_Parameter("Vehicle_ID");
ActionParamsStruct params;
params.Set_Basic(this, 100, 0);
...
DECLARE_SCRIPT(MSK_Controller, ""){void Created(GameObject * obj){
...
Commands->Add_Radar_Marker(300204, Vector3(-148.55f, -53.50f, -2.44f), RADAR_BLIP_SHAPE_OBJECTIVE,
                           RADAR_BLIP_COLOR_SECONDARY_OBJECTIVE);
Commands->Add_Radar_Marker(300205, Vector3(-130.60f, -23.70f, -1.33f), RADAR_BLIP_SHAPE_OBJECTIVE,
                           RADAR_BLIP_COLOR_SECONDARY_OBJECTIVE);
Commands->Add_Radar_Marker(300206, Vector3(-172.46f, -18.81f, -2.22f), RADAR_BLIP_SHAPE_OBJECTIVE,
                           RADAR_BLIP_COLOR_SECONDARY_OBJECTIVE);
Commands->Add_Radar_Marker(300207, Vector3(-142.41f, -63.27f, -1.28f), RADAR_BLIP_SHAPE_OBJECTIVE,
                           RADAR_BLIP_COLOR_SECONDARY_OBJECTIVE);
Commands->Add_Radar_Marker(300208, Vector3(-171.69f, -42.64f, -1.67f), RADAR_BLIP_SHAPE_OBJECTIVE,
                           RADAR_BLIP_COLOR_SECONDARY_OBJECTIVE);
Commands->Add_Radar_Marker(300209, Vector3(-138.67f, -80.16f, -1.29f), RADAR_BLIP_SHAPE_OBJECTIVE,
                           RADAR_BLIP_COLOR_SECONDARY_OBJECTIVE);
Commands->Add_Radar_Marker(300216, Vector3(-138.72f, -38.65f, -2.11f), RADAR_BLIP_SHAPE_OBJECTIVE,
                           RADAR_BLIP_COLOR_SECONDARY_OBJECTIVE);
Commands->Add_Radar_Marker(300219, Vector3(-147.80f, -36.11f, -1.95f), RADAR_BLIP_SHAPE_OBJECTIVE,
                           RADAR_BLIP_COLOR_SECONDARY_OBJECTIVE);
Commands->Add_Radar_Marker(300220, Vector3(-42.57f, 53.47f, 1.32f), RADAR_BLIP_SHAPE_OBJECTIVE,
                           RADAR_BLIP_COLOR_SECONDARY_OBJECTIVE);
Commands->Add_Radar_Marker(300221, Vector3(-63.18f, 61.87f, -0.89f), RADAR_BLIP_SHAPE_OBJECTIVE,
                           RADAR_BLIP_COLOR_SECONDARY_OBJECTIVE);
Commands->Add_Radar_Marker(300222, Vector3(-43.25f, 130.42f, -1.98f), RADAR_BLIP_SHAPE_OBJECTIVE,
                           RADAR_BLIP_COLOR_SECONDARY_OBJECTIVE);
Commands->Add_Radar_Marker(300223, Vector3(-45.95f, 45.55f, 0.59f), RADAR_BLIP_SHAPE_OBJECTIVE,
                           RADAR_BLIP_COLOR_SECONDARY_OBJECTIVE);
Commands->Add_Radar_Marker(300224, Vector3(-21.88f, 86.67f, -2.14f), RADAR_BLIP_SHAPE_OBJECTIVE,
                           RADAR_BLIP_COLOR_SECONDARY_OBJECTIVE);
Commands->Add_Radar_Marker(300225, Vector3(-26.22f, 43.53f, -2.12f), RADAR_BLIP_SHAPE_OBJECTIVE,
                           RADAR_BLIP_COLOR_SECONDARY_OBJECTIVE);
Commands->Add_Radar_Marker(300226, Vector3(-46.19f, 77.10f, 1.31f), RADAR_BLIP_SHAPE_OBJECTIVE,
                           RADAR_BLIP_COLOR_SECONDARY_OBJECTIVE);
Commands->Add_Radar_Marker(300230, Vector3(-45.71f, 62.55f, -2.55f), RADAR_BLIP_SHAPE_OBJECTIVE,
                           RADAR_BLIP_COLOR_SECONDARY_OBJECTIVE);
