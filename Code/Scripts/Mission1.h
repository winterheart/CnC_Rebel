...
inline const char *M01_Choose_Duck_Animation() {
  const char *animationList[5] = {
      "H_A_A0A0_L20", "H_A_A0A0_L21", "H_A_A0A0_L36", "H_A_A0A0_L52", "H_A_J21C",
  };
...
inline const char *M01_Choose_Idle_Animation() {
  const char *animationList[14] = {
      "H_A_A0A0_L01", "H_A_A0A0_L02", "H_A_A0A0_L03", "H_A_A0A0_L04", "H_A_A0A0_L05", "H_A_A0A0_L13", "H_A_X33C",
      "H_A_J33C",     "H_A_J24C",     "H_A_J22C",     "H_A_J17C",     "H_A_J15C",     "H_A_J14C",     "H_A_J11C",
  };
