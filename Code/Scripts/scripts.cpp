...
void ScriptImpClass::Set_Request_Destroy_Func(void (*function)(ScriptClass *)) { Request_Destroy_Script = function; }
...
const char *ScriptImpClass::Get_Name(void) { return mFactory->GetName(); }
