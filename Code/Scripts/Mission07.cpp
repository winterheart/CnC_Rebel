...
DECLARE_SCRIPT(M07_Objective_Controller, "") // 100657
{
  ...
  void Add_An_Objective(int id) {
    ...
    // Evacuate Sydney
    case 701: {
      Commands->Add_Objective(701, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_PENDING, IDS_Enc_ObjTitle_Primary_M07_01,
      ...
      if (object) {
        ...
        Commands->Set_Objective_HUD_Info_Position(701, 90.0f, "POG_M07_1_04.tga", IDS_POG_EVACUATE,
                                                  Commands->Get_Position(object));
      }
    } break;
    // Secure SAM Sites
    case 702: {
      Commands->Add_Objective(702, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_PENDING, IDS_Enc_ObjTitle_Primary_M07_03,
                              NULL, IDS_Enc_Obj_Primary_M07_03);
      ...
      if (object) {
        ...
        Commands->Set_Objective_HUD_Info_Position(702, 90.0f, "POG_M07_1_01.tga", IDS_POG_SECURE,
                                                  Commands->Get_Position(object));
      }
    } break;
    // Destroy SSM Launchers
    case 703: {
      Commands->Add_Objective(703, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_PENDING, IDS_Enc_ObjTitle_Primary_M07_04,
                              NULL, IDS_Enc_Obj_Primary_M07_04);
      object = Commands->Find_Object(100798);
      if (object) {
        Commands->Set_Objective_Radar_Blip_Object(703, object);
        Commands->Set_Objective_HUD_Info_Position(703, 90.0f, "POG_M07_1_02.tga", IDS_POG_DESTROY,
                                                  Commands->Get_Position(object));
      }
    } break;
    // Destroy Radar Installations
    case 704: {
      Commands->Add_Objective(704, OBJECTIVE_TYPE_SECONDARY, OBJECTIVE_STATUS_PENDING,
                              IDS_Enc_ObjTitle_Secondary_M07_01, NULL, IDS_Enc_Obj_Secondary_M07_01);
      object = Commands->Find_Object(100721);
      if (object) {
        Commands->Set_Objective_Radar_Blip_Object(704, object);
        Commands->Set_Objective_HUD_Info_Position(704, 90.0f, "POG_M07_2_07.tga", IDS_POG_DESTROY,
                                                  Commands->Get_Position(object));
      }
    } break;
    // Rescue Resistance
    case 705: {
      Commands->Add_Objective(705, OBJECTIVE_TYPE_SECONDARY, OBJECTIVE_STATUS_PENDING,
                              IDS_Enc_ObjTitle_Secondary_M07_02, NULL, IDS_Enc_Obj_Secondary_M07_02);
      object = Commands->Find_Object(115842);
      if (object) {
        Commands->Set_Objective_Radar_Blip_Object(705, object);
        Commands->Set_Objective_HUD_Info_Position(705, 90.0f, "POG_M07_2_04.tga", IDS_POG_RESCUE,
                                                  Commands->Get_Position(object));
      }
    } break;
    // Destroy Napalm Stockpile
    case 706: {
      Commands->Add_Objective(706, OBJECTIVE_TYPE_SECONDARY, OBJECTIVE_STATUS_PENDING,
                              IDS_Enc_ObjTitle_Secondary_M07_03, NULL, IDS_Enc_Obj_Secondary_M07_03);
      object = Commands->Find_Object(100781);
      if (object) {
        Commands->Set_Objective_Radar_Blip_Object(706, object);
        Commands->Set_Objective_HUD_Info_Position(706, 90.0f, "POG_M07_2_06.tga", IDS_POG_DESTROY,
                                                  Commands->Get_Position(object));
      }
    } break;
    // Destroy Stealth Tank
    case 707: {
      Commands->Add_Objective(707, OBJECTIVE_TYPE_SECONDARY, OBJECTIVE_STATUS_PENDING,
                              IDS_Enc_ObjTitle_Secondary_M07_04, NULL, IDS_Enc_Obj_Secondary_M07_04);
      object = Commands->Find_Object(100801);
      if (object) {
        Commands->Set_Objective_Radar_Blip_Object(707, object);
        Commands->Set_Objective_HUD_Info_Position(707, 90.0f, "POG_M07_2_03.tga", IDS_POG_DESTROY,
                                                  Commands->Get_Position(object));
      }
    } break;
    // Defeat Obelisk
    case 708: {
      Commands->Add_Objective(708, OBJECTIVE_TYPE_SECONDARY, OBJECTIVE_STATUS_PENDING,
                              IDS_Enc_ObjTitle_Secondary_M07_05, NULL, IDS_Enc_Obj_Secondary_M07_05);
      object = Commands->Find_Object(168926);
      if (object) {
        Commands->Set_Objective_Radar_Blip_Object(708, object);
        Commands->Set_Objective_HUD_Info_Position(708, 90.0f, "POG_M07_2_05.tga", IDS_POG_DEFEAT,
                                                  Commands->Get_Position(object));
      }
    } break;
    // Protect Team Members
    case 709: {
      Commands->Add_Objective(709, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_PENDING, IDS_Enc_ObjTitle_Primary_M07_05,
                              NULL, IDS_Enc_Obj_Primary_M07_05);
      ...
      if (object) {
        ...
        Commands->Set_Objective_HUD_Info_Position(709, 90.0f, "POG_M07_1_05.tga", IDS_POG_PROTECT,
                                                  Commands->Get_Position(object));
      }
    } break;
    // Escape Nuclear Strike
    case 710: {
      Commands->Add_Objective(710, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_PENDING, IDS_Enc_ObjTitle_Primary_M07_02,
                              NULL, IDS_Enc_Obj_Primary_M07_02);
      object = Commands->Find_Object(100717);
      if (object) {
        Commands->Set_Objective_Radar_Blip_Object(710, object);
        Commands->Set_Objective_HUD_Info_Position(710, 90.0f, "POG_M07_1_03.tga", IDS_POG_ESCAPE,
                                                  Commands->Get_Position(object));
      }
    } break;
    }
...
DECLARE_SCRIPT(M07_Havoc_DLS, "") {
  ...
  // Register variables to be Auto-Saved
  // All variables must have a unique ID, less than 256, that never changes
  REGISTER_VARIABLES() { SAVE_VARIABLE(nuke_blast, 1); }
...
DECLARE_SCRIPT(M07_Cathedral_Controller, "") // 100663
{
  ...
  void Timer_Expired(GameObject * obj, int timer_id) {
    ...
    if (timer_id == FIVE) {
      GameObject *cinematic_controller =
          Commands->Create_Object("Invisible_Object", Vector3(-100.879f, 88.570f, 29.184f));
...
DECLARE_SCRIPT(M07_Evac_Site_Controller, "") // 100664
{
  ...
  // Register variables to be Auto-Saved
  // All variables must have a unique ID, less than 256, that never changes
  REGISTER_VARIABLES() { SAVE_VARIABLE(m07_evac_site_vehicle_killed, 1); }

  void Created(GameObject * obj) { m07_evac_site_vehicle_killed = 0; }
...
DECLARE_SCRIPT(M07_Evac_Site_APC, ""){void Killed(GameObject * obj, GameObject *killer){
    // Custom to evac site controller to count when four vehicles in area destroyed
    Commands->Send_Custom_Event(obj, Commands->Find_Object(100664), M07_EVAC_SITE_VEHICLE_KILLED, 1, 0.0f);
Commands->Debug_Message("Evac Site Vehicle Killed = %d \n", Commands->Get_ID(obj));
}
...
DECLARE_SCRIPT(M07_SAM_Truck_100680, "") {
  ...
  // Register variables to be Auto-Saved
  // All variables must have a unique ID, less than 256, that never changes
  REGISTER_VARIABLES() { SAVE_VARIABLE(health, 1); }

  void Created(GameObject * obj) { health = Commands->Get_Max_Health(obj); }
...
DECLARE_SCRIPT(M07_Activate_Objective_704, "") {
  ...
  void Entered(GameObject * obj, GameObject * enterer) {
    if (Commands->Is_A_Star(enterer) && !already_entered) {
      ...
      // Attention GDI, this is Resistance Radio. Nod's aerial reinforcements are coordinated from mobile radar stations
      // in the Town Square.  We need those radar dishes destroyed.\n
...
DECLARE_SCRIPT(M07_Activate_Objective_705, "") {
  ...
  void Entered(GameObject * obj, GameObject * enterer) {
    if (Commands->Is_A_Star(enterer) && !already_entered) {
      ...
      // This is Resistance Radio, I have reports of captured resistance fighters west of your position.  Can anyone
      // assist?\n
...
DECLARE_SCRIPT(M07_Destroyed_SAM_Site, ""){void Created(GameObject * obj){Commands->Start_Timer(obj, this, 1.0f, 0);
}
...
DECLARE_SCRIPT(M07_Mobile_Radar, ""){
    ...
    void Created(GameObject *
                 obj){Commands->Set_Animation(obj, "v_nod_radar.v_nod_radar", true, NULL, 0.0f, -1.0f, false);
}
...
DECLARE_SCRIPT(M07_TownSquare_Gun_Emp, ""){
    ...
    void Killed(GameObject * obj, GameObject *killer){Commands->Enable_Spawner(100748, true);
}
}
;
...
DECLARE_SCRIPT(M07_Prisoner_Gate, ""){
    ...
    void Created(GameObject * obj){Commands->Set_Animation_Frame(obj, "cht_jail.cht_jail", 0);
}
...
DECLARE_SCRIPT(M07_Biohazard_Barrel, "") {
  ...
  void Created(GameObject * obj) { Commands->Set_Animation_Frame(obj, "o_barrl_bio.o_barrl_bio", 0); }
...
DECLARE_SCRIPT(M07_Stockpile_Object, "") {
  ...
  // Register variables to be Auto-Saved
  // All variables must have a unique ID, less than 256, that never changes
  REGISTER_VARIABLES() { SAVE_VARIABLE(damaged, 1); }

  void Created(GameObject * obj) { damaged = false; }
...
DECLARE_SCRIPT(M07_Stockpile_Controller, "") {
  ...
  // Register variables to be Auto-Saved
  // All variables must have a unique ID, less than 256, that never changes
  REGISTER_VARIABLES() { SAVE_VARIABLE(ssm_crate_killed, 1); }
...
DECLARE_SCRIPT(M07_Park_Controller, "") {
  ...
  // Register variables to be Auto-Saved
  // All variables must have a unique ID, less than 256, that never changes
  REGISTER_VARIABLES() { SAVE_VARIABLE(m07_artillery_killed, 1); }

  void Created(GameObject * obj) { m07_artillery_killed = 0; }
...
DECLARE_SCRIPT(M07_Activate_Encounter, "Spawner_ID1=0:int, Spawner_ID2=0:int, Spawner_ID3=0:int, Spawner_ID4=0:int, "
...
DECLARE_SCRIPT(M07_V05_Unit, "Stationary=0:int"){
    ...
    void Created(GameObject * obj){bool stationary = (Get_Int_Parameter("Stationary") == 1) ? true : false;
if (stationary) {
  Commands->Set_Innate_Is_Stationary(obj, true);
}
...
DECLARE_SCRIPT(M07_V01_Unit, "") {
  ...
  void Created(GameObject * obj) { Commands->Start_Timer(obj, this, 3.0f, 10); }
...
DECLARE_SCRIPT(M07_Activate_Hostage_Encounter, ""){
    ...
    void Entered(GameObject * obj,
                 GameObject *enterer){if (Commands->Is_A_Star(enterer)){// Hostage
...
DECLARE_SCRIPT(M07_Fuel_Barrel, "") {
  ...
  void Created(GameObject * obj) { Commands->Set_Animation_Frame(obj, "o_barrl_fuel.o_barrl_fuel", 0); }
...
DECLARE_SCRIPT(M07_Hostage_Controller, "") {
  ...
  // Register variables to be Auto-Saved
  // All variables must have a unique ID, less than 256, that never changes
  REGISTER_VARIABLES() { SAVE_VARIABLE(destroy_stockpile, 1); }
...
DECLARE_SCRIPT(M07_Activate_Bridge_Civ, ""){
    ...
    void Entered(GameObject * obj,
                 GameObject *enterer){if (Commands->Is_A_Star(enterer)){// Bridge Civilians
...
DECLARE_SCRIPT(M07_E10_Tank, "") {
  ...
  // Register variables to be Auto-Saved
  // All variables must have a unique ID, less than 256, that never changes
  REGISTER_VARIABLES() { SAVE_VARIABLE(m07_player_vehicle_id, 1); }
...
DECLARE_SCRIPT(M07_Para_Drop_Zone, "Zone_ID=0:int"){
    ...
    void Entered(GameObject * obj, GameObject *enterer){int zone_id = Get_Int_Parameter("Zone_ID");
...
DECLARE_SCRIPT(M07_Flyover_Controller, "") {
  ...
  void Timer_Expired(GameObject * obj, int timer_id) {
    const char *flyovers[8] = {
        "X7A_CPlane_00.txt", "X7A_CPlane_01.txt", "X7A_CPlane_02.txt", "X7A_CPlane_03.txt",

        "X7A_Apache_00.txt", "X7A_Apache_01.txt", "X7A_Apache_02.txt", "X7A_Apache_03.txt",
...
DECLARE_SCRIPT(M07_Move_Hotwire, "Move_Loc=0:int"){
    ...
    void Entered(GameObject * obj,
                 GameObject *enterer){if (Commands->Is_A_Star(enterer)){int move_loc = Get_Int_Parameter("Move_Loc");
...
DECLARE_SCRIPT(M07_Player_Rocket_Emplacement, ""){
    ...
    void Damaged(GameObject * obj, GameObject *damager, float amount){if (damager == Commands->Find_Object(100905)){
        if (Commands->Get_Health(obj) < 10.0f){Commands->Set_Health(obj, 10.0f);
}
...
DECLARE_SCRIPT(M07_Inn_Evac, "") // 104496
{
  ...
  void Custom(GameObject * obj, int type, int param, GameObject *sender) {
    ...
    if (type == M07_EVAC_INN) // SAM sites captured, evac DEAD6 and Sydney
    {
      ...
      GameObject *evacChopper =
          Commands->Create_Object_At_Bone(evacWaypath, "GDI_Transport_Helicopter_Flyover", "BN_Trajectory");
...
DECLARE_SCRIPT(M07_Inn_Evac_Climb, "Dead6_ID=0:int"){
    ...
    void Created(GameObject * obj){int dead6_id = Get_Int_Parameter("Dead6_ID");
...
DECLARE_SCRIPT(M07_Inn_Evac_Rope, ""){
    void Animation_Complete(GameObject * obj, const char *anim){if (stricmp(anim, "XG_EV5_rope.XG_EV5_ropeA") == 0){
...
DECLARE_SCRIPT(M07_Inn_Evac_Trajectory, ""){
    void Animation_Complete(GameObject * obj, const char *anim){if (stricmp(anim, "XG_EV5_Path.XG_EV5_PathA") == 0){
...
DECLARE_SCRIPT(M07_Inn_Evac_Helicopter, ""){void Created(GameObject * obj){Commands->Enable_Hibernation(obj, false);
Commands->Disable_Physical_Collisions(obj);
...
DECLARE_SCRIPT(M07_Deadeye_Nod_Chinook, ""){
    ...
    void Damaged(GameObject * obj, GameObject *damager,
                 float amount){if (Commands->Get_Health(obj) < 10.0f){Commands->Set_Health(obj, 10.0f);
}
if (Commands->Get_Health(obj) < (.3 * Commands->Get_Max_Health(obj))) {
  Commands->Apply_Damage(obj, -10000.0f, "STEEL", NULL);
}
...
DECLARE_SCRIPT(M07_Park_Stealth_Tank, "") {
  ...
  // Register variables to be Auto-Saved
  // All variables must have a unique ID, less than 256, that never changes
  REGISTER_VARIABLES() { SAVE_VARIABLE(health, 8); }

  void Created(GameObject * obj) { health = Commands->Get_Health(obj); }
...
{void Custom(GameObject * obj, int type, int param,
             GameObject *sender){if (type == CUSTOM_EVENT_POWERUP_GRANTED){// Reveal Stealth Tank
...
{void Custom(GameObject * obj, int type, int param,
             GameObject *sender){if (type == CUSTOM_EVENT_POWERUP_GRANTED){// Reveal Stealth Soldier
