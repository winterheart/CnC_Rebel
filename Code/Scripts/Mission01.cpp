  ...
  void Custom(GameObject * obj, int type, int param, GameObject *sender) {
    if (type == CUSTOM_EVENT_SOUND_ENDED) {
      if (param == eva_comm_center_line_01) {
        ...
        eva_comm_center_line_05 = Commands->Create_Sound("00-N030E", Vector3(0, 0, 0), obj); // data acquisition
                                                                                             // complete
      ...
      case M01_PLAYER_IS_OUTSIDE_HON_JDG: // Player is outside HON--restart rain sounds
      {
        ...
        Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_AMBIENT_SOUND_CONTROLLER_JDG), 0,
                                    M01_TURN_ON_OUTSIDE_AMBIENTS_JDG, 0);
      } break;

      case M01_PLAYER_IS_INSIDE_COMM_CENTER_JDG: // Player is inside Comm Center--kill rain sounds--start internal
                                                 // pagings
      {
        ...
        if (warroomTech02 != NULL) {
          Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_COMMCENTER_WAROOM_TECH_02_JDG), 0,
                                      M01_PLAYER_IS_INSIDE_COMM_CENTER_JDG, 0);
        }
      ...
      case M01_PLAYER_IS_INSIDE_TUNNEL_JDG: // Player is inside TUNNEL leading to tailgun run--stop rain sounds
      {
        ...
        Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_AMBIENT_SOUND_CONTROLLER_JDG), 0,
                                    M01_TURN_OFF_OUTSIDE_AMBIENTS_JDG, 0);
      } break;
      ...
      case M01_PLAYER_IS_IN_HON_DOJO_JDG: // Player is entering DOJO--cue actors
      {
        if ((hand_of_nod_state != DESTROYED) && (first_time_in_hon_dojolevel == true)) {
          ...
          if (Commands->Find_Object(M01_HON_DOJO_SENSEI_JDG)) {
            Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_HON_DOJO_SENSEI_JDG), 0, M01_START_ACTING_JDG,
                                        0);
          }
        }
      } break;
      ...
      {
        Commands->Add_Objective(M01_CHURCH_OBJECTIVE_JDG, OBJECTIVE_TYPE_SECONDARY, OBJECTIVE_STATUS_PENDING,
                                IDS_Enc_ObjTitle_Secondary_M01_05, NULL, IDS_Enc_Obj_Secondary_M01_05);
      ...
      case M01_LOVESHACK_GUARD_IS_DEAD_JDG: // Loveshack guard is dead--let nun know
      {
        ...
        if ((loveshack_guard_is_dead == true) && (church_guard_is_dead == true) &&
            (church_pickup_chinook_is_on_its_way == false)) {
          GameObject *churchEvacController = Commands->Find_Object(103394);
          if (churchEvacController != NULL) {
            Commands->Send_Custom_Event(obj, churchEvacController, 0, M01_START_ACTING_JDG,
                                        3); // giving clearance to havoc exit zone for conversation
          }
      ...
      {
        if (Commands->Find_Object(M01_CHURCH_LOVESHACK_NUN_ID) || (Commands->Find_Object(M01_CHURCH_INTERIOR_NUN_ID)) ||
            (Commands->Find_Object(m01_church_interior_nun02_ID)) || (Commands->Find_Object(M01_CHURCH_PRIEST_ID))) {
      ...
      case M01_PLAYER_IS_ATTACKING_ME_JDG: // if player is being escorted--tell escort who havoc's target is
      {
        if (player_has_an_escort == true) {
          ...
          Commands->Send_Custom_Event(obj, Commands->Find_Object(players_escorts_ID), M01_PLAYER_IS_ATTACKING_ME_JDG,
                                      havocs_targets_ID, delayTimer);
        }
      } break;
      ...
      {
        if (player_has_an_escort == true) {
          Commands->Send_Custom_Event(obj, Commands->Find_Object(players_escorts_ID), 0,
                                      M01_PLAYER_IS_LEAVING_CHURCH_01_JDG, 0);
        }
      } break;
      ...
      case M01_PLAYER_IS_LEAVING_CHURCH_02_JDG: // if havoc has escort--tell them to go somewhere else
      {
        if (player_has_an_escort == true) {
          Commands->Send_Custom_Event(obj, Commands->Find_Object(players_escorts_ID), 0,
                                      M01_PLAYER_IS_LEAVING_CHURCH_02_JDG, 0);
        }
      } break;
      ...
      case M01_PLAYER_IS_LEAVING_HON_01_JDG: // if havoc has escort--tell them to go somewhere else
      {
        if (player_has_an_escort == true) {
          Commands->Send_Custom_Event(obj, Commands->Find_Object(players_escorts_ID), 0,
                                      M01_PLAYER_IS_LEAVING_HON_01_JDG, 0);
        }
      } break;
      ...
      case M01_PLAYER_IS_LEAVING_HON_02_JDG: // if havoc has escort--tell them to go somewhere else
      {
        if (player_has_an_escort == true) {
          Commands->Send_Custom_Event(obj, Commands->Find_Object(players_escorts_ID), 0,
                                      M01_PLAYER_IS_LEAVING_HON_02_JDG, 0);
        }
      } break;
      ...
      case M01_PLAYER_IS_CROSSING_THE_BRIDGE_VIA_CAVE_JDG: // havoc is crossing bridge for first time--cue actors
                                                           // driveby actors
      {
        if (m01_bridgeWeather_is_Set == false) {
          m01_bridgeWeather_is_Set = true;
      ...
      {
        GameObject *m01_tiberium_cave_helicopter =
            Commands->Create_Object("NOD_Apache", Vector3(-40.708f, 375.387f, 30.275f));
      ...
      {
        Commands->Add_Objective(M01_HON_OBJECTIVE_JDG, OBJECTIVE_TYPE_SECONDARY, OBJECTIVE_STATUS_PENDING,
                                IDS_Enc_ObjTitle_Secondary_M01_07, NULL, IDS_Enc_Obj_Secondary_M01_07);
      ...
      case M01_PLAYER_HAS_POKED_PEN_GATE_JDG: {
        if (player_has_unlocked_pen != true) {
          ...
          if (Commands->Find_Object(M01_COMMCENTER_SAM_JDG)) {
            Commands->Create_Logical_Sound(obj, M01_DETENTION_GATE_IS_DOWN_JDG, Vector3(-315.383f, 572.805f, 27.623f),
                                           50.0f);
            Commands->Send_Custom_Event(obj, obj, 0, M01_ANNOUNCE_COMMCENTER_SAM_OBJECTIVE_JDG, 0);
          }

          else {
            Commands->Create_Logical_Sound(obj, M01_DETENTION_GATE_DOWN_SAM_DEAD_JDG,
                                           Vector3(-315.383f, 572.805f, 27.623f), 50.0f);
          }
      ...
      case M01_ADD_COMM_SAM_OBJECTIVE_JDG: {
        ...
        if (commSamSite != NULL) {
          Commands->Add_Objective(M01_COMM_SAM_OBJECTIVE_JDG, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_PENDING,
                                  IDS_Enc_ObjTitle_Primary_M01_04, NULL, IDS_Enc_Obj_Primary_M01_04);
      ...
      case M01_ADD_UNLOCK_GATE_OBJECTIVE_JDG: {
        ...
        Commands->Add_Objective(M01_UNLOCK_GATE_OBJECTIVE_JDG, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_PENDING,
                                IDS_Enc_ObjTitle_Primary_M01_02, NULL, IDS_Enc_Obj_Primary_M01_02);
        Commands->Set_Objective_HUD_Info_Position(M01_UNLOCK_GATE_OBJECTIVE_JDG, 93, "POG_M01_1_02.tga", IDS_POG_HACK,
                                                  pogMarker);
      ...
      case M01_SCRAMBLE_THE_RADAR_JDG: {
        if (players_first_time_by_commcenter == true) {
          Commands->Send_Custom_Event(obj, Commands->Find_Object(103099), 0, M01_START_ACTING_JDG,
                                      0); // telling propaganda to start up
      ...
      case M01_SPAWN_WHACK_A_MOLE_GUY_JDG: {
        GameObject *m01_whack_a_mole_guy =
            Commands->Create_Object("Nod_MiniGunner_1Off", Vector3(-198.088f, 525.828f, 10.035f));
        ...
        if (hand_of_nod_state != DESTROYED) {
          ...
          if (m01_hon_total_spawners_tally <= 6) {
            if ((m01_hon_spawned_guy_01_alive == false) && (players_location != INSIDE_HAND_OF_NOD)) {
              GameObject *m01_hon_spawned_guy_01 =
                  Commands->Create_Object("Nod_MiniGunner_0", Vector3(-212.6f, 541.1f, 4));
              ...
              GameObject *m01_hon_spawned_guy_02 =
                  Commands->Create_Object("Nod_MiniGunner_0", Vector3(-217.2f, 540.2f, 4));
              ...
              GameObject *m01_hon_spawned_guy_03 =
                  Commands->Create_Object("Nod_FlameThrower_0", Vector3(-217.6f, 533.6f, 4));
          ...
          Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0,
                                      M01_HON_SPAWNS_MINIGUNNER_JDG, m01_HON_SpawnRate);
        }
      } break;
      ...
      case M01_ADD_BARN_COMMANDER_OBJECTIVE_JDG: {
        ...
        if (barnCommander != NULL) {
          Commands->Add_Objective(M01_FIRST_NOD_COMMANDER_OBJECTIVE_JDG, OBJECTIVE_TYPE_SECONDARY,
                                  OBJECTIVE_STATUS_PENDING, IDS_Enc_ObjTitle_Secondary_M01_01, NULL,
                                  IDS_Enc_Obj_Secondary_M01_01);
          ...
          GameObject *pogController = Commands->Find_Object(M01_MISSION_POG_CONTROLLER_JDG);
          if (pogController != NULL) {
            Commands->Send_Custom_Event(obj, pogController, M01_ADD_OBJECTIVE_POG_JDG,
                                        M01_FIRST_NOD_COMMANDER_OBJECTIVE_JDG, 0);
          }
      ...
      case M01_ADD_TURRETS_OBJECTIVE_JDG: {
        Commands->Add_Objective(M01_TURRETS_OBJECTIVE_JDG, OBJECTIVE_TYPE_SECONDARY, OBJECTIVE_STATUS_PENDING,
                                IDS_Enc_ObjTitle_Secondary_M01_02, NULL, IDS_Enc_Obj_Secondary_M01_02);
      ...
      case M01_END_TURRETS_OBJECTIVE_PASS_JDG: {
        if (turret_objective_over == false) {
          ...
          if (gunboat != NULL) {
            ...
            // turrets_hummVee_conv = Commands->Create_Conversation( "M01_Locke_GiveHummVee_Conversation", 100, 1000,
            // false); Commands->Join_Conversation( NULL, turrets_hummVee_conv, false, false, true );
      ...
      case M01_PASS_TURRETS_OBJECTIVE_JDG: {
        ...
        Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0,
                                    M01_SPAWN_THE_MEDIUM_TANK_JDG, 0);
      } break;
        ...
        case M01_ANNOUNCE_BARN_OBJECTIVE_JDG:
                {
                        ...
                        {
                                int barn_conv = Commands->Create_Conversation( "M01_Add_Barn_Objective", 100, 1000,
        false);
        ...
        /*case M01_ADD_BARN_OBJECTIVE_JDG:
                        {
                                if (barn_objective_active == false)
                                {
                                        ...
                                        Commands->Add_Objective( M01_BARN_OBJECTIVE_JDG, OBJECTIVE_TYPE_SECONDARY,
           OBJECTIVE_STATUS_PENDING, IDS_Enc_ObjTitle_Secondary_M01_03, NULL, IDS_Enc_Obj_Secondary_M01_03 );

                                        GameObject * pogController = Commands->Find_Object (
           M01_MISSION_POG_CONTROLLER_JDG ); if (pogController != NULL)
                                        {
                                                Commands->Send_Custom_Event( obj, pogController,
           M01_ADD_OBJECTIVE_POG_JDG, M01_BARN_OBJECTIVE_JDG, 0 );
                                        }

                                        GameObject * barnPrisoner01 = Commands->Find_Object ( M01_BARN_PRISONER_01_ID );
                                        if (barnPrisoner01 != NULL)
                                        {
                                                Commands->Set_Obj_Radar_Blip_Shape ( barnPrisoner01,
           RADAR_BLIP_SHAPE_OBJECTIVE ); Commands->Set_Obj_Radar_Blip_Color ( barnPrisoner01,
           RADAR_BLIP_COLOR_SECONDARY_OBJECTIVE );
                                        ...
                                        {
                                                Commands->Set_Obj_Radar_Blip_Shape ( barnPrisoner02,
           RADAR_BLIP_SHAPE_OBJECTIVE ); Commands->Set_Obj_Radar_Blip_Color ( barnPrisoner02,
           RADAR_BLIP_COLOR_SECONDARY_OBJECTIVE );
                                        }
                                        ...
                                        {
                                                Commands->Set_Obj_Radar_Blip_Shape ( barnPrisoner03,
           RADAR_BLIP_SHAPE_OBJECTIVE ); Commands->Set_Obj_Radar_Blip_Color ( barnPrisoner03,
           RADAR_BLIP_COLOR_SECONDARY_OBJECTIVE );
                                        }
                                }
                        }
        ...
        /*case M01_CHANGE_BARN_OBJECTIVE_JDG:
                {
                        ...
                        {
                                int roundupcivs_conv = Commands->Create_Conversation( "M01_Add_Barn_Roundup_Objective",
           100, 1000, false); Commands->Join_Conversation( NULL, roundupcivs_conv, false, false, true );
                                ...
                                Commands->Add_Objective( M01_BARN_ROUNDUP_OBJECTIVE_JGD, OBJECTIVE_TYPE_SECONDARY,
           OBJECTIVE_STATUS_PENDING, IDS_Enc_ObjTitle_Secondary_M01_04, NULL, IDS_Enc_Obj_Secondary_M01_04 );

                                GameObject * pogController = Commands->Find_Object ( M01_MISSION_POG_CONTROLLER_JDG );
                                if (pogController != NULL)
                                {
                                        Commands->Send_Custom_Event( obj, pogController, M01_ADD_OBJECTIVE_POG_JDG,
           M01_BARN_ROUNDUP_OBJECTIVE_JGD, 0 );
                                }
                        }
                }
                break;*/
      ...
      case M01_END_BARN_ROUNDUP_OBJECTIVE_JDG: {
        if (barn_objective_ended == false) {
          ...
          /*if (barn_objective_failed == true)
          {
                  ...
                  barnfailed_conv = Commands->Create_Conversation( "M01_Locke_3CivsDead_Conversation", 100, 1000,
          false); Commands->Join_Conversation( NULL, barnfailed_conv, false, false, true ); Commands->Join_Conversation(
          STAR, barnfailed_conv, false, false, true ); Commands->Start_Conversation( barnfailed_conv,  barnfailed_conv
          );
      ...
      {
        if (sender ==
            Commands->Find_Object(M01_HAND_OF_NOD_JDG)) // hand of nod under attack--refinery okay--send engineer
        {
      ...
      case M01_CUE_KANE_AND_NUMBER2_CONVERSATION_JDG: // player is in comm center--cue kane encounter
      {
        ...
        if (holograph != NULL) {
          ...
          if (commBaseCommander != NULL) {
            ...
            kane_and_no2_conv01 =
                Commands->Create_Conversation("M01_Kane_and_Number02_Conversation_01", 100, 1000, true);
  ...
  void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason complete_reason) {
    ...
    case ACTION_COMPLETE_CONVERSATION_ENDED: {
      ...
      else if (action_id == unlocked_gate_conv) //
      {
        ...
        Commands->Add_Objective(M01_OPEN_THE_GATE_JDG, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_PENDING,
                                IDS_Enc_ObjTitle_Primary_M01_03, NULL, IDS_Enc_Obj_Primary_M01_03);
        Commands->Set_Objective_Radar_Blip(M01_OPEN_THE_GATE_JDG, radarMarker);
        Commands->Set_Objective_HUD_Info_Position(M01_OPEN_THE_GATE_JDG, 95, "POG_M01_1_03.tga", IDS_POG_OPEN,
                                                  radarMarker);
...
DECLARE_SCRIPT(M01_HON_Medlab_DropOff_Guy_JDG, ""){void Created(GameObject * obj){Commands->Innate_Disable(obj);
Commands->Enable_Hibernation(obj, false);
}
...
DECLARE_SCRIPT(M01_Hand_of_Nod_Building_Script_JDG, "") {
  ...
  REGISTER_VARIABLES() { SAVE_VARIABLE(memorial_sound, 1); }
  ...
  void Killed(GameObject * obj, GameObject * killer) {
    ...
    Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0,
                                M01_HON_HAS_BEEN_DESTROYED_JDG, 0);
    Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_AMBIENT_SOUND_CONTROLLER_JDG), 0,
                                M01_HON_HAS_BEEN_DESTROYED_JDG, 0);
    Commands->Send_Custom_Event(obj, Commands->Find_Object(103371), 0, M01_HON_HAS_BEEN_DESTROYED_JDG,
                                0); // this is the final escort zone
  ...
  void Damaged(GameObject * obj, GameObject * damager, float amount) {
    if (obj) {
      ...
      if (myEngineer != NULL) {
        Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0, M01_DO_DAMAGE_CHECK_JDG,
                                    0);
...
DECLARE_SCRIPT(M01_Flyover_Generic_Script_JDG,
               ""){void Created(GameObject * obj){Commands->Disable_Physical_Collisions(obj);
Commands->Enable_Hibernation(obj, false);
...
DECLARE_SCRIPT(M01_Ambient_Sound_Controller_JDG, "") {
  ...
  void Custom(GameObject * obj, int type, int param, GameObject *sender) {
    ...
    else if ((param == play_commcenter_klaxon) && (players_location == INSIDE_COMM_CENTER) &&
             (comm_center_state != DESTROYED)) {
      const char *klaxonNames[2] = {"Klaxon Warning", "Klaxon Info"};
    ...
    else if ((param == play_commcenter_sound) && (players_location == INSIDE_COMM_CENTER) &&
             (comm_center_state != DESTROYED)) {
      const char *sounds[15] = {"01-I022E", "01-I028E", "01-I030E", "01-I032E", "01-I034E",
                                "01-I036E", "01-I038E", "01-I040E", "01-I042E", "01-I044E",
                                "01-I046E", "01-I048E", "01-I050E", "01-I062E", "01-I066E"};
    ...
    else if ((param == pick_commcenter_sound) && (players_location == INSIDE_COMM_CENTER) &&
             (comm_center_state != DESTROYED)) {
...
DECLARE_SCRIPT(M01_Entering_Church_Area_Zone, ""){void Entered(GameObject * obj, GameObject *enterer){
    if (enterer == STAR){Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0,
                                                     M01_PLAYER_IS_APPROACHING_CHURCH_JDG, 0);
...
DECLARE_SCRIPT(M01_Hand_Of_Nod_Interior_Zone, ""){void Entered(GameObject * obj, GameObject *enterer){
    if (enterer == STAR){Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0,
                                                     M01_PLAYER_IS_INSIDE_HON_JDG, 0);
}
}
}
;

DECLARE_SCRIPT(M01_Hand_Of_Nod_Exterior_Zone, ""){void Entered(GameObject * obj, GameObject *enterer){
    if (enterer == STAR){Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0,
                                                     M01_PLAYER_IS_OUTSIDE_HON_JDG, 0);
}
}
}
;

DECLARE_SCRIPT(M01_Comm_Center_Interior_Zone, ""){void Entered(GameObject * obj, GameObject *enterer){
    if (enterer == STAR){Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0,
                                                     M01_PLAYER_IS_INSIDE_COMM_CENTER_JDG, 0);
}
}
...
DECLARE_SCRIPT(M01_Comm_Center_Exterior_Zone, ""){void Entered(GameObject * obj, GameObject *enterer){
    if (enterer == STAR){Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0,
                                                     M01_PLAYER_IS_OUTSIDE_COMM_CENTER_JDG, 0);
}
}
}
;

DECLARE_SCRIPT(M01_Tunnel_Interior_Zone, ""){void Entered(GameObject * obj, GameObject *enterer){
    if (enterer == STAR){Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0,
                                                     M01_PLAYER_IS_INSIDE_TUNNEL_JDG, 0);
}
}
}
;

DECLARE_SCRIPT(M01_Tunnel_Exterior_Zone, ""){void Entered(GameObject * obj, GameObject *enterer){
    if (enterer == STAR){Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0,
                                                     M01_PLAYER_IS_OUTSIDE_TUNNEL_JDG, 0);
}
}
}
;

DECLARE_SCRIPT(M01_Waterfall_Interior_Zone, ""){void Entered(GameObject * obj, GameObject *enterer){
    if (enterer == STAR){Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0,
                                                     M01_PLAYER_IS_INSIDE_WATERFALL_JDG, 0);
}
}
}
;

DECLARE_SCRIPT(M01_Waterfall_Exterior_Zone, ""){void Entered(GameObject * obj, GameObject *enterer){
    if (enterer == STAR){Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0,
                                                     M01_PLAYER_IS_OUTSIDE_WATERFALL_JDG, 0);
}
}
}
;
...
DECLARE_SCRIPT(M01_Player_is_Leaving_GDI_Base_Zone, "") {
  ...
  void Entered(GameObject * obj, GameObject * enterer) {
    if (enterer == STAR) {
      ...
      Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0,
                                  M01_PLAYER_APPROACHING_BARN_AREA_JDG, 0);
    }
  }
};

DECLARE_SCRIPT(M01_Player_is_Entering_GDI_Base_Zone, ""){void Entered(GameObject * obj, GameObject *enterer){
    if (enterer == STAR){Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0,
                                                     M01_PLAYER_APPROACHING_GDI_BASE_AREA_JDG, 0);
}
}
}
;

DECLARE_SCRIPT(M01_Lose_Any_Church_Escorts_Zone, ""){void Entered(GameObject * obj, GameObject *enterer){
    if (enterer == STAR){Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0,
                                                     M01_PLAYER_IS_LEAVING_CHURCH_01_JDG, 0);
}
}
...
DECLARE_SCRIPT(M01_Lose_Any_Church_Escorts_Zone_02, ""){void Entered(GameObject * obj, GameObject *enterer){
    if (enterer == STAR){Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0,
                                                     M01_PLAYER_IS_LEAVING_CHURCH_02_JDG, 0);
}
}
...
DECLARE_SCRIPT(M01_Lose_Any_HON_Escorts_Zone, ""){void Entered(GameObject * obj, GameObject *enterer){
    if (enterer == STAR){Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0,
                                                     M01_PLAYER_IS_LEAVING_HON_01_JDG, 0);
}
}
...
DECLARE_SCRIPT(M01_Lose_Any_HON_Escorts_Zone_02, ""){void Entered(GameObject * obj, GameObject *enterer){
    if (enterer == STAR){Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0,
                                                     M01_PLAYER_IS_LEAVING_HON_02_JDG, 0);
}
}
...
DECLARE_SCRIPT(M01_Announce_Prisoner_Objective_Zone, ""){void Entered(GameObject * obj, GameObject *enterer){
    if (enterer == STAR){Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0,
                                                     M01_ANNOUNCE_PRISONER_OBJECTIVE_JDG, 0);
...
DECLARE_SCRIPT(M01_Scramble_Radar_Zone, ""){void Entered(GameObject * obj, GameObject *enterer){
    if (enterer == STAR){Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0,
                                                     M01_SCRAMBLE_THE_RADAR_JDG, 0);
}
}
}
;

DECLARE_SCRIPT(M01_UnScramble_Radar_Zone, ""){void Entered(GameObject * obj, GameObject *enterer){
    if (enterer == STAR){Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0,
                                                     M01_UNSCRAMBLE_THE_RADAR_JDG, 0);
}
}
}
;

DECLARE_SCRIPT(M01_HON_Commander_Guy, ""){void Killed(GameObject * obj, GameObject *killer){
    Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0,
                                M01_CARD_CARRIER_HAS_BEEN_KILLED_JDG, 0); // tell controller you've been killed
}
}
;

DECLARE_SCRIPT(M01_COMM_Commander_Guy, ""){void Killed(GameObject * obj, GameObject *killer){
    Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0,
                                M01_CARD_CARRIER_HAS_BEEN_KILLED_JDG, 0); // tell controller you've been killed
}
}
...
{void Damaged(GameObject * obj, GameObject *damager, float amount){
    if (damager == (STAR)){if (obj){Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG),
                                                                0, M01_PLAYER_IS_ATTACKING_ME_JDG, 0);
}
}
}
...
void Killed(GameObject *obj, GameObject *killer) {
  Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0,
                              M01_HON_SAMSITE_HAS_BEEN_DESTROYED_JDG, 5);
}
}
;

DECLARE_SCRIPT(M01_Destroyed_SAMSITE_JDG, ""){void Created(GameObject * obj){ActionParamsStruct params;
...
void Damaged(GameObject *obj, GameObject *damager, float amount) {
  if (damager == STAR) {
    if (obj) {
      Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0,
                                  M01_PLAYER_IS_ATTACKING_ME_JDG, 0);
    }
  }
}

void Action_Complete(GameObject *obj, int action_id, ActionCompleteReason complete_reason) {
  if (action_id == M01_GOING_TO_EVAC_SPOT_JDG &&
      complete_reason == ACTION_COMPLETE_NORMAL) // Tech is at workstation--face monitor
  {
...
DECLARE_SCRIPT(M01_HON_FrontDoor_Evacuator_JDG, ""){void Created(GameObject * obj){ActionParamsStruct params;
Commands->Enable_Hibernation(obj, false);
...
void Action_Complete(GameObject *obj, int action_id, ActionCompleteReason complete_reason) {
  ...
  else if (action_id == M01_GOING_TO_EVAC_SPOT_JDG &&
           complete_reason == ACTION_COMPLETE_NORMAL) // Tech is evac'd allow hibernation
  {
    Commands->Enable_Hibernation(obj, true);
  }
}
...
DECLARE_SCRIPT(M01_HON_BackDoor_Evacuator_JDG, ""){void Created(GameObject * obj){ActionParamsStruct params;
Commands->Enable_Hibernation(obj, false);
Vector3 evac_spot;
...
DECLARE_SCRIPT(M01_HON_Dorm_Crapper_JDG, ""){void Created(GameObject * obj){Commands->Innate_Disable(obj);
...
DECLARE_SCRIPT(M01_HON_Dorm_FlameGuy_JDG, ""){void Created(GameObject * obj){Commands->Innate_Disable(obj);
...
DECLARE_SCRIPT(M01_HON_Dorm_ChemGuy_JDG, ""){void Created(GameObject * obj){Commands->Innate_Disable(obj);
Commands->Set_Facing(obj, -90);
}
...
DECLARE_SCRIPT(M01_HON_Dorm_RocketGuy_JDG, ""){void Created(GameObject * obj){Commands->Innate_Disable(obj);
Commands->Set_Facing(obj, -90);
}
...
DECLARE_SCRIPT(M01_HON_Dorm_MiniGunner_JDG, ""){void Created(GameObject * obj){Commands->Innate_Disable(obj);
...
DECLARE_SCRIPT(M01_HON_Cafeteria_Eating_Guy_JDG, "") {
  ...
  REGISTER_VARIABLES() { SAVE_VARIABLE(enemy_detected, 1); }
...
DECLARE_SCRIPT(M01_HON_Cafeteria_Walking_Guy_JDG, ""){void Created(GameObject * obj){Commands->Innate_Disable(obj);
}
...
DECLARE_SCRIPT(M01_Hand_Of_Nod_Grunt_Zone, ""){void Entered(GameObject * obj, GameObject *enterer){
    if (enterer == STAR){Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0,
                                                     M01_PLAYER_IS_IN_HON_GRUNT_LEVEL_JDG, 0);
}
}
}
;

DECLARE_SCRIPT(M01_Hand_Of_Nod_Dojo_Zone, ""){void Entered(GameObject * obj, GameObject *enterer){
    if (enterer == STAR){Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0,
                                                     M01_PLAYER_IS_IN_HON_DOJO_JDG, 0);
}
}
}
;
...
void Killed(GameObject *obj, GameObject *killer) {
  ...
  Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0,
                              M01_LOVESHACK_GUARD_IS_DEAD_JDG, 0);
  Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0,
                              M01_CARD_CARRIER_HAS_BEEN_KILLED_JDG, 0); // tell controller you've been killed
}
...
DECLARE_SCRIPT(M01_Church_Exterior_MiniGunner_JDG, ""){void Created(GameObject * obj){Commands->Innate_Disable(obj);
}
...
void Action_Complete(GameObject *obj, int action_id, ActionCompleteReason complete_reason) {
  ...
  if (action_id == M01_WALKING_WAYPATH_01_JDG &&
      complete_reason == ACTION_COMPLETE_NORMAL) // minigunner is at animation point--choose and do animation
  {
    ...
    Commands->Action_Play_Animation(obj, params);
           ...
           complete_reason == ACTION_COMPLETE_NORMAL) // minigunner is done with animation--keep moving
  {
    params.Set_Basic(this, 45, M01_WALKING_WAYPATH_02_JDG);
    params.Set_Movement(Vector3(0, 0, 0), WALK, .25f);
...
DECLARE_SCRIPT(M01_Church_Balcony_MiniGunner_JDG, ""){void Created(GameObject * obj){Commands->Innate_Disable(obj);
}
...
DECLARE_SCRIPT(M01_Announce_Hand_of_Nod_Zone, ""){void Entered(GameObject * obj, GameObject *enterer){
    if (enterer == STAR){GameObject *controller = Commands->Create_Object("Invisible_Object", Vector3(0, 0, 0));
...
Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0, M01_ANNOUNCE_HON_OBJECTIVE_JDG,
                            0);
...
DECLARE_SCRIPT(M01_Announce_Barn_Objective_Zone, ""){void Entered(GameObject * obj, GameObject *enterer){
    if (enterer == STAR){// Commands->Send_Custom_Event( obj, Commands->Find_Object ( M01_MISSION_CONTROLLER_JDG ), 0,
                         // M01_START_BARN_OBJECTIVE_JDG, 0 );
                         Commands->Destroy_Object(obj); // this is a 1-time only zone--cleaning up
}
}
}
...
DECLARE_SCRIPT(M01_Tiberium_Cave_Helicopter_JDG, ""){void Created(GameObject * obj){ActionParamsStruct params;
...
DECLARE_SCRIPT(M01_Player_Is_Crossing_Bridge_Zone, ""){void Entered(GameObject * obj, GameObject *enterer){
    if (enterer == STAR){Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0,
                                                     M01_PLAYER_IS_CROSSING_THE_BRIDGE_JDG, 0);

if (Commands->Find_Object(M01_TAILGUNRUN_SPAWNER_CONTROLLER_JDG)) {
  Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_TAILGUNRUN_SPAWNER_CONTROLLER_JDG), 0,
                              M01_QUIT_SPAWNING_PLEASE_JDG, 0);
}

if (Commands->Find_Object(M01_CHURCHAREA_SPAWNER_CONTROLLER_JDG)) {
  Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_CHURCHAREA_SPAWNER_CONTROLLER_JDG), 0,
...
DECLARE_SCRIPT(M01_Player_Is_Crossing_Bridge_Via_Cave_Zone, ""){void Entered(GameObject * obj, GameObject *enterer){
    if (enterer == STAR){Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0,
                                                     M01_PLAYER_IS_CROSSING_THE_BRIDGE_VIA_CAVE_JDG, 0);
...
DECLARE_SCRIPT(M01_Player_Is_Crossing_Bridge_Via_Church_Zone, ""){void Entered(GameObject * obj, GameObject *enterer){
    if (enterer == STAR){Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0,
                                                     M01_PLAYER_IS_CROSSING_THE_BRIDGE_JDG, 0);
...
DECLARE_SCRIPT(M01_HON_Easy_Spawned_Guy_01_JDG, "") {
  ...
  void Killed(GameObject * obj, GameObject * killer) {
    if (hunting != true) {
      Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0,
                                  M01_HON_SPAWNER_01_IS_DEAD_JDG, 0);
    }

    Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0, M01_HON_SPAWNER_IS_DEAD_JDG,
                                0);
  }
  ...
  void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason complete_reason) {
    ...
    if (action_id == M01_HUNT_THE_PLAYER_JDG &&
        (complete_reason == ACTION_COMPLETE_PATH_BAD_START || complete_reason == ACTION_COMPLETE_PATH_BAD_DEST ||
         complete_reason == ACTION_COMPLETE_MOVE_NO_PROGRESS_MADE)) {
...
DECLARE_SCRIPT(M01_HON_Easy_Spawned_Guy_02_JDG, "") {
  ...
  void Killed(GameObject * obj, GameObject * killer) {
    if (hunting != true) {
      Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0,
                                  M01_HON_SPAWNER_02_IS_DEAD_JDG, 0);
    }
...
DECLARE_SCRIPT(M01_HON_Easy_Spawned_Guy_03_JDG, "") {
  ...
  void Killed(GameObject * obj, GameObject * killer) {
    if (hunting != true) {
      Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0,
                                  M01_HON_SPAWNER_03_IS_DEAD_JDG, 0);
    }
  ...
  void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason complete_reason) {
    ...
    if (action_id == M01_HUNT_THE_PLAYER_JDG &&
      ...
      Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0,
                                  M01_HON_SPAWNER_IN_POSITION_JDG, 0);
    }
  }
};
...
{void Entered(GameObject * obj, GameObject *enterer){
    if (enterer == STAR){Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0,
                                                     M01_SPAWN_WHACK_A_MOLE_GUY_JDG, 0);
...
DECLARE_SCRIPT(M01_Whack_A_Mole_Exit_Zone_JDG, "") // this guys ID is 101207
{
  ...
  REGISTER_VARIABLES() { SAVE_VARIABLE(okayToAct, 1); }

  void Created(GameObject * obj) { okayToAct = false; }
  ...
  void Entered(GameObject * obj, GameObject * enterer) {
    if (enterer == STAR && okayToAct == true) {
      Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0,
                                  M01_CHANGE_WHACK_A_MOLE_GUY_JDG, 0);
      Commands->Destroy_Object(obj);
    }
  }
};
...
{void Entered(GameObject * obj, GameObject *enterer){
    if (enterer == STAR){if (Commands->Find_Object(M01_HON_INTERROGATION_ROOM_GUY_ID)){Commands->Send_Custom_Event(
        obj, Commands->Find_Object(M01_HON_INTERROGATION_ROOM_GUY_ID), 0, M01_PLAYER_ENTERING_LEFT_INTEROG_ROOM_JDG, 0);
}
...
{void Entered(GameObject * obj,
              GameObject *enterer){if (enterer == STAR){if (Commands->Find_Object(M01_HON_INTERROGATION_ROOM_GUY_ID)){
    Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_HON_INTERROGATION_ROOM_GUY_ID), 0,
                                M01_PLAYER_ENTERING_RIGHT_INTEROG_ROOM_JDG, 0);
}
...
DECLARE_SCRIPT(M01_Interrogation_Room_L03_Keycard_JDG,
               ""){void Created(GameObject * obj){Commands->Set_Obj_Radar_Blip_Shape(obj, RADAR_BLIP_SHAPE_NONE);
}
}
;
...
DECLARE_SCRIPT(M01_Medium_Tank_Tunnel_Squish_Guy_JDG,
               ""){void Created(GameObject * obj){Vector3 myPositon = Commands->Get_Position(obj);
  ...
  void Custom(GameObject * obj, int type, int param, GameObject *sender) {
    ...
    else if ((param == M01_CUE_BILLYS_CONVERSATION_JDG)) // see if billy and havoc are present
    {
      if (playerEntered == true && okay_to_play_conversation == true) {
        Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0,
                                    M01_CUE_BILLYS_CONVERSATION_JDG, 0);
...
DECLARE_SCRIPT(M01_Tank_Entering_Tunnel_Zone_JDG, "") // this guys ID is
{
  ...
  REGISTER_VARIABLES() { SAVE_VARIABLE(gdi_medium_tank, 1); }

  void Created(GameObject * obj) { gdi_medium_tank = 0; }
  ...
  void Entered(GameObject * obj, GameObject * enterer) {
    ...
    if (enterer == Commands->Find_Object(gdi_medium_tank)) {
      if (Commands->Find_Object(M01_TANK_TUNNEL_SQUISH_GUY_01_ID)) {
        Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_TANK_TUNNEL_SQUISH_GUY_01_ID), 0,
                                    M01_MEDIUM_TANK_IS_HERE_JDG, 0);
      }

      if (Commands->Find_Object(M01_TANK_TUNNEL_SQUISH_GUY_02_ID)) {
        Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_TANK_TUNNEL_SQUISH_GUY_02_ID), 0,
                                    M01_MEDIUM_TANK_IS_HERE_JDG, 0);
      }

      if (Commands->Find_Object(M01_TANK_TUNNEL_SQUISH_GUY_03_ID)) {
        Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_TANK_TUNNEL_SQUISH_GUY_03_ID), 0,
                                    M01_MEDIUM_TANK_IS_HERE_JDG, 0);
      }
...
if (Commands->Find_Object(M01_MISSION_CONTROLLER_JDG)) {
  Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0,
                              M01_PLAYER_IS_APPROACHING_TAILGUN_ALLEY_JDG, 0);
}
...
if (Commands->Find_Object(M01_GDIBASE_SPAWNER_CONTROLLER_JDG)) {
  Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_GDIBASE_SPAWNER_CONTROLLER_JDG), 0,
                              M01_QUIT_SPAWNING_PLEASE_JDG, 0);
}
...
{void Entered(GameObject * obj, GameObject *enterer){
    if (enterer == STAR){if (Commands->Find_Object(M01_MISSION_CONTROLLER_JDG)){Commands->Send_Custom_Event(
        obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0, M01_PLAYER_IS_APPROACHING_TAILGUN_ALLEY_JDG, 0);
}
...
DECLARE_SCRIPT(M01_Tailgun_02_SpawnApache_Zone_JDG, ""){void Entered(GameObject * obj, GameObject *enterer){
    if (enterer == STAR){GameObject *controller = Commands->Create_Object("Invisible_Object", Vector3(0, 0, 0));
...
DECLARE_SCRIPT(M01_Civ_To_Minigunner_Guy_JDG, ""){void Created(GameObject * obj){ActionParamsStruct params;
...
DECLARE_SCRIPT(M01_Comm_Base_Commander_JDG, "") // this guys ID is M01_COMMCENTER_BASE_COMMANDER_JDG 101936
{
  ...
  REGISTER_VARIABLES() { SAVE_VARIABLE(enemyEngaged, 1); }
  ...
  void Damaged(GameObject * obj, GameObject * damager, float amount) {
    if (damager == STAR && enemyEngaged == false) {
      ...
      Commands->Enable_Hibernation(obj, true);
      // Commands->Send_Custom_Event( obj, Commands->Find_Object ( M01_MISSION_CONTROLLER_JDG ), 0,
      // M01_CUE_KANE_AND_HAVOC_CONVERSATION_JDG, 0 );
    }
  }
                        ...
                        case M01_START_ATTACKING_01_JDG: //kane has told you to kill the scapegoat
                                {
                                        ...
                                        {
                                                params.Set_Basic(this, 100, M01_START_ATTACKING_01_JDG);
                                                params.Set_Attack( Commands->Find_Object
(M01_COMMCENTER_BASE_SCAPEGOAT_JDG), 100, 0, true ); Commands->Action_Attack( obj, params );
                                        }
                                }
                                break;
                }
...
DECLARE_SCRIPT(M01_Comm_Stationary_Tech_JDG, "") {
  ...
  REGISTER_VARIABLES() { SAVE_VARIABLE(myLocation, 1); }
...
{void Entered(GameObject * obj, GameObject *enterer){
    if (enterer == STAR){Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0,
                                                     M01_CUE_KANE_AND_NUMBER2_CONVERSATION_JDG, 0);
...
DECLARE_SCRIPT(M01_HON_MCT_Placeholder_JDG, ""){void Killed(GameObject * obj, GameObject *killer){
    Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0, M01_KILL_THE_HON_JDG, 0);
}
}
;

DECLARE_SCRIPT(M01_Comm_MCT_Placeholder_JDG, ""){void Killed(GameObject * obj, GameObject *killer){
    Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0, M01_KILL_THE_COMM_JDG, 0);
}
}
;

DECLARE_SCRIPT(M01_GDI_Toolshed_PatrolGuy_JDG, ""){void Created(GameObject * obj){ActionParamsStruct params;
...
DECLARE_SCRIPT(M01_GDI_Base_Spawner_Controller_JDG, "") // this guys ID is M01_GDIBASE_SPAWNER_CONTROLLER_JDG
{
  ...
  REGISTER_VARIABLES() { SAVE_VARIABLE(active_unit_count, 1); }

  void Created(GameObject * obj) { active_unit_count = 0; }
...
DECLARE_SCRIPT(M01_GDI_Base_Spawner_Guy_JDG,
               ""){void Killed(GameObject * obj,
                               GameObject *killer){if (Commands->Find_Object(M01_GDIBASE_SPAWNER_CONTROLLER_JDG)){
    Commands->Debug_Message("***************************GDI Base/barn area spawner has been killed--sending custom\n");
Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_GDIBASE_SPAWNER_CONTROLLER_JDG), 0, M01_SPAWNER_IS_DEAD_JDG,
                            0);
}
}
}
...
DECLARE_SCRIPT(M01_TailgunRun_Spawner_Guy_JDG,
               "") // Innate_Disable)(GameObject* object);(*Innate_Enable)(GameObject* object);
{void Killed(GameObject * obj, GameObject *killer){if (Commands->Find_Object(M01_TAILGUNRUN_SPAWNER_CONTROLLER_JDG)){
...
DECLARE_SCRIPT(M01_ChurchArea_Spawner_Guy_JDG, ""){
    void Killed(GameObject * obj, GameObject *killer){if (Commands->Find_Object(M01_CHURCHAREA_SPAWNER_CONTROLLER_JDG)){
...
DECLARE_SCRIPT(M01_Turn_on_the_Hand_of_Nod_Zone_JDG, ""){void Entered(GameObject * obj, GameObject *enterer){
    if (enterer == STAR){if (Commands->Find_Object(M01_CHURCHAREA_SPAWNER_CONTROLLER_JDG)){Commands->Send_Custom_Event(
        obj, Commands->Find_Object(M01_CHURCHAREA_SPAWNER_CONTROLLER_JDG), 0, M01_QUIT_SPAWNING_PLEASE_JDG, 0);
}

if (Commands->Find_Object(M01_MISSION_CONTROLLER_JDG)) {
  Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0, M01_HON_SPAWNS_MINIGUNNER_JDG,
                              0);
}
                                ...
                                case M01_MODIFY_YOUR_ACTION_JDG://here comes player start calling in reinforcements
                                        {
                                                if (obj)
                                                {
                                                        ...
                                                        Commands->Send_Custom_Event( obj, obj, 0,
M01_SEND_BARN_CHINOOK_JDG, delayTimer ); Commands->Send_Custom_Event( obj, obj, 0, M01_MODIFY_YOUR_ACTION_JDG,
delayTimer );
                                                }
                                        }
                                        break;
                                ...
                                case M01_SEND_BARN_CHINOOK_JDG: //here comes player start calling in reinforcements
                                        {
                                                if (obj)
                                                {
                                                        Commands->Send_Custom_Event( obj, Commands->Find_Object (
M01_MISSION_CONTROLLER_JDG ), 0, M01_SEND_BARN_CHINOOK_JDG, 0 );
                                                }
                                        }
                                        break;
                                ...
                                case M01_CALL_IN_REINFORCEMENTS_JDG: //here comes player start calling in reinforcements
                                        {
                                                ...
                                                {
                                                        GameObject * nodCommanderDialogController =
Commands->Find_Object ( 103398 ); if (nodCommanderDialogController != NULL)
                                                        {
                                                                Commands->Send_Custom_Event( obj,
nodCommanderDialogController, 0, M01_MODIFY_YOUR_ACTION_JDG, 0 );
                                                        }
                                                        float delayTimer = Commands->Get_Random ( 15, 30 );
                                                        Commands->Send_Custom_Event( obj, obj, 0,
M01_CALL_IN_REINFORCEMENTS_JDG, delayTimer );
                                                }
                                        }
                                        break;
                        }
  ...
  void Custom(GameObject * obj, int type, int param, GameObject *sender) {
    if (type == 0) {
      ...
      case M01_SEND_TAILGUN_CHINOOK_JDG: // here comes player start calling in reinforcements
      {
        if (obj) {
          Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0,
                                      M01_SEND_TAILGUN_CHINOOK_JDG, 0);
        }
      } break;
...
Commands->Attach_Script(sniperTarget01, "M01_GuardTower_Sniper_Target_JDG",
                        "-157.390 363.504 10.695, 148.379 342.954 9.656");

GameObject *sniperTarget02 = Commands->Create_Object("Nod_MiniGunner_0", Vector3(-149.930f, 338.900f, 9.170f));
Commands->Attach_Script(sniperTarget02, "M01_GuardTower_Sniper_Target_JDG",
                        "-158.760 357.590 10.695, -149.930 338.900 9.170");

GameObject *sniperTarget03 = Commands->Create_Object("Nod_MiniGunner_0", Vector3(-146.812f, 339.745f, 9.345f));
Commands->Attach_Script(sniperTarget03, "M01_GuardTower_Sniper_Target_JDG",
                        "-162.892 357.941 10.655, -146.812 339.745 9.345");
...
DECLARE_SCRIPT(M01_TibField_Guard01_New_JDG, ""){void Custom(GameObject * obj, int type, int param, GameObject *sender){
    if (param == M01_START_ACTING_JDG){GameObject *chemGuy01 = Commands->Find_Object(103270);
...
DECLARE_SCRIPT(M01_Barn_Babushkas_Conversation_Zone_JDG, "") // this guys ID is 101662
{
  ...
  void Custom(GameObject * obj, int type, int param, GameObject *sender) {
    ...
    if ((param == M01_START_ACTING_JDG)) // babushka is in position--give okay for conversation
    {
      ...
      if (playerEntered == true && okay_to_play_conversation == true) {
        Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0,
                                    M01_CUE_BABUSHKA_CONVERSATION_JDG, 0);
  ...
  if (obj) {
    if (damager == STAR) {
      ...
      if (Commands->Find_Object(101658)) {
        Commands->Send_Custom_Event(obj, Commands->Find_Object(101658), 0, M01_PLAYER_IS_ATTACKING_ME_JDG,
                                    0); // this is sent to his nearby buddy
      }
    }
  }
}
...
DECLARE_SCRIPT(M01_Barn_Point_Guard_02_JDG, "") // this guys ID is 101658
{
  ...
  REGISTER_VARIABLES() { SAVE_VARIABLE(retreating, 1); }
  ...
  void Killed(GameObject * obj, GameObject * killer) {
    Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0, M01_BARN_GUARD_IS_DEAD_JDG,
                                0);
  }
};
...
DECLARE_SCRIPT(M01_BarnArea_AI_ExitZone_JDG, "") // 112015 -- tunnel 112016 -- shack
{
  ...
  REGISTER_VARIABLES() { SAVE_VARIABLE(hovercraftGuyId, 1); }

  void Created(GameObject * obj) { hovercraftGuyId = 0; }
...
DECLARE_SCRIPT(M01_TurretBeach_GDI_Guy_01_JDG, "") //
{
  ...
  REGISTER_VARIABLES() { SAVE_VARIABLE(turretbeach_conv, 1); }
...
DECLARE_SCRIPT(M01_TurretBeach_GDI_Guy_02_JDG, ""){void Animation_Complete(GameObject * obj, const char *anim){
    if (stricmp(anim, "S_A_Human.H_A_X1E_Run") == 0){ActionParamsStruct params;
...
DECLARE_SCRIPT(M01_DetentionPen_CivDeathMonitor, "") {
  ...
  REGISTER_VARIABLES() { SAVE_VARIABLE(damagedYet, 1); }
...
DECLARE_SCRIPT(M01_DetentionPen_Evac_Controller01_JDG, "") // 103380
{
  ...
  void Created(GameObject * obj) { deadPrisonerTally = 0; }
...
DECLARE_SCRIPT(M01_DetentionCiv_Air_Evac_Waypath_JDG, ""){
    void Animation_Complete(GameObject * obj, const char *anim){if (stricmp(anim, "XG_TransprtBone.XG_EV1_PathA") == 0){
...
DECLARE_SCRIPT(M01_DetentionCiv_Air_Evac_Chopper_JDG,
               ""){void Created(GameObject * obj){Commands->Set_Shield_Type(obj, "Blamo");
Commands->Enable_Hibernation(obj, false);
Commands->Disable_Physical_Collisions(obj);
...
{void Animation_Complete(GameObject * obj,
                         const char *anim){if (stricmp(anim, "s_a_human.h_a_troopdrop") == 0){Vector3 offset;
...
DECLARE_SCRIPT(M01_Hunt_The_Player_JDG, ""){void Created(GameObject * obj){Commands->Enable_Hibernation(obj, false);
...
DECLARE_SCRIPT(M01_HON_Engineer02_JDG, "") // 101948
{
  ...
  REGISTER_VARIABLES() { SAVE_VARIABLE(repairSoundPlaying, 1); }
...
DECLARE_SCRIPT(M01_HON_Chinook_Spawned_Soldier_03_GDI_JDG, "") {
  ...
  REGISTER_VARIABLES() { SAVE_VARIABLE(buggy_id, 1); }
...
DECLARE_SCRIPT(M01_Priest_Conversation_Zone_JDG, "") // this guys ID is 103395  M01_PriestReminder_Conversation
{
  ...
  REGISTER_VARIABLES() { SAVE_VARIABLE(okay_to_play_conversation, 1); }

  void Created(GameObject * obj) { okay_to_play_conversation = false; }
  ...
  void Entered(GameObject * obj, GameObject * enterer) {
    if (enterer == STAR) {
      if (okay_to_play_conversation == true) {
        Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0,
                                    M01_CUE_PRIEST_CONVERSATION_JDG, 0);
        Commands->Destroy_Object(obj); // this is one-time only zone--cleaning up
      }
    }
  }
...
DECLARE_SCRIPT(M01_Loveshack_Nun_Conversation_Zone_JDG, "") // this guys ID is 101368
{
  ...
  void Entered(GameObject * obj, GameObject * enterer) {
    if (enterer == STAR) {
      if (okay_to_play_conversation == true) {
        Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0,
                                    M01_CUE_LOVESHACK_NUN_CONVERSATION_JDG, 0);
        Commands->Destroy_Object(obj); // this is one-time only zone--cleaning up
      }
    }
  }
...
DECLARE_SCRIPT(M01_Interior_Nun_Conversation_Zone_JDG, "") // this guys ID is #101370
{
  ...
  void Entered(GameObject * obj, GameObject * enterer) {
    if (enterer == STAR) {
      if (okay_to_play_conversation == true) {
        Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0,
                                    M01_CUE_INTERIOR_NUN_CONVERSATION_JDG, 0);
        Commands->Destroy_Object(obj); // this is one-time only zone--cleaning up
      }
    }
  }
...
void Killed(GameObject *obj, GameObject *killer) {
  Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0, M01_CHURCH_GUARD_IS_DEAD_JDG,
                              0);
...
DECLARE_SCRIPT(M01_Church_Loveshack_InterrogationConv_Zone_JDG, "") // 103392
{
  ...
  REGISTER_VARIABLES() { SAVE_VARIABLE(conversation_triggered, 1); }

  void Created(GameObject * obj) { conversation_triggered = false; }
...
DECLARE_SCRIPT(M01_GDI_Escort_Conversation_Controller_GDI, "") // 103396
{
  ...
  REGISTER_VARIABLES() { SAVE_VARIABLE(first_time_at_escort_limit, 1); }

  void Created(GameObject * obj) { first_time_at_escort_limit = true; }
...
DECLARE_SCRIPT(M01_CHURCH_Chinook_Spawned_Soldier01_GDI, "") {
  ...
  void Created(GameObject * obj) { thisGuysState = NOT_ESCORTING; }

  void Poked(GameObject * obj, GameObject * poker) {
    if (poker == STAR) {
      Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0,
                                  M01_GDI_GUY_HAS_BEEN_POKED_JDG, 0);
    }
  }
  ...
  void Killed(GameObject * obj, GameObject * killer) {
    if (thisGuysState == ESCORTING) {
      Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0,
                                  M01_PLAYERS_ESCORT_HAS_BEEN_KILLED_JDG, 0);
    }
  }
...
DECLARE_SCRIPT(M01_CHURCH_Chinook_Spawned_Soldier02_GDI, "") {
  ...
  REGISTER_VARIABLES() { SAVE_VARIABLE(thisGuysState, 1); }
...
{void Killed(GameObject * obj, GameObject *killer){Vector3 myPosition = Commands->Get_Position(obj);
...
DECLARE_SCRIPT(M01_GDIBase_EvacMonitor_JDG, "") // M01_GDIBASE_EVAC_MONITOR_JDG
{
  ...
  REGISTER_VARIABLES() { SAVE_VARIABLE(unitsEvacuated, 1); }

  void Created(GameObject * obj) { unitsEvacuated = 0; }
    ...
    if (type == 0) {
      ...
      //}
        ...
        const char *propaganda_screen[10] = {
            "M01_Propaganda_Screen_01", "M01_Propaganda_Screen_02", "M01_Propaganda_Screen_03",
            "M01_Propaganda_Screen_04", "M01_Propaganda_Screen_05", "M01_Propaganda_Screen_06",
            "M01_Propaganda_Screen_07", "M01_Propaganda_Screen_08", "M01_Propaganda_Screen_10",
            "M01_Propaganda_Screen_11",
        };

        const char *propaganda_sound[10] = {
            "M01NCXS_DSGN0270I1NCXS_SND", "M01NCXS_DSGN0271I1NCXS_SND", "M01NCXS_DSGN0272I1NCXS_SND",
            "M01NCXS_DSGN0273I1NCXS_SND", "M01NCXS_DSGN0279I1NCXS_SND", "M01NCXS_DSGN0275I1NCXS_SND",
            "M01NCXS_DSGN0276I1NCXS_SND", "M01NCXS_DSGN0277I1NCXS_SND", "M01NCXS_DSGN0278I1NCXS_SND",
...
DECLARE_SCRIPT(M01_Comm_Center_Building_Script_JDG, ""){void Killed(GameObject * obj, GameObject *killer){
    Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0,
                                M01_COMM_CENTER_HAS_BEEN_DESTROYED_JDG, 0);
Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_AMBIENT_SOUND_CONTROLLER_JDG), 0,
                            M01_COMM_CENTER_HAS_BEEN_DESTROYED_JDG, 0);
  ...
  void Custom(GameObject * obj, int type, int param, GameObject *sender) {
    if (type == 0) {
      if (param == M01_START_ACTING_JDG && acting == false) {
        ...
        GameObject *nodguy01 = Commands->Find_Object(nodguy01_id);
        if (nodguy01 != NULL) {
          int paintball_alert_conv =
              Commands->Create_Conversation("M01_Paintball_Intruder_Conversation_02", 95, 20, true);
        ...
        if (nodguy03 != NULL) {
          int paintball_alert_conv =
              Commands->Create_Conversation("M01_Paintball_Intruder_Conversation_01", 95, 20, true);
        ...
        if (nodguy05 != NULL) {
          int paintball_alert_conv =
              Commands->Create_Conversation("M01_Paintball_Intruder_Conversation_03", 95, 20, true);
...
DECLARE_SCRIPT(M01_HON_Dojo_Trainer_JDG, "") // this guys ID is M01_HON_DOJO_SENSEI_JDG 102051
{
  ...
  void Killed(GameObject * obj, GameObject * killer) {
    if (handOfNodDead == false) {
      if (Commands->Find_Object(M01_HON_DOJO_CIV_01_JDG)) {
        float delayTimer = Commands->Get_Random(0, 1);
        Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_HON_DOJO_CIV_01_JDG), 0,
                                    M01_MODIFY_YOUR_ACTION_02_JDG, delayTimer);
      }

      if (Commands->Find_Object(M01_HON_DOJO_CIV_02_JDG)) {
        float delayTimer2 = Commands->Get_Random(0, 1);
        Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_HON_DOJO_CIV_02_JDG), 0,
                                    M01_MODIFY_YOUR_ACTION_02_JDG, delayTimer2);
      }

      if (Commands->Find_Object(M01_HON_DOJO_CIV_03_JDG)) {
        float delayTimer3 = Commands->Get_Random(0, 1);
        Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_HON_DOJO_CIV_03_JDG), 0,
                                    M01_MODIFY_YOUR_ACTION_02_JDG, delayTimer3);
      }
    }
      ...
      if (Commands->Find_Object(M01_HON_DOJO_CIV_01_JDG)) {
        float delayTimer = Commands->Get_Random(0, 1);
        Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_HON_DOJO_CIV_01_JDG), 0,
                                    M01_YOUR_BUILDING_HAS_BEEN_DESTROYED_JDG, delayTimer);
      }

      if (Commands->Find_Object(M01_HON_DOJO_CIV_02_JDG)) {
        float delayTimer2 = Commands->Get_Random(0, 1);
        Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_HON_DOJO_CIV_02_JDG), 0,
                                    M01_YOUR_BUILDING_HAS_BEEN_DESTROYED_JDG, delayTimer2);
      }

      if (Commands->Find_Object(M01_HON_DOJO_CIV_03_JDG)) {
        float delayTimer3 = Commands->Get_Random(0, 1);
        Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_HON_DOJO_CIV_03_JDG), 0,
                                    M01_YOUR_BUILDING_HAS_BEEN_DESTROYED_JDG, delayTimer3);
      }
    }
  }
  ...
  void Damaged(GameObject * obj, GameObject * damager, float amount) {
    if (damager == STAR && first_time == true) {
      ...
      if (Commands->Find_Object(M01_HON_DOJO_CIV_01_JDG)) {
        float delayTimer = Commands->Get_Random(0, 1);
        Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_HON_DOJO_CIV_01_JDG), 0,
                                    M01_PLAYER_IS_ATTACKING_ME_JDG, delayTimer);
      }

      if (Commands->Find_Object(M01_HON_DOJO_CIV_02_JDG)) {
        float delayTimer2 = Commands->Get_Random(0, 1);
        Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_HON_DOJO_CIV_02_JDG), 0,
                                    M01_PLAYER_IS_ATTACKING_ME_JDG, delayTimer2);
      }

      if (Commands->Find_Object(M01_HON_DOJO_CIV_03_JDG)) {
        float delayTimer3 = Commands->Get_Random(0, 1);
        Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_HON_DOJO_CIV_03_JDG), 0,
                                    M01_PLAYER_IS_ATTACKING_ME_JDG, delayTimer3);
      }
    }
  }
  ...
  void Custom(GameObject * obj, int type, int param, GameObject *sender) {
    ...
    case M01_YOUR_BUILDING_HAS_BEEN_DESTROYED_JDG: // turn your sight and hearing back on
  ...
  void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason complete_reason) {
    ...
    case ACTION_COMPLETE_CONVERSATION_ENDED: {
      if (action_id == dojo_conv) // your initial conv is over--tell civs to do pushups
      {
        if (Commands->Find_Object(M01_HON_DOJO_CIV_01_JDG)) {
          float delayTimer = Commands->Get_Random(0, 1);
          Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_HON_DOJO_CIV_01_JDG), 0, M01_START_ACTING_JDG,
                                      delayTimer);
        }

        if (Commands->Find_Object(M01_HON_DOJO_CIV_02_JDG)) {
          float delayTimer2 = Commands->Get_Random(0, 1);
          Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_HON_DOJO_CIV_02_JDG), 0, M01_START_ACTING_JDG,
                                      delayTimer2);
        }

        if (Commands->Find_Object(M01_HON_DOJO_CIV_03_JDG)) {
          float delayTimer3 = Commands->Get_Random(0, 1);
          Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_HON_DOJO_CIV_03_JDG), 0, M01_START_ACTING_JDG,
                                      delayTimer3);
        }
      }
    } break;
...
{                                                     // target location ()
 void Entered(GameObject * obj,
              GameObject *enterer){if (enterer == STAR){Vector3 radarMarker(-293.163f, 499.787f, 19.959f);
Commands->Set_Objective_HUD_Info_Position(M01_UNLOCK_GATE_OBJECTIVE_JDG, 93, "POG_M01_1_02.tga", IDS_POG_ACCESS,
                                          radarMarker);
...
{                                                     // target location ()
 void Entered(GameObject * obj,
              GameObject *enterer){if (enterer == STAR){Vector3 radarMarker(-292.135f, 522.740f, 16.448f);
Commands->Set_Objective_HUD_Info_Position(M01_UNLOCK_GATE_OBJECTIVE_JDG, 93, "POG_M01_1_02.tga", IDS_POG_ACCESS,
                                          radarMarker);
...
{                                                     // target location ()
 void Entered(GameObject * obj,
              GameObject *enterer){if (enterer == STAR){Vector3 radarMarker(-314.578f, 517.124f, 16.447f);
Commands->Set_Objective_HUD_Info_Position(M01_UNLOCK_GATE_OBJECTIVE_JDG, 93, "POG_M01_1_02.tga", IDS_POG_ACCESS,
                                          radarMarker);
  ...
  void Poked(GameObject * obj, GameObject * poker) {
    if (poker == STAR && poked == false) {
      if (commCenterDead == false) {
        poked = true;
        Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0,
                                    M01_PLAYER_HAS_POKED_COMM_CENTER_PCT_JDG, 0);
  ...
  void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason complete_reason) {
    ...
    case ACTION_COMPLETE_CONVERSATION_ENDED: {
      if (action_id == missionIntro) // add first objective pog here
      {
        ...
        Commands->Add_Objective(M01_PRISONER_OBJECTIVE_JDG, OBJECTIVE_TYPE_PRIMARY, OBJECTIVE_STATUS_PENDING,
                                IDS_Enc_ObjTitle_Primary_M01_01, NULL, IDS_Enc_Obj_Primary_M01_01);
        Commands->Set_Objective_Radar_Blip(M01_PRISONER_OBJECTIVE_JDG, prisonerPenLocation);

        Commands->Set_Objective_HUD_Info_Position(M01_PRISONER_OBJECTIVE_JDG, 80, "POG_M01_1_01.tga", IDS_POG_LOCATE,
                                                  prisonerPenLocation);
  ...
  void Custom(GameObject * obj, int type, int param, GameObject *sender) {
    if (type == 0) {
      ...
      if (param == M01_GDI_BASE_POW_OBJECTIVE_JDG) {
        ...
        Commands->Add_Objective(M01_GDI_BASE_POW_OBJECTIVE_JDG, OBJECTIVE_TYPE_SECONDARY, OBJECTIVE_STATUS_PENDING,
                                IDS_Enc_ObjTitle_Secondary_M01_06, NULL, IDS_Enc_Obj_Secondary_M01_06);
        Commands->Set_Objective_Radar_Blip(M01_GDI_BASE_POW_OBJECTIVE_JDG, initialCaptainLocation);

        Commands->Set_Objective_HUD_Info_Position(M01_GDI_BASE_POW_OBJECTIVE_JDG, 85, "POG_M01_2_08.tga",
                                                  IDS_POG_RESCUE, initialCaptainLocation);

        // Commands->Send_Custom_Event( obj, obj, M01_REMOVE_OBJECTIVE_POG_JDG, M01_GDI_BASE_COMMANDER_OBJECTIVE_JDG,
        // SECONDARY_POG_DELAY );
        ...
        if (barnCommander != NULL) {
          ...
          Commands->Set_Objective_HUD_Info_Position(M01_FIRST_NOD_COMMANDER_OBJECTIVE_JDG, 86, "POG_M01_2_01.tga",
                                                    IDS_POG_ELIMINATE, commanderPosition);

          // Commands->Send_Custom_Event( obj, obj, M01_REMOVE_OBJECTIVE_POG_JDG, M01_FIRST_NOD_COMMANDER_OBJECTIVE_JDG,
          // SECONDARY_POG_DELAY );
        ...
        Commands->Set_Objective_HUD_Info_Position(M01_TURRETS_OBJECTIVE_JDG, 91, "POG_M01_2_02.tga", IDS_POG_DESTROY,
                                                  turretsLocation);

        // Commands->Send_Custom_Event( obj, obj, M01_REMOVE_OBJECTIVE_POG_JDG, M01_TURRETS_OBJECTIVE_JDG,
        // SECONDARY_POG_DELAY );
        ...
        Commands->Set_Objective_HUD_Info_Position(M01_BARN_OBJECTIVE_JDG, 92, "POG_M01_2_03.tga", IDS_POG_RESCUE,
                                                  barnLocation);

        // Commands->Send_Custom_Event( obj, obj, M01_REMOVE_OBJECTIVE_POG_JDG, M01_BARN_OBJECTIVE_JDG,
        // SECONDARY_POG_DELAY );
        ...
        Commands->Set_Objective_HUD_Info_Position(M01_BARN_ROUNDUP_OBJECTIVE_JGD, 93, "POG_M01_2_04.tga",
                                                  IDS_POG_EVACUATE, barnLocation);

        // Commands->Send_Custom_Event( obj, obj, M01_REMOVE_OBJECTIVE_POG_JDG, M01_BARN_ROUNDUP_OBJECTIVE_JGD,
        // SECONDARY_POG_DELAY );
      ...
      else if (param == M01_CHURCH_OBJECTIVE_JDG) //
      {
        ...
        Commands->Set_Objective_HUD_Info_Position(M01_CHURCH_OBJECTIVE_JDG, 94, "POG_M01_2_06.tga", IDS_POG_RESCUE,
                                                  churchLocation);

        // Commands->Send_Custom_Event( obj, obj, M01_REMOVE_OBJECTIVE_POG_JDG, M01_CHURCH_OBJECTIVE_JDG,
        // SECONDARY_POG_DELAY );
        ...
        Commands->Set_Objective_HUD_Info_Position(M01_HON_OBJECTIVE_JDG, 95, "POG_M02_2_01.tga", IDS_POG_DESTROY,
                                                  mctLocation);

        // Commands->Send_Custom_Event( obj, obj, M01_REMOVE_OBJECTIVE_POG_JDG, M01_HON_OBJECTIVE_JDG,
        // SECONDARY_POG_DELAY );
        ...
        Commands->Set_Objective_HUD_Info_Position(M01_COMM_SAM_OBJECTIVE_JDG, 96, "POG_M01_1_04.tga", IDS_POG_DESTROY,
                                                  samLocation);
      ...
      if (captDuncan != NULL) {
        if (param == M01_GDI_BASE_COMMANDER_OBJECTIVE_JDG) {
          ...
          Commands->Add_Objective(M01_GDI_BASE_COMMANDER_OBJECTIVE_JDG, OBJECTIVE_TYPE_SECONDARY,
                                  OBJECTIVE_STATUS_PENDING, IDS_Enc_ObjTitle_Secondary_M01_08, NULL,
                                  IDS_Enc_Obj_Secondary_M01_08);
          Vector3 realCaptainLocation(109.959f, 97.340f, 8.923f);
          Commands->Set_Objective_HUD_Info_Position(M01_GDI_BASE_COMMANDER_OBJECTIVE_JDG, 91, "POG_M01_2_05.tga",
                                                    IDS_POG_CONTACT, realCaptainLocation);
...
{void Killed(GameObject * obj, GameObject *killer){GameObject *gdiGuy01 = Commands->Find_Object(104685);
if (gdiGuy01 != NULL) {
...
DECLARE_SCRIPT(M01_Church_EvacController_JDG, "") // 103394
{
  ...
  void Custom(GameObject * obj, int type, int param, GameObject *sender) {
    ...
    else if (param == M01_EVERYONES_ON_BOARD_JDG) // civs are on board--send aircraft away
    {
      ...
      if (deadCivs == 3) {
        Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0,
                                    M01_CLEAR_CHURCH_OBJECTIVE_FAIL_JDG, 0);
      }
    }
...
DECLARE_SCRIPT(M01_ChurchArea_Air_Evac_Rope_JDG, ""){
    void Created(GameObject * obj){Commands->Debug_Message("**********************script attached to evac rope\n");
Commands->Enable_Hibernation(obj, false);
...
DECLARE_SCRIPT(M01_ChurchArea_Air_Evac_Chopper_JDG, ""){void Created(GameObject * obj){
...
void Custom(GameObject *obj, int type, int param, GameObject *sender) {
  ...
  case M01_DO_END_MISSION_CHECK_JDG: {
    ...
    if ((loveshackNun != NULL) || (churchNun != NULL) || (priest != NULL)) {
      ...
      Commands->Debug_Message(
          "*******************************all barn civs on board--about to send cutom to controller\n");
...
DECLARE_SCRIPT(M01_Church_Priest_JDG, "") {
  ...
  void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason complete_reason) {
    ...
    if (complete_reason == ACTION_COMPLETE_NORMAL) {
      ...
      {
        Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0,
                                    M01_CHURCH_CLERGY_HAS_BOARDED_JDG, 1);
      ...
      else if (action_id == M01_PICK_A_NEW_LOCATION_JDG) // priest is by Havoc--cue lucky charms conversation
      {
        ...
        // Commands->Monitor_Conversation( obj, lucky_charms );
               ...
               complete_reason == ACTION_COMPLETE_NORMAL) // priest is by Havoc--cue lucky charms conversation
      {
        Vector3 evacSpot = Commands->Get_Position(Commands->Find_Object(103394));
        params.Set_Basic(this, 100, M01_GOING_TO_EVAC_SPOT_JDG);
        params.Set_Movement(evacSpot, RUN, 0.5f);
...
DECLARE_SCRIPT(M01_Church_LoveShack_Nun_JDG, ""){void Created(GameObject * obj){Commands->Innate_Disable(obj);
}
...
DECLARE_SCRIPT(M01_BarnArea_Air_Evac_Chopper_JDG, ""){void Created(GameObject * obj){
    Commands->Set_Animation(obj, "v_GDI_trnspt.XG_EV5_trnsA", false, NULL, 0.0f, -1.0f, false);
Commands->Debug_Message("**********************script attached to evac chopper\n");
Commands->Set_Shield_Type(obj, "Blamo");
Commands->Enable_Hibernation(obj, false);
...
DECLARE_SCRIPT(M01_Barn_Prisoner_01_JDG, "") // this guys ID is M01_BARN_PRISONER_01_ID 101442--this is female
{
  ...
  void Killed(GameObject * obj, GameObject * killer) //
  {
    Commands->Create_Sound("EVA_Civilian_Killed", Vector3(0, 0, 0), obj);
    // Commands->Send_Custom_Event( obj, Commands->Find_Object ( M01_MISSION_CONTROLLER_JDG ), 0,
    // M01_CIVILIAN_KILLED_JDG, 0 );

    if (talkingToHavoc == true) {
      Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0,
                                  M01_CUE_BABUSHKA_CONVERSATION_JDG, 2);
    }
...
DECLARE_SCRIPT(M01_Barn_Prisoner_02_JDG, "") // this guys ID is M01_BARN_PRISONER_02_ID 101444--this is Billy
{
  ...
  REGISTER_VARIABLES() { SAVE_VARIABLE(chinookOnWay, 1); }
...
DECLARE_SCRIPT(M01_Barn_Prisoner_03_JDG, "") // this guys ID is M01_BARN_PRISONER_03_ID 101443--this is pierre
{
  ...
  void Custom(GameObject * obj, int type, int param, GameObject *sender) {
    ...
    else if (param == M01_SEND_BARN_CIVILIANS_RESCUE_CHINOOK_JDG) // your ride is on the way--disable hibernation
    {
      ...
      Commands->Debug_Message(
          "***************************barn civ 3 has received evac chopper call--should now be going to evac spot\n");
      Commands->Enable_Hibernation(obj, false);
      Commands->Set_Innate_Is_Stationary(obj, false);
...
DECLARE_SCRIPT(M01_Evac_TroopBone_JDG, ""){void Animation_Complete(GameObject * obj, const char *anim){
    if (stricmp(anim, "XG_EV5_troopBN.XG_EV5_troopBN") == 0){Commands->Destroy_Object(obj);
}
}
}
;
...
{void Entered(GameObject * obj,
              GameObject *enterer){if (enterer == STAR){GameObject *gdiBaseCommander = Commands->Find_Object(106050);
...
DECLARE_SCRIPT(M01_GDIBase_FirstChinookFlamethrowerGuy_JDG,
               ""){void Created(GameObject * obj){GameObject *gdiGuy01 = Commands->Find_Object(104685);
...
{void Entered(GameObject * obj,
              GameObject *enterer){if (enterer == STAR){GameObject *visceroid01 = Commands->Find_Object(106908);
...
DECLARE_SCRIPT(M01_Tiberium_Cave_Spawn_Helicopter_Zone_JDG,
               "") // M01_TIB_TUNNEL_HELICOPTER_ZONE_JDG...this guys ID is 100955
{void Entered(GameObject * obj, GameObject *enterer){
    if (enterer == STAR){Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0,
                                                     M01_SPAWN_TIB_CAVE_HELICOPTER_JDG, 0);
...
DECLARE_SCRIPT(M01_Detention_GuardTower_Enter_Zone_JDG, ""){void Entered(GameObject * obj, GameObject *enterer){
    if (enterer == STAR){GameObject *detentionCiv01 = Commands->Find_Object(M01_DETENTION_CIVILIAN_01_JDG);
...
DECLARE_SCRIPT(M01_PrisonPen_POW_JDG, "") {
  ...
  void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason complete_reason) {
    ...
    if (action_id == M01_WALKING_WAYPATH_02_JDG) {
      ...
      Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0,
                                  M01_DO_END_MISSION_CHECK_JDG, 5);
  ...
  void Poked(GameObject * obj, GameObject * poker) {
    if (gateIsDown == true) {
      if (sam_is_destroyed == false) {
        ...
        if (obj == babushka) {
          int apacheConv =
              Commands->Create_Conversation("M01_Detention_Babushka_Poke_Conversation01", 100, 1000, false);
          Commands->Join_Conversation(obj, apacheConv, false, true, true);
          Commands->Start_Conversation(apacheConv, apacheConv);
        }
          ...
          int apacheConv =
              Commands->Create_Conversation("M01_Detention_FarmerJohn_Poke_Conversation01", 100, 1000, false);
          Commands->Join_Conversation(obj, apacheConv, false, true, true);
          Commands->Start_Conversation(apacheConv, apacheConv);
        }
      }
...
{void Entered(GameObject * obj, GameObject *enterer){
    if (enterer == STAR){GameObject *firstFieldCommander = Commands->Find_Object(M01_BARNAREA_NOD_COMMANDER_JDG);
if (firstFieldCommander != NULL) {
  ...
  Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0,
                              M01_ADD_BARN_COMMANDER_OBJECTIVE_JDG, 5);
}
  ...
  void Custom(GameObject * obj, int type, int param, GameObject *sender) {
    if (type == 0) {
      ...
      case M01_START_ACTING_JDG: // here comes player start calling in reinforcements
      {
        ...
        if (sender == zone01) {
          Commands->Debug_Message(
              "**********************Nod gdi tower commander has recieved command to start acting\n");
          Commands->Send_Custom_Event(obj, obj, 0, M01_MODIFY_YOUR_ACTION_JDG, 2);
      ...
      case M01_SEND_GUARD_TOWER_CHINOOK_JDG: // here comes player start calling in reinforcements
      {
        if (obj) {
          Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0,
                                      M01_SEND_GUARD_TOWER_CHINOOK_JDG, 0);
        }
      } break;
      ...
      case M01_CALL_IN_REINFORCEMENTS_JDG: // here comes player start calling in reinforcements
      {
        if (obj && deadYet == false) {
          ...
          if (nodCommanderDialogController != NULL) {
            Commands->Debug_Message(
                "**********************Nod gdi tower commander is sending custom to dialog controller\n");
            Commands->Send_Custom_Event(obj, nodCommanderDialogController, 0, M01_MODIFY_YOUR_ACTION_JDG, 0);
          }
          float delayTimer = Commands->Get_Random(15, 30);
          Commands->Send_Custom_Event(obj, obj, 0, M01_CALL_IN_REINFORCEMENTS_JDG, delayTimer);
...
DECLARE_SCRIPT(M01_Nod_Commander_Conversation_Controller_GDI, "") // 103398
{
  ...
  void Created(GameObject * obj) { first_call = true; }
...
DECLARE_SCRIPT(M01_GDIBase_LightTank_PastTunnelZone_JDG, ""){void Entered(GameObject * obj, GameObject *enterer){
    GameObject *lightTank = Commands->Find_Object(M01_TAILGUNAREA_NOD_LIGHTTANK_JDG);
...
DECLARE_SCRIPT(M01_GDIBase_AI_ExitZone_JDG, ""){
    void Entered(GameObject * obj, GameObject *enterer){GameObject *gdiFollower = Commands->Find_Object(104686);
...
DECLARE_SCRIPT(M01_Sinking_Gunboat_JDG, ""){
    void Created(GameObject * obj){Commands->Set_Animation(obj, "V_GDI_GBOAT.XG_GBOAT_SINK", false, NULL, 0, 60, false);
}
...
DECLARE_SCRIPT(M01_PlayerEntering_BarnArea_Zone_JDG, ""){void Entered(GameObject * obj, GameObject *enterer){
    if (enterer == STAR){GameObject *gunboatController = Commands->Find_Object(M01_TURRETBEACH_CONTROLLER_ID);
...
DECLARE_SCRIPT(M01_PlayerLeaving_BarnArea_Zone_JDG, ""){void Entered(GameObject * obj, GameObject *enterer){
    if (enterer == STAR){GameObject *gunboatController = Commands->Find_Object(M01_TURRETBEACH_CONTROLLER_ID);
if (gunboatController != NULL) {
...
{void Entered(GameObject * obj,
              GameObject *enterer){if (enterer == STAR) //
                                   {GameObject *missionController = Commands->Find_Object(M01_MISSION_CONTROLLER_JDG);
if (missionController != NULL) {
...
DECLARE_SCRIPT(M01_Obelisk_UpdateDisc_JDG, ""){void Custom(GameObject * obj, int type, int param, GameObject *sender){
    if (type == CUSTOM_EVENT_POWERUP_GRANTED){Commands->Reveal_Encyclopedia_Building(12);
...
DECLARE_SCRIPT(M01_HON_RedKey_Zone_JDG, ""){void Entered(GameObject * obj, GameObject *enterer){
    if (enterer == STAR){bool playerHasRedKey = Commands->Has_Key(STAR, 3);
...
DECLARE_SCRIPT(M01_Comm_Center_Pen_Gate, "") {
  ...
  REGISTER_VARIABLES() { SAVE_VARIABLE(samDead, 1); }
  ...
  void Poked(GameObject * obj, GameObject * poker) //
  {
    if (poker == STAR && samDead == true) {
      Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0,
                                  M01_PLAYER_HAS_POKED_PEN_GATE_JDG, 0);
    }
  }
...
DECLARE_SCRIPT(M01_CommCenter_SAMSite_Script, ""){void Damaged(GameObject * obj, GameObject *damager, float amount){
    if (damager == (STAR)){if (obj){Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG),
                                                                0, M01_PLAYER_IS_ATTACKING_ME_JDG, 0);
}
}
...
void Killed(GameObject *obj, GameObject *killer) {
  Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0,
                              M01_COMMCENTER_SAMSITE_HAS_BEEN_DESTROYED_JDG, 0);
...
DECLARE_SCRIPT(M01_TurretBeach_Engineer_JDG, "") // this guys ID is M01_TURRETBEACH_ENGINEER_ID 101654
{
  ...
  void Killed(GameObject * obj, GameObject * killer) {
    killedYet = true;
    Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0,
                                M01_TURRET_BEACH_ENGINEER_IS_DEAD_JDG, 5);
  }
  ...
  void Custom(GameObject * obj, int type, int param, GameObject *sender) {
    ...
    if (param == M01_START_ACTING_JDG) {
      ...
      Commands->Debug_Message(
          "***************************turret engineer has fixed turret one--going back to hiding spot\n");
  ...
  void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason complete_reason) {
    ...
    if (action_id == M01_WALKING_WAYPATH_01_JDG &&
        complete_reason == ACTION_COMPLETE_NORMAL) // engineer is at damaged turret 01--play fixing animation
    {
      GameObject *turret01 = Commands->Find_Object(M01_TURRETBEACH_TURRET_01_ID);
      if (turret01 != NULL) {
        params.Set_Basic(this, 100, M01_START_ATTACKING_01_JDG);
        ...
        Commands->Send_Custom_Event(obj, obj, 0, M01_START_ATTACKING_01_JDG, 1.5f);
             ...
             complete_reason == ACTION_COMPLETE_NORMAL) // engineer is at damaged turret 02--play fixing animation
    {
      GameObject *turret02 = Commands->Find_Object(M01_TURRETBEACH_TURRET_02_ID);
      if (turret02 != NULL) {
        ...
        Commands->Send_Custom_Event(obj, obj, 0, M01_START_ATTACKING_02_JDG, 0.5f);
             ...
             complete_reason == ACTION_COMPLETE_NORMAL) // engineer has been damaged look around
    {
      const char *animationName = M01_Choose_Duck_Animation();
      Commands->Action_Reset(obj, 100);
...
{void Created(GameObject * obj){Vector3 myTarget(-27.746f, 52.823f, 1.071f);
ActionParamsStruct params;
params.Set_Basic(this, 100, M01_START_ATTACKING_01_JDG);
...
{                                                 // waypath 120218
 ...
 void Custom(GameObject * obj, int type, int param,
             GameObject *sender){if (type == 0){if (param == M01_START_ACTING_JDG){ActionParamsStruct params;
params.Set_Basic(this, 100, M01_WALKING_WAYPATH_01_JDG);
...
{void Created(GameObject *
              obj){int pressF1Conv = Commands->Create_Conversation("M01_Press_F1_Conversation", 100, 1000, true);
...
{void Custom(GameObject * obj, int type, int param, GameObject *sender){
    if (type == CUSTOM_EVENT_POWERUP_GRANTED){GameObject *c4TextController = Commands->Find_Object(117188);
...
{void Created(GameObject * obj){Commands->Attach_Script(obj, "M00_Soldier_Powerup_Disable", "");
Commands->Enable_Hibernation(obj, false);
ActionParamsStruct params;
params.Set_Basic(this, 90, M01_WALKING_WAYPATH_01_JDG);
params.Set_Movement(Vector3(0, 0, 0), WALK, .25f);
...
DECLARE_SCRIPT(M01_Use_Ladder_Zone_JDG, ""){
    void Entered(GameObject * obj, GameObject *enterer) // M01_Press_F1_Conversation
    {if (enterer ==
         STAR){int pressF1Conv = Commands->Create_Conversation("M01_Press_E_For_Ladders_Conversation", 100, 1000, true);
Commands->Join_Conversation(NULL, pressF1Conv, false, false, true);
Commands->Start_Conversation(pressF1Conv, pressF1Conv);
...
DECLARE_SCRIPT(M01_AccessDenied_Zone_JDG, ""){
    void Entered(GameObject * obj, GameObject *enterer) // M01_Press_F1_Conversation
    {if (enterer == STAR){int pressF1Conv = Commands->Create_Conversation("M01_Lockdown_Conversation", 100, 1000, true);
Commands->Join_Conversation(NULL, pressF1Conv, false, false, true);
Commands->Start_Conversation(pressF1Conv, pressF1Conv);
...
DECLARE_SCRIPT(M01_QuickSave_Zone_JDG, ""){void Entered(GameObject * obj, GameObject *enterer){
    if (enterer == STAR){Commands->Set_HUD_Help_Text(IDS_M01DSGN_DSGN0525I1DSGN_TXT, TEXT_COLOR_OBJECTIVE_PRIMARY);
Commands->Destroy_Object(obj);
}
}
}
...
DECLARE_SCRIPT(M01_GDIBaseCommander_Air_Evac_Chopper_JDG, ""){void Created(GameObject * obj){
    Commands->Set_Animation(obj, "v_GDI_trnspt.XG_EV5_trnsA", false, NULL, 0.0f, -1.0f, false);
Commands->Debug_Message("**********************script attached to evac chopper\n");
Commands->Set_Shield_Type(obj, "Blamo");
Commands->Enable_Hibernation(obj, false);
      ...
      if (param == M01_START_ACTING_JDG) // gdi commander is done giving ion beacon--start evac scenario
      {
        ...
        if (gdiBaseGrenadier != NULL) {
          Commands->Send_Custom_Event(obj, gdiBaseGrenadier, 0, M01_GOTO_YOUR_EVAC_SPOT_JDG, 0);
               ...
               evacing == false) // one of your guys is at his wait spot--call in chopper
      {
        evacing = true;
        ...
        Commands->Attach_Script(controller, "Test_Cinematic", "XG_M01_GDIBaseCommander_EvacAnim.txt");
               ...
               evacing == true) // everyone is on or dead--give take off orders
      {
        GameObject *evacChopper = Commands->Find_Object(evac_helicopter_id);
        GameObject *evacWaypath = Commands->Find_Object(evac_waypath_id);
        GameObject *evacRope = Commands->Find_Object(evac_rope_id);
...
DECLARE_SCRIPT(M01_GDIBasePOW_Air_Evac_Chopper_JDG, ""){void Created(GameObject * obj){
    Commands->Set_Animation(obj, "v_GDI_trnspt.XG_EV5_trnsA", false, NULL, 0.0f, -1.0f, false);
Commands->Debug_Message("**********************script attached to evac chopper\n");
Commands->Set_Shield_Type(obj, "Blamo");
Commands->Enable_Hibernation(obj, false);
...
DECLARE_SCRIPT(M01_ConDropZone_JDG, ""){void Entered(GameObject * obj, GameObject *enterer){if (enterer == STAR){
...
DECLARE_SCRIPT(M01_ConYard_Dropoff_Dude_JDG, ""){void Animation_Complete(GameObject * obj, const char *anim){
    if (stricmp(anim, "S_A_Human.H_A_TroopDrop") == 0){Commands->Destroy_Object(obj);
}
}
}
;

DECLARE_SCRIPT(M01_C130_Dropoff_Dude_JDG, ""){void Animation_Complete(GameObject * obj, const char *anim){
    if (stricmp(anim, "S_a_Human.H_A_X5D_ParaT_1") == 0){Commands->Destroy_Object(obj);
}
...
DECLARE_SCRIPT(M01_Base_GDI_Fodder_JDG, ""){void Created(GameObject * obj){Vector3 myTarget(72.223f, -24.751f, -0.296f);
ActionParamsStruct params;
Commands->Set_Innate_Is_Stationary(obj, true);
params.Set_Basic(this, 100, M01_START_ACTING_JDG);
...
{void Entered(GameObject * obj,
              GameObject *enterer){if (enterer == STAR){GameObject *minigunner = Commands->Find_Object(116382);
...
DECLARE_SCRIPT(M01_Nod_Truck_JDG,
               ""){void Created(GameObject * obj){Commands->Set_Player_Type(obj, SCRIPT_PLAYERTYPE_NEUTRAL);
Commands->Set_Obj_Radar_Blip_Color(obj, RADAR_BLIP_COLOR_NOD);
}
}
;

DECLARE_SCRIPT(M01_C4_Tutorial_Zone_JDG, ""){void Entered(GameObject * obj, GameObject *enterer){
    if (enterer == STAR){GameObject *c4TextController = Commands->Find_Object(117188);
if (c4TextController != NULL) {
  Commands->Send_Custom_Event(obj, c4TextController, 1, 1, 0);
}
...
DECLARE_SCRIPT(M01_Mainframe_Tutorial_Zone_JDG, ""){void Entered(GameObject * obj, GameObject *enterer){
    if (enterer == STAR){Commands->Set_HUD_Help_Text(IDS_M01DSGN_DSGN0527I1DSGN_TXT, TEXT_COLOR_OBJECTIVE_PRIMARY);
...
DECLARE_SCRIPT(M01_GateSwitch_Tutorial_Zone_JDG, "") // 120844
{
  ...
  REGISTER_VARIABLES() { SAVE_VARIABLE(command_clearance, 1); }

  void Created(GameObject * obj) { command_clearance = false; }
...
DECLARE_SCRIPT(M01_BarnArea_NOD_Commander_Trigger_Zone02_JDG, "") // 103343
{
  ...
  void Entered(GameObject * obj, GameObject * enterer) {
    if (enterer == STAR && entered == false) {
      ...
      if (firstFieldCommander != NULL) {
        Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_BARNAREA_NOD_COMMANDER_JDG), 0, M01_START_ACTING_JDG,
                                    0);
        Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0,
                                    M01_ADD_BARN_COMMANDER_OBJECTIVE_JDG, 5);
      }
...
DECLARE_SCRIPT(M01_TurretBeach_Turret_01_Script_JDG, "") // M01_TURRETBEACH_TURRET_01_ID 101434
{
  ...
  void Created(GameObject * obj) { engineer_id = M01_TURRETBEACH_ENGINEER_ID; }
  ...
  void Killed(GameObject * obj, GameObject * killer) // M01_IVE_BEEN_KILLED_JDG
  {
    ...
    Commands->Send_Custom_Event(obj, Commands->Find_Object(M01_MISSION_CONTROLLER_JDG), 0,
                                M01_TURRET_HAS_BEEN_DESTROYED_JDG, 5);
    ...
    if (type == 0) {
      if (param == M01_MODIFY_YOUR_ACTION_JDG) // run over next to ladder
      {
        ...
        Commands->Action_Goto(obj, params);
               ...
               M01_START_ATTACKING_01_JDG) // player is at top of ladders...check if nod minigunner is still alive
      {
      ...
      else if (action_id == M01_GOING_TO_EVAC_SPOT_JDG) // start load animation here
      {
        ...
        if (myEvacController != NULL) // tell controller to spawn a rope
        {
          Commands->Send_Custom_Event(obj, myEvacController, 0, M01_GIVE_ME_A_ROPE_JDG, 0);
               ...
               M01_WALKING_WAYPATH_03_JDG) // you're over by the pows now...check if nod guy 02 is still alive
      {
        Commands->Send_Custom_Event(obj, obj, 0, M01_WALKING_WAYPATH_04_JDG, 0);
      }
...
DECLARE_SCRIPT(M01_GDIBase_POW_Conversation_Controller_JDG, "") // 121237
{
  ...
  void Created(GameObject * obj) { convPlayed = false; }
  ...
  void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason complete_reason) {
    ...
    if (complete_reason == ACTION_COMPLETE_CONVERSATION_ENDED) {
      if (action_id == pow02conv01) {
        GameObject *pogController = Commands->Find_Object(M01_MISSION_POG_CONTROLLER_JDG);
        if (pogController != NULL) {
          Commands->Send_Custom_Event(obj, pogController, M01_CHANGE_OBJECTIVE_POG_JDG,
                                      M01_GDI_BASE_COMMANDER_OBJECTIVE_JDG, 0);
        }
...
DECLARE_SCRIPT(M01_GDI_BeachGuy01_JDG, ""){void Created(GameObject * obj){Commands->Innate_Disable(obj);
ActionParamsStruct params;
Commands->Enable_Hibernation(obj, false);
params.Set_Basic(this, 100, M01_WALKING_WAYPATH_01_JDG);
...
DECLARE_SCRIPT(M01_Announce_TankAirstrikeZone_JDG, ""){void Entered(GameObject * obj, GameObject *enterer){
    if (enterer == STAR){GameObject *missionController = Commands->Find_Object(M01_MISSION_CONTROLLER_JDG);
if (missionController != NULL) {
...
DECLARE_SCRIPT(M01_GDI_GuardTower_02_Enter_Zone_JDG, ""){void Entered(GameObject * obj, GameObject *enterer){
    if (enterer == STAR){GameObject *sniperTarget01 = Commands->Create_Object("Nod_MiniGunner_0", Vector3());
Commands->Attach_Script(sniperTarget01, "M01_GuardTower_Sniper_Target_JDG",
                        "-90.385 124.308 1.610, -79.477 139.201 0.947");

GameObject *sniperTarget02 = Commands->Create_Object("Nod_MiniGunner_0", Vector3());
Commands->Attach_Script(sniperTarget02, "M01_GuardTower_Sniper_Target_JDG",
                        "-85.499 117.221 1.915, -79.477 139.201 0.947");

GameObject *sniperTarget03 = Commands->Create_Object("Nod_MiniGunner_0", Vector3());
Commands->Attach_Script(sniperTarget03, "M01_GuardTower_Sniper_Target_JDG",
                        "-93.364 113.202 1.701, -79.477 139.201 0.947");
...
DECLARE_SCRIPT(M01_GuardTower02_Sniper_TowerZone_JDG, "") // 123645
{
  ...
  void Custom(GameObject * obj, int type, int param, GameObject *sender) {
    if (type == 0) {
      if (param ==
          M01_IVE_BEEN_KILLED_JDG) // a sniper targets been killed--check player position and spawn new target if needed
      {
...
DECLARE_SCRIPT(M01_TurnOff_TankReminder_Zone_JDG, ""){void Entered(GameObject * obj, GameObject *enterer){
    if (enterer == STAR){GameObject *tankReminderZone = Commands->Find_Object(122848);
...
{void Entered(GameObject * obj,
              GameObject *enterer){if (enterer == STAR){GameObject *mctCommander = Commands->Find_Object(103373);
...
DECLARE_SCRIPT(M01_Havoc_In_WarroomZone_JDG, ""){void Entered(GameObject * obj, GameObject *enterer){
    if (enterer == STAR){GameObject *HON_MonitorZone = Commands->Find_Object(124044);
if (HON_MonitorZone != NULL) {
...
DECLARE_SCRIPT(M01_Havoc_Out_WarroomZone_JDG, ""){void Entered(GameObject * obj, GameObject *enterer){
    if (enterer == STAR){GameObject *HON_MonitorZone = Commands->Find_Object(124044);
if (HON_MonitorZone != NULL) {
...
DECLARE_SCRIPT(M01_Medium_Tank01_JDG, ""){
    void Created(GameObject * obj){GameObject *hovercraftExplosionController = Commands->Find_Object(121839);
...
DECLARE_SCRIPT(M01_CantBring_MediumTank_ThroughHereZone_JDG, "") {
  ...
  void Created(GameObject * obj) { player_in_tank = false; }
...
DECLARE_SCRIPT(M01_Medium_Tank_JDG, "") {
  ...
  REGISTER_VARIABLES() { SAVE_VARIABLE(firstTimeEntered, 1); }
...
DECLARE_SCRIPT(M01_TurretBeach_FodderHovercraft_Controller_JDG, "") // 121630  M01_START_ACTING_JDG
{
  ...
  void Created(GameObject * obj) { hovercraftAlive = false; }

  void Custom(GameObject * obj, int type, int param, GameObject *sender) {
    if (type == 0) {
      if (param == M01_START_ACTING_JDG &&
          hovercraftAlive == false) // turret objective has been added--start bringing in hovercraft
      {
...
DECLARE_SCRIPT(M01_Hovercraft_Explosion_Controller_JDG, "") // 121839
{
  ...
  REGISTER_VARIABLES() { SAVE_VARIABLE(tank_id, 1); }
...
DECLARE_SCRIPT(M01_FodderHovercraft_Script_JDG, ""){
    void Created(GameObject * obj){GameObject *fodderHovercraftController = Commands->Find_Object(121630);
if (fodderHovercraftController != NULL) {
...
DECLARE_SCRIPT(M01_Beach_Datadisc_JDG, ""){void Custom(GameObject * obj, int type, int param, GameObject *sender){
...
DECLARE_SCRIPT(M01_Priest_Datadisc_JDG, ""){void Custom(GameObject * obj, int type, int param, GameObject *sender){
...
DECLARE_SCRIPT(M01_DataDisc_TextController_JDG, "") // 117188
{
  ...
  REGISTER_VARIABLES() { SAVE_VARIABLE(playingText, 1); }

  void Created(GameObject * obj) { playingText = false; }
  ...
  void Custom(GameObject * obj, int type, int param, GameObject *sender) {
    if (type == 0) {
      ...
      if (param == 1 && playingText == false) // player has picked up a C4 -- start text routine
      {
        ...
        Commands->Join_Conversation(NULL, pressF1Conv, false, false, true);
        Commands->Start_Conversation(pressF1Conv, pressF1Conv);
        Commands->Set_HUD_Help_Text(IDS_M01DSGN_DSGN0519I1DSGN_TXT,
                                    TEXT_COLOR_OBJECTIVE_PRIMARY); // Press '9' to select Remote C4.\n
        Commands->Send_Custom_Event(obj, obj, 1, 2, 2);
        playingText = true;
      }

      else if (param == 2) {
        Commands->Set_HUD_Help_Text(IDS_M01DSGN_DSGN0523I1DSGN_TXT,
                                    TEXT_COLOR_OBJECTIVE_PRIMARY); // Left-click your mouse to place C4.\n
        Commands->Send_Custom_Event(obj, obj, 1, 3, 2);
      }

      else if (param == 3) {
        Commands->Set_HUD_Help_Text(IDS_M01DSGN_DSGN0524I1DSGN_TXT,
                                    TEXT_COLOR_OBJECTIVE_PRIMARY); // Right-click your mouse to detonate.\n
    ...
    else if (type == 2) // player has picked up sniper rifle
    {
      if (param == 1 && playingText == false) // player has picked up a C4 -- start text routine
      {
        ...
        Commands->Join_Conversation(NULL, pressF1Conv, false, false, true);
        Commands->Start_Conversation(pressF1Conv, pressF1Conv);
        Commands->Set_HUD_Help_Text(IDS_M01DSGN_DSGN0518I1DSGN_TXT,
                                    TEXT_COLOR_OBJECTIVE_PRIMARY); // Press '3' to select your Sniper Rifle.\n
        Commands->Send_Custom_Event(obj, obj, 2, 2, 2);
        playingText = true;
      }

      else if (param == 2) {
        Commands->Set_HUD_Help_Text(IDS_M01DSGN_DSGN0521I1DSGN_TXT,
                                    TEXT_COLOR_OBJECTIVE_PRIMARY); // Right-click your mouse for sniper mode.\n
        Commands->Send_Custom_Event(obj, obj, 2, 3, 2);
      }

      else if (param == 3) {
        Commands->Set_HUD_Help_Text(IDS_M01DSGN_DSGN0522I1DSGN_TXT,
                                    TEXT_COLOR_OBJECTIVE_PRIMARY); // Use the mouse wheel or 'G' and 'T' to zoom.\n
...
DECLARE_SCRIPT(M01_Duncan_Assailer_JDG, ""){
    void Killed(GameObject * obj, GameObject *killer){GameObject *convController = Commands->Find_Object(125857);
if (convController != NULL) {
  Commands->Send_Custom_Event(obj, convController, 0, M01_IVE_BEEN_KILLED_JDG, 0);
}
}
...
void Custom(GameObject *obj, int type, int param, GameObject *sender) {
  if (type == 0) {
    if (param == M01_MODIFY_YOUR_ACTION_JDG) {
      ...
      GameObject *grenadier = Commands->Find_Object(116383);
      if (grenadier != NULL) {
        Commands->Send_Custom_Event(obj, grenadier, 0, M01_MODIFY_YOUR_ACTION_06_JDG,
                                    0); // tell grenadier to go down back path too
      }
...
DECLARE_SCRIPT(M01_Base_GDI_Minigunner_JDG, "") // 116382
{
    ...
    if (type == 0) {
      if (param == M01_MODIFY_YOUR_ACTION_JDG) // leave the guard tower and take up second position outside guard tower
      {
        ...
        Commands->Attach_Script(controller1, "Test_Cinematic", "X01D_C130Troopdrop.txt");
               ...
               M01_MODIFY_YOUR_ACTION_02_JDG) // leave outside guard tower and take up third position beside the ladder
      {
      ...
      else if (param == M01_GOING_TO_EVAC_SPOT_JDG) // your ride is here--go get in
      {
        ...
        if (myEvacController != NULL) {
          ...
          Commands->Action_Goto(obj, params);
               ...
               headingDownBackPath == false) // POW conversation is over---wave at havoc
      {
  ...
  void Action_Complete(GameObject * obj, int action_id, ActionCompleteReason complete_reason) {
    ...
    if (complete_reason == ACTION_COMPLETE_NORMAL) {
      ...
      else if (action_id == M01_WALKING_WAYPATH_03_JDG) // you are by pows now...run to path entrance and attack nod guy
                                                        // 01 if still alive
      {
        Commands->Send_Custom_Event(obj, obj, 0, M01_WALKING_WAYPATH_04_JDG, 0);
      }
      ...
      if (action_id == gdi01conv01) {
        ...
        GameObject *grenadier = Commands->Find_Object(116383);
        if (grenadier != NULL) {
          Commands->Send_Custom_Event(obj, grenadier, 0, M01_MODIFY_YOUR_ACTION_03_JDG,
                                      0); // tell grenadier to greet havoc
        }
      }
