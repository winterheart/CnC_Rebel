...
void StyleMgrClass::Initialize(void) {
  ...
  for (int index = 0; index < FONT_MAX; index++) {
    ...
    //	Create the font
    //
    Fonts[index] = WW3DAssetManager::Get_Instance()->Get_FontChars(DEFAULT_FONTS[index].name, point_size,
...
void StyleMgrClass::Initialize_From_INI(const char *filename) {
  ...
  if (ini_file != NULL) {
    ...
    const char *FONT_INI_ENTRIES[FONT_MAX] = {"FONT_TITLE",
                                              "FONT_LG_CONTROLS",
                                              "FONT_CONTROLS",
                                              "FONT_LISTS",
                                              "FONT_TOOLTIPS",
...
//
////////////////////////////////////////////////////////////////
void StyleMgrClass::Render_Title_Text(const WCHAR *text, Render2DSentenceClass *renderer, const RectClass &rect) {
  //
...
//
////////////////////////////////////////////////////////////////
void StyleMgrClass::Render_Text(const WCHAR *text, Render2DSentenceClass *renderer, const RectClass &rect,
                                bool do_shadow, bool do_clip, JUSTIFICATION justify, bool is_enabled,
                                bool is_vcentered) {
  //
  //	Determine what color to render the text in
  //
...
//
////////////////////////////////////////////////////////////////
void StyleMgrClass::Render_Text(const WCHAR *text, Render2DSentenceClass *renderer, uint32 text_color,
                                uint32 shadow_color, const RectClass &rect, bool do_shadow, bool do_clip,
                                JUSTIFICATION justify, bool is_vcentered) {
  //
  //	If necessary, assign the clipping rectangle
  //
  if (do_clip) {
...
//
////////////////////////////////////////////////////////////////
void StyleMgrClass::Render_Wrapped_Text(const WCHAR *text, Render2DSentenceClass *renderer, const RectClass &rect,
                                        bool do_shadow, bool do_vcenter, bool is_enabled) {
  //
  //	Determine what color to render the text in
  //
  int text_color = TextColor;
...
//
////////////////////////////////////////////////////////////////
void StyleMgrClass::Render_Wrapped_Text_Ex(const WCHAR *text, Render2DSentenceClass *renderer, const RectClass &rect,
                                           bool do_shadow, bool do_vcenter, bool is_enabled, JUSTIFICATION justify) {
  //
  //	Determine what color to render the text in
  //
  int text_color = TextColor;
  ...
  //	Render the text
  //
  Render_Wrapped_Text_Ex(text, renderer, text_color, shadow_color, rect, do_shadow, do_vcenter, justify);
  return;
}
...
//
////////////////////////////////////////////////////////////////
void StyleMgrClass::Render_Wrapped_Text_Ex(const WCHAR *text, Render2DSentenceClass *renderer, uint32 text_color,
                                           uint32 shadow_color, const RectClass &rect, bool do_shadow, bool do_vcenter,
                                           JUSTIFICATION justify) {
  //
  //	Enable wrapping
  //
...
#define COPY_LINE(dest, src_start, src_end)                                                                            \
  ...
  while (line_start != NULL) {
    ...
    //
    Render_Text(curr_text, renderer, text_color, shadow_color, curr_rect, do_shadow, false, justify, false);
...
//
////////////////////////////////////////////////////////////////
void StyleMgrClass::Render_Wrapped_Text(const WCHAR *text, Render2DSentenceClass *renderer, uint32 text_color,
                                        uint32 shadow_color, const RectClass &rect, bool do_shadow, bool do_vcenter) {
  //
  //	Enable wrapping
  //
...
//
////////////////////////////////////////////////////////////////
void StyleMgrClass::Render_Glow(const WCHAR *text, Render2DSentenceClass *renderer, const RectClass &rect, int radius_x,
                                int radius_y, int color, JUSTIFICATION justify) {
  //
  //	Get the extents of the text we will be drawing
  //
  Vector2 text_extent = renderer->Get_Text_Extents(text);
