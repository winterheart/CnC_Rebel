...
CheckBoxCtrlClass::CheckBoxCtrlClass(void)
    : TextRect(0, 0, 0, 0), ButtonRect(0, 0, 0, 0), MaxRect(0, 0, 0, 0), IsChecked(false) {
  //
...
//
////////////////////////////////////////////////////////////////
CheckBoxCtrlClass::~CheckBoxCtrlClass(void) { return; }
...
//
////////////////////////////////////////////////////////////////
void CheckBoxCtrlClass::Create_Text_Renderers(void) {
  ...
  //	Draw the text
  //
  StyleMgrClass::Render_Text(Title, &TextRenderer, TextRect, true, true, StyleMgrClass::LEFT_JUSTIFY, IsEnabled);
...
//
////////////////////////////////////////////////////////////////
void CheckBoxCtrlClass::Create_Control_Renderers(void) {
...
//
////////////////////////////////////////////////////////////////
void CheckBoxCtrlClass::Set_Check(bool onoff) { Internal_Set_Check(onoff, false); }
...
//
////////////////////////////////////////////////////////////////
void CheckBoxCtrlClass::On_LButton_Up(const Vector2 &mouse_pos) { return; }
...
//
////////////////////////////////////////////////////////////////
void CheckBoxCtrlClass::On_Create(void) { return; }
