...
ListCtrlClass::ListCtrlClass(void)
    : CurrState(NORMAL), ScrollPos(0), HeaderRect(0, 0, 0, 0), TextRect(0, 0, 0, 0), CurrSel(-1), RowBorderHeight(0),
      PulsePercent(1.0F), PulseDirection(1.0F), IsScrollBarDisplayed(false), LastPageTopEntryIndex(0),
      IsSelectionAllowed(true), IsNoSelectionAllowed(false), IsMultipleSelection(false), SortColumn(0),
      SortType(SORT_NONE), MinRowHeight(0) {
  //
...
void ListCtrlClass::Set_Tabstop(float stop) { TextRenderer.Set_Tabstop(stop); }
...
//
////////////////////////////////////////////////////////////////
void ListCtrlClass::Create_Control_Renderer(void) {
...
//
////////////////////////////////////////////////////////////////
void ListCtrlClass::Create_Text_Renderers(void) {
  //
  ...
  if ((Style & LVS_NOCOLUMNHEADER) == 0) {
    ...
    for (int index = 0; index < ColList.Count(); index++) {
      ...
      UnderlineRenderer.Add_Line(Vector2(rect.Left, y_pos), Vector2(rect.Left + text_extent.X, y_pos), 1.0F, color);
      ...
      //	Render the text
      //
      StyleMgrClass::Render_Text(ColList[index]->Get_Name(), &HeaderRenderer, color, RGB_TO_INT32(0, 0, 0), rect, true,
                                 true);
...
//
////////////////////////////////////////////////////////////////
void ListCtrlClass::Render_Entry(const RectClass &clip_rect, int col_index, int row_index) {
  ...
  //	Render the text
  //
  StyleMgrClass::Render_Wrapped_Text(text, &TextRenderer, text_color, RGB_TO_INT32(0, 0, 0), rect, true, true);
...
//
////////////////////////////////////////////////////////////////
int CALLBACK ListCtrlClass::Default_Sort_Callback(ListCtrlClass *list_ctrl, int item_index1, int item_index2,
                                                  uint32 user_param) {
  //
...
//
////////////////////////////////////////////////////////////////
int ListCtrlClass::Find_Top_Of_Page(int bottom_index) {
  int retval = 0;
...
//
////////////////////////////////////////////////////////////////
int ListCtrlClass::Find_End_Of_Page(void) {
  int count = RowInfoList.Count();
  int retval = count;
  float y_pos = TextRect.Top;
...
//
////////////////////////////////////////////////////////////////
int ListCtrlClass::Find_Last_Page_Top_Entry(void) {
  int retval = 0;
...
//
////////////////////////////////////////////////////////////////
void ListCtrlClass::Update_Scroll_Bar_Visibility(void) {
...
//
////////////////////////////////////////////////////////////////
void ListCtrlClass::Select_All(bool select) {
  //
  //	Loop over all the entries in the list control
  //
  int entry_count = Get_Entry_Count();
...
//
////////////////////////////////////////////////////////////////
void ListCtrlClass::On_LButton_Up(const Vector2 &mouse_pos) { return; }
...
//
////////////////////////////////////////////////////////////////
void ListCtrlClass::Quick_Sort(int start_index, int end_index, LISTCTRL_SORT_CALLBACK sort_callback,
                               uint32 user_param) {
//
...
//
////////////////////////////////////////////////////////////////
void ListCtrlClass::On_Create(void) { return; }
...
//
////////////////////////////////////////////////////////////////
void ListCtrlClass::Add_Column(const WCHAR *column_name, float width, const Vector3 &color) {
  //
...
//
////////////////////////////////////////////////////////////////
bool ListCtrlClass::Remove_Column(int index) {
...
//
////////////////////////////////////////////////////////////////
int ListCtrlClass::Get_Column_Count(void) const { return ColList.Count(); }
...
//
////////////////////////////////////////////////////////////////
int ListCtrlClass::Get_Entry_Count(void) const { return RowInfoList.Count(); }
...
//
////////////////////////////////////////////////////////////////
int ListCtrlClass::Insert_Entry(int index, const WCHAR *text) {
  if (ColList.Count() <= 0) {
    return -1;
  }
...
//
////////////////////////////////////////////////////////////////
const WCHAR *ListCtrlClass::Get_Entry_Text(int index, int col_index) {
  //
...
//
////////////////////////////////////////////////////////////////
void ListCtrlClass::Delete_All_Entries(void) {
  //
...
//
////////////////////////////////////////////////////////////////
void ListCtrlClass::Scroll_To_End(void) {
  //
  //	Update the last page top entry
  //
  LastPageTopEntryIndex = Find_Last_Page_Top_Entry();
...
//
////////////////////////////////////////////////////////////////
void ListCtrlClass::Set_Curr_Sel(int new_sel) {
  if (new_sel == -1) {
    Select_All(false);
    CurrSel = -1;
  } else {
...
//
////////////////////////////////////////////////////////////////
void ListCtrlClass::Update_Scroll_Pos(void) {
  if (CurrSel < 0) {
    return;
  }
...
//
////////////////////////////////////////////////////////////////
void ListCtrlClass::Get_Entry_Rect(int index, RectClass &rect) {
  if (index < 0 || index >= RowInfoList.Count()) {
    return;
  }
...
void ListCtrlClass::Scroll_Page(int direction) {
  ...
  //
  int index;
  for (index = ScrollPos; index >= 0 && index < count; index += direction) {
    //
...
//
////////////////////////////////////////////////////////////////
void ListCtrlClass::On_VScroll(ScrollBarCtrlClass *, int, int new_position) {
...
//
////////////////////////////////////////////////////////////////
void ListColumnClass::Free_Data(void) {
  Delete_All_Entries();
  return;
}
...
//
////////////////////////////////////////////////////////////////
void ListColumnClass::Reset_Contents(void) {
  //
...
//
////////////////////////////////////////////////////////////////
void ListColumnClass::Delete_All_Entries(void) {
  //
...
void ListColumnClass::Move_Entry(int old_index, int new_index) {
  if (old_index < 0 || (old_index >= EntryList.Count()) && new_index < 0 || (new_index >= EntryList.Count())) {
    return;
  }
...
void ListColumnClass::Swap_Entries(int index1, int index2) {
  if (index1 < 0 || (index1 >= EntryList.Count()) && index2 < 0 || (index2 >= EntryList.Count())) {
    return;
  }
