...
TreeCtrlClass::TreeCtrlClass(void)
    : SelectedItem(NULL), ScrollPos(0), RowHeight(0), RowsPerPage(0), IsScrollBarDisplayed(false) {
  //
...
//
////////////////////////////////////////////////////////////////
void TreeCtrlClass::Create_Text_Renderers(void) {
  //
...
//
////////////////////////////////////////////////////////////////
bool TreeCtrlClass::Render_Item(TreeItemClass *item, float x_pos, float &y_pos, int &row_index, int level) {
  bool retval = true;
  if (item == NULL) {
    return false;
  }
  ...
  if (row_index >= ScrollPos && ((y_pos + RowHeight) <= ClientRect.Bottom)) {
    ...
    //	Draw the text
    //
    StyleMgrClass::Render_Text(item->Get_Name(), &TextRenderer, text_rect, true, true, StyleMgrClass::LEFT_JUSTIFY,
                               IsEnabled);
  ...
  if (item->Is_Expanded()) {
    ...
    //
    if (end_row_index != start_row_index && end_row_index >= ScrollPos &&
...
//
////////////////////////////////////////////////////////////////
int TreeCtrlClass::Count_Visible_Rows(void) {
  int total = 0;
...
//
////////////////////////////////////////////////////////////////
int TreeCtrlClass::Count_Visible_Rows(TreeItemClass *item) {
  if (item == NULL) {
    return 0;
  }
...
//
////////////////////////////////////////////////////////////////
void TreeCtrlClass::Create_Control_Renderers(void) {
...
//
////////////////////////////////////////////////////////////////
void TreeCtrlClass::Sort_Children(TreeItemClass *parent, TREECTRL_SORT_CALLBACK sort_callback, uint32 user_data) {
...
//
////////////////////////////////////////////////////////////////
int __cdecl TreeCtrlClass::Sort_Callback(const void *elem1, const void *elem2) {
  WWASSERT(elem1 != NULL);
  WWASSERT(elem2 != NULL);
...
//
////////////////////////////////////////////////////////////////
int CALLBACK TreeCtrlClass::Alphabetic_Sort_Callback(TreeCtrlClass *tree_ctrl, TreeItemClass *item1,
                                                     TreeItemClass *item2, uint32 user_param) {
  //
  //	Sort by name
  //
...
//
////////////////////////////////////////////////////////////////
TreeItemClass *TreeCtrlClass::Find_Top_Item(void) {
...
//
////////////////////////////////////////////////////////////////
TreeItemClass *TreeCtrlClass::Find_Last_Visible_Item(void) {
  //
...
//
////////////////////////////////////////////////////////////////
void TreeCtrlClass::On_LButton_Up(const Vector2 &mouse_pos) { return; }
...
//
////////////////////////////////////////////////////////////////
void TreeCtrlClass::On_Create(void) { return; }
...
//
////////////////////////////////////////////////////////////////
void TreeCtrlClass::Ensure_Visible(TreeItemClass *item_to_find) {
...
//
////////////////////////////////////////////////////////////////
TreeItemClass *TreeCtrlClass::Insert_Item(const WCHAR *name, const char *icon_name, const char *selected_icon_name,
...
//
////////////////////////////////////////////////////////////////
TreeItemClass *TreeCtrlClass::Get_Selected_Item(void) { return SelectedItem; }
...
//
////////////////////////////////////////////////////////////////
TreeItemClass *TreeCtrlClass::Get_Next_Sibling(TreeItemClass *item) {
  TreeItemClass *retval = NULL;
  if (item == NULL) {
    return NULL;
  }
...
//
////////////////////////////////////////////////////////////////
TreeItemClass *TreeCtrlClass::Get_Prev_Sibling(TreeItemClass *item) {
  TreeItemClass *retval = NULL;
  if (item == NULL) {
    return NULL;
  }
...
//
////////////////////////////////////////////////////////////////
TreeItemClass *TreeCtrlClass::Find_Prev_Visible(TreeItemClass *item) {
  TreeItemClass *retval = NULL;
  if (item == NULL) {
    if (ItemList.Count() > 0) {
      return ItemList[0];
...
//
////////////////////////////////////////////////////////////////
TreeItemClass *TreeCtrlClass::Find_Next_Visible(TreeItemClass *item) {
  TreeItemClass *retval = NULL;
  if (item == NULL) {
    if (ItemList.Count() > 0) {
      return ItemList[0];
...
//
////////////////////////////////////////////////////////////////
void TreeCtrlClass::Update_Scroll_Bar_Visibility(void) {
  int visible_rows = Count_Visible_Rows();
...
//
////////////////////////////////////////////////////////////////
void TreeCtrlClass::On_Expanded(TreeItemClass *item) {
  //
  //	Notify any advise sinks
  //
...
//
////////////////////////////////////////////////////////////////
void TreeItemClass::Remove_Child(TreeItemClass *child) {
...
//
////////////////////////////////////////////////////////////////
void TreeItemClass::Expand(bool onoff) {
  IsExpanded = onoff;
...
//
////////////////////////////////////////////////////////////////
void TreeItemClass::Set_Name(const WCHAR *name) {
  Name = name;
  TreeCtrl->Set_Dirty();
  return;
}
...
//
////////////////////////////////////////////////////////////////
void TreeItemClass::Set_Icon(const char *texture_name) {
...
//
////////////////////////////////////////////////////////////////
void TreeItemClass::Set_Selected_Icon(const char *texture_name) {
...
//
////////////////////////////////////////////////////////////////
TreeItemClass *TreeItemClass::Get_Prev_Child(TreeItemClass *child) {
  TreeItemClass *retval = NULL;
  if (child == NULL) {
    return NULL;
  }
...
//
////////////////////////////////////////////////////////////////
TreeItemClass *TreeItemClass::Get_Next_Child(TreeItemClass *child) {
  TreeItemClass *retval = NULL;
  if (child == NULL) {
    return NULL;
  }
...
//
////////////////////////////////////////////////////////////////
int TreeItemClass::Get_Indent_Level(void) {
  int retval = 0;
...
//
////////////////////////////////////////////////////////////////
TreeItemClass *TreeItemClass::Get_Last_Child(void) {
  TreeItemClass *retval = NULL;
...
//
////////////////////////////////////////////////////////////////
void TreeItemClass::Set_Needs_Children(bool onoff) {
  NeedsChildren = onoff;
  TreeCtrl->Set_Dirty();
  return;
}
