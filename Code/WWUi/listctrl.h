...
//	Typedefs
////////////////////////////////////////////////////////////////
typedef int(CALLBACK *LISTCTRL_SORT_CALLBACK)(ListCtrlClass *list_ctrl, int item_index1, int item_index2,
                                              uint32 user_param);
...
public:
  ...
  //	Public constants
  ////////////////////////////////////////////////////////////////
  typedef enum { SORT_NONE = 0, SORT_ASCENDING, SORT_DESCENDING } SORT_TYPE;
...
protected:
  ...
  static int CALLBACK Default_Sort_Callback(ListCtrlClass *list_ctrl, int item_index1, int item_index2,
                                            uint32 user_param);

  ////////////////////////////////////////////////////////////////
  //	Protected constants
  ////////////////////////////////////////////////////////////////
  enum { NORMAL = 0, DISABLED, STATE_MAX };
...
public:
  ...
  //	Public constructors/destructors
  ////////////////////////////////////////////////////////////////
  ListEntryClass(void) : Name(L""), Color(1, 1, 1), UserData(0) {}

  ListEntryClass(const WCHAR *name) : Name(name), Color(1, 1, 1), UserData(0) {}
...
public:
  ...
  //	Public constructors/destructors
  ////////////////////////////////////////////////////////////////
  ListColumnClass(void) : Width(0) { Reset_Contents(); }
...
public:
  ...
  //	Public constructors/destructors
  ////////////////////////////////////////////////////////////////
  ListRowClass(void) : Height(0), IsSelected(false) {}
