...
//
//////////////////////////////////////////////////////////////////////
MerchandiseCtrlClass::MerchandiseCtrlClass(void) : UserData(0), Cost(0), CurrentTextureIndex(0), Count(0) {
  //
  ...
  TextureClass *texture =
      WW3DAssetManager::Get_Instance()->Get_Texture("hud_cnc_Button.tga", TextureClass::MIP_LEVELS_1);
...
//
//////////////////////////////////////////////////////////////////////
MerchandiseCtrlClass::~MerchandiseCtrlClass(void) { return; }
...
//
////////////////////////////////////////////////////////////////
void MerchandiseCtrlClass::Create_Text_Renderer(void) {
  //
  ...
  StyleMgrClass::Render_Text(Title, &NameTextRenderer, RGB_TO_INT32(255, 255, 255), RGB_TO_INT32(0, 0, 0), TextRect,
                             true, true, StyleMgrClass::LEFT_JUSTIFY, true);
  StyleMgrClass::Render_Text(cost_text, &CostTextRenderer, RGB_TO_INT32(255, 255, 255), RGB_TO_INT32(0, 0, 0), CostRect,
                             true, true, StyleMgrClass::LEFT_JUSTIFY, true);
  ...
  if (Count > 1) {
    ...
    StyleMgrClass::Render_Text(count_text, &CountTextRenderer, RGB_TO_INT32(255, 255, 255), RGB_TO_INT32(0, 0, 0),
                               CountRect, true, true, StyleMgrClass::CENTER_JUSTIFY, true);
  }
...
//
////////////////////////////////////////////////////////////////
void MerchandiseCtrlClass::Create_Control_Renderer(void) {
...
//
////////////////////////////////////////////////////////////////
void MerchandiseCtrlClass::Create_Texture_Renderer(void) {
...
//
////////////////////////////////////////////////////////////////
void MerchandiseCtrlClass::Set_Texture(const char *texture_name) {
...
//
////////////////////////////////////////////////////////////////
void MerchandiseCtrlClass::Add_Alternate_Texture(const char *texture_name) {
  TextureNameList.Add(texture_name);
  Set_Dirty();
  return;
}
...
void MerchandiseCtrlClass::On_LButton_Down(const Vector2 &mouse_pos) {
  ...
  if (TextureNameList.Count() > 1 && button_rect.Contains(mouse_pos)) {
    ...
    //
    TextureClass *texture =
        WW3DAssetManager::Get_Instance()->Get_Texture(TextureNameList[CurrentTextureIndex], TextureClass::MIP_LEVELS_1);
    if (texture != NULL) {
      TextureRenderer.Set_Texture(texture);
      REF_PTR_RELEASE(texture);
    }
