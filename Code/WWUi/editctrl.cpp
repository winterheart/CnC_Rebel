...
EditCtrlClass::EditCtrlClass(void)
    : CaretPos(0), ScrollPos(0), NumChars(0), TextLimit(0xFFFF), CaretBlinkDelay(500), LastCaretBlink(0),
      HilightStartPos(-1), HilightEndPos(-1), HilightAnchorPos(-1), WasButtonPressedOnMe(false),
      IsCaretDisplayed(false), mInComposition(false)
...
//
////////////////////////////////////////////////////////////////
void EditCtrlClass::Create_Text_Renderers(void) {
  ...
  StyleMgrClass::Render_Text(text, &TextRenderer, color, shadowColor, ClientRect, true, true,
...
//
////////////////////////////////////////////////////////////////
void EditCtrlClass::Create_Control_Renderers(void) {
  //
...
//
////////////////////////////////////////////////////////////////
void EditCtrlClass::Update_Caret(void) {
  //
...
//
////////////////////////////////////////////////////////////////
void EditCtrlClass::Create_Caret_Renderer(void) {
  CaretRenderer.Reset();
...
//
////////////////////////////////////////////////////////////////
float EditCtrlClass::Pos_From_Character(int char_index) {
  //
...
//
////////////////////////////////////////////////////////////////
bool EditCtrlClass::Delete_Selection(void) {
  if (HilightStartPos >= 0) {
...
//
////////////////////////////////////////////////////////////////
void EditCtrlClass::Update_Hilight(int new_pos, int anchor_pos) {
...
//
////////////////////////////////////////////////////////////////
void EditCtrlClass::Update_Scroll_Pos(void) {
...
//
////////////////////////////////////////////////////////////////
int EditCtrlClass::Get_Int(void) { return _wtoi(Get_Text()); }
...
//
////////////////////////////////////////////////////////////////
int EditCtrlClass::Get_Text_Length(void) const { return NumChars; }
...
//
////////////////////////////////////////////////////////////////
int EditCtrlClass::Get_Text_Limit(void) const { return TextLimit; }
...
//
////////////////////////////////////////////////////////////////
int EditCtrlClass::Get_Caret_Pos(void) const {
  if (mIME && mInComposition) {
...
//
////////////////////////////////////////////////////////////////
void EditCtrlClass::Set_Sel(int start_index, int end_index) {
...
//
////////////////////////////////////////////////////////////////
void EditCtrlClass::Get_Sel(int &start_index, int &end_index) const {
