...
SubTitleManagerClass *SubTitleManagerClass::Create(const char *filename, const char *subtitlefilename,
                                                   FontCharsClass *font) {
...
SubTitleManagerClass::SubTitleManagerClass() : mSubTitles(NULL), mSubTitleIndex(0), mActiveSubTitle(NULL) {}
...
void SubTitleManagerClass::Render() { Renderer.Render(); }
