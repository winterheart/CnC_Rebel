...
{
        SIM_DIR_INFO ( 0.0F,						 	 Vector3 ( 0.9F, -0.1F, -1.5F), Vector3
( 2.0F,  0.1F, 1.5F) ), SIM_DIR_INFO ( (float)DEG_TO_RAD (90),	 Vector3 (-0.1F,  0.9F, -1.5F), Vector3 (
0.1F,  2.0F, 1.5F) ), SIM_DIR_INFO ( (float)DEG_TO_RAD (180), Vector3 (-2.0F, -0.1F, -1.5F), Vector3 (-0.9F, 0.1F, 1.5F)
...
static const SimDirInfoClass DIR_INFO[DIR_MAX] = {
    ...
    SimDirInfoClass((float)DEG_TO_RAD(90), 0, Vector3(0, 1.0F, 0), Vector3(-0.05F, 0.95F, -2.0F),
                    Vector3(0.05F, 1.2F, 2.0F)),
    SimDirInfoClass((float)DEG_TO_RAD(180), 0, Vector3(-1.0F, 0, 0), Vector3(-1.2F, -0.05F, -2.0F),
                    Vector3(-0.95F, 0.05F, 2.0F)),
    SimDirInfoClass((float)DEG_TO_RAD(270), 0, Vector3(0, -1.0F, 0), Vector3(-0.05F, -1.2F, -2.0F),
                    Vector3(0.05F, -0.95F, 2.0F))};
...
PathfindSectorBuilderClass::PathfindSectorBuilderClass(void)
    : m_PhysicsSim(NULL), m_RecurseLevel(0), m_RepartitionCount(0), m_CurrentSector(NULL),
      m_SimBoundingBox(Vector3(0.5F, 0.5F, 1.8F)), m_DirInfo(NULL), m_bCancel(false) {
  //
...
//
//////////////////////////////////////////////////////////////////////////
void PathfindSectorBuilderClass::Generate_Sectors(const Vector3 &start_pos) {
...
void PathfindSectorBuilderClass::Do_Physics_Sim(const Vector3 &start_pos, PATHFIND_DIR direction) {
  ...
  PhysAABoxCollisionTestClass test(box, Vector3(0, 0, -movement), &result, m_PhysicsSim->Get_Collision_Group(),
...
//
//////////////////////////////////////////////////////////////////////////
BodyBoxCullObj *PathfindSectorBuilderClass::Get_Sector_Occupant(const Vector3 &pos) {
...
//
//////////////////////////////////////////////////////////////////////////
void PathfindSectorBuilderClass::Mark_Sector(BodyBoxCullObj *body_box) {
  //
...
//
//////////////////////////////////////////////////////////////////////////
BodyBoxCullObj *PathfindSectorBuilderClass::Mark_Sector(const Vector3 &pos) {
  //
...
//
//////////////////////////////////////////////////////////////////////////
void PathfindSectorBuilderClass::Compress_Sectors(void) {
  ...
  while (BodyBoxCullObj::Get_First() != NULL) {
    ...
    //
    largest_area = 0;
    for (BodyBoxCullObj *cull_obj = BodyBoxCullObj::Get_First(); cull_obj != NULL; cull_obj = cull_obj->Get_Next()) {
      int max_down = 0;
      int max_right = 0;
      int max_area = 0;
...
//
///////////////////////////////////////////////////////////////////////////
void PathfindSectorBuilderClass::Free_Sectors(void) {
  //
...
//
///////////////////////////////////////////////////////////////////////////
void PathfindSectorBuilderClass::Import_Raw_Data(void) {
