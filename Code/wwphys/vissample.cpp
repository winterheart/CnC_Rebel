...
VisSampleClass::VisSampleClass(void) : DirectionBits(0), ViewTransform(1), CurDirection(VIS_FORWARD), BitsChanged(0) {
...
const char *VisSampleClass::Get_Cur_Direction_Name(void) const {
  ...
  static const char *_direction_names[] = {"F", "L", "B", "R", "U", "D"};
...
int VisSampleClass::Get_Cur_Direction(void) const { return CurDirection; }
