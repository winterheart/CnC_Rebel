...
public:
  ...
  PathfindPortalClass(void)
      : m_DestSector1((uint16)-1), m_DestSector2((uint16)-1), m_HeapLocation(0), m_ClosedListPtr(NULL), m_ID(0) {}
...
//	Get_Bounding_Box
//////////////////////////////////////////////////////////////////////////
inline void PathfindPortalClass::Get_Bounding_Box(AABoxClass &box) const {
  box = m_BoundingBox;
  return;
}
...
//	Set_Bounding_Box
//////////////////////////////////////////////////////////////////////////
inline void PathfindPortalClass::Set_Bounding_Box(const AABoxClass &box) {
  m_BoundingBox = box;
  return;
}
...
//	Add_Dest_Sector
//////////////////////////////////////////////////////////////////////////
inline void PathfindPortalClass::Add_Dest_Sector(int sector_index) {
...
//	Add_Dest_Sector
//////////////////////////////////////////////////////////////////////////
inline void PathfindPortalClass::Add_Dest_Sector(PathfindSectorClass *sector) {
...
//	Get_Dest_Sector1
//////////////////////////////////////////////////////////////////////////
inline uint16 PathfindPortalClass::Get_Dest_Sector1(void) { return m_DestSector1; }

//////////////////////////////////////////////////////////////////////////
//	Get_Dest_Sector2
//////////////////////////////////////////////////////////////////////////
inline uint16 PathfindPortalClass::Get_Dest_Sector2(void) { return m_DestSector2; }

//////////////////////////////////////////////////////////////////////////
//	Peek_Dest_Sector
//////////////////////////////////////////////////////////////////////////
inline PathfindSectorClass *PathfindPortalClass::Peek_Dest_Sector(PathfindSectorClass *current_sector) {
  //
...
//	Is_Two_Way_Portal
//////////////////////////////////////////////////////////////////////////
inline bool PathfindPortalClass::Is_Two_Way_Portal(void) const {
...
//	Get_Heap_Location
//////////////////////////////////////////////////////////////////////////
inline uint32 PathfindPortalClass::Get_Heap_Location(void) const { return m_HeapLocation; }

//////////////////////////////////////////////////////////////////////////
//	Set_Heap_Location
//////////////////////////////////////////////////////////////////////////
inline void PathfindPortalClass::Set_Heap_Location(uint32 location) {
...
public:
  ...
  PathfindActionPortalClass(void)
      : m_Destination(0, 0, 0), m_EntranceSector(NULL), m_ExitPortal(NULL), m_EnterPortal(NULL), m_MechanismID(0),
