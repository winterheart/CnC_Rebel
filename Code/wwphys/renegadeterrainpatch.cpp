...
RenegadeTerrainPatchClass::RenegadeTerrainPatchClass(void)
    : Density(1.0F), GridPointsX(0), GridPointsY(0), GridPointCount(0), Grid(NULL), GridNormals(NULL),
      VertexColors(NULL), QuadFlags(NULL), BaseMaterial(NULL), LayerMaterial(NULL), BaseShader(0), LayerShader(0),
      BoundingBoxMin(0, 0, 0), BoundingBoxMax(0, 0, 0), AreBuffersDirty(true), IsPreLit(false) {
  Initialize();
  return;
}
...
RenegadeTerrainPatchClass::RenegadeTerrainPatchClass(const RenegadeTerrainPatchClass &src)
    : Density(1.0F), GridPointsX(0), GridPointsY(0), GridPointCount(0), Grid(NULL), GridNormals(NULL),
      VertexColors(NULL), QuadFlags(NULL), BaseMaterial(NULL), LayerMaterial(NULL), BaseShader(0), LayerShader(0),
      BoundingBoxMin(0, 0, 0), BoundingBoxMax(0, 0, 0), AreBuffersDirty(true), IsPreLit(false), RenderObjClass(src) {
  Initialize();
  *this = src;
  return;
}
...
//
//////////////////////////////////////////////////////////////////////
const RenegadeTerrainPatchClass &RenegadeTerrainPatchClass::operator=(const RenegadeTerrainPatchClass &src) {
  return *this;
}
...
//
//////////////////////////////////////////////////////////////////////
void RenegadeTerrainPatchClass::Initialize(void) {
...
//
//////////////////////////////////////////////////////////////////////
void RenegadeTerrainPatchClass::Allocate(int points_x, int points_y, float meters_per_point) {
  Free_Grid();
...
//
//////////////////////////////////////////////////////////////////////
void RenegadeTerrainPatchClass::Allocate_Grid(void) {
  //
...
//
//////////////////////////////////////////////////////////////////////
void RenegadeTerrainPatchClass::Free_Grid(void) {
  if (Grid != NULL) {
    delete[] Grid;
    Grid = NULL;
  }
...
//
//////////////////////////////////////////////////////////////////////
void RenegadeTerrainPatchClass::Render(RenderInfoClass &rinfo) {
  //
...
//
//////////////////////////////////////////////////////////////////////
void RenegadeTerrainPatchClass::Render_Procedural_Material_Pass(MaterialPassClass *matpass) {
#if 0
  ...
  */
  ...
  for (int index = 0; index < MaterialPassList.Count(); index++) {
    ...
    //	Alias some data
    //
    DynamicVectorClass<int> &vert_list =
        MaterialPassList[index]->VertexRenderList[RenegadeTerrainMaterialPassClass::PASS_BASE];
...
//
//////////////////////////////////////////////////////////////////////
void RenegadeTerrainPatchClass::Submit_Rendering_Buffers(int texture_index, int pass_type) {
  //
...
//
//////////////////////////////////////////////////////////////////////
void RenegadeTerrainPatchClass::Render_By_Texture(int texture_index, int pass_type) {
  //
  //	Don't render this layer if there isn't anything to render!
  //
  if (MaterialPassList[texture_index]->VertexBuffers[pass_type] == NULL ||
...
//
//////////////////////////////////////////////////////////////////////
void RenegadeTerrainPatchClass::Free_Rendering_Buffers(void) {
  //
...
//
//////////////////////////////////////////////////////////////////////
void RenegadeTerrainPatchClass::Update_Rendering_Buffers(void) {
  Free_Rendering_Buffers();
...
//
//////////////////////////////////////////////////////////////////////
void RenegadeTerrainPatchClass::Build_Rendering_Buffers(int texture_index, int pass_type) {
  //
  //	Alias some data
  //
...
//
//////////////////////////////////////////////////////////////////////
void RenegadeTerrainPatchClass::Initialize_Material(void) {
  //
...
//
//////////////////////////////////////////////////////////////////////
void RenegadeTerrainPatchClass::Free_Materials(void) {
  //
...
//
//////////////////////////////////////////////////////////////////////
void RenegadeTerrainPatchClass::Get_Obj_Space_Bounding_Sphere(SphereClass &sphere) const {
...
//
//////////////////////////////////////////////////////////////////////
void RenegadeTerrainPatchClass::Get_Obj_Space_Bounding_Box(AABoxClass &box) const {
  float delta_x = BoundingBoxMax.X - BoundingBoxMin.X;
  float delta_y = BoundingBoxMax.Y - BoundingBoxMin.Y;
  float delta_z = BoundingBoxMax.Z - BoundingBoxMin.Z;
...
//
//////////////////////////////////////////////////////////////////////
bool RenegadeTerrainPatchClass::Cast_OBBox(OBBoxCollisionTestClass &boxtest) {
  //
  ...
  //
  OBBoxCollisionTestClass obj_space_test(obj_space_box, obj_space_move, boxtest.Result, boxtest.CollisionType);
  ...
  for (int y_pos = min_y; y_pos <= max_y; y_pos++) {
    for (int x_pos = min_x; x_pos <= max_x; x_pos++) {
      ...
      retval |= CollisionMath::Collide(obj_space_test.Box, obj_space_test.Move, tri1, Vector3(0, 0, 0),
                                       obj_space_test.Result);
      retval |= CollisionMath::Collide(obj_space_test.Box, obj_space_test.Move, tri2, Vector3(0, 0, 0),
                                       obj_space_test.Result);
...
//
//////////////////////////////////////////////////////////////////////
bool RenegadeTerrainPatchClass::Intersect_AABox(AABoxIntersectionTestClass &boxtest) {
  //
  //	Skip this object if it doesn't match the collision type
  //
  if ((Get_Collision_Type() & boxtest.CollisionType) == 0) {
...
//
//////////////////////////////////////////////////////////////////////
bool RenegadeTerrainPatchClass::Intersect_OBBox(OBBoxIntersectionTestClass &boxtest) {
  //
  //	Skip this object if it doesn't match the collision type
  //
  if ((Get_Collision_Type() & boxtest.CollisionType) == 0) {
...
//
//////////////////////////////////////////////////////////////////////
bool RenegadeTerrainPatchClass::Cast_AABox(AABoxCollisionTestClass &boxtest) {
  //
  //	Skip this object if it doesn't match the collision type
  //
  if ((Get_Collision_Type() & boxtest.CollisionType) == 0) {
...
//
//////////////////////////////////////////////////////////////////////
bool RenegadeTerrainPatchClass::Cast_Ray(RayCollisionTestClass &raytest) {
  //
  //	Skip this object if it doesn't match the collision type
  //
  if ((Get_Collision_Type() & raytest.CollisionType) == 0 || raytest.Result->StartBad) {
    return false;
  }
...
//
//////////////////////////////////////////////////////////////////////
bool RenegadeTerrainPatchClass::Cast_Vertical_Ray(RayCollisionTestClass &raytest) {
  //
  //	Sanity check
  //
  ...
  //
  if (p0.X >= BoundingBoxMin.X && p0.Y >= BoundingBoxMin.Y && p0.X <= BoundingBoxMax.X && p0.Y <= BoundingBoxMax.Y) {
...
//
//////////////////////////////////////////////////////////////////////
bool RenegadeTerrainPatchClass::Brute_Force_Cast_Ray(RayCollisionTestClass &raytest) {
  bool retval = false;
...
//
//////////////////////////////////////////////////////////////////////
bool RenegadeTerrainPatchClass::Cast_Non_Vertical_Ray(RayCollisionTestClass &raytest) {
  bool retval = false;
...
//
//////////////////////////////////////////////////////////////////////
const PersistFactoryClass &RenegadeTerrainPatchClass::Get_Factory(void) const { return _TerrainPatchFactory; }
...
//
//////////////////////////////////////////////////////////////////////
bool RenegadeTerrainPatchClass::Save(ChunkSaveClass &csave) {
  //
  //	Write the variables
  //
...
//
//////////////////////////////////////////////////////////////////////
bool RenegadeTerrainPatchClass::Load(ChunkLoadClass &cload) {
  Free_Grid();
...
//
////////////////////////////////////////////////////////////////
void RenegadeTerrainPatchClass::Load_Variables(ChunkLoadClass &cload) {
...
//
////////////////////////////////////////////////////////////////
void RenegadeTerrainPatchClass::Load_Materials(ChunkLoadClass &cload) {
  while (cload.Open_Chunk()) {
    switch (cload.Cur_Chunk_ID()) {
...
//
////////////////////////////////////////////////////////////////
int RenegadeTerrainPatchClass::Add_Material(TerrainMaterialClass *material) {
  //
...
//
////////////////////////////////////////////////////////////////
void RenegadeTerrainPatchClass::Reset_Material_Passes(void) {
  //
...
//
////////////////////////////////////////////////////////////////
void RenegadeTerrainPatchClass::Update_UVs(void) {
...
//
////////////////////////////////////////////////////////////////
void RenegadeTerrainPatchClass::Update_Vertex_Render_Lists(void) {
  int col_count = GridPointsX - 1;
...
//
////////////////////////////////////////////////////////////////
RenegadeTerrainMaterialPassClass *RenegadeTerrainPatchClass::Get_Material_Pass(int index,
