...
void DecorationPhysClass::Init(const DecorationPhysDefClass &def) { DynamicPhysClass::Init(def); }
...
const PersistFactoryClass &DecorationPhysClass::Get_Factory(void) const { return _DecoPhysFactory; }
...
uint32 DecorationPhysDefClass::Get_Class_ID(void) const { return CLASSID_DECOPHYSDEF; }
...
const char *DecorationPhysDefClass::Get_Type_Name(void) { return "DecorationPhysDef"; }
...
const PersistFactoryClass &DecorationPhysDefClass::Get_Factory(void) const { return _DecorationPhysDefFactory; }
