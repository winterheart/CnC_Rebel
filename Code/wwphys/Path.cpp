...
//	Save/Load constants
////////////////////////////////////////////////////////////////
enum { CHUNKID_VARIABLES = 0x11040535, CHUNKID_SPLINE };
...
PathClass::PathClass(void)
    : m_ExpectedPos(0, 0, 0), m_StartPos(0, 0, 0), m_DestPos(0, 0, 0), m_StartTime(0), m_EndTime(1.0F),
      m_LookAheadTime(0), m_LookAheadDist(0), m_SplineTime(0), m_State(ERROR_NOT_INITIALIZED), m_TraversalType(SPLINE),
      m_Velocity(DEF_VEHICLE_VELOCITY), m_Spline(NULL), m_MovementRadius(0.1F), m_MovementDirections(MOVE_X | MOVE_Y),
      m_CurrentAction(-1), m_IsLooping(false), m_TotalDist(0) {
  _InstanceCount++;
  return;
}
...
//
///////////////////////////////////////////////////////////////////////////
void PathClass::Initialize(const Vector3 &start, const Vector3 &end) {
...
//
///////////////////////////////////////////////////////////////////////////
void PathClass::Initialize(PathSolveClass &path_solve) {
...
//
///////////////////////////////////////////////////////////////////////////
void PathClass::Add_Waypoint_Info_To_Node_List(DynamicVectorClass<PathClass::PATH_NODE> &node_list,
                                               WaypointClass *waypoint, WaypointClass *next_point) {
  //
...
//
///////////////////////////////////////////////////////////////////////////
void PathClass::Add_Waypath_Data(DynamicVectorClass<PATH_NODE> &node_list, WaypathClass *waypath, int start_index,
                                 int end_index) {
  //
  ...
  //
  if (m_IsLooping) {
    Add_Waypoint_Info_To_Node_List(node_list, waypath->Get_Point(end_index), waypath->Get_Point(start_index));
  }
  ...
  if (m_IsLooping) {
    ...
    Add_Waypoint_Info_To_Node_List(node_list, waypath->Get_Point(start_index), waypath->Get_Point(start_index + inc));
...
//
///////////////////////////////////////////////////////////////////////////
void PathClass::Initialize(WaypathClass *waypath, int start_pt_id, int end_pt_id) {
  WWMEMLOG(MEM_PATHFIND);
...
//
///////////////////////////////////////////////////////////////////////////
bool PathClass::Evaluate_Next_Point(const Vector3 &curr_pos, Vector3 &new_pos) {
  //
  ...
  if (m_DisplayMoveVectors) {
    PhysicsSceneClass::Get_Instance()->Add_Debug_AABox(AABoxClass(curr_pos, Vector3(0.25F, 0.25F, 0.25F)),
                                                       Vector3(1, 0, 0));
    PhysicsSceneClass::Get_Instance()->Add_Debug_AABox(AABoxClass(m_ExpectedPos, Vector3(0.25F, 0.25F, 0.25F)),
                                                       Vector3(0, 1, 0));
...
//
///////////////////////////////////////////////////////////////////////////
float PathClass::Get_Curve_Sharpness(Vector3 *position) const {
  float sharpness = 0;
...
//
///////////////////////////////////////////////////////////////////////////
float PathClass::Get_Last_Eval_Time(void) const { return m_SplineTime; }
...
//
///////////////////////////////////////////////////////////////////////////
float PathClass::Get_Remaining_Path_Length(void) {
...
//
///////////////////////////////////////////////////////////////////////////
void PathClass::Display_Path(bool onoff) {
  if (onoff == false) {
...
//
/////////////////////////////////////////////////////////////////////////////////
void PathClass::Set_Traversal_Type(TRAVERSAL_TYPE type) {
  //
...
//
/////////////////////////////////////////////////////////////////////////////////
bool Find_Intersection_X(const Vector3 &start, const Vector3 &end, const Vector3 &rgn_center, const Vector3 &rgn_extent,
...
//
/////////////////////////////////////////////////////////////////////////////////
bool Find_Intersection_Y(const Vector3 &start, const Vector3 &end, const Vector3 &rgn_center, const Vector3 &rgn_extent,
                         Vector3 *intersect_point) {
...
//
/////////////////////////////////////////////////////////////////////////////////
bool Find_Side_Intersection(int index, const AABoxClass &box, const Vector3 &start, const Vector3 &end,
...
//
/////////////////////////////////////////////////////////////////////////////////
bool PathClass::Is_Point_In_Boxes(const Vector3 &point, BOX_LIST &box_list) {
  bool retval = false;
...
//
/////////////////////////////////////////////////////////////////////////////////
void PathClass::Clip_Control_Point(const Vector3 &start_point, Vector3 *point, BOX_LIST &sector_list,
...
//
/////////////////////////////////////////////////////////////////////////////////
void PathClass::Initialize_Vehicle_Spline(DynamicVectorClass<PATH_NODE> &node_list) {
...
//
/////////////////////////////////////////////////////////////////////////////////
void PathClass::Initialize_Human_Spline(DynamicVectorClass<PATH_NODE> &node_list) {
...
//
/////////////////////////////////////////////////////////////////////////////////
void PathClass::Clip_Spline_To_Pathfind_Data(DynamicVectorClass<PATH_NODE> &node_list, PathSolveClass &path_solve) {
  //
...
//
/////////////////////////////////////////////////////////////////////////////////
void PathClass::Initialize_Spline(DynamicVectorClass<PATH_NODE> &node_list) {
...
//
/////////////////////////////////////////////////////////////////////////////////
void PathClass::Set_Path_Object(PathObjectClass &path_object) {
...
//
/////////////////////////////////////////////////////////////////////////////////
void PathClass::Get_Path_Object(PathObjectClass &path_object) const {
...
//
////////////////////////////////////////////////////////////////////////////////////////////
void PathClass::Save(ChunkSaveClass &csave) {
  if (m_Spline != NULL) {
...
//
////////////////////////////////////////////////////////////////////////////////////////////
void PathClass::Load(ChunkLoadClass &cload) {
