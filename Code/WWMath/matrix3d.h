...
public:
  ...
  WWINLINE explicit Matrix3D(float m11, float m12, float m13, float m14, float m21, float m22, float m23, float m24,
                             float m31, float m32, float m33, float m34);

  WWINLINE explicit Matrix3D(const Vector3 &x,  // x-axis unit vector
                             const Vector3 &y,  // y-axis unit vector
                             const Vector3 &z,  // z-axis unit vector
                             const Vector3 &pos // position
  );

  WWINLINE explicit Matrix3D(const Vector3 &axis, float angle);

  WWINLINE explicit Matrix3D(const Vector3 &axis, float sine, float cosine);

  WWINLINE explicit Matrix3D(const Matrix3 &rotation, const Vector3 &position);

  WWINLINE explicit Matrix3D(const Quaternion &rotation, const Vector3 &position);
  ...
  WWINLINE void Set(float m11, float m12, float m13, float m14, float m21, float m22, float m23, float m24, float m31,
                    float m32, float m33, float m34);

  WWINLINE void Set(const Vector3 &x,  // x-axis unit vector
                    const Vector3 &y,  // y-axis unit vector
                    const Vector3 &z,  // z-axis unit vector
                    const Vector3 &pos // position
  );
  ...
  void Transform_Center_Extent_AABox(const Vector3 &center, const Vector3 &extent, Vector3 *set_center,
...
WWINLINE Matrix3D::Matrix3D(float m11, float m12, float m13, float m14, float m21, float m22, float m23, float m24,
                            float m31, float m32, float m33, float m34) {
...
WWINLINE Matrix3D::Matrix3D(const Vector3 &x,  // x-axis unit vector
                            const Vector3 &y,  // y-axis unit vector
                            const Vector3 &z,  // z-axis unit vector
                            const Vector3 &pos // position
) {
...
WWINLINE Matrix3D::Matrix3D(const Vector3 &axis, float angle) { Set(axis, angle); }

WWINLINE Matrix3D::Matrix3D(const Vector3 &axis, float sine, float cosine) { Set(axis, sine, cosine); }

WWINLINE Matrix3D::Matrix3D(const Matrix3 &rot, const Vector3 &pos) { Set(rot, pos); }

WWINLINE Matrix3D::Matrix3D(const Quaternion &rot, const Vector3 &pos) { Set(rot, pos); }

WWINLINE Matrix3D::Matrix3D(const Vector3 &position) { Set(position); }
 ...
 *   2/24/98    GTH : Created.                                                                 *
 *=============================================================================================*/
WWINLINE void Matrix3D::Set(float m11, float m12, float m13, float m14, float m21, float m22, float m23, float m24,
                            float m31, float m32, float m33, float m34) {
  Row[0].Set(m11, m12, m13, m14);
  Row[1].Set(m21, m22, m23, m24);
  Row[2].Set(m31, m32, m33, m34);
...
// !! with Orthogonal Matrices, for optimization purposes
// !!
WWINLINE void Matrix3D::Scale(float scale) { // uniform scale all 3 axis
  // X
  Row[0][0] *= scale;
  Row[1][0] *= scale;
  Row[2][0] *= scale;
...
// !! with Orthogonal Matrices, for optimization purposes
// !!
WWINLINE void Matrix3D::Scale(float x, float y, float z) { // separate input for each axis
  // X
  Row[0][0] *= x;
  Row[1][0] *= x;
  Row[2][0] *= x;
...
// !! with Orthogonal Matrices, for optimization purposes
// !!
WWINLINE void Matrix3D::Scale(Vector3 &scale) { // scale each axis
 ...
 *   04/29/1998 NH  : Created.                                                                 *
 *=============================================================================================*/
WWINLINE bool operator!=(const Matrix3D &A, const Matrix3D &B) { return !(A == B); }
