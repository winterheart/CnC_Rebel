 ...
 * HISTORY:                                                               *
 *========================================================================*/
WWINLINE float operator*(const Vector2 &a, const Vector2 &b) { return a.X * b.X + a.Y * b.Y; }

WWINLINE float Vector2::Dot_Product(const Vector2 &a, const Vector2 &b) { return a * b; }

WWINLINE float Vector2::Perp_Dot_Product(const Vector2 &a, const Vector2 &b) { return a.X * -b.Y + a.Y * b.X; }
 ...
 * HISTORY:                                                               *
 *========================================================================*/
WWINLINE float Vector2::Length() const { return (float)WWMath::Sqrt(Length2()); }
 ...
 * HISTORY:                                                               *
 *========================================================================*/
WWINLINE float Vector2::Length2() const { return (X * X + Y * Y); }
 ...
 * HISTORY:                                                               *
 *========================================================================*/
WWINLINE void Vector2::Rotate(float theta) { Rotate(WWMath::Sin(theta), WWMath::Cos(theta)); }
