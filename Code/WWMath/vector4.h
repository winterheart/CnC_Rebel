...
WWINLINE float Vector4::Dot_Product(const Vector4 &a, const Vector4 &b) { return a * b; }
 ...
 * HISTORY:                                                               *
 *========================================================================*/
WWINLINE float Vector4::Length() const { return WWMath::Sqrt(Length2()); }
 ...
 * HISTORY:                                                               *
 *========================================================================*/
WWINLINE float Vector4::Length2() const { return X * X + Y * Y + Z * Z + W * W; }
