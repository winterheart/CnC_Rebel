...
void LookupTableMgrClass::Shutdown() { Reset(); }
...
bool LookupTableMgrClass::Add_Table(LookupTableClass *table) { return Tables.Add(table); }

bool LookupTableMgrClass::Remove_Table(LookupTableClass *table) { return Tables.Remove(table); }
...
void LookupTableMgrClass::Save_Table_Desc(ChunkSaveClass &csave, Curve1DClass *curve, const Vector2 &min_corner,
...
void LookupTableMgrClass::Load_Table_Desc(ChunkLoadClass &cload, Curve1DClass **curve_ptr, Vector2 *set_min_corner,
